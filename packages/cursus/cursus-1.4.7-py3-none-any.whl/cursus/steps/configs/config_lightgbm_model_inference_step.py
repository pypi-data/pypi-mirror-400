...
This module implements the configuration class for the LightGBM model inference step
...
class LightGBMModelInferenceConfig(ProcessingStepConfigBase):
    """
    Configuration for LightGBM model inference step with self-contained derivation logic.

    This class defines the configuration parameters for the LightGBM model inference step,
    ...
    processing_entry_point: str = Field(
        default="lightgbm_model_inference.py",
    ...
    def initialize_derived_fields(self) -> "LightGBMModelInferenceConfig":
    ...
    @model_validator(mode="after")
    def validate_inference_config(self) -> "LightGBMModelInferenceConfig":
