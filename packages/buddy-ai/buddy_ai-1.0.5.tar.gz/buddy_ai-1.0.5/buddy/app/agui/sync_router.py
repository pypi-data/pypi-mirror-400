...
from buddy.app.agui.utils import convert_agui_messages_to_BUDDY_messages, stream_BUDDY_response_as_agui_events
...
def run_agent(agent: Agent, run_input: RunAgentInput) -> Iterator[BaseEvent]:
    ...
    try:
        ...
        for event in stream_BUDDY_response_as_agui_events(
