...
static PyObject *
U8Vector4Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(uint8_t) * 4;
...
static PyMethodDef U8Vector4Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)U8Vector4Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
