...
class TalonFXSConfiguration:
    ...
    def __init__(self):
        ...
        self.custom_brushless_motor: CustomBrushlessMotorConfigs = CustomBrushlessMotorConfigs()
        """
        ...
        - CustomBrushlessMotorConfigs.motor_kv
        - CustomBrushlessMotorConfigs.pole_pair_count
        - CustomBrushlessMotorConfigs.hall_during_ab
        - CustomBrushlessMotorConfigs.hall_during_ac
        - CustomBrushlessMotorConfigs.hall_ccw_select
        - CustomBrushlessMotorConfigs.hall_direction
        
        """
        
        
        self.external_temp: ExternalTempConfigs = ExternalTempConfigs()
        """
        ...
        - ExternalTempConfigs.thermistor_max_temperature
        - ExternalTempConfigs.thermistor_beta
        - ExternalTempConfigs.thermistor_r0
        - ExternalTempConfigs.temp_sensor_required
    ...
    @final
    def with_custom_brushless_motor(self, new_custom_brushless_motor: CustomBrushlessMotorConfigs) -> 'TalonFXSConfiguration':
        """
        Modifies this configuration's custom_brushless_motor parameter and returns itself for
        method-chaining and easier to use config API.
        ...
        :param new_custom_brushless_motor: Parameter to modify
        :type new_custom_brushless_motor: CustomBrushlessMotorConfigs
        :returns: Itself
        :rtype: TalonFXSConfiguration
        """
        self.custom_brushless_motor = new_custom_brushless_motor
        return self
    
    @final
    def with_external_temp(self, new_external_temp: ExternalTempConfigs) -> 'TalonFXSConfiguration':
        """
        Modifies this configuration's external_temp parameter and returns itself for
        method-chaining and easier to use config API.
        ...
        :param new_external_temp: Parameter to modify
        :type new_external_temp: ExternalTempConfigs
        :returns: Itself
        :rtype: TalonFXSConfiguration
        """
        self.external_temp = new_external_temp
        return self
    ...
    def __str__(self) -> str:
        ...
        ss.append(str(self.custom_brushless_motor))
        ss.append(str(self.external_temp))
    ...
    def serialize(self) -> str:
        ...
        ss.append(self.custom_brushless_motor.serialize())
        ss.append(self.external_temp.serialize())
    ...
    def deserialize(self, to_deserialize: str) -> StatusCode:
        ...
        err = self.custom_brushless_motor.deserialize(to_deserialize)
        err = self.external_temp.deserialize(to_deserialize)
...
class TalonFXSConfigurator(ParentConfigurator):
    ...
    This handles applying and refreshing the configurations for TalonFXS.
    """
    ...
    @overload
    def refresh(self, configs: TalonFXSConfiguration, timeout_seconds: second = 0.100) -> StatusCode:
        """
        ...
        :type configs: TalonFXSConfiguration
    ...
    @overload
    def apply(self, configs: TalonFXSConfiguration, timeout_seconds: second = 0.100) -> StatusCode:
        """
    ...
    @overload
    def refresh(self, configs: ExternalFeedbackConfigs, timeout_seconds: second = 0.100) -> StatusCode:
        """
        Refreshes the values of the specified config group.
        ...
        :param configs: The configs to refresh
        :type configs: ExternalFeedbackConfigs
        :param timeout_seconds: Maximum amount of time to wait when performing configuration
        :type timeout_seconds: second
        :returns: StatusCode of refreshing the configs
        :rtype: StatusCode
    ...
    @overload
    def apply(self, configs: ExternalFeedbackConfigs, timeout_seconds: second = 0.100) -> StatusCode:
        """
        Applies the contents of the specified config to the device.
    ...
    @overload
    def refresh(self, configs: CommutationConfigs, timeout_seconds: second = 0.100) -> StatusCode:
        """
        Refreshes the values of the specified config group.
        ...
        :param configs: The configs to refresh
        :type configs: CommutationConfigs
        :param timeout_seconds: Maximum amount of time to wait when performing configuration
        :type timeout_seconds: second
        :returns: StatusCode of refreshing the configs
        :rtype: StatusCode
    ...
    @overload
    def apply(self, configs: CommutationConfigs, timeout_seconds: second = 0.100) -> StatusCode:
        """
        Applies the contents of the specified config to the device.
    ...
    @overload
    def refresh(self, configs: CustomBrushlessMotorConfigs, timeout_seconds: second = 0.100) -> StatusCode:
        """
        Refreshes the values of the specified config group.
        ...
        :param configs: The configs to refresh
        :type configs: CustomBrushlessMotorConfigs
        :param timeout_seconds: Maximum amount of time to wait when performing configuration
        :type timeout_seconds: second
        :returns: StatusCode of refreshing the configs
        :rtype: StatusCode
    ...
    @overload
    def apply(self, configs: CustomBrushlessMotorConfigs, timeout_seconds: second = 0.100) -> StatusCode:
        """
        Applies the contents of the specified config to the device.
    ...
    @overload
    def refresh(self, configs: ExternalTempConfigs, timeout_seconds: second = 0.100) -> StatusCode:
        """
        Refreshes the values of the specified config group.
        ...
        :param configs: The configs to refresh
        :type configs: ExternalTempConfigs
        :param timeout_seconds: Maximum amount of time to wait when performing configuration
        :type timeout_seconds: second
        :returns: StatusCode of refreshing the configs
        :rtype: StatusCode
    ...
    @overload
    def apply(self, configs: ExternalTempConfigs, timeout_seconds: second = 0.100) -> StatusCode:
        """
        Applies the contents of the specified config to the device.
    ...
    def clear_sticky_fault_motor_arrangement_not_selected(self, timeout_seconds: second = 0.100) -> StatusCode:
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(SpnValue.CLEAR_STICKY_FAULT_TALONFX_MOTOR_ARRANGEMENT_NOT_SELECTED.value, 0, ctypes.byref(value))
        if value.value is not None:
            serialized = str(value.value, encoding='utf-8')
            Native.instance().c_ctre_phoenix6_free_memory(ctypes.byref(value))
        else:
