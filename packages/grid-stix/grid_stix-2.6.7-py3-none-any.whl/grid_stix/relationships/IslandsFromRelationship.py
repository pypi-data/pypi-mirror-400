"""
Relationship indicating that a microgrid can disconnect and operate independently from the main grid.
...
class IslandsFromRelationship(GridSTIXRelationshipObject):
    """
    Relationship indicating that a microgrid can disconnect and operate independently from the main grid.
    ...
    _type = "x-grid-islands-from-relationship"
    ...
    _properties = OrderedDict(
        [
            ...
            ("x_islanding_duration_seconds", ListProperty(IntegerProperty())),
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize IslandsFromRelationship with Grid-STIX properties."""
