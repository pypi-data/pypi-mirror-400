    ...
    def make_instance(self, include_optional) -> GetAvailableRoomTypesResponse:
        ...
        if include_optional:
            return GetAvailableRoomTypesResponse(
                success = True,
                data = [
                    cloudbeds_pms_v1_3.models.get_available_room_types_response_data_inner.GetAvailableRoomTypesResponse_data_inner(
                        property_id = '', 
                        property_currency = [
                        ...
                        property_rooms = [
                            cloudbeds_pms_v1_3.models.get_available_room_types_response_data_inner_property_rooms_inner.GetAvailableRoomTypesResponse_data_inner_propertyRooms_inner(
                                room_type_id = '', 
                                room_type_name = '', 
                                ...
                                room_rate_detailed = [
                                    cloudbeds_pms_v1_3.models.get_available_room_types_response_data_inner_property_rooms_inner_room_rate_detailed_inner.GetAvailableRoomTypesResponse_data_inner_propertyRooms_inner_roomRateDetailed_inner(
                                ...
                                derived_value = 1.337, 
                                individual_rooms = [
                                    cloudbeds_pms_v1_3.models.get_available_room_types_response_data_inner_property_rooms_inner_individual_rooms_inner.GetAvailableRoomTypesResponse_data_inner_propertyRooms_inner_individualRooms_inner(
                                        room_id = '', 
                                        room_name = 1.337, 
                                        dorm_room_name = '', )
                                    ], )
