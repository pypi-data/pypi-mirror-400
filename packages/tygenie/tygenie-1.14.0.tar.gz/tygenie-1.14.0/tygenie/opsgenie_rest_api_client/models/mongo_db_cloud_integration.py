...
T = TypeVar("T", bound="MongoDBCloudIntegration")
...
class MongoDBCloudIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        mongo_db_cloud_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        mongo_db_cloud_integration.additional_properties = d
        return mongo_db_cloud_integration
