...
VALID_BODY_IGNORE_SIGNING_ERRORS: Literal[{"description": "Allow use of FortiGate images that are unsigned", "help": "Allow use of FortiGate images that are unsigned.", "label": "Enable", "name": "enable"}, {"description": "Reject use of FortiGate images that are unsigned", "help": "Reject use of FortiGate images that are unsigned.", "label": "Disable", "name": "disable"}]
