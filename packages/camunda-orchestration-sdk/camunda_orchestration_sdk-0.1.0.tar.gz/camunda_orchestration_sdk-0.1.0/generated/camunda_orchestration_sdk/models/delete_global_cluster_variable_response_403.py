...
T = TypeVar("T", bound="DeleteGlobalClusterVariableResponse403")


@_attrs_define
class DeleteGlobalClusterVariableResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_global_cluster_variable_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_global_cluster_variable_response_403.additional_properties = d
        return delete_global_cluster_variable_response_403
