...
T = TypeVar("T", bound="DeleteProcessInstancesBatchOperationResponse401")


@_attrs_define
class DeleteProcessInstancesBatchOperationResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_process_instances_batch_operation_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_process_instances_batch_operation_response_401.additional_properties = d
        return delete_process_instances_batch_operation_response_401
