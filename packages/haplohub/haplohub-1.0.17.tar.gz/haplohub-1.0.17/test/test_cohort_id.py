...
from haplohub.models.cohort_id import CohortId  # noqa: E501


class TestCohortId(unittest.TestCase):
    """CohortId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CohortId:
        """Test CohortId
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CohortId`
        """
        model = CohortId()  # noqa: E501
        if include_optional:
            return CohortId(
            )
        else:
