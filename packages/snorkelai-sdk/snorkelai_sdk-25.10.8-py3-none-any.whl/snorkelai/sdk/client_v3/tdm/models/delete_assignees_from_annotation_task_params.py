...
T = TypeVar("T", bound="DeleteAssigneesFromAnnotationTaskParams")


@attrs.define
class DeleteAssigneesFromAnnotationTaskParams:
    """Request model for removing assignees from datapoints.

    Attributes:
        user_uids (List[int]): List of user UIDs to remove from datapoints
