# Orrin SDK v0.0.5
The Orrrin SDK v0.0.5 is the first revolution of the Orrin SDK, and brings forth a simple Python decorator for developers creating small-scale apps to be deployed on the Orrin platform.
