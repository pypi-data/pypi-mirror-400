...
from pytket.utils.operators import QubitPauliOperator  # noqa: TC002
...
class GeneralState:
    ...
    def expectation_value(
        ...
        for pstr, coeff in operator.get_dict().items():
            ...
            this_pauli_string = "".join(map(lambda x: paulis[x], pauli_list))  # type: ignore  # noqa: C417
...
class GeneralBraOpKet:
    ...
    def contract(
        ...
        if operator is None:
            ...
            for tk_pstr, coeff in operator.get_dict().items():
