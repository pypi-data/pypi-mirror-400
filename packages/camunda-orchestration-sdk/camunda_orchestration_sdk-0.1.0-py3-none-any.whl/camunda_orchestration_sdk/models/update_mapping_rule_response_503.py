...
T = TypeVar("T", bound="UpdateMappingRuleResponse503")


@_attrs_define
class UpdateMappingRuleResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_mapping_rule_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        update_mapping_rule_response_503.additional_properties = d
        return update_mapping_rule_response_503
