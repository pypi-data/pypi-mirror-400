...
Passive but accessible: Studied information is not actively stored in working memory, yet attended regardless of anticipated load (OpenNeuro ``ds007081``). Access recordings and metadata through EEGDash.
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds007081.v1.0.0 <https://doi.org/10.18112/openneuro.ds007081.v1.0.0>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds007081>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds007081>`__
...
.. grid:: 1 2 3 3
   ...
   .. grid-item-card:: Provenance
      ...
      - Source: openneuro
      - OpenNeuro: `ds007081 <https://openneuro.org/datasets/ds007081>`__
      - NeMAR: `ds007081 <https://nemar.org/dataexplorer/detail?dataset_id=ds007081>`__
...
.. autoclass:: eegdash.dataset.DS007081
...
* :mod:`eegdash.dataset`
* `OpenNeuro dataset page <https://openneuro.org/datasets/ds007081>`__
* `NeMAR dataset page <https://nemar.org/dataexplorer/detail?dataset_id=ds007081>`__
