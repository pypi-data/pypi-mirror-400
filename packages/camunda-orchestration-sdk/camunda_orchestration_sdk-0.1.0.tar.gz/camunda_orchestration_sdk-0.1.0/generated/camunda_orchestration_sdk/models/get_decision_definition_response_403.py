...
T = TypeVar("T", bound="GetDecisionDefinitionResponse403")


@_attrs_define
class GetDecisionDefinitionResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_decision_definition_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_decision_definition_response_403.additional_properties = d
        return get_decision_definition_response_403
