...
T = TypeVar("T", bound="ApimetricsIntegration")


@_attrs_define
class ApimetricsIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        apimetrics_integration.additional_properties = d
        return apimetrics_integration
