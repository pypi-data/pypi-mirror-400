...
T = TypeVar("T", bound="GetProcessDefinitionInstanceStatisticsResponse401")


@_attrs_define
class GetProcessDefinitionInstanceStatisticsResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_process_definition_instance_statistics_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_process_definition_instance_statistics_response_401.additional_properties = d
        return get_process_definition_instance_statistics_response_401
