"""
Monitoring system used for nuclear safeguards verification and material control.
...
class SafeguardsSystem(GridSTIXDomainObject):
    """
    Monitoring system used for nuclear safeguards verification and material control.
    ...
    _properties = OrderedDict(
        [
            ...
            ("x_monitors_material", ListProperty(StringProperty())),
        ]
    )

    def __init__(self, **kwargs: Any) -> None:
        """Initialize SafeguardsSystem with Grid-STIX properties."""
