...
class LISWET12(_AbstractLISWET):
    """LISWET12 - Li and Swetits k-convex approximation problem.
    ...
    def _g_function(self, t):
        """The g(t) function for LISWET12: g(t) = cos(4π*t)."""
        return jnp.cos(4.0 * jnp.pi * t)
