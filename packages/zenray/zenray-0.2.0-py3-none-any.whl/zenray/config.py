...
- ZENRAY_ENDPOINT: Server endpoint (default: https://api.zenray.live)
...
@dataclass
class XRayConfig:
    endpoint: str = "https://api.zenray.live"
...
def init(
    ...
    **kwargs,
    ...
    _endpoint = endpoint or _get_env("ENDPOINT", "https://api.zenray.live")
