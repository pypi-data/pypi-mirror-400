"""A0NNDNDL quadratic programming problem.
...
_DATA_PATH = Path(__file__).parent / "data" / "a0nndndl_full.npz"
...
_LOWER = jnp.array(_PROBLEM_DATA["lower"][:60012], dtype=jnp.float64)
...
class A0NNDNDL(AbstractConstrainedQuadraticProblem):
    """A0NNDNDL quadratic programming problem.
