...
## References
- Autodiff Modes: `docs/archive_tr/topics/03_autodiff_modes.md`.
- Layers & Variants: `docs/archive_tr/topics/04_layers.md`.
- Training Policies: `docs/archive_tr/topics/05_training_policies.md`.
- Sampling & Curriculum: `docs/archive_tr/topics/06_sampling_curriculum.md`.
- Evaluation & Metrics: `docs/archive_tr/topics/07_evaluation_metrics.md`.
