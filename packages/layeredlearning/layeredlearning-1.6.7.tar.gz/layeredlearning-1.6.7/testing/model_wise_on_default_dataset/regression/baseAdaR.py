...
from layerlearn.baseAdaR import AdaBoostRegressor, AdaCatRegressor, AdaGradientRegressor, AdaLightRegressor, AdaXGBRegressor, AdaForestRegressor, AdaSupportRegressor, AdaLinearRegressor, AdaKNNRegressor
import warnings
...
models = {
    "Ada Forest Regressor": AdaForestRegressor(),
    "Ada Support Regressor": AdaSupportRegressor(),
    "Ada Linear Regressor": AdaLinearRegressor(),
    "Ada KNN Regressor": AdaKNNRegressor(),
    "Ada XGBoost Regressor": AdaXGBRegressor(),
    "Ada CatBoost Regressor": AdaCatRegressor(),
    "Ada Gradient Boosting Regressor": AdaGradientRegressor(),
    "Ada AdaBoost Regressor": AdaBoostRegressor(),
    "Ada LightGBM Regressor": AdaLightRegressor(),
}
...
ax.set_title('Comparison of Ada Model Regression Performance', fontsize=18, fontweight='bold')
