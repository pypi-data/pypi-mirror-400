...
class DecisionManager:
    ...
    def _maybe_capture_execution_decision(
        ...
        try:
            ...
            if not span_kind or span_kind not in ["llm", "rag", "tool", "select", "retrieval"]:
                print(f"[Nora] ⏭️  Skipping decision: span_kind '{span_kind}' not in [llm, rag, tool, select, retrieval]")
                return
