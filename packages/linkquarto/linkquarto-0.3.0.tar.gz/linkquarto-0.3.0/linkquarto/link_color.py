...
def bar_bivariee(x, y, xlab, ylab, titre, couleurs):
    ...
    graf = sns.countplot(x = x, hue= y,  palette=couleurs)
...
def cramers_v(var1, var2):
    cm = confusion_matrix(var1, var2)
    """
    Calcule le coefficient de contingence (V de Cramer) pour un tableau de contingence.
    
    Args:
        var1 et var2
        confusion_matrix (numpy.ndarray): Tableau de contingence.
    
    Returns:
        float: Coefficient de contingence (V de Cramer).
    """
