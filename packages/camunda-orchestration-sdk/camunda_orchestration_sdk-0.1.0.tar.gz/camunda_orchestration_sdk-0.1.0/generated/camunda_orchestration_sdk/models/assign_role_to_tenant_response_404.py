...
T = TypeVar("T", bound="AssignRoleToTenantResponse404")


@_attrs_define
class AssignRoleToTenantResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assign_role_to_tenant_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        assign_role_to_tenant_response_404.additional_properties = d
        return assign_role_to_tenant_response_404
