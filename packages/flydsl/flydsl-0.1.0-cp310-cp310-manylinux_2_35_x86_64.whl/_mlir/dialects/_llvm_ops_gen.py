...
def intr_acos(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def ashr(lhs, rhs, *, is_exact=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_asin(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_atan2(a, b, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_atan(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def add(lhs, rhs, overflow_flags, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def and_(lhs, rhs, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_annotation(integer, annotation, file_name, line, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def cmpxchg(ptr, cmp, val, success_ordering, failure_ordering, *, syncscope=None, alignment=None, weak=None, volatile_=None, access_groups=None, alias_scopes=None, noalias_scopes=None, tbaa=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def atomicrmw(bin_op, ptr, val, ordering, *, syncscope=None, alignment=None, volatile_=None, access_groups=None, alias_scopes=None, noalias_scopes=None, tbaa=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_bitreverse(in_, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_bswap(in_, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
  ...
  def __init__(self, result, callee_operands, op_bundle_operands, op_bundle_sizes, *, var_callee_type=None, callee=None, fastmathFlags=None, CConv=None, TailCallKind=None, memory_effects=None, convergent=None, no_unwind=None, will_return=None, op_bundle_tags=None, arg_attrs=None, res_attrs=None, no_inline=None, always_inline=None, inline_hint=None, access_groups=None, alias_scopes=None, noalias_scopes=None, tbaa=None, loc=None, ip=None):
    ...
    if var_callee_type is not None: attributes["var_callee_type"] = (var_callee_type if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_973')) else
          _ods_ir.AttrBuilder.get('anonymous_973')(var_callee_type, context=_ods_context))
...
def intr_copysign(a, b, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_cos(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_cosh(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_ctlz(in_, is_zero_poison, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_cttz(in_, is_zero_poison, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_ctpop(in_, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_exp2(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_exp10(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_exp(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_expect(val, expected, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_expect_with_probability(val, expected, prob, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def extractelement(vector, position, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_fabs(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def fadd(lhs, rhs, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_ceil(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def fcmp(predicate, lhs, rhs, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def fdiv(lhs, rhs, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_floor(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_fma(a, b, c, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_fmuladd(a, b, c, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def fmul(lhs, rhs, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def fneg(operand, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def frem(lhs, rhs, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def fsub(lhs, rhs, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_trunc(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def freeze(val, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_fshl(a, b, c, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_fshr(a, b, c, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
class GlobalOp(_ods_ir.OpView):
  ...
  def target_specific_attrs(self, value):
    if value is not None:
...
def mlir_global(global_type, sym_name, linkage, *, constant=None, dso_local=None, thread_local_=None, externally_initialized=None, value=None, alignment=None, addr_space=None, unnamed_addr=None, section=None, comdat=None, dbg_exprs=None, visibility_=None, target_specific_attrs=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def icmp(predicate, lhs, rhs, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def insertelement(vector, value, position, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def insertvalue(container, value, position, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_invariant_start(size, ptr, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_is_constant(val, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
class LLVMFuncOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, function_type, *, sym_visibility=None, linkage=None, dso_local=None, CConv=None, comdat=None, convergent=None, personality=None, garbageCollector=None, passthrough=None, arg_attrs=None, res_attrs=None, function_entry_count=None, memory_effects=None, visibility_=None, arm_streaming=None, arm_locally_streaming=None, arm_streaming_compatible=None, arm_new_za=None, arm_in_za=None, arm_out_za=None, arm_inout_za=None, arm_preserves_za=None, section=None, unnamed_addr=None, alignment=None, vscale_range=None, frame_pointer=None, target_cpu=None, tune_cpu=None, reciprocal_estimates=None, prefer_vector_width=None, target_features=None, unsafe_fp_math=None, no_infs_fp_math=None, no_nans_fp_math=None, no_signed_zeros_fp_math=None, denormal_fp_math=None, denormal_fp_math_f32=None, fp_contract=None, instrument_function_entry=None, instrument_function_exit=None, no_inline=None, always_inline=None, no_unwind=None, will_return=None, optimize_none=None, vec_type_hint=None, work_group_size_hint=None, reqd_work_group_size=None, intel_reqd_sub_group_size=None, uwtable_kind=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_973')) else
      _ods_ir.AttrBuilder.get('anonymous_973')(function_type, context=_ods_context))
...
def lshr(lhs, rhs, *, is_exact=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_launder_invariant_group(ptr, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_log2(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_log10(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_log(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_masked_load(res, data, mask, alignment, *, pass_thru=None, nontemporal=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_maxnum(a, b, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_maximum(a, b, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_minnum(a, b, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_minimum(a, b, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def mul(lhs, rhs, overflow_flags, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_nearbyint(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def mlir_none(*, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def or_(lhs, rhs, *, is_disjoint=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_pow(a, b, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_ptr_annotation(ptr, annotation, file_name, line, attr, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_ptrmask(ptr, mask, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_rint(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_roundeven(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_round(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_sadd_sat(a, b, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def sdiv(lhs, rhs, *, is_exact=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_smax(a, b, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_smin(a, b, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def srem(lhs, rhs, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_ssa_copy(operand, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_sshl_sat(a, b, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_ssub_sat(a, b, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def select(condition, true_value, false_value, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def shl(lhs, rhs, overflow_flags, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_sin(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_sinh(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_sqrt(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_strip_invariant_group(ptr, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def sub(lhs, rhs, overflow_flags, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_tan(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_tanh(in_, *, fastmath_flags=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_uadd_sat(a, b, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def udiv(lhs, rhs, *, is_exact=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_umax(a, b, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_umin(a, b, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def urem(lhs, rhs, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_ushl_sat(a, b, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_usub_sat(a, b, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def xor(lhs, rhs, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_masked_compressstore(value, ptr, mask, *, arg_attrs=None, res_attrs=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def intr_masked_expandload(res, ptr, mask, passthru, *, arg_attrs=None, res_attrs=None, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_vector_insert(dstvec, srcvec, pos, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
