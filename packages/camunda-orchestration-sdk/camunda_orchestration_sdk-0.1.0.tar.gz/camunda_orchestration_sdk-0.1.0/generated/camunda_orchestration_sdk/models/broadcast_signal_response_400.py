...
T = TypeVar("T", bound="BroadcastSignalResponse400")


@_attrs_define
class BroadcastSignalResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        broadcast_signal_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        broadcast_signal_response_400.additional_properties = d
        return broadcast_signal_response_400
