...
T = TypeVar("T", bound="GetGlobalClusterVariableResponse404")


@_attrs_define
class GetGlobalClusterVariableResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_global_cluster_variable_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_global_cluster_variable_response_404.additional_properties = d
        return get_global_cluster_variable_response_404
