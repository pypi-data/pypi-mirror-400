...
from layerlearn.baseKNNR import KNNAdaRegressor, KNNCatRegressor, KNNDecisionRegressor, KNNGradientRegressor, KNNLinearRegressor, KNNSupportRegressor, KNNXGBRegressor, KNNLightRegressor, KNNForestRegressor
import warnings
...
models = {
    "KNN Decision Regressor": KNNDecisionRegressor(),
    "KNN Forest Regressor": KNNForestRegressor(),
    "KNN Support Regressor": KNNSupportRegressor(),
    "KNN Linear Regressor": KNNLinearRegressor(),
    "KNN XGBoost Regressor": KNNXGBRegressor(),
    "KNN CatBoost Regressor": KNNCatRegressor(),
    "KNN Gradient Boosting Regressor": KNNGradientRegressor(),
    "KNN AdaBoost Regressor": KNNAdaRegressor(),
    "KNN LightGBM Regressor": KNNLightRegressor(),
}
...
ax.set_title('Comparison of KNN Model Regression Performance', fontsize=18, fontweight='bold')
