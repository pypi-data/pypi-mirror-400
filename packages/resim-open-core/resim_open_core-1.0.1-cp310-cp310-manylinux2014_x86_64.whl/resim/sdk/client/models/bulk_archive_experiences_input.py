...
T = TypeVar("T", bound="BulkArchiveExperiencesInput")



@_attrs_define
class BulkArchiveExperiencesInput:
    """ 
        Attributes:
            experience_i_ds (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.experience_filter_input import ExperienceFilterInput
        d = dict(src_dict)
        experience_i_ds = cast(list[str], d.pop("experienceIDs"))
        ...
        bulk_archive_experiences_input = cls(
        ...
        bulk_archive_experiences_input.additional_properties = d
        return bulk_archive_experiences_input
