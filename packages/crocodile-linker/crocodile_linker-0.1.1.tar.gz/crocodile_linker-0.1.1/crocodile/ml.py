...
class MLWorker:
    ...
    def load_ml_model(self) -> "Model":
        ...
        try:
            model_ref = resources.files("crocodile").joinpath("models", "default.h5")
            with resources.as_file(model_ref) as model_path:
                return load_model(model_path)
        except Exception:
            fallback_path = os.path.join(PROJECT_ROOT, "crocodile", "models", "default.h5")
