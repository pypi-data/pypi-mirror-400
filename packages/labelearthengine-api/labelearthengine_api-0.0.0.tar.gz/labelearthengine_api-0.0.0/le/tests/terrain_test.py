...
class TerrainTest(apitestcase.ApiTestCase):
  ...
  def test_aspect(self):
    ...
    expression = le.Terrain.aspect(IMAGE_1)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Terrain.aspect(input=IMAGE_1)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_fill_minima(self):
    ...
    expression = le.Terrain.fillMinima(IMAGE_1, border_value, neighborhood)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Terrain.fillMinima(
  ...
  def test_hill_shadow(self):
    ...
    expression = le.Terrain.hillShadow(
  ...
  def test_hillshade(self):
    ...
    expression = le.Terrain.hillshade(IMAGE_1, azimuth, elevation)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Terrain.hillshade(
  ...
  def test_products(self):
    ...
    expression = le.Terrain.products(IMAGE_1)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Terrain.products(input=IMAGE_1)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_slope(self):
    ...
    expression = le.Terrain.slope(IMAGE_1)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Terrain.slope(input=IMAGE_1)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
