...
from xladmin.util import static, json, vendor, sortkeypicker

from xladmin.models import Log
...
class BaseAdminView(BaseAdminObject, View):
    ...
    base_template = 'xladmin/base.html'
...
class CommAdminView(BaseAdminView):
    ...
    base_template = 'xladmin/base_site.html'
    menu_template = 'xladmin/includes/sitemenu_default.html'
...
class ModelAdminView(CommAdminView):
    ...
    def get_template_list(self, template_name):
        ...
        return (
            ...
            "xladmin/%s/%s" % (opts.app_label, template_name),
            "xladmin/%s" % template_name,
        )
