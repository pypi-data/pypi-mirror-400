...
T = TypeVar("T", bound="UnassignMappingRuleFromGroupResponse400")


@_attrs_define
class UnassignMappingRuleFromGroupResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unassign_mapping_rule_from_group_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        unassign_mapping_rule_from_group_response_400.additional_properties = d
        return unassign_mapping_rule_from_group_response_400
