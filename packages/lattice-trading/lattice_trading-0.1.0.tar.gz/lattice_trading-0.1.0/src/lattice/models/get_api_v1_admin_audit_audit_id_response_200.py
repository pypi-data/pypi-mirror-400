...
if TYPE_CHECKING:
    from ..models.get_api_v1_admin_audit_audit_id_response_200_changes_type_0 import (
        GetApiV1AdminAuditAuditIdResponse200ChangesType0,
    )


T = TypeVar("T", bound="GetApiV1AdminAuditAuditIdResponse200")


@_attrs_define
class GetApiV1AdminAuditAuditIdResponse200:
    """
    Attributes:
        id (str):
        tenant_id (str):
        ...
        changes (Union['GetApiV1AdminAuditAuditIdResponse200ChangesType0', None]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.changes, GetApiV1AdminAuditAuditIdResponse200ChangesType0):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_changes(data: object) -> Union["GetApiV1AdminAuditAuditIdResponse200ChangesType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                changes_type_0 = GetApiV1AdminAuditAuditIdResponse200ChangesType0.from_dict(data)

                return changes_type_0
            except:  # noqa: E722
                pass
            return cast(Union["GetApiV1AdminAuditAuditIdResponse200ChangesType0", None], data)
        ...
        get_api_v1_admin_audit_audit_id_response_200 = cls(
            id=id,
            tenant_id=tenant_id,
        ...
        return get_api_v1_admin_audit_audit_id_response_200
