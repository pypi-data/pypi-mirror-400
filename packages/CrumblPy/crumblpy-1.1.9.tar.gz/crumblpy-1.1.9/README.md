...
> ℹ️ **AWSToolKit users**: Install the [AWS CLI](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html) before using the AWS tooling in `CrumblPy`.
---
...
> ℹ️ **Prerequisite**: Install the [AWS CLI](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html) before using `AWSToolKit`.
