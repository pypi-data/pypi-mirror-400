...
inline
void CPad_Base::C_Attlist::SetWith(CPad_Base::C_Attlist::TWith&& value)
{
    m_With = std::forward<CPad_Base::C_Attlist::TWith>(value);
    m_set_State[0] |= 0x3;
}
...
inline
void CPad_Base::C_Attlist::SetWidth(CPad_Base::C_Attlist::TWidth&& value)
{
    m_Width = std::forward<CPad_Base::C_Attlist::TWidth>(value);
    m_set_State[0] |= 0xc;
}
