...
VALID_COMMANDS = ["version", "init", "debug", "deploy", "reset", "package"]
...
FIVETRAN_NAMING_ENV = "FIVETRAN_NAMING" #Env Var name for setting naming strategy
FIVETRAN_NAMING_VALUE = "FIVETRAN" # Fivetran naming strategy prompt for args
SOURCE_NAMING_VALUE = "SOURCE" # Source naming strategy prompt for args
