...
class KIRBY2(AbstractNonlinearEquations):
    ...
    def starting_point(self, y0_id: int = 0) -> Array:
        ...
        if y0_id == 0:
            # START1
            return jnp.array([2.0, -0.1, 0.003, -0.001, 0.00001])
        elif y0_id == 1:
            # START2
            return jnp.array([1.5, -0.15, 0.0025, -0.0015, 0.00002])
        else:
    ...
    def residual(self, y: Array, args) -> Array:
        ...
        Args:
            y: Array of shape (5,) containing [b1, b2, b3, b4, b5]
            args: Additional arguments (unused)

        Returns:
            Array of shape (151,) containing the residuals
        """
