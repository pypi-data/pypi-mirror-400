...
def summary_description(context: dict[str, Any]) -> list[Message]:
    ...
    return [
        Message(
            role='system',
            content='You are a helpful assistant that creates short, concise names for content summaries.',
        ),
        Message(
            role='user',
            content=f"""
        Create a short, concise name (3-8 words) that represents the main topic or theme of the summary.
        The name should be descriptive but brief, suitable for use as a community or group title.
        Avoid long descriptive sentences - focus on creating a clear, memorable name.
