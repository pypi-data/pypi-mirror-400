...
@final
class Diff_TorqueCurrentFOC_Open:
    """
    Requires Phoenix Pro and CANivore;
    Differential control with torque current average target and torque current
    difference target.
    ...
    def __init__(self, average_request: TorqueCurrentFOC, differential_request: TorqueCurrentFOC):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_TorqueCurrentFOC_Open"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_TorqueCurrentFOC_Open")
    ...
    def with_average_request(self, new_average_request: TorqueCurrentFOC) -> 'Diff_TorqueCurrentFOC_Open':
        ...
        :returns: Itself
        :rtype: Diff_TorqueCurrentFOC_Open
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: TorqueCurrentFOC) -> 'Diff_TorqueCurrentFOC_Open':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_TorqueCurrentFOC_Open':
        """
