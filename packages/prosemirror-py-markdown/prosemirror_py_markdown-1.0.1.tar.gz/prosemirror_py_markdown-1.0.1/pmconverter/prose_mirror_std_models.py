...
register_node_class("task_list", TaskList)
...
class TaskItem(CommonSimpleNode):
    ...
    def convert_to_markdown(self, **kwargs) -> str:
        checked = self.get_attr("checked", False)
        checkbox = "[x] " if checked else "[ ] "
        content_md = CommonSimpleNode.convert_to_markdown(self, **kwargs)
        return f"{checkbox}{content_md}"


register_node_class("task_item", TaskItem)
