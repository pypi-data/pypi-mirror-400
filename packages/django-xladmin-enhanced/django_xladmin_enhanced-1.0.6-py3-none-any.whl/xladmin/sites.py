...
class AdminSite(object):
    ...
    def __init__(self, name='xladmin'):
        self.name = name
        self.app_name = 'xladmin'
    ...
    def register_modelview(self, path, admin_view_class, name):
        from xladmin.views.base import BaseAdminView
    ...
    def register_plugin(self, plugin_class, admin_view_class):
        from xladmin.views.base import BaseAdminPlugin
    ...
    def get_plugins(self, admin_view_class, *option_classes):
        from xladmin.views import BaseAdminView
        plugins = []
