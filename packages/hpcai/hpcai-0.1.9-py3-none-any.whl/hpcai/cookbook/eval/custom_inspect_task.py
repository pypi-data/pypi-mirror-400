...
python -m hpcai.cookbook.eval.run_inspect_evals \
    model_path=hpcai://your-model-path \
    tasks=hpcai.cookbook.eval.custom_inspect_task:example_lm_as_judge \
...
from hpcai.cookbook.eval.inspect_utils import InspectAPIFromTinkerSampling
