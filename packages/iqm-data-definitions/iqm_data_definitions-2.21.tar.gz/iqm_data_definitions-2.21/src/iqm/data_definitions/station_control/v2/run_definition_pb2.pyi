...
import iqm.data_definitions.common.v1.struct_pb2
...
class RunDefinition(google.protobuf.message.Message):
    ...
    SWEEP_DEFINITION_PAYLOAD_FIELD_NUMBER: builtins.int
    run_id: builtins.str
    ...
    @property
    def options(self) -> iqm.data_definitions.common.v1.struct_pb2.Struct:
        """Experiment-specific options or toggles that generated the run."""

    @property
    def additional_run_properties(self) -> iqm.data_definitions.common.v1.struct_pb2.Struct:
    ...
    def sweep_definition(self) -> iqm.data_definitions.station_control.v1.sweep_request_pb2.SweepRequest:
        """The instructions required to perform a sweep. DEPRECATED."""

    @property
    def sweep_definition_payload(self) -> google.protobuf.any_pb2.Any:
        """The instructions required to perform a sweep, as binary. Should be used instead of sweep_definition.
        We don't want to deserialize the sweep definition unnecessarily when we only need the run-exclusive data.
        """
    ...
    def __init__(
        ...
        *,
        ...
        experiment_name: builtins.str = ...,
        experiment_label: builtins.str = ...,
        options: iqm.data_definitions.common.v1.struct_pb2.Struct | None = ...,
        additional_run_properties: iqm.data_definitions.common.v1.struct_pb2.Struct | None = ...,
        software_version_set_id: builtins.int = ...,
        ...
        sweep_definition_payload: google.protobuf.any_pb2.Any | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["additional_run_properties", b"additional_run_properties", "options", b"options", "sweep_definition", b"sweep_definition", "sweep_definition_payload", b"sweep_definition_payload"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["additional_run_properties", b"additional_run_properties", "components", b"components", "default_data_parameters", b"default_data_parameters", "default_sweep_parameters", b"default_sweep_parameters", "experiment_label", b"experiment_label", "experiment_name", b"experiment_name", "hard_sweeps", b"hard_sweeps", "options", b"options", "run_id", b"run_id", "software_version_set_id", b"software_version_set_id", "sweep_definition", b"sweep_definition", "sweep_definition_payload", b"sweep_definition_payload", "username", b"username"]) -> None: ...
