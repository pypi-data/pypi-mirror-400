...
class OverrideSettingPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    use_management_vdom: NotRequired[Literal[{"description": "Enable use of management VDOM as source VDOM", "help": "Enable use of management VDOM as source VDOM.", "label": "Enable", "name": "enable"}, {"description": "Use the current VDOM as source VDOM", "help": "Use the current VDOM as source VDOM.", "label": "Disable", "name": "disable"}]]  # Enable/disable use of management VDOM as source VDOM for log
...
class OverrideSetting:
    ...
    def post(
        ...
        use_management_vdom: Literal[{"description": "Enable use of management VDOM as source VDOM", "help": "Enable use of management VDOM as source VDOM.", "label": "Enable", "name": "enable"}, {"description": "Use the current VDOM as source VDOM", "help": "Use the current VDOM as source VDOM.", "label": "Disable", "name": "disable"}] | None = ...,
        port: int | None = ...,
