...
class UserOauthToken(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "username", "token", "refreshToken", "expiryDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserOauthToken from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserOauthToken from a dict"""
        if obj is None:
            return None
