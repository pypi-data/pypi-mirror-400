...
T = TypeVar("T", bound="CorrelateMessageResponse500")


@_attrs_define
class CorrelateMessageResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        correlate_message_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        correlate_message_response_500.additional_properties = d
        return correlate_message_response_500
