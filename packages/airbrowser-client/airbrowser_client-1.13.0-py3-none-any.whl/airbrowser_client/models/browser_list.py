...
class BrowserList(BaseModel):
    ...
    data: Optional[BrowserListData] = Field(default=None, description="Browser list data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": BrowserListData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
