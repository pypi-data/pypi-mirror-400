...
class BriefResponseStub(BaseAPIModelStub):
    ...
    default_data = {
        ...
        "id": 54321,
        "links": {
            "brief": "http://localhost:8000/brief/1234",
            "self": "http://localhost:8000/brief-responses/54321",
            "supplier": "http://localhost:8000/supplier/1234",
        },
    ...
    def _make_brief_ids_consistent(self, **kwargs):
        ...
        self.response_data["links"]["brief"] = "http://localhost:8000/brief/{}".format(brief_id)
    ...
    def __init__(self, **kwargs):
        ...
        if kwargs.get("supplier_id") is not None:
            ...
            self.response_data["links"]["supplier"] = "http://localhost:8000/supplier/{}".format(supplier_id)
            del self.response_data["supplier_id"]
        if kwargs.get("id") is not None:
            self.response_data["links"]["self"] = "http://localhost:8000/brief-response/{}".format(kwargs.get("id"))
