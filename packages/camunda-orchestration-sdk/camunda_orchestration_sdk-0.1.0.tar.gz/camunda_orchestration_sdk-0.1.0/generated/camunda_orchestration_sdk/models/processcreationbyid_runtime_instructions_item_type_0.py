...
@_attrs_define
class ProcesscreationbyidRuntimeInstructionsItemType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        processcreationbyid_runtime_instructions_item_type_0 = cls(
            after_element_id=after_element_id,
            type_=type_,
        )

        processcreationbyid_runtime_instructions_item_type_0.additional_properties = d
        return processcreationbyid_runtime_instructions_item_type_0
