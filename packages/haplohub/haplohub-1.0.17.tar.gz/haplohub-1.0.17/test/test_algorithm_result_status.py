...
class TestAlgorithmResultStatus(unittest.TestCase):
    """AlgorithmResultStatus unit test stubs"""
    ...
    def testAlgorithmResultStatus(self):
        """Test AlgorithmResultStatus"""
        # inst = AlgorithmResultStatus()
