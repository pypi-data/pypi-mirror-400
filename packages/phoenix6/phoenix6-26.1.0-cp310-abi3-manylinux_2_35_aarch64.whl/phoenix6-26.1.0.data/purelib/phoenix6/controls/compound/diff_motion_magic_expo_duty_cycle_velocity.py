...
@final
class Diff_MotionMagicExpoDutyCycle_Velocity:
    """
    ...
    def __init__(self, average_request: MotionMagicExpoDutyCycle, differential_request: VelocityDutyCycle):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_MotionMagicExpoDutyCycle_Velocity"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicExpoDutyCycle_Velocity")
    ...
    def with_average_request(self, new_average_request: MotionMagicExpoDutyCycle) -> 'Diff_MotionMagicExpoDutyCycle_Velocity':
        ...
        :returns: Itself
        :rtype: Diff_MotionMagicExpoDutyCycle_Velocity
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: VelocityDutyCycle) -> 'Diff_MotionMagicExpoDutyCycle_Velocity':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicExpoDutyCycle_Velocity':
        """
