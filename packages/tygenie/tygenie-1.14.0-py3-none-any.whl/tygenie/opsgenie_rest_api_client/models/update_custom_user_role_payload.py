...
T = TypeVar("T", bound="UpdateCustomUserRolePayload")
...
class UpdateCustomUserRolePayload:
    """
    Attributes:
        name (Union[Unset, str]): Name of custom user role
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_custom_user_role_payload = cls(
            name=name,
        ...
        update_custom_user_role_payload.additional_properties = d
        return update_custom_user_role_payload
