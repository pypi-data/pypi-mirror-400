...
T = TypeVar("T", bound="DeleteMappingRuleResponse404")


@_attrs_define
class DeleteMappingRuleResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_mapping_rule_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_mapping_rule_response_404.additional_properties = d
        return delete_mapping_rule_response_404
