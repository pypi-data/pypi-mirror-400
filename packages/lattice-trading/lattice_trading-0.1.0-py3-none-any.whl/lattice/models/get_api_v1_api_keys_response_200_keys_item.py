...
from ..models.get_api_v1_api_keys_response_200_keys_item_scopes_item import GetApiV1ApiKeysResponse200KeysItemScopesItem

T = TypeVar("T", bound="GetApiV1ApiKeysResponse200KeysItem")


@_attrs_define
class GetApiV1ApiKeysResponse200KeysItem:
    """
    Attributes:
        id (str):
        name (str):
        key_prefix (str):
        scopes (List[GetApiV1ApiKeysResponse200KeysItemScopesItem]):
        status (str):
        is_active (bool):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for scopes_item_data in _scopes:
            scopes_item = GetApiV1ApiKeysResponse200KeysItemScopesItem(scopes_item_data)
        ...
        get_api_v1_api_keys_response_200_keys_item = cls(
            id=id,
            name=name,
        ...
        return get_api_v1_api_keys_response_200_keys_item
