"""
Union of all asset types: PhysicalAsset, GridComponent, and OTDevice
...
class UnionAllAssets(GridSTIXDomainObject):
    """
    Union of all asset types: PhysicalAsset, GridComponent, and OTDevice
    ...
    _properties = OrderedDict(
        [
            ...
            ("x_feeds_power_to", ListProperty(StringProperty())),
        ]
    )

    def __init__(self, **kwargs: Any) -> None:
        """Initialize UnionAllAssets with Grid-STIX properties."""
