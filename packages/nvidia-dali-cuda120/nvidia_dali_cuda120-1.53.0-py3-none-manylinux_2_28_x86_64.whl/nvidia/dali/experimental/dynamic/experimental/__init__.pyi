...
def audio_resample(
    ...
    *,
    ...
    in_rate: Union[TensorLikeArg, Batch, float, None] = None,
    out_length: Union[TensorLikeArg, Batch, int, None] = None,
    out_rate: Union[TensorLikeArg, Batch, float, None] = None,
    quality: Optional[float] = 50.0,
    scale: Union[TensorLikeArg, Batch, float, None] = None,
) -> Union[Tensor, Batch]:
    """
    .. warning::
...
def debayer(
    ...
    *,
    ...
    blue_position: Union[TensorLikeArg, Batch, Sequence[int], int],
) -> Union[Tensor, Batch]:
    """
    ...
    Args
    ----
    input : Tensor/Batch ('HW', 'HWC', 'FHW', 'FHWC')
    ...
    blue_position : int or list of int or Tensor/Batch of int
...
def dilate(
    ...
    *,
    ...
    anchor: Union[TensorLikeArg, Batch, Sequence[int], int, None] = [-1, -1],
    border_mode: Optional[str] = "constant",
    iterations: Optional[int] = 1,
    mask_size: Union[TensorLikeArg, Batch, Sequence[int], int, None] = [3, 3],
) -> Union[Tensor, Batch]:
    """
    ...
    Args
    ----
    input : Tensor/Batch ('HW', 'HWC', 'FHWC', 'CHW', 'FCHW')
...
@overload
def equalize(
    input: TensorLike, /, *, device: Optional[Literal["cpu", "gpu"]] = None
) -> Union[Tensor, Batch]:
    """
    ...
    Args
    ----
    input : Tensor/Batch ('HW', 'HWC', 'CHW', 'FHW', 'FHWC', 'FCHW')
        Input to the operator.
...
@overload
def equalize(
    input: TensorLike, /, *, device: Optional[Literal["cpu", "gpu"]] = None, batch_size: int
) -> Batch:
    """
    Performs grayscale/per-channel histogram equalization.
...
@overload
def equalize(input: Batch, /, *, device: Optional[Literal["cpu", "gpu"]] = None) -> Batch:
    """
    Performs grayscale/per-channel histogram equalization.
...
def filter(
    data: Batch,
    filter: Batch,
    fill_value: Optional[Batch] = None,
    /,
    *,
    device: Optional[Literal["cpu", "gpu"]] = None,
    anchor: Union[TensorLikeArg, Batch, Sequence[int], int, None] = [-1],
    ...
    fill_value : Tensor/Batch, optional
    ...
    Keyword args
    ------------
    anchor : int or list of int or Tensor/Batch of int, optional, default = `[-1]`
...
def filter(
    ...
    filter: Union[TensorLike, Batch],
    fill_value: Union[TensorLike, Batch, None] = None,
    /,
    *,
    device: Optional[Literal["cpu", "gpu"]] = None,
    anchor: Union[TensorLikeArg, Batch, Sequence[int], int, None] = [-1],
...
def inflate(
    ...
    *,
    ...
    chunk_offsets: Union[TensorLikeArg, Batch, Sequence[int], int, None] = None,
    chunk_sizes: Union[TensorLikeArg, Batch, Sequence[int], int, None] = None,
    dtype: Union[DALIDataType, DType, None] = DALIDataType.UINT8,
    layout: Optional[str] = "",
    sequence_axis_name: Optional[str] = "F",
    shape: Union[TensorLikeArg, Batch, Sequence[int], int],
) -> Union[Tensor, Batch]:
    """
    ...
    bytes_per_sample_hint : int or list of int, optional, default = `[0]`
        ...
        If specified, the operator's outputs residing in GPU or page-locked host memory will be preallocated
        to accommodate a batch of samples of this size.
    chunk_offsets : int or list of int or Tensor/Batch of int, optional
    ...
    chunk_sizes : int or list of int or Tensor/Batch of int, optional
    ...
    shape : int or list of int or Tensor/Batch of int
...
def median_blur(
    ...
    *,
    device: Optional[Literal["gpu"]] = None,
    window_size: Union[TensorLikeArg, Batch, Sequence[int], int, None] = [3, 3],
) -> Union[Tensor, Batch]:
    """
    ...
    preserve : bool, optional, default = `False`
        Prevents the operator from being removed from the
        graph even if its outputs are not used.
    window_size : int or list of int or Tensor/Batch of int, optional, default = `[3, 3]`
...
def peek_image_shape(
    ...
    *,
    ...
    dtype: Union[DALIDataType, DType, None] = DALIDataType.INT64,
...
def remap(
    ...
    *,
    ...
    Args
    ----
    input : Tensor/Batch ('HWC', 'FHWC')
        Input data. Must be a 1- or 3-channel HWC image.
    mapx : Tensor/Batch of float ('HWC', 'HW', 'FHWC', 'FHW', 'F***', 'F**')
        Defines the remap transformation for x coordinates.
    mapy : Tensor/Batch of float ('HWC', 'HW', 'FHWC', 'FHW', 'F***', 'F**')
...
@overload
def remap(
    input: Union[TensorLike, Batch],
    mapx: Union[TensorLike, Batch],
    mapy: Union[TensorLike, Batch],
    /,
    *,
    device: Optional[Literal["gpu"]] = None,
    interp: Optional[DALIInterpType] = DALIInterpType.INTERP_LINEAR,
...
def resize(
    ...
    *,
    device: Optional[Literal["gpu"]] = None,
    antialias: Optional[builtins.bool] = True,
    dtype: Union[DALIDataType, DType, None] = None,
    interp_type: Union[TensorLikeArg, Batch, DALIInterpType, None] = DALIInterpType.INTERP_LINEAR,
    mag_filter: Union[TensorLikeArg, Batch, DALIInterpType, None] = DALIInterpType.INTERP_LINEAR,
    max_size: Union[Sequence[float], float, None] = None,
    min_filter: Union[TensorLikeArg, Batch, DALIInterpType, None] = DALIInterpType.INTERP_LINEAR,
    minibatch_size: Optional[int] = 32,
    mode: Optional[str] = "default",
    resize_longer: Union[TensorLikeArg, Batch, float, None] = 0.0,
    resize_shorter: Union[TensorLikeArg, Batch, float, None] = 0.0,
    resize_x: Union[TensorLikeArg, Batch, float, None] = 0.0,
    resize_y: Union[TensorLikeArg, Batch, float, None] = 0.0,
    resize_z: Union[TensorLikeArg, Batch, float, None] = 0.0,
    roi_end: Union[TensorLikeArg, Batch, Sequence[float], float, None] = None,
    roi_relative: Optional[builtins.bool] = False,
    roi_start: Union[TensorLikeArg, Batch, Sequence[float], float, None] = None,
    save_attrs: Optional[builtins.bool] = False,
    size: Union[TensorLikeArg, Batch, Sequence[float], float, None] = None,
    subpixel_scale: Optional[builtins.bool] = True,
    ...
    Args
    ----
    input : Tensor/Batch ('HWC', 'FHWC', 'CHW', 'FCHW', 'CFHW', 'DHWC', 'FDHWC', 'CDHW', 'FCDHW', 'CFDHW')
        Input to the operator.
    ...
    interp_type : :class:`nvidia.dali.types.DALIInterpType` or Tensor/Batch of :class:`nvidia.dali.types.DALIInterpType`, optional, default = `DALIInterpType.INTERP_LINEAR`
    ...
    mag_filter : :class:`nvidia.dali.types.DALIInterpType` or Tensor/Batch of :class:`nvidia.dali.types.DALIInterpType`, optional, default = `DALIInterpType.INTERP_LINEAR`
    ...
    max_size : float or list of float, optional
        ...
        .. note::
          ...
          1400x700.
    min_filter : :class:`nvidia.dali.types.DALIInterpType` or Tensor/Batch of :class:`nvidia.dali.types.DALIInterpType`, optional, default = `DALIInterpType.INTERP_LINEAR`
    ...
    preserve : bool, optional, default = `False`
        Prevents the operator from being removed from the
        graph even if its outputs are not used.
    resize_longer : float or Tensor/Batch of float, optional, default = `0.0`
    ...
    resize_shorter : float or Tensor/Batch of float, optional, default = `0.0`
    ...
    resize_x : float or Tensor/Batch of float, optional, default = `0.0`
    ...
    resize_y : float or Tensor/Batch of float, optional, default = `0.0`
        ...
        A negative value flips the image.
    resize_z : float or Tensor/Batch of float, optional, default = `0.0`
    ...
    roi_end : float or list of float or Tensor/Batch of float, optional
    ...
    roi_start : float or list of float or Tensor/Batch of float, optional
    ...
    size : float or list of float or Tensor/Batch of float, optional
...
def tensor_resize(
    ...
    *,
    device: Optional[Literal["cpu", "gpu"]] = None,
    alignment: Union[TensorLikeArg, Batch, Sequence[float], float, None] = [0.5],
    antialias: Optional[builtins.bool] = True,
    ...
    roi_relative: Optional[builtins.bool] = False,
    roi_start: Union[TensorLikeArg, Batch, Sequence[float], float, None] = None,
    scales: Union[TensorLikeArg, Batch, Sequence[float], float, None] = None,
    size_rounding: Optional[str] = "round",
    sizes: Union[TensorLikeArg, Batch, Sequence[float], float, None] = None,
    subpixel_scale: Optional[builtins.bool] = True,
    temp_buffer_hint: Optional[int] = 0,
) -> Union[Tensor, Batch]:
    """
    ...
    Keyword args
    ------------
    alignment : float or list of float or Tensor/Batch of float, optional, default = `[0.5]`
    ...
    roi_start : float or list of float or Tensor/Batch of float, optional
        ...
        relative (0..1), depending on the value of ``relative_roi`` argument. If the ROI origin is greater
        than the ROI end in any dimension, the region is flipped in that dimension.
    scales : float or list of float or Tensor/Batch of float, optional
        Scale factors.
    ...
    sizes : float or list of float or Tensor/Batch of float, optional
        Output sizes.
...
def warp_perspective(
    input: Batch,
    matrix_input: Optional[Batch] = None,
    /,
    *,
    device: Optional[Literal["cpu", "gpu"]] = None,
    border_mode: Optional[str] = "constant",
    ...
    inverse_map: Optional[builtins.bool] = True,
    matrix: Union[TensorLikeArg, Batch, Sequence[float], float, None] = [],
    pixel_origin: Optional[str] = "corner",
    size: Union[TensorLikeArg, Batch, Sequence[float], float, None] = [],
) -> Batch:
    """
    ...
    Args
    ----
    input : Tensor/Batch of uint8, uint16, int16 or float ('HW', 'HWC', 'FHWC', 'CHW', 'FCHW')
        Input data. Must be images in HWC or CHW layout, or a sequence of those.
    matrix_input : 2D Tensor/Batch of float, optional
...
def warp_perspective(
    input: Union[TensorLike, Batch],
    matrix_input: Union[TensorLike, Batch, None] = None,
    /,
    *,
    device: Optional[Literal["cpu", "gpu"]] = None,
    border_mode: Optional[str] = "constant",
