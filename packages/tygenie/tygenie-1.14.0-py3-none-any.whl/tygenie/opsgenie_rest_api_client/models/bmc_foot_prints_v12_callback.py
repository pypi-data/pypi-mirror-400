...
T = TypeVar("T", bound="BMCFootPrintsV12Callback")


@_attrs_define
class BMCFootPrintsV12Callback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bmc_foot_prints_v12_callback = cls(
        ...
        bmc_foot_prints_v12_callback.additional_properties = d
        return bmc_foot_prints_v12_callback
