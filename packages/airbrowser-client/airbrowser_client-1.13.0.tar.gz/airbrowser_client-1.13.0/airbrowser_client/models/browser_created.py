...
class BrowserCreated(BaseModel):
    ...
    data: Optional[BrowserCreationData] = Field(default=None, description="Browser creation data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": BrowserCreationData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
