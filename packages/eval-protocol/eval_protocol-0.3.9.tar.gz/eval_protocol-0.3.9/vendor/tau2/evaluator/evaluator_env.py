...
from vendor.tau2.data_model.message import AssistantMessage, Message, ToolCall, UserMessage
from vendor.tau2.data_model.simulation import DBCheck, EnvAssertionCheck, RewardInfo
...
class EnvironmentEvaluator(EvaluatorBase):
    ...
    def calculate_reward(
        ...
        if task.initial_state is not None and task.initial_state.initialization_actions is not None:
