...
T = TypeVar("T", bound="SearchProcessInstancesResponse400")


@_attrs_define
class SearchProcessInstancesResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_process_instances_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_process_instances_response_400.additional_properties = d
        return search_process_instances_response_400
