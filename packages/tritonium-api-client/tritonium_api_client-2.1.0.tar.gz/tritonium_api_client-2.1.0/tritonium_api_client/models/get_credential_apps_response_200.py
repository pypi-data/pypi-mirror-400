...
T = TypeVar("T", bound="GetCredentialAppsResponse200")



@_attrs_define
class GetCredentialAppsResponse200:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_credential_apps_response_200 = cls(
            apps=apps,
        )


        get_credential_apps_response_200.additional_properties = d
        return get_credential_apps_response_200
