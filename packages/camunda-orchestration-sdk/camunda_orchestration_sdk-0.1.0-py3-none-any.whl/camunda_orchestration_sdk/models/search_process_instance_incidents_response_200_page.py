...
T = TypeVar("T", bound="SearchProcessInstanceIncidentsResponse200Page")


@_attrs_define
class SearchProcessInstanceIncidentsResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_process_instance_incidents_response_200_page = cls(
        ...
        search_process_instance_incidents_response_200_page.additional_properties = d
        return search_process_instance_incidents_response_200_page
