...
* [cli](docs/sdks/auth/README.md#cli) - CLI Authentication
...
* [get_status](docs/sdks/projects/README.md#get_status) - Get Project Status
...
* [get](docs/sdks/usersdk/README.md#get) - Get User Info
...
[`AlphSDKError`](./src/alph_sdk/errors/alphsdkerror.py) is the base class for all HTTP error responses. It has the following properties:
...
### Error Classes
**Primary error:**
* [`AlphSDKError`](./src/alph_sdk/errors/alphsdkerror.py): The base class for HTTP error responses.
...
**Inherit from [`AlphSDKError`](./src/alph_sdk/errors/alphsdkerror.py)**:
* [`ResponseValidationError`](./src/alph_sdk/errors/responsevalidationerror.py): Type mismatch between the response data and the expected Pydantic model. Provides access to the Pydantic validation error via the `cause` attribute.
