...
# source: openads/proto/drivers/sensor_image.proto
...
_IMAGE = _descriptor.Descriptor(
  name='Image',
  full_name='openads.proto.drivers.Image',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='header', full_name='openads.proto.drivers.Image.header', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='frame_id', full_name='openads.proto.drivers.Image.frame_id', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='measurement_time', full_name='openads.proto.drivers.Image.measurement_time', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='height', full_name='openads.proto.drivers.Image.height', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='width', full_name='openads.proto.drivers.Image.width', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='encoding', full_name='openads.proto.drivers.Image.encoding', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='step', full_name='openads.proto.drivers.Image.step', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='openads.proto.drivers.Image.data', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='disparity_step', full_name='openads.proto.drivers.Image.disparity_step', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='disparity_data', full_name='openads.proto.drivers.Image.disparity_data', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pixel_format', full_name='openads.proto.drivers.Image.pixel_format', index=10,
...
_COMPRESSEDIMAGE = _descriptor.Descriptor(
  ...
  full_name='openads.proto.drivers.CompressedImage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='header', full_name='openads.proto.drivers.CompressedImage.header', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='frame_id', full_name='openads.proto.drivers.CompressedImage.frame_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='format', full_name='openads.proto.drivers.CompressedImage.format', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='openads.proto.drivers.CompressedImage.data', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='measurement_time', full_name='openads.proto.drivers.CompressedImage.measurement_time', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='frame_type', full_name='openads.proto.drivers.CompressedImage.frame_type', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='raw_buf_fd', full_name='openads.proto.drivers.CompressedImage.raw_buf_fd', index=6,
      number=7, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='raw_buf_pixel_format', full_name='openads.proto.drivers.CompressedImage.raw_buf_pixel_format', index=7,
...
_IMAGE.fields_by_name['header'].message_type = openads_dot_proto_dot_common_dot_header__pb2._HEADER
_IMAGE.fields_by_name['pixel_format'].enum_type = _PIXELFORMAT
_COMPRESSEDIMAGE.fields_by_name['header'].message_type = openads_dot_proto_dot_common_dot_header__pb2._HEADER
_COMPRESSEDIMAGE.fields_by_name['raw_buf_pixel_format'].enum_type = _PIXELFORMAT
...
Image = _reflection.GeneratedProtocolMessageType('Image', (_message.Message,), dict(
  DESCRIPTOR = _IMAGE,
  __module__ = 'openads.proto.drivers.sensor_image_pb2'
  # @@protoc_insertion_point(class_scope:openads.proto.drivers.Image)
  ))
...
CompressedImage = _reflection.GeneratedProtocolMessageType('CompressedImage', (_message.Message,), dict(
  ...
  __module__ = 'openads.proto.drivers.sensor_image_pb2'
  # @@protoc_insertion_point(class_scope:openads.proto.drivers.CompressedImage)
  ))
