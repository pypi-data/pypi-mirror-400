...
T = TypeVar("T", bound="LibreNMSIntegration")


@_attrs_define
class LibreNMSIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        libre_nms_integration.additional_properties = d
        return libre_nms_integration
