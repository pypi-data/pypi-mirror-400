...
from society import data, instructions, tools
...
from society.util import agent_util
...
async def run(
    ...
    Output: run_dir/{events.jsonl, chat.jsonl, people.json, config.yaml, debug.log}
...
""".strip()
        ...
        async for event in _run_with_retry(
            ...
            if event.event_kind == "function_tool_call":
                ...
                result = T.cast(T.Any, tool_return_part.content)
