<template>
  <div class="card filter">
    ...
    <div class="search">
      <el-input v-model="filterText" :placeholder="t('common.inputKeywordToFilter')" clearable />
      <el-dropdown trigger="click">
        <el-icon size="20"><More /></el-icon>
        <template #dropdown>
          <el-dropdown-menu>
            <el-dropdown-item @click="toggleTreeNodes(true)">{{ t("common.expandAll") }}</el-dropdown-item>
            <el-dropdown-item @click="toggleTreeNodes(false)">{{ t("common.collapseAll") }}</el-dropdown-item>
          </el-dropdown-menu>
        </template>
      </el-dropdown>
    </div>
