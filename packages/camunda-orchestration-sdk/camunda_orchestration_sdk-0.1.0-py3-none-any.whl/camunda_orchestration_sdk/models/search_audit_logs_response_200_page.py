...
T = TypeVar("T", bound="SearchAuditLogsResponse200Page")


@_attrs_define
class SearchAuditLogsResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_audit_logs_response_200_page = cls(
        ...
        search_audit_logs_response_200_page.additional_properties = d
        return search_audit_logs_response_200_page
