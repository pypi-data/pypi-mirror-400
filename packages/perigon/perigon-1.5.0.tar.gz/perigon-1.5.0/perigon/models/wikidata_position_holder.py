...
class WikidataPositionHolder(BaseModel):
    """
    ...
    employer: Optional[WikidataLabelHolder] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WikidataPositionHolder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WikidataPositionHolder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "employer": (
                    WikidataLabelHolder.from_dict(obj["employer"])
                    if obj.get("employer") is not None
                    else None
                ),
            }
        )
