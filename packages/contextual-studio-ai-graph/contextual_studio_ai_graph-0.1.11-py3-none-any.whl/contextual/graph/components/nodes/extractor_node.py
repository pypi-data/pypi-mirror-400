            ...
            if tracer and execution_id:
                await tracer.log_step(
                    ...
                    metadata={
                        ...
                        # We can't easily get raw JSON here without re-architecting to not use with_structured_output
                        # But model_dump is usually sufficient for successful extractions
                    },
                )
