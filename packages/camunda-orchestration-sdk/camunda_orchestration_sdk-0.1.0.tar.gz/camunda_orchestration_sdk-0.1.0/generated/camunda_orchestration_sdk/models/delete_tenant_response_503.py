...
T = TypeVar("T", bound="DeleteTenantResponse503")


@_attrs_define
class DeleteTenantResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_tenant_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_tenant_response_503.additional_properties = d
        return delete_tenant_response_503
