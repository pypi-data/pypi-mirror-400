...
def soc(ctx, box, value):
    ...
    resolved_box = resolve_box(ctx, box)
    netname = require_netname(ctx, "battery")
    _run_backend(ctx, resolved_box, 'set_soc', netname=netname, value=value)
...
def voc(ctx, box, value):
    ...
    resolved_box = resolve_box(ctx, box)
    netname = require_netname(ctx, "battery")
    _run_backend(ctx, resolved_box, 'set_voc', netname=netname, value=value)
...
def batt_full(ctx, box, value):
    ...
    resolved_box = resolve_box(ctx, box)
    netname = require_netname(ctx, "battery")
    _run_backend(ctx, resolved_box, 'set_volt_full', netname=netname, value=value)
...
def batt_empty(ctx, box, value):
    ...
    resolved_box = resolve_box(ctx, box)
    netname = require_netname(ctx, "battery")
    _run_backend(ctx, resolved_box, 'set_volt_empty', netname=netname, value=value)
...
def capacity(ctx, box, value):
    ...
    resolved_box = resolve_box(ctx, box)
    netname = require_netname(ctx, "battery")
    _run_backend(ctx, resolved_box, 'set_capacity', netname=netname, value=value)
...
def current_limit(ctx, box, value):
    ...
    resolved_box = resolve_box(ctx, box)
    netname = require_netname(ctx, "battery")
    _run_backend(ctx, resolved_box, 'set_current_limit', netname=netname, value=value)
...
def ovp(ctx, box, value):
    ...
    resolved_box = resolve_box(ctx, box)
    netname = require_netname(ctx, "battery")
    _run_backend(ctx, resolved_box, 'set_ovp', netname=netname, value=value)
...
def ocp(ctx, box, value):
    ...
    resolved_box = resolve_box(ctx, box)
    netname = require_netname(ctx, "battery")
    _run_backend(ctx, resolved_box, 'set_ocp', netname=netname, value=value)
