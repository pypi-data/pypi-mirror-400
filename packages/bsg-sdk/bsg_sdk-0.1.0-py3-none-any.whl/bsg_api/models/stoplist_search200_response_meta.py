...
class StoplistSearch200ResponseMeta(BaseModel):
    """
    Information about search criteria and total results count
    """ # noqa: E501
    page: Optional[StoplistSearch200ResponseMetaPage] = None
    search: Optional[StoplistSearch200ResponseMetaSearch] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "page": StoplistSearch200ResponseMetaPage.from_dict(obj["page"]) if obj.get("page") is not None else None,
            "search": StoplistSearch200ResponseMetaSearch.from_dict(obj["search"]) if obj.get("search") is not None else None
        })
        return _obj
