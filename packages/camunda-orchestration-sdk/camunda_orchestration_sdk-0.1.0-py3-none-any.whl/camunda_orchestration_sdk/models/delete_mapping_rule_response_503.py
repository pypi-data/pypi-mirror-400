...
T = TypeVar("T", bound="DeleteMappingRuleResponse503")


@_attrs_define
class DeleteMappingRuleResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_mapping_rule_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_mapping_rule_response_503.additional_properties = d
        return delete_mapping_rule_response_503
