...
T = TypeVar("T", bound="EvaluateExpressionResponse403")


@_attrs_define
class EvaluateExpressionResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        evaluate_expression_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        evaluate_expression_response_403.additional_properties = d
        return evaluate_expression_response_403
