...
class KnowledgeItem(BaseModel):
    ...
    id: Optional[Union[int, str]] = Field(None, description="Unique identifier (int from KDDB, str from platform)")
    uuid: Optional[str] = None
    ...
    knowledge_item_type_ref: Optional[str] = Field(None, alias="knowledgeItemTypeRef", description="Type reference slug")
    ...
    external_id: Optional[str] = Field(None, alias="externalId", description="External/platform ID")
    created_on: Optional[StandardDateTime] = Field(None, alias="createdOn")
    updated_on: Optional[StandardDateTime] = Field(None, alias="updatedOn")
    change_sequence: Optional[int] = Field(None, alias="changeSequence")
