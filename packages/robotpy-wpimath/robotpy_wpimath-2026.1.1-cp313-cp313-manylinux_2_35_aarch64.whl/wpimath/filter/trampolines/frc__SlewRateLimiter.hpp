...
struct bind_frc__SlewRateLimiter {
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_SlewRateLimiter.def(py::init<Rate_t, Rate_t, Unit_t>()
    ...
    cls_SlewRateLimiter.def(py::init<Rate_t>()
      , py::arg("rateLimit")
      , release_gil()
      , py::doc(
    ...
    cls_SlewRateLimiter.def("calculate", &frc::SlewRateLimiter<Unit>::Calculate
      , py::arg("input")
      , release_gil()
      , py::doc(
    ...
    cls_SlewRateLimiter.def("lastValue", &frc::SlewRateLimiter<Unit>::LastValue
      , release_gil()
      , py::doc(
    ...
    cls_SlewRateLimiter.def("reset", &frc::SlewRateLimiter<Unit>::Reset
      , py::arg("value")
      , release_gil()
      , py::doc(
