...
T = TypeVar("T", bound="ModifyProcessInstanceResponse503")


@_attrs_define
class ModifyProcessInstanceResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        modify_process_instance_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        modify_process_instance_response_503.additional_properties = d
        return modify_process_instance_response_503
