...
# source: openads/proto/drivers/canbus/can_card_parameter.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='openads/proto/drivers/canbus/can_card_parameter.proto',
  package='openads.proto.drivers.canbus',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n5openads/proto/drivers/canbus/can_card_parameter.proto\x12\x1copenads.proto.drivers.canbus\"\xa2\x05\n\x10\x43\x41NCardParameter\x12J\n\x05\x62rand\x18\x01 \x01(\x0e\x32;.openads.proto.drivers.canbus.CANCardParameter.CANCardBrand\x12H\n\x04type\x18\x02 \x01(\x0e\x32:.openads.proto.drivers.canbus.CANCardParameter.CANCardType\x12O\n\nchannel_id\x18\x03 \x01(\x0e\x32;.openads.proto.drivers.canbus.CANCardParameter.CANChannelId\x12N\n\tinterface\x18\x04 \x01(\x0e\x32;.openads.proto.drivers.canbus.CANCardParameter.CANInterface\"^\n\x0c\x43\x41NCardBrand\x12\x0c\n\x08\x46\x41KE_CAN\x10\x00\x12\x0b\n\x07\x45SD_CAN\x10\x01\x12\x12\n\x0eSOCKET_CAN_RAW\x10\x02\x12\x0e\n\nHERMES_CAN\x10\x03\x12\x0f\n\x0bSEMI_VIRCAN\x10\x04\")\n\x0b\x43\x41NCardType\x12\x0c\n\x08PCI_CARD\x10\x00\x12\x0c\n\x08USB_CARD\x10\x01\"\x8b\x01\n\x0c\x43\x41NChannelId\x12\x13\n\x0f\x43HANNEL_ID_ZERO\x10\x00\x12\x12\n\x0e\x43HANNEL_ID_ONE\x10\x01\x12\x12\n\x0e\x43HANNEL_ID_TWO\x10\x02\x12\x14\n\x10\x43HANNEL_ID_THREE\x10\x03\x12\x13\n\x0f\x43HANNEL_ID_FOUR\x10\x04\x12\x13\n\x0f\x43HANNEL_ID_FIVE\x10\x05\">\n\x0c\x43\x41NInterface\x12\n\n\x06NATIVE\x10\x00\x12\x0b\n\x07VIRTUAL\x10\x01\x12\t\n\x05SLCAN\x10\x02\x12\n\n\x06VIRCAN\x10\x04')
)
...
_CANCARDPARAMETER_CANCARDBRAND = _descriptor.EnumDescriptor(
  name='CANCardBrand',
  full_name='openads.proto.drivers.canbus.CANCardParameter.CANCardBrand',
  filename=None,
  file=DESCRIPTOR,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SEMI_VIRCAN', index=4, number=4,
      serialized_options=None,
      type=None),
  ],
...
_CANCARDPARAMETER_CANCARDTYPE = _descriptor.EnumDescriptor(
  name='CANCardType',
  full_name='openads.proto.drivers.canbus.CANCardParameter.CANCardType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_CANCARDPARAMETER_CANCHANNELID = _descriptor.EnumDescriptor(
  name='CANChannelId',
  full_name='openads.proto.drivers.canbus.CANCardParameter.CANChannelId',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_CANCARDPARAMETER_CANINTERFACE = _descriptor.EnumDescriptor(
  name='CANInterface',
  full_name='openads.proto.drivers.canbus.CANCardParameter.CANInterface',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_CANCARDPARAMETER = _descriptor.Descriptor(
  ...
  full_name='openads.proto.drivers.canbus.CANCardParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='brand', full_name='openads.proto.drivers.canbus.CANCardParameter.brand', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='openads.proto.drivers.canbus.CANCardParameter.type', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='channel_id', full_name='openads.proto.drivers.canbus.CANCardParameter.channel_id', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='interface', full_name='openads.proto.drivers.canbus.CANCardParameter.interface', index=3,
...
CANCardParameter = _reflection.GeneratedProtocolMessageType('CANCardParameter', (_message.Message,), dict(
  ...
  __module__ = 'openads.proto.drivers.canbus.can_card_parameter_pb2'
  # @@protoc_insertion_point(class_scope:openads.proto.drivers.canbus.CANCardParameter)
  ))
