...
T = TypeVar("T", bound="UpdateMaintenanceResponse")
...
class UpdateMaintenanceResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_maintenance_response = cls(
            request_id=request_id,
            took=took,
            data=data,
        )

        update_maintenance_response.additional_properties = d
        return update_maintenance_response
