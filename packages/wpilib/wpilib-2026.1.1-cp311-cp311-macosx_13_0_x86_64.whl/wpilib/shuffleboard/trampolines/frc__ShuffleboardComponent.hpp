...
struct bind_frc__ShuffleboardComponent {
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_ShuffleboardComponent.def("withProperties", &frc::ShuffleboardComponent<Derived>::WithProperties
      , py::arg("properties")
    ...
    cls_ShuffleboardComponent.def("withPosition", &frc::ShuffleboardComponent<Derived>::WithPosition
    ...
    cls_ShuffleboardComponent.def("withSize", &frc::ShuffleboardComponent<Derived>::WithSize
