...
static PyObject *
I16Vector2Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(int16_t) * 2;
...
static PyMethodDef I16Vector2Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)I16Vector2Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
