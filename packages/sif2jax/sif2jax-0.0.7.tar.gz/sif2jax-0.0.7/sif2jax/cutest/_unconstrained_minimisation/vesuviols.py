...
class VESUVIOLS(AbstractUnconstrainedMinimisation):
    """ISIS Data fitting problem VESUVIO (least squares version).
    ...
    def objective(self, y, args=None):
        ...
        # E values (standard deviations) for scaling the residuals - same as VESUVIO
        e_data = jnp.array(
            [
                0.0303863,
                0.0310173,
