...
class RunState:
    ...
    def public_status(self, *, options: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        events_to_send = list(self.events or [])
        # User-facing messages without meta.
        ...
        for ev in events_to_send:
            ...
            if isinstance(data, str) and data.strip():
                user_events.append(data.strip())
            elif isinstance(msg, str) and msg.strip():
                user_events.append(msg.strip())
        ...
        return {
            ...
            "event_id": int(self.event_seq),
            "summary": summary_payload,
            "events": events_to_send,
            "events_user": user_events,
        }
