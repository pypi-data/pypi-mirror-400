...
import typing
__all__: list[str] = ['SimulatedAnnealing']
class SimulatedAnnealing:
    ...
    """
    def __init__(self, initialTemperature: typing.SupportsFloat, neighbor: collections.abc.Callable[[typing.Any], typing.Any], cost: collections.abc.Callable[[typing.Any], float]) -> None:
        """
        ...
        """
    def solve(self, initialGuess: typing.Any, iterations: typing.SupportsInt) -> typing.Any:
        """
