...
from xladmin.util import json
from xladmin.views.list import ALL_VAR
...
class ExportMenuPlugin(BaseAdminPlugin):
    ...
    def block_top_toolbar(self, context, nodes):
        if self.list_export:
            ...
            nodes.append(loader.render_to_string('xladmin/blocks/model_list.top_toolbar.exports.html',
