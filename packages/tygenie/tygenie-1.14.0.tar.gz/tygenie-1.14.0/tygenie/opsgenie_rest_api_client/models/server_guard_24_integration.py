...
T = TypeVar("T", bound="ServerGuard24Integration")
...
class ServerGuard24Integration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        server_guard_24_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        server_guard_24_integration.additional_properties = d
        return server_guard_24_integration
