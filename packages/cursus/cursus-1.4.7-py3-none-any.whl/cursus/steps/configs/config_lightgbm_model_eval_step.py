...
This module implements the configuration class for the LightGBM model evaluation step
...
class LightGBMModelEvalConfig(ProcessingStepConfigBase):
    """
    Configuration for LightGBM model evaluation step with self-contained derivation logic.

    This class defines the configuration parameters for the LightGBM model evaluation step,
    ...
    processing_entry_point: str = Field(
        default="lightgbm_model_eval.py",
    ...
    def initialize_derived_fields(self) -> "LightGBMModelEvalConfig":
    ...
    @model_validator(mode="after")
    def validate_eval_config(self) -> "LightGBMModelEvalConfig":
