...
T = TypeVar("T", bound="NagiosXIIntegrationV2")


@_attrs_define
class NagiosXIIntegrationV2:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nagios_xi_integration_v2.additional_properties = d
        return nagios_xi_integration_v2
