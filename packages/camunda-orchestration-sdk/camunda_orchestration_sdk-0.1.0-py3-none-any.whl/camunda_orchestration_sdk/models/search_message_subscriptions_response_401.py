...
T = TypeVar("T", bound="SearchMessageSubscriptionsResponse401")


@_attrs_define
class SearchMessageSubscriptionsResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_message_subscriptions_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_message_subscriptions_response_401.additional_properties = d
        return search_message_subscriptions_response_401
