...
class S3WorkflowData(
    ...
    def grant_put(
        ...
        '''(experimental) Grant put permissions to the given grantee for the workflow data in S3.
    ...
    def grant_read(
        ...
        '''(experimental) Grant read permissions to the given grantee for the workflow data in S3.
