...
from vendor.tau2.data_model.simulation import RunConfig
from vendor.tau2.run import get_options, run_domain
...
def run_view_simulations(args):
    from vendor.tau2.scripts.view_simulations import main as view_main
...
def run_show_domain(args):
    from vendor.tau2.scripts.show_domain_doc import main as domain_main

    domain_main(args.domain)


def run_start_servers():
    from vendor.tau2.scripts.start_servers import main as start_main

    start_main()


def run_check_data():
    from vendor.tau2.scripts.check_data import main as check_data_main
