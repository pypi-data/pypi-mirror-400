...
def random_mask_pixel(
    ...
    *,
    ...
    foreground: Union[TensorLikeArg, Batch, int, None] = 0,
    seed: Optional[int] = -1,
    threshold: Union[TensorLikeArg, Batch, float, None] = 0.0,
    value: Union[TensorLikeArg, Batch, int, None] = None,
) -> Union[Tensor, Batch]:
    """
...
def random_object_bbox(
    ...
    *,
    device: Optional[Literal["cpu"]] = None,
    background: Union[TensorLikeArg, Batch, int, None] = 0,
    cache_objects: Optional[builtins.bool] = False,
    class_weights: Union[TensorLikeArg, Batch, Sequence[float], float, None] = None,
    classes: Union[TensorLikeArg, Batch, Sequence[int], int, None] = None,
    foreground_prob: Union[TensorLikeArg, Batch, float, None] = 1.0,
    format: Optional[str] = "anchor_shape",
    ignore_class: Optional[builtins.bool] = False,
    k_largest: Optional[int] = None,
    output_class: Optional[builtins.bool] = False,
    seed: Optional[int] = -1,
    threshold: Union[TensorLikeArg, Batch, Sequence[int], int, None] = None,
) -> Union[Tensor, Batch]:
    """
    ...
    Keyword args
    ------------
    background : int or Tensor/Batch of int, optional, default = `0`
        Background label.
    ...
    class_weights : float or list of float or Tensor/Batch of float, optional
        ...
        normalized .
    classes : int or list of int or Tensor/Batch of int, optional
        List of labels considered as foreground.

        If left unspecified, all labels not equal to `background` are considered foreground.
    foreground_prob : float or Tensor/Batch of float, optional, default = `1.0`
    ...
    seed : int, optional, default = `-1`
        Random seed; if not set, one will be assigned automatically.
    threshold : int or list of int or Tensor/Batch of int, optional
...
def select_masks(
    ...
    *,
    device: Optional[Literal["cpu"]] = None,
    reindex_masks: Optional[builtins.bool] = False,
) -> Batch:
    """
...
@overload
def select_masks(
    mask_ids: Union[TensorLike, Batch],
    polygons: Union[TensorLike, Batch],
    vertices: Union[TensorLike, Batch],
    /,
    *,
    device: Optional[Literal["cpu"]] = None,
    reindex_masks: Optional[builtins.bool] = False,
