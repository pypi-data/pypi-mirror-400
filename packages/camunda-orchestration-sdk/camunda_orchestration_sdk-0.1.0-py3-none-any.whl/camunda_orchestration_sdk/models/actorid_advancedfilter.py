...
T = TypeVar("T", bound="ActoridAdvancedfilter")


@_attrs_define
class ActoridAdvancedfilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        actorid_advancedfilter.additional_properties = d
        return actorid_advancedfilter
