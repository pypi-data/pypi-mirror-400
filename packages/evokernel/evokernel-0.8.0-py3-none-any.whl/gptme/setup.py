...
def ask_for_api_key():  # pragma: no cover
    ...
    # OpenRouter only
    console.print()
    console.print("[cyan]Get your API key at:[/cyan] https://openrouter.ai/settings/keys")
    console.print()
