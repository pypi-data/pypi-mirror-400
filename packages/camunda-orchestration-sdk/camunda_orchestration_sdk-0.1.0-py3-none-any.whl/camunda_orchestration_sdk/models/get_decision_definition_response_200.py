...
T = TypeVar("T", bound="GetDecisionDefinitionResponse200")


@_attrs_define
class GetDecisionDefinitionResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_decision_definition_response_200 = cls(
        ...
        get_decision_definition_response_200.additional_properties = d
        return get_decision_definition_response_200
