...
T = TypeVar("T", bound="MSTeamsV2Integration")


@_attrs_define
class MSTeamsV2Integration:
    """
    Attributes:
        ...
        execute_commands (Union[Unset, bool]):
        tenant_id (Union[Unset, str]):
        msteams_v2_team_id (Union[Unset, str]):
    """
    ...
    execute_commands: Union[Unset, bool] = UNSET
    tenant_id: Union[Unset, str] = UNSET
    msteams_v2_team_id: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        msteams_v2_team_id = self.msteams_v2_team_id
        ...
        if execute_commands is not UNSET:
            field_dict["executeCommands"] = execute_commands
        if tenant_id is not UNSET:
            field_dict["tenantId"] = tenant_id
        if msteams_v2_team_id is not UNSET:
            field_dict["msteamsV2TeamId"] = msteams_v2_team_id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        execute_commands = d.pop("executeCommands", UNSET)

        tenant_id = d.pop("tenantId", UNSET)

        msteams_v2_team_id = d.pop("msteamsV2TeamId", UNSET)

        ms_teams_v2_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
            ...
            tenant_id=tenant_id,
            msteams_v2_team_id=msteams_v2_team_id,
        )

        ms_teams_v2_integration.additional_properties = d
        return ms_teams_v2_integration
