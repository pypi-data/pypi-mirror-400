...
T = TypeVar("T", bound="ThrowJobErrorResponse409")


@_attrs_define
class ThrowJobErrorResponse409:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        throw_job_error_response_409 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        throw_job_error_response_409.additional_properties = d
        return throw_job_error_response_409
