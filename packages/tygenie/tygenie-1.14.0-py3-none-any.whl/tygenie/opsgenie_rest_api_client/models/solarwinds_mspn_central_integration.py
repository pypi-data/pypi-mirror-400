...
T = TypeVar("T", bound="SolarwindsMSPNCentralIntegration")
...
class SolarwindsMSPNCentralIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        solarwinds_mspn_central_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        solarwinds_mspn_central_integration.additional_properties = d
        return solarwinds_mspn_central_integration
