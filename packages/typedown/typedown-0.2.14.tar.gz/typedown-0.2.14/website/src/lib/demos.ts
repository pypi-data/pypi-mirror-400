      ...
      files: [
        {
          ...
          language: "markdown",
          content: "",
          path: "/examples/00_basic_modeling/README.md",
        },
        {
          name: "intro.td",
          language: "typedown",
          content: "",
          path: "/examples/00_basic_modeling/intro.td",
        },
      ],
    },
    {
      ...
      files: [
        {
          ...
          language: "markdown",
          content: "",
          path: "/examples/01_schema_constraints/README.md",
        },
        {
          name: "constraints.td",
          language: "typedown",
          content: "",
          path: "/examples/01_schema_constraints/constraints.td",
        },
      ],
    },
    {
      ...
      files: [
        {
          ...
          language: "markdown",
          content: "",
          path: "/examples/02_inheritance/README.md",
        },
        {
          name: "ebook.td",
          language: "typedown",
          content: "",
          path: "/examples/02_inheritance/ebook.td",
        },
      ],
    },
    {
      ...
      files: [
        {
          ...
          language: "markdown",
          content: "",
          path: "/examples/03_simple_rules/README.md",
        },
        {
          name: "rules.td",
          language: "typedown",
          content: "",
          path: "/examples/03_simple_rules/rules.td",
        },
      ],
    },
    {
      ...
      files: [
        {
          ...
          language: "markdown",
          content: "",
          path: "/examples/04_context_interaction/README.md",
        },
        {
          name: "methods.td",
          language: "typedown",
          content: "",
          path: "/examples/04_context_interaction/methods.td",
        },
      ],
    },
    {
      ...
      files: [
        {
          ...
          language: "markdown",
          content: "",
          path: "/examples/05_global_governance/README.md",
        },
        {
          name: "library.td",
          language: "typedown",
          content: "",
          path: "/examples/05_global_governance/library.td",
        },
      ],
    },
    {
      ...
      files: [
        {
          ...
          language: "markdown",
          content: "",
          path: "/examples/06_modular_project/README.md",
        },
        {
          name: "config.td",
          language: "typedown",
          content: "",
          path: "/examples/06_modular_project/config.td",
        },
        {
          name: "models.td",
          language: "typedown",
          content: "",
          path: "/examples/06_modular_project/models.td",
        },
        {
          name: "data.td",
          language: "typedown",
          content: "",
          path: "/examples/06_modular_project/data.td",
        },
      ],
    },
    {
