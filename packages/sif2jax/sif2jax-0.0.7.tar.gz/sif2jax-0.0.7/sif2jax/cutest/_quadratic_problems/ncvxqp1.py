...
class NCVXQP1(AbstractConstrainedQuadraticProblem):
    """NCVXQP1 problem - a non-convex quadratic program.
    ...
    def expected_result(self):
        ...
        raise NotImplementedError("Expected result not available for NCVXQP1")
