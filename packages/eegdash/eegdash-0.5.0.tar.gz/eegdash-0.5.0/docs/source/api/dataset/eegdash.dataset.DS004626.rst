...
Can we dissociate hypervigilance to social threats from altered perceptual decision-making processes in lonely individuals? An exploration with Drift Diffusion Modelling and event-related potentials. (OpenNeuro ``ds004626``). Access recordings and metadata through EEGDash.
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds004626.v1.0.2 <https://doi.org/10.18112/openneuro.ds004626.v1.0.2>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds004626>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds004626>`__
