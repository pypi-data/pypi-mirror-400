...
T = TypeVar("T", bound="SearchProcessInstancesResponse500")


@_attrs_define
class SearchProcessInstancesResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_process_instances_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_process_instances_response_500.additional_properties = d
        return search_process_instances_response_500
