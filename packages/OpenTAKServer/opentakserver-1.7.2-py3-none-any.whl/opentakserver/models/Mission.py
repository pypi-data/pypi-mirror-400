...
class Mission(db.Model):
    ...
    #boundingPolygon: Mapped[str] = mapped_column(String(255), nullable=True)
    ...
    #last_edited: Mapped[datetime] = mapped_column(DateTime, nullable=True)
