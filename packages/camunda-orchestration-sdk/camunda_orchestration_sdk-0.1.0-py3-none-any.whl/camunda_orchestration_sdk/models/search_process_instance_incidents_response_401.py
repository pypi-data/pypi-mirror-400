...
T = TypeVar("T", bound="SearchProcessInstanceIncidentsResponse401")


@_attrs_define
class SearchProcessInstanceIncidentsResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_process_instance_incidents_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_process_instance_incidents_response_401.additional_properties = d
        return search_process_instance_incidents_response_401
