...
T = TypeVar("T", bound="CorrelateMessageResponse404")


@_attrs_define
class CorrelateMessageResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        correlate_message_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        correlate_message_response_404.additional_properties = d
        return correlate_message_response_404
