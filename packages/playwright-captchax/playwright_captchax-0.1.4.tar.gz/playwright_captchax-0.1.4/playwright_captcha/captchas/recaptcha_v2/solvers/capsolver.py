...
async def solve_recaptcha_v2_capsolver(async_capsolver_client: AsyncCapSolver, **kwargs) -> dict:
    """
    Solve Recaptcha V2 captcha using CapSolver service
    ...
    logger.debug('Solving Recaptcha V2 captcha using CapSolver...')
