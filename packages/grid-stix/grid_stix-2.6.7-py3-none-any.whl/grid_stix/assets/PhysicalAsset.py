"""
A physical asset in the distribution grid, e.g., poles, transformers, substations.
...
class PhysicalAsset(GridSTIXDomainObject):
    """
    A physical asset in the distribution grid, e.g., poles, transformers, substations.
    ...
    _properties = OrderedDict(
        [
            ...
            ("x_contains_asset", ListProperty(StringProperty())),
        ]
    )

    def __init__(self, **kwargs: Any) -> None:
        """Initialize PhysicalAsset with Grid-STIX properties."""
