...
T = TypeVar("T", bound="AssignUserToTenantResponse403")


@_attrs_define
class AssignUserToTenantResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assign_user_to_tenant_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        assign_user_to_tenant_response_403.additional_properties = d
        return assign_user_to_tenant_response_403
