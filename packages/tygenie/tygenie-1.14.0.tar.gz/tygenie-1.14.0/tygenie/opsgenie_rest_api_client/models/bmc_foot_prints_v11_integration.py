...
T = TypeVar("T", bound="BMCFootPrintsV11Integration")


@_attrs_define
class BMCFootPrintsV11Integration:
    """
    Attributes:
        ...
        incident_workspace_id (Union[Unset, str]):
        problem_workspace_id (Union[Unset, str]):
    """
    ...
    incident_workspace_id: Union[Unset, str] = UNSET
    problem_workspace_id: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        incident_workspace_id = self.incident_workspace_id

        problem_workspace_id = self.problem_workspace_id
        ...
        if incident_workspace_id is not UNSET:
            field_dict["incidentWorkspaceId"] = incident_workspace_id
        if problem_workspace_id is not UNSET:
            field_dict["problemWorkspaceId"] = problem_workspace_id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        incident_workspace_id = d.pop("incidentWorkspaceId", UNSET)

        problem_workspace_id = d.pop("problemWorkspaceId", UNSET)

        bmc_foot_prints_v11_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
            ...
            username=username,
            password=password,
            incident_workspace_id=incident_workspace_id,
            problem_workspace_id=problem_workspace_id,
        )

        bmc_foot_prints_v11_integration.additional_properties = d
        return bmc_foot_prints_v11_integration
