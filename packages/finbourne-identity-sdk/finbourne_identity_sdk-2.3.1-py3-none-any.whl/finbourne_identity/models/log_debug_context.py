...
class LogDebugContext(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LogDebugContext:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # set to None if debug_data (nullable) is None
        # and __fields_set__ contains the field
        if self.debug_data is None and "debug_data" in self.__fields_set__:
            _dict['debugData'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> LogDebugContext:
        """Create an instance of LogDebugContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LogDebugContext.parse_obj(obj)

        _obj = LogDebugContext.parse_obj({
