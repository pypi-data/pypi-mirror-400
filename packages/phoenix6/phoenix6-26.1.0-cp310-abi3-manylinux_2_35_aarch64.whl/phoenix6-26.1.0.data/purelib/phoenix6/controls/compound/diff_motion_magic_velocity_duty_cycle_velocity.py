...
@final
class Diff_MotionMagicVelocityDutyCycle_Velocity:
    """
    ...
    def __init__(self, average_request: MotionMagicVelocityDutyCycle, differential_request: VelocityDutyCycle):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_MotionMagicVelocityDutyCycle_Velocity"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicVelocityDutyCycle_Velocity")
    ...
    def with_average_request(self, new_average_request: MotionMagicVelocityDutyCycle) -> 'Diff_MotionMagicVelocityDutyCycle_Velocity':
        ...
        :returns: Itself
        :rtype: Diff_MotionMagicVelocityDutyCycle_Velocity
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: VelocityDutyCycle) -> 'Diff_MotionMagicVelocityDutyCycle_Velocity':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicVelocityDutyCycle_Velocity':
        """
