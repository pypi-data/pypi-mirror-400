...
def audio(
    ...
    *,
    ...
    downmix: Optional[builtins.bool] = False,
    dtype: Union[DALIDataType, DType, None] = DALIDataType.FLOAT,
    quality: Optional[float] = 50.0,
    sample_rate: Union[TensorLikeArg, Batch, float, None] = 0.0,
) -> Union[Tensor, Batch]:
    """
    ...
    * output[1]: A batch of sampling rates [Hz].
    ...
    sample_rate : float or Tensor/Batch of float, optional, default = `0.0`
...
def image(
    ...
    *,
    ...
    memory_stats: Optional[builtins.bool] = False,
