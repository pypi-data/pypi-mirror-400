...
Example:
    ...
    >>> from kwdagger.utils.result_analysis import ResultAnalysis
...
Example:
    ...
    >>> # Given a list of experiments, configs, and results
    >>> from kwdagger.utils.result_analysis import ResultAnalysis, Result
    >>> # Given a table of experiments with parameters, and metrics
    >>> table = [
...
class ResultTable:
    ...
    Example:
        >>> from kwdagger.utils.result_analysis import *  # NOQA
