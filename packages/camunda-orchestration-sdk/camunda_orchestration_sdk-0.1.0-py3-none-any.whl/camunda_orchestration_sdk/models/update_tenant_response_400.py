...
T = TypeVar("T", bound="UpdateTenantResponse400")


@_attrs_define
class UpdateTenantResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_tenant_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        update_tenant_response_400.additional_properties = d
        return update_tenant_response_400
