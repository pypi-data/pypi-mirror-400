...
class DTOC1L(AbstractConstrainedMinimisation):
    """A discrete time optimal control (DTOC) problem with linear transition functions.
    ...
    def constraint(self, y):
        ...
        # Combine all terms
        equality_constraints = base_terms + state_coupling + control_contrib
    ...
    def expected_objective_value(self):
        # From the SIF file: SOLUTION(1000,2,4) 3.9430507151
        return jnp.array(3.9430507151)
