...
from haplohub.models.get_algorithm_response import GetAlgorithmResponse  # noqa: E501


class TestGetAlgorithmResponse(unittest.TestCase):
    """GetAlgorithmResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAlgorithmResponse:
        """Test GetAlgorithmResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetAlgorithmResponse`
        """
        model = GetAlgorithmResponse()  # noqa: E501
        if include_optional:
    ...
    def testGetAlgorithmResponse(self):
        """Test GetAlgorithmResponse"""
