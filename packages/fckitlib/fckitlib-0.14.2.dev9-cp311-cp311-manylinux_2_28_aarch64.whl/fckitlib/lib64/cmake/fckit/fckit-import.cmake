...
if( fckit_IS_BUILD_DIR_EXPORT )
  set( FCTEST_GENERATOR /venv/build3.11/bin/python3.11 /src/fckit/tools/fctest-generate-runner.py )
  ...
  set( FCTEST_GENERATOR /venv/build3.11/bin/python3.11 ${fckit_BASE_DIR}/libexec/fctest-generate-runner.py )
endif()
