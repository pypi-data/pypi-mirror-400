...
class Datasetparameter(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "value", "units", "datasetId", "sampleName", "sampleId", "createTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Datasetparameter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Datasetparameter from a dict"""
        if obj is None:
            return None
