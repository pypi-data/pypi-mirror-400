...
T = TypeVar("T", bound="UpdateGroupResponse500")


@_attrs_define
class UpdateGroupResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_group_response_500.additional_properties = d
        return update_group_response_500
