...
@final
class Diff_VelocityVoltage_Open:
    """
    ...
    def __init__(self, average_request: VelocityVoltage, differential_request: VoltageOut):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_VelocityVoltage_Open"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_VelocityVoltage_Open")
    ...
    def with_average_request(self, new_average_request: VelocityVoltage) -> 'Diff_VelocityVoltage_Open':
        ...
        :returns: Itself
        :rtype: Diff_VelocityVoltage_Open
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: VoltageOut) -> 'Diff_VelocityVoltage_Open':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_VelocityVoltage_Open':
        """
