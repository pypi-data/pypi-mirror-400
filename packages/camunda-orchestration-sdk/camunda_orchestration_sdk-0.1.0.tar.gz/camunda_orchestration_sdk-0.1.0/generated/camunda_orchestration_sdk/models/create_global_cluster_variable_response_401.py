...
T = TypeVar("T", bound="CreateGlobalClusterVariableResponse401")


@_attrs_define
class CreateGlobalClusterVariableResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_global_cluster_variable_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_global_cluster_variable_response_401.additional_properties = d
        return create_global_cluster_variable_response_401
