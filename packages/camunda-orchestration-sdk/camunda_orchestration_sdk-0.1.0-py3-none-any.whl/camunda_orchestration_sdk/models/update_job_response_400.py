...
T = TypeVar("T", bound="UpdateJobResponse400")


@_attrs_define
class UpdateJobResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_job_response_400.additional_properties = d
        return update_job_response_400
