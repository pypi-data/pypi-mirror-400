...
T = TypeVar("T", bound="GroundTruthFilterSchema")


@attrs.define
class GroundTruthFilterSchema:
    """
    Attributes:
        label_schema_uids (List[int]):
        voted (str):
        filter_type (Union[Unset, FilterTransformFilterTypes]):
        transform_config_type (Union[Literal['ground_truth_filter_schema'], Unset]):  Default:
            'ground_truth_filter_schema'.
    ...
    transform_config_type: Union[Literal["ground_truth_filter_schema"], Unset] = (
        "ground_truth_filter_schema"
    )
