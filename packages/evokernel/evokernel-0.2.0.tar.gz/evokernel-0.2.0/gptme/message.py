...
def _hide_tool_invocations(content: str) -> str:
    ...
    content = re.sub(
        ...
        replace_file_tool, content, flags=re.DOTALL
    )
    return content
...
def format_msgs(
    ...
    for msg in msgs:
        ...
        # Get content, hiding thinking blocks for assistant messages
        content = msg.content
        ...
        if oneline:
            ...
            output += textwrap.shorten(content_oneline, width=max_len, placeholder="...")
            if len(output) < 20:
