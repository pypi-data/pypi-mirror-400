...
<complexContent>
<extension base="tns:PlacementAction">
<sequence/>
</extension>
</complexContent>
</complexType>
...
<extension base="tns:ApiError">
<sequence>
<element maxOccurs="1" minOccurs="0" name="reason" type="tns:PlacementError.Reason"/>
</sequence>
</extension>
</complexContent>
</complexType>
...
<annotation>
<documentation> Creates new {@link Placement} objects. </documentation>
</annotation>
<complexType>
<sequence>
<element maxOccurs="unbounded" minOccurs="0" name="placements" type="tns:Placement"/>
</sequence>
</complexType>
</element>
<element name="createPlacementsResponse">
<complexType>
<sequence>
<element maxOccurs="unbounded" minOccurs="0" name="rval" type="tns:Placement"/>
</sequence>
</complexType>
</element>
...
<element name="getPlacementsByStatementResponse">
<complexType>
<sequence>
<element maxOccurs="1" minOccurs="0" name="rval" type="tns:PlacementPage"/>
</sequence>
</complexType>
</element>
<element name="performPlacementAction">
<annotation>
<documentation> Performs actions on {@link Placement} objects that match the given {@link Statement#query}. </documentation>
</annotation>
<complexType>
<sequence>
<element maxOccurs="1" minOccurs="0" name="placementAction" type="tns:PlacementAction"/>
<element maxOccurs="1" minOccurs="0" name="filterStatement" type="tns:Statement"/>
</sequence>
</complexType>
</element>
...
<element name="updatePlacementsResponse">
<complexType>
<sequence>
<element maxOccurs="unbounded" minOccurs="0" name="rval" type="tns:Placement"/>
</sequence>
...
<wsdl:message name="createPlacementsRequest">
<wsdl:part element="tns:createPlacements" name="parameters"/>
</wsdl:message>
<wsdl:message name="createPlacementsResponse">
<wsdl:part element="tns:createPlacementsResponse" name="parameters"/>
</wsdl:message>
<wsdl:message name="ApiException">
<wsdl:part element="tns:ApiExceptionFault" name="ApiException"/>
</wsdl:message>
<wsdl:message name="getPlacementsByStatementRequest">
<wsdl:part element="tns:getPlacementsByStatement" name="parameters"/>
</wsdl:message>
<wsdl:message name="getPlacementsByStatementResponse">
<wsdl:part element="tns:getPlacementsByStatementResponse" name="parameters"/>
</wsdl:message>
<wsdl:message name="performPlacementActionRequest">
<wsdl:part element="tns:performPlacementAction" name="parameters"/>
</wsdl:message>
<wsdl:message name="performPlacementActionResponse">
<wsdl:part element="tns:performPlacementActionResponse" name="parameters"/>
</wsdl:message>
<wsdl:message name="updatePlacementsRequest">
<wsdl:part element="tns:updatePlacements" name="parameters"/>
</wsdl:message>
<wsdl:message name="updatePlacementsResponse">
<wsdl:part element="tns:updatePlacementsResponse" name="parameters"/>
</wsdl:message>
...
<wsdl:operation name="createPlacements">
<wsdl:documentation> Creates new {@link Placement} objects. </wsdl:documentation>
<wsdl:input message="tns:createPlacementsRequest" name="createPlacementsRequest"/>
<wsdl:output message="tns:createPlacementsResponse" name="createPlacementsResponse"/>
...
<wsdl:input message="tns:getPlacementsByStatementRequest" name="getPlacementsByStatementRequest"/>
<wsdl:output message="tns:getPlacementsByStatementResponse" name="getPlacementsByStatementResponse"/>
<wsdl:fault message="tns:ApiException" name="ApiException"/>
</wsdl:operation>
<wsdl:operation name="performPlacementAction">
<wsdl:documentation> Performs actions on {@link Placement} objects that match the given {@link Statement#query}. </wsdl:documentation>
<wsdl:input message="tns:performPlacementActionRequest" name="performPlacementActionRequest"/>
<wsdl:output message="tns:performPlacementActionResponse" name="performPlacementActionResponse"/>
<wsdl:fault message="tns:ApiException" name="ApiException"/>
</wsdl:operation>
<wsdl:operation name="updatePlacements">
<wsdl:documentation> Updates the specified {@link Placement} objects. </wsdl:documentation>
<wsdl:input message="tns:updatePlacementsRequest" name="updatePlacementsRequest"/>
<wsdl:output message="tns:updatePlacementsResponse" name="updatePlacementsResponse"/>
<wsdl:fault message="tns:ApiException" name="ApiException"/>
</wsdl:operation>
</wsdl:portType>
<wsdl:binding name="PlacementServiceSoapBinding" type="tns:PlacementServiceInterface">
<wsdlsoap:binding style="document" transport="http://schemas.xmlsoap.org/soap/http"/>
<wsdl:operation name="createPlacements">
<wsdlsoap:operation soapAction=""/>
<wsdl:input name="createPlacementsRequest">
<wsdlsoap:header message="tns:RequestHeader" part="RequestHeader" use="literal"/>
<wsdlsoap:body use="literal"/>
</wsdl:input>
<wsdl:output name="createPlacementsResponse">
...
<wsdl:operation name="getPlacementsByStatement">
<wsdlsoap:operation soapAction=""/>
<wsdl:input name="getPlacementsByStatementRequest">
<wsdlsoap:header message="tns:RequestHeader" part="RequestHeader" use="literal"/>
<wsdlsoap:body use="literal"/>
</wsdl:input>
<wsdl:output name="getPlacementsByStatementResponse">
<wsdlsoap:header message="tns:ResponseHeader" part="ResponseHeader" use="literal"/>
<wsdlsoap:body use="literal"/>
</wsdl:output>
<wsdl:fault name="ApiException">
...
<wsdl:operation name="performPlacementAction">
<wsdlsoap:operation soapAction=""/>
<wsdl:input name="performPlacementActionRequest">
<wsdlsoap:header message="tns:RequestHeader" part="RequestHeader" use="literal"/>
<wsdlsoap:body use="literal"/>
</wsdl:input>
<wsdl:output name="performPlacementActionResponse">
<wsdlsoap:header message="tns:ResponseHeader" part="ResponseHeader" use="literal"/>
<wsdlsoap:body use="literal"/>
</wsdl:output>
<wsdl:fault name="ApiException">
...
<wsdl:operation name="updatePlacements">
<wsdlsoap:operation soapAction=""/>
<wsdl:input name="updatePlacementsRequest">
<wsdlsoap:header message="tns:RequestHeader" part="RequestHeader" use="literal"/>
<wsdlsoap:body use="literal"/>
</wsdl:input>
<wsdl:output name="updatePlacementsResponse">
<wsdlsoap:header message="tns:ResponseHeader" part="ResponseHeader" use="literal"/>
<wsdlsoap:body use="literal"/>
</wsdl:output>
<wsdl:fault name="ApiException">
...
<wsdl:service name="PlacementService">
<wsdl:port binding="tns:PlacementServiceSoapBinding" name="PlacementServiceInterfacePort">
<wsdlsoap:address location="https://ads.google.com/apis/ads/publisher/v202502/PlacementService"/>
</wsdl:port>
</wsdl:service>
</wsdl:definitions>
"""
...
from .common import GAMSOAPBaseModel, DateTime
...
class Placement(GAMSOAPBaseModel):
    """
    <complexType name="Placement">
    <annotation>
    <documentation> A {@code Placement} groups related {@code AdUnit} objects. </documentation>
    ...
    """
    id: Optional[int] = Field(None, description="Uniquely identifies the Placement. This attribute is read-only and is assigned by Google when a placement is created.")
    name: Optional[str] = Field(None, max_length=255, description="The name of the Placement. This value is required and has a maximum length of 255 characters.")
    description: Optional[str] = Field(None, max_length=65535, description="A description of the Placement. This value is optional and its maximum length is 65,535 characters.")
    placementCode: Optional[str] = Field(None, description="A string used to uniquely identify the Placement for purposes of serving the ad. This attribute is read-only and is assigned by Google when a placement is created.")
    status: Optional[InventoryStatus] = Field(None, description="The status of the Placement. This attribute is read-only.")
    targetedAdUnitIds: Optional[List[str]] = Field(None, description="The collection of AdUnit object IDs that constitute the Placement.")
    lastModifiedDateTime: Optional[DateTime] = Field(None, description="The date and time this placement was last modified.")
