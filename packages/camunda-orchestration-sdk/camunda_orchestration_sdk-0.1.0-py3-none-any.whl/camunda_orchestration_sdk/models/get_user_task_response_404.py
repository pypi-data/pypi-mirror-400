...
T = TypeVar("T", bound="GetUserTaskResponse404")


@_attrs_define
class GetUserTaskResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_user_task_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_user_task_response_404.additional_properties = d
        return get_user_task_response_404
