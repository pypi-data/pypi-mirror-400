...
T = TypeVar("T", bound="BigPandaIntegration")


@_attrs_define
class BigPandaIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        big_panda_integration.additional_properties = d
        return big_panda_integration
