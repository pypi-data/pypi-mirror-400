...
static PyObject *
DVector1Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(double) * 1;
...
static PyMethodDef DVector1Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)DVector1Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
