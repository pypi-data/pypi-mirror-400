...
from layerlearn.baseAdaC import AdaDecisionClassifier, AdaCatClassifier, AdaGradientClassifier, AdaLightClassifier, AdaXGBClassifier, AdaForestClassifier, AdaSupportClassifier, AdaLogisticClassifier, AdaKNNClassifier
import warnings
...
models = {
    "Ada Forest Classifier": AdaForestClassifier(),
    "Ada Support Classifier": AdaSupportClassifier(),
    "Ada Logistic Classifier": AdaLogisticClassifier(),
    "Ada KNN Classifier": AdaKNNClassifier(),
    "Ada XGBoost Classifier": AdaXGBClassifier(),
    "Ada CatBoost Classifier": AdaCatClassifier(),
    "Ada Gradient Boosting Classifier": AdaGradientClassifier(),
    "Ada Decision Classifier": AdaDecisionClassifier(),
    "Ada LightGBM Classifier": AdaLightClassifier(),
}
