...
T = TypeVar("T", bound="AssignMappingRuleToTenantResponse503")


@_attrs_define
class AssignMappingRuleToTenantResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assign_mapping_rule_to_tenant_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        assign_mapping_rule_to_tenant_response_503.additional_properties = d
        return assign_mapping_rule_to_tenant_response_503
