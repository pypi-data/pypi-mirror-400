...
if TYPE_CHECKING:
    ...
    from ..models.modify_process_instances_batch_operation_data_filter_or_item_variables_item import (
...
T = TypeVar("T", bound="ModifyProcessInstancesBatchOperationDataFilterOrItem")


@_attrs_define
class ModifyProcessInstancesBatchOperationDataFilterOrItem:
    ...
    Attributes:
        ...
        variables (list[ModifyProcessInstancesBatchOperationDataFilterOrItemVariablesItem] | Unset): The process
            instance variables.
    ...
    variables: (
        list[ModifyProcessInstancesBatchOperationDataFilterOrItemVariablesItem] | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        variables: (
            list[ModifyProcessInstancesBatchOperationDataFilterOrItemVariablesItem]
            | Unset
        ) = UNSET
        if _variables is not UNSET:
            variables = []
            for variables_item_data in _variables:
                variables_item = ModifyProcessInstancesBatchOperationDataFilterOrItemVariablesItem.from_dict(
                    variables_item_data
                )
        ...
        modify_process_instances_batch_operation_data_filter_or_item = cls(
        ...
        modify_process_instances_batch_operation_data_filter_or_item.additional_properties = d
        return modify_process_instances_batch_operation_data_filter_or_item
