...
@final
class Diff_PositionVoltage_Open:
    """
    ...
    def __init__(self, average_request: PositionVoltage, differential_request: VoltageOut):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_PositionVoltage_Open"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_PositionVoltage_Open")
    ...
    def with_average_request(self, new_average_request: PositionVoltage) -> 'Diff_PositionVoltage_Open':
        ...
        :returns: Itself
        :rtype: Diff_PositionVoltage_Open
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: VoltageOut) -> 'Diff_PositionVoltage_Open':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_PositionVoltage_Open':
        """
