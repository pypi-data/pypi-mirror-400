...
) -> Any | GetApiV1AccountResponse200 | GetApiV1AccountResponse404 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | GetApiV1AccountResponse200 | GetApiV1AccountResponse404]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Any, GetApiV1AccountResponse200, GetApiV1AccountResponse404]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, GetApiV1AccountResponse200, GetApiV1AccountResponse404]
    """
