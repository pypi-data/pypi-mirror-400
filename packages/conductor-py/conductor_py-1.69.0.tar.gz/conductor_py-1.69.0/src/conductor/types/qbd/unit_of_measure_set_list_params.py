...
class UnitOfMeasureSetListParams(TypedDict, total=False):
    ...
    **IMPORTANT**: QuickBooks Desktop does not support cursor-based pagination for
    ...
    """
    Filter for unit-of-measure sets whose `name` contains this substring,
    case-insensitive.
    ...
    **NOTE**: If you use this parameter, you cannot also use `nameStartsWith` or
    ...
    """
    Filter for unit-of-measure sets whose `name` ends with this substring,
    case-insensitive.
    ...
    **NOTE**: If you use this parameter, you cannot also use `nameContains` or
    ...
    """
    Filter for unit-of-measure sets whose `name` is alphabetically greater than or
    equal to this value.
    """
    ...
    **NOTE**: If any of the values you specify in this parameter are not found, the
    ...
    """
    Filter for unit-of-measure sets whose `name` starts with this substring,
    case-insensitive.
    ...
    **NOTE**: If you use this parameter, you cannot also use `nameContains` or
    ...
    """
    Filter for unit-of-measure sets whose `name` is alphabetically less than or
    equal to this value.
    """
