...
class CampaignRCSApi:
    ...
    def rcs_send(
        self,
        send_rcs_campaign: SendRcsCampaign,
        ...
        :param send_rcs_campaign: (required)
        :type send_rcs_campaign: SendRcsCampaign
        ...
        _param = self._rcs_send_serialize(
            send_rcs_campaign=send_rcs_campaign,
    ...
    def rcs_send_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RcsSend200Response]:
        """Send RCS message
    ...
    @validate_call
    def rcs_send_without_preload_content(
        self,
        send_rcs_campaign: SendRcsCampaign,
        _request_timeout: Union[
            None,
    ...
    def _rcs_send_serialize(
        ...
        if send_rcs_campaign is not None:
            _body_params = send_rcs_campaign
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/campaigns/rcs/send',
    ...
    def rcs_send_groups(
        self,
        send_rcs_campaign_groups: SendRcsCampaignGroups,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param send_rcs_campaign_groups: (required)
        :type send_rcs_campaign_groups: SendRcsCampaignGroups
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rcs_send_groups_serialize(
            send_rcs_campaign_groups=send_rcs_campaign_groups,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def rcs_send_groups_with_http_info(
        self,
        send_rcs_campaign_groups: SendRcsCampaignGroups,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RcsSendGroups200Response]:
        """Send RCS message to contact list
    ...
    @validate_call
    def rcs_send_groups_without_preload_content(
        self,
        send_rcs_campaign_groups: SendRcsCampaignGroups,
        _request_timeout: Union[
            None,
    ...
    def _rcs_send_groups_serialize(
        self,
        send_rcs_campaign_groups,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if send_rcs_campaign_groups is not None:
            _body_params = send_rcs_campaign_groups
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/campaigns/rcs/send-groups',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rcs_single(
        ...
        :param rcs_message: (required)
        :type rcs_message: RcsMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rcs_single_serialize(
    ...
    def rcs_single_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RcsSingle200Response]:
        """Send single RCS message
    ...
    @validate_call
    def rcs_single_without_preload_content(
        self,
        rcs_message: RcsMessage,
        _request_timeout: Union[
            None,
    ...
    def _rcs_single_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/messages/rcs/send',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
