"""
An individual or entity that owns DER assets, such as residential, commercial, or utility customers.
...
class DerOwner(GridSTIXDomainObject):
    """
    An individual or entity that owns DER assets, such as residential, commercial, or utility customers.
    ...
    _properties = OrderedDict(
        [
            ...
            ("x_owns", ListProperty(StringProperty())),
        ]
    )

    def __init__(self, **kwargs: Any) -> None:
        """Initialize DerOwner with Grid-STIX properties."""
