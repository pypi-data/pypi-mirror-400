...
struct bind_frc__MedianFilter {
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    cls_MedianFilter.doc() = 
      ...
      "sensors).";
    cls_MedianFilter.def(py::init<size_t>()
      , py::arg("size")
      , release_gil()
      , py::doc(
    ...
    cls_MedianFilter.def("calculate", &frc::MedianFilter<T>::Calculate
      , py::arg("next")
      , release_gil()
      , py::doc(
    ...
    cls_MedianFilter.def("lastValue", &frc::MedianFilter<T>::LastValue
      , release_gil()
      , py::doc(
    ...
    cls_MedianFilter.def("reset", &frc::MedianFilter<T>::Reset
      , release_gil()
