...
T = TypeVar("T", bound="CreateMappingRuleResponse404")


@_attrs_define
class CreateMappingRuleResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_mapping_rule_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_mapping_rule_response_404.additional_properties = d
        return create_mapping_rule_response_404
