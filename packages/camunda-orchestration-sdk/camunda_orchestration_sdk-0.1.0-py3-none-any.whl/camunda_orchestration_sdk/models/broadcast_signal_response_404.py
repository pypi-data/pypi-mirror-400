...
T = TypeVar("T", bound="BroadcastSignalResponse404")


@_attrs_define
class BroadcastSignalResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        broadcast_signal_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        broadcast_signal_response_404.additional_properties = d
        return broadcast_signal_response_404
