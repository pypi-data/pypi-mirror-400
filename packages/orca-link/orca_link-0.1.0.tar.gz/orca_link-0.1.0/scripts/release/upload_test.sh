...
echo ""
echo "🔗 View your package at: https://test.pypi.org/project/orca-link/"
echo ""
echo "📦 Test installation:"
echo "   pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ orca-link"
