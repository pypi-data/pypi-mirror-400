...
T = TypeVar("T", bound="UnassignClientFromTenantResponse403")


@_attrs_define
class UnassignClientFromTenantResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unassign_client_from_tenant_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        unassign_client_from_tenant_response_403.additional_properties = d
        return unassign_client_from_tenant_response_403
