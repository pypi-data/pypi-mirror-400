...
class LLMContextRangesResponse(BaseModel):
    """
    LLMContextRangesResponse
    """ # noqa: E501
    min_context_window: StrictInt
    max_context_window: StrictInt
    min_max_tokens: Optional[StrictInt] = None
    max_max_tokens: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LLMContextRangesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LLMContextRangesResponse from a dict"""
        if obj is None:
            return None
