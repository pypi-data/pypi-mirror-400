...
T = TypeVar("T", bound="EvaluateDecisionResponse500")


@_attrs_define
class EvaluateDecisionResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        evaluate_decision_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        evaluate_decision_response_500.additional_properties = d
        return evaluate_decision_response_500
