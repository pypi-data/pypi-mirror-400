...
T = TypeVar("T", bound="GetResourceContentResponse404")


@_attrs_define
class GetResourceContentResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_resource_content_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_resource_content_response_404.additional_properties = d
        return get_resource_content_response_404
