...
T = TypeVar("T", bound="AssignMappingRuleToGroupResponse400")


@_attrs_define
class AssignMappingRuleToGroupResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assign_mapping_rule_to_group_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        assign_mapping_rule_to_group_response_400.additional_properties = d
        return assign_mapping_rule_to_group_response_400
