...
T = TypeVar("T", bound="GetApiV1OrdersOrderIdResponse200")


@_attrs_define
class GetApiV1OrdersOrderIdResponse200:
    """
    Attributes:
        id (str):
        market_id (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_api_v1_orders_order_id_response_200 = cls(
            id=id,
            market_id=market_id,
        ...
        return get_api_v1_orders_order_id_response_200
