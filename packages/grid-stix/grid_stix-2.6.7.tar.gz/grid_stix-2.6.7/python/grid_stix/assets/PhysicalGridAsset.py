"""
Physical infrastructure components of the electrical grid including buildings, equipment, and structures.
...
class PhysicalGridAsset(GridSTIXDomainObject):
    """
    Physical infrastructure components of the electrical grid including buildings, equipment, and structures.
    ...
    _type = "x-grid-physical-grid-asset"
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize PhysicalGridAsset with Grid-STIX properties."""
