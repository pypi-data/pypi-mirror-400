...
T = TypeVar("T", bound="BMCRemedyForceIntegration")


@_attrs_define
class BMCRemedyForceIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bmc_remedy_force_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        bmc_remedy_force_integration.additional_properties = d
        return bmc_remedy_force_integration
