...
class UpdateReportResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateReportResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateReportResponse:
        """Create an instance of UpdateReportResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateReportResponse.parse_obj(obj)

        _obj = UpdateReportResponse.parse_obj(
            {
                "status": obj.get("status"),
                "result": ReportSchema2.from_dict(obj.get("result")) if obj.get("result") is not None else None,
            }
        )
        return _obj
