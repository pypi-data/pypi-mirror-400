...
T = TypeVar("T", bound="CompleteJobResponse400")


@_attrs_define
class CompleteJobResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        complete_job_response_400.additional_properties = d
        return complete_job_response_400
