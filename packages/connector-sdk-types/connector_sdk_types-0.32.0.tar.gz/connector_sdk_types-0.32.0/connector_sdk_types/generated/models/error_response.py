...
class ErrorResponse(BaseModel):
    ...
    """ # noqa: E501
    is_error: StrictBool = Field(description="Always true for error responses.")
    error: Error = Field(description="The error details.")
    raw_data: Optional[Dict[str, Any]] = Field(default=None, description="Raw data associated with the error, if any.")
