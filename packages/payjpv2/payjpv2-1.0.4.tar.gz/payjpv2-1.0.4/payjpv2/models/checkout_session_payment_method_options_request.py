...
class CheckoutSessionPaymentMethodOptionsRequest(BaseModel):
    """
    CheckoutSessionPaymentMethodOptionsRequest
    """ # noqa: E501
    card: Optional[CheckoutSessionPaymentMethodOptionsCardRequest] = Field(default=None, description="カード支払い方法に関するオプション")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "card": CheckoutSessionPaymentMethodOptionsCardRequest.from_dict(obj["card"]) if obj.get("card") is not None else None
        })
        return _obj
