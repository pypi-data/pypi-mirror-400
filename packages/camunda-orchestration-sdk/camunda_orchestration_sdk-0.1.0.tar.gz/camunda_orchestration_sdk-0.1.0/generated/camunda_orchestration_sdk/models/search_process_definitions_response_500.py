...
T = TypeVar("T", bound="SearchProcessDefinitionsResponse500")


@_attrs_define
class SearchProcessDefinitionsResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_process_definitions_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_process_definitions_response_500.additional_properties = d
        return search_process_definitions_response_500
