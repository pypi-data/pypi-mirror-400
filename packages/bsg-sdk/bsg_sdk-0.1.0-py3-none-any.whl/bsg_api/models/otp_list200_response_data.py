...
class OtpList200ResponseData(BaseModel):
    """
    OtpList200ResponseData
    """ # noqa: E501
    list: Optional[List[TwoFactorAuthenticationMessagesResource]] = None
    total: Optional[StrictInt] = Field(default=None, description="The total number of authentications.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": [TwoFactorAuthenticationMessagesResource.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None,
            "total": obj.get("total")
        })
        return _obj
