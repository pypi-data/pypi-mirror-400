...
@final
class Diff_MotionMagicExpoVoltage_Position:
    """
    Requires Phoenix Pro and CANivore;
    Differential control with Motion Magic® Expo average target and position
    ...
    def __init__(self, average_request: MotionMagicExpoVoltage, differential_request: PositionVoltage):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_MotionMagicExpoVoltage_Position"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicExpoVoltage_Position")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlDiff_MotionMagicExpoVoltage_Position(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.average_request.position, self.average_request.enable_foc, self.average_request.feed_forward, self.average_request.slot, self.average_request.override_brake_dur_neutral, self.average_request.limit_forward_motion, self.average_request.limit_reverse_motion, self.average_request.ignore_hardware_limits, self.average_request.ignore_software_limits, self.average_request.use_timesync, self.differential_request.position, self.differential_request.velocity, self.differential_request.enable_foc, self.differential_request.feed_forward, self.differential_request.slot, self.differential_request.override_brake_dur_neutral, self.differential_request.limit_forward_motion, self.differential_request.limit_reverse_motion, self.differential_request.ignore_hardware_limits, self.differential_request.ignore_software_limits, self.differential_request.use_timesync))

    
    def with_average_request(self, new_average_request: MotionMagicExpoVoltage) -> 'Diff_MotionMagicExpoVoltage_Position':
        """
        ...
        :type new_average_request: MotionMagicExpoVoltage
        :returns: Itself
        :rtype: Diff_MotionMagicExpoVoltage_Position
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: PositionVoltage) -> 'Diff_MotionMagicExpoVoltage_Position':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicExpoVoltage_Position':
        """
