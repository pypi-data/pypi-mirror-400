...
T = TypeVar("T", bound="RedGateSqlMonitorEmailIntegration")
...
class RedGateSqlMonitorEmailIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        red_gate_sql_monitor_email_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        red_gate_sql_monitor_email_integration.additional_properties = d
        return red_gate_sql_monitor_email_integration
