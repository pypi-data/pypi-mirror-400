...
class Int64 (SpireObject) :
    ...
    def CompareTo(self ,value:SpireObject)->int:
        ...
        ret = CallCFunction(dlllib.Int64_CompareTo,self.Ptr, intPtrvalue)
        return ret
    ...
    def CompareTo(self ,value:int)->int:
        ...
        ret = CallCFunction(dlllib.Int64_CompareToV,self.Ptr, value)
        return ret
    ...
    def Equals(self ,obj:SpireObject)->bool:
        ...
        ret = CallCFunction(dlllib.Int64_Equals,self.Ptr, intPtrobj)
        return ret
    ...
    def Equals(self ,obj:int)->bool:
        ...
        ret = CallCFunction(dlllib.Int64_EqualsO,self.Ptr, obj)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = CallCFunction(dlllib.Int64_GetHashCode,self.Ptr)
        return ret
    ...
    def ToString(self)->str:
        ...
        ret = PtrToStr(CallCFunction(dlllib.Int64_ToString,self.Ptr))
        return ret
...
#        ret = CallCFunction(dlllib.Int64_ToStringP,self.Ptr, intPtrprovider)
#        return ret
#
    ...
    def ToString(self ,format:str)->str:
        ...
        ret = PtrToStr(CallCFunction(dlllib.Int64_ToStringF,self.Ptr, format))
        return ret
...
#        ret = CallCFunction(dlllib.Int64_ToStringFP,self.Ptr, format,intPtrprovider)
#        return ret
#
    ...
    def Parse(s:str)->int:
        ...
        ret = CallCFunction(dlllib.Int64_Parse, s)
        return ret
...
#        ret = CallCFunction(dlllib.Int64_ParseSS, s,enumstyle)
#        return ret
...
#        ret = CallCFunction(dlllib.Int64_ParseSP, s,intPtrprovider)
#        return ret
...
#        ret = CallCFunction(dlllib.Int64_ParseSSP, s,enumstyle,intPtrprovider)
#        return ret
...
#        ret = CallCFunction(dlllib.Int64_TryParse, s,intPtrresult)
#        return ret
...
#        ret = CallCFunction(dlllib.Int64_TryParseSSPR, s,enumstyle,intPtrprovider,intPtrresult)
#        return ret
...
#        ret = CallCFunction(dlllib.Int64_GetTypeCode,self.Ptr)
...
#        return objwraped
    ...
    def MaxValue()->int:
        ...
        ret = CallCFunction(dlllib.Int64_MaxValue)
        return ret
    ...
    def MinValue()->int:
        ...
        ret = CallCFunction(dlllib.Int64_MinValue)
        return ret
