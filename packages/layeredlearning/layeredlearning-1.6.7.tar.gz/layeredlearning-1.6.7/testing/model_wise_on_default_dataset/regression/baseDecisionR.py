...
from layerlearn.baseDecisionR import DecisionForestRegressor, DecisionSupportRegressor, DecisionLinearRegressor, DecisionKNNRegressor, DecisionXGBRegressor, DecisionCatRegressor, DecisionGradientRegressor, DecisionAdaRegressor, DecisionLightRegressor
import warnings
...
models = {
    "Decision Forest Regressor": DecisionForestRegressor(),
    "Decision Support Regressor": DecisionSupportRegressor(),
    "Decision Linear Regressor": DecisionLinearRegressor(),
    "Decision KNN Regressor": DecisionKNNRegressor(),
    "Decision XGBoost Regressor": DecisionXGBRegressor(),
    "Decision CatBoost Regressor": DecisionCatRegressor(),
    "Decision Gradient Boosting Regressor": DecisionGradientRegressor(),
    "Decision AdaBoost Regressor": DecisionAdaRegressor(),
    "Decision LightGBM Regressor": DecisionLightRegressor(),
}
...
ax.set_title('Comparison of Decision Model Regression Performance', fontsize=18, fontweight='bold')
