...
T = TypeVar("T", bound="UpdateRoleResponse404")


@_attrs_define
class UpdateRoleResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_role_response_404.additional_properties = d
        return update_role_response_404
