...
T = TypeVar("T", bound="SearchTenantsResponse403")


@_attrs_define
class SearchTenantsResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_tenants_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_tenants_response_403.additional_properties = d
        return search_tenants_response_403
