...
class SearchCampaignResourceMeta(BaseModel):
    """
    Total count of items, current offset and page limit
    """ # noqa: E501
    page: Optional[SearchCampaignResourceMetaPage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "page": SearchCampaignResourceMetaPage.from_dict(obj["page"]) if obj.get("page") is not None else None
        })
        return _obj
