...
T = TypeVar("T", bound="UnassignUserFromTenantResponse500")


@_attrs_define
class UnassignUserFromTenantResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unassign_user_from_tenant_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        unassign_user_from_tenant_response_500.additional_properties = d
        return unassign_user_from_tenant_response_500
