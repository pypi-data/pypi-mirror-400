...
def _build_cli(server: AgentServer) -> typer.Typer:
    ...
    def console(
        *,
        ...
        """
        Run [bold]RiyadhAI Agents[/bold] in [yellow]console[/yellow] mode.
        """
        if list_devices:
    ...
    def start(
        *,
        ...
        url: Annotated[
            Optional[str],  # noqa: UP007
            typer.Option(
                help="The WebSocket URL of your server.",
                envvar="RIYADAI_URL",
            ),
        ] = None,
        api_key: Annotated[
            Optional[str],  # noqa: UP007
            typer.Option(
                help="API key for authenticating with your server.",
                envvar="RIYADAI_API_KEY",
            ),
        ] = None,
        api_secret: Annotated[
            Optional[str],  # noqa: UP007
            typer.Option(
                help="API secret for authenticating with your server.",
                envvar="RIYADAI_API_SECRET",
            ),
        ] = None,
