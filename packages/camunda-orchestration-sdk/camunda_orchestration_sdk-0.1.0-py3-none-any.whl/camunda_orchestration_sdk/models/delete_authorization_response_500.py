...
T = TypeVar("T", bound="DeleteAuthorizationResponse500")


@_attrs_define
class DeleteAuthorizationResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_authorization_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_authorization_response_500.additional_properties = d
        return delete_authorization_response_500
