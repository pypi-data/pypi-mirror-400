...
#ifndef OBJECTS_PCASSAY2_PC_ANNOTATEDXREF_BASE_HPP
#define OBJECTS_PCASSAY2_PC_ANNOTATEDXREF_BASE_HPP
...
class CPC_AnnotatedXRef_Base : public CSerialObject
{
...
public:
    ...
    // types
    typedef objects::CPC_XRefData TXref;
    typedef CStringUTF8 TComment;
    typedef int TType;
...
inline
void CPC_AnnotatedXRef_Base::SetComment(CPC_AnnotatedXRef_Base::TComment&& value)
{
    m_Comment = std::forward<CPC_AnnotatedXRef_Base::TComment>(value);
    m_set_State[0] |= 0xc;
}
...
#ifdef _DEBUG
    if (!IsSetComment()) {
        m_Comment = UnassignedStringUTF8();
    }
#endif
    m_set_State[0] |= 0x4;
    return m_Comment;
...
#endif // OBJECTS_PCASSAY2_PC_ANNOTATEDXREF_BASE_HPP
