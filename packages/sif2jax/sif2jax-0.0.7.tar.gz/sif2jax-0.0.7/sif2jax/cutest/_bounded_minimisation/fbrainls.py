...
# Load FBRAINLS specific data
A_coeffs, A_lambdas, B_coeffs, B_lambdas, R_values = load_fbrain_data("fbrainls")


class FBRAINLS(AbstractBoundedMinimisation):
    """FBRAINLS - Brain tissue shear stress model as least squares.
