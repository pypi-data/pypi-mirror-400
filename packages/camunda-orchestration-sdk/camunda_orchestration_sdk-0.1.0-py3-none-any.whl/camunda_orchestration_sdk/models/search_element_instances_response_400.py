...
T = TypeVar("T", bound="SearchElementInstancesResponse400")


@_attrs_define
class SearchElementInstancesResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_element_instances_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_element_instances_response_400.additional_properties = d
        return search_element_instances_response_400
