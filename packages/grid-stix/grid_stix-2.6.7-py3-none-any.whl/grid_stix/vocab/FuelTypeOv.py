"""
Open vocabulary for fuel and energy source types used by generation assets
...
class FuelTypeOv(GridSTIXDomainObject):
    """
    Open vocabulary for fuel and energy source types used by generation assets
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize FuelTypeOv with Grid-STIX properties."""
