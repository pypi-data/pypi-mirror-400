...
T = TypeVar("T", bound="GetAuthenticationResponse403")


@_attrs_define
class GetAuthenticationResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_authentication_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_authentication_response_403.additional_properties = d
        return get_authentication_response_403
