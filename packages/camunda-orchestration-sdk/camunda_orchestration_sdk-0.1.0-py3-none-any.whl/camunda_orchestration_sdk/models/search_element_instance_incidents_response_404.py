...
T = TypeVar("T", bound="SearchElementInstanceIncidentsResponse404")


@_attrs_define
class SearchElementInstanceIncidentsResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_element_instance_incidents_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_element_instance_incidents_response_404.additional_properties = d
        return search_element_instance_incidents_response_404
