...
class SystemInterface(java.lang.Cloneable, java.io.Serializable):
    ...
    def getHydratePhase(self) -> jneqsim.neqsim.thermo.phase.PhaseInterface: ...
    ...
    def getOilAssayCharacterisation(self) -> jneqsim.neqsim.thermo.characterization.OilAssayCharacterisation: ...
...
class SystemElectrolyteCPAMM(SystemSrkCPA):
    ...
    @typing.overload
    def setDielectricMixingRule(self, dielectricMixingRule: jneqsim.neqsim.thermo.phase.PhaseElectrolyteCPAMM.DielectricMixingRule) -> None: ...
