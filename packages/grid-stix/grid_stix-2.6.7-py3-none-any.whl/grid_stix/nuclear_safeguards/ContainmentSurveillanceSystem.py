"""
Surveillance system monitoring containment and surveillance measures.
...
class ContainmentSurveillanceSystem(GridSTIXDomainObject):
    """
    Surveillance system monitoring containment and surveillance measures.
    ...
    _properties = OrderedDict(
        [
            ...
            ("x_provides_containment_for", ListProperty(StringProperty())),
        ]
    )

    def __init__(self, **kwargs: Any) -> None:
        """Initialize ContainmentSurveillanceSystem with Grid-STIX properties."""
