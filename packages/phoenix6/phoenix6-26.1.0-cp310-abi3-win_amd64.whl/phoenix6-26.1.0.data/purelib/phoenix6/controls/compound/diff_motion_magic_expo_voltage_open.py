...
@final
class Diff_MotionMagicExpoVoltage_Open:
    """
    Requires Phoenix Pro and CANivore;
    Differential control with Motion Magic® Expo average target and voltage
    difference target.
    ...
    def __init__(self, average_request: MotionMagicExpoVoltage, differential_request: VoltageOut):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_MotionMagicExpoVoltage_Open"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicExpoVoltage_Open")
    ...
    def with_average_request(self, new_average_request: MotionMagicExpoVoltage) -> 'Diff_MotionMagicExpoVoltage_Open':
        ...
        :returns: Itself
        :rtype: Diff_MotionMagicExpoVoltage_Open
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: VoltageOut) -> 'Diff_MotionMagicExpoVoltage_Open':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicExpoVoltage_Open':
        """
