...
Alph API Reference: API for the Alph platform - used by alphai CLI and SDKs
<!-- End Summary [summary] -->
...
with AlphSDK() as as_client:

    as_client.auth.cli(redirect_uri="http://127.0.0.1:8080", response_type="token", hostname="my-laptop")
...
async def main():
    ...
    async with AlphSDK() as as_client:

        await as_client.auth.cli_async(redirect_uri="http://127.0.0.1:8080", response_type="token", hostname="my-laptop")
...
### [Auth](https://github.com/americandatascience/alph-python-sdk/blob/master/docs/sdks/auth/README.md)

* [cli](https://github.com/americandatascience/alph-python-sdk/blob/master/docs/sdks/auth/README.md#cli) - CLI Authentication
...
* [create](https://github.com/americandatascience/alph-python-sdk/blob/master/docs/sdks/projects/README.md#create) - Create Project
...
* [get_status](https://github.com/americandatascience/alph-python-sdk/blob/master/docs/sdks/projects/README.md#get_status) - Get Project Status
...
### [User](https://github.com/americandatascience/alph-python-sdk/blob/master/docs/sdks/usersdk/README.md)

* [get](https://github.com/americandatascience/alph-python-sdk/blob/master/docs/sdks/usersdk/README.md#get) - Get User Info
...
[`AlphSDKError`](https://github.com/americandatascience/alph-python-sdk/blob/master/./src/alph_sdk/errors/alphsdkerror.py) is the base class for all HTTP error responses. It has the following properties:
...
with AlphSDK() as as_client:
    ...
    except errors.AlphSDKError as e:
...
### Error Classes
**Primary error:**
* [`AlphSDKError`](https://github.com/americandatascience/alph-python-sdk/blob/master/./src/alph_sdk/errors/alphsdkerror.py): The base class for HTTP error responses.
...
**Inherit from [`AlphSDKError`](https://github.com/americandatascience/alph-python-sdk/blob/master/./src/alph_sdk/errors/alphsdkerror.py)**:
* [`ResponseValidationError`](https://github.com/americandatascience/alph-python-sdk/blob/master/./src/alph_sdk/errors/responsevalidationerror.py): Type mismatch between the response data and the expected Pydantic model. Provides access to the Pydantic validation error via the `cause` attribute.
...
| #   | Server                  | Description              |
| --- | ----------------------- | ------------------------ |
| 0   | `https://runalph.ai`    | Production server        |
