...
__all__: list[str] = ['ExponentialProfileMeterVolts', 'Trajectory', 'TrajectoryConfig', 'TrajectoryGenerator', 'TrajectoryParameterizer', 'TrajectoryUtil', 'TrapezoidProfile', 'TrapezoidProfileRadians']
...
class Trajectory:
    ...
    class State:
        ...
        def __repr__(self) -> str:
            ...
        def interpolate(self, endValue: Trajectory.State, i: typing.SupportsFloat) -> Trajectory.State:
            """
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, states: collections.abc.Sequence[Trajectory.State]) -> None:
        """
...
class TrajectoryGenerator:
    ...
    @staticmethod
    @typing.overload
    def generateTrajectory(initial: wpimath.spline._spline.Spline3.ControlVector, interiorWaypoints: collections.abc.Sequence[wpimath.geometry._geometry.Translation2d], end: wpimath.spline._spline.Spline3.ControlVector, config: TrajectoryConfig) -> Trajectory:
        """
    ...
    @staticmethod
    @typing.overload
    def generateTrajectory(start: wpimath.geometry._geometry.Pose2d, interiorWaypoints: collections.abc.Sequence[wpimath.geometry._geometry.Translation2d], end: wpimath.geometry._geometry.Pose2d, config: TrajectoryConfig) -> Trajectory:
        """
    ...
    @staticmethod
    @typing.overload
    def generateTrajectory(controlVectors: collections.abc.Sequence[wpimath.spline._spline.Spline5.ControlVector], config: TrajectoryConfig) -> Trajectory:
        """
    ...
    @staticmethod
    @typing.overload
    def generateTrajectory(waypoints: collections.abc.Sequence[wpimath.geometry._geometry.Pose2d], config: TrajectoryConfig) -> Trajectory:
        """
        Generates a trajectory from the given waypoints and config. This method
        ...
        """
    @staticmethod
    def setErrorHandler(func: collections.abc.Callable[[str], None]) -> None:
        """
    ...
    @staticmethod
    @typing.overload
    def splinePointsFromSplines(splines: collections.abc.Sequence[wpimath.spline._spline.CubicHermiteSpline]) -> list[tuple[wpimath.geometry._geometry.Pose2d, wpimath.units.radians_per_meter]]:
        """
    ...
    @staticmethod
    @typing.overload
    def splinePointsFromSplines(splines: collections.abc.Sequence[wpimath.spline._spline.QuinticHermiteSpline]) -> list[tuple[wpimath.geometry._geometry.Pose2d, wpimath.units.radians_per_meter]]:
        """
        Generate spline points from a vector of splines by parameterizing the
        splines.
