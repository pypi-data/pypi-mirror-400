...
T = TypeVar("T", bound="UnassignRoleFromMappingRuleResponse404")


@_attrs_define
class UnassignRoleFromMappingRuleResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unassign_role_from_mapping_rule_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        unassign_role_from_mapping_rule_response_404.additional_properties = d
        return unassign_role_from_mapping_rule_response_404
