...
class ReplayBuffer:
    ...
    def advance_episode(self):
        ...
        assert self.circular or self.num_episodes < self.max_episodes, 'The replay buffer is full ({self.max_episodes} episodes) and is not set to be circular. Please set `circular = True` or clear the buffer.'
