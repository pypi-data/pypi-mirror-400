...
class DIAGIQB(AbstractBoundedMinimisation):
    """A variable dimension indefinite quadratic problem with eigenvalues
    clustered towards the bottom of the spectrum.
    ...
    def objective(self, y, args):
        ...
        # Compute shift: 1/n - n/2
        shift = 1.0 / rn - rn / 2.0

        # Create eigenvalues: lambda_i = i^2/n + shift
        i_vals = jnp.arange(1, n + 1, dtype=y.dtype)
        h_vals = i_vals * i_vals / rn + shift
