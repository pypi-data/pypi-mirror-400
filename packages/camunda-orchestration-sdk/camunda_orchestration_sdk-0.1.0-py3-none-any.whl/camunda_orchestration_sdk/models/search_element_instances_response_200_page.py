...
T = TypeVar("T", bound="SearchElementInstancesResponse200Page")


@_attrs_define
class SearchElementInstancesResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_element_instances_response_200_page = cls(
        ...
        search_element_instances_response_200_page.additional_properties = d
        return search_element_instances_response_200_page
