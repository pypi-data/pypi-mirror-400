...
from layerlearn.baseSupportR import SupportAdaRegressor, SupportCatRegressor, SupportKNNRegressor, SupportLightRegressor, SupportXGBRegressor, SupportGradientRegressor, SupportLinearRegressor, SupportForestRegressor, SupportDecisionRegressor
import warnings
...
models = {
    "Support Forest Regressor": SupportForestRegressor(),
    "Support Decision Regressor": SupportDecisionRegressor(),
    "Support Linear Regressor": SupportLinearRegressor(),
    "Support KNN Regressor": SupportKNNRegressor(),
    "Support XGBoost Regressor": SupportXGBRegressor(),
    "Support CatBoost Regressor": SupportCatRegressor(),
    "Support Gradient Boosting Regressor": SupportGradientRegressor(),
    "Support AdaBoost Regressor": SupportAdaRegressor(),
    "Support LightGBM Regressor": SupportLightRegressor(),
}
...
ax.set_title('Comparison of Support Model Regression Performance', fontsize=18, fontweight='bold')
