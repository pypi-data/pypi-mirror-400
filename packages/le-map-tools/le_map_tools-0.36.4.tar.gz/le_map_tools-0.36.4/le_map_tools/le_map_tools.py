...
class Map(core.Map):
    ...
    def __init__(self, **kwargs):
        ...
        self._USER_AGENT_PREFIX = "le_map_tools"
        self.kwargs = kwargs
        ...
        if kwargs["ee_initialize"]:
            self.roi_reducer = le.Reducer.mean()
    ...
    def _raster_filter(self, pair: Tuple[str, Dict[str, Any]]) -> bool:
        ...
        """
        return isinstance(pair[1]["ee_object"], (le.Image, le.ImageCollection))
    ...
    def _vector_filter(self, pair: Tuple[str, Dict[str, Any]]) -> bool:
        ...
        """
        return isinstance(
            pair[1]["ee_object"], (le.Geometry, le.Feature, le.FeatureCollection)
        )
    ...
    def add_ee_layer(
        self,
        ee_object: Union[
            le.FeatureCollection, le.Feature, le.Image, le.ImageCollection
        ],
        ...
        if layer is not None:
            if isinstance(ee_layer["ee_object"], (le.Image, le.ImageCollection)):
        ...
        if isinstance(ee_object, (le.Image, le.ImageCollection)):
            if has_plot_dropdown:
    ...
    def center_object(
        self, ee_object: Union[le.Element, le.Geometry], zoom: Optional[int] = None
    ) -> None:
    ...
    def marker_cluster(self):
        ...
        def handle_interaction(**kwargs):
            ...
            if kwargs.get("type") == "click":
                ...
                geom = le.Geometry.Point(latlon[1], latlon[0])
                feature = le.Feature(geom)
    ...
    def plot_demo(
        ...
        **kwargs,
        ...
        image = le.Image("LANDSAT/LE7_TOA_5YEAR/1999_2003").select([0, 1, 2, 3, 4, 6])
        self.addLayer(
            image,
        ...
        for i in range(iterations):
            try:
                coordinate = le.Geometry.Point([longitudes[i], latitudes[i]])
    ...
    def plot_raster(
        ...
        **kwargs,
        ...
        elif isinstance(ee_object, le.ImageCollection):
            ee_object = ee_object.mosaic()
        elif not isinstance(ee_object, le.Image):
            print(msg)
            return
        ...
        **kwargs,
        ...
        def left_dropdown_change(change):
            ...
            if left_dropdown_index is not None and left_dropdown_index >= 0:
                try:
                    if isinstance(left_ts, le.ImageCollection):
                        left_image = left_ts.toList(left_ts.size()).get(
                            left_dropdown_index
                        )
                    elif isinstance(left_ts, le.List):
                        left_image = left_ts.get(left_dropdown_index)
                    else:
                        print("The left_ts argument must be an ImageCollection.")
                        return

                    if isinstance(left_image, le.ImageCollection):
                        left_image = le.Image(left_image.mosaic())
                    elif isinstance(left_image, le.Image):
                        pass
                    else:
                        left_image = le.Image(left_image)
        ...
        def right_dropdown_change(change):
            ...
            if right_dropdown_index is not None and right_dropdown_index >= 0:
                try:
                    if isinstance(right_ts, le.ImageCollection):
                        right_image = right_ts.toList(left_ts.size()).get(
                            right_dropdown_index
                        )
                    elif isinstance(right_ts, le.List):
                        right_image = right_ts.get(right_dropdown_index)
                    else:
                        print("The left_ts argument must be an ImageCollection.")
                        return

                    if isinstance(right_image, le.ImageCollection):
                        right_image = le.Image(right_image.mosaic())
                    elif isinstance(right_image, le.Image):
                        pass
                    else:
                        right_image = le.Image(right_image)
    ...
    def basemap_demo(self):
        """A demo for using le_map_tools basemaps."""
    ...
    def add_time_slider(
        ...
        **kwargs,
        ...
        if isinstance(ee_object, le.Image):
            ...
            if labels is not None:
                ...
                labels = (
                    ...
                    .map(lambda d: le.Date(d).format(date_format))
                    .getInfo()
                )
        else:
        ...
        first = le.Image(ee_object.first())
        ...
        def slider_changed(change):
            ...
            image = le.Image(ee_object.toList(ee_object.size()).get(index))
            if layer_name not in self.ee_layers:
                self.addLayer(ee_object.toBands(), {}, layer_name, False, opacity)
    ...
    def add_labels(
        ...
        **kwargs,
        ...
        if isinstance(data, le.FeatureCollection):
    ...
    def layer_to_image(
        ...
        region: Optional[le.Geometry] = None,
        ...
        **kwargs: Any,
        ...
        if region is None:
            ...
            region = le.Geometry.BBox(west, south, east, north)
