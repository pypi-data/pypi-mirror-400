...
class HealthAPIWorkerResponse:
    ...
    """
    def __init__(self, name, running_tasks, running_tasks_gpu, running_tasks_cpu, running_tasks_local, scheduled_tasks, is_local, have_gpus, processors_count, local_processors_count, startup_id, *, validate_toml=False) -> None:
        self.name = name
    ...
    def clone(self) -> 'HealthAPIWorkerResponse':
        return HealthAPIWorkerResponse(self.name, self.running_tasks, self.running_tasks_gpu, self.running_tasks_cpu, self.running_tasks_local, self.scheduled_tasks, self.is_local, self.have_gpus, self.processors_count, self.local_processors_count, self.startup_id)
...
class UsersInsightsResponse:
    ...
    """
    def __init__(self, user, datasets, experiments, *, validate_toml=False) -> None:
        self.user = user
        self.datasets = datasets
        self.experiments = experiments
    ...
    def clone(self) -> 'UsersInsightsResponse':
        return UsersInsightsResponse(self.user, self.datasets, self.experiments)
