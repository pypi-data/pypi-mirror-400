...
Simultaneous EEG and fMRI signals during sleep from humans (OpenNeuro ``ds003768``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 2` :bdg-light:`License: CC0` :bdg-light:`Subjects: 33` :bdg-light:`Recordings: 255` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `10.18112/openneuro.ds003768.v1.0.0 <https://doi.org/10.18112/openneuro.ds003768.v1.0.0>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds003768>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds003768>`__
