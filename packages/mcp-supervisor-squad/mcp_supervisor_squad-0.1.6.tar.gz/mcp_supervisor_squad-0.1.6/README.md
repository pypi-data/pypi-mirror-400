...
- `squad_start(cwd, query, options?)` → creates a run, executes an internal **planner** pass to generate requirements + shared KB, then dispatches 1–2 coder jobs in worktrees, returns brief status (`lines` ≤ 3).
