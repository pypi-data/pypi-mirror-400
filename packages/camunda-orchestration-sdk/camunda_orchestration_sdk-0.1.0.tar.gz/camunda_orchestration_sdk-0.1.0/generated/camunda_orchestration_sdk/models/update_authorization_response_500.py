...
T = TypeVar("T", bound="UpdateAuthorizationResponse500")


@_attrs_define
class UpdateAuthorizationResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_authorization_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        update_authorization_response_500.additional_properties = d
        return update_authorization_response_500
