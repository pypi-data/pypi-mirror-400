...
T = TypeVar("T", bound="CreateAdminUserResponse403")


@_attrs_define
class CreateAdminUserResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_admin_user_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_admin_user_response_403.additional_properties = d
        return create_admin_user_response_403
