...
T = TypeVar("T", bound="ThrowJobErrorResponse500")


@_attrs_define
class ThrowJobErrorResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        throw_job_error_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        throw_job_error_response_500.additional_properties = d
        return throw_job_error_response_500
