...
#     'ldppackages': ['djangoldp_account', 'djangoldp_community',
#     #TODO: remove the unused dependencies as soon as they are not necessary in community anymore
#                     'modeltranslation', 'djangoldp_project', 'djangoldp_joboffer', 'djangoldp_skill', 'djangoldp_conversation',
#                     'djangoldp_circle', 'djangoldp_circle.tests', 'djangoldp_notification'],
