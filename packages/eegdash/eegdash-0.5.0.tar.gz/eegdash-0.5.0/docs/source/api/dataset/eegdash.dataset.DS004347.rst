...
Symmetry perception and affective responses: a combined EEG/EMG study (OpenNeuro ``ds004347``). Access recordings and metadata through EEGDash.
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds004347.v1.0.0 <https://doi.org/10.18112/openneuro.ds004347.v1.0.0>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds004347>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds004347>`__
