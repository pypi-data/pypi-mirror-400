...
T = TypeVar("T", bound="SearchIncidentsResponse403")


@_attrs_define
class SearchIncidentsResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_incidents_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_incidents_response_403.additional_properties = d
        return search_incidents_response_403
