"""
Embedded controller within EVSE that manages charging authorization, session scheduling, energy delivery, and communication with utility systems or aggregators.
...
class EvseController(GridSTIXDomainObject):
    """
    Embedded controller within EVSE that manages charging authorization, session scheduling, energy delivery, and communication with utility systems or aggregators.
    ...
    _properties = OrderedDict(
        [
            ...
            ("x_controls_evse", ListProperty(StringProperty())),
        ]
    )

    def __init__(self, **kwargs: Any) -> None:
        """Initialize EvseController with Grid-STIX properties."""
