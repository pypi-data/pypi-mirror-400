...
T = TypeVar("T", bound="DeleteTenantResponse400")


@_attrs_define
class DeleteTenantResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_tenant_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_tenant_response_400.additional_properties = d
        return delete_tenant_response_400
