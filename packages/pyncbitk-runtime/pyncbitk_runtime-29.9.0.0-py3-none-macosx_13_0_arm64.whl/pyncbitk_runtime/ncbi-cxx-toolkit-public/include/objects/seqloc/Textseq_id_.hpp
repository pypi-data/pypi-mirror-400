...
{
    m_Name = std::forward<CTextseq_id_Base::TName>(value);
    m_set_State[0] |= 0x3;
}
...
{
    m_Accession = std::forward<CTextseq_id_Base::TAccession>(value);
    m_set_State[0] |= 0xc;
}
...
{
    m_Release = std::forward<CTextseq_id_Base::TRelease>(value);
    m_set_State[0] |= 0x30;
}
