...
class MAVLink_wifi_credentials_message(MAVLink_message):
    ...
    def __init__(self, behavior, auth_type, hidden, ssid, password):
...
class MAVLink(object):
    ...
    def wifi_credentials_encode(self, behavior, auth_type, hidden, ssid, password):
        """
        Used to query/set the wifi credientials of the device
    ...
    def wifi_credentials_send(self, behavior, auth_type, hidden, ssid, password, force_mavlink1=False):
        """
        Used to query/set the wifi credientials of the device
