...
class DifferentialDutyCycle:
    ...
    :param average_output: Proportion of supply voltage to apply on the Average axis
                           in fractional units between -1 and +1.
    :type average_output: float
    ...
    def __init__(self, average_output: float, differential_position: rotation, enable_foc: bool = True, differential_slot: int = 1, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, ignore_software_limits: bool = False, use_timesync: bool = False):
        ...
        """
        Proportion of supply voltage to apply on the Average axis in fractional units
        between -1 and +1.
    ...
    def __str__(self) -> str:
        ...
        ss.append("    average_output: " + str(self.average_output) + " fractional")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlDifferentialDutyCycle(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.average_output, self.differential_position, self.enable_foc, self.differential_slot, self.override_brake_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.ignore_hardware_limits, self.ignore_software_limits, self.use_timesync))

    
    def with_average_output(self, new_average_output: float) -> 'DifferentialDutyCycle':
        """
        Modifies this Control Request's average_output parameter and returns itself for
        ...
        :param new_average_output: Parameter to modify
        :type new_average_output: float
        :returns: Itself
        :rtype: DifferentialDutyCycle
        """
        self.average_output = new_average_output
        return self
    ...
    def with_ignore_software_limits(self, new_ignore_software_limits: bool) -> 'DifferentialDutyCycle':
        """
    ...
    def control_info(self) -> dict:
        ...
        control_info["average_output"] = self.average_output
