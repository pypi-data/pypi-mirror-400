...
T = TypeVar("T", bound="AtlassianBambooIntegration")


@_attrs_define
class AtlassianBambooIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        atlassian_bamboo_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        atlassian_bamboo_integration.additional_properties = d
        return atlassian_bamboo_integration
