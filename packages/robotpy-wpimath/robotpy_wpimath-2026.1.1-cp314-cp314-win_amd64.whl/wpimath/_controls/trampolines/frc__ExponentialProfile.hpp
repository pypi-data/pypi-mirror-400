...
struct bind_frc__ExponentialProfile {
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    cls_ExponentialProfile.doc() = 
      ...
      "`IsFinished()`.";
    cls_ExponentialProfile.def(py::init<Constraints>()
      , py::arg("constraints")
      , release_gil()
      , py::doc(
    ...
    cls_ExponentialProfile.def("calculate", &frc::ExponentialProfile<Distance, Input>::Calculate
    ...
    cls_ExponentialProfile.def("calculateInflectionPoint", static_cast<State (frc::ExponentialProfile<Distance, Input>::*)(const State&, const State&) const>(&frc::ExponentialProfile<Distance, Input>::CalculateInflectionPoint)
    ...
    cls_ExponentialProfile.def("timeLeftUntil", &frc::ExponentialProfile<Distance, Input>::TimeLeftUntil
      , py::arg("current"), py::arg("goal")
      , release_gil()
      , py::doc(
    ...
    cls_ExponentialProfile.def("calculateProfileTiming", static_cast<ProfileTiming (frc::ExponentialProfile<Distance, Input>::*)(const State&, const State&) const>(&frc::ExponentialProfile<Distance, Input>::CalculateProfileTiming)
      , py::arg("current"), py::arg("goal")
      , release_gil()
      , py::doc(
    ...
    cls_ProfileTiming.def(py::init<>(), release_gil());
    cls_ProfileTiming.def("isFinished", &frc::ExponentialProfile<Distance, Input>::ProfileTiming::IsFinished
      , py::arg("t")
      , release_gil()
      , py::doc(
    ...
    cls_ProfileTiming.def_readonly("inflectionTime", &frc::ExponentialProfile<Distance, Input>::ProfileTiming::inflectionTime, py::doc("Profile inflection time."));
    cls_ProfileTiming.def_readonly("totalTime", &frc::ExponentialProfile<Distance, Input>::ProfileTiming::totalTime, py::doc("Total profile time."));
    cls_Constraints.doc() = "Profile constraints.";
    cls_Constraints.def("maxVelocity", &frc::ExponentialProfile<Distance, Input>::Constraints::MaxVelocity
      , release_gil()
      , py::doc(
    ...
    cls_Constraints.def_readonly("maxInput", &frc::ExponentialProfile<Distance, Input>::Constraints::maxInput, py::doc("Maximum unsigned input voltage."));
    cls_Constraints.def_readonly("A", &frc::ExponentialProfile<Distance, Input>::Constraints::A, py::doc("The State-Space 1x1 system matrix."));
    cls_Constraints.def_readonly("B", &frc::ExponentialProfile<Distance, Input>::Constraints::B, py::doc("The State-Space 1x1 input matrix."));
    cls_Constraints
    ...
    cls_State.def(py::self == py::self
    );
    cls_State.def_readonly("position", &frc::ExponentialProfile<Distance, Input>::State::position, py::doc("The position at this state."));
    cls_State.def_readonly("velocity", &frc::ExponentialProfile<Distance, Input>::State::velocity, py::doc("The velocity at this state."));
    cls_State
