"""
ragctl Unified Configuration System
...
Usage:
    ...
    # Override from file
    config = AtlasConfig.from_file("~/.ragctl/config.yml")
"""
...
def get_atlas_config(reload: bool = False) -> AtlasConfig:
    ...
    if _global_config is None or reload:
        ...
        default_config_path = Path.home() / ".ragctl" / "config.yml"
