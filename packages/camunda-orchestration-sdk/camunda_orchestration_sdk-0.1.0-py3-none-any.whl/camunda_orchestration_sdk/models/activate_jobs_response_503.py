...
T = TypeVar("T", bound="ActivateJobsResponse503")


@_attrs_define
class ActivateJobsResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activate_jobs_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        activate_jobs_response_503.additional_properties = d
        return activate_jobs_response_503
