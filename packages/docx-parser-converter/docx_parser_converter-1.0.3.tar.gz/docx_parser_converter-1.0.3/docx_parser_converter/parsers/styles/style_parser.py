...
from ..document.paragraph_properties_parser import parse_paragraph_properties
from ..document.run_properties_parser import parse_run_properties
from ..document.table_cell_properties_parser import parse_table_cell_properties
from ..document.table_properties_parser import parse_table_properties
from ..document.table_row_properties_parser import parse_table_row_properties
from ..utils import (
    find_all_children,
    find_child,
    get_attribute,
