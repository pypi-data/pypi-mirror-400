...
class TestGetReservationsWithRateDetailsResponseDataInnerSource(unittest.TestCase):
    """GetReservationsWithRateDetailsResponseDataInnerSource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservationsWithRateDetailsResponseDataInnerSource:
        """Test GetReservationsWithRateDetailsResponseDataInnerSource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservationsWithRateDetailsResponseDataInnerSource`
        """
        model = GetReservationsWithRateDetailsResponseDataInnerSource()
        if include_optional:
            return GetReservationsWithRateDetailsResponseDataInnerSource(
                name = '',
    ...
    def testGetReservationsWithRateDetailsResponseDataInnerSource(self):
        """Test GetReservationsWithRateDetailsResponseDataInnerSource"""
