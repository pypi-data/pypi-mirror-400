...
def root(context, missing=missing):
    ...
    if t_2((undefined(name='platform') if l_0_platform is missing else l_0_platform)):
        pass
        for l_1_profile in t_1(environment.getattr(environment.getattr(environment.getattr((undefined(name='platform') if l_0_platform is missing else l_0_platform), 'trident'), 'mmu'), 'queue_profiles'), sort_key='name'):
