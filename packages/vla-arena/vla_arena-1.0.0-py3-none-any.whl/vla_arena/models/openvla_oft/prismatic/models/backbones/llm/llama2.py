...
from vla_arena.models.openvla_oft.prismatic.models.backbones.llm.base_llm import (
    HFCausalLLMBackbone,
)
...
class LLaMa2LLMBackbone(HFCausalLLMBackbone):
    ...
    def prompt_builder_fn(self) -> type[PromptBuilder]:
        if self.identifier.startswith('llama2-') and self.identifier.endswith(
            '-pure'
        ):
            ...
            'llama2-'
        ) and self.identifier.endswith('-chat'):
