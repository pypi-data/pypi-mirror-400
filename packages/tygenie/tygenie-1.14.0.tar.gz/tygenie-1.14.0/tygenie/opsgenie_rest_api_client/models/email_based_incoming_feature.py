...
T = TypeVar("T", bound="EmailBasedIncomingFeature")
...
class EmailBasedIncomingFeature:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        email_based_incoming_feature = cls(
        ...
        email_based_incoming_feature.additional_properties = d
        return email_based_incoming_feature
