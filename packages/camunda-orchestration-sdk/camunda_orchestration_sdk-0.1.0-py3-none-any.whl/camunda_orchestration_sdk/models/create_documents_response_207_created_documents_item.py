...
from ..models.create_documents_response_207_created_documents_item_camunda_document_type import (
    CreateDocumentsResponse207CreatedDocumentsItemCamundaDocumentType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.create_documents_response_207_created_documents_item_metadata import (
        CreateDocumentsResponse207CreatedDocumentsItemMetadata,
    )


T = TypeVar("T", bound="CreateDocumentsResponse207CreatedDocumentsItem")


@_attrs_define
class CreateDocumentsResponse207CreatedDocumentsItem:
    """
    Attributes:
        camunda_document_type (CreateDocumentsResponse207CreatedDocumentsItemCamundaDocumentType | Unset): Document
        ...
        metadata (CreateDocumentsResponse207CreatedDocumentsItemMetadata | Unset): Information about the document.
    """

    camunda_document_type: (
        CreateDocumentsResponse207CreatedDocumentsItemCamundaDocumentType | Unset
    ) = UNSET
    store_id: str | Unset = UNSET
    document_id: DocumentId | Unset = UNSET
    content_hash: str | Unset = UNSET
    metadata: CreateDocumentsResponse207CreatedDocumentsItemMetadata | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        metadata: CreateDocumentsResponse207CreatedDocumentsItemMetadata | Unset
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = CreateDocumentsResponse207CreatedDocumentsItemMetadata.from_dict(
                _metadata
            )

        create_documents_response_207_created_documents_item = cls(
        ...
        create_documents_response_207_created_documents_item.additional_properties = d
        return create_documents_response_207_created_documents_item
