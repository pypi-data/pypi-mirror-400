...
T = TypeVar("T", bound="CreateAdminUserResponse503")


@_attrs_define
class CreateAdminUserResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_admin_user_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_admin_user_response_503.additional_properties = d
        return create_admin_user_response_503
