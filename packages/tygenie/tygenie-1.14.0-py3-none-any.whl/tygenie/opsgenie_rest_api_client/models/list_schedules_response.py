...
class ListSchedulesResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, List['Schedule']]):
    """

    request_id: str
    took: float = 0.0
    expandable: Union[Unset, List[str]] = UNSET
    data: Union[Unset, List["Schedule"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = Schedule.from_dict(data_item_data)
        ...
        list_schedules_response.additional_properties = d
