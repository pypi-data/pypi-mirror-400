...
Changes in behavioral priority influence the accessibility of working memory content - Experiment 2 (OpenNeuro ``ds004520``). Access recordings and metadata through EEGDash.
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds004520.v1.0.1 <https://doi.org/10.18112/openneuro.ds004520.v1.0.1>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds004520>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds004520>`__
