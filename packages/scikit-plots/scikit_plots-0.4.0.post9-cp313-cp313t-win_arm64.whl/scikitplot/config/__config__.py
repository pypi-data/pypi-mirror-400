...
CONFIG = _cleanup(
  {
    "Build Dependencies": {
      "blas": {
        ...
        "include directory": r"C:/Users/runneradmin/AppData/Local/Temp/cibw-run-oikueqdh/cp313t-win_arm64/build/venv/Lib/site-packages/scipy_openblas64/include",
        "lib directory": r"C:/Users/runneradmin/AppData/Local/Temp/cibw-run-oikueqdh/cp313t-win_arm64/build/venv/Lib/site-packages/scipy_openblas64/lib",
        "openblas configuration": r"OpenBLAS 0.3.29.dev  USE64BITINT NO_AFFINITY ARMV8 MAX_THREADS=4",
        "pc file directory": r"C:/a/scikit-plots/scikit-plots/.openblas",
      },
      "lapack": {
        "name": "scipy-openblas",
        "found": bool("True".lower().replace('false', '')),
    ...
    "Python Information": {
      "path": r"C:\Users\runneradmin\AppData\Local\Temp\build-env-6ocb7r92\Scripts\python.exe",
      "version": "3.13",
    },
  }
)
