...
class NCVXQP6(AbstractConstrainedQuadraticProblem):
    """NCVXQP6 problem - a non-convex quadratic program.
    ...
    def expected_result(self):
        ...
        raise NotImplementedError("Expected result not available for NCVXQP6")
