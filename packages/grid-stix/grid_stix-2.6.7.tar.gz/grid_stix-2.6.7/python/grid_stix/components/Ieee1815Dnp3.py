"""
Distributed Network Protocol 3.0 (DNP3) used for SCADA-based DER telemetry and control.
...
class Ieee1815Dnp3(GridSTIXDomainObject):
    """
    Distributed Network Protocol 3.0 (DNP3) used for SCADA-based DER telemetry and control.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize Ieee1815Dnp3 with Grid-STIX properties."""
