    ...
    def make_instance(self, include_optional) -> GetReservationAssignmentsResponse:
        ...
        if include_optional:
            return GetReservationAssignmentsResponse(
                success = True,
                data = [
                    cloudbeds_pms_v1_3.models.get_reservation_assignments_response_data_inner.GetReservationAssignmentsResponse_data_inner(
                        guest_name = '', 
                        reservation_id = '', 
                        unassigned = 56, 
                        assigned = [
                            cloudbeds_pms_v1_3.models.get_reservation_assignments_response_data_inner_assigned_inner.GetReservationAssignmentsResponse_data_inner_assigned_inner(
                                room_type_id = '', 
                                room_type_name = '', 
