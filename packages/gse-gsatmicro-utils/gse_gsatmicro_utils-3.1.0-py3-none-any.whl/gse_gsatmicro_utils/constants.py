...
# GSE USB vendor/manufacturer string (for port detection)
USB_VENDOR_STRING = "GSE"
# Management serial port name (for port detection)
USB_MGMT_PORT_NAME = "GSE port mgmt"
# Console serial port name (for port detection)
USB_CONSOLE_PORT_NAME = "GSE port term"
# Logs serial port name (for port detection)
USB_LOGS_PORT_NAME = "GSE port logs"