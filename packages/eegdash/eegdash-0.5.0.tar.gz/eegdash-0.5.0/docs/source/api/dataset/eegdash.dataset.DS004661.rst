...
ANDI (OpenNeuro ``ds004661``). Access recordings and metadata through EEGDash.
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds004661.v1.1.0 <https://doi.org/10.18112/openneuro.ds004661.v1.1.0>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds004661>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds004661>`__
