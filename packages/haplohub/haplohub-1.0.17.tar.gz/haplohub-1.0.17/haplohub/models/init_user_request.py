...
class InitUserRequest(BaseModel):
    ...
    organization_slug: StrictStr = Field(...)
    organization_display_name: StrictStr = Field(...)
    __properties = ["full_name", "email", "organization_slug", "organization_display_name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InitUserRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InitUserRequest:
        """Create an instance of InitUserRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InitUserRequest.parse_obj(obj)

        _obj = InitUserRequest.parse_obj(
            {
                "full_name": obj.get("full_name"),
                "email": obj.get("email"),
                "organization_slug": obj.get("organization_slug"),
                "organization_display_name": obj.get("organization_display_name"),
            }
        )
        return _obj
