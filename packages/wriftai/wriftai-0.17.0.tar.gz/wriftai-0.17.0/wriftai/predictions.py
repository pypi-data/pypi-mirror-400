...
class Predictions(Resource):
    ...
    _ERROR_MSG_INVALID_MODEL = (
        "Model must be in either owner/name or owner/name:version-number format."
    )
    ...
    def _parse_model(self, model: str) -> tuple[str, str, str | None]:
        """Parses model string into owner, name, and version number.
        ...
        """
        owner, sep, name_part = model.partition("/")
    ...
    def _prediction_path(
        ...
        Raises:
            ValueError: When the provided model reference is not in owner/name or
                owner/name:version-number format.
        """
        model_owner, model_name, version_number = self._parse_model(model=model)
