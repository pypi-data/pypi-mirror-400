...
from layerlearn.baseGradientR import GradientAdaRegressor, GradientCatRegressor, GradientDecisionRegressor, GradientForestRegressor, GradientKNNRegressor, GradientLinearRegressor, GradientLightRegressor, GradientSupportRegressor, GradientXGBRegressor
...
models = {
    "Gradient Forest Regressor": GradientForestRegressor(),
    "Gradient Support Regressor": GradientSupportRegressor(),
    "Gradient Linear Regressor": GradientLinearRegressor(),
    "Gradient KNN Regressor": GradientKNNRegressor(),
    "Gradient XGBoost Regressor": GradientXGBRegressor(),
    "Gradient Ada Regressor": GradientAdaRegressor(),
    "Gradient Cat Regressor": GradientCatRegressor(),
    "Gradient Decision Regressor": GradientDecisionRegressor(),
    "Gradient LightGBM Regressor": GradientLightRegressor(),
}
...
ax.set_title('Comparison of Gradient Model Regression Performance', fontsize=18, fontweight='bold')
