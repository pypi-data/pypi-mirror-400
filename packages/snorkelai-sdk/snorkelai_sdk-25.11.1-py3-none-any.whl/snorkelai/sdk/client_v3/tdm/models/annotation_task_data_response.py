...
if TYPE_CHECKING:
    # fmt: off
    from ..models.datapoint_status_stats import DatapointStatusStats  # noqa: F401
    # fmt: on
...
class AnnotationTaskDataResponse:
    ...
    Attributes:
        ...
        name (str):
        status_stats (List['DatapointStatusStats']):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status_stats = []
        _status_stats = d.pop("status_stats")
        for status_stats_item_data in _status_stats:
            status_stats_item = DatapointStatusStats.from_dict(status_stats_item_data)
