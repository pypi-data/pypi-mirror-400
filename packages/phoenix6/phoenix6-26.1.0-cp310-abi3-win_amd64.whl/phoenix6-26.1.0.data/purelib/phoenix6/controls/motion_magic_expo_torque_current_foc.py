...
class MotionMagicExpoTorqueCurrentFOC:
    ...
    def __init__(self, position: rotation, feed_forward: ampere = 0.0, slot: int = 0, override_coast_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, ignore_software_limits: bool = False, use_timesync: bool = False):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "MotionMagicExpoTorqueCurrentFOC"
    ...
    def with_ignore_software_limits(self, new_ignore_software_limits: bool) -> 'MotionMagicExpoTorqueCurrentFOC':
        """
