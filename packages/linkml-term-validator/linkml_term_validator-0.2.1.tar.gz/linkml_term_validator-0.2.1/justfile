...
gh-add-topics:
  gh repo edit --add-topic "linkml-term-validator,monarchinitiative,linkml"
...
gh-invite-the-dragon:
  gh api repos/linkml/linkml-term-validator/collaborators/dragon-ai-agent -X PUT -f permission=push
