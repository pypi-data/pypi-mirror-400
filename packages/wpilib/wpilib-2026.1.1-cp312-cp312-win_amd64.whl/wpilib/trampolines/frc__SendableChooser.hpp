...
#include <trampolines/frc__SendableChooserBase.hpp>

namespace frc {

template <typename T, typename CfgBase = swgen::EmptyTrampolineCfg>
...
struct bind_frc__SendableChooser {
  ...
  static_assert(std::is_abstract<SendableChooser_Trampoline>::value == false, "frc::SendableChooser<T> " SEMIWRAP_BAD_TRAMPOLINE);
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    cls_SendableChooser.doc() = 
      ...
      "@see SmartDashboard";
    cls_SendableChooser.def(py::init<>()
      , release_gil()
    );
    cls_SendableChooser.def("addOption", &frc::SendableChooser<T>::AddOption
    ...
    cls_SendableChooser.def("setDefaultOption", &frc::SendableChooser<T>::SetDefaultOption
      , py::arg("name"), py::arg("object")
      , release_gil()
      , py::doc(
    ...
    cls_SendableChooser.def("getSelected", [](frc::SendableChooser<T> * __that) -> py::object {
    ...
    cls_SendableChooser.def("onChange", [](frc::SendableChooser<T> *self, std::function<void(T)> fn) {
    ...
    cls_SendableChooser.def("initSendable", &frc::SendableChooser<T>::InitSendable
      , py::arg("builder")
      , release_gil()
    );
    if (set_doc) {
