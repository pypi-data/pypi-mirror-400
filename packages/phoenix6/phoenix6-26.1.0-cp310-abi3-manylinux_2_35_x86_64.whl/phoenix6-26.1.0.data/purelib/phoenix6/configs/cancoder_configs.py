...
class CANcoderConfigurator(ParentConfigurator):
    ...
    @overload
    def refresh(self, configs: CANcoderConfiguration, timeout_seconds: second = 0.100) -> StatusCode:
        """
        ...
        :type configs: CANcoderConfiguration
    ...
    @overload
    def apply(self, configs: CANcoderConfiguration, timeout_seconds: second = 0.100) -> StatusCode:
        """
    ...
    @overload
    def refresh(self, configs: MagnetSensorConfigs, timeout_seconds: second = 0.100) -> StatusCode:
        """
        Refreshes the values of the specified config group.
        ...
        :param configs: The configs to refresh
        :type configs: MagnetSensorConfigs
        :param timeout_seconds: Maximum amount of time to wait when performing configuration
        :type timeout_seconds: second
        :returns: StatusCode of refreshing the configs
        :rtype: StatusCode
    ...
    @overload
    def apply(self, configs: MagnetSensorConfigs, timeout_seconds: second = 0.100) -> StatusCode:
        """
        Applies the contents of the specified config to the device.
