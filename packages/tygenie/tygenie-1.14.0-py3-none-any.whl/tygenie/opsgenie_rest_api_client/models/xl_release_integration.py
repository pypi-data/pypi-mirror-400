...
T = TypeVar("T", bound="XLReleaseIntegration")


@_attrs_define
class XLReleaseIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        xl_release_integration.additional_properties = d
        return xl_release_integration
