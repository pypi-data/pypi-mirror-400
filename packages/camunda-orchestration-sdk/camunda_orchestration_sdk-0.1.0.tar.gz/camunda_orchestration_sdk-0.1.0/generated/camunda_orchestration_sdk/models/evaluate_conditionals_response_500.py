...
T = TypeVar("T", bound="EvaluateConditionalsResponse500")


@_attrs_define
class EvaluateConditionalsResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        evaluate_conditionals_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        evaluate_conditionals_response_500.additional_properties = d
        return evaluate_conditionals_response_500
