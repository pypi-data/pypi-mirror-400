...
class Diff_MotionMagicVelocityDutyCycle_Open:
    ...
    Differential control with Motion Magic® Velocity average target and duty cycle
    difference target.
    ...
    def __init__(self, average_request: MotionMagicVelocityDutyCycle, differential_request: DutyCycleOut):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_MotionMagicVelocityDutyCycle_Open"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicVelocityDutyCycle_Open")
    ...
    def with_average_request(self, new_average_request: MotionMagicVelocityDutyCycle) -> 'Diff_MotionMagicVelocityDutyCycle_Open':
        ...
        :returns: Itself
        :rtype: Diff_MotionMagicVelocityDutyCycle_Open
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: DutyCycleOut) -> 'Diff_MotionMagicVelocityDutyCycle_Open':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicVelocityDutyCycle_Open':
        """
