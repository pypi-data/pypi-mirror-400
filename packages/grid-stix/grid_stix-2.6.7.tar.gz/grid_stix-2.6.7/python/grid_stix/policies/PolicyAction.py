"""
Represents possible actions that can be enforced by policies, inheriting from STIX Course of Action.
...
class PolicyAction(GridSTIXDomainObject):
    """
    Represents possible actions that can be enforced by policies, inheriting from STIX Course of Action.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize PolicyAction with Grid-STIX properties."""
