...
T = TypeVar("T", bound="HostedGraphiteIntegration")
...
class HostedGraphiteIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        hosted_graphite_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        hosted_graphite_integration.additional_properties = d
        return hosted_graphite_integration
