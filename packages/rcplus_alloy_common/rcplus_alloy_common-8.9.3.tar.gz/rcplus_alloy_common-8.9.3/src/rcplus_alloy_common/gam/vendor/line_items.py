...
<wsdl:definitions xmlns:tns="https://www.google.com/apis/ads/publisher/v202502" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:wsdlsoap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" targetNamespace="https://www.google.com/apis/ads/publisher/v202502">
<wsdl:types>
<schema xmlns="http://www.w3.org/2001/XMLSchema" xmlns:jaxb="http://java.sun.com/xml/ns/jaxb" xmlns:tns="https://www.google.com/apis/ads/publisher/v202502" elementFormDefault="qualified" jaxb:version="1.0" targetNamespace="https://www.google.com/apis/ads/publisher/v202502">
<annotation>
<appinfo>
...
<complexType name="ActivateLineItems">
<annotation>
<documentation> The action used for activating {@link LineItem} objects. </documentation>
</annotation>
<complexContent>
<extension base="tns:LineItemAction">
<sequence/>
</extension>
</complexContent>
</complexType>
...
<complexType name="ArchiveLineItems">
<annotation>
<documentation> The action used for archiving {@link LineItem} objects. </documentation>
</annotation>
<complexContent>
<extension base="tns:LineItemAction">
<sequence/>
...
<annotation>
<documentation> The action used for deleting {@link LineItem} objects. A line item can be deleted if it has never been eligible to serve. Note: deleted line items will still count against your network limits. For more information, see the <a href="https://support.google.com/admanager/answer/1628457">Help Center</a>. </documentation>
</annotation>
<complexContent>
<extension base="tns:LineItemAction">
<sequence/>
...
<complexType abstract="true" name="LineItemAction">
<annotation>
<documentation> Represents the actions that can be performed on {@link LineItem} objects. </documentation>
</annotation>
<sequence/>
</complexType>
...
<complexType name="LineItemPage">
<annotation>
<documentation> Captures a page of {@link LineItem} objects. </documentation>
</annotation>
<sequence>
...
<element maxOccurs="unbounded" minOccurs="0" name="results" type="tns:LineItem">
<annotation>
<documentation> The collection of line items contained within this page. </documentation>
</annotation>
</element>
</sequence>
</complexType>
...
<complexType name="PauseLineItems">
<annotation>
<documentation> The action used for pausing {@link LineItem} objects. </documentation>
</annotation>
<complexContent>
<extension base="tns:LineItemAction">
<sequence/>
...
<complexType name="ReleaseLineItems">
<annotation>
<documentation> The action used for releasing {@link LineItem} objects. </documentation>
</annotation>
<complexContent>
<extension base="tns:LineItemAction">
<sequence/>
...
<complexType name="ReserveAndOverbookLineItems">
<annotation>
<documentation> The action used for reserving and overbooking {@link LineItem} objects. </documentation>
</annotation>
<complexContent>
<extension base="tns:ReserveLineItems">
<sequence/>
</extension>
</complexContent>
</complexType>
...
<annotation>
<documentation> The action used for reserving {@link LineItem} objects. </documentation>
</annotation>
<complexContent>
<extension base="tns:LineItemAction">
<sequence>
...
<complexType name="ResumeAndOverbookLineItems">
<annotation>
<documentation> The action used for resuming and overbooking {@link LineItem} objects. </documentation>
</annotation>
<complexContent>
<extension base="tns:ResumeLineItems">
<sequence/>
</extension>
</complexContent>
</complexType>
...
<annotation>
<documentation> The action used for resuming {@link LineItem} objects. </documentation>
</annotation>
<complexContent>
<extension base="tns:LineItemAction">
<sequence>
...
<complexType name="UnarchiveLineItems">
<annotation>
<documentation> The action used for unarchiving {@link LineItem} objects. </documentation>
</annotation>
<complexContent>
<extension base="tns:LineItemAction">
<sequence/>
...
<enumeration value="CREATIVE_SKIPPABILITY_MISMATCH_WITH_LINE_ITEM">
<annotation>
<documentation> Creative and line item skippability must match. </documentation>
</annotation>
</enumeration>
<enumeration value="UNKNOWN">
<annotation>
...
<annotation>
<documentation> Cannot update (archive, pause, resume) an {@link Order} because it has more than the allowed number of {@link LineItem}s. </documentation>
</annotation>
</enumeration>
<enumeration value="UNKNOWN">
<annotation>
...
<annotation>
<documentation> Creates new {@link LineItem} objects. </documentation>
</annotation>
<complexType>
<sequence>
<element maxOccurs="unbounded" minOccurs="0" name="lineItems" type="tns:LineItem"/>
</sequence>
</complexType>
</element>
<element name="createLineItemsResponse">
<complexType>
<sequence>
<element maxOccurs="unbounded" minOccurs="0" name="rval" type="tns:LineItem"/>
</sequence>
</complexType>
</element>
...
<annotation>
<documentation> Gets a {@link LineItemPage} of {@link LineItem} objects that satisfy the given {@link Statement#query}. The following fields are supported for filtering: <table> <tbody> <tr> <th>PQL property</th> <th>Entity property</th> </tr> <tr> <td> {@code CostType} </td> <td> {@link LineItem#costType} </td> </tr> <tr> <td> {@code CreationDateTime} </td> <td> {@link LineItem#creationDateTime} </td> </tr> <tr> <td> {@code DeliveryRateType} </td> <td> {@link LineItem#deliveryRateType} </td> </tr> <tr> <td> {@code EndDateTime} </td> <td> {@link LineItem#endDateTime} </td> </tr> <tr> <td> {@code ExternalId} </td> <td> {@link LineItem#externalId} </td> </tr> <tr> <td> {@code Id} </td> <td> {@link LineItem#id} </td> </tr> <tr> <td> {@code IsMissingCreatives} </td> <td> {@link LineItem#isMissingCreatives} </td> </tr> <tr> <td> {@code IsSetTopBoxEnabled} </td> <td> {@link LineItem#isSetTopBoxEnabled} </td> </tr> <tr> <td> {@code LastModifiedDateTime} </td> <td> {@link LineItem#lastModifiedDateTime} </td> </tr> <tr> <td> {@code LineItemType} </td> <td> {@link LineItem#lineItemType} </td> </tr> <tr> <td> {@code Name} </td> <td> {@link LineItem#name} </td> </tr> <tr> <td> {@code OrderId} </td> <td> {@link LineItem#orderId} </td> </tr> <tr> <td> {@code StartDateTime} </td> <td> {@link LineItem#startDateTime} </td> </tr> <tr> <td> {@code Status} </td> <td> {@link LineItem#status} </td> </tr> <tr> <td> {@code UnitsBought} </td> <td> {@link LineItem#unitsBought} </td> </tr> </tbody> </table> </documentation>
</annotation>
<complexType>
<sequence>
...
<complexType>
<sequence>
<element maxOccurs="1" minOccurs="0" name="rval" type="tns:LineItemPage"/>
</sequence>
</complexType>
</element>
<element name="performLineItemAction">
<annotation>
<documentation> Performs actions on {@link LineItem} objects that match the given {@link Statement#query}. </documentation>
</annotation>
<complexType>
<sequence>
<element maxOccurs="1" minOccurs="0" name="lineItemAction" type="tns:LineItemAction"/>
<element maxOccurs="1" minOccurs="0" name="filterStatement" type="tns:Statement"/>
</sequence>
</complexType>
</element>
<element name="performLineItemActionResponse">
<complexType>
<sequence>
...
<element name="updateLineItems">
<annotation>
<documentation> Updates the specified {@link LineItem} objects. </documentation>
</annotation>
<complexType>
<sequence>
<element maxOccurs="unbounded" minOccurs="0" name="lineItems" type="tns:LineItem"/>
...
<element name="updateLineItemsResponse">
<complexType>
<sequence>
<element maxOccurs="unbounded" minOccurs="0" name="rval" type="tns:LineItem"/>
</sequence>
...
<wsdl:message name="createLineItemsRequest">
<wsdl:part element="tns:createLineItems" name="parameters"/>
</wsdl:message>
<wsdl:message name="createLineItemsResponse">
<wsdl:part element="tns:createLineItemsResponse" name="parameters"/>
</wsdl:message>
<wsdl:message name="ApiException">
<wsdl:part element="tns:ApiExceptionFault" name="ApiException"/>
</wsdl:message>
<wsdl:message name="getLineItemsByStatementRequest">
<wsdl:part element="tns:getLineItemsByStatement" name="parameters"/>
</wsdl:message>
<wsdl:message name="getLineItemsByStatementResponse">
<wsdl:part element="tns:getLineItemsByStatementResponse" name="parameters"/>
</wsdl:message>
<wsdl:message name="performLineItemActionRequest">
<wsdl:part element="tns:performLineItemAction" name="parameters"/>
</wsdl:message>
<wsdl:message name="performLineItemActionResponse">
<wsdl:part element="tns:performLineItemActionResponse" name="parameters"/>
</wsdl:message>
<wsdl:message name="updateLineItemsRequest">
<wsdl:part element="tns:updateLineItems" name="parameters"/>
</wsdl:message>
<wsdl:message name="updateLineItemsResponse">
<wsdl:part element="tns:updateLineItemsResponse" name="parameters"/>
</wsdl:message>
<wsdl:portType name="LineItemServiceInterface">
<wsdl:documentation> Provides methods for creating, updating and retrieving {@link LineItem} objects. <p>Line items define the campaign. For example, line items define: <ul> <li>a budget <li>a span of time to run <li>ad unit targeting </ul> <p>In short, line items connect all of the elements of an ad campaign. <p>Line items and creatives can be associated with each other through {@link LineItemCreativeAssociation} objects. An ad unit will host a creative through both this association and the {@link LineItem#targeting} to it. The delivery of a line item depends on its priority. More information on line item priorities can be found on the <a href="https://support.google.com/admanager/answer/177279">Ad Manager Help Center</a>. </wsdl:documentation>
<wsdl:operation name="createLineItems">
<wsdl:documentation> Creates new {@link LineItem} objects. </wsdl:documentation>
<wsdl:input message="tns:createLineItemsRequest" name="createLineItemsRequest"/>
<wsdl:output message="tns:createLineItemsResponse" name="createLineItemsResponse"/>
<wsdl:fault message="tns:ApiException" name="ApiException"/>
</wsdl:operation>
<wsdl:operation name="getLineItemsByStatement">
<wsdl:documentation> Gets a {@link LineItemPage} of {@link LineItem} objects that satisfy the given {@link Statement#query}. The following fields are supported for filtering: <table> <tbody> <tr> <th>PQL property</th> <th>Entity property</th> </tr> <tr> <td> {@code CostType} </td> <td> {@link LineItem#costType} </td> </tr> <tr> <td> {@code CreationDateTime} </td> <td> {@link LineItem#creationDateTime} </td> </tr> <tr> <td> {@code DeliveryRateType} </td> <td> {@link LineItem#deliveryRateType} </td> </tr> <tr> <td> {@code EndDateTime} </td> <td> {@link LineItem#endDateTime} </td> </tr> <tr> <td> {@code ExternalId} </td> <td> {@link LineItem#externalId} </td> </tr> <tr> <td> {@code Id} </td> <td> {@link LineItem#id} </td> </tr> <tr> <td> {@code IsMissingCreatives} </td> <td> {@link LineItem#isMissingCreatives} </td> </tr> <tr> <td> {@code IsSetTopBoxEnabled} </td> <td> {@link LineItem#isSetTopBoxEnabled} </td> </tr> <tr> <td> {@code LastModifiedDateTime} </td> <td> {@link LineItem#lastModifiedDateTime} </td> </tr> <tr> <td> {@code LineItemType} </td> <td> {@link LineItem#lineItemType} </td> </tr> <tr> <td> {@code Name} </td> <td> {@link LineItem#name} </td> </tr> <tr> <td> {@code OrderId} </td> <td> {@link LineItem#orderId} </td> </tr> <tr> <td> {@code StartDateTime} </td> <td> {@link LineItem#startDateTime} </td> </tr> <tr> <td> {@code Status} </td> <td> {@link LineItem#status} </td> </tr> <tr> <td> {@code UnitsBought} </td> <td> {@link LineItem#unitsBought} </td> </tr> </tbody> </table> </wsdl:documentation>
<wsdl:input message="tns:getLineItemsByStatementRequest" name="getLineItemsByStatementRequest"/>
<wsdl:output message="tns:getLineItemsByStatementResponse" name="getLineItemsByStatementResponse"/>
<wsdl:fault message="tns:ApiException" name="ApiException"/>
</wsdl:operation>
<wsdl:operation name="performLineItemAction">
<wsdl:documentation> Performs actions on {@link LineItem} objects that match the given {@link Statement#query}. </wsdl:documentation>
<wsdl:input message="tns:performLineItemActionRequest" name="performLineItemActionRequest"/>
<wsdl:output message="tns:performLineItemActionResponse" name="performLineItemActionResponse"/>
<wsdl:fault message="tns:ApiException" name="ApiException"/>
</wsdl:operation>
<wsdl:operation name="updateLineItems">
<wsdl:documentation> Updates the specified {@link LineItem} objects. </wsdl:documentation>
<wsdl:input message="tns:updateLineItemsRequest" name="updateLineItemsRequest"/>
<wsdl:output message="tns:updateLineItemsResponse" name="updateLineItemsResponse"/>
<wsdl:fault message="tns:ApiException" name="ApiException"/>
</wsdl:operation>
</wsdl:portType>
<wsdl:binding name="LineItemServiceSoapBinding" type="tns:LineItemServiceInterface">
<wsdlsoap:binding style="document" transport="http://schemas.xmlsoap.org/soap/http"/>
<wsdl:operation name="createLineItems">
<wsdlsoap:operation soapAction=""/>
<wsdl:input name="createLineItemsRequest">
<wsdlsoap:header message="tns:RequestHeader" part="RequestHeader" use="literal"/>
<wsdlsoap:body use="literal"/>
</wsdl:input>
<wsdl:output name="createLineItemsResponse">
...
<wsdl:operation name="getLineItemsByStatement">
<wsdlsoap:operation soapAction=""/>
<wsdl:input name="getLineItemsByStatementRequest">
<wsdlsoap:header message="tns:RequestHeader" part="RequestHeader" use="literal"/>
<wsdlsoap:body use="literal"/>
</wsdl:input>
<wsdl:output name="getLineItemsByStatementResponse">
<wsdlsoap:header message="tns:ResponseHeader" part="ResponseHeader" use="literal"/>
<wsdlsoap:body use="literal"/>
</wsdl:output>
<wsdl:fault name="ApiException">
...
<wsdl:operation name="performLineItemAction">
<wsdlsoap:operation soapAction=""/>
<wsdl:input name="performLineItemActionRequest">
<wsdlsoap:header message="tns:RequestHeader" part="RequestHeader" use="literal"/>
<wsdlsoap:body use="literal"/>
</wsdl:input>
<wsdl:output name="performLineItemActionResponse">
<wsdlsoap:header message="tns:ResponseHeader" part="ResponseHeader" use="literal"/>
<wsdlsoap:body use="literal"/>
</wsdl:output>
<wsdl:fault name="ApiException">
...
<wsdl:operation name="updateLineItems">
<wsdlsoap:operation soapAction=""/>
<wsdl:input name="updateLineItemsRequest">
<wsdlsoap:header message="tns:RequestHeader" part="RequestHeader" use="literal"/>
<wsdlsoap:body use="literal"/>
</wsdl:input>
<wsdl:output name="updateLineItemsResponse">
<wsdlsoap:header message="tns:ResponseHeader" part="ResponseHeader" use="literal"/>
<wsdlsoap:body use="literal"/>
</wsdl:output>
<wsdl:fault name="ApiException">
...
<wsdl:service name="LineItemService">
<wsdl:port binding="tns:LineItemServiceSoapBinding" name="LineItemServiceInterfacePort">
<wsdlsoap:address location="https://ads.google.com/apis/ads/publisher/v202502/LineItemService"/>
</wsdl:port>
</wsdl:service>
</wsdl:definitions>
"""
from __future__ import annotations
from typing import Any, Optional, Literal, List, Annotated, Union
...
class CustomPacingGoal(GAMSOAPBaseModel):
    """
    <complexType name="CustomPacingGoal">
    <annotation>
    <documentation> An interval of a {@link CustomPacingCurve}. A custom pacing goal contains a start time and an amount. The goal will apply until either the next custom pacing goal's {@code getStartTime} or the line item's end time if it is the last goal. </documentation>
    ...
    useLineItemStartDateTime: Optional[bool] = Field(
        default=None,
        description=(
            "Whether the LineItem.startDateTime should be used for the start date and time of this goal. "
            "This field is not persisted and if it is set to true, "
            "the startDateTime field will be populated by the line item's start time."
        )
    )
    amount: int = Field(
        ...,
    ...
    # def start_date_time_must_be_in_the_future(cls, v):
    #     assert datetime.now() < datetime(
    #         year=v.date.year, month=v.date.month, day=v.date.day, hour=v.hour, minute=v.minute, second=v.second
    #     ), "start date time must be in the future"
    #     return v


class CustomPacingCurve(GAMSOAPBaseModel):
    """
    <complexType name="CustomPacingCurve">
    <annotation>
    <documentation> A curve consisting of {@link CustomPacingGoal} objects that is used to pace line item delivery. </documentation>
    ...
    """
    customPacingGoalUnit: Literal["ABSOLUTE", "MILLI_PERCENT", "UNKNOWN"] = Field(
        ...,
        description="The unit of the CustomPacingGoalDto.amount values."
    )
    customPacingGoals: list[CustomPacingGoal] = Field(
        ...,
        description="The list of goals that make up the custom pacing curve."
    )


class CreativePlaceholder(GAMSOAPBaseModel):
    """
    <complexType name="CreativePlaceholder">
    <annotation>
    <documentation> A {@code CreativePlaceholder} describes a slot that a creative is expected to fill. This is used primarily to help in forecasting, and also to validate that the correct creatives are associated with the line item. A {@code CreativePlaceholder} must contain a size, and it can optionally contain companions. Companions are only valid if the line item's environment type is {@link EnvironmentType#VIDEO_PLAYER}. </documentation>
    ...
    size: Size = Field(
        ...,
        description="The dimensions that the creative is expected to have. This attribute is required."
    )
    creativeTemplateId: Optional[int] = Field(
        default=None,
        description=(
    ...
    companions: Optional[list[CreativePlaceholder]] = Field(
        default=None,
        description=(
            "The companions that the creative is expected to have. "
            "This attribute can only be set if the line item it belongs to has a LineItem.environmentType of "
            "EnvironmentType.VIDEO_PLAYER or LineItem.roadblockingType of RoadblockingType.CREATIVE_SET."
        )
    )
    appliedLabels: Optional[list[AppliedLabel]] = Field(
        default=None,
        description="The set of label frequency caps applied directly to this creative placeholder."
    )
    effectiveAppliedLabels: Optional[list[AppliedLabel]] = Field(
        default=None,
        description=(
            "Contains the set of labels applied directly to this creative placeholder as well "
            "as those inherited from the creative template from which this creative placeholder was instantiated. "
            "This field is readonly and is assigned by Google."
        )
    )
    expectedCreativeCount: Optional[int] = Field(
        default=None,
        gt=0,
        description=(
            ...
            "for example, if label frequency capping limits the number of times a creative may be served."
        )
    )
    creativeSizeType: Optional[Literal["PIXEL", "ASPECT_RATIO", "INTERSTITIAL", "IGNORED", "NATIVE", "AUDIO"]] = Field(
        default="PIXEL",
        description=(
            "Describes the types of sizes a creative can be."
            "By default, the creative's size is CreativeSizeType.PIXEL, "
            "which is a dimension based size (width-height pair)."
        )
    )
    targetingName: Optional[str] = Field(
        ...
        description=(
            ...
            "Specifying creative targeting here is for forecasting purposes only and has no effect on serving. "
            "The same creative targeting should be specified on a LineItemCreativeAssociation "
            "when associating a Creative with the LineItem."
        )
    )
    isAmpOnly: Optional[bool] = Field(
        default=None,
        description=(
...
class LineItemActivityAssociation(GAMSOAPBaseModel):
    """
    <complexType name="LineItemActivityAssociation">
    <annotation>
    <documentation> A {@code LineItemActivityAssociation} associates a {@link LineItem} with an {@link Activity} so that the conversions of the {@link Activity} can be counted against the {@link LineItem}. </documentation>
    ...
    activityId: int = Field(
        ...,
        description="The ID of the Activity to which the LineItem should be associated. This attribute is required."
    )
    clickThroughConversionCost: Money = Field(
        ...,
        description=(
            "The amount of money to attribute per click through conversion. "
            "This attribute is required for creating a LineItemActivityAssociation. "
            "The currency code is readonly and should match the LineItem."
        )
    )
    viewThroughConversionCost: Money = Field(
        ...,
        description=(
...
class DeliveryIndicator(GAMSOAPBaseModel):
    """
    <complexType name="DeliveryIndicator">
    <annotation>
    <documentation> Indicates the delivery performance of the {@link LineItem}. </documentation>
    ...
    """
    expectedDeliveryPercentage: float = Field(
        ...,
        description="How much the LineItem was expected to deliver as a percentage of LineItem.primaryGoal."
    )
    actualDeliveryPercentage: float = Field(
        ...,
        description="How much the line item actually delivered as a percentage of LineItem.primaryGoal."
    )


class DeliveryData(GAMSOAPBaseModel):
    """
    <complexType name="DeliveryData">
    <annotation>
    <documentation> Holds the number of clicks or impressions, determined by {@link LineItem#costType}, delivered for a single line item for the last 7 days </documentation>
...
class ThirdPartyMeasurementSettings(GAMSOAPBaseModel):
    """
    <complexType name="ThirdPartyMeasurementSettings">
    <annotation>
    <documentation> Contains third party auto-pixeling settings for cross-sell Partners. </documentation>
    ...
    """
    viewabilityPartner: Literal[
        "NONE", "MOAT", "DOUBLE_VERIFY", "INTEGRAL_AD_SCIENCE", "COMSCORE", "TELEMETRY", "UNKNOWN"
    ] = Field(
        default="NONE",
        description=(
    ...
    viewabilityClientId: str = Field(
        ...,
        description="The third party partner id for YouTube viewability verification."
    )
    viewabilityReportingId: str = Field(
        ...,
        description=(
            "The reporting id that maps viewability partner data with a campaign "
            "(or a group of related campaigns) specific data."
        )
    )
    publisherViewabilityPartner: Literal[
        "NONE", "MOAT", "DOUBLE_VERIFY", "INTEGRAL_AD_SCIENCE", "COMSCORE", "TELEMETRY", "UNKNOWN"
    ] = Field(
        default="NONE",
        description="A field to determine the type of publisher's viewability partner. This field default is NONE."
    )
    publisherViewabilityClientId: str = Field(
        ...,
        description="The third party partner id for YouTube viewability verification for publisher."
    )
    publisherViewabilityReportingId: str = Field(
        ...,
        description=(
            "The reporting id that maps viewability partner data with a campaign "
            "(or a group of related campaigns) specific data for publisher."
        )
    )
    brandLiftPartner: Literal["UNKNOWN", "NONE", "KANTAR_MILLWARD_BROWN", "DYNATA", "INTAGE", "MACROMILL"] = Field(
        default="NONE",
        description=(
            "A field to determine the type of ThirdPartyBrandLiftIntegrationPartner. This field default is NONE."
        )
    )
    brandLiftClientId: str = Field(
        ...,
        description="The third party partner id for YouTube brand lift verification."
    )
    brandLiftReportingId: str = Field(
        ...,
        description=(
    ...
    reachPartner: Literal[
        "NONE", "COMSCORE", "NIELSEN", "KANTAR_MILLWARD_BROWN", "VIDEO_RESEARCH", "GEMIUS", "VIDEO_AMP", "ISPOT_TV",
        "AUDIENCE_PROJECT", "UNKNOWN"
    ] = Field(
        default="UNKNOWN",
        description=(
            "A field to determine the type of advertiser's ThirdPartyReachIntegrationPartner."
            "This field default is UNKNOWN."
        ),
    )
    reachClientId: str = Field(
        ...,
        description="The third party partner id for YouTube reach verification for advertiser."
    )
    reachReportingId: str = Field(
        ...,
        description=(
            "The reporting id that maps reach partner data with a campaign "
            "(or a group of related campaigns) specific data for advertiser."
        )
    )
    publisherReachPartner: Literal[
        "NONE", "COMSCORE", "NIELSEN", "KANTAR_MILLWARD_BROWN", "VIDEO_RESEARCH", "GEMIUS", "VIDEO_AMP", "ISPOT_TV",
        "AUDIENCE_PROJECT", "UNKNOWN"
    ] = Field(
        default="UNKNOWN",
    ...
    publisherReachClientId: str = Field(
        ...,
        description="The third party partner id for YouTube reach verification for publisher."
    )
    publisherReachReportingId: str = Field(
        ...,
        description=(
            "The reporting id that maps reach partner data with a campaign "
            "(or a group of related campaigns) specific data for publisher."
...
class Goal(GAMSOAPBaseModel):
    ...
    units: int = Field(
        ...
        description=(
            ...
            "will be reserved for the LineItem. If the line item is of type LineItemType.SPONSORSHIP, "
            "it represents the percentage of available impressions reserved. "
            "If the line item is of type LineItemType.BULK or LineItemType.PRICE_PRIORITY, "
            "it represents the number of remaining impressions reserved. "
            "If the line item is of type LineItemType.NETWORK or LineItemType.HOUSE, "
            "it represents the percentage of remaining impressions reserved. "
            "If this is a secondary goal, it represents the number of impressions or conversions that the line item "
            "will stop serving at if reached. For valid line item types, see LineItem.secondaryGoals."
        )
    )


class GrpSettings(GAMSOAPBaseModel):
    """
    <complexType name="GrpSettings">
    <annotation>
    <documentation> {@code GrpSettings} contains information for a line item that will have a target demographic when serving. This information will be used to set up tracking and enable reporting on the demographic information. </documentation>
    ...
    """
    minTargetAge: Optional[int] = Field(
        default=None,
        description=(
            "Specifies the minimum target age (in years) of the LineItem. "
            "This field is only applicable if provider is not null."
        )
    )
    maxTargetAge: Optional[int] = Field(
        default=None,
        description=(
            "Specifies the maximum target age (in years) of the LineItem. "
            "This field is only applicable if provider is not null."
        )
    )
    targetGender: Optional[Literal["UNKNOWN", "MALE", "FEMALE", "BOTH"]] = Field(
        default=None,
        description=(
            "Specifies the target gender of the LineItem. This field is only applicable if provider is not null."
        )
    )
    provider: Optional[Literal["UNKNOWN", "NIELSEN", "GOOGLE"]] = Field(
        default=None,
        description="Specifies the GRP provider of the LineItem."
    )
    inTargetRatioEstimateMilliPercent: Optional[int] = Field(
        default=None,
        description=(
            "Estimate for the in-target ratio given the line item's audience targeting. "
            "This field is only applicable if provider is Nielsen, LineItem.primaryGoal.unitType is in-target "
            "impressions, and LineItem.CostType is in-target CPM. "
            "This field determines the in-target ratio to use for pacing "
            "Nielsen line items before Nielsen reporting data is available. "
            "Represented as a milli percent, so 55.7% becomes 55700."
        )
    )
    nielsenCtvPacingType: Optional[Literal["UNKNOWN", "NONE", "COVIEW", "STRICT_COVIEW"]] = Field(
        default=None,
        description=(
    ...
    pacingDeviceCategorizationType: Optional[Literal["UNKNOWN", "GOOGLE", "NIELSEN"]] = Field(
        default=None,
        description="Specifies whether to use Google or Nielsen device breakdown in Nielsen Line Item auto pacing."
    )
    applyTrueCoview: Optional[bool] = Field(
        default=None,
        description="Specifies whether to apply true coview."
    )


class LineItemDealInfoDto(GAMSOAPBaseModel):
    """
    <complexType name="LineItemDealInfoDto">
    <annotation>
    <documentation> Data transfer object for the exchange deal info of a line item. </documentation>
    ...
    """
    externalDealId: Optional[int] = Field(
        default=None,
        description=(
            "The external deal ID shared between seller and buyer. "
            "This field is only present if the deal has been finalized. "
...
class LineItemSummary(GAMSOAPBaseModel):
    """
    <complexType name="LineItemSummary">
    <annotation>
    <documentation> The {@code LineItemSummary} represents the base class from which a {@code LineItem} is derived. </documentation>
    ...
    orderId: Optional[int] = Field(
        ...
        description=(
            ...
            "but when used is in the context of a ProspectiveLineItem, in that case in can be None."
        )
    )
    id: Optional[int] = Field(
        default=None,
        description=(
            "Uniquely identifies the LineItem. "
            "This attribute is read-only and is assigned by Google when a line item is created."
        )
    )
    name: str = Field(
        ...,
        max_length=255,
        description="The name of the line item. This attribute is required and has a maximum length of 255 characters."
    )
    ...
    orderName: Optional[str] = Field(
        default=None,
        description="The name of the Order. This value is read-only."
    )
    startDateTime: Optional[DateTime] = Field(
        default=None,  # TODO: apparently it is not required
        description=(
            "The date and time on which the LineItem is enabled to begin serving. "
            "This attribute is required and must be in the future."
        )
    )
    # @validator("startDateTime")
    # def start_datetime_must_be_in_future(cls, v: DateTime) -> DateTime:
    #     if datetime(v.date.year, v.date.month, v.date.day, v.hour, v.minute, v.second) < datetime.now():
    #         raise ValueError("startDateTime must be in the future")
    #     return v
    startDateTimeType: Optional[Literal["USE_START_DATE_TIME", "IMMEDIATELY", "ONE_HOUR_FROM_NOW", "UNKNOWN"]] = Field(
        default="USE_START_DATE_TIME",
        description=(
    ...
    endDateTime: Optional[DateTime] = Field(
        default=None,
        description=(
            "The date and time on which the LineItem will stop serving. "
            "This attribute is required unless LineItem.unlimitedEndDateTime is set to true. "
            "If specified, it must be after the LineItem.startDateTime. "
            "This end date and time does not include auto extension days."
        )
    )
    autoExtensionDays: Optional[int] = Field(
        default=None,
        description=(
            "The number of days to allow a line item to deliver past its endDateTime. A maximum of 7 days is allowed. "
            "This is feature is only available for Ad Manager 360 accounts."
        )
    )
    unlimitedEndDateTime: Optional[bool] = Field(
        default=False,
        description=(
            "Specifies whether or not the LineItem has an end time. "
            "This attribute is optional and defaults to false. "
            "It can be be set to true for only line items of type LineItemType.SPONSORSHIP, LineItemType.NETWORK, "
            "LineItemType.PRICE_PRIORITY and LineItemType.HOUSE."
        )
    )
    creativeRotationType: Literal["EVEN", "OPTIMIZED", "MANUAL", "SEQUENTIAL"] = Field(
        ...,
        description=(
            "The strategy used for displaying multiple Creative objects that are associated with the LineItem. "
            "This attribute is required."
        )
    )
    deliveryRateType: Optional[Literal["EVENLY", "FRONTLOADED", "AS_FAST_AS_POSSIBLE"]] = Field(
        default=None,
        description=(
            "The strategy for delivering ads over the course of the line item's duration. "
            "This attribute is optional and defaults to DeliveryRateType.EVENLY or DeliveryRateType.FRONTLOADED "
            "depending on the network's configuration."
        )
    )
    deliveryForecastSource: Optional[Literal["HISTORICAL", "FORECASTING", "CUSTOM_PACING_CURVE", "UNKNOWN"]] = Field(
        default="HISTORICAL",
        description=(
            "Strategy for choosing forecasted traffic shapes to pace line items. "
            "This field is optional and defaults to DeliveryForecastSource.HISTORICAL."
        )
    )
    customPacingCurve: Optional[CustomPacingCurve] = Field(
        default=None,
        description=(
            "The curve that is used to pace the line item's delivery. "
            "This field is required if and only if "
            "the delivery forecast source is DeliveryForecastSource.CUSTOM_PACING_CURVE."
        )
    )
    roadblockingType: Optional[
        Literal["ONLY_ONE", "ONE_OR_MORE", "AS_MANY_AS_POSSIBLE", "ALL_ROADBLOCK", "CREATIVE_SET"]
    ] = Field(
        default="ONE_OR_MORE",
        description=(
            "The strategy for serving roadblocked creatives, "
            "i.e. instances where multiple creatives must be served together on a single web page. "
            "This attribute is optional and defaults to RoadblockingType.ONE_OR_MORE."
        )
    )
    skippableAdType: Optional[Literal["UNKNOWN", "DISABLED", "ENABLED", "INSTREAM_SELECT", "ANY"]] = Field(
        default="DISABLED",
        description=(
            "The nature of the line item's creatives' skippability. "
            "This attribute is optional, only applicable for video line items, "
            "and defaults to SkippableAdType.NOT_SKIPPABLE.")
    )
    frequencyCaps: Optional[List[FrequencyCap]] = Field(
        default=None,
        description="The set of frequency capping units for this LineItem. This attribute is optional."
    )
    lineItemType: LineItemType = Field(
        ...,
        description="Indicates the line item type of a LineItem. This attribute is required."
    )
    priority: Optional[int] = Field(
        default=None,
        description=(
            "The priority for the line item. Valid values range from 1 to 16. "
            "This field is optional and defaults to the default priority of the LineItemType."
    ...
    costPerUnit: Money = Field(
        ...,
        description=(
            "The amount of money to spend per impression or click. This attribute is required for creating a LineItem."
        )
    )
    valueCostPerUnit: Optional[Money] = Field(
        default=None,
        description=(
            "An amount to help the adserver rank inventory. "
            "LineItem.valueCostPerUnit artificially raises the value of inventory over the LineItem.costPerUnit "
            "but avoids raising the actual LineItem.costPerUnit. "
            "This attribute is optional and defaults to a Money object in the local currency with Money.microAmount 0."
        )
    )
    costType: CostType = Field(
        description="The method used for billing this LineItem. This attribute is required."
    )
    discountType: Optional[Literal["ABSOLUTE_VALUE", "PERCENTAGE"]] = Field(
        default="PERCENTAGE",
        description=(
    ...
    discount: Optional[float] = Field(
        default=None,
        description=(
            "The number here is either a percentage or an absolute value depending on the LineItemDiscountType. "
            "If the LineItemDiscountType is LineItemDiscountType.PERCENTAGE, "
            "then only non-fractional values are supported."
        )
    )
    contractedUnitsBought: Optional[int] = Field(
        default=None,
        description=(
            "This attribute is only applicable for certain line item types and acts as an 'FYI' or note, "
            "which does not impact adserving or other backend systems. "
            "For LineItemType.SPONSORSHIP line items, this represents the minimum quantity, "
            "which is a lifetime impression volume goal for reporting purposes only. "
            "For LineItemType.STANDARD line items, this represent the contracted quantity, "
            "which is the number of units specified in the contract the advertiser has bought for this LineItem. "
            "This field is just a 'FYI' for traffickers to manually intervene with the LineItem when needed. "
            "This attribute is only available for LineItemType.STANDARD line items "
            "if you have this feature enabled on your network."
        )
    )
    creativePlaceholders: Optional[List[CreativePlaceholder]] = Field(
        default=None,
        description=(
            "Details about the creatives that are expected to serve through this LineItem."
            "This attribute is required and replaces the creativeSizes attribute."
        )
    )
    activityAssociations: Optional[List[LineItemActivityAssociation]] = Field(
        default=None,
        description="This attribute is required and meaningful only if the LineItem.costType is CostType.CPA."
    )
    environmentType: EnvironmentType = Field(
        default=EnvironmentType.BROWSER,
        description=(
            "The environment that the LineItem is targeting. The default value is EnvironmentType.BROWSER. "
            "If this value is EnvironmentType.VIDEO_PLAYER, then this line item can only target AdUnits "
            "that have AdUnitSizes whose environmentType is also VIDEO_PLAYER."
        )
    )
    allowedFormats: Optional[List[Literal["AUDIO", "UNKNOWN"]]] = Field(
        default=None,
        description=(
            "The set of allowedFormats that this programmatic line item can have. "
            "If the set is empty, this line item allows all formats."
        )
    )
    companionDeliveryOption: Optional[Literal["OPTIONAL", "AT_LEAST_ONE", "ALL", "UNKNOWN"]] = Field(
        default=None,
        description=(
            "The delivery option for companions. "
            "Setting this field is only meaningful if the following conditions are met:"
    ...
    allowOverbook: Optional[bool] = Field(
        default=False,
        description=(
            "The flag indicates whether overbooking should be allowed when creating or updating reservations "
            "of line item types LineItemType.SPONSORSHIP and LineItemType.STANDARD. "
            "When true, operations on this line item will never trigger a ForecastError, "
            "which corresponds to an overbook warning in the UI. "
            "The default value is false."
            "Note: this field will not persist on the line item itself, "
            "and the value will only affect the current request."
        )
    )
    skipInventoryCheck: Optional[bool] = Field(
        default=False,
        description=(
            "The flag indicates whether the inventory check should be skipped when creating or updating a line item. "
            "The default value is false."
            "Note: this field will not persist on the line item itself, "
            "and the value will only affect the current request."
        )
    )
    skipCrossSellingRuleWarningChecks: Optional[bool] = Field(
        default=False,
        description=(
            "True to skip checks for warnings from rules applied to line items targeting inventory shared by "
            "a distributor partner for cross selling when performing an action on this line item. The default is false."
        )
    )
    reserveAtCreation: Optional[bool] = Field(
        default=False,
        description=(
            "The flag indicates whether inventory should be reserved when creating a line item "
            "of types LineItemType.SPONSORSHIP and LineItemType.STANDARD in an unapproved Order. "
            "The default value is false."
        )
    )
    ...
    deliveryIndicator: Optional[DeliveryIndicator] = Field(
        default=None,
        description=(
            "Indicates how well the line item has been performing. "
            "This attribute is readonly and is populated by Google. "
            "This will be null if the delivery indicator information is not available "
    ...
    deliveryData: Optional[DeliveryData] = Field(
        default=None,
        description=(
            "Delivery data provides the number of clicks or impressions delivered for a LineItem in the last 7 days. "
            "This attribute is readonly and is populated by Google. "
            "This will be null if the delivery data cannot be computed due to one of the following reasons: "
            ...
            "\nLineItem.deliveryIndicator should be used to track its progress in this case."
        )
    )
    budget: Optional[Money] = Field(
        default=None,
        description=(
            "The amount of money allocated to the LineItem. This attribute is readonly and is populated by Google. "
            "The currency code is readonly."
        )
    )
    status: Optional[
        Literal[
            "DELIVERY_EXTENDED", "DELIVERING", "READY", "PAUSED", "INACTIVE", "PAUSED_INVENTORY_RELEASED",
            "PENDING_APPROVAL", "COMPLETED", "DISAPPROVED", "DRAFT", "CANCELED"
        ]
    ] = Field(
        default=None,
        description="The status of the LineItem. This attribute is readonly."
    )
    reservationStatus: Optional[Literal["RESERVED", "UNRESERVED"]] = Field(
        default=None,
        description=(
            "Describes whether or not inventory has been reserved for the LineItem. "
            "This attribute is readonly and is assigned by Google."
        )
    )
    isArchived: Optional[bool] = Field(
        default=None,
        description="The archival status of the LineItem. This attribute is readonly."
    )
    ...
    appliedLabels: Optional[List[AppliedLabel]] = Field(
        default=None,
        description="The set of labels applied directly to this line item."
    )
    effectiveAppliedLabels: Optional[List[AppliedLabel]] = Field(
        default=None,
        description=(
            "Contains the set of labels inherited from the order that contains this line item "
            "and the advertiser that owns the order. "
            "If a label has been negated, only the negated label is returned. "
            "This field is readonly and is assigned by Google."
        )
    )
    disableSameAdvertiserCompetitiveExclusion: Optional[bool] = Field(
        default=None,
        description=(
            ...
            "to serve regardless of the other competitive exclusion labels being applied."
        )
    )
    ...
    notes: Optional[str] = Field(
        ...
        max_length=65535,
        description=(
            "Provides any additional notes that may annotate the LineItem. "
            "This attribute is optional and has a maximum length of 65,535 characters."
        )
    )
    competitiveConstraintScope: Optional[Literal["POD", "STREAM", "UNKNOWN"]] = Field(
        default="POD",
        description=(
    ...
    lastModifiedDateTime: Optional[DateTime] = Field(
        default=None,
        description="The date and time this line item was last modified."
    )
    creationDateTime: Optional[DateTime] = Field(
        default=None,
        description="This attribute may be null for line items created before this feature was introduced."
    )
    customFieldValues: Optional[List[CustomFieldValue | DropDownCustomFieldValue]] = Field(
        default=None,
        description="The values of the custom fields associated with this line item."
    )
    isMissingCreatives: Optional[bool] = Field(
        default=None,
        description=(
            ...
            "as determined by CreativePlaceholder.expectedCreativeCount. "
            "For example a LineItem specifies 750x350, 400x200 but only a 750x350 was uploaded. "
            "Or LineItem specifies 750x350 with an expected count of 2, but only one was uploaded."
            "\n - The Creative.appliedLabels of an associated Creative do not match the "
            "CreativePlaceholder.effectiveAppliedLabels of the LineItem. "
            "For example LineItem specifies 750x350 with a Foo AppliedLabel "
            "but a 750x350 creative without a AppliedLabel was uploaded."
        )
    )
    programmaticCreativeSource: Optional[Literal["PUBLISHER", "ADVERTISER", "UNKNOWN"]] = Field(
        default=None,
        description=(
            "Indicates the ProgrammaticCreativeSource of the programmatic line item."
            "This is a read-only field. Any changes must be made on the ProposalLineItem."
        )
    )
    thirdPartyMeasurementSettings: Optional[ThirdPartyMeasurementSettings] = Field(
        default=None,
        description="The third party measurement settings for the line item."
    )
    youtubeKidsRestricted: Optional[bool] = Field(
        default=None,
        description=(
            "Designates this line item as intended for YT Kids app. "
            "If true, all creatives associated with this line item must be reviewed and approved. "
            "See the Ad Manager Help Center for more information."
        )
    )
    videoMaxDuration: Optional[int] = Field(
        default=None,
        description=(
            "The max duration of a video creative associated with this LineItem in milliseconds. "
            "This attribute is only meaningful for video line items. "
            "For version v202011 and earlier, this attribute is optional and defaults to 0. "
            "For version v202102 and later, this attribute is required for video line items and must be greater than 0."
        )
    )
    primaryGoal: Optional[Goal] = Field(
        default=None,
        description="The primary goal that this LineItem is associated with, which is used in its pacing and budgeting."
    )
    secondaryGoals: Optional[List[Goal]] = Field(
        default=None,
        description=(
            "The secondary goals that this LineItem is associated with. "
            "It is required and meaningful only if the LineItem.costType is CostType.CPA or "
            "if the LineItem.lineItemType is LineItemType.SPONSORSHIP and LineItem.costType is CostType.CPM."
        )
    )
    grpSettings: Optional[GrpSettings] = Field(
        default=None,
        description="Contains the information for a line item which has a target GRP demographic."
    )
    dealInfo: Optional[LineItemDealInfoDto] = Field(
        default=None,
        description="The deal information associated with this line item, if it is programmatic."
    )
    viewabilityProviderCompanyIds: Optional[List[int]] = Field(
        default=None,
        description=(
            "Optional IDs of the Company that provide ad verification for this line item. "
            "Company.Type.VIEWABILITY_PROVIDER."
        )
    )
    childContentEligibility: Optional[Literal["UNKNOWN", "DISALLOWED", "ALLOWED"]] = Field(
        default=None,
        description="Child content eligibility designation for this line item."
    )
    customVastExtension: Optional[str] = Field(
        default=None,
        description="Custom XML to be rendered in a custom VAST response at serving time."
    )


class AudienceSegmentCriteria(GAMSOAPBaseModel):
    """
    <complexType name="AudienceSegmentCriteria">
    <annotation>
    <documentation> An {@link AudienceSegmentCriteria} object is used to target {@link AudienceSegment} objects. </documentation>
    ...
    """
    operator: Literal["IS", "IS_NOT"] = Field(
        ...,
        description="The comparison operator. This attribute is required."
    )
    audienceSegmentIds: list[int] = Field(
        ...,
        description="The ids of AudienceSegment objects used to target audience segments. This attribute is required."
    )


class CustomCriteria(GAMSOAPBaseModel):
    """
    <complexType name="CustomCriteria">
    <annotation>
    <documentation> A {@link CustomCriteria} object is used to perform custom criteria targeting on custom targeting keys of type {@link CustomTargetingKey.Type#PREDEFINED} or {@link CustomTargetingKey.Type#FREEFORM}. </documentation>
    ...
    keyId: int = Field(
        ...,
        description=(
            "The CustomTargetingKey.id of the CustomTargetingKey object that was created using CustomTargetingService."
        )
    )
    valueIds: list[int] = Field(
        ...,
        description="The ids of CustomTargetingValue objects to target the custom targeting key with id keyId."
    )
    operator: Literal["IS", "IS_NOT"] = Field(
        ...,
        description="The comparison operator. This attribute is required."
...
def get_custom_criteria_set_children_discriminator_value(v: Any) -> str:  # noqa: PLR0911, PLR0912
    if isinstance(v, CustomCriteria):
        return "CustomCriteria"
    elif isinstance(v, AudienceSegmentCriteria):
        return "AudienceSegmentCriteria"
    elif isinstance(v, CustomCriteriaSet):
        return "CustomCriteriaSet"
    elif isinstance(v, dict):
        if "xsi_type" in v:
            return v["xsi_type"]
        elif "audienceSegmentIds" in v or "audienceSegmentIds".lower() in v:
            return "AudienceSegmentCriteria"
        elif ("keyId" in v and "valueIds" in v) or ("keyId".lower() in v and "valueIds".lower() in v):
            return "CustomCriteria"
        elif "children" in v:
            return "CustomCriteriaSet"
...
CustomCriteriaSetChildren = Annotated[
    Union[
        Annotated[CustomCriteria, Tag("CustomCriteria")],
        Annotated[AudienceSegmentCriteria, Tag("AudienceSegmentCriteria")],
        Annotated["CustomCriteriaSet", Tag("CustomCriteriaSet")],
    ],
    Discriminator(get_custom_criteria_set_children_discriminator_value),
]


class CustomCriteriaSet(GAMSOAPBaseModel):
    """
    <complexType name="CustomCriteriaSet">
    <annotation>
    <documentation> A {@link CustomCriteriaSet} comprises of a set of {@link CustomCriteriaNode} objects combined by the {@link CustomCriteriaSet.LogicalOperator#logicalOperator}. The custom criteria targeting tree is subject to the rules defined on {@link Targeting#customTargeting}. </documentation>
    ...
    """
    logicalOperator: Literal["AND", "OR"] = Field(
        title="Logical operator",
        description=(
            "The logical operator to be applied to CustomCriteriaSet.children. "
            "This attribute is required."
        ),
    )
    # NOTE: we intentionally exclude CmsMetadataCriteria from the children list
    children: list[CustomCriteriaSetChildren] = Field(
        title="Children",
        description="The custom criteria. This attribute is required.",
    )


class Location(GAMSOAPBaseModel):
    """
    <complexType name="Location">
    <annotation>
    <documentation> A {@link Location} represents a geographical entity that can be targeted. If a location type is not available because of the API version you are using, the location will be represented as just the base class, otherwise it will be sub-classed correctly. </documentation>
    ...
    type: Optional[str] = Field(
        None,
        title="Type",
        description="The location type for this geographical entity (ex. 'COUNTRY', 'CITY', 'STATE', 'COUNTY', etc.)",
    )
    canonicalParentId: Optional[int] = Field(
        None,
        title="Canonical parent ID",
        description="The nearest location parent's ID for this geographical entity.",
    )
...
class GeoTargeting(GAMSOAPBaseModel):
    """
    <complexType name="GeoTargeting">
    <annotation>
    <documentation> Provides line items the ability to target geographical locations. By default, line items target all countries and their subdivisions. With geographical targeting, you can target line items to specific countries, regions, metro areas, and cities. You can also exclude the same. <p>The following rules apply for geographical targeting: <ul> <li>You cannot target and exclude the same location. <li>You cannot target a child whose parent has been excluded. For example, if the state of Illinois has been excluded, then you cannot target Chicago. <li>You must not target a location if you are also targeting its parent. For example, if you are targeting New York City, you must not have the state of New York as one of the targeted locations. <li>You cannot explicitly define inclusions or exclusions that are already implicit. For example, if you explicitly include California, you implicitly exclude all other states. You therefore cannot explicitly exclude Florida, because it is already implicitly excluded. Conversely if you explicitly exclude Florida, you cannot explicitly include California. </ul> </documentation>
...
class AdUnitTargeting(GAMSOAPBaseModel):
    """
    <complexType name="AdUnitTargeting">
    <annotation>
    <documentation> Represents targeted or excluded ad units. </documentation>
    ...
    includeDescendants: bool = Field(
        default=True,
        title="Include descendants",
        description=(
            "Whether or not all descendants are included (or excluded) "
            "as part of including (or excluding) this ad unit. "
            "By default, the value is true which means targeting this ad unit will target all of its descendants."
        ),
    )


class InventoryTargeting(GAMSOAPBaseModel):
    """
    <complexType name="InventoryTargeting">
    <annotation>
    <documentation> A collection of targeted and excluded ad units and placements. </documentation>
    ...
    """
    targetedAdUnits: Optional[list[AdUnitTargeting]] = Field(
        default=None,
        title="Targeted ad units",
        description="A list of targeted AdUnitTargeting.",
    )
    excludedAdUnits: Optional[list[AdUnitTargeting]] = Field(
        default=None,
        title="Excluded ad units",
        description="A list of excluded AdUnitTargeting.",
    )
    targetedPlacementIds: Optional[list[int]] = Field(
        default=None,
        title="Targeted placement IDs",
        description="A list of targeted Placement ids.",
    )


class TargetedSize(GAMSOAPBaseModel):
    """
    <complexType name="TargetedSize">
    <annotation>
    <documentation> A size that is targeted on a request. </documentation>
...
class InventorySizeTargeting(GAMSOAPBaseModel):
    """
    <complexType name="InventorySizeTargeting">
    <annotation>
    <documentation> Represents a collection of targeted and excluded inventory sizes. This is currently only available on {@link YieldGroup} and {@link TrafficDataRequest}. </documentation>
    ...
    """
    isTargeted: bool = Field(
        title="Is targeted",
        description="Whether the inventory sizes should be targeted or excluded.",
    )
    targetedSizes: list[TargetedSize] = Field(
        title="Targeted sizes",
        description="A list of TargetedSizeDtos.",
    )
...
class RequestPlatformTargeting(GAMSOAPBaseModel):
    """
    <complexType name="RequestPlatformTargeting">
    <annotation>
    <documentation> Provides line items the ability to target the platform that requests and renders the ad. <p>The following rules apply for {@link RequestPlatformTargeting} <ul> <li>{@link RequestPlatformTargeting} must be specified for {@link ProposalLineItem}s. <li>{@link RequestPlatformTargeting} must be specified for video line items. Empty values for {@link RequestPlatformTargeting#targetedRequestPlatforms} mean that all request platforms will be targeted. <li>{@link RequestPlatformTargeting} is read-only and assigned by Google for non-video line items. <li>{@link RequestPlatformTargeting} is read-only and assigned by Google for line items generated from proposal line items. </ul> </documentation>
    ...
    """
    # NOTE: the schema of above feels wrong
    targetedRequestPlatforms: Optional[list[RequestPlatform]] = Field(
        default=None,
        title="Targeted request platforms",
        description="The request platforms being targeted by the LineItem.",
    )


class VideoPositionType(str, Enum):
    """
    <simpleType name="VideoPosition.Type">
    <annotation>
    <documentation> Represents a targetable position within a video. </documentation>
...
class VideoPosition(GAMSOAPBaseModel):
    """
    <complexType name="VideoPosition">
    <annotation>
    <documentation> Represents a targetable position within a video. A video ad can be targeted to a position (pre-roll, all mid-rolls, or post-roll), or to a specific mid-roll index. </documentation>
    ...
    """
    positionType: Optional[VideoPositionType] = Field(
        default=None,
        title="Position type",
        description="The type of video position (pre-roll, mid-roll, or post-roll).",
    )
    midrollIndex: Optional[int] = Field(
        default=None,
        title="Mid-roll index",
        description=(
            "The index of the mid-roll to target. "
            "Only valid if the positionType is VideoPositionType.MIDROLL, otherwise this field will be ignored."
        ),
    )


class VideoBumperType(str, Enum):
    """
    <simpleType name="VideoBumperType">
    <annotation>
    <documentation> Represents the options for targetable bumper positions, surrounding an ad pod, within a video stream. This includes before and after the supported ad pod positions, {@link VideoPositionType#PREROLL}, {@link VideoPositionType#MIDROLL}, and {@link VideoPositionType#POSTROLL}. </documentation>
...
class VideoPositionWithinPod(GAMSOAPBaseModel):
    """
    <complexType name="VideoPositionWithinPod">
    <annotation>
    <documentation> Represents a targetable position within a pod within a video stream. A video ad can be targeted to any position in the pod (first, second, third ... last). If there is only 1 ad in a pod, either first or last will target that position. </documentation>
    ...
    index: int = Field(
        ...
        description=(
            ...
            "1 = first, 2 = second, 3 = third, ...., 100 = last. "
            "100 will always be the last position. "
            "For example, for a pod with 5 positions, 100 would target position 5. "
            "Multiple targets against the index 100 can exist. "
            "Positions over 100 are not supported."
        ),
    )


class VideoPositionTarget(GAMSOAPBaseModel):
    """
    <complexType name="VideoPositionTarget">
    <annotation>
    <documentation> Represents the options for targetable positions within a video. </documentation>
    ...
    """
    videoPosition: Optional[VideoPosition] = Field(
        default=None,
        title="Video position",
        description="The video position to target.",
    )
    videoBumperType: Optional[VideoBumperType] = Field(
        default=None,
        title="Video bumper type",
        description=(
            "The video bumper type to target. "
            "To target a video position or a pod position, this value must be null. "
            "To target a bumper position this value must be populated and the line item must have a bumper type. "
            "To target a custom ad spot, this value must be null."
        ),
    )
    videoPositionWithinPod: Optional[VideoPositionWithinPod] = Field(
        default=None,
        title="Video position within pod",
        description=(
            "The video position within a pod to target. "
            "To target a video position or a bumper position, this value must be null. "
            "To target a position within a pod this value must be populated. "
            "To target a custom ad spot, this value must be null."
        ),
    )
    adSpotId: Optional[int] = Field(
        default=None,
        title="Ad spot ID",
        description=(
            "A custom spot AdSpot to target. "
            "To target a video position, a bumper type or a video position within a pod this value must be null."
        ),
    )


class VideoPositionTargeting(GAMSOAPBaseModel):
    """
    <complexType name="VideoPositionTargeting">
    <annotation>
    <documentation> Represents positions within and around a video where ads can be targeted to. <p>Example positions could be {@code pre-roll} (before the video plays), {@code post-roll} (after a video has completed playback) and {@code mid-roll} (during video playback). <p>Empty video position targeting means that all video positions are allowed. If a bumper line item has empty video position targeting it will be updated to target all bumper positions. </documentation>
    ...
    """
    targetedPositions: Optional[list[VideoPositionTarget]] = Field(
        default=None,
        title="Targeted positions",
        description="The VideoTargetingPosition objects being targeted by the video LineItem.",
    )
...
class TimeOfDay(GAMSOAPBaseModel):
    """
    <complexType name="TimeOfDay">
    <annotation>
    <documentation> Represents a specific time in a day. </documentation>
    ...
    minute: MinuteOfHour = Field(
        ...,
        title="Minute",
        description="Minutes in an hour. Currently, only 0, 15, 30, and 45 are supported. This field is required.",
    )


class DayPart(GAMSOAPBaseModel):
    """
    <complexType name="DayPart">
    <annotation>
    <documentation> {@code DayPart} represents a time-period within a day of the week which is targeted by a {@link LineItem}. </documentation>
    ...
    dayOfWeek: DayOfWeek = Field(
        title="Day of week",
        description="Day of the week the target applies to. This field is required.",
    )
    startTime: Optional[TimeOfDay] = Field(
        default=None,
        title="Start time",
        description="Represents the start time of the targeted period (inclusive).",
    )
    endTime: Optional[TimeOfDay] = Field(
        default=None,
        title="End time",
        description="Represents the end time of the targeted period (exclusive).",
    )


class DayPartTargeting(GAMSOAPBaseModel):
    """
    <complexType name="DayPartTargetingError">
    <annotation>
    <documentation> Lists all errors associated with day-part targeting for a line item. </documentation>
    ...
    """
    targetedDayParts: Optional[list[DayPart]] = Field(
        default=None,
        title="Targeted day parts",
        description="The day parts that the line item is eligible to serve.",
    )


class DateTimeRange(GAMSOAPBaseModel):
    """
    <complexType name="DateTimeRange">
    <annotation>
    <documentation> Represents a range of dates (combined with time of day) that has an upper and/or lower bound. </documentation>
    ...
    startDateTime: Optional[DateTime] = Field(
        ...
        description=(
            ...
            "This field is optional and if it is not set then there is no lower bound on the date time range. "
            "If this field is not set then endDateTime must be specified."
        ),
    )
    endDateTime: Optional[DateTime] = Field(
        default=None,
        ...
        description=(
            ...
            "This field is optional and if it is not set then there is no upper bound on the date time range. "
            "If this field is not set then startDateTime must be specified."
        ),
    )


class DateTimeRangeTargeting(GAMSOAPBaseModel):
    """
    <complexType name="DateTimeRangeTargeting">
    <annotation>
    <documentation> The date time ranges that the line item is eligible to serve. </documentation>
    ...
    """
    targetedDateTimeRanges: Optional[list[DateTimeRange]] = Field(
        default=None,
        title="Targeted date time ranges",
        description="The date time ranges that the line item is eligible to serve.",
    )


class Targeting(GAMSOAPBaseModel):
    """
    <complexType name="Targeting">
    <annotation>
    <documentation> Contains targeting criteria for {@link LineItem} objects. See {@link LineItem#targeting}. </documentation>
    ...
    geoTargeting: Optional[GeoTargeting] = Field(
        default=None,
        title="Geo targeting",
        description="Specifies what geographical locations are targeted by the LineItem. This attribute is optional.",
    )
    inventoryTargeting: Optional[InventoryTargeting] = Field(
        default=None,
        title="Inventory targeting",
        description="Specifies what inventory is targeted by the LineItem. This attribute is required. The line item must target at least one ad unit or placement.",
    )
    customTargeting: Optional[CustomCriteriaSet] = Field(
        default=None,
    ...
    inventorySizeTargeting: Optional[InventorySizeTargeting] = Field(
        default=None,
        title="Inventory size targeting",
        description="Specifies the sizes that are targeted by the entity. This is currently only supported on YieldGroup and TrafficDataRequest.",
    )
    dayPartTargeting: Optional[DayPartTargeting] = Field(
        default=None,
        title="Day part targeting",
        description="Specifies the days of the week and times that are targeted by the LineItem. This attribute is optional.",
    )
    dateTimeRangeTargeting: Optional[DateTimeRangeTargeting] = Field(
        default=None,
        title="Date time range targeting",
        description="Specifies the dates and time ranges that are targeted by the LineItem. This attribute is optional.",
    )
    technologyTargeting: Optional[Any] = Field(  # TODO: add TechnologyTargeting model
        default=None,
        title="Technology targeting",
        description="Specifies the browsing technologies that are targeted by the LineItem. This attribute is optional.",
    )
    userDomainTargeting: Optional[Any] = Field(  # TODO: add UserDomainTargeting model
        default=None,
        title="User domain targeting",
        description="Specifies the domains or subdomains that are targeted or excluded by the LineItem. Users visiting from an IP address associated with those domains will be targeted or excluded. This attribute is optional.",
    )
    contentTargeting: Optional[Any] = Field(  # TODO: add ContentTargeting model
        default=None,
        title="Content targeting",
        description="Specifies the video categories and individual videos targeted by the LineItem.",
    )
    videoPositionTargeting: Optional[Any] = Field(  # TODO: add VideoPositionTargeting model
        default=None,
        title="Video position targeting",
        description="Specifies targeting against video position types.",
    )
    mobileApplicationTargeting: Optional[Any] = Field(  # TODO: add MobileApplicationTargeting model
        default=None,
        title="Mobile application targeting",
        description="Specifies targeting against mobile applications.",
    )
    buyerUserListTargeting: Optional[Any] = Field(  # TODO: add BuyerUserListTargeting model
        default=None,
        title="Buyer user list targeting",
        description="Specifies whether buyer user lists are targeted on a programmatic LineItem or ProposalLineItem. This attribute is readonly and is populated by Google.",
    )
    inventoryUrlTargeting: Optional[Any] = Field(  # TODO: add InventoryUrlTargeting model
        default=None,
        title="Inventory URL targeting",
        description="Specifies the URLs that are targeted by the entity. This is currently only supported by YieldGroup.",
    )
    verticalTargeting: Optional[Any] = Field(  # TODO: add VerticalTargeting model
        default=None,
        title="Vertical targeting",
        description="Specifies the verticals that are targeted by the entity. The IDs listed here correspond to the IDs in the AD_CATEGORY table of type VERTICAL.",
    )
    contentLabelTargeting: Optional[Any] = Field(  # TODO: add ContentLabelTargeting model
        default=None,
        title="Content label targeting",
        description="Specifies the content labels that are excluded by the entity. The IDs listed here correspond to the IDs in the CONTENT_LABEL table.",
    )
    requestPlatformTargeting: Optional[Any] = Field(  # TODO: add RequestPlatformTargeting model
        default=None,
        title="Request platform targeting",
        description=(
...
class CreativeTargeting(GAMSOAPBaseModel):
    """
    <complexType name="CreativeTargeting">
    <annotation>
    <documentation> Represents the creative targeting criteria for a {@link LineItem}. </documentation>
    ...
    name: str = Field(
        title="Name",
        description="The name of this creative targeting. This attribute is required.",
    )
    targeting: Targeting = Field(
        title="Targeting",
        description="The Targeting criteria of this creative targeting. This attribute is required.",
    )


class LineItem(LineItemSummary):
    """
    <complexType name="LineItem">
    <annotation>
    <documentation> {@link LineItem} is an advertiser's commitment to purchase a specific number of ad impressions, clicks, or time. </documentation>
    ...
    targeting: Optional[Targeting] = Field(
        default=None,
        title="Targeting",
        description="Contains the targeting criteria for the ad campaign. This attribute is required.",
    )
    creativeTargetings: Optional[list[CreativeTargeting]] = Field(
        default=None,
        title="Creative targetings",
        description=(
