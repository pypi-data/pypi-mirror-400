...
T = TypeVar("T", bound="LabTechEmailIntegration")
...
class LabTechEmailIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        lab_tech_email_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        lab_tech_email_integration.additional_properties = d
        return lab_tech_email_integration
