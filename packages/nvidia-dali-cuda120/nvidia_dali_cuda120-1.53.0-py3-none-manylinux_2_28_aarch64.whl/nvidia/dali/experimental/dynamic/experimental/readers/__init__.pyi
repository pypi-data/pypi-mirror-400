    ...
    * ``timestamps``: Time in seconds of each frame in the sequence. Only available when ``enable_timestamps=True``.
    ...
    pad_last_batch : bool, optional, default = `False`
        ...
        .. note::
          If the number of batches differs across shards, this option can cause an entire batch of repeated
          samples to be added to the dataset.
    pad_mode : str or Tensor/Batch of str, optional, default = `'none'`
    ...
    def __init__(
        ...
        *,
        ...
        file_list_include_end: Optional[builtins.bool] = True,
    ...
    @overload
    def __call__(
        self, /, *, pad_mode: Union[TensorLikeArg, Batch, str, None] = "none"
    ) -> Tensor: ...
    @overload
    def __call__(
        self, /, *, batch_size: int, pad_mode: Union[TensorLikeArg, Batch, str, None] = "none"
    ) -> Batch: ...
    @overload
    def next_epoch(
        self,
