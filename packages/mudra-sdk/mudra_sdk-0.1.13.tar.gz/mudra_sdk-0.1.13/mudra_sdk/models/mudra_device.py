...
class MudraDevice(BLEDevice):
    ...
    def on_serial_number_right_part_received(self, serial_number: int):
        self._serial_number_right_part = serial_number

    def on_serial_number_left_part_received(self, serial_number: int):
        self._serial_number_left_part = serial_number

    def on_firmware_version_received(self, version: str):
    ...
    def get_serial_number(self) -> Optional[int]:
        if self._serial_number_right_part is not None and self._serial_number_left_part is not None:
            return self._serial_number_right_part + self._serial_number_left_part
        return None
