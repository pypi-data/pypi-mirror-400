...
def create_run_content_mapper() -> ParserMapper:
    ...
    """
    from .document.run_content_parser import (
        parse_break,
...
def create_body_content_mapper() -> ParserMapper:
    ...
    """
    from .document.paragraph_parser import parse_paragraph
    from .document.section_parser import parse_section_properties
    from .document.table_parser import parse_table
...
def create_paragraph_content_mapper() -> ParserMapper:
    ...
    """
    from .document.hyperlink_parser import (
        parse_bookmark_end,
        parse_bookmark_start,
        parse_hyperlink,
    )
    from .document.run_parser import parse_run
