...
class RateLimiter:
    ...
    async def wait_if_needed(self):
        ...
        if elapsed < self.min_request_interval:
            await sleep(self.min_request_interval - elapsed)
...
class DigiKeyApi:
    ...
    async def _ensure_token_valid(self):
        # TODO: should be beind mutex to ensure only single refresh happens
    ...
    async def keyword_search(
        ...
        return response.then(DigiKeyApi.validate_respfn(KeywordResponse))
    ...
    async def product_details(
        ...
        return response.then(DigiKeyApi.validate_respfn(ProductDetails))
    ...
    async def get_manufacturers(
        ...
        return response.then(DigiKeyApi.validate_respfn(ManufacturersResponse))
    ...
    async def get_digireel_pricing(
        ...
        return response.then(DigiKeyApi.validate_respfn(DigiReelPricing))
    ...
    async def get_pricing_by_quantity(
        ...
        return response.then(DigiKeyApi.validate_respfn(PricingOptionsForQuantityResponse))
    ...
    async def get_recommended_products(
        ...
        return response.then(DigiKeyApi.validate_respfn(Dict[str, Any]))
    ...
    async def create_quote(
        ...
        return response.then(DigiKeyApi.validate_respfn(QuoteResponse))
    ...
    async def get_all_quotes(
        ...
        return response.then(DigiKeyApi.validate_respfn(QuotesResponse))
    ...
    async def add_products_to_quote(
        ...
        return response.then(DigiKeyApi.validate_respfn(AddProductsToQuoteResponse))
    ...
    async def get_products_from_quote(
        ...
        return response.then(DigiKeyApi.validate_respfn(ProductsFromQuoteResponse))
    ...
    async def search_orders(
        ...
        return response.then(DigiKeyApi.validate_respfn(OrderResponse))
    ...
    async def retrieve_sales_order(
        ...
        return response.then(DigiKeyApi.validate_respfn(SalesOrder))
