...
class Navx:
    ...
    def getAlgoStates(self) -> tuple[int, typing.Annotated[list[float], "FixedSize(9)"]]:
        ...
    def getAngularVel(self) -> tuple[int, typing.Annotated[list[float], "FixedSize(3)"]]:
        ...
    def getCompass(self) -> tuple[int, typing.Annotated[list[float], "FixedSize(4)"]]:
        ...
    def getLinearAccel(self) -> tuple[int, typing.Annotated[list[float], "FixedSize(3)"]]:
        ...
    def getPitch(self) -> float:
        ...
    def getQuat6D(self) -> tuple[int, typing.Annotated[list[float], "FixedSize(4)"]]:
        ...
    def getQuat9D(self) -> tuple[int, typing.Annotated[list[float], "FixedSize(4)"]]:
        ...
    def getRoll(self) -> float:
        ...
