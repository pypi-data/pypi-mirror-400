...
T = TypeVar("T", bound="CreateAuthorizationResponse404")


@_attrs_define
class CreateAuthorizationResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_authorization_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_authorization_response_404.additional_properties = d
        return create_authorization_response_404
