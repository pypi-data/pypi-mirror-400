...
T = TypeVar("T", bound="SubscriptionkeyAdvancedfilter")


@_attrs_define
class SubscriptionkeyAdvancedfilter:
    """Advanced MessageSubscriptionKey filter.

    Attributes:
        eq (str | Unset): Checks for equality with the provided value. Example: 2251799813632456.
        neq (str | Unset): Checks for equality with the provided value. Example: 2251799813632456.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        subscriptionkey_advancedfilter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        subscriptionkey_advancedfilter.additional_properties = d
        return subscriptionkey_advancedfilter
