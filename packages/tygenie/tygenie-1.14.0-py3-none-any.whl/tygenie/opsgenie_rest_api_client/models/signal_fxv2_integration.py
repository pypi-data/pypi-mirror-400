...
T = TypeVar("T", bound="SignalFXV2Integration")


@_attrs_define
class SignalFXV2Integration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        signal_fxv2_integration.additional_properties = d
        return signal_fxv2_integration
