...
T = TypeVar("T", bound="ServiceNowV2Integration")
...
class ServiceNowV2Integration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        service_now_v2_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        service_now_v2_integration.additional_properties = d
        return service_now_v2_integration
