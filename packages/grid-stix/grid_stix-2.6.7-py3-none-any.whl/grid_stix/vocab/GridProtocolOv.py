"""
Open vocabulary for grid protocols
...
class GridProtocolOv(GridSTIXDomainObject):
    """
    Open vocabulary for grid protocols
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize GridProtocolOv with Grid-STIX properties."""
