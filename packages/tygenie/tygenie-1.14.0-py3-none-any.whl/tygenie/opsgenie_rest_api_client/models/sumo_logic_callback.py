...
T = TypeVar("T", bound="SumoLogicCallback")


@_attrs_define
class SumoLogicCallback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sumo_logic_callback.additional_properties = d
        return sumo_logic_callback
