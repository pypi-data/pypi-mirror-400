...
class Agent:
    def __init__(
        ...
        *,
        ...
        if isinstance(stt, str) or isinstance(llm, str) or isinstance(tts, str):
            raise ValueError("String model shortcuts are not supported. Pass initialized model instances instead.")
