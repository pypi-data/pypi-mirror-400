...
T = TypeVar("T", bound="SearchMappingRulesForTenantDataFilter")


@_attrs_define
class SearchMappingRulesForTenantDataFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_mapping_rules_for_tenant_data_filter = cls(
        ...
        search_mapping_rules_for_tenant_data_filter.additional_properties = d
        return search_mapping_rules_for_tenant_data_filter
