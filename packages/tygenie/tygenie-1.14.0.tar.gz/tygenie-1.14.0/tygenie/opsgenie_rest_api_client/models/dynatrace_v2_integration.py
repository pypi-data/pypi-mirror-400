...
T = TypeVar("T", bound="DynatraceV2Integration")


@_attrs_define
class DynatraceV2Integration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        dynatrace_v2_integration.additional_properties = d
        return dynatrace_v2_integration
