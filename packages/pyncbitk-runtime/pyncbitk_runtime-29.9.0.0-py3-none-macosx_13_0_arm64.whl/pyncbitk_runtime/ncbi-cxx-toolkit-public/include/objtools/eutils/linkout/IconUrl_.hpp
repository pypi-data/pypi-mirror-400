...
#ifndef linkout__OBJTOOLS_EUTILS_LINKOUT_ICONURL_BASE_HPP
#define linkout__OBJTOOLS_EUTILS_LINKOUT_ICONURL_BASE_HPP
...
inline
void CIconUrl_Base::SetIconUrl(CIconUrl_Base::TIconUrl&& value)
{
    m_IconUrl = std::forward<CIconUrl_Base::TIconUrl>(value);
    m_set_State[0] |= 0xc;
}
...
#endif // linkout__OBJTOOLS_EUTILS_LINKOUT_ICONURL_BASE_HPP
