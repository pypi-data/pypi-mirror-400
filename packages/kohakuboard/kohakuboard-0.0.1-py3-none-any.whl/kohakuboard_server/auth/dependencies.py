...
from kohakuboard_server.auth.utils import hash_token
from kohakuboard_server.config import cfg
from kohakuboard_server.db import Session, Token, User
...
def get_current_user(
    ...
    if cfg.app.no_auth:
        ...
        if not test_user:
            from kohakuboard_server.auth.utils import hash_password
