...
class SenderRequests200ResponseMeta(BaseModel):
    """
    SenderRequests200ResponseMeta
    """ # noqa: E501
    page: Optional[SenderRequests200ResponseMetaPage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "page": SenderRequests200ResponseMetaPage.from_dict(obj["page"]) if obj.get("page") is not None else None
        })
        return _obj
