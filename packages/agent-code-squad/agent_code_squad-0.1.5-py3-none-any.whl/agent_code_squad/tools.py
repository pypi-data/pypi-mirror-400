...
def register_tools(mcp: FastMCP, *, config: SquadConfig) -> None:
    ...
    def _apply_reasoning_effort_cap(extra_config: Any, *, options: dict[str, Any], task: dict[str, Any]) -> list[str]:
        """
        Self-use hard cap: enforce model_reasoning_effort <= medium.
        - If caller explicitly requests low, keep low.
        - If caller requests medium/high or provides none, use medium.
        ...
        effective = "low" if requested == "low" else "medium"
