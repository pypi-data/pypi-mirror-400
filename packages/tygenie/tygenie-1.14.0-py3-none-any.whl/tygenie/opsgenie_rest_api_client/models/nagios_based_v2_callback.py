...
T = TypeVar("T", bound="NagiosBasedV2Callback")


@_attrs_define
class NagiosBasedV2Callback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nagios_based_v2_callback.additional_properties = d
        return nagios_based_v2_callback
