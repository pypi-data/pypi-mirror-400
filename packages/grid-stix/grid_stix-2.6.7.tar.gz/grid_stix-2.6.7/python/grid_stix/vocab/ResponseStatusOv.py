"""
Open vocabulary for response statuses
...
class ResponseStatusOv(GridSTIXDomainObject):
    """
    Open vocabulary for response statuses
    ...
    _type = "x-grid-response-status-ov"
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize ResponseStatusOv with Grid-STIX properties."""
