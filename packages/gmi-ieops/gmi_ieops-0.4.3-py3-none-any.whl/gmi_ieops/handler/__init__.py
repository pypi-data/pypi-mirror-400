...
# Engine - unified management for Register and Interceptor
from .engine import Engine

# Interceptor - transparent proxy (usually used via Engine)
from .interceptor import Interceptor, DEFAULT_FILTER_HEADERS, DEFAULT_FILTER_RESPONSE_HEADERS
...
__all__ = [
    ...
    # Engine (unified management, recommended)
    'Engine',
    
    # Interceptor (low-level, usually use Engine instead)
    'Interceptor',
    'DEFAULT_FILTER_HEADERS',
    'DEFAULT_FILTER_RESPONSE_HEADERS',
