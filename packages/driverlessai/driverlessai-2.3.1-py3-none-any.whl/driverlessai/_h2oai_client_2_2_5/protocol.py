...
from _h2oai_client_2_2_5 import references
from _h2oai_client_2_2_5 import validation
from _h2oai_client_2_2_5.messages import *
...
class Client:
    ...
    # These are extension methods that are appended to the _h2oai_client_2_2_5 module
    ...
    def create_dataset_from_s3_sync(
        ...
        args = S3CreateDatasetArgs(
            access_key_id, secret_access_key, assumed_role_arn, session_token
        )
        key = self.create_dataset_from_s3(filepath, args)
        job = self._wait_for_dataset(key)
        return job.entity
    ...
    def search_s3_files(self, pattern: str, args: S3CreateDatasetArgs) -> FileSearchResults:
        """

        """
        req_ = dict(pattern=pattern, args=args.dump())
    ...
    def create_dataset_from_s3(self, filepath: str, args: S3CreateDatasetArgs) -> str:
        """

        """
        req_ = dict(filepath=filepath, args=args.dump())
...
class AutovizClient:
    ...
    def __init__(self, _h2oai_client_2_2_5):
        self.client = _h2oai_client_2_2_5
