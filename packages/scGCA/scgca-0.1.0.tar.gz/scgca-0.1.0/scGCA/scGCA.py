...
class scGCA(nn.Module):
    ...
    gene_factor_size
        Number of sequence features associated with gene regions
    transforms
        Number of transform functions used by normalizing flow
    flow_hidden_layers
        Network structures used by normalizing flow
    z_dim
    ...
    def __init__(self,
                 ...
                 transforms: int = 3,
                 flow_hidden_layers: list = [64,64,64],
                 z_dim: int = 50,
                 loss_func: Literal['poisson','bernoulli','negbinomial'] = 'negbinomial',
    ...
    def setup_networks(self):
        ...
        self.decoder_zn = zuko.flows.NSF(features=self.latent_dim, context=self.input_dim, 
    ...
    def model(self, xs, us=None):
        ...
        with pyro.plate('data'):
            zns = pyro.sample('zn', ZukoToPyro(self.decoder_zn(xs)))
    ...
    def get_log_mu(self, zs, us = None,
                   ...
                   show_progress: bool = True):
        """
        Return the log-mean expression of input cells.

        Parameters
        ----------
        xs
            Single-cell peak matrix.
        batch_size
            Size of batch processing.
        show_progress
            Verbose on or off.
    ...
    def get_counts(self, zs, library_sizes, us=None, 
                        ...
                        show_progress: bool = True):
        """
        Return the count predict of input cells.
    ...
    def get_cell_accessibility(self, zs, us=None,
                                 ...
                                 show_progress: bool = True):
        """
        Return the accessibiilty predict of input cells.
    ...
    def fit(self, xs, 
        ...
        us
            Cell covariates.
        gene_factors
            Gene region features.
        threshold
            Threshold for binarizing peak values.
        num_epochs
