...
class VESUVIOULS(AbstractUnconstrainedMinimisation):
    """ISIS Data fitting problem VESUVIO (unweighted least squares version).
    ...
    def objective(self, y, args=None):
        """Compute the least squares objective function (unweighted)."""
        b1, b2, b3, b4, b5, b6, b7, b8 = y

        # X data points (1025 values from 5e-05 to 0.000562)
        x_data = jnp.linspace(5e-05, 0.000562, 1025)

        # Y data points (1025 observed values - same as VESUVIO/VESUVIOU)
        y_data = jnp.array(
            [
                -0.043818,
                -0.0374639,
        ...
        # Using standard Gaussian (division in exponent) - same as VESUVIO/VESUVIOU
        model = (
            b1
            + b2 * x_data
