...
class CommandMassiveInvoiceReceptionElectronica(DataTransferObject):
    nit: int | str
    cuis: str
    cufd: str
...
class ResponseMassiveInvoiceReceptionElectronica(DataTransferObject):
    literal_status: SectorDocumentState | str
    reception_code: str
    raw_response: Any


@siat_soap_sdk.feature(CommandMassiveInvoiceReceptionElectronica)
class MassiveReceptionElectronica(Feature):

    def execute(
        self, dto: CommandMassiveInvoiceReceptionElectronica
        ...
        return ResponseMassiveInvoiceReceptionElectronica(
