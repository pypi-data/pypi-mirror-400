...
T = TypeVar("T", bound="GetProcessInstanceSequenceFlowsResponse400")


@_attrs_define
class GetProcessInstanceSequenceFlowsResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_process_instance_sequence_flows_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_process_instance_sequence_flows_response_400.additional_properties = d
        return get_process_instance_sequence_flows_response_400
