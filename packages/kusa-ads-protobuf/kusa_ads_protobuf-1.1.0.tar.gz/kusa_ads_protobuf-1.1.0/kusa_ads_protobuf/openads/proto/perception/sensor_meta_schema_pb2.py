...
# source: openads/proto/perception/sensor_meta_schema.proto
...
_SENSORMETA_SENSORTYPE = _descriptor.EnumDescriptor(
  name='SensorType',
  full_name='openads.proto.perception.SensorMeta.SensorType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SENSORMETA_SENSORORIENTATION = _descriptor.EnumDescriptor(
  ...
  full_name='openads.proto.perception.SensorMeta.SensorOrientation',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_SENSORMETA = _descriptor.Descriptor(
  name='SensorMeta',
  full_name='openads.proto.perception.SensorMeta',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='openads.proto.perception.SensorMeta.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='openads.proto.perception.SensorMeta.type', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='orientation', full_name='openads.proto.perception.SensorMeta.orientation', index=2,
...
_MULTISENSORMETA = _descriptor.Descriptor(
  ...
  full_name='openads.proto.perception.MultiSensorMeta',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='sensor_meta', full_name='openads.proto.perception.MultiSensorMeta.sensor_meta', index=0,
...
SensorMeta = _reflection.GeneratedProtocolMessageType('SensorMeta', (_message.Message,), dict(
  ...
  __module__ = 'openads.proto.perception.sensor_meta_schema_pb2'
  # @@protoc_insertion_point(class_scope:openads.proto.perception.SensorMeta)
  ))
...
MultiSensorMeta = _reflection.GeneratedProtocolMessageType('MultiSensorMeta', (_message.Message,), dict(
  ...
  __module__ = 'openads.proto.perception.sensor_meta_schema_pb2'
  # @@protoc_insertion_point(class_scope:openads.proto.perception.MultiSensorMeta)
  ))
