...
class RunState:
    ...
    phase: str  # supervisor_run|coder_run|integrate|cleanup|done|error
    next_action: str  # wait|apply
    wait_reason: str  # agent_running|cleanup_running|blocked|idle|ready_to_apply|error
    created_at: str
    updated_at: str
