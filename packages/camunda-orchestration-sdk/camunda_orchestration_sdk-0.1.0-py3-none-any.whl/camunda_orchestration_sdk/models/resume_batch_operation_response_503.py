...
T = TypeVar("T", bound="ResumeBatchOperationResponse503")


@_attrs_define
class ResumeBatchOperationResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resume_batch_operation_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        resume_batch_operation_response_503.additional_properties = d
        return resume_batch_operation_response_503
