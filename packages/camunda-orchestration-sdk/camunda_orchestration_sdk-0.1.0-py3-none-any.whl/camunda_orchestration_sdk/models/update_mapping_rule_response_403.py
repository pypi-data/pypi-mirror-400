...
T = TypeVar("T", bound="UpdateMappingRuleResponse403")


@_attrs_define
class UpdateMappingRuleResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_mapping_rule_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        update_mapping_rule_response_403.additional_properties = d
        return update_mapping_rule_response_403
