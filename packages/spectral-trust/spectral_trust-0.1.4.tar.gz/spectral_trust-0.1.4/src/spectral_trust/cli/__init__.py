...
def main():
    ...
    # Diagnose
    p_diagnose = subparsers.add_parser('diagnose')
    p_diagnose.add_argument('--model', type=str, default='microsoft/Phi-3-mini-4k-instruct')
    ...
    if args.command == 'analyze':
        ...
        from spectral_trust.cli.diagnosis import run_diagnosis
