...
class TrackedGoogleAI:
    ...
    def generate_content(self, contents, **api_kwargs):
        with track(**self._kwargs) as t:
...
class _TrackedGoogleAIChat:
    ...
    def send_message(self, content, **api_kwargs):
        with track(**self._kwargs) as t:
...
def wrap(
    ...
    *,
    ...
    Example:
        ...
        openai = wrap(OpenAI(), prompt_id="my_agent")
        anthropic = wrap(Anthropic(), prompt_id="my_agent")
    """
    kwargs = {
        "api_key": api_key,
        "base_url": base_url,
    ...
    if provider == "openai":
        return wrap_openai(client, prompt_id, **kwargs)
    elif provider == "anthropic":
        return wrap_anthropic(client, prompt_id, **kwargs)
    elif provider == "google":
        return wrap_google_ai(client, prompt_id, **kwargs)
    elif provider == "mistral":
        return wrap_mistral(client, prompt_id, **kwargs)
    elif provider == "cohere":
        return wrap_cohere(client, prompt_id, **kwargs)
    else:
