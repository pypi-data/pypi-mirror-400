...
__all__ = ["ItemReceiptListParams"]


class ItemReceiptListParams(TypedDict, total=False):
    ...
    """
    Filter for specific item receipts by their QuickBooks-assigned unique
    identifier(s).
    ...
    **NOTE**: If any of the values you specify in this parameter are not found, the
    ...
    Defaults to `false`. For example, a payment linked to the corresponding item
    receipt.
    """
    ...
    **NOTE**: If you use this parameter, you cannot also use `refNumberContains` or
    ...
    """
    Filter for item receipts whose `refNumber` is greater than or equal to this
    ...
    """Filter for specific item receipts by their ref-number(s), case-sensitive.
    ...
    **NOTE**: If you use this parameter, you cannot also use `refNumberContains` or
    ...
    """Filter for item receipts whose `refNumber` is less than or equal to this value.
    ...
    """
    Filter for item receipts whose `date` field is on or after this date, in ISO
    ...
    **NOTE:** QuickBooks Desktop interprets this date as the **start of the
    ...
    """
    Filter for item receipts whose `date` field is on or before this date, in ISO
    8601 format (YYYY-MM-DD).
    ...
    **NOTE:** QuickBooks Desktop interprets this date as the **end of the specified
    ...
    """Filter for item receipts updated on or after this date/time.
    ...
    """Filter for item receipts updated on or before this date/time.
