...
The effects of sham hypnosis techniques (OpenNeuro ``ds004572``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 10` :bdg-light:`License: CC0` :bdg-light:`Subjects: 52` :bdg-light:`Recordings: 516` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds004572.v1.3.1 <https://doi.org/10.18112/openneuro.ds004572.v1.3.1>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds004572>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds004572>`__
