...
export default [
  {
    ...
    component: ComponentCreator('/solace-agent-mesh/docs', '3a2'),
    routes: [
      {
        path: '/solace-agent-mesh/docs',
        component: ComponentCreator('/solace-agent-mesh/docs', 'de5'),
        routes: [
          {
            path: '/solace-agent-mesh/docs',
            component: ComponentCreator('/solace-agent-mesh/docs', '7f8'),
            routes: [
              {
