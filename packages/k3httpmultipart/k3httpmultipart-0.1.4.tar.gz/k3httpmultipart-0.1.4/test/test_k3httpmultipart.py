...
class TestMultipart(unittest.TestCase):
    ...
    def test_headers(self):
        ...
        k3fs.fwrite("/tmp/a.txt", str1)
        k3fs.fwrite("/tmp/b.txt", str2)
        ...
        for h in case:
            self.assertEqual(h[1], self.test_multipart.make_headers(fields, h[0]))
    ...
    def test_raise_invalid_argument_type_error(self):
        ...
        for case in cases:
            self.assertRaises(k3httpmultipart.InvalidArgumentTypeError, self.test_multipart._standardize_field, *case)
