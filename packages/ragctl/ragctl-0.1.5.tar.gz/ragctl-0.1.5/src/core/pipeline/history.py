"""History tracking for ragctl pipeline runs.

This module manages the history of pipeline executions, storing detailed
information about each run in ~/.ragctl/history/.
"""
...
DEFAULT_HISTORY_DIR = Path.home() / ".ragctl" / "history" / "runs"
    ...
    def __init__(self, history_dir: Optional[Path] = None):
        ...
        Args:
            history_dir: Directory for storing run history
                        (defaults to ~/.ragctl/history/runs)
        """
