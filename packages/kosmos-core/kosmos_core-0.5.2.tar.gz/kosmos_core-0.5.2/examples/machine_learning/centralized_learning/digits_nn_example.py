...
from kosmos.ml.datasets.digits_dataset import DigitsDataset
from kosmos.utils.rng import RNG


def digits_nn_example() -> None:
    """Run example of training and testing on the Digits dataset using a neural network."""
    ...
    config = SLTrainConfig(
        ...
        batch_size=64,
        num_epochs=50,
        model_config=NeuralNetworkConfig([128, 64]),
