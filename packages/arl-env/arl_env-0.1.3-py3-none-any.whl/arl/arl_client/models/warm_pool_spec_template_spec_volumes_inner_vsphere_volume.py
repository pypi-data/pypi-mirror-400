...
class WarmPoolSpecTemplateSpecVolumesInnerVsphereVolume(BaseModel):
    ...
    storage_policy_id: Optional[StrictStr] = Field(default=None, alias="storagePolicyID")
    storage_policy_name: Optional[StrictStr] = Field(default=None, alias="storagePolicyName")
