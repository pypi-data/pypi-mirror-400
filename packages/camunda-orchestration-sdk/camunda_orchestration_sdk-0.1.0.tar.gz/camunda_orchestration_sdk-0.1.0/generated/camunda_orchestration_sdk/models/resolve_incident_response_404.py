...
T = TypeVar("T", bound="ResolveIncidentResponse404")


@_attrs_define
class ResolveIncidentResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resolve_incident_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        resolve_incident_response_404.additional_properties = d
        return resolve_incident_response_404
