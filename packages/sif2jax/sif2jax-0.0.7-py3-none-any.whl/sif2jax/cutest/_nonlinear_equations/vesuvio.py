...
class VESUVIO(AbstractNonlinearEquations):
    ...
    def residual(self, y):
        ...
        # E values (standard deviations) for scaling the residuals - same as VESUVIA
        e_data = jnp.array(
            [
                0.0303863,
                0.0310173,
        ...
        # Y data points (1025 observed values - same as VESUVIA/VESUVIALS)
        y_data = jnp.array(
            [
                -0.043818,
                -0.0374639,
        ...
        # Using standard Gaussian (division in exponent)
        model = (
            b1
            + b2 * x_data
        ...
        # Residuals: (model - observed) / e_data (scaled residuals)
        return (model - y_data) / e_data
