...
class ProgramDatabase:
    ...
    def add(
        self, program: Program, iteration: int = None, target_island: int | None = None
    ) -> str:
        """
    ...
    def sample(
        self, num_inspirations: int | None = None
    ...
    def _is_novel(self, program_id: int, island_idx: int) -> bool:
        ...
        for pid in self.islands[island_idx]:
            ...
            if other.embedding is None:
                logger.log(
                    "Warning: Program %s has no embedding, skipping similarity check",
                    other.id,
                )
                continue
    ...
    def _enforce_population_limit(self, exclude_program_id: str | None = None) -> None:
        ...
        for program in programs_to_remove:
            ...
            for _island_idx, island_map in enumerate(self.island_feature_maps):
                keys_to_remove = []
            ...
            for migrant in migrants:
                ...
                for target_island in target_islands:
                    ...
                    has_duplicate_code = any(
                        p.code == migrant.code for p in target_island_programs
                    )
    ...
    def store_artifacts(
        self, program_id: str, artifacts: dict[str, str | bytes]
    ) -> None:
        """
    ...
    def _write_artifact_file(
        self, artifact_dir: str, key: str, value: str | bytes
    ) -> None:
