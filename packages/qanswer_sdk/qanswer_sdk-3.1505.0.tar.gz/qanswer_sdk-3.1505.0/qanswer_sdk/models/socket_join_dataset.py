...
class SocketJoinDataset(BaseModel):
    """
    SocketJoinDataset
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["username", "dataset", "jwt", "api_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SocketJoinDataset from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SocketJoinDataset from a dict"""
        if obj is None:
            return None
