...
class ConfigLoader:
    ...
    def get_config(self, key: str, config_name: str) -> Union[str, int, float, bool, None, dict, list]:
        ...
        return reduce(lambda d, k: d.get(k, key) if isinstance(d, dict) else key, keys,
    ...
    async def async_set_config(self, key: str, value: Union[str, int, float, bool, None, dict, list],
    ...
    @staticmethod
    def _check_configuration_list(configurations: list[dict[str, Union[str, os.PathLike]]]) -> None:
        """
...
def set_config_value(key: str, value: Union[str, int, float, bool, None, dict, list],
...
async def async_set_config_value(key: str, value: Union[str, int, float, bool, None, dict, list],
                                 config_name: str = 'default') -> None:
    """
    Set a value in a configuration by key and save the changes to the configuration file asynchronously
