...
class TAIntegration:
    ...
    @staticmethod
    def get_volume_indicators(df: pd.DataFrame,
                             high_col: str = 'High',
                             low_col: str = 'Low',
                             close_col: str = 'Close',
    ...
    @staticmethod
    def get_volatility_indicators(df: pd.DataFrame,
                                 high_col: str = 'High',
                                 low_col: str = 'Low',
    ...
    @staticmethod
    def get_trend_indicators(df: pd.DataFrame,
                            high_col: str = 'High',
                            low_col: str = 'Low',
                            close_col: str = 'Close') -> Dict[str, pd.Series]:
        ...
        try:
            ...
            indicators['kst_sig'] = ta.trend.KSTIndicator(
                close=df[close_col]
            ).kst_sig()
    ...
    @staticmethod
    def get_momentum_indicators(df: pd.DataFrame,
                               high_col: str = 'High',
                               low_col: str = 'Low',
                               close_col: str = 'Close',
                               volume_col: str = 'Volume') -> Dict[str, pd.Series]:
    ...
    @staticmethod
    def get_others_indicators(df: pd.DataFrame,
                             high_col: str = 'High',
                             low_col: str = 'Low',
                             close_col: str = 'Close',
                             volume_col: str = 'Volume') -> Dict[str, pd.Series]:
    ...
    @staticmethod
    def get_all_indicators(df: pd.DataFrame,
                          high_col: str = 'High',
                          low_col: str = 'Low',
                          close_col: str = 'Close',
                          volume_col: str = 'Volume',
                          open_col: str = 'Open') -> Dict[str, Dict[str, pd.Series]]:
        """Get all indicators organized by category."""
        if not TA_AVAILABLE:
            return {}
        
        all_indicators = {
            'volume': TAIntegration.get_volume_indicators(df, high_col, low_col, close_col, volume_col),
            'volatility': TAIntegration.get_volatility_indicators(df, high_col, low_col, close_col),
            'trend': TAIntegration.get_trend_indicators(df, high_col, low_col, close_col),
            'momentum': TAIntegration.get_momentum_indicators(df, high_col, low_col, close_col, volume_col),
            'others': TAIntegration.get_others_indicators(df, high_col, low_col, close_col, volume_col)
        }
...
def get_all_ta_indicators(df: pd.DataFrame, **kwargs) -> Dict[str, Dict[str, pd.Series]]:
