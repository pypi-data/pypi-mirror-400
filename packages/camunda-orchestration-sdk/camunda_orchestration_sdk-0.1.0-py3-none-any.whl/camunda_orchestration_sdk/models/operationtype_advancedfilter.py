...
from ..models.operationtype_advancedfilter_eq import OperationtypeAdvancedfilterEq
from ..models.operationtype_advancedfilter_in_item import (
...
class OperationtypeAdvancedfilter:
    ...
    Attributes:
        eq (OperationtypeAdvancedfilterEq | Unset): Checks for equality with the provided value.
        neq (OperationtypeAdvancedfilterNeq | Unset): Checks for inequality with the provided value.
        exists (bool | Unset): Checks if the current property exists.
        in_ (list[OperationtypeAdvancedfilterInItem] | Unset): Checks if the property matches any of the provided
            values.
    ...
    neq: OperationtypeAdvancedfilterNeq | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        _eq = d.pop("$eq", UNSET)
        eq: OperationtypeAdvancedfilterEq | Unset
        if isinstance(_eq, Unset):
            eq = UNSET
        else:
            eq = OperationtypeAdvancedfilterEq(_eq)

        _neq = d.pop("$neq", UNSET)
        neq: OperationtypeAdvancedfilterNeq | Unset
        if isinstance(_neq, Unset):
            neq = UNSET
        else:
            neq = OperationtypeAdvancedfilterNeq(_neq)
        ...
        if _in_ is not UNSET:
            ...
            for in_item_data in _in_:
                in_item = OperationtypeAdvancedfilterInItem(in_item_data)

                in_.append(in_item)

        like = d.pop("$like", UNSET)

        operationtype_advancedfilter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        operationtype_advancedfilter.additional_properties = d
        return operationtype_advancedfilter
