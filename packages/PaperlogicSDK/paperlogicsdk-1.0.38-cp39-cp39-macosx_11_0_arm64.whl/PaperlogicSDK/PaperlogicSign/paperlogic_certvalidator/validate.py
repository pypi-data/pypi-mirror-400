...
async def intl_validate_path(
    ...
    :param path:
        A paperlogic_certvalidator.path.ValidationPath object of the path to validate
...
def validate_tls_hostname(
    ...
    paperlogic_certvalidator.path.ValidationPath object to ensure that the certificate
...
def validate_usage(
    ...
    """
    Validates the end-entity certificate from a
    paperlogic_certvalidator.path.ValidationPath object to ensure that the
