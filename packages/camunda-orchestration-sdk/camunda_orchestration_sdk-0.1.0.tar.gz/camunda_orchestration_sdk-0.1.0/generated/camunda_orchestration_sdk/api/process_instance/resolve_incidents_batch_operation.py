...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ResolveIncidentsBatchOperationResponse200 | ResolveIncidentsBatchOperationResponse400 | ResolveIncidentsBatchOperationResponse401 | ResolveIncidentsBatchOperationResponse403 | ResolveIncidentsBatchOperationResponse500 | None:
    if response.status_code == 200:
        response_200 = ResolveIncidentsBatchOperationResponse200.from_dict(response.json())
        return response_200
    if response.status_code == 400:
        response_400 = ResolveIncidentsBatchOperationResponse400.from_dict(response.json())
        return response_400
    if response.status_code == 401:
        response_401 = ResolveIncidentsBatchOperationResponse401.from_dict(response.json())
        return response_401
    if response.status_code == 403:
        response_403 = ResolveIncidentsBatchOperationResponse403.from_dict(response.json())
        return response_403
    if response.status_code == 500:
        response_500 = ResolveIncidentsBatchOperationResponse500.from_dict(response.json())
        return response_500
