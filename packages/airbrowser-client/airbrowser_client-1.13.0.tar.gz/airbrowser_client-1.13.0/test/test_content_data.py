...
class TestContentData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ContentData:
        """Test ContentData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentData`
        """
        model = ContentData()
        if include_optional:
            return ContentData(
