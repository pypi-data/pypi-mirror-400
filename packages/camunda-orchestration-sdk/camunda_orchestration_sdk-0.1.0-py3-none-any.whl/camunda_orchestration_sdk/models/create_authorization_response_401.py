...
T = TypeVar("T", bound="CreateAuthorizationResponse401")


@_attrs_define
class CreateAuthorizationResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_authorization_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_authorization_response_401.additional_properties = d
        return create_authorization_response_401
