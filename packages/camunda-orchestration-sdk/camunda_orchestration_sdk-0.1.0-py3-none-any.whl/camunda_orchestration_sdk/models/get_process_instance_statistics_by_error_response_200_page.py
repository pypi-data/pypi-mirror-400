...
T = TypeVar("T", bound="GetProcessInstanceStatisticsByErrorResponse200Page")


@_attrs_define
class GetProcessInstanceStatisticsByErrorResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_process_instance_statistics_by_error_response_200_page = cls(
        ...
        get_process_instance_statistics_by_error_response_200_page.additional_properties = d
        return get_process_instance_statistics_by_error_response_200_page
