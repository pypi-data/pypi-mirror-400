"""
Open Charge Point Protocol. Used by EVSEs to communicate with central management systems. Common in commercial/public charging deployments.
...
class OcppProtocol(GridSTIXDomainObject):
    """
    Open Charge Point Protocol. Used by EVSEs to communicate with central management systems. Common in commercial/public charging deployments.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize OcppProtocol with Grid-STIX properties."""
