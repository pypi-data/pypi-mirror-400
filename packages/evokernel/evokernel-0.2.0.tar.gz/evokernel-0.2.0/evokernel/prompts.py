...
6. When spec is complete, ask "Ready to start evolution?"
7. On confirmation, use evo_evolve to launch OpenEvolve
8. Tell user evolution is running and they can check with evo_status or /dashboard
9. **DO NOT wait, sleep, or poll** - let user continue or check when ready
10. When user asks about results, use evo_show to display them
11. Use evo_explain to explain what optimizations were applied
12. Use evo_compare to compare original vs optimized
13. Use evo_apply to write optimized kernel to codebase
