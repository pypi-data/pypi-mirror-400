...
@_attrs_define
class SearchIncidentsDataFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_incidents_data_filter = cls(
        ...
        search_incidents_data_filter.additional_properties = d
        return search_incidents_data_filter
