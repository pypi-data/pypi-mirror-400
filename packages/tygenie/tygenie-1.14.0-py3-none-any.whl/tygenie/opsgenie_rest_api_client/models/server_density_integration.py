...
T = TypeVar("T", bound="ServerDensityIntegration")
...
class ServerDensityIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        server_density_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        server_density_integration.additional_properties = d
        return server_density_integration
