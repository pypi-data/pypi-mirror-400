...
T = TypeVar("T", bound="DeprecatedAutoRestartNotificationsAlertPolicy")
...
class DeprecatedAutoRestartNotificationsAlertPolicy:
    ...
    Attributes:
        ...
        max_repeat_count (Union[Unset, int]): Max restart count of the notification flow
    """
    ...
    max_repeat_count: Union[Unset, int] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if max_repeat_count is not UNSET:
            field_dict["maxRepeatCount"] = max_repeat_count
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        max_repeat_count = d.pop("maxRepeatCount", UNSET)

        deprecated_auto_restart_notifications_alert_policy = cls(
            type=type,
            id=id,
            name=name,
        ...
        deprecated_auto_restart_notifications_alert_policy.additional_properties = d
        return deprecated_auto_restart_notifications_alert_policy
