...
T = TypeVar("T", bound="SearchDecisionDefinitionsResponse500")


@_attrs_define
class SearchDecisionDefinitionsResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_decision_definitions_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_decision_definitions_response_500.additional_properties = d
        return search_decision_definitions_response_500
