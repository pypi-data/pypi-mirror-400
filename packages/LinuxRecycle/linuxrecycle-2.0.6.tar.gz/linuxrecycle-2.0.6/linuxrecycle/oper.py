...
def MoveToTrash(address):
    ...
    trash_dir_name = os.path.expanduser(trash_dir_name)
    exits = "exits"
    Type = "f"
    ...
    if trashInfo.whiteFile(address):
        ...
        trashAddress = os.path.expanduser(trashAddress)
        try:
            shutil.move(os.path.expanduser(address), os.path.expanduser(trashAddress))
