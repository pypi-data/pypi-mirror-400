...
T = TypeVar("T", bound="SearchBatchOperationsResponse200Page")


@_attrs_define
class SearchBatchOperationsResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_batch_operations_response_200_page = cls(
        ...
        search_batch_operations_response_200_page.additional_properties = d
        return search_batch_operations_response_200_page
