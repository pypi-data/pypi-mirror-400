...
T = TypeVar("T", bound="GetAppReviewsResponse200")



@_attrs_define
class GetAppReviewsResponse200:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_app_reviews_response_200 = cls(
            reviews=reviews,
            next_cursor=next_cursor,
        )


        get_app_reviews_response_200.additional_properties = d
        return get_app_reviews_response_200
