...
T = TypeVar("T", bound="AssignRoleToUserResponse400")


@_attrs_define
class AssignRoleToUserResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assign_role_to_user_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        assign_role_to_user_response_400.additional_properties = d
        return assign_role_to_user_response_400
