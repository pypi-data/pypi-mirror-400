...
T = TypeVar("T", bound="SolarWindsWebHelpDeskCallback")
...
class SolarWindsWebHelpDeskCallback:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        solar_winds_web_help_desk_callback = cls(
        ...
        solar_winds_web_help_desk_callback.additional_properties = d
        return solar_winds_web_help_desk_callback
