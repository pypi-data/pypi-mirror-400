...
class ProfilesApi:
    ...
    def create_profile(
        ...
        :type payload: CreateProfileRequest
    ...
    def delete_profile(
        self,
        profile_name: Annotated[StrictStr, Field(description="Profile name")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param profile_name: Profile name (required)
    ...
    def _delete_profile_serialize(
        ...
        if profile_name is not None:
            _path_params['profile_name'] = profile_name
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/profiles/{profile_name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
