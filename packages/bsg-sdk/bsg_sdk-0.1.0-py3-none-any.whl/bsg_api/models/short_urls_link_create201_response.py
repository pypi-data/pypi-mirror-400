...
class ShortUrlsLinkCreate201Response(BaseModel):
    """
    ShortUrlsLinkCreate201Response
    """ # noqa: E501
    data: Optional[ShortUrlLinkSchema] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ShortUrlLinkSchema.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
