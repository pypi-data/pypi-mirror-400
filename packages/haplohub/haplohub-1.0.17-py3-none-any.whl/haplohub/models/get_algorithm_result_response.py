...
class GetAlgorithmResultResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAlgorithmResultResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAlgorithmResultResponse:
        """Create an instance of GetAlgorithmResultResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAlgorithmResultResponse.parse_obj(obj)

        _obj = GetAlgorithmResultResponse.parse_obj(
            {
