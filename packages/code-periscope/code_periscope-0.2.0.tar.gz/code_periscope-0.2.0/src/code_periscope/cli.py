...
def analyze(
    ...
    out_format: Literal["markdown", "html"] = typer.Option(
        "markdown",
        "--out-format",
        help="Which report to generate: 'markdown' writes report.md, 'html' writes report.html.",
        show_default=True,
    ),
    debug: bool = typer.Option(
        False,
        "--debug",
        help="Keep intermediate CSV artifacts in the output folder (do not clean up).",
        show_default=True,
    ),
) -> None:
