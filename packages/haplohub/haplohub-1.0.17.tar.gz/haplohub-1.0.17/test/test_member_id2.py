...
from haplohub.models.member_id2 import MemberId2  # noqa: E501


class TestMemberId2(unittest.TestCase):
    """MemberId2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MemberId2:
        """Test MemberId2
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MemberId2`
        """
        model = MemberId2()  # noqa: E501
        if include_optional:
            return MemberId2(
            )
        else:
