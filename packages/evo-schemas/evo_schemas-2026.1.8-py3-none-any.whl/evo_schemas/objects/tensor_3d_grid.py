...
class Tensor3DGrid_V1_3_0_GridCells3D(Serialiser):
    ...
    Attributes:
        ...
        cell_sizes_z (list[float]): An array of float values that represent the cell sizes along the z-axis.
    """
...
class Tensor3DGrid_V1_3_0(BaseSpatialDataProperties_V1_1_0):
    ...
    Attributes:
        ...
        grid_cells_3d (Tensor3DGrid_V1_3_0_GridCells3D): Grid cell sizes along the axes
...
class Tensor3DGrid_V1_1_0(BaseSpatialDataProperties_V1_0_1):
    ...
    Attributes:
        ...
        origin (list[float]): The coordinates of the origin [x,y,z]
        size (list[int]): Number of cells in each direction. [grid_size_x, grid_size_y, grid_size_z]
        grid_cells_3d (Tensor3DGrid_V1_1_0_GridCells3D): Grid cell sizes along the axes
...
class Tensor3DGrid_V1_0_1(BaseSpatialDataProperties_V1_0_1):
    ...
    Attributes:
        ...
        origin (list[float]): The coordinates of the origin [x,y,z]
        size (list[int]): Number of cells in each direction. [grid_size_x, grid_size_y, grid_size_z]
        grid_cells_3d (Tensor3DGrid_V1_0_1_GridCells3D): Grid cell sizes along the axes
        rotation (Rotation_V1_0_1, optional): Orientation of the grid.
...
class Tensor3DGrid_V1_2_0(BaseSpatialDataProperties_V1_0_1):
    ...
    Attributes:
        ...
        origin (list[float]): The coordinates of the origin [x,y,z]
        size (list[int]): Number of cells in each direction. [grid_size_x, grid_size_y, grid_size_z]
        grid_cells_3d (Tensor3DGrid_V1_2_0_GridCells3D): Grid cell sizes along the axes
        rotation (Rotation_V1_1_0, optional): Orientation of the grid.
        cell_attributes (OneOfAttribute_V1_2_0, optional): Attributes associated with the cells.
        vertex_attributes (OneOfAttribute_V1_2_0, optional): Attributes associated with the vertices.
        bounding_box (BoundingBox_V1_0_1): Bounding box of the spatial data.
