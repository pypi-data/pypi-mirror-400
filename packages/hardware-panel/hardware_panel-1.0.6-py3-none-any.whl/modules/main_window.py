import os
from PyQt5.QtWidgets import QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QGridLayout, QMessageBox
...
class HardwarePanelApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        main_layout.addLayout(top_layout, 0)  # No stretch
