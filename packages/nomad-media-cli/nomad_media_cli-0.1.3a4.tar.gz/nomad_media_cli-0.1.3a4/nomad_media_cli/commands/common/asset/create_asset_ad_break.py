...
@click.command()
@click.option("--id", help="The ID of the Asset to create the Asset ad break for.")
...
@click.option("--tag-names", multiple=True, help="The tag name(s) to add to the Asset ad break.")
@click.option("--tag-ids", multiple=True, help="The tag id(s) to add to the Asset ad break.")
@click.option("--label-names", multiple=True, help="The label_name(s) to add to the Asset ad break.")
@click.option("--label-ids", multiple=True, help="The label id(s) to add to the Asset ad break.")
@click.pass_context
def create_asset_ad_break(ctx, id, url, object_key, time_code, tag_names, tag_ids, label_names, label_ids):
    ...
    labels = [{"id": label_id} for label_id in label_ids] if label_ids else None
    if label_names:
