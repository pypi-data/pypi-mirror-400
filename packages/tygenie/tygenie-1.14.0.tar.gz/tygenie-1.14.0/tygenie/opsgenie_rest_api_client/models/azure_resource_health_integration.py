...
T = TypeVar("T", bound="AzureResourceHealthIntegration")


@_attrs_define
class AzureResourceHealthIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        azure_resource_health_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        azure_resource_health_integration.additional_properties = d
        return azure_resource_health_integration
