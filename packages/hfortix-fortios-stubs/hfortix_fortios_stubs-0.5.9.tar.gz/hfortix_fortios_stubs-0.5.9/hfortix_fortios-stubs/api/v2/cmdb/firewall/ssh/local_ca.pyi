...
class LocalCaPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    """
    name: NotRequired[str]  # SSH proxy local CA name.
    ...
    source: NotRequired[Literal[{"description": "Built-in SSH proxy local keys", "help": "Built-in SSH proxy local keys.", "label": "Built In", "name": "built-in"}, {"description": "User imported SSH proxy local keys", "help": "User imported SSH proxy local keys.", "label": "User", "name": "user"}]]  # SSH proxy local CA source type.
