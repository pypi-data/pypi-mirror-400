...
3. Is this UNCLEAR or MISSING REQUIRED INFO? → "needs_info"
   ...
   - Note: Screenshots/images may be attached but you cannot view them - focus on whether a reproducible sample file is provided
4. Otherwise → "valid"
...
Examples:
- "Could you please attach a sample PDF that reproduces the issue?"
- "Would you mind sharing the code snippet you used?"
- "Could you provide your Python and package versions?"
