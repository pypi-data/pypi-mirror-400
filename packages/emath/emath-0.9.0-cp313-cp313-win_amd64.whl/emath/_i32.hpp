...
static PyObject *
I32Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(int32_t);
...
static PyMethodDef I32Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)I32Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
