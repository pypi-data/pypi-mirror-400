...
class DIAGPQB(AbstractBoundedMinimisation):
    """A variable dimension convex quadratic problem with eigenvalues
    ...
    def objective(self, y, args):
        ...
        # No shift for this problem
        shift = 0.0

        # Create eigenvalues: lambda_i = i^2/n
