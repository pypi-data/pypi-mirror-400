...
class SAM2CameraPredictor(SAM2Base):
    ...
    def perpare_data(self, img, image_size=1024, img_mean=(0.485, 0.456, 0.406), img_std=(0.229, 0.224, 0.225)):
        if isinstance(img, np.ndarray):
            img_np = img
            img_np = cv.resize(img_np, (image_size, image_size)) / 255.0
...
### ----------------------------------------------------------------------------------------------------------   
    ...
    def _get_feature(self, img: torch.Tensor, batch_size: int) -> torch.Tensor:
