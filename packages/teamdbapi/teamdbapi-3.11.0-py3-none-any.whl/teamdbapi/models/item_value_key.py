...
class ItemValueKey(object):
    ...
    def __init__(self, ModelFieldId=None, ParentItemId=None, _configuration=None):  # noqa: E501
    ...
    def ModelFieldId(self):
        """Gets the ModelFieldId of this ItemValueKey.  # noqa: E501

        The model field id to which the value is linked  # noqa: E501

        :return: The ModelFieldId of this ItemValueKey.  # noqa: E501
        :rtype: str
        """
    ...
    def ModelFieldId(self, ModelFieldId):
        """Sets the ModelFieldId of this ItemValueKey.

        The model field id to which the value is linked  # noqa: E501

        :param ModelFieldId: The ModelFieldId of this ItemValueKey.  # noqa: E501
        :type: str
        """
    ...
    def ParentItemId(self):
        """Gets the ParentItemId of this ItemValueKey.  # noqa: E501

        The id of the parent entity (event, car, session, run, lap) which owns the value.  # noqa: E501

        :return: The ParentItemId of this ItemValueKey.  # noqa: E501
        :rtype: str
        """
    ...
    def ParentItemId(self, ParentItemId):
        """Sets the ParentItemId of this ItemValueKey.

        The id of the parent entity (event, car, session, run, lap) which owns the value.  # noqa: E501

        :param ParentItemId: The ParentItemId of this ItemValueKey.  # noqa: E501
        :type: str
        """
