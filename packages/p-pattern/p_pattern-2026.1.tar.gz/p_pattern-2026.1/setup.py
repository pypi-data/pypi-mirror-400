...
if __name__ == "__main__":
    ...
    setup(
        ...
        package_data={
            "p_pattern.catalog.instance.surface.c_extension": [
                "circle-linux-aarch64.so",
                "circle-win32.so",
                "ellipse-linux-aarch64.so",
                "ellipse-win32.so",
                "rectangle-linux-aarch64.so",
                "rectangle-win32.so",
                "superquadric-linux-aarch64.so",
                "superquadric-win32.so",
            ],
            "p_pattern.catalog.instance.volume.c_extension": [
                "ellipsoid-linux-aarch64.so",
                "ellipsoid-win32.so",
            ],
        },
        package_dir={"": "package"},
