...
T = TypeVar("T", bound="MigrateProcessInstanceResponse503")


@_attrs_define
class MigrateProcessInstanceResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        migrate_process_instance_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        migrate_process_instance_response_503.additional_properties = d
        return migrate_process_instance_response_503
