# Contributing to l0-py-blocks-genesis

Thank you for your interest in contributing to **l0-py-blocks-genesis**! Your contributions help improve this project for everyone. Whether you're reporting a bug, suggesting an enhancement, or submitting code changes, we welcome your input.
...
If you encounter a bug or any issue, please report it by [opening an issue](https://github.com/SELISEdigitalplatforms/l0-py-blocks-genesis/issues/new) and include the following details:
...
2. **Clone Your Fork**: Clone your forked repository to your local machine.
   ```bash
   git clone https://github.com/your-username/l0-py-blocks-genesis.git
   cd l0-py-blocks-genesis
   ```
