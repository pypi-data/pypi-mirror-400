...
class MQISolver:
    ...
    def _is_unknown_predicate_error(self, error_msg: str) -> bool:
        lowered = error_msg.lower()
        return (
            "unknown procedure" in lowered
            or "undefined procedure" in lowered
            or "existence_error" in lowered
        )
        ...
        with self._lock:
            ...
            try:
                ...
                try:
                    ...
                    error_msg = str(e)
                    if self._is_unknown_predicate_error(error_msg):
                        return {
                            "success": True,
                            "solutions": [],
                            "query": query_text,
