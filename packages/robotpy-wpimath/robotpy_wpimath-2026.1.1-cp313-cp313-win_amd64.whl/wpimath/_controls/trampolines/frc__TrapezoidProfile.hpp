...
struct bind_frc__TrapezoidProfile {
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    cls_TrapezoidProfile.doc() = 
      ...
      ":meth:`isFinished`.\n";
    cls_TrapezoidProfile.def(py::init<typename TrapezoidProfile<Distance>::Constraints>()
      , py::arg("constraints")
      , release_gil()
      , py::doc(
    ...
    cls_TrapezoidProfile.def("calculate", &frc::TrapezoidProfile<Distance>::Calculate
    ...
    cls_TrapezoidProfile.def("timeLeftUntil", &frc::TrapezoidProfile<Distance>::TimeLeftUntil
      , py::arg("target")
      , release_gil()
      , py::doc(
    ...
    cls_TrapezoidProfile.def("totalTime", &frc::TrapezoidProfile<Distance>::TotalTime
      , release_gil()
      , py::doc(
    ...
    cls_TrapezoidProfile.def("isFinished", &frc::TrapezoidProfile<Distance>::IsFinished
      , py::arg("t")
      , release_gil()
      , py::doc(
    ...
    cls_Constraints.def(py::init<Velocity_t, Acceleration_t>()
      , py::arg("maxVelocity") = 0, py::arg("maxAcceleration") = 0
      , release_gil()
      , py::doc(
    ...
    cls_Constraints.def_readonly("maxVelocity", &frc::TrapezoidProfile<Distance>::Constraints::maxVelocity, py::doc("Maximum velocity."));
    cls_Constraints.def_readonly("maxAcceleration", &frc::TrapezoidProfile<Distance>::Constraints::maxAcceleration, py::doc("Maximum acceleration."));
    cls_State.doc() = "Profile state.";
    cls_State.def(py::self == State()
    );
    cls_State.def_readonly("position", &frc::TrapezoidProfile<Distance>::State::position, py::doc("The position at this state."));
    cls_State.def_readonly("velocity", &frc::TrapezoidProfile<Distance>::State::velocity, py::doc("The velocity at this state."));
    if (set_doc) {
