...
EEG: Amphetamine trials 5CCPT and Probabilistic Learning (OpenNeuro ``ds003987``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 1` :bdg-light:`License: CC0` :bdg-light:`Subjects: 23` :bdg-light:`Recordings: 69` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds003987.v1.0.0 <https://doi.org/10.18112/openneuro.ds003987.v1.0.0>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds003987>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds003987>`__
