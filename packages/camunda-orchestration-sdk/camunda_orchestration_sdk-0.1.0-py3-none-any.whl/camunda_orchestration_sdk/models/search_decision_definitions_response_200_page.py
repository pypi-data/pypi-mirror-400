...
T = TypeVar("T", bound="SearchDecisionDefinitionsResponse200Page")


@_attrs_define
class SearchDecisionDefinitionsResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_decision_definitions_response_200_page = cls(
        ...
        search_decision_definitions_response_200_page.additional_properties = d
        return search_decision_definitions_response_200_page
