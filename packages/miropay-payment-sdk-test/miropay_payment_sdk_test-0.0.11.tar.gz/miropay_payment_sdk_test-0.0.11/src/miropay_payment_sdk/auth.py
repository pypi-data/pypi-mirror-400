...
class Auth:
    def __init__(self, private_key_pem: str, key_id: str, passphrase: Optional[str] = None):
        # private_key_pem: PEM string (multi-line or single-line)
        # key_id: string to use in x-id header
        # passphrase: passphrase for encrypted PEMs (optional, rarely needed)
    ...
    def make_signature(self, method: str, relative_url: str) -> str:
        ...
        password: Optional[bytes] = self._passphrase.encode("utf-8") if self._passphrase else None
