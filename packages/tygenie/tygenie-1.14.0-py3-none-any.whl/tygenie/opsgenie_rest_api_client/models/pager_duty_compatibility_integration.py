...
T = TypeVar("T", bound="PagerDutyCompatibilityIntegration")
...
class PagerDutyCompatibilityIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pager_duty_compatibility_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        pager_duty_compatibility_integration.additional_properties = d
        return pager_duty_compatibility_integration
