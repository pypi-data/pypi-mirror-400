...
class DirectUploadsApi(object):
    ...
    def cancel_direct_upload_with_http_info(self, upload_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('upload_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `upload_id` when calling `cancel_direct_upload`")  # noqa: E501
    ...
    def create_direct_upload_with_http_info(self, create_upload_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('create_upload_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['create_upload_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `create_upload_request` when calling `create_direct_upload`")  # noqa: E501
    ...
    def get_direct_upload_with_http_info(self, upload_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('upload_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['upload_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `upload_id` when calling `get_direct_upload`")  # noqa: E501
    ...
    def list_direct_uploads(self, **kwargs):  # noqa: E501
        ...
        Lists direct uploads in the current environment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_direct_uploads_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListUploadsResponse, status_code(int), headers(HTTPHeaderDict))
        """
