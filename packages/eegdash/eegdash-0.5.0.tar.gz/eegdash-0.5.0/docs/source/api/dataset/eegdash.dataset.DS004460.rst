...
:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 1` :bdg-light:`License: CC0` :bdg-light:`Subjects: 20` :bdg-light:`Recordings: 40` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds004460>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds004460>`__
