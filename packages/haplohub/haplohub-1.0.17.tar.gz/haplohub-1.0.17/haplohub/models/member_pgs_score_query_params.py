...
class MemberPgsScoreQueryParams(BaseModel):
    """
    MemberPgsScoreQueryParams
    """

    member_id: StrictStr = Field(...)
    latest: Optional[StrictBool] = False
    __properties = ["member_id", "latest"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MemberPgsScoreQueryParams:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MemberPgsScoreQueryParams:
        """Create an instance of MemberPgsScoreQueryParams from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MemberPgsScoreQueryParams.parse_obj(obj)

        _obj = MemberPgsScoreQueryParams.parse_obj(
            {"member_id": obj.get("member_id"), "latest": obj.get("latest") if obj.get("latest") is not None else False}
        )
        return _obj
