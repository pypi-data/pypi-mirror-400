...
T = TypeVar("T", bound="SearchGroupIdsForTenantResponse200Page")


@_attrs_define
class SearchGroupIdsForTenantResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_group_ids_for_tenant_response_200_page = cls(
        ...
        search_group_ids_for_tenant_response_200_page.additional_properties = d
        return search_group_ids_for_tenant_response_200_page
