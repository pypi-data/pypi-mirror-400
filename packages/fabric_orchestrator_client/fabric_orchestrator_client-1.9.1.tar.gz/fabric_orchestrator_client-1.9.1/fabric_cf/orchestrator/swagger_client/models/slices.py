...
class Slices(Status200OkPaginated):
    ...
    def __init__(self, data=None, *args, **kwargs):  # noqa: E501
        """Slices - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this Slices.  # noqa: E501


        :return: The data of this Slices.  # noqa: E501
        :rtype: list[Slice]
        """
        return self._data
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Slices):
            return False
