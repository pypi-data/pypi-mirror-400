...
class DashAdminSite(admin.AdminSite):
    ...
    site_title = DASH_SETTINGS.get("SITE_TITLE", "django admin")
    site_header = DASH_SETTINGS.get("SITE_HEADER", "Administration")
    index_title = DASH_SETTINGS.get("SITE_HEADER", "hi, welcome to your dashboard")
    logo = DASH_SETTINGS.get(
    ...
    def _build_app_dict(self, request, label=None):
        ...
        override_apps_config = DASH_SETTINGS.get("APPS_REORDER", {})
