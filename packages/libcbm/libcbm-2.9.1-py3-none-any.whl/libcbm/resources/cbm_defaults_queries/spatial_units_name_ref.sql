select spatial_unit.id as spatial_unit_id, admin_boundary.id as admin_boundary_id, admin_boundary_tr.name as admin_boundary_name,
eco_boundary.id as eco_boundary_id, eco_boundary_tr.name as eco_boundary_name from spatial_unit
