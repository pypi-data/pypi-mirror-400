...
T = TypeVar("T", bound="KapacitorIntegration")


@_attrs_define
class KapacitorIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        kapacitor_integration.additional_properties = d
        return kapacitor_integration
