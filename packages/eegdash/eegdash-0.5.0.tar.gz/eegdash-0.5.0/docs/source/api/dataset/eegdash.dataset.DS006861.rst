...
Targeted Neuromodulation of the Left Dorsolateral Prefrontal Cortex Alleviates Altered Affective Response Evaluation in Lonely Individuals (OpenNeuro ``ds006861``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 1` :bdg-light:`License: CC0` :bdg-light:`Subjects: 120` :bdg-light:`Recordings: 239` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds006861.v1.0.2 <https://doi.org/10.18112/openneuro.ds006861.v1.0.2>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds006861>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds006861>`__
...
.. grid:: 1 2 3 3
   ...
   .. grid-item-card:: Provenance
      ...
      - Source: openneuro
      - OpenNeuro: `ds006861 <https://openneuro.org/datasets/ds006861>`__
      - NeMAR: `ds006861 <https://nemar.org/dataexplorer/detail?dataset_id=ds006861>`__
...
.. autoclass:: eegdash.dataset.DS006861
...
* :mod:`eegdash.dataset`
* `OpenNeuro dataset page <https://openneuro.org/datasets/ds006861>`__
* `NeMAR dataset page <https://nemar.org/dataexplorer/detail?dataset_id=ds006861>`__
