# Документация для библиотеки `kundoluk-api`

## Обзор

Библиотека `kundoluk-api` предоставляет Python-интерфейс для взаимодействия с API электронного журнала "Кундолук" (Кыргызстан). Библиотека позволяет получать расписание уроков, оценки, домашние задания и другую информацию из системы.
