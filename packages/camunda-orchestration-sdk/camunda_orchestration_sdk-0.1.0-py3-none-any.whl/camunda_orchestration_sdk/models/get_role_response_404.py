...
T = TypeVar("T", bound="GetRoleResponse404")


@_attrs_define
class GetRoleResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_role_response_404.additional_properties = d
        return get_role_response_404
