    ...
    def _setup_handlers(self):
        ...
        async def handle_list_tools() -> list[types.Tool]:
            ...
            return [
                ...
                types.Tool(
                    name="train_data",
                    description="Train a machine learning model using HIDENNSIM. Creates configuration and automatically executes training. REQUIRED: input_col, output_col, data_filenames. Supports INN (linear/nonlinear/gaussian), MLP, KAN, and FNO models. Models saved to tools/pyinn/model_saved/, plots to tools/plots/.",
                    inputSchema={
                        "type": "object",
                        "properties": {
                            "input_col": {
                            ...
                            "data_filenames": {
                                "type": "array",
                                "items": {"type": "string"},
                                "description": "(REQUIRED) List of file paths for train/val/test data (1-3 files)"
                            },
                            "interp_method": {
                                "type": "string",
                        ...
                        "required": ["input_col", "output_col", "data_filenames"]
                    },
                ),
            ]
        ...
        async def handle_call_tool(
            ...
            if name == "add_jax":
                ...
                result = execute_train_data(
                    ...
                    data_filenames=arguments.get("data_filenames"),
