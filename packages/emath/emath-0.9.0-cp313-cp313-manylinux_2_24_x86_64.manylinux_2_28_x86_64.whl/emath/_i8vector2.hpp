...
static PyObject *
I8Vector2Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(int8_t) * 2;
...
static PyMethodDef I8Vector2Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)I8Vector2Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
