...
__all__ = ["CreditCardRefundListParams"]


class CreditCardRefundListParams(TypedDict, total=False):
    ...
    """
    Filter for specific credit card refunds by their QuickBooks-assigned unique
    identifier(s).
    ...
    **NOTE**: If you use this parameter, you cannot also use `refNumberContains` or
    ...
    """
    Filter for credit card refunds whose `refNumber` is greater than or equal to
    ...
    """Filter for specific credit card refunds by their ref-number(s), case-sensitive.
    ...
    **NOTE**: If you use this parameter, you cannot also use `refNumberContains` or
    ...
    """
    Filter for credit card refunds whose `refNumber` is less than or equal to this
    ...
    """
    Filter for credit card refunds whose `date` field is on or after this date, in
    ...
    **NOTE:** QuickBooks Desktop interprets this date as the **start of the
    ...
    """
    Filter for credit card refunds whose `date` field is on or before this date, in
    ISO 8601 format (YYYY-MM-DD).
