...
from haplohub.models.init_user_request import InitUserRequest  # noqa: E501


class TestInitUserRequest(unittest.TestCase):
    """InitUserRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitUserRequest:
        """Test InitUserRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InitUserRequest`
        """
        model = InitUserRequest()  # noqa: E501
        if include_optional:
