...
Motor Control Processes Moderate Visual Working Memory Gating Dataset (OpenNeuro ``ds006963``). Access recordings and metadata through EEGDash.
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds006963.v1.0.0 <https://doi.org/10.18112/openneuro.ds006963.v1.0.0>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds006963>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds006963>`__
...
.. grid:: 1 2 3 3
   ...
   .. grid-item-card:: Provenance
      ...
      - Source: openneuro
      - OpenNeuro: `ds006963 <https://openneuro.org/datasets/ds006963>`__
      - NeMAR: `ds006963 <https://nemar.org/dataexplorer/detail?dataset_id=ds006963>`__
...
.. autoclass:: eegdash.dataset.DS006963
...
* :mod:`eegdash.dataset`
* `OpenNeuro dataset page <https://openneuro.org/datasets/ds006963>`__
* `NeMAR dataset page <https://nemar.org/dataexplorer/detail?dataset_id=ds006963>`__
