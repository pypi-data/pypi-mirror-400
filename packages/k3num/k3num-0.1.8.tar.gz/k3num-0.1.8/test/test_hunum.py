...
class TestHunum(unittest.TestCase):
    ...
    def test_parse_number(self):
        ...
        for _in, _out, _msg in cases:
            ...
            for suff in suffixes:
                ...
                self.assertEqual(int(_out), k3num.parseint(_in + suff), msg + "; parseint with suffix: " + repr(suff))
    ...
    def test_limit_keys(self):
        cases = (
            (({"a": 10240, "b": 10240}, {"include": ["a", "inexistent"]}), {"a": "10K", "b": 10240}, ""),
            (({"a": 10240, "b": 10240}, {"exclude": ["b", "inexistent"]}), {"a": "10K", "b": 10240}, ""),
        )
