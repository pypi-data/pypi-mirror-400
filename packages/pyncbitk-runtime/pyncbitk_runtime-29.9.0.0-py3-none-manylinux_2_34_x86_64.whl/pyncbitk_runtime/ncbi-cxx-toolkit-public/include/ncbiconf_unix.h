...
#define NCBI_SIGNATURE "GCC_1421-ReleaseMT64--x86_64-linux6.11.0-gnu-092bbe8147ab"
...
#define NCBI_COMPILER_VERSION 1421
...
/* If you have the `getservbyname_r' function, define to the number of
   arguments it takes (normally 5 or 6). */
#define NCBI_HAVE_GETSERVBYNAME_R 6
