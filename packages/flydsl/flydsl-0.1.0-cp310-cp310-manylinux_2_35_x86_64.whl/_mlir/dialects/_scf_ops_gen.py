...
def execute_region(result, *, no_inline=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ExecuteRegionOp(result=result, no_inline=no_inline, loc=loc, ip=ip))
...
def for_(results_, lower_bound, upper_bound, step, init_args, *, unsigned_cmp=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ForOp(results_=results_, lowerBound=lower_bound, upperBound=upper_bound, step=step, initArgs=init_args, unsignedCmp=unsigned_cmp, loc=loc, ip=ip))
