...
with haplohub.ApiClient(configuration) as api_client:
    ...
    try:
        # Create environment
        api_response = api_client.environment_api.create_environment(create_environment_request)
...
with haplohub.ApiClient(configuration) as api_client:
    ...
    try:
        # List environments
        api_response = api_client.environment_api.list_environments()
...
with haplohub.ApiClient(configuration) as api_client:
    ...
    try:
        # Switch environment
        api_response = api_client.environment_api.switch_environment(environment_id)
