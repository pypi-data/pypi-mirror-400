...
T = TypeVar("T", bound="AutotaskAEMEmailIntegration")
...
class AutotaskAEMEmailIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        autotask_aem_email_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        autotask_aem_email_integration.additional_properties = d
        return autotask_aem_email_integration
