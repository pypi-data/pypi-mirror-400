...
"""
    ...
    The version of the OpenAPI document: 1.3.9335
...
class V1ResolvedInstruction(BaseModel):
    ...
    earliest_time_above_elevation_mask: Optional[datetime] = Field(None, alias="earliestTimeAboveElevationMask")
    ...
    __properties = ["id", "noradId", "orbitType", "imageSetId", "targetId", "trackingType", "exposureDuration", "binning", "gain", "gainMode", "gainOffset", "ra", "dec", "captureStart", "captureEnd", "preCaptureWait", "startSlewAt", "cameraMode", "tleName", "tleLine1", "tleLine2", "tleOffsetDec", "tleOffsetRa", "blackoutBoxes", "plateSolveParameters", "uploadPriority", "satellitePassEphemeris", "ascomAxisRates", "earliestTimeAboveElevationMask", "cropSizeWidthPx", "cropSizeHeightPx", "resolvedImageAutoExposure"]
    ...
    def from_dict(cls, obj: dict) -> V1ResolvedInstruction:
        ...
        _obj = V1ResolvedInstruction.parse_obj({
            ...
            "earliest_time_above_elevation_mask": obj.get("earliestTimeAboveElevationMask"),
