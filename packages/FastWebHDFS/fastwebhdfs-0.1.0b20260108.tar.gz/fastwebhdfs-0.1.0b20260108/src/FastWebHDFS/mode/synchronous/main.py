...
from .base import SyncWebHDFSInterface

from httpx import Client, Response, RequestError
from typing import Optional


class SyncWebHDFS(SyncWebHDFSInterface):
    ...
    def append(
        ...
        try:
            ...
            with Client() as client:
                step1: Response = client.post(url1, timeout=10.0)
        ...
        try:
            ...
            with Client() as client:
                step2: Response = client.post(url2, content=content, timeout=10.0)
        except RequestError as e:
            self._logging.error(e)
            raise
    ...
    def create(
        ...
        try:
            self._logging.info(url1)
            with Client() as client:
                step1: Response = client.put(url1, timeout=10.0)
        except RequestError as e:
            self._logging.error(e)
            raise
        ...
        try:
            self._logging.info(url2)
            with Client() as client:
                step2: Response = client.put(url2, content=content, timeout=10.0)
        except RequestError as e:
            self._logging.error(e)
            raise
    ...
    def delete(
        ...
        try:
            ...
            with Client() as client:
                response: Response = client.delete(url, timeout=10.0)
        except RequestError as e:
            self._logging.error(e)
            raise
    ...
    def getcontentsummary(
        ...
        try:
            self._logging.info(url)
            with Client() as client:
                response: Response = client.get(url, timeout=10.0)
        except RequestError as e:
            self._logging.error(e)
            raise
    ...
    def getfilechecksum(
        ...
        try:
            self._logging.info(url1)
            with Client() as client:
                step1: Response = client.get(url1, timeout=10.0)
        except RequestError as e:
            self._logging.error(e)
            raise
        ...
        try:
            self._logging.info(url2)
            with Client() as client:
                step2: Response = client.get(url2, timeout=10.0)
        except RequestError as e:
            self._logging.error(e)
            raise
    ...
    def mkdirs(
        ...
        try:
            self._logging.info(url)
            with Client() as client:
                response: Response = client.put(url, timeout=10.0)
        except RequestError as e:
            self._logging.error(e)
            raise
