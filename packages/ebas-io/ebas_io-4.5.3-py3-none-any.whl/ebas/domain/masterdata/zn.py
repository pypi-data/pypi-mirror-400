"""
$Id: zn.py 2088 2018-06-29 13:46:38Z pe $

EBAS Masterdata Class for zero negative masterdata

This module implements the class EbasMasterZN.
...
from .offline_masterdata import ZNOfflineMasterData
from .base import EbasMasterBase

class EbasMasterZN(EbasMasterBase, ZNOfflineMasterData):
    """
    Domain Class for zero negative masterdata.
    ...
    ZNOfflineMasterData.read_pickle_file()

    def __init__(self, dbh=None):
        """
        Read zn masterdata if dbh is provided.
        """
        ZNOfflineMasterData.__init__(self)
