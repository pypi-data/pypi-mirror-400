...
class NCVXQP3(AbstractConstrainedQuadraticProblem):
    """NCVXQP3 problem - a non-convex quadratic program.
    ...
    def expected_result(self):
        ...
        raise NotImplementedError("Expected result not available for NCVXQP3")
