...
class TrailerReference(Dereferenceable):
    ...
    :param reader:
        a :class:`~.pdf_utils.reader.PdfFileReader`
    """
...
class StreamObject(DictionaryObject):
    ...
    :param handler:
        ...
        :class:`.pdf_utils.crypt.SecurityHandler`.
    ...
    def apply_filter(
        ...
        *Note:* Calling this method on an encoded stream will first cause the
        ...
        :param filter_name:
            Name of the filter
            (see :const:`~.pdf_utils.filters.DECODERS`)
        :param params:
...
class DecryptedObjectProxy(PdfObject):
    ...
    .. warning::
        ...
        which paperlogic's object handling code ultimately derives, there are
        some Python builtins that might cause these wrapper objects to
        inadvertently "leak". Please `tell us about such cases`_ so we can
