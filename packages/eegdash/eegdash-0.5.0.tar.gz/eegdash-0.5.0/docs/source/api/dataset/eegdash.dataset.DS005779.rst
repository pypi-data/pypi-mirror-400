...
Real-time personalized brain state-dependent TMS in healthy adults (OpenNeuro ``ds005779``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 16` :bdg-light:`License: CC0` :bdg-light:`Subjects: 19` :bdg-light:`Recordings: 250` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds005779.v1.0.1 <https://doi.org/10.18112/openneuro.ds005779.v1.0.1>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds005779>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds005779>`__
