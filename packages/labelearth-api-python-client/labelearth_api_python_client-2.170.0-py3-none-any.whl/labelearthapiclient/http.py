...
from labelearthapiclient import _auth
from labelearthapiclient import _helpers as util
...
from labelearthapiclient.model import JsonModel
...
class MediaIoBaseDownload(object):
    ...
    def __init__(self, fd, request, chunksize=DEFAULT_CHUNK_SIZE):
        ...
        Args:
          fd: io.Base or file object, The stream in which to write the downloaded
            bytes.
          request: labelearthapiclient.http.HttpRequest, the media request to perform in
            chunks.
    ...
    def next_chunk(self, num_retries=0):
        ...
        Raises:
          labelearthapiclient.errors.HttpError if the response was not a 2xx.
...
class HttpRequest(object):
    ...
    def _process_response(self, resp, content):
        ...
        Raises:
          labelearthapiclient.errors.HttpError if the response was not a 2xx or a 308.
        """
...
class BatchHttpRequest(object):
    ...
    Example:
      from labelearthapiclient.http import BatchHttpRequest
    ...
    def __init__(self, callback=None, batch_uri=None):
        ...
        Args:
          callback: callable, A callback to be called for each response, of the
            ...
            third is an labelearthapiclient.errors.HttpError exception object if an HTTP error
    ...
    def _execute(self, http, order, requests):
        ...
        Raises:
          httplib2.HttpLib2Error if a transport error has occurred.
          labelearthapiclient.errors.BatchError if the response is the wrong format.
        """
...
class RequestMockBuilder(object):
    ...
    Example:
      ...
      labelearthapiclient.discovery.build("plus", "v1", requestBuilder=requestBuilder)
