...
class PaymentClient:
    ...
    # ------------------------------- Basic Methods ------------------------------ #
    async def _call(self, path: str, method: str, request_body: Optional[Union[str, bytes]] = None) -> Dict[str, Any]:
    ...
    # ======================== Public Methods =======================
    async def get_payment_by_id(self, reference_code: str) -> Dict[str, Any]:
        return await self._call(f"/status/{reference_code}", "GET", None)
    ...
    async def create_payment(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return await self._call("/create", "POST", json.dumps(json_payload).encode("utf-8"))

    async def cancel_payment(self, reference_code: str) -> Dict[str, Any]:
        return await self._call(f"/cancel/{reference_code}", "PATCH", None)
