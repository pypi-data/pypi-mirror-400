#!/usr/bin/env python3
"""Generate golden output file from real Claude Code v2.0.74 session.
...
REAL_CLAUDE_SESSION = FIXTURES_DIR / "real-claude-session-v2.0.74.bin"
GOLDEN_OUTPUT = FIXTURES_DIR / "real-claude-session-v2.0.74-expected-output.bin"
