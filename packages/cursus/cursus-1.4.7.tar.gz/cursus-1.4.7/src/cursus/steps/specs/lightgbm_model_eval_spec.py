"""
LightGBM Model Evaluation Step Specification.

This module defines the declarative specification for LightGBM model evaluation steps,
...
# LightGBM Model Evaluation Step Specification
LIGHTGBM_MODEL_EVAL_SPEC = StepSpecification(
    step_type=get_spec_step_type("LightGBMModelEval"),
