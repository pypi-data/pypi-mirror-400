...
# Default matchmaker URL - can be overridden via env var or function parameter
# For local dev: ws://127.0.0.1:9000/matchmaking/ws
# For tunnel: wss://<tunnel>.trycloudflare.com/matchmaking/ws
# For direct KVM: ws://192.168.x.x:9000/matchmaking/ws
...
async def run(
    ...
    Args:
        ...
        game_type: The game type to play (e.g., GameType.FLIPFLOP_3X3)
        matchmaker_url: WebSocket URL of the matchmaker
            Default: MATCHMAKER_URL env var or ws://127.0.0.1:9000/matchmaking/ws
