...
Alphabetic Decision Task (Arial Light Font) (OpenNeuro ``ds005594``). Access recordings and metadata through EEGDash.
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds005594.v1.0.3 <https://doi.org/10.18112/openneuro.ds005594.v1.0.3>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds005594>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds005594>`__
