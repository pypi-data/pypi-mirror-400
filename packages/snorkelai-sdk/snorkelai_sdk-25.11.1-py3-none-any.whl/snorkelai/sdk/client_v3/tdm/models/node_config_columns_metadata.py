...
if TYPE_CHECKING:
    # fmt: off
    from ..models.column_metadata import ColumnMetadata  # noqa: F401
    # fmt: on


T = TypeVar("T", bound="NodeConfigColumnsMetadata")


@attrs.define
class NodeConfigColumnsMetadata:
    """ """

    additional_properties: Dict[str, "ColumnMetadata"] = attrs.field(
