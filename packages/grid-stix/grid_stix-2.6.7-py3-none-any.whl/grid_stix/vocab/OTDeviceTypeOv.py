"""
Open vocabulary for OT device types
...
class OTDeviceTypeOv(GridSTIXDomainObject):
    """
    Open vocabulary for OT device types
    ...
    _type = "x-grid-ot-device-type-ov"
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize OTDeviceTypeOv with Grid-STIX properties."""
