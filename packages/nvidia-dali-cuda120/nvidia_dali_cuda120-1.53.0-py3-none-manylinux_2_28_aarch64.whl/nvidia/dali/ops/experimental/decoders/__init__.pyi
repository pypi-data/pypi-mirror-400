...
class Video:
    ...
    * Using ``start_frame``, ``sequence_length`` and ``stride``:
    ...
    bytes_per_sample_hint : int or list of int, optional, default = `[0]`
        ...
        If specified, the operator's outputs residing in GPU or page-locked host memory will be preallocated
        to accommodate a batch of samples of this size.
    end_frame : int or TensorList of int, optional
    ...
    def __init__(
        ...
        *,
        ...
        bytes_per_sample_hint: Union[Sequence[int], int, None] = [0],
        end_frame: Union[DataNode, TensorLikeArg, int, None] = None,
        fill_value: Union[Sequence[int], int, None] = [0],
        frames: Union[DataNode, TensorLikeArg, Sequence[int], int, None] = None,
        pad_mode: Union[DataNode, TensorLikeArg, str, None] = "constant",
        preserve: Optional[bool] = False,
        sequence_length: Union[DataNode, TensorLikeArg, int, None] = None,
        start_frame: Union[DataNode, TensorLikeArg, int, None] = None,
        stride: Union[DataNode, TensorLikeArg, int, None] = None,
    ) -> None: ...
    @overload
    def __call__(
        self,
        encoded: Union[DataNode, TensorLikeIn],
        /,
        *,
        device: Optional[Literal["cpu", "mixed"]] = None,
        name: Optional[str] = None,
