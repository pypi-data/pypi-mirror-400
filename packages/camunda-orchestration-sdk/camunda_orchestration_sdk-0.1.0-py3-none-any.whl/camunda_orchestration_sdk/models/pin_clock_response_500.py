...
T = TypeVar("T", bound="PinClockResponse500")


@_attrs_define
class PinClockResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pin_clock_response_500.additional_properties = d
        return pin_clock_response_500
