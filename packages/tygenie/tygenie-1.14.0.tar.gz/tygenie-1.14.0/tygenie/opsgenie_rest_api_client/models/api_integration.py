...
T = TypeVar("T", bound="ApiIntegration")
...
class ApiIntegration:
    ...
    Attributes:
        ...
        is_default_integration (Union[Unset, bool]):
    """
    ...
    is_default_integration: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        is_default_integration = self.is_default_integration
        ...
        if is_default_integration is not UNSET:
            field_dict["isDefaultIntegration"] = is_default_integration
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        is_default_integration = d.pop("isDefaultIntegration", UNSET)
        ...
        api_integration = cls(
            ...
            is_default_integration=is_default_integration,
        )

        api_integration.additional_properties = d
