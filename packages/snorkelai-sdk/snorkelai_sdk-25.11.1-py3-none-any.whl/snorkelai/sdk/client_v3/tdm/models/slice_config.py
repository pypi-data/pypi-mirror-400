...
if TYPE_CHECKING:
    ...
    from ..models.annotator_status_filter_schema import (
        AnnotatorStatusFilterSchema,  # noqa: F401
    )
    ...
    from ..models.datapoint_status_filter_schema import (
        DatapointStatusFilterSchema,  # noqa: F401
    )
...
class SliceConfig:
    ...
    Attributes:
        transform_config (Union['AnnotationFilterSchema', 'AnnotatorAgreementFilterSchema', 'AnnotatorFilterSchema',
            'AnnotatorStatusFilterSchema', 'ClusterFilterSchema', 'CombinerTransformConfig', 'CommentFilterSchema',
            'CriteriaFilterSchema', 'DataLoaderForIndexProvenance', 'DatapointStatusFilterSchema',
            'DatasetBatchSorterConfig', 'FieldFilterSchema', 'FilterGraphConfig', 'FilterStringConfig', 'FirstNConfig',
            'GroundTruthFilterSchema', 'MarginDistanceFilterSchema', 'ModelFilterSchema', 'SliceFilterSchema',
            'TemplateFilterSchema', 'VDSSorterConfig']):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.transform_config, FilterStringConfig):
            ...
            transform_config = self.transform_config.to_dict()
        elif isinstance(self.transform_config, DatapointStatusFilterSchema):
            transform_config = self.transform_config.to_dict()
        elif isinstance(self.transform_config, AnnotatorStatusFilterSchema):
            transform_config = self.transform_config.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_transform_config(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                transform_config_type_13 = DatapointStatusFilterSchema.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                transform_config_type_14 = AnnotatorStatusFilterSchema.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                transform_config_type_15 = FilterGraphConfig.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                transform_config_type_16 = DataLoaderForIndexProvenance.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                transform_config_type_17 = FirstNConfig.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                transform_config_type_18 = CombinerTransformConfig.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                transform_config_type_19 = DatasetBatchSorterConfig.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            transform_config_type_20 = VDSSorterConfig.from_dict(data)

            return transform_config_type_20
