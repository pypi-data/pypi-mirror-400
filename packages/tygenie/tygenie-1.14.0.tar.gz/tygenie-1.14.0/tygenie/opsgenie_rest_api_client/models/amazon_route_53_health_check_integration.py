...
T = TypeVar("T", bound="AmazonRoute53HealthCheckIntegration")
...
class AmazonRoute53HealthCheckIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        amazon_route_53_health_check_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        amazon_route_53_health_check_integration.additional_properties = d
        return amazon_route_53_health_check_integration
