    ...
    def make_instance(self, include_optional) -> StreamResultOfExecCommandReply:
        ...
        if include_optional:
            return StreamResultOfExecCommandReply(
                result = koyeb.api.models.exec_command_reply.ExecCommandReply(
                    stdout = koyeb.api.models.exec_command_io.ExecCommandIO(
                        data = 'YQ==', 
                        close = True, ), 
                    stderr = koyeb.api.models.exec_command_io.ExecCommandIO(
                        data = 'YQ==', 
                        close = True, ), 
                    exited = True, 
                    exit_code = 56, ),
