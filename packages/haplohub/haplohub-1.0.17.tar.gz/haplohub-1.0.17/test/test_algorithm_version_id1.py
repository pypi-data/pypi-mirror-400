...
from haplohub.models.algorithm_version_id1 import AlgorithmVersionId1  # noqa: E501


class TestAlgorithmVersionId1(unittest.TestCase):
    """AlgorithmVersionId1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgorithmVersionId1:
        """Test AlgorithmVersionId1
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AlgorithmVersionId1`
        """
        model = AlgorithmVersionId1()  # noqa: E501
        if include_optional:
            return AlgorithmVersionId1(
            )
        else:
            return AlgorithmVersionId1(
        )
    ...
    def testAlgorithmVersionId1(self):
        """Test AlgorithmVersionId1"""
