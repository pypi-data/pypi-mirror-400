...
T = TypeVar("T", bound="SearchRolesResponse200Page")


@_attrs_define
class SearchRolesResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_roles_response_200_page = cls(
        ...
        search_roles_response_200_page.additional_properties = d
        return search_roles_response_200_page
