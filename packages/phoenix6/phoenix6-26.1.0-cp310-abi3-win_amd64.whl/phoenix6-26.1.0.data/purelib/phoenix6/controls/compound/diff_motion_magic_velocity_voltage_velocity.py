...
@final
class Diff_MotionMagicVelocityVoltage_Velocity:
    """
    Requires Phoenix Pro and CANivore;
    Differential control with Motion Magic® Velocity average target and velocity
    ...
    def __init__(self, average_request: MotionMagicVelocityVoltage, differential_request: VelocityVoltage):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_MotionMagicVelocityVoltage_Velocity"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicVelocityVoltage_Velocity")
    ...
    def with_average_request(self, new_average_request: MotionMagicVelocityVoltage) -> 'Diff_MotionMagicVelocityVoltage_Velocity':
        ...
        :type new_average_request: MotionMagicVelocityVoltage
        :returns: Itself
        :rtype: Diff_MotionMagicVelocityVoltage_Velocity
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: VelocityVoltage) -> 'Diff_MotionMagicVelocityVoltage_Velocity':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicVelocityVoltage_Velocity':
        """
