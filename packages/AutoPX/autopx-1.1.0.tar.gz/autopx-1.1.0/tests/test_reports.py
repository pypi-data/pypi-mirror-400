...
class TestReportBuilder(unittest.TestCase):
    ...
    def test_generate_json_report(self):
        ...
        self.assertIn('"language": "en"', output) # Constants changed to "en"
        self.assertIn('"task": "sentiment"', output) # Constants changed to "sentiment"
    ...
    def test_generate_pdf_report(self):
        # For testing PDF we just ensure it returns a path/filename
