...
class WhatIsVisibleResult(BaseModel):
    """
    WhatIsVisibleResult
    """ # noqa: E501
    ...
    analysis: Optional[StrictStr] = Field(default=None, description="Comprehensive page state analysis")
    model: Optional[StrictStr] = Field(default=None, description="AI model used for analysis")
    screenshot_url: Optional[StrictStr] = Field(default=None, description="URL to the screenshot")
    screenshot_path: Optional[StrictStr] = Field(default=None, description="Path to the screenshot file")
    error: Optional[StrictStr] = Field(default=None, description="Error message if failed")
    __properties: ClassVar[List[str]] = ["success", "message", "timestamp", "analysis", "model", "screenshot_url", "screenshot_path", "error"]
