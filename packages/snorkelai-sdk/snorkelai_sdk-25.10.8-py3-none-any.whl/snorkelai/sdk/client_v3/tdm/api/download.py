...
@overload
def download_file_download_get(
    *, filepath: str, workspace_uid: Union[Unset, int] = UNSET, raw: Literal[True]
) -> requests.Response: ...
...
def download_file_download_get(
    *, filepath: str, workspace_uid: Union[Unset, int] = UNSET, raw: bool = False
