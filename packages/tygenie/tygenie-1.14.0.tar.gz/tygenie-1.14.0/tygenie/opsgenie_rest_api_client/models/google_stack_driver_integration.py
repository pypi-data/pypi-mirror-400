...
T = TypeVar("T", bound="GoogleStackDriverIntegration")
...
class GoogleStackDriverIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        google_stack_driver_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        google_stack_driver_integration.additional_properties = d
        return google_stack_driver_integration
