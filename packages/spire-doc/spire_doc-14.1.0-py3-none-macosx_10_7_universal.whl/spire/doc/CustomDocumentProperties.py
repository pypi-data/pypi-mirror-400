...
#
    ...
    @dispatch
    def get_Item(self, name: str) -> TypingUnion[DocumentProperty,None]:
        """
    ...
    @dispatch
    def get_Item(self, index: int) -> TypingUnion[DocumentProperty,None]:
        """
    ...
    def Add(self ,name:str,value:'object')->TypingUnion[DocumentProperty,None]:
        """
