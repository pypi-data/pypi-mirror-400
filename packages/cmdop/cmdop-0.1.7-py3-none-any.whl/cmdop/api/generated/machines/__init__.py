...
# from .enums import Machine.os, Machine.status, MachineCreate.os, MachineCreateRequest.os, MachineLog.level, MachineLogRequest.level, MachineRequest.os, MachineRequest.status, MachinesMachinesUpdateMetricsCreateRequest.status, PatchedMachineRequest.os, PatchedMachineRequest.status, SharedMachine.permission, SharedMachineList.permission
