...
from ..models.modify_process_instances_batch_operation_response_200_batch_operation_type import (
    ModifyProcessInstancesBatchOperationResponse200BatchOperationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModifyProcessInstancesBatchOperationResponse200")


@_attrs_define
class ModifyProcessInstancesBatchOperationResponse200:
    """The created batch operation.

    Attributes:
        batch_operation_key (str | Unset): Key of the batch operation. Example: 2251799813684321.
        batch_operation_type (ModifyProcessInstancesBatchOperationResponse200BatchOperationType | Unset): The type of
            the batch operation.
    """

    batch_operation_key: BatchOperationKey | Unset = UNSET
    batch_operation_type: (
        ModifyProcessInstancesBatchOperationResponse200BatchOperationType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        modify_process_instances_batch_operation_response_200 = cls(
            batch_operation_key=batch_operation_key,
            batch_operation_type=batch_operation_type,
        )

        modify_process_instances_batch_operation_response_200.additional_properties = d
        return modify_process_instances_batch_operation_response_200
