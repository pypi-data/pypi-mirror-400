...
def test__iter__(test_seq) -> None:
    assert [b for b in test_seq] == [1, 1, 0]


def test__getitem__(test_seq) -> None:
...
def test_ones(test_seq) -> None:
    assert test_seq.ones == 2


def test_zeros(test_seq) -> None:
    assert test_seq.zeros == 1


def test_balance(test_seq) -> None:
...
def test_crosscor(test_seq) -> None:
    pass
