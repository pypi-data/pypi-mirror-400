...
from _h2oai_client_1_10_6_1 import references
from _h2oai_client_1_10_6_1 import validation
from _h2oai_client_1_10_6_1.messages import *
...
class Client:
    ...
    # These are extension methods that are appended to the _h2oai_client_1_10_6_1 module
    ...
    def get_dataset_details(self, key: str) -> DatasetJob:
        """
    ...
    def get_explainer_params(self, mli_key: str, explainer_id: str) -> str:
        """
...
class AutovizClient:
    ...
    def __init__(self, _h2oai_client_1_10_6_1):
        self.client = _h2oai_client_1_10_6_1
