...
EXTENSIONS_THUMBNAILS = {
    ...
    '.heic': 'application-x-egon.png',
    '.heif': 'application-x-egon.png',
...
def FileFactory(data, filename=None):  # pylint: disable=invalid-name
    """File object factory
...
def BinaryFileFactory(data, filename=None):
    """Binary file object factory"""
    content_type = None
    try:
        content_type = get_magic_content_type(data)
    except ValueError:
