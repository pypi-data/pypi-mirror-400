...
class EXPFITB(AbstractConstrainedMinimisation):
    ...
    exponential function over the interval [0, 5] with 51 fitting points.
    ...
    def objective(self, y: Array, args) -> Array:
        ...
        i_values = jnp.arange(1, R + 1, dtype=jnp.float64)  # 1 to 51
        T = 5.0 * (i_values - 1.0) / (R - 1.0)  # [0, 0.1, 0.2, ..., 5.0]
    ...
    def constraint(self, y: Array):
        ...
        # Combine all constraints (102 total)
    ...
    def expected_objective_value(self):
        ...
        # Solution value given as 5.0193e-3
        return jnp.array(5.0193e-3, dtype=jnp.float64)
