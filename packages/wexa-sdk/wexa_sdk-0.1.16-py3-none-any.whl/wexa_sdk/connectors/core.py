...
class Connectors:
    ...
    # GET /connectors/{projectID} - Get all connectors grouped by category
    def get_connectors_by_project(self, project_id: str) -> Any:
        return self.http.request("GET", f"/connectors/{project_id}")

    # GET /connector/{connector_id} - Get a single connector by ID
    def get_by_id(self, connector_id: str) -> Any:
        return self.http.request("GET", f"/connector/{connector_id}")

    # GET /connectors/{projectID}/trigger_actions - Get available trigger actions for a project
    def get_trigger_actions(self, project_id: str) -> Any:
        return self.http.request("GET", f"/connectors/{project_id}/trigger_actions")
