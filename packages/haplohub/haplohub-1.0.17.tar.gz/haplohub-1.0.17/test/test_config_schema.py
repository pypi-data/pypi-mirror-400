...
from haplohub.models.config_schema import ConfigSchema  # noqa: E501
...
class TestConfigSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConfigSchema:
        """Test ConfigSchema
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ConfigSchema`
        """
        model = ConfigSchema()  # noqa: E501
        if include_optional:
            return ConfigSchema(
