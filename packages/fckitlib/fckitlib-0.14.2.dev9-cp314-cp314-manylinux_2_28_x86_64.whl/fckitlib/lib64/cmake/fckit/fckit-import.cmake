...
if( fckit_IS_BUILD_DIR_EXPORT )
  set( FCTEST_GENERATOR /venv/build3.14/bin/python3.14 /src/fckit/tools/fctest-generate-runner.py )
  ...
  set( FCTEST_GENERATOR /venv/build3.14/bin/python3.14 ${fckit_BASE_DIR}/libexec/fctest-generate-runner.py )
endif()
