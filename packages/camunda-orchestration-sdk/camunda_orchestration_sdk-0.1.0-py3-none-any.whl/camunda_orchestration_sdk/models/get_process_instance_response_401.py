...
T = TypeVar("T", bound="GetProcessInstanceResponse401")


@_attrs_define
class GetProcessInstanceResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_process_instance_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_process_instance_response_401.additional_properties = d
        return get_process_instance_response_401
