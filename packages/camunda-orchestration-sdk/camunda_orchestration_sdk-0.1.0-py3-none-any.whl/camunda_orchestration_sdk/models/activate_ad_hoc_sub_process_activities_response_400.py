...
T = TypeVar("T", bound="ActivateAdHocSubProcessActivitiesResponse400")


@_attrs_define
class ActivateAdHocSubProcessActivitiesResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activate_ad_hoc_sub_process_activities_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        activate_ad_hoc_sub_process_activities_response_400.additional_properties = d
        return activate_ad_hoc_sub_process_activities_response_400
