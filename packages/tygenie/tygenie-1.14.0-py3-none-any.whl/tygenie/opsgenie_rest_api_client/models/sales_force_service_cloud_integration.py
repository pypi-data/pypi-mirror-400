...
T = TypeVar("T", bound="SalesForceServiceCloudIntegration")


@_attrs_define
class SalesForceServiceCloudIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sales_force_service_cloud_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        sales_force_service_cloud_integration.additional_properties = d
        return sales_force_service_cloud_integration
