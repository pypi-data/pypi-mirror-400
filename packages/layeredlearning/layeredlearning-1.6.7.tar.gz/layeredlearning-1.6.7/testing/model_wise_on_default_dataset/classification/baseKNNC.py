...
from layerlearn.baseKNNC import KNNAdaClassifier, KNNCatClassifier, KNNDecisionClassifier, KNNGradientClassifier, KNNLogisticClassifier, KNNSupportClassifier, KNNXGBClassifier, KNNLightClassifier, KNNForestClassifier
import warnings
...
models = {
    "KNN Decision Classifier": KNNDecisionClassifier(),
    "KNN Forest Classifier": KNNForestClassifier(),
    "KNN Support Classifier": KNNSupportClassifier(),
    "KNN Logistic Classifier": KNNLogisticClassifier(),
    "KNN XGBoost Classifier": KNNXGBClassifier(),
    "KNN CatBoost Classifier": KNNCatClassifier(),
    "KNN Gradient Boosting Classifier": KNNGradientClassifier(),
    "KNN AdaBoost Classifier": KNNAdaClassifier(),
    "KNN LightGBM Classifier": KNNLightClassifier(),
}
