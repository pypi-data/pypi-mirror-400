...
T = TypeVar("T", bound="WhatsUpGoldIntegration")


@_attrs_define
class WhatsUpGoldIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        whats_up_gold_integration.additional_properties = d
        return whats_up_gold_integration
