...
from .run_properties_parser import (
    parse_language,
    parse_run_fonts,
...
from .table_cell_parser import parse_table_cell
from .table_cell_properties_parser import (
    parse_table_cell_margins,
    parse_table_cell_properties,
)
from .table_grid_parser import parse_table_grid, parse_table_grid_column
from .table_parser import parse_table
from .table_properties_parser import (
    parse_table_look,
    parse_table_properties,
)
from .table_row_parser import parse_table_row
from .table_row_properties_parser import (
