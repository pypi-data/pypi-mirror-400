...
class EXPFITA(AbstractConstrainedMinimisation):
    ...
    exponential function over the interval [0, 5].
    ...
    @property
    def m(self) -> int:
        """Number of constraints: 22 linear constraints."""
        return 22
    ...
    def objective(self, y: Array, args) -> Array:
        ...
        i_values = jnp.arange(1, R + 1, dtype=jnp.float64)  # 1 to 11
        T = 5.0 * (i_values - 1.0) / (R - 1.0)  # [0, 0.5, 1.0, ..., 5.0]
    ...
    def constraint(self, y: Array):
        ...
        # Combine all constraints (22 total)
    ...
    def expected_objective_value(self):
        ...
        # Solution value given as 1.1366e-3
        return jnp.array(1.1366e-3, dtype=jnp.float64)
