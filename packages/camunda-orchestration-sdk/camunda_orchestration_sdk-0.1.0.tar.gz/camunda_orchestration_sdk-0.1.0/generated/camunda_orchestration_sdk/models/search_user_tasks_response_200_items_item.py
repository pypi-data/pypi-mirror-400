...
from ..models.search_user_tasks_response_200_items_item_state import (
    SearchUserTasksResponse200ItemsItemState,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.search_user_tasks_response_200_items_item_custom_headers import (
        SearchUserTasksResponse200ItemsItemCustomHeaders,
    )


T = TypeVar("T", bound="SearchUserTasksResponse200ItemsItem")


@_attrs_define
class SearchUserTasksResponse200ItemsItem:
    """
    Attributes:
        name (str | Unset): The name for this user task.
        state (SearchUserTasksResponse200ItemsItemState | Unset): The state of the user task.
        ...
        custom_headers (SearchUserTasksResponse200ItemsItemCustomHeaders | Unset): Custom headers for the user task.
    ...
    state: SearchUserTasksResponse200ItemsItemState | Unset = UNSET
    ...
    custom_headers: SearchUserTasksResponse200ItemsItemCustomHeaders | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        state: SearchUserTasksResponse200ItemsItemState | Unset
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = SearchUserTasksResponse200ItemsItemState(_state)
        ...
        custom_headers: SearchUserTasksResponse200ItemsItemCustomHeaders | Unset
        if isinstance(_custom_headers, Unset):
            custom_headers = UNSET
        else:
            custom_headers = SearchUserTasksResponse200ItemsItemCustomHeaders.from_dict(
                _custom_headers
            )
        ...
        search_user_tasks_response_200_items_item = cls(
            name=name,
            state=state,
            assignee=assignee,
        ...
        search_user_tasks_response_200_items_item.additional_properties = d
        return search_user_tasks_response_200_items_item
