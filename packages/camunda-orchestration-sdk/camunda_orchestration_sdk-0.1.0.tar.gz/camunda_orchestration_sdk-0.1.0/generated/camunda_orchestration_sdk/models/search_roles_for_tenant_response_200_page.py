...
T = TypeVar("T", bound="SearchRolesForTenantResponse200Page")


@_attrs_define
class SearchRolesForTenantResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_roles_for_tenant_response_200_page = cls(
        ...
        search_roles_for_tenant_response_200_page.additional_properties = d
        return search_roles_for_tenant_response_200_page
