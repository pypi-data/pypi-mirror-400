...
A multi-modal human neuroimaging dataset for data integration: simultaneous EEG and fMRI acquisition during a motor imagery neurofeedback task: XP2 (OpenNeuro ``ds002338``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 4` :bdg-light:`License: CC0` :bdg-light:`Subjects: 17` :bdg-light:`Recordings: 85` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `10.18112/openneuro.ds002338.v2.0.1 <https://doi.org/10.18112/openneuro.ds002338.v2.0.1>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds002338>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds002338>`__
