...
class GraphAPIClient:
        ...
        **kwargs: Any,
        ...
        if not future_responses and self._batch_mode:
            return self._register_batch_request(
                method, path, full_url, params, data, timeout, retry_params, files, **kwargs
            )
        ...
        def _retry_parameterizer() -> GraphAPIResponse:
            ...
            return GraphAPIResponse(
                request_params=GraphAPIRequestParams(method, path, params, data, files),
    ...
    def _register_batch_request(
        ...
        **kwargs: Any,
        ...
        future_response = GraphAPIResponse(GraphAPIRequestParams(method, path, params, data, files))
    ...
    def execute_batch(self, **kwargs: Any) -> GraphAPIResponse:
        ...
        for idx, future_response in enumerate(self._future_responses):
            method, path, params, data, files = astuple(future_response.request_params)
