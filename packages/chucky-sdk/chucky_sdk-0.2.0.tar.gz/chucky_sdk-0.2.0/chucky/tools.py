...
from .types import InputSchema, InputSchemaProperty, McpServer, McpSdkServerConfig, Tool, ToolHandler, ToolResult
...
def create_sdk_mcp_server(
    ...
    This function matches the official Claude Agent SDK API.

    Args:
        name: Unique identifier for the server
        version: Server version string (default: "1.0.0")
        tools: List of tool functions created with @tool decorator

    Returns:
        McpSdkServerConfig object that can be passed to ChuckyOptions.mcp_servers

    Example:
        ```python
        from chucky import tool, create_sdk_mcp_server
        ...
        ```
    """
    # Create an internal McpServer from the tools
