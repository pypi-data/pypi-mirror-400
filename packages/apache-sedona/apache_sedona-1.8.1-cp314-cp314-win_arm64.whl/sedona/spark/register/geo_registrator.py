...
from sedona.spark.core.jvm.config import deprecated
from sedona.spark.register.java_libs import SedonaJvmLib
from sedona.spark.utils.prep import assign_all
...
class PackageImporter:
    ...
    def import_jvm_lib(jvm) -> bool:
        from sedona.spark.core.utils import ImportedJvmLib
