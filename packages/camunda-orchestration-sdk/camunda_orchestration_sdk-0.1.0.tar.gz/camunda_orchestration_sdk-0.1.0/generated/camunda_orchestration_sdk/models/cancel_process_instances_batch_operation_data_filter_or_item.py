...
if TYPE_CHECKING:
    ...
    from ..models.cancel_process_instances_batch_operation_data_filter_or_item_variables_item import (
...
T = TypeVar("T", bound="CancelProcessInstancesBatchOperationDataFilterOrItem")


@_attrs_define
class CancelProcessInstancesBatchOperationDataFilterOrItem:
    ...
    Attributes:
        ...
        variables (list[CancelProcessInstancesBatchOperationDataFilterOrItemVariablesItem] | Unset): The process
            instance variables.
    ...
    variables: (
        list[CancelProcessInstancesBatchOperationDataFilterOrItemVariablesItem] | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        variables: (
            list[CancelProcessInstancesBatchOperationDataFilterOrItemVariablesItem]
            | Unset
        ) = UNSET
        if _variables is not UNSET:
            variables = []
            for variables_item_data in _variables:
                variables_item = CancelProcessInstancesBatchOperationDataFilterOrItemVariablesItem.from_dict(
                    variables_item_data
                )
        ...
        cancel_process_instances_batch_operation_data_filter_or_item = cls(
        ...
        cancel_process_instances_batch_operation_data_filter_or_item.additional_properties = d
        return cancel_process_instances_batch_operation_data_filter_or_item
