...
static PyObject *
UVector2Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(unsigned int) * 2;
...
static PyMethodDef UVector2Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)UVector2Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
