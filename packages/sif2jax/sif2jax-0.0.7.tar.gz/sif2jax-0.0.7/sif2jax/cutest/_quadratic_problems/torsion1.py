...
class TORSION1(AbstractBoundedQuadraticProblem):
    ...
    def y0(self):
        ...
        # Create grid using Fortran ordering
        x = jnp.zeros((p, p))

        # Boundary edges are fixed at 0 (already set)
        # Interior points start from upper bounds
