...
class TestGetReservationResponseDataBalanceDetailedOneOf(unittest.TestCase):
    """GetReservationResponseDataBalanceDetailedOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservationResponseDataBalanceDetailedOneOf:
        """Test GetReservationResponseDataBalanceDetailedOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservationResponseDataBalanceDetailedOneOf`
        """
        model = GetReservationResponseDataBalanceDetailedOneOf()
        if include_optional:
            return GetReservationResponseDataBalanceDetailedOneOf(
                suggested_deposit = '',
                sub_total = 1.337,
    ...
    def testGetReservationResponseDataBalanceDetailedOneOf(self):
        """Test GetReservationResponseDataBalanceDetailedOneOf"""
