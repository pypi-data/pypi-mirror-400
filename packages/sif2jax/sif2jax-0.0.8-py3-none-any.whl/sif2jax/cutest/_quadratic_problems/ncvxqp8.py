...
class NCVXQP8(AbstractConstrainedQuadraticProblem):
    """NCVXQP8 problem - a non-convex quadratic program.
    ...
    def expected_result(self):
        ...
        raise NotImplementedError("Expected result not available for NCVXQP8")
