...
def check_outfall_connections(inp):
    """
    Check if any outfall connection is malicious with mote than one inlet link or an outlet link.

    Base on following error reported in the .rpt-file:
        ::
    ...
    Returns:
        dict[str, tuple[str]]: key is outfall label and value is a list of inlet links and a list of outfall links.
    """
    #
    g = inp_to_graph(inp)
    error_nodes = {}
