...
- `dataset_export_id` (str | None): Specific export ID (optional)
- `annotations_only` (bool): Download only annotations (default: False)
- `export_settings` (DatasetExportSettings | dict): Export configuration
- `save_dir` (Path | str): Save directory
- `overwrite` (bool): Overwrite existing files
- `show_progress` (bool): Show progress bars

**Returns:** [`DatasetDownloadResult`](resources/datasets.md#dataset-download-result)
...
- `ckpt` (str | None): Checkpoint name (optional, uses latest if None)
- `save_path` (Path | str): Save directory

**Returns:** [`ModelDownloadResult`](resources/models.md#model-download-result)
...
See: [Datasets API Reference](resources/datasets.md)
...
See: [Assets API Reference](resources/assets.md)
...
See: [Annotations API Reference](resources/annotations.md)
...
See: [Runs API Reference](resources/runs.md)
...
See: [Models API Reference](resources/models.md)
...
See: [Flows API Reference](resources/flows.md)
...
- [Authentication Guide](../getting-started/authentication.md) - Detailed authentication methods
