...
if TYPE_CHECKING:
    # fmt: off
    from ..models.prompt_template_hyperparameters import (
        PromptTemplateHyperparameters,  # noqa: F401
    )
    # fmt: on
...
class PromptTemplate:
    ...
    Attributes:
        created_by (int):
        hyperparameters (PromptTemplateHyperparameters):
        model (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        hyperparameters = PromptTemplateHyperparameters.from_dict(
