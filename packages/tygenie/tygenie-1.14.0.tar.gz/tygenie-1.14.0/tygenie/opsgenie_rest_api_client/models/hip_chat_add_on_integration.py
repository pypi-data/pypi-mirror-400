...
T = TypeVar("T", bound="HipChatAddOnIntegration")


@_attrs_define
class HipChatAddOnIntegration:
    """
    Attributes:
        ...
        use_collapsed_messages (Union[Unset, bool]):
        require_matching_user (Union[Unset, bool]):
        glance_label (Union[Unset, str]):
    """
    ...
    use_collapsed_messages: Union[Unset, bool] = UNSET
    require_matching_user: Union[Unset, bool] = UNSET
    glance_label: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        use_collapsed_messages = self.use_collapsed_messages

        require_matching_user = self.require_matching_user

        glance_label = self.glance_label
        ...
        if use_collapsed_messages is not UNSET:
            field_dict["useCollapsedMessages"] = use_collapsed_messages
        if require_matching_user is not UNSET:
            field_dict["requireMatchingUser"] = require_matching_user
        if glance_label is not UNSET:
            field_dict["glanceLabel"] = glance_label
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        use_collapsed_messages = d.pop("useCollapsedMessages", UNSET)

        require_matching_user = d.pop("requireMatchingUser", UNSET)

        glance_label = d.pop("glanceLabel", UNSET)

        hip_chat_add_on_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
            ...
            host_url=host_url,
            use_collapsed_messages=use_collapsed_messages,
            require_matching_user=require_matching_user,
            glance_label=glance_label,
        )

        hip_chat_add_on_integration.additional_properties = d
        return hip_chat_add_on_integration
