...
class FLOSP2HM(AbstractNonlinearEquations):
    ...
    ra: float = 1.0e5  # Rayleigh number (middling)
    ax: float = 1.0
    ...
    # Derived parameters
    axx: float = 1.0  # ax * ax
    pi1: float = 0.0  # -0.5 * 1.0 * 1.0e5 * cos(pi/2) = 0.0
    pi2: float = 50000.0  # 0.5 * 1.0 * 1.0e5 * sin(pi/2) = 50000
