...
class PoolApi:
    ...
    def scale_pool(
        ...
        _param = self._scale_pool_serialize(
            payload=payload,
    ...
    @validate_call
    def scale_pool_without_preload_content(
        self,
        payload: ScalePool,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def shutdown_server_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
