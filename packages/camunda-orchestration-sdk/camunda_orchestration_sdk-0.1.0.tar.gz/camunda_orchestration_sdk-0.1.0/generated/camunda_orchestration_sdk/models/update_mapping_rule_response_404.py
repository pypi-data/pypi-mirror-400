...
T = TypeVar("T", bound="UpdateMappingRuleResponse404")


@_attrs_define
class UpdateMappingRuleResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_mapping_rule_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        update_mapping_rule_response_404.additional_properties = d
        return update_mapping_rule_response_404
