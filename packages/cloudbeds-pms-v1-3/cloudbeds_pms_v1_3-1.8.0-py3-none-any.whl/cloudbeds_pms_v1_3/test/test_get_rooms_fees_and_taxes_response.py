    ...
    def make_instance(self, include_optional) -> GetRoomsFeesAndTaxesResponse:
        ...
        if include_optional:
            return GetRoomsFeesAndTaxesResponse(
                success = True,
                data = cloudbeds_pms_v1_3.models.get_rooms_fees_and_taxes_response_data.GetRoomsFeesAndTaxesResponse_data(
                    fees = [
                        cloudbeds_pms_v1_3.models.get_rooms_fees_and_taxes_response_data_fees_inner.GetRoomsFeesAndTaxesResponse_data_fees_inner(
                            fee_name = '', 
                            fee_value = 1.337, 
                            total_fees = 1.337, )
                        ], 
                    taxes = [
                        cloudbeds_pms_v1_3.models.get_rooms_fees_and_taxes_response_data_taxes_inner.GetRoomsFeesAndTaxesResponse_data_taxes_inner(
                            fee_name = '', 
                            fee_value = '', 
                            total_taxes = 1.337, )
                        ], 
