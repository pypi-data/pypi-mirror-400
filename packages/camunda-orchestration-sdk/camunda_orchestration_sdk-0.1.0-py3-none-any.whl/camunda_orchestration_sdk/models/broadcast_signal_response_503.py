...
T = TypeVar("T", bound="BroadcastSignalResponse503")


@_attrs_define
class BroadcastSignalResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        broadcast_signal_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        broadcast_signal_response_503.additional_properties = d
        return broadcast_signal_response_503
