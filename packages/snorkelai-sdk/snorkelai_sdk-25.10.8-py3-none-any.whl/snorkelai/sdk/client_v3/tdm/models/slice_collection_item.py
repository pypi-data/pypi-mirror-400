...
if TYPE_CHECKING:
    # fmt: off
    from ..models.slice_collection_item_metadata import (
        SliceCollectionItemMetadata,  # noqa: F401
    )
    from ..models.slice_config import SliceConfig  # noqa: F401
    # fmt: on


T = TypeVar("T", bound="SliceCollectionItem")


@attrs.define
class SliceCollectionItem:
    """
    Attributes:
        ...
        metadata (Union[Unset, SliceCollectionItemMetadata]):
    ...
    metadata: Union[Unset, "SliceCollectionItemMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = SliceCollectionItemMetadata.from_dict(_metadata)
