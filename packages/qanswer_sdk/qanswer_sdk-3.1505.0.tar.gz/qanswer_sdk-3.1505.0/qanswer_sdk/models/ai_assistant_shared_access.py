...
class AiAssistantSharedAccess(BaseModel):
    """
    AiAssistantSharedAccess
    """ # noqa: E501
    shared_by: Optional[StrictStr] = Field(default=None, alias="sharedBy")
    shared_id: Optional[StrictInt] = Field(default=None, alias="sharedId")
    ...
    __properties: ClassVar[List[str]] = ["sharedBy", "sharedId", "sourceName", "accessType"]

    @field_validator('shared_by')
    def shared_by_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AiAssistantSharedAccess from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AiAssistantSharedAccess from a dict"""
        if obj is None:
            return None
