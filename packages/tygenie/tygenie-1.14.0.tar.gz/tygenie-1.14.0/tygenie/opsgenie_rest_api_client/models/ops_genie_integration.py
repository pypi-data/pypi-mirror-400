...
T = TypeVar("T", bound="OpsGenieIntegration")
...
class OpsGenieIntegration:
    ...
    Attributes:
        ...
        destination_api_key (Union[Unset, str]):
    """
    ...
    destination_api_key: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        destination_api_key = self.destination_api_key
        ...
        if destination_api_key is not UNSET:
            field_dict["destinationApiKey"] = destination_api_key
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        destination_api_key = d.pop("destinationApiKey", UNSET)

        ops_genie_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        ops_genie_integration.additional_properties = d
        return ops_genie_integration
