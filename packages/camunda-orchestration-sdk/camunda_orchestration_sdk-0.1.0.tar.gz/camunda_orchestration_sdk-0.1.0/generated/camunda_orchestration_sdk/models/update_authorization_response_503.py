...
T = TypeVar("T", bound="UpdateAuthorizationResponse503")


@_attrs_define
class UpdateAuthorizationResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_authorization_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        update_authorization_response_503.additional_properties = d
        return update_authorization_response_503
