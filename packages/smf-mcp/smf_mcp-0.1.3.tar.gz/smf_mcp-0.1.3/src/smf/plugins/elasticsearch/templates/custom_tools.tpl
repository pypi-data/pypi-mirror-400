...
from smf.plugins.elasticsearch import ElasticsearchClient


def create_custom_tools(es_client: ElasticsearchClient, index: str) -> List[Any]:
    """
    Create custom Elasticsearch tools.
