...
# NOTE: pre_tool_use removed - causes stdin conflict with AskUserQuestion (GitHub #13439)
ALLOWED_HOOKS = {'stop', 'notification', 'notification_debug', 'session_start', 'session_end', 'subagent_stop', 'permission_request'}
...
# NOTE: handle_pre_tool_use removed - PreToolUse causes stdin conflict with AskUserQuestion (GitHub #13439)
# PermissionRequest now handles all tool approvals including AskUserQuestion
...
HANDLERS = {
    ...
    # pre_tool_use removed - GitHub #13439
}
