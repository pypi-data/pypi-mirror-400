"""
A facility used to monitor and control the grid, typically housing SCADA systems and other control equipment.
...
class ControlCenter(GridSTIXDomainObject):
    """
    A facility used to monitor and control the grid, typically housing SCADA systems and other control equipment.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize ControlCenter with Grid-STIX properties."""
