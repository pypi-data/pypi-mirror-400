...
T = TypeVar("T", bound="SlackAppIntegration")
...
class SlackAppIntegration:
    ...
    Attributes:
        ...
        use_slack_buttons (Union[Unset, bool]):
    """
    ...
    use_slack_buttons: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        use_slack_buttons = self.use_slack_buttons
        ...
        if use_slack_buttons is not UNSET:
            field_dict["useSlackButtons"] = use_slack_buttons
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        use_slack_buttons = d.pop("useSlackButtons", UNSET)

        slack_app_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
            ...
            use_slack_buttons=use_slack_buttons,
        )

        slack_app_integration.additional_properties = d
        return slack_app_integration
