...
T = TypeVar("T", bound="SearchClientsForGroupResponse403")


@_attrs_define
class SearchClientsForGroupResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_clients_for_group_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_clients_for_group_response_403.additional_properties = d
        return search_clients_for_group_response_403
