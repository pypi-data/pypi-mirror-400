...
T = TypeVar("T", bound="PostGoogleSsoResponse200")



@_attrs_define
class PostGoogleSsoResponse200:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_google_sso_response_200 = cls(
            success=success,
            user=user,
            tokens=tokens,
        )
        ...
        post_google_sso_response_200.additional_properties = d
        return post_google_sso_response_200
