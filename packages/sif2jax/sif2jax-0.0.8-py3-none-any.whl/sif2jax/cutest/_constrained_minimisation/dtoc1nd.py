...
class DTOC1ND(AbstractConstrainedMinimisation):
    ...
    n_controls: int = 2  # NX
    n_states: int = 4  # NY
    mu: float = 1.0  # Nonlinearity parameter
    ...
    def expected_objective_value(self):
        # From the SIF file: S(1000,2,4) 47.6030771433
        return jnp.array(47.6030771433)
