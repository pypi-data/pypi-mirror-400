...
from buddy.embedder import Embedder
from buddy.utils.log import log_debug, log_info
from buddy.vectordb.base import VectorDb
from buddy.vectordb.cassandra.index import BuddyMetadataVectorCassandraTable
...
class Cassandra(VectorDb):
    ...
    def initialize_table(self):
        self.table = BuddyMetadataVectorCassandraTable(
