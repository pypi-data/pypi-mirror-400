...
T = TypeVar("T", bound="DatadogCallback")
...
class DatadogCallback:
    ...
    send_to_eu: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if send_to_eu is not UNSET:
            field_dict["sendToEU"] = send_to_eu
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        send_to_eu = d.pop("sendToEU", UNSET)

        datadog_callback = cls(
            ...
            token=token,
            send_to_eu=send_to_eu,
        )

        datadog_callback.additional_properties = d
        return datadog_callback
