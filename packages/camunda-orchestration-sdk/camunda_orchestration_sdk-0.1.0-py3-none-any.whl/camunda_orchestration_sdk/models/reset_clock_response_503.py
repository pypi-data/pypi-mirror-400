...
T = TypeVar("T", bound="ResetClockResponse503")


@_attrs_define
class ResetClockResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reset_clock_response_503.additional_properties = d
        return reset_clock_response_503
