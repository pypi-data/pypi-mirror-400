...
T = TypeVar("T", bound="RotateApiKeyResponse200")



@_attrs_define
class RotateApiKeyResponse200:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rotate_api_key_response_200 = cls(
            api_key=api_key,
            message=message,
        )


        rotate_api_key_response_200.additional_properties = d
        return rotate_api_key_response_200
