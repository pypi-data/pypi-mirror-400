"""CLEUVEN4 problem with pre-computed data from NPZ file."""
...
_data_file = Path(__file__).parent / "data" / "cleuven4.npz"
...
class CLEUVEN4(AbstractConstrainedMinimisation):
    ...
    def __init__(self):
        """Load exact CLEUVEN4 data from NPZ file."""
