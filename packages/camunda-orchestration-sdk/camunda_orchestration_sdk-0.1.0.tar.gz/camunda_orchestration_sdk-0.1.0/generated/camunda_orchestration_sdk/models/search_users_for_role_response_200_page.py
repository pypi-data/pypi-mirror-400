...
T = TypeVar("T", bound="SearchUsersForRoleResponse200Page")


@_attrs_define
class SearchUsersForRoleResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_users_for_role_response_200_page = cls(
        ...
        search_users_for_role_response_200_page.additional_properties = d
        return search_users_for_role_response_200_page
