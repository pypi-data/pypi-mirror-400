...
T = TypeVar("T", bound="RollbarCallback")


@_attrs_define
class RollbarCallback:
    """
    Attributes:
        ...
        write_access_token (Union[Unset, str]):
    """
    ...
    write_access_token: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if write_access_token is not UNSET:
            field_dict["writeAccessToken"] = write_access_token
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        write_access_token = d.pop("writeAccessToken", UNSET)

        rollbar_callback = cls(
        ...
        rollbar_callback.additional_properties = d
        return rollbar_callback
