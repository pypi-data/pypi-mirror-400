"""
Shared DAG definition for LightGBM Complete End-to-End Pipeline
...
def create_lightgbm_complete_e2e_dag() -> PipelineDAG:
    ...
    calibration, packaging, registration, and evaluation of a LightGBM model.
...
def get_dag_metadata() -> DAGMetadata:
    """
    Get metadata for the LightGBM complete end-to-end DAG.
...
def validate_dag_structure(dag: PipelineDAG) -> Dict[str, Any]:
    """
    Validate the structure of the LightGBM complete end-to-end DAG.
