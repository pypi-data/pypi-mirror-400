...
class LoggingConfig:
    ...
    Tiger Style: Group related parameters into a single config object.
    """
...
def setup_logging(  # noqa: PLR0913 - intentionally many params for flexibility
    level: str | None = None,
    use_json: bool | None = None,
    use_rich: bool | None = None,
    use_color: bool | None = None,
    ...
    Args:
        ...
        disable_console: If True, don't add console handler. Useful when stdout is
                        being captured (e.g., by progress_display TUI). Requires log_file.
    ...
    assert not (disable_console and not log_file), "disable_console requires log_file"
    ...
    # Add console handler unless disabled (e.g., when TUI owns stdout)
