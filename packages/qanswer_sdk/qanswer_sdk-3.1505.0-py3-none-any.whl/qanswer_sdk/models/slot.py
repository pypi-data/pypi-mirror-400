...
class Slot(BaseModel):
    ...
    versions: Optional[List[SlotHistoryEntry]] = Field(default=None, description="Chronological history of prompt/completion pairs for this slot.")
    __properties: ClassVar[List[str]] = ["id", "node_id", "metadata_filters", "prompt", "completion", "sources", "prompt_used", "llm_choice", "mode", "is_input_data_cropped", "conversation_id", "user_message_id", "assistant_message_id", "feedback", "comment", "task_settings", "versions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "versions": [SlotHistoryEntry.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
