...
from labelearthapiclient import http
from labelearthapiclient import model
import httplib2
import requests
...
class _Http:
  ...
  def request(  # pylint: disable=invalid-name
    ...
    try:
      # labelearthapiclient is expecting an httplib2 object, and doesn't include
      # requests error in the list of transient errors. Therefore, transient
      # requests errors should be converted to kinds that labelearthapiclient
      # consider transient.
...
def build_cloud_resource(
  ...
  discovery_service_url = (
      ...
      '{}/rest?version={}&prettyPrint=false'
