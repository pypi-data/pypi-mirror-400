...
T = TypeVar("T", bound="CreateElementInstanceVariablesResponse503")


@_attrs_define
class CreateElementInstanceVariablesResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_element_instance_variables_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_element_instance_variables_response_503.additional_properties = d
        return create_element_instance_variables_response_503
