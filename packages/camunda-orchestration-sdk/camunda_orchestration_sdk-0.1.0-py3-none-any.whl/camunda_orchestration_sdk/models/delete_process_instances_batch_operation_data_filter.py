...
if TYPE_CHECKING:
    ...
    from ..models.delete_process_instances_batch_operation_data_filter_or_item import (
        DeleteProcessInstancesBatchOperationDataFilterOrItem,
    )
    from ..models.delete_process_instances_batch_operation_data_filter_variables_item import (
...
T = TypeVar("T", bound="DeleteProcessInstancesBatchOperationDataFilter")


@_attrs_define
class DeleteProcessInstancesBatchOperationDataFilter:
    ...
    Attributes:
        ...
        variables (list[DeleteProcessInstancesBatchOperationDataFilterVariablesItem] | Unset): The process instance
            variables.
        ...
        or_ (list[DeleteProcessInstancesBatchOperationDataFilterOrItem] | Unset): Defines a list of alternative filter
    ...
    variables: (
        list[DeleteProcessInstancesBatchOperationDataFilterVariablesItem] | Unset
    ) = UNSET
    ...
    or_: list[DeleteProcessInstancesBatchOperationDataFilterOrItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _variables is not UNSET:
            ...
            for variables_item_data in _variables:
                variables_item = DeleteProcessInstancesBatchOperationDataFilterVariablesItem.from_dict(
                    variables_item_data
                )
        ...
        if _or_ is not UNSET:
            ...
            for or_item_data in _or_:
                or_item = (
                    DeleteProcessInstancesBatchOperationDataFilterOrItem.from_dict(
                        or_item_data
                    )
                )
        ...
        delete_process_instances_batch_operation_data_filter = cls(
        ...
        delete_process_instances_batch_operation_data_filter.additional_properties = d
        return delete_process_instances_batch_operation_data_filter
