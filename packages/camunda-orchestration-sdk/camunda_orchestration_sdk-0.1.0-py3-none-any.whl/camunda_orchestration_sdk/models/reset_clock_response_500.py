...
T = TypeVar("T", bound="ResetClockResponse500")


@_attrs_define
class ResetClockResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reset_clock_response_500.additional_properties = d
        return reset_clock_response_500
