...
if __name__ == "__main__":
    ...
    try:
        ...
        # Example: Breast Cancer Wisconsin (Diagnostic)
        dataset = fetch_ucirepo(id=45)  # Breast Cancer Wisconsin (Diagnostic)
    ...
    # Run benchmark
    print("\n" + "="*70)
    print("  STARTING DUAL LINEARBOOST BENCHMARK")
    print("="*70)
    ...
    benchmark = ModelBenchmark(
        ...
        cv_folds=10,               # CV folds
        n_runs=30,                 # Repeated runs
        n_jobs=4,                  # Threads per model
        hp_sample_threshold=2000,  # Sample if > 2000 records
        hp_sample_size=1500,       # Use 1500 for HP tuning
        include_tabpfn=False       # Set True to include TabPFN
    )
