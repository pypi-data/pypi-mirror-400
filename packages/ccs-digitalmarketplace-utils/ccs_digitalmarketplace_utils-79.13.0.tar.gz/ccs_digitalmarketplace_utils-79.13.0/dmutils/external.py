...
@external.route('/suppliers/details')
...
@external.route("/suppliers/frameworks/<string:framework_slug>/services/<string:service_id>")
def supplier_edit_service(framework_slug, service_id):
    raise NotImplementedError()
...
@external.route('/admin/frameworks/<framework_slug>/services-awaiting-approval/<service_id>')
def admin_pending_services_show(framework_slug, service_id):
    raise NotImplementedError()
