...
T = TypeVar("T", bound="UnassignMappingRuleFromGroupResponse503")


@_attrs_define
class UnassignMappingRuleFromGroupResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unassign_mapping_rule_from_group_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        unassign_mapping_rule_from_group_response_503.additional_properties = d
        return unassign_mapping_rule_from_group_response_503
