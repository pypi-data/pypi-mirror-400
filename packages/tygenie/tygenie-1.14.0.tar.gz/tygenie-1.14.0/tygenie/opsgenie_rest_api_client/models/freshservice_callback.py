...
T = TypeVar("T", bound="FreshserviceCallback")


@_attrs_define
class FreshserviceCallback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        freshservice_callback.additional_properties = d
        return freshservice_callback
