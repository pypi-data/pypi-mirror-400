...
T = TypeVar("T", bound="SearchAuditLogsResponse401")


@_attrs_define
class SearchAuditLogsResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_audit_logs_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_audit_logs_response_401.additional_properties = d
        return search_audit_logs_response_401
