...
class TaskState(Enum):
    ...
    PENDING = "pending"  # Task moved to Todo, waiting to start
...
class TaskStateMachine:
    ...
    Valid transitions:
        ...
        COMPLETED -> IN_REVIEW, FAILED (if PR creation fails)
    ...
    TRANSITIONS: dict[TaskState, set[TaskState]] = {
        ...
        TaskState.COMPLETED: {TaskState.IN_REVIEW, TaskState.FAILED},
