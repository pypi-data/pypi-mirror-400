...
class LocalInPolicyPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    ha_mgmt_intf_only: NotRequired[Literal[{"description": "Enable dedicating HA management interface only for local-in policy", "help": "Enable dedicating HA management interface only for local-in policy.", "label": "Enable", "name": "enable"}, {"description": "Disable dedicating HA management interface only for local-in policy", "help": "Disable dedicating HA management interface only for local-in policy.", "label": "Disable", "name": "disable"}]]  # Enable/disable dedicating the HA management interface only f
    ...
    internet_service_src: NotRequired[Literal[{"description": "Enable use of Internet Services source in local-in policy", "help": "Enable use of Internet Services source in local-in policy.", "label": "Enable", "name": "enable"}, {"description": "Disable use of Internet Services source in local-in policy", "help": "Disable use of Internet Services source in local-in policy.", "label": "Disable", "name": "disable"}]]  # Enable/disable use of Internet Services in source for this l
    ...
    virtual_patch: NotRequired[Literal[{"description": "Enable virtual patching", "help": "Enable virtual patching.", "label": "Enable", "name": "enable"}, {"description": "Disable virtual patching", "help": "Disable virtual patching.", "label": "Disable", "name": "disable"}]]  # Enable/disable virtual patching.
...
class LocalInPolicy:
    ...
    def post(
        ...
        policyid: int | None = ...,
        uuid: str | None = ...,
        ha_mgmt_intf_only: Literal[{"description": "Enable dedicating HA management interface only for local-in policy", "help": "Enable dedicating HA management interface only for local-in policy.", "label": "Enable", "name": "enable"}, {"description": "Disable dedicating HA management interface only for local-in policy", "help": "Disable dedicating HA management interface only for local-in policy.", "label": "Disable", "name": "disable"}] | None = ...,
        ...
        internet_service_src: Literal[{"description": "Enable use of Internet Services source in local-in policy", "help": "Enable use of Internet Services source in local-in policy.", "label": "Enable", "name": "enable"}, {"description": "Disable use of Internet Services source in local-in policy", "help": "Disable use of Internet Services source in local-in policy.", "label": "Disable", "name": "disable"}] | None = ...,
        ...
        virtual_patch: Literal[{"description": "Enable virtual patching", "help": "Enable virtual patching.", "label": "Enable", "name": "enable"}, {"description": "Disable virtual patching", "help": "Disable virtual patching.", "label": "Disable", "name": "disable"}] | None = ...,
