...
class PostContactsFieldsDeleteRequest(BaseModel):
    """
    PostContactsFieldsDeleteRequest
    """ # noqa: E501
    ids: Annotated[List[StrictInt], Field(min_length=1, max_length=30)] = Field(description="List of contact field ids")
