...
class ColorFlowAnimation:
    ...
    def __init__(self, led_start_index: int, led_end_index: int, slot: int = 0, color: RGBWColor = RGBWColor(), direction: AnimationDirectionValue = AnimationDirectionValue.FORWARD, frame_rate: hertz = 25):
        ...
        A frame is defined as a transition in the state of the LEDs, turning one on or
        off.
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: ColorFlowAnimation")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlColorFlowAnimation(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.led_start_index, self.led_end_index, self.slot, self.color.red, self.color.green, self.color.blue, self.color.white, self.direction.value, self.frame_rate))

    
    def with_led_start_index(self, new_led_start_index: int) -> 'ColorFlowAnimation':
        """
        ...
        :returns: Itself
        :rtype: ColorFlowAnimation
        """
        self.led_start_index = new_led_start_index
        return self
    
    def with_led_end_index(self, new_led_end_index: int) -> 'ColorFlowAnimation':
        """
    ...
    def with_slot(self, new_slot: int) -> 'ColorFlowAnimation':
        """
    ...
    def with_color(self, new_color: RGBWColor) -> 'ColorFlowAnimation':
        """
    ...
    def with_direction(self, new_direction: AnimationDirectionValue) -> 'ColorFlowAnimation':
        """
    ...
    def with_frame_rate(self, new_frame_rate: hertz) -> 'ColorFlowAnimation':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'ColorFlowAnimation':
        """
