...
struct bind_frc__SimulatedAnnealing {
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_SimulatedAnnealing.def(py::init<double, std::function<State (const State&)>, std::function<double (const State&)>>()
    ...
    cls_SimulatedAnnealing.def("solve", &frc::SimulatedAnnealing<State>::Solve
