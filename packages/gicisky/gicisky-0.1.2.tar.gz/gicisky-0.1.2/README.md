...
1. **BLE Interface** ([ble/](https://git.boxo.cc/massivebox/gicisky/src/branch/main/ble)): Handles Bluetooth Low Energy communication
2. **Core Protocol** ([core/](https://git.boxo.cc/massivebox/gicisky/src/branch/main/core)): Implements the Gicisky communication protocol, independent of the Bluetooth library
3. **Image Processing** ([image/](https://git.boxo.cc/massivebox/gicisky/src/branch/main/image)): `conversion` formats images to the Gicisky format, `optimizer` (optional) uses
dithering and letterboxing for better results
4. **Logging** ([logger/](https://git.boxo.cc/massivebox/gicisky/src/branch/main/logger)): Provides detailed logging capabilities
