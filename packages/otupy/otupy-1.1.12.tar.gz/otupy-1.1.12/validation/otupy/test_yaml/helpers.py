...
def load_yaml(path):
	""" Load an otupy command/response from a yaml string or file. 
		
		It expects the command in a string; alternatively, the file containing the yaml can be given by
