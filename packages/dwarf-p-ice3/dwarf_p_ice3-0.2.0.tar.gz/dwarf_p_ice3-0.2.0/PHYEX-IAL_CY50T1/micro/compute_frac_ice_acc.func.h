...
!
! ******* OpenACC GPU-compatible version *******
!
!$acc routine seq
...
!!
!!    GPU-COMPATIBLE: Added !$acc routine seq directive for device execution
!!    This subroutine is called from within GPU kernels in CONDENSATION
!
!!    AUTHOR
!!    ------
...
!!      OpenACC          20/12/2025 added !$acc routine seq for GPU
!
!! --------------------------------------------------------------------------
