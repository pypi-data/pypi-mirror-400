"""
Relationship where an OTDevice monitors a GridComponent.
...
class MonitorsRelationship(GridSTIXRelationshipObject):
    """
    Relationship where an OTDevice monitors a GridComponent.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize MonitorsRelationship with Grid-STIX properties."""
