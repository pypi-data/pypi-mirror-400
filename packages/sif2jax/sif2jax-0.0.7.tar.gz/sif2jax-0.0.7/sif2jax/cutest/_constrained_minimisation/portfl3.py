...
_data_file = Path(__file__).parent / "data" / "portfl3_data.npz"
...
class PORTFL3(AbstractConstrainedMinimisation):
    """Portfolio optimization problem PORTFL3.
    ...
    def expected_objective_value(self):
        # From SIF file: *LO SOLTN 3.27497293D-2
        return jnp.array(3.27497293e-2)
