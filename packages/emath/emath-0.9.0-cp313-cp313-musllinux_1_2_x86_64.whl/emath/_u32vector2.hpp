...
static PyObject *
U32Vector2Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(uint32_t) * 2;
...
static PyMethodDef U32Vector2Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)U32Vector2Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
