...
T = TypeVar("T", bound="CreateDocumentLinkResponse400")


@_attrs_define
class CreateDocumentLinkResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_document_link_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_document_link_response_400.additional_properties = d
        return create_document_link_response_400
