...
class VESUVIA(AbstractNonlinearEquations):
    ...
    def residual(self, y):
        ...
        # X data points (1025 values from 5e-05 to 0.000562 in steps of 5e-07)
        ...
        # Y data points (1025 observed values)
        y_data = jnp.array(
            [
                -0.043818,
                -0.0374639,
        ...
        # Using transformed Gaussian (multiplication in exponent)
        model = (
            b1
            + b2 * x_data
