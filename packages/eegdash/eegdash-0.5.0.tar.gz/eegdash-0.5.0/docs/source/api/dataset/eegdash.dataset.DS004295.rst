...
Reward gain and punishment avoidance reversal learning (OpenNeuro ``ds004295``). Access recordings and metadata through EEGDash.
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds004295.v1.0.0 <https://doi.org/10.18112/openneuro.ds004295.v1.0.0>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds004295>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds004295>`__
