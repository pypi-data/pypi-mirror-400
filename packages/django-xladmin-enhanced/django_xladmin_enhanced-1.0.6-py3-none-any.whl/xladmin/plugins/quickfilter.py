...
from xladmin.filters import manager, MultiSelectFieldListFilter
from xladmin.plugins.filters import *
...
class QuickFilterMultiSelectFieldListFilter(MultiSelectFieldListFilter):
    ...
    """
    template = 'xladmin/filters/quickfilter.html'
...
class QuickFilterPlugin(BaseAdminPlugin):
    ...
    def get_media(self, media):
        return media + self.vendor('xladmin.plugin.quickfilter.js', 'xladmin.plugin.quickfilter.css')
    ...
    def block_left_navbar(self, context, nodes):
        nodes.append(loader.render_to_string('xladmin/blocks/modal_list.left_navbar.quickfilter.html',
