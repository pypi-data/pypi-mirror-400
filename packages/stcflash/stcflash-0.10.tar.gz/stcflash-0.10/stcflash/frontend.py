...
import stcflash
import serial
from stcflash.utils import BaudType
from stcflash.protocols import Stc89Protocol
from stcflash.protocols import Stc89AProtocol
from stcflash.protocols import Stc12AProtocol
from stcflash.protocols import Stc12BProtocol
from stcflash.protocols import Stc12Protocol
from stcflash.protocols import Stc15Protocol
from stcflash.protocols import Stc15AProtocol
from stcflash.protocols import StcUsb15Protocol
from stcflash.protocols import Stc8Protocol
from stcflash.protocols import Stc8dProtocol
from stcflash.protocols import Stc8gProtocol
from stcflash.protocols import StcAutoProtocol
from stcflash.protocols import StcProtocolException
from stcflash.protocols import StcFramingException
from stcflash.ihex import IHex
...
class StcGal:
    ...
    def run(self):
        ...
        if self.opts.version:
            print("stcgal {}".format(stcflash.__version__))
            return 0
...
def cli():
    ...
    parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter,
                                     description="stcgal {} - an STC MCU ISP flash tool\n".format(stcflash.__version__) +
                                                 "(C) 2026 CXi and others\n\thttps://github.com/cx693/StcFlash\n")
