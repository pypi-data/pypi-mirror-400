...
class ContextRelevanceProcessor(BaseProcessor):
    def pre_process(self, args) -> Any:
        ...
        eval_output_suffix = getattr(args, "eval_output_suffix", "c_relevance")
    ...
    def core_process(self, pre_data):
        ...
        processor = ContextRelevanceEvalProcessor(
            yaml_path=yaml_path,
    ...
    def post_process(self, result: Any) -> Tuple[bool, str]:
        ...
        try:
            ...
            columns_config = getattr(args, "columns_config", {}) or {}
            col_score = columns_config.get('context_relevance_score', '上下文相关性（问题和文档）分数')
            col_score_desc = columns_config.get('context_relevance_description', '上下文相关性得分说明')
