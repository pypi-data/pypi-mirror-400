...
class ReducerTest(apitestcase.ApiTestCase):
  ...
  def test_simple(self):
    reducer = le.Reducer.toList()
    self.assertEqual({'value': 'fakeValue'}, reducer.getInfo())

    reducer_func = le.ApiFunction.lookup(TO_LIST)
  ...
  def test_bad_arg_literal(self):
    ...
    with self.assertRaisesRegex(TypeError, message):
      le.Reducer(1)  # pytype: disable=wrong-arg-types

  def test_all_non_zero(self):
    expect = make_expression_graph(
        {'arguments': {}, 'functionName': 'Reducer.allNonZero'}
    )
    expression = le.Reducer.allNonZero()
  ...
  def test_anyNonZero(self):
    ...
    expression = le.Reducer.anyNonZero()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_auto_histogram(self):
    ...
    expression = le.Reducer.autoHistogram(
  ...
  def test_bitwise_and(self):
    ...
    expression = le.Reducer.bitwiseAnd()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_bitwise_or(self):
    ...
    expression = le.Reducer.bitwiseOr()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_centered_covariance(self):
    ...
    expression = le.Reducer.centeredCovariance()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_circular_mean(self):
    ...
    expression = le.Reducer.circularMean()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_circular_stddev(self):
    ...
    expression = le.Reducer.circularStddev()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_circular_variance(self):
    ...
    expression = le.Reducer.circularVariance()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

  def test_combine(self):
    reducer1 = le.Reducer.first()
    reducer2 = le.Reducer.last()
    output_prefix = 'a'
    shared_inputs = True
    expect = make_expression_graph({
        'arguments': {
  ...
  def test_count_distinct(self):
    ...
    expression = le.Reducer.countDistinct()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_count_distinct_non_null(self):
    ...
    expression = le.Reducer.countDistinctNonNull()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_count_every(self):
    ...
    expression = le.Reducer.countEvery()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_count_runs(self):
    ...
    expression = le.Reducer.countRuns()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_covariance(self):
    ...
    expression = le.Reducer.covariance()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

  def test_disaggregate(self):
    reducer = le.Reducer.last()
    axis = 1
    expect = make_expression_graph({
        'arguments': {
            'reducer': {
  ...
  def test_first_non_null(self):
    ...
    expression = le.Reducer.firstNonNull()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_fixed_2d_histogram(self):
    ...
    expression = le.Reducer.fixed2DHistogram(
  ...
  def test_fixed_histogram(self):
    ...
    expression = le.Reducer.fixedHistogram(
  ...
  def test_frequency_histogram(self):
    ...
    expression = le.Reducer.frequencyHistogram()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_geometric_median(self):
    ...
    expression = le.Reducer.geometricMedian(num_x, eta, initial_step_size)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Reducer.geometricMedian(
  ...
  def test_histogram(self):
    ...
    expression = le.Reducer.histogram(max_buckets, min_bucket_width, max_raw)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Reducer.histogram(
  ...
  def test_interval_mean(self):
    ...
    expression = le.Reducer.intervalMean(
  ...
  def test_kendalls_correlation(self):
    ...
    expression = le.Reducer.kendallsCorrelation(num_inputs)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Reducer.kendallsCorrelation(numInputs=num_inputs)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_kurtosis(self):
    ...
    expression = le.Reducer.kurtosis()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_last_non_null(self):
    ...
    expression = le.Reducer.lastNonNull()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_linear_fit(self):
    ...
    expression = le.Reducer.linearFit()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_linear_regression(self):
    ...
    expression = le.Reducer.linearRegression(num_x, num_y)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Reducer.linearRegression(numX=num_x, numY=num_y)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_max(self):
    ...
    expression = le.Reducer.max(num_inputs)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Reducer.max(numInputs=num_inputs)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_median(self):
    ...
    expression = le.Reducer.median(max_buckets, min_bucket_width, max_raw)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Reducer.median(
        maxBuckets=max_buckets, minBucketWidth=min_bucket_width, maxRaw=max_raw
    )
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_min(self):
    ...
    expression = le.Reducer.min(num_inputs)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Reducer.min(numInputs=num_inputs)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_mode(self):
    ...
    expression = le.Reducer.mode(max_buckets, min_bucket_width, max_raw)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Reducer.mode(
        maxBuckets=max_buckets, minBucketWidth=min_bucket_width, maxRaw=max_raw
    )
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_pearsons_correlation(self):
    ...
    expression = le.Reducer.pearsonsCorrelation()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_percentile(self):
    ...
    expression = le.Reducer.percentile(
  ...
  def test_product(self):
    ...
    expression = le.Reducer.product()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

  def test_repeat(self):
    reducer = le.Reducer.product()
    count = 1
    expect = make_expression_graph({
        'arguments': {
            'reducer': {
  ...
  def test_ridge_regression(self):
    ...
    expression = le.Reducer.ridgeRegression(num_x, num_y, lambda_)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
    ...
    expression = le.Reducer.ridgeRegression(**args)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_robust_linear_regression(self):
    ...
    expression = le.Reducer.robustLinearRegression(num_x, num_y, beta)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Reducer.robustLinearRegression(
  ...
  def test_sample_std_dev(self):
    ...
    expression = le.Reducer.sampleStdDev()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_sample_variance(self):
    ...
    expression = le.Reducer.sampleVariance()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_sens_slope(self):
    ...
    expression = le.Reducer.sensSlope()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_spearmans_correlation(self):
    ...
    expression = le.Reducer.spearmansCorrelation()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_to_collection(self):
    ...
    expression = le.Reducer.toCollection(property_names, num_optional)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Reducer.toCollection(
  ...
  def test_to_list(self):
    ...
    expression = le.Reducer.toList(tuple_size, num_optional)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Reducer.toList(
  ...
  def test_variance(self):
    ...
    expression = le.Reducer.variance()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
