...
def mbcnt_hi(res, in0, in1, *, arg_attrs=None, res_attrs=None, loc=None, ip=None) -> _ods_ir.Value:
...
def mbcnt_lo(res, in0, in1, *, arg_attrs=None, res_attrs=None, loc=None, ip=None) -> _ods_ir.Value:
...
def permlane16_swap(res, old, src, fi, bound_control, *, loc=None, ip=None) -> _ods_ir.Value:
...
def permlane32_swap(res, old, src, fi, bound_control, *, loc=None, ip=None) -> _ods_ir.Value:
...
def readfirstlane(res, src, *, loc=None, ip=None) -> _ods_ir.Value:
...
def s_sleep(count, *, loc=None, ip=None) -> _ods_ir.Operation:
...
def s_wait_dscnt(count, *, loc=None, ip=None) -> _ods_ir.Operation:
...
def s_wait_expcnt(count, *, loc=None, ip=None) -> _ods_ir.Operation:
...
def s_wait_loadcnt(count, *, loc=None, ip=None) -> _ods_ir.Operation:
...
def s_wait_storecnt(count, *, loc=None, ip=None) -> _ods_ir.Operation:
