...
if TYPE_CHECKING:
    from ..models.search_mapping_rules_for_group_response_200_page import (
...
class SearchMappingRulesForGroupResponse200:
    """
    Attributes:
        page (SearchMappingRulesForGroupResponse200Page): Pagination information about the search results. Example:
            {'totalItems': 1, 'hasMoreTotalItems': False}.
    """

    page: SearchMappingRulesForGroupResponse200Page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page = SearchMappingRulesForGroupResponse200Page.from_dict(d.pop("page"))
