...
from haplohub.models.score_id import ScoreId  # noqa: E501


class TestScoreId(unittest.TestCase):
    """ScoreId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScoreId:
        """Test ScoreId
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ScoreId`
        """
        model = ScoreId()  # noqa: E501
        if include_optional:
            return ScoreId(
            )
        else:
