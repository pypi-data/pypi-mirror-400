...
if __name__ == "__main__":
    ...
    This function runs an issue response time analysis on the dataset provided. \
    It returns the number of unanswered issues at each point in time \
    as well as a curve representing the evolution of the reponse time to the issues of a certain project or community."
    )
