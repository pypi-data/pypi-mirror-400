...
class ScreenshotResponse(BaseModel):
    ...
    data: Optional[ScreenshotData] = Field(default=None, description="Screenshot data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ScreenshotData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
