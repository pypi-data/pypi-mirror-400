...
EEG data from an auditory oddball task (OpenNeuro ``ds003061``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 1` :bdg-light:`License: CC0` :bdg-light:`Subjects: 13` :bdg-light:`Recordings: 39` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds003061.v1.1.0 <https://doi.org/10.18112/openneuro.ds003061.v1.1.0>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds003061>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds003061>`__
