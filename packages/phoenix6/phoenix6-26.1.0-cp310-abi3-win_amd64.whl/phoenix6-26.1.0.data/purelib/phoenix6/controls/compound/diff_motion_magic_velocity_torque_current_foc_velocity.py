...
@final
class Diff_MotionMagicVelocityTorqueCurrentFOC_Velocity:
    """
    ...
    def __init__(self, average_request: MotionMagicVelocityTorqueCurrentFOC, differential_request: VelocityTorqueCurrentFOC):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_MotionMagicVelocityTorqueCurrentFOC_Velocity"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicVelocityTorqueCurrentFOC_Velocity")
    ...
    def with_average_request(self, new_average_request: MotionMagicVelocityTorqueCurrentFOC) -> 'Diff_MotionMagicVelocityTorqueCurrentFOC_Velocity':
        ...
        :returns: Itself
        :rtype: Diff_MotionMagicVelocityTorqueCurrentFOC_Velocity
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: VelocityTorqueCurrentFOC) -> 'Diff_MotionMagicVelocityTorqueCurrentFOC_Velocity':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicVelocityTorqueCurrentFOC_Velocity':
        """
