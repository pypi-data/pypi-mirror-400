...
T = TypeVar("T", bound="LightstepIntegration")


@_attrs_define
class LightstepIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        lightstep_integration.additional_properties = d
        return lightstep_integration
