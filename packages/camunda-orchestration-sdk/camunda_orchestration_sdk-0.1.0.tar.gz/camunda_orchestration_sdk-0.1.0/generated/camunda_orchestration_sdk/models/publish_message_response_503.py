...
T = TypeVar("T", bound="PublishMessageResponse503")


@_attrs_define
class PublishMessageResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        publish_message_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        publish_message_response_503.additional_properties = d
        return publish_message_response_503
