...
T = TypeVar("T", bound="UptimeWebhookIntegration")
...
class UptimeWebhookIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        uptime_webhook_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        uptime_webhook_integration.additional_properties = d
        return uptime_webhook_integration
