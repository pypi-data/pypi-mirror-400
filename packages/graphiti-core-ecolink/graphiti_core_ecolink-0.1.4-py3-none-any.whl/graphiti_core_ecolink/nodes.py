...
class EpisodicNode(Node):
    ...
    agent_id: str | None = Field(
        description='agent identifier for this episode',
        default=None,
    )
    # 新增 file_id 字段
    file_id: str | None = Field(
        description='file identifier for this episode',
        default=None,
    )
    ...
    async def save(self, driver: GraphDriver):
        result = await driver.execute_query(
            ...
            agent_id=self.agent_id,  # 新增
            file_id=self.file_id,  # 新增
        )
...
class EntityNode(Node):
    ...
    agent_id: str | None = Field(
        default=None, description='agent identifier for this entity'
    )
    file_id: str | None = Field(
        default=None, description='file identifier for this entity'
    )
...
class CommunityNode(Node):
    ...
    agent_id: str | None = Field(
        default=None, description='agent identifier for this community'
    )
    file_id: str | None = Field(
        default=None, description='file identifier for this community'
    )
...
def get_episodic_node_from_record(record: Any) -> EpisodicNode:
    ...
    return EpisodicNode(
        ...
        file_id=record.get('file_id'),  # 添加 file_id 字段
    )
