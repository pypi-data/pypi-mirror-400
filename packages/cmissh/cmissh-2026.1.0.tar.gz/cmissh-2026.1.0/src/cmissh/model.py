...
from cmissh.atompub.binding import AtomPubBinding
from cmissh.cmis_services import Binding
...
class CmisClient:
    ...
    def __init__(self, repositoryUrl, username, password, **kwargs):
        ...
        # Store base URL on session for URL resolution
        self.session.base_url = repositoryUrl
