...
static PyObject *
UArray_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(unsigned int);
...
static PyMethodDef UArray_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)UArray_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
