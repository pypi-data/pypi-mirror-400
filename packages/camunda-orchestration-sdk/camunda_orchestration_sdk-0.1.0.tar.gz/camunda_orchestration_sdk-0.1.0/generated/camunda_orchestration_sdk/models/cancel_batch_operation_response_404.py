...
T = TypeVar("T", bound="CancelBatchOperationResponse404")


@_attrs_define
class CancelBatchOperationResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancel_batch_operation_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        cancel_batch_operation_response_404.additional_properties = d
        return cancel_batch_operation_response_404
