...
cdef bytes _ee2_data_path

def _init_data_path():
    global _ee2_data_path
    with as_file(files("euclidemu2") / "euclidemu2/ee2_bindata.dat") as p:
        _ee2_data_path = str(p).encode("utf-8")
        set_data_path(_ee2_data_path)
