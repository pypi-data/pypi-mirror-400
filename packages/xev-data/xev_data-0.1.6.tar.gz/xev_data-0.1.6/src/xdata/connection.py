...
class CopyPair(object):
    """A pair of connection objects for reading and writing"""
    def __init__(
            self,
            fname_src,
            fname_out = None,
    ...
    def __enter__(self):
        self.entered_objects = [
            self._stack.enter_context(conn) for conn in self.connections
        ]
        return self
