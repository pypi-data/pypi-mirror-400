...
_version_path = os.path.abspath(
    os.path.join(_docs_path, "..", "src", "apolo_sdk", "__init__.py")
)
...
man_pages = [(master_doc, "apolosdk", "Apolo SDK Documentation", [author], 1)]
