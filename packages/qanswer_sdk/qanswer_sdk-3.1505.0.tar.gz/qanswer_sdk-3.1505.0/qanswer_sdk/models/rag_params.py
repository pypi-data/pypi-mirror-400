...
class RAGParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["context_window", "min_context_window"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RAGParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RAGParams from a dict"""
        if obj is None:
            return None
