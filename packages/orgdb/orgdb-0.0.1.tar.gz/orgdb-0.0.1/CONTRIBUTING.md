...
Welcome to `orgdb` contributor's guide.
...
If you experience bugs or general issues with `orgdb`, please have a look
...
You can help improve `orgdb` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`orgdb` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `orgdb`'s files. While this mechanism can
...
```
conda create -n orgdb python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/orgdb.git
   cd orgdb
   ```
...
5. Install [pre-commit]:
   ...
   `orgdb` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/orgdb
[issue tracker]: https://github.com/<USERNAME>/orgdb/issues
