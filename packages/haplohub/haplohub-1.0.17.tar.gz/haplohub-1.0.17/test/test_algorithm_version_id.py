...
from haplohub.models.algorithm_version_id import AlgorithmVersionId  # noqa: E501


class TestAlgorithmVersionId(unittest.TestCase):
    """AlgorithmVersionId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgorithmVersionId:
        """Test AlgorithmVersionId
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AlgorithmVersionId`
        """
        model = AlgorithmVersionId()  # noqa: E501
        if include_optional:
    ...
    def testAlgorithmVersionId(self):
        """Test AlgorithmVersionId"""
