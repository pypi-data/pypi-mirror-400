...
from keys import load_certs_from_pemder_data
from sign.ades.report import AdESFailure, AdESIndeterminate
from sign.validation.errors import SignatureValidationError
from sign.validation.qualified.tsp import (
...
from ..sign.validation.settings import KeyUsageConstraints
...
def _lotl_certs_file(fname: str) -> List[x509.Certificate]:
    pkg_files = resources.files(".sign.validation.qualified")
