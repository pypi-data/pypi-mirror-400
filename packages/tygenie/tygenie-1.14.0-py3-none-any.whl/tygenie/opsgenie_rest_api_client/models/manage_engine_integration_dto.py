...
T = TypeVar("T", bound="ManageEngineIntegrationDTO")


@_attrs_define
class ManageEngineIntegrationDTO:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        manage_engine_integration_dto = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        manage_engine_integration_dto.additional_properties = d
        return manage_engine_integration_dto
