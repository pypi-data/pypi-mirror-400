...
def main():
    ...
    parser.add_argument("--layers", type=int, default=3, help="Maksymalna liczba warstw (domyślnie: 3)")
    parser.add_argument("--neurons", type=int, default=10, help="Liczba neuronów na warstwę (domyślnie: 10)")
    parser.add_argument("--time", type=float, default=10.0, help="Limit czasu w sekundach na warstwę (domyślnie: 10.0)")
    parser.add_argument("--accuracy", type=float, default=1.0, help="Docelowa dokładność 0.0-1.0 (domyślnie: 1.0)")
