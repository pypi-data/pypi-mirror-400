"""
Components that distribute electrical energy from transmission systems to end users.
...
class DistributionAsset(GridSTIXDomainObject):
    """
    Components that distribute electrical energy from transmission systems to end users.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize DistributionAsset with Grid-STIX properties."""
