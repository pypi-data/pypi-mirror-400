                ...
                try:
                    ...
                    while current_part in buffered_parts:
                        ...
                        if already_verified:
                            ...
                            logging.info(
                                f"[Extract {current_part}] Part streamed to tar "
                                f"extractor (already verified, {total_written} bytes)"
                            )
                        else:
                            ...
                            # Part now streamed to tar extractor
                            logging.info(
                                f"[Extract {current_part}] Part streamed to tar "
                                f"extractor ({total_written} bytes)"
                            )
