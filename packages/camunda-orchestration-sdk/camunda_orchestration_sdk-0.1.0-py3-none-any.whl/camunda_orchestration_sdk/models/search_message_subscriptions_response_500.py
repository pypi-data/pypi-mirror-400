...
T = TypeVar("T", bound="SearchMessageSubscriptionsResponse500")


@_attrs_define
class SearchMessageSubscriptionsResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_message_subscriptions_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_message_subscriptions_response_500.additional_properties = d
        return search_message_subscriptions_response_500
