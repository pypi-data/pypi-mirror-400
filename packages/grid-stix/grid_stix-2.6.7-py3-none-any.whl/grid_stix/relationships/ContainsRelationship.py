"""
Relationship where one physical asset physically contains another asset or component.
...
class ContainsRelationship(GridSTIXRelationshipObject):
    """
    Relationship where one physical asset physically contains another asset or component.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize ContainsRelationship with Grid-STIX properties."""
