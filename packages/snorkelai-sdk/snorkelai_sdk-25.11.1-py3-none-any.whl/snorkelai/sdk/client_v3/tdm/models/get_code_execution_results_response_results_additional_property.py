...
T = TypeVar("T", bound="GetCodeExecutionResultsResponseResultsAdditionalProperty")


@attrs.define
class GetCodeExecutionResultsResponseResultsAdditionalProperty:
    """ """

    additional_properties: Dict[str, Union[None, float, int, str]] = attrs.field(
