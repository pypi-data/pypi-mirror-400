...
T = TypeVar("T", bound="UpdateSchedulePayload")
...
class UpdateSchedulePayload:
    """
    Attributes:
        name (Union[Unset, str]): Name of the schedule
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_schedule_payload.additional_properties = d
        return update_schedule_payload
