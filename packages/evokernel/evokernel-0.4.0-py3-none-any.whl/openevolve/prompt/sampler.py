...
class PromptSampler:
    ...
    def build_prompt(
        ...
        current_program: str = "",
        parent_program: str = "",
        program_metrics: dict[str, float] = None,
        previous_programs: list[dict[str, Any]] = None,
        top_programs: list[dict[str, Any]] = None,
        inspirations: list[dict[str, Any]] = None,  # Add inspirations parameter
        language: str = "python",
        ...
        **kwargs: Any,
        ...
        if top_programs is None:
            top_programs = []
        if previous_programs is None:
            previous_programs = []
        if program_metrics is None:
            program_metrics = {}
        if template_key:
    ...
    def _extract_unique_features(self, program: dict[str, Any]) -> str:
        ...
        if not features:
            ...
            features.append(
                ...
                ).format(program_type=program_type)
            )
