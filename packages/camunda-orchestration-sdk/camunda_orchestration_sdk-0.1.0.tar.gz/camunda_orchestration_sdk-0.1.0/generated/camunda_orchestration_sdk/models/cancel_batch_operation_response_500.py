...
T = TypeVar("T", bound="CancelBatchOperationResponse500")


@_attrs_define
class CancelBatchOperationResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancel_batch_operation_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        cancel_batch_operation_response_500.additional_properties = d
        return cancel_batch_operation_response_500
