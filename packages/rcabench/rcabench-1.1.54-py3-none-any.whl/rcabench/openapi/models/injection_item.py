...
class InjectionItem(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["end_time", "id", "name", "pre_duration", "start_time"]
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of InjectionItem from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of InjectionItem from a dict"""
        if obj is None:
            return None
