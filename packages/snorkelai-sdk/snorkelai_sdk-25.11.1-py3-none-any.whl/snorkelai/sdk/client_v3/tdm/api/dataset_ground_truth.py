...
from ..models import (
    BulkAddDatasetGroundTruthRequest,
    DatasetGroundTruth,
)
from ..types import UNSET, Unset


def bulk_update_dataset_ground_truth_per_datapoint_dataset__dataset_uid__ground_truth__x_uid__bulk_post(
    dataset_uid: int,
    x_uid: str,
    *,
    body: BulkAddDatasetGroundTruthRequest,
    ...
    params["annotation_task_uid"] = annotation_task_uid
    ...
    _kwargs: Dict[str, Any] = {
        "endpoint": f"/dataset/{dataset_uid}/ground-truth/{x_uid}/bulk",
        "params": params,
    }
    ...
    def _parse_response(response: Any) -> List["DatasetGroundTruth"]:
        ...
        for response_201_item_data in _response_201:
            response_201_item = DatasetGroundTruth.from_dict(response_201_item_data)
