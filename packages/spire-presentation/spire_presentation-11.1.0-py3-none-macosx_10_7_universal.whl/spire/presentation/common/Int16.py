...
class Int16 (SpireObject) :
    ...
    def CompareTo(self ,value:SpireObject)->int:
        ...
        ret = CallCFunction(dlllib.Int16_CompareTo,self.Ptr, intPtrvalue)
        return ret
    ...
    def CompareTo(self ,value:'Int16')->int:
        ...
        ret = CallCFunction(dlllib.Int16_CompareToV,self.Ptr, intPtrvalue)
        return ret
    ...
    def Equals(self ,obj:SpireObject)->bool:
        ...
        ret = CallCFunction(dlllib.Int16_Equals,self.Ptr, intPtrobj)
        return ret
    ...
    def Equals(self ,obj:'Int16')->bool:
        ...
        ret = CallCFunction(dlllib.Int16_EqualsO,self.Ptr, intPtrobj)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = CallCFunction(dlllib.Int16_GetHashCode,self.Ptr)
        return ret
    ...
    def ToString(self)->str:
        ...
        ret = PtrToStr(CallCFunction(dlllib.Int16_ToString,self.Ptr))
        return ret
...
#        ret = CallCFunction(dlllib.Int16_ToStringP,self.Ptr, intPtrprovider)
#        return ret
#
    ...
    def ToString(self ,format:str)->str:
        ...
        ret = PtrToStr(CallCFunction(dlllib.Int16_ToStringF,self.Ptr, format))
        return ret
...
#        ret = CallCFunction(dlllib.Int16_ToStringFP,self.Ptr, format,intPtrprovider)
#        return ret
#
    ...
    def Parse(s:str)->'Int16':
        ...
        intPtr = CallCFunction(dlllib.Int16_Parse, s)
...
#        intPtr = CallCFunction(dlllib.Int16_ParseSS, s,enumstyle)
#        ret = None if intPtr==None else Int16(intPtr)
#        return ret
#
...
#        intPtr = CallCFunction(dlllib.Int16_ParseSP, s,intPtrprovider)
#        ret = None if intPtr==None else Int16(intPtr)
#        return ret
#
...
#        intPtr = CallCFunction(dlllib.Int16_ParseSSP, s,enumstyle,intPtrprovider)
#        ret = None if intPtr==None else Int16(intPtr)
#        return ret
#
...
#        ret = CallCFunction(dlllib.Int16_TryParse, s,intPtrresult)
#        return ret
...
#        ret = CallCFunction(dlllib.Int16_TryParseSSPR, s,enumstyle,intPtrprovider,intPtrresult)
#        return ret
...
#        ret = CallCFunction(dlllib.Int16_GetTypeCode,self.Ptr)
...
#        return objwraped
    ...
    def MaxValue()->'Int16':
        ...
        intPtr = CallCFunction(dlllib.Int16_MaxValue)
        ret = None if intPtr==None else Int16(intPtr)
        return ret
    ...
    def MinValue()->'Int16':
        ...
        intPtr = CallCFunction(dlllib.Int16_MinValue)
        ret = None if intPtr==None else Int16(intPtr)
        return ret
