...
class Resourceinformation(BaseModel):
    """
    resource information related to a file
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["_id", "filename", "fileType", "groupName", "multiplicity", "file"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Resourceinformation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Resourceinformation from a dict"""
        if obj is None:
            return None
