...
class PandasConversionMixin(object):
    ...
    def toPandas(self):
        ...
        1    5    Bob
        """
        from tecton_spark.type_annotations import is_pyspark_df

        assert is_pyspark_df(self)
...
class SparkConversionMixin(object):
    ...
    def createDataFrame(self, data, schema=None, samplingRatio=None, verifySchema=True):
        from tecton_spark.type_annotations import is_pyspark_session

        assert is_pyspark_session(self)
