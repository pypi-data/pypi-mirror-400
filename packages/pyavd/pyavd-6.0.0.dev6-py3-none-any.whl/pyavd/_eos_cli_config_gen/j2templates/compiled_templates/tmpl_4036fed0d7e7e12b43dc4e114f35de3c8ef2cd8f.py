...
def root(context, missing=missing):
    ...
    if t_2((undefined(name='router_adaptive_virtual_topology') if l_0_router_adaptive_virtual_topology is missing else l_0_router_adaptive_virtual_topology)):
        ...
        if (t_2(environment.getattr(environment.getattr((undefined(name='router_adaptive_virtual_topology') if l_0_router_adaptive_virtual_topology is missing else l_0_router_adaptive_virtual_topology), 'site'), 'name')) and environment.getattr(environment.getattr((undefined(name='router_adaptive_virtual_topology') if l_0_router_adaptive_virtual_topology is missing else l_0_router_adaptive_virtual_topology), 'site'), 'id')):
            ...
            yield '\n'
        for l_1_policy in t_1(environment.getattr((undefined(name='router_adaptive_virtual_topology') if l_0_router_adaptive_virtual_topology is missing else l_0_router_adaptive_virtual_topology), 'policies'), sort_key='name'):
            _loop_vars = {}
            pass
            yield '   !\n   policy '
            ...
            l_2_match = missing
        l_1_policy = missing
        for l_1_profile in t_1(environment.getattr((undefined(name='router_adaptive_virtual_topology') if l_0_router_adaptive_virtual_topology is missing else l_0_router_adaptive_virtual_topology), 'profiles'), sort_key='name'):
            _loop_vars = {}
            pass
            yield '   !\n   profile '
            ...
            if t_2(environment.getattr(environment.getattr(l_1_profile, 'outlier_elimination'), 'threshold')):
                ...
                if t_2(environment.getattr(environment.getattr(environment.getattr(l_1_profile, 'outlier_elimination'), 'threshold'), 'load')):
                    ...
                    yield ' percent\n'
        l_1_profile = missing
        for l_1_vrf in t_1(environment.getattr((undefined(name='router_adaptive_virtual_topology') if l_0_router_adaptive_virtual_topology is missing else l_0_router_adaptive_virtual_topology), 'vrfs'), sort_key='name'):
            _loop_vars = {}
            pass
            yield '   !\n   vrf '
            ...
            if t_2(environment.getattr(l_1_vrf, 'policy')):
                ...
                yield '\n'
            for l_2_profile in t_1(environment.getattr(l_1_vrf, 'profiles'), sort_key='id'):
                _loop_vars = {}
                pass
