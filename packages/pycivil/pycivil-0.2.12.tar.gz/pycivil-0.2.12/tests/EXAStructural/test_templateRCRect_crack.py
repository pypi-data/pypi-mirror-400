...
# ----------------------
def test_no_symmetric_M_unknown_001(tmp_path: Path):
...
# BY-HAND TEST CASE #2.7
# ----------------------
def test_no_symmetric_M_decompressed_002(tmp_path: Path):
    # Setting code for check
    code = Code("NTC2008")
...
# ----------------------
def test_no_symmetric_M_cracked_bot_003(tmp_path: Path):
    # Setting code for check
    code = Code("NTC2008")
...
def test_no_symmetric_M_cracked_top_004(tmp_path: Path):
    # Setting code for check
    code = Code("NTC2008")
    concrete = Concrete(descr="My concrete")
    concrete.setByCode(code, "C32/40")
...
# ----------------------
def test_no_symmetric_N_cracked_005(tmp_path: Path):
    # Setting code for check
    code = Code("NTC2008")
...
# ----------------------
def test_cracked_compressed_NM_006(tmp_path: Path):
    # Setting code for check
    code = Code("NTC2008")
