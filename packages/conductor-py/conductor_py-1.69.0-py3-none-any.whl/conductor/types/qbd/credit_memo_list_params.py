...
class CreditMemoListParams(TypedDict, total=False):
    ...
    **NOTE**: If you use this parameter, you cannot also use `refNumberContains` or
    ...
    """
    Filter for credit memos whose `date` field is on or after this date, in ISO 8601
    format (YYYY-MM-DD).
    ...
    **NOTE:** QuickBooks Desktop interprets this date as the **start of the
    ...
    """
    Filter for credit memos whose `date` field is on or before this date, in ISO
    ...
    **NOTE:** QuickBooks Desktop interprets this date as the **end of the specified
    ...
    """Filter for credit memos updated on or after this date/time.
    ...
    """Filter for credit memos updated on or before this date/time.
