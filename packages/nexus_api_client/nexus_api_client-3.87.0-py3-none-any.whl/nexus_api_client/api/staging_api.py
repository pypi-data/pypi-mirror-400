...
"""
    ...
    The version of the OpenAPI document: 3.87.1-01
...
class StagingApi:
    ...
    def delete2(
        ...
        terraform_system: Annotated[Optional[StrictStr], Field(description="terraform system")] = None,
        terraform_architecture: Annotated[Optional[StrictStr], Field(description="terraform architecture")] = None,
        terraform_asset_kind: Annotated[Optional[StrictStr], Field(description="terraform asset kind")] = None,
        ...
        :param terraform_system: terraform system
        :type terraform_system: str
        :param terraform_architecture: terraform architecture
        :type terraform_architecture: str
        :param terraform_asset_kind: terraform asset kind
        :type terraform_asset_kind: str
        ...
        _param = self._delete2_serialize(
            ...
            terraform_system=terraform_system,
            terraform_architecture=terraform_architecture,
            terraform_asset_kind=terraform_asset_kind,
    ...
    def _delete2_serialize(
        ...
        if terraform_system is not None:
            
            _query_params.append(('terraform.system', terraform_system))
            
        if terraform_architecture is not None:
            
            _query_params.append(('terraform.architecture', terraform_architecture))
            
        if terraform_asset_kind is not None:
            
            _query_params.append(('terraform.asset_kind', terraform_asset_kind))
