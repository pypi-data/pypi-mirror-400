...
T = TypeVar("T", bound="UnassignGroupFromTenantResponse404")


@_attrs_define
class UnassignGroupFromTenantResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unassign_group_from_tenant_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        unassign_group_from_tenant_response_404.additional_properties = d
        return unassign_group_from_tenant_response_404
