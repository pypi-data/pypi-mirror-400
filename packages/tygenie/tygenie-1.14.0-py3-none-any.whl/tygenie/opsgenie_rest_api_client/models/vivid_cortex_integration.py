...
T = TypeVar("T", bound="VividCortexIntegration")


@_attrs_define
class VividCortexIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        vivid_cortex_integration.additional_properties = d
        return vivid_cortex_integration
