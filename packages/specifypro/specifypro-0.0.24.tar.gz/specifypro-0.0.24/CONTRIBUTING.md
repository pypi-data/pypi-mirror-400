...
Create new workflow commands like `/spp.deploy`, `/spp.test`, `/spp.docs`
...
# Test: /spp.your-command test-arguments
```
...
- [ ] Integration testing with SDD workflow (`/spp.specify` → `/spp.plan` → `/spp.tasks` → `/spp.implement` → `/spp.your-command`)
