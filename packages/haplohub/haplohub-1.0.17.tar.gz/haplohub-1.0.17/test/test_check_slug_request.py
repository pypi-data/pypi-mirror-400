...
from haplohub.models.check_slug_request import CheckSlugRequest  # noqa: E501


class TestCheckSlugRequest(unittest.TestCase):
    """CheckSlugRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckSlugRequest:
        """Test CheckSlugRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CheckSlugRequest`
        """
        model = CheckSlugRequest()  # noqa: E501
        if include_optional:
