...
from ...models.alert_assign_request import AlertAssignRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/alerts/{alert_id}/assign".format(alert_id=alert_id,),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Assign an alert to a team member.
     ...
     Assigns the specified alert to a team member for follow-up. Used by the alerts PWA for delegation
    workflows.
