...
static PyObject *
DMatrix3x3Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(double) * 9;
...
static PyMethodDef DMatrix3x3Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)DMatrix3x3Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
