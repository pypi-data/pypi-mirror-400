...
if TYPE_CHECKING:
    # fmt: off
    from ..models.ground_truth_file_model_label_map import (
        GroundTruthFileModelLabelMap,  # noqa: F401
    )
    from ..models.ground_truth_file_model_remap_labels import (
        GroundTruthFileModelRemapLabels,  # noqa: F401
    )
    from ..models.single_data_source_ingestion_request import (
        SingleDataSourceIngestionRequest,  # noqa: F401
    )
    # fmt: on


T = TypeVar("T", bound="GroundTruthFileModel")


@attrs.define
class GroundTruthFileModel:
    """
    Attributes:
        datasource (SingleDataSourceIngestionRequest):
        label_col (Union[Unset, str]):  Default: 'label'.
        label_map (Union[Unset, GroundTruthFileModelLabelMap]):
        remap_labels (Union[Unset, GroundTruthFileModelRemapLabels]):
    """

    datasource: "SingleDataSourceIngestionRequest"
    label_col: Union[Unset, str] = "label"
    label_map: Union[Unset, "GroundTruthFileModelLabelMap"] = UNSET
    remap_labels: Union[Unset, "GroundTruthFileModelRemapLabels"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        # fmt: on
        d = src_dict.copy()
        datasource = SingleDataSourceIngestionRequest.from_dict(d.pop("datasource"))
        ...
        if isinstance(_label_map, Unset):
            ...
            label_map = GroundTruthFileModelLabelMap.from_dict(_label_map)
        ...
        if isinstance(_remap_labels, Unset):
            ...
            remap_labels = GroundTruthFileModelRemapLabels.from_dict(_remap_labels)
