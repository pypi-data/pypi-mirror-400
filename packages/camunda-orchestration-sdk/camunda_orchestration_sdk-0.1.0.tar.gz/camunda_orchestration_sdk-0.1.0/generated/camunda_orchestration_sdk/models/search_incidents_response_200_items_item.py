...
if TYPE_CHECKING:
    from ..models.search_incidents_response_200_items_item_error_type import (
        SearchIncidentsResponse200ItemsItemErrorType,
    )
    from ..models.search_incidents_response_200_items_item_state import (
        SearchIncidentsResponse200ItemsItemState,
    )


T = TypeVar("T", bound="SearchIncidentsResponse200ItemsItem")


@_attrs_define
class SearchIncidentsResponse200ItemsItem:
    """
    Attributes:
        ...
        error_type (SearchIncidentsResponse200ItemsItemErrorType | Unset):
        ...
        state (SearchIncidentsResponse200ItemsItemState | Unset):
    ...
    error_type: SearchIncidentsResponse200ItemsItemErrorType | Unset = UNSET
    error_message: str | Unset = UNSET
    element_id: ElementId | Unset = UNSET
    creation_time: datetime.datetime | Unset = UNSET
    state: SearchIncidentsResponse200ItemsItemState | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_error_type, Unset):
            ...
            error_type = SearchIncidentsResponse200ItemsItemErrorType.from_dict(
                _error_type
            )
        ...
        if isinstance(_state, Unset):
            ...
            state = SearchIncidentsResponse200ItemsItemState.from_dict(_state)
        ...
        search_incidents_response_200_items_item = cls(
        ...
        search_incidents_response_200_items_item.additional_properties = d
        return search_incidents_response_200_items_item
