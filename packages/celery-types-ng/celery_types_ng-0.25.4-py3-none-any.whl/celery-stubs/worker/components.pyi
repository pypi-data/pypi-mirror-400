...
class Timer(bootsteps.Step):
    ...
    def create(self, w: Any) -> Any: ...  # ty: ignore[invalid-method-override]
...
class Hub(bootsteps.StartStopStep):
    ...
    def create(self, w: Any) -> Any: ...  # ty: ignore[invalid-method-override]
    def include_if(self, w: Any) -> bool: ...  # ty: ignore[invalid-method-override]
    def start(self, w: Any) -> None: ...  # ty: ignore[invalid-method-override]
    def stop(self, w: Any) -> None: ...  # ty: ignore[invalid-method-override]
    def terminate(self, w: Any) -> None: ...  # ty: ignore[invalid-method-override]

class Pool(bootsteps.StartStopStep):
    def __init__(
        self, w: Any, autoscale: tuple[int, int] | None = None, **kwargs: Any
    ) -> None: ...
    def close(self, w: Any) -> None: ...  # ty: ignore[invalid-method-override]
    def create(self, w: Any) -> Any: ...  # ty: ignore[invalid-method-override]
