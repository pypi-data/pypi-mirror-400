...
EEG: First Episode Psychosis vs. Control Resting Task 1 (OpenNeuro ``ds003944``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 1` :bdg-light:`License: CC0` :bdg-light:`Subjects: 82` :bdg-light:`Recordings: 82` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds003944.v1.0.1 <https://doi.org/10.18112/openneuro.ds003944.v1.0.1>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds003944>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds003944>`__
