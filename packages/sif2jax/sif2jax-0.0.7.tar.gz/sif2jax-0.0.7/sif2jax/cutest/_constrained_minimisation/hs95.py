...
class HS95(AbstractConstrainedMinimisation):
    """Hock and Schittkowski problem 95.
    ...
    def constraint(self, y):
        ...
        #     - 139.0*x1*x3 - 2450.0*x4*x5 - 16600.0*x4*x6 - 17200.0*x5*x6 >= -1.88
        c2 = (
            17.9 * x1
            + 36.8 * x2
            + 113.9 * x3
