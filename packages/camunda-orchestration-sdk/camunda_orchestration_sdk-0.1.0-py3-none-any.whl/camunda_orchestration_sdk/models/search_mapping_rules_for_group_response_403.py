...
T = TypeVar("T", bound="SearchMappingRulesForGroupResponse403")


@_attrs_define
class SearchMappingRulesForGroupResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_mapping_rules_for_group_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_mapping_rules_for_group_response_403.additional_properties = d
        return search_mapping_rules_for_group_response_403
