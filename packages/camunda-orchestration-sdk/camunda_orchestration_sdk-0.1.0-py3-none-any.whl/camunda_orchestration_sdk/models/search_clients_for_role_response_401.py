...
T = TypeVar("T", bound="SearchClientsForRoleResponse401")


@_attrs_define
class SearchClientsForRoleResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_clients_for_role_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_clients_for_role_response_401.additional_properties = d
        return search_clients_for_role_response_401
