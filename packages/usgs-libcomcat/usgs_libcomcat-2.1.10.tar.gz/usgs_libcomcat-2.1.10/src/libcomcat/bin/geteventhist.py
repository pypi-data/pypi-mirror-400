...
def get_parser():
    ...
    i_help = """Allows users to choose whether deleted products are included."""
...
def main():
    ...
    try:
        ...
        dataframe, event = get_history_data_frame(
            detail_event, products, args.include_deleted
        )
    ...
    if args.timeline:
        timeline = Timeline(
            args.timeline_block * 60, dataframe, detail_event, args.timeline_format
        )
