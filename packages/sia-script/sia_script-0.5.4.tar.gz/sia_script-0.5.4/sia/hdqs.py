...
class HDQSClient:
    ...
    def qbt_create(self, 
        ...
        # 🔧 CHANGE #1 — qbt_create must RECORD the session's active state
        resp = self.call("qbt_create", payload)
        
        # ✅ NEW: remember that a circuit now exists
    ...
    def qbt_run(self,
        ...
        # 🔧 CHANGE #2 — qbt_run must ALWAYS send state_id="current"
    ...
    def qbt_measure(self,
        ...
        Returns:
            Measurement results
        """
        # 🔧 CHANGE #3 — qbt_measure must REQUIRE a prior run
