...
setup(
    author="Fabio Massaretto",
    author_email='fabio_no_more@yahoo.com.br',
    python_requires='>=3.6',
    classifiers=[
    ...
    keywords='savify2, spotify, downloader, mp3, save, playlist',
    name='savify2',
    packages=find_packages(include=['savify', 'savify.*']),
    setup_requires=setup_requirements,
    test_suite='tests',
    tests_require=test_requirements,
    url='https://github.com/fmassaretto/savify',
    version='2.3.5',
    zip_safe=False,
)
