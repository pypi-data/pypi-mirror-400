...
class ResultResponseBool(BaseModel):
    """
    ResultResponseBool
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResultResponseBool:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResultResponseBool:
        """Create an instance of ResultResponseBool from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResultResponseBool.parse_obj(obj)

        _obj = ResultResponseBool.parse_obj(
            {"status": obj.get("status") if obj.get("status") is not None else "success", "result": obj.get("result")}
        )
        return _obj
