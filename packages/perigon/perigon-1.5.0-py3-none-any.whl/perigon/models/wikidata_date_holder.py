...
class WikidataDateHolder(BaseModel):
    """
    WikidataDateHolder
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["time", "precision"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WikidataDateHolder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WikidataDateHolder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"time": obj.get("time"), "precision": obj.get("precision")}
        )
        return _obj
