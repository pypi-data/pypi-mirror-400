...
T = TypeVar("T", bound="BMCRemedyCallback")


@_attrs_define
class BMCRemedyCallback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bmc_remedy_callback.additional_properties = d
        return bmc_remedy_callback
