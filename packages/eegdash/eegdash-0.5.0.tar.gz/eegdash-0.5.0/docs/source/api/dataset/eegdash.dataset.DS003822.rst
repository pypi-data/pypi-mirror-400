...
EEG: Probabilistic Learning with Affective Feedback: Exp #1 (OpenNeuro ``ds003822``). Access recordings and metadata through EEGDash.
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `10.18112/openneuro.ds003822.v1.1.0 <https://doi.org/10.18112/openneuro.ds003822.v1.1.0>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds003822>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds003822>`__
