...
T = TypeVar("T", bound="ServiceNowV3Integration")


@_attrs_define
class ServiceNowV3Integration:
    """
    Attributes:
        ...
        instance_subdomain (Union[Unset, str]):
    ...
    instance_subdomain: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        instance_subdomain = self.instance_subdomain
        ...
        if instance_subdomain is not UNSET:
            field_dict["instanceSubdomain"] = instance_subdomain
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        instance_subdomain = d.pop("instanceSubdomain", UNSET)

        user_id = d.pop("userId", UNSET)

        password = d.pop("password", UNSET)

        service_now_v3_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        service_now_v3_integration.additional_properties = d
        return service_now_v3_integration
