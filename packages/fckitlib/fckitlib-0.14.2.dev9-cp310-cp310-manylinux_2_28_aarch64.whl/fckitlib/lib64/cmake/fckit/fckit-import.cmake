...
if( fckit_IS_BUILD_DIR_EXPORT )
  set( FCTEST_GENERATOR /venv/build3.10/bin/python3.10 /src/fckit/tools/fctest-generate-runner.py )
  ...
  set( FCTEST_GENERATOR /venv/build3.10/bin/python3.10 ${fckit_BASE_DIR}/libexec/fctest-generate-runner.py )
endif()
