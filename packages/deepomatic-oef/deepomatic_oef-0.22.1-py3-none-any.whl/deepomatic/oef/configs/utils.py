...
def flatten_dict(nested_dict, parent_key=None):
    """
    Helper method to transform a nested dict into a flattened dict.
    Example:
        source: {'a': 1, 'c': {'a': 2, 'b': {'x': 5, 'y' : 10}}, 'd': [1, 2, 3]}
        target: {'a': 1, 'c.a': 2, 'c.b.x': 5, 'c.b.y': 10, 'd': [1, 2, 3]}
    """
    items = []
