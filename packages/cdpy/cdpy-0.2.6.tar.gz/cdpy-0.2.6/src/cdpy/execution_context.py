...
if TYPE_CHECKING:
    from cdpy.element_handle import ElementHandle  # noqa: F401
    from cdpy.frame_manager import Frame  # noqa: F401

logger = logging.getLogger(__name__)

EVALUATION_SCRIPT_URL = "__cdpy_evaluation_script__"
...
class ExecutionContext(object):
    ...
    async def queryObjects(self, prototypeHandle: "JSHandle") -> "JSHandle":
        ...
        Details see :meth:`cdpy.page.Page.queryObjects`.
        """
...
class JSHandle(object):
    ...
    with the :meth:`~cdpy.page.Page.evaluateHandle` method.
    """
