...
T = TypeVar("T", bound="SearchGroupsResponse403")


@_attrs_define
class SearchGroupsResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_groups_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_groups_response_403.additional_properties = d
        return search_groups_response_403
