...
T = TypeVar("T", bound="SearchProcessDefinitionsResponse200ItemsItem")


@_attrs_define
class SearchProcessDefinitionsResponse200ItemsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_process_definitions_response_200_items_item = cls(
            name=name,
        ...
        search_process_definitions_response_200_items_item.additional_properties = d
        return search_process_definitions_response_200_items_item
