...
class HDQSClient:
    ...
    def __init__(self, 
        ...
        # 🛠️ STEP 1 — Add session storage
        self.session_id: Optional[str] = None  # Store server session ID
    ...
    def call(self,
        ...
        # 🛠️ STEP 3 — Automatically inject session_id in call()
        # Automatically attach session_id if available
        if self.session_id:
        ...
        try:
            ...
            if "application/octet-stream" in content_type and save_to:
                ...
                return self._handle_file_response(response, save_to, op)
    ...
    def qbt_create(self, 
        ...
        # 🛠️ STEP 2 — Capture session_id in qbt_create
        # ❌ CURRENT: return self.call("qbt_create", payload)
        # ✅ CHANGE TO:
    ...
    def qbt_run(self,
        ...
        Args:
            ...
            state_id: Optional existing state ID to continue from
        ...
        if state_id:
            ...
            raise ValueError("Either state_id or num_qubits must be provided")
    ...
    def qbt_measure(self,
        ...
        Args:
            ...
            state_id: Optional state ID to measure
    ...
    def qbt_demo(self, 
        ...
        return self.call("qbt_demo", payload, save_to=save_to)
    
    def qbt_define_chunk(self,
                         state_id: str,
                         chunk_id: str,
                         qubit_indices: List[int]) -> Dict[str, Any]:
        """
        Define quantum chunk
        
        Args:
            state_id: State ID containing the circuit
    ...
    def qbt_get_chunk_features(self,
        ...
        Args:
            state_id: State ID containing the chunk
...
def analyze(state_id: str, **kwargs) -> Dict[str, Any]:
    """Analyze quantum state"""
    return call("qbt_analyze", {"state_id": state_id, **kwargs})
