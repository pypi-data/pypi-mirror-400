...
if TYPE_CHECKING:
    ...
    from ..models.dataset_response_hydrated_node_dag import (
        DatasetResponseHydratedNodeDag,  # noqa: F401
    )
    from ..models.dataset_response_node_dag import DatasetResponseNodeDag  # noqa: F401
    # fmt: on
...
class DatasetResponse:
    ...
    Attributes:
        ...
        dataset_uid (int):
        name (str):
        node_dag (DatasetResponseNodeDag):
        file_storage_config_uid (Union[Unset, int]):
        first_created (Union[Unset, datetime.date]):
        hydrated_node_dag (Union[Unset, DatasetResponseHydratedNodeDag]):
    ...
    hydrated_node_dag: Union[Unset, "DatasetResponseHydratedNodeDag"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        from ..models.dataset_response_node_dag import (
            DatasetResponseNodeDag,  # noqa: F401
        )
        # fmt: on
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        node_dag = DatasetResponseNodeDag.from_dict(d.pop("node_dag"))
        ...
        if isinstance(_hydrated_node_dag, Unset):
            ...
            hydrated_node_dag = DatasetResponseHydratedNodeDag.from_dict(
                _hydrated_node_dag
            )
