"""
Relationship indicating that an asset or component is within a specific security zone.
...
class WithinSecurityZoneRelationship(GridSTIXRelationshipObject):
    """
    Relationship indicating that an asset or component is within a specific security zone.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize WithinSecurityZoneRelationship with Grid-STIX properties."""
