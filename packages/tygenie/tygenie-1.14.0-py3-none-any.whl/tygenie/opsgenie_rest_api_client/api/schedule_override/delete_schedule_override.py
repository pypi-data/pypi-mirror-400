...
from ...models.delete_schedule_override_schedule_identifier_type import DeleteScheduleOverrideScheduleIdentifierType
...
def _get_kwargs(
    ...
    *,
    schedule_identifier_type: Union[
        Unset, DeleteScheduleOverrideScheduleIdentifierType
    ] = DeleteScheduleOverrideScheduleIdentifierType.ID,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        identifier (str):
        alias (str):
        schedule_identifier_type (Union[Unset, DeleteScheduleOverrideScheduleIdentifierType]):
            Default: DeleteScheduleOverrideScheduleIdentifierType.ID.
