...
@final
class DifferentialMotionMagicExpoVoltage:
    """
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "DifferentialMotionMagicExpoVoltage"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: DifferentialMotionMagicExpoVoltage")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlDifferentialMotionMagicExpoVoltage(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.average_position, self.differential_position, self.enable_foc, self.average_slot, self.differential_slot, self.override_brake_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.ignore_hardware_limits, self.ignore_software_limits, self.use_timesync))

    
    def with_average_position(self, new_average_position: rotation) -> 'DifferentialMotionMagicExpoVoltage':
        """
        ...
        :returns: Itself
        :rtype: DifferentialMotionMagicExpoVoltage
        """
        self.average_position = new_average_position
        return self
    
    def with_differential_position(self, new_differential_position: rotation) -> 'DifferentialMotionMagicExpoVoltage':
        """
    ...
    def with_enable_foc(self, new_enable_foc: bool) -> 'DifferentialMotionMagicExpoVoltage':
        """
    ...
    def with_average_slot(self, new_average_slot: int) -> 'DifferentialMotionMagicExpoVoltage':
        """
    ...
    def with_differential_slot(self, new_differential_slot: int) -> 'DifferentialMotionMagicExpoVoltage':
        """
    ...
    def with_override_brake_dur_neutral(self, new_override_brake_dur_neutral: bool) -> 'DifferentialMotionMagicExpoVoltage':
        """
    ...
    def with_limit_forward_motion(self, new_limit_forward_motion: bool) -> 'DifferentialMotionMagicExpoVoltage':
        """
    ...
    def with_limit_reverse_motion(self, new_limit_reverse_motion: bool) -> 'DifferentialMotionMagicExpoVoltage':
        """
    ...
    def with_ignore_hardware_limits(self, new_ignore_hardware_limits: bool) -> 'DifferentialMotionMagicExpoVoltage':
        """
    ...
    def with_ignore_software_limits(self, new_ignore_software_limits: bool) -> 'DifferentialMotionMagicExpoVoltage':
        """
    ...
    def with_use_timesync(self, new_use_timesync: bool) -> 'DifferentialMotionMagicExpoVoltage':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'DifferentialMotionMagicExpoVoltage':
        """
