...
inline
void CApad_Base::C_Attlist::SetWith(CApad_Base::C_Attlist::TWith&& value)
{
    m_With = std::forward<CApad_Base::C_Attlist::TWith>(value);
    m_set_State[0] |= 0x3;
}
...
inline
void CApad_Base::C_Attlist::SetWidth(CApad_Base::C_Attlist::TWidth&& value)
{
    m_Width = std::forward<CApad_Base::C_Attlist::TWidth>(value);
    m_set_State[0] |= 0xc;
}
