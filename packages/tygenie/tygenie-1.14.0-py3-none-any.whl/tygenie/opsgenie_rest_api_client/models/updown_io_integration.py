...
T = TypeVar("T", bound="UpdownIOIntegration")


@_attrs_define
class UpdownIOIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        updown_io_integration.additional_properties = d
        return updown_io_integration
