...
T = TypeVar("T", bound="SearchRolesDataFilter")


@_attrs_define
class SearchRolesDataFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_roles_data_filter = cls(
            role_id=role_id,
            name=name,
        )

        search_roles_data_filter.additional_properties = d
        return search_roles_data_filter
