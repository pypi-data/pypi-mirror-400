...
T = TypeVar("T", bound="CancelProcessInstanceResponse400")


@_attrs_define
class CancelProcessInstanceResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancel_process_instance_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        cancel_process_instance_response_400.additional_properties = d
        return cancel_process_instance_response_400
