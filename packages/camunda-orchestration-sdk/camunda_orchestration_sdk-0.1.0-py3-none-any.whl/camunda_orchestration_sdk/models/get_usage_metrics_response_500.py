...
T = TypeVar("T", bound="GetUsageMetricsResponse500")


@_attrs_define
class GetUsageMetricsResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_usage_metrics_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_usage_metrics_response_500.additional_properties = d
        return get_usage_metrics_response_500
