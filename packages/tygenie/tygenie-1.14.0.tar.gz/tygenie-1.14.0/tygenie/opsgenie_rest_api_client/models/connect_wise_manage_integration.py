...
T = TypeVar("T", bound="ConnectWiseManageIntegration")


@_attrs_define
class ConnectWiseManageIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        connect_wise_manage_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        connect_wise_manage_integration.additional_properties = d
        return connect_wise_manage_integration
