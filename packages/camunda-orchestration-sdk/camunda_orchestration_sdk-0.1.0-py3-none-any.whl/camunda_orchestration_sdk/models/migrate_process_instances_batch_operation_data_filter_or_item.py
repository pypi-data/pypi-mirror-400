...
if TYPE_CHECKING:
    ...
    from ..models.migrate_process_instances_batch_operation_data_filter_or_item_variables_item import (
...
T = TypeVar("T", bound="MigrateProcessInstancesBatchOperationDataFilterOrItem")


@_attrs_define
class MigrateProcessInstancesBatchOperationDataFilterOrItem:
    ...
    Attributes:
        ...
        variables (list[MigrateProcessInstancesBatchOperationDataFilterOrItemVariablesItem] | Unset): The process
            instance variables.
    ...
    variables: (
        list[MigrateProcessInstancesBatchOperationDataFilterOrItemVariablesItem] | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        variables: (
            list[MigrateProcessInstancesBatchOperationDataFilterOrItemVariablesItem]
            | Unset
        ) = UNSET
        if _variables is not UNSET:
            variables = []
            for variables_item_data in _variables:
                variables_item = MigrateProcessInstancesBatchOperationDataFilterOrItemVariablesItem.from_dict(
                    variables_item_data
                )
        ...
        migrate_process_instances_batch_operation_data_filter_or_item = cls(
        ...
        migrate_process_instances_batch_operation_data_filter_or_item.additional_properties = d
        return migrate_process_instances_batch_operation_data_filter_or_item
