...
T = TypeVar("T", bound="MonitisEmailIntegration")


@_attrs_define
class MonitisEmailIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        monitis_email_integration.additional_properties = d
        return monitis_email_integration
