...
T = TypeVar("T", bound="GetUserTaskFormResponse401")


@_attrs_define
class GetUserTaskFormResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_user_task_form_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_user_task_form_response_401.additional_properties = d
        return get_user_task_form_response_401
