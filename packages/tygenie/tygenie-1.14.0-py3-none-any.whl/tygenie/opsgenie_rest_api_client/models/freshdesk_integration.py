...
T = TypeVar("T", bound="FreshdeskIntegration")
...
class FreshdeskIntegration:
    ...
    Attributes:
        ...
        freshdesk_subdomain (Union[Unset, str]):
    """
    ...
    freshdesk_subdomain: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        freshdesk_subdomain = self.freshdesk_subdomain
        ...
        if freshdesk_subdomain is not UNSET:
            field_dict["freshdeskSubdomain"] = freshdesk_subdomain
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        freshdesk_subdomain = d.pop("freshdeskSubdomain", UNSET)

        freshdesk_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        freshdesk_integration.additional_properties = d
        return freshdesk_integration
