...
from buddy.api.schemas.user import TeamSchema
from buddy.api.schemas.workspace import WorkspaceSchema
from buddy.infra.base import InfraBase
from buddy.infra.resources import InfraResources
from buddy.utils.log import logger
from buddy.workspace.settings import WorkspaceSettings
...
class WorkspaceConfig(BaseModel):
    """The WorkspaceConfig holds the configuration for an Buddy workspace."""
    ...
    def workspace_settings(self) -> Optional[WorkspaceSettings]:
        ...
        try:
            from buddy.utils.py_io import get_python_objects_from_module
