...
T = TypeVar("T", bound="UpdateKeyBindingRequestDto")


@_attrs_define
class UpdateKeyBindingRequestDto:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_key_binding_request_dto = cls(
            provider_id=provider_id,
        )

        update_key_binding_request_dto.additional_properties = d
        return update_key_binding_request_dto
