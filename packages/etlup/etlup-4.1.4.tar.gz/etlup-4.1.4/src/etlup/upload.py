...
def get_sequence_model(version: str, constr_type: str):
    try:
        return SequenceModel.core_schema['schema']['choices'][version]['choices'][constr_type]["cls"]
    except KeyError:  # this only for the case for no versions, pydantic simplies the map
        return SequenceModel.core_schema['schema']['choices'][constr_type]["cls"]
