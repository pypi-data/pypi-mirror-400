...
T = TypeVar("T", bound="NagiosIntegrationV1")


@_attrs_define
class NagiosIntegrationV1:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nagios_integration_v1.additional_properties = d
        return nagios_integration_v1
