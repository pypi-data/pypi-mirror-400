...
from ...models.un_acknowledge_alert_identifier_type import (
...
def _get_kwargs(
    ...
    *,
    ...
    identifier_type: Union[
        Unset, UnAcknowledgeAlertIdentifierType
    ] = UnAcknowledgeAlertIdentifierType.ID,
) -> Dict[str, Any]:
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": f"/v2/alerts/{identifier}/unacknowledge",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        identifier (str):
        identifier_type (Union[Unset, UnAcknowledgeAlertIdentifierType]):  Default:
            UnAcknowledgeAlertIdentifierType.ID.
        body (AlertActionPayload):
