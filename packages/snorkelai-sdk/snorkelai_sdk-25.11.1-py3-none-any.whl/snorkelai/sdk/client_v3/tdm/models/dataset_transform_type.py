...
class DatasetTransformType(StrEnum):
    ANNOTATION_TASK_ANNOTATOR_AGREEMENT_FILTER = (
        "annotation_task_annotator_agreement_filter"
    )
    ANNOTATION_TASK_ANNOTATOR_FILTER = "annotation_task_annotator_filter"
    ANNOTATION_TASK_ANNOTATOR_STATUS_FILTER = "annotation_task_annotator_status_filter"
    ANNOTATION_TASK_COMMENT_FILTER = "annotation_task_comment_filter"
    ANNOTATION_TASK_DATA_POINT_STATUS_FILTER = (
        "annotation_task_data_point_status_filter"
    )
    ANNOTATION_TASK_FIELD_FILTER = "annotation_task_field_filter"
    ANNOTATION_TASK_SLICE_FILTER = "annotation_task_slice_filter"
