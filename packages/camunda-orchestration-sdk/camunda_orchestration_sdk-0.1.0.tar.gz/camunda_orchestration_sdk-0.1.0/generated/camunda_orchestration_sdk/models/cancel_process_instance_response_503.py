...
T = TypeVar("T", bound="CancelProcessInstanceResponse503")


@_attrs_define
class CancelProcessInstanceResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancel_process_instance_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        cancel_process_instance_response_503.additional_properties = d
        return cancel_process_instance_response_503
