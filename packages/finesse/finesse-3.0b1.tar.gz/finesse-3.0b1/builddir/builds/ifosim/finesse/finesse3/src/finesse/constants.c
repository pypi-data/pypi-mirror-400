...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "include_dirs": [
            ...
            "/tmp/build-env-zqe08kzb/lib/python3.14/site-packages/numpy/_core/include",
            "/usr/include/suitesparse",
            "/tmp/build-env-zqe08kzb/include"
        ],
        "language": "c",
        "library_dirs": [
            "/tmp/build-env-zqe08kzb/lib"
        ],
...
#define __pyx_kp_u_PI_C_LIGHT_RAD2DEG_DEG2RAD_H_PLA __pyx_string_tab[1]
#define __pyx_kp_u__2 __pyx_string_tab[2]
#define __pyx_n_u_Constants __pyx_string_tab[3]
...
#define __pyx_n_u_values __pyx_string_tab[13]
...
*/
  __pyx_t_4 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_namedtuple); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_mstate_global->__pyx_tuple[0], NULL); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyFloat_FromDouble(PI); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_7 = PyFloat_FromDouble(C_LIGHT); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_8 = PyFloat_FromDouble(RAD2DEG); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_9 = PyFloat_FromDouble(DEG2RAD); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_10 = PyFloat_FromDouble(H_PLANCK); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
  __pyx_t_11 = 1;
  {
    PyObject *__pyx_callargs[6] = {__pyx_t_4, __pyx_t_5, __pyx_t_7, __pyx_t_8, __pyx_t_9, __pyx_t_10};
    __pyx_t_2 = __Pyx_PyObject_FastCall((PyObject*)__pyx_t_6, __pyx_callargs+__pyx_t_11, (6-__pyx_t_11) | (__pyx_t_11*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET));
  ...
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_values, __pyx_t_2) < (0)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{35},{1},{9},{18},{11},{8},{10},{8},{10},{12},{10},{8},{6}};
    #if (CYTHON_COMPRESS_STRINGS) == 3 && __PYX_LIMITED_VERSION_HEX >= 0x030e0000 /* compression: zstd (127 bytes) */
const char* const cstring = "(\265/\375 \223\265\003\000\242\207\030\027po\003\024\262^\366\256\312hB\005Z\003\305M\360\313\376\275\3727!\222go%\371U\277\347>\354<\313\3369I\363\035\216\326UU\271\247\023U\035n\244*=\302\177\334\035\037\364\266\341\267\324\253Ce\207\375\344\373\276\364\330\204\243%\014Q\264X\216-\301\"\006\0278\266,\246 \014D\3332\024 \006\000/\2509'\337\014D\312\360\371\005 \300e\002";
    PyObject *data = __Pyx_DecompressString(cstring, 127, 3);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (125 bytes) */
const char* const cstring = "x\332%\212Q\n\3020\020D\257\222\023\370\321\013HI\245-\026)\342\377\262&+\0047\211u7\236\337-\035\230\34113\247uv\036\226y\234\036\356\336\017\335p\031\235\2713v\023\254K\177\363\327\263\257E\024\213J\340T\010R\001\375b\240'\206w\250\314\0244\331\003 \243M\246\\cc\332\251`\246#\243\266\317\336m\r\371h\2054\322\013\033+\200\222X\376\220\033\311\037\223\2676\213";
    PyObject *data = __Pyx_DecompressString(cstring, 125, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (147 bytes) */
const char* const bytes = ".PI C_LIGHT RAD2DEG DEG2RAD H_PLANCK?Constantscline_in_tracebackcollections__main____module____name__namedtuple__qualname__setdefault__test__values";
    PyObject *data = NULL;
