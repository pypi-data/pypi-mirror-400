...
from haplohub.models.cli_schema import CliSchema  # noqa: E501


class TestCliSchema(unittest.TestCase):
    """CliSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CliSchema:
        """Test CliSchema
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CliSchema`
        """
        model = CliSchema()  # noqa: E501
        if include_optional:
            return CliSchema(
                auth_domain = '',
                auth_client_id = '',
