...
T = TypeVar("T", bound="UpdateGroupResponse503")


@_attrs_define
class UpdateGroupResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_group_response_503.additional_properties = d
        return update_group_response_503
