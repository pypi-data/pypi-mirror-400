...
# The import_attribute function is from rq
...
def import_attribute(name: str) -> Callable[..., Any]:
    ...
    if module is None:
        ...
        try:
            ...
            raise ValueError(f"Invalid attribute name: {name}")  # noqa
    ...
    try:
        ...
        raise ValueError("Invalid attribute name: %s" % attribute_name)  # noqa
