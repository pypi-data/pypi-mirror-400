...
@_attrs_define
class GetAuthenticationResponse200TenantsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_authentication_response_200_tenants_item = cls(
            name=name,
            tenant_id=tenant_id,
            description=description,
        )

        get_authentication_response_200_tenants_item.additional_properties = d
        return get_authentication_response_200_tenants_item
