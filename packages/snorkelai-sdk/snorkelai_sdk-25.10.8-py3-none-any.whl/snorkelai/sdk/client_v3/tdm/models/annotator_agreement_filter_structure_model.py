...
T = TypeVar("T", bound="AnnotatorAgreementFilterStructureModel")


@attrs.define
class AnnotatorAgreementFilterStructureModel:
    """A wrapper around data returned to the FE to render a Annotator Agreement Filter options.

    Attributes:
        annotators (List['OptionModel']):
        description (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for annotators_item_data in _annotators:
            annotators_item = OptionModel.from_dict(annotators_item_data)
