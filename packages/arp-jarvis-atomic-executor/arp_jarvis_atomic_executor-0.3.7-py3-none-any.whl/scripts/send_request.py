...
def main() -> int:
    parser = argparse.ArgumentParser(description="Execute an atomic NodeRun from a JSON file.")
    ...
    result = _request("POST", f"{base_url}/atomic-node-runs:execute", body, headers)
