...
class JobMessage(BaseModel):
    ...
    log_file: StrictStr | None = None
    namespace: StrictStr | None = None
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["job_name", "log_file", "namespace"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {"job_name": obj.get("job_name"), "log_file": obj.get("log_file"), "namespace": obj.get("namespace")}
        )
