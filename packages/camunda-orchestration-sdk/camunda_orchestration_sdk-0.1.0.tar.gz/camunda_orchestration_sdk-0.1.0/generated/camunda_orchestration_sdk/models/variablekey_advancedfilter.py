...
T = TypeVar("T", bound="VariablekeyAdvancedfilter")


@_attrs_define
class VariablekeyAdvancedfilter:
    """Advanced VariableKey filter.

    Attributes:
        eq (str | Unset): Checks for equality with the provided value. Example: 2251799813683287.
        neq (str | Unset): Checks for inequality with the provided value. Example: 2251799813683287.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        variablekey_advancedfilter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        variablekey_advancedfilter.additional_properties = d
        return variablekey_advancedfilter
