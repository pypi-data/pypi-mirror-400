...
T = TypeVar("T", bound="DeleteRoleResponse500")


@_attrs_define
class DeleteRoleResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_role_response_500.additional_properties = d
        return delete_role_response_500
