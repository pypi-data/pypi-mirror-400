...
class StatusCode(Enum):
    ...
    """
    The given network/CAN bus is invalid. Verify that any status signals provided
    are on the same network and that the network is present.
    """
    ...
    """
    The schema for the logged user signal is invalid or missing. Ensure that the
    schema is written before the user signal.
    """
    ...
    def name(self) -> str:
        ...
        if False:
            ...
            return "ONLY_SUPPORTED_IN_TUNER_X"
        elif self.value == -145:
            ...
            return "NOT_ALL_PID_VALUES_UPDATED"
            ...
            return "CONFIG_MOTION_S_CURVE_REQUIRES_HIGHER_FIRM"
        elif self.value == -1704:
            return "TALON_FX_FIRMWARE_PRE_V_BAT_DETECT"
    ...
    def description(self) -> str:
        ...
        if False:
            ...
            return "The given network/CAN bus is invalid. Verify that any status signals provided are on the same network and that the network is present."
        elif self.value == -10002:
            ...
            return "The schema for the logged user signal is invalid or missing. Ensure that the schema is written before the user signal."
        else:
            return f"Status Code {self.value}"
