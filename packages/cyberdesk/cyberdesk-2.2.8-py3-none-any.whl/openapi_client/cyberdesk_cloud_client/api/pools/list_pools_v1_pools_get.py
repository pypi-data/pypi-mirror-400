...
) -> HTTPValidationError | PaginatedResponsePoolResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | PaginatedResponsePoolResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | PaginatedResponsePoolResponse
    """
