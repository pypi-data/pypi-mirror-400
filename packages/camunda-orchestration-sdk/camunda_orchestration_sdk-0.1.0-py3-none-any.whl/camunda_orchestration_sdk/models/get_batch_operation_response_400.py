...
T = TypeVar("T", bound="GetBatchOperationResponse400")


@_attrs_define
class GetBatchOperationResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_batch_operation_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_batch_operation_response_400.additional_properties = d
        return get_batch_operation_response_400
