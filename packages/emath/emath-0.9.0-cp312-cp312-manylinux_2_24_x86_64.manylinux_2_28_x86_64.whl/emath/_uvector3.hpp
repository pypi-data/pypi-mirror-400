...
static PyObject *
UVector3Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(unsigned int) * 3;
...
static PyMethodDef UVector3Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)UVector3Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
