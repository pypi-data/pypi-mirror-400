...
class ContactsSearch200ResponseMeta(BaseModel):
    """
    Information about search criteria and total results count
    """ # noqa: E501
    page: Optional[ContactsSearch200ResponseMetaPage] = None
    search: Optional[ContactsSearch200ResponseMetaSearch] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "page": ContactsSearch200ResponseMetaPage.from_dict(obj["page"]) if obj.get("page") is not None else None,
            "search": ContactsSearch200ResponseMetaSearch.from_dict(obj["search"]) if obj.get("search") is not None else None
        })
        return _obj
