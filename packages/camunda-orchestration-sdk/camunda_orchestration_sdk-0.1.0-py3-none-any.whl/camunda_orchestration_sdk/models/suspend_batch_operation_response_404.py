...
T = TypeVar("T", bound="SuspendBatchOperationResponse404")


@_attrs_define
class SuspendBatchOperationResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        suspend_batch_operation_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        suspend_batch_operation_response_404.additional_properties = d
        return suspend_batch_operation_response_404
