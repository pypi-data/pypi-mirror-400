...
def build_entity(world, var_name=None, size=None, _type=None, color=None, material=None, location=None,
    ...
    """ Creates an Entity instance and initializes it with the properties given above. If the location is provided,
        the entity is added to the :attr:`location.objects <pydialogue.environment.entities.Entity.objects>` field.
    """
...
def build_place(world, var_name, size=None, _type=None, color=None, material=None, location=None):
    ...
    if location is None:
        ...
        place.properties['location'] = location
    place.prop_seen['location'] = place.properties['location']
...
def build_bed(world, var_name, size=None, color=None, material=None, location=None):
    ...
    bed.attributes[('hollow', 'under')] = None
...
def build_table(world, var_name, size=None, color=None, material=None, location=None):
    ...
    table.attributes[('hollow', 'under')] = None
