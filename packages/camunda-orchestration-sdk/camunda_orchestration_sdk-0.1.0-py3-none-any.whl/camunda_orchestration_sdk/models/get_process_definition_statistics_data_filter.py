...
if TYPE_CHECKING:
    ...
    from ..models.get_process_definition_statistics_data_filter_or_item import (
        GetProcessDefinitionStatisticsDataFilterOrItem,
    )
    from ..models.get_process_definition_statistics_data_filter_variables_item import (
...
T = TypeVar("T", bound="GetProcessDefinitionStatisticsDataFilter")


@_attrs_define
class GetProcessDefinitionStatisticsDataFilter:
    ...
    Attributes:
        ...
        variables (list[GetProcessDefinitionStatisticsDataFilterVariablesItem] | Unset): The process instance variables.
        ...
        or_ (list[GetProcessDefinitionStatisticsDataFilterOrItem] | Unset): Defines a list of alternative filter groups
            combined using OR logic. Each object in the array is evaluated independently, and the filter matches if any one
    ...
    variables: list[GetProcessDefinitionStatisticsDataFilterVariablesItem] | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        variables: (
            list[GetProcessDefinitionStatisticsDataFilterVariablesItem] | Unset
        ) = UNSET
        if _variables is not UNSET:
            variables = []
            for variables_item_data in _variables:
                variables_item = (
                    GetProcessDefinitionStatisticsDataFilterVariablesItem.from_dict(
                        variables_item_data
                    )
                )
        ...
        if _or_ is not UNSET:
            ...
            for or_item_data in _or_:
                or_item = GetProcessDefinitionStatisticsDataFilterOrItem.from_dict(
                    or_item_data
                )

                or_.append(or_item)

        get_process_definition_statistics_data_filter = cls(
        ...
        get_process_definition_statistics_data_filter.additional_properties = d
        return get_process_definition_statistics_data_filter
