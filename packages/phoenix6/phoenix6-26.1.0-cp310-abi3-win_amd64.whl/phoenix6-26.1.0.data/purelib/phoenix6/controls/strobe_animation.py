...
class StrobeAnimation:
    ...
    :param frame_rate: The frame rate of the animation, from [1, 500] Hz. This
    ...
    def __init__(self, led_start_index: int, led_end_index: int, slot: int = 0, color: RGBWColor = RGBWColor(), frame_rate: hertz = 4):
        ...
        """
        The frame rate of the animation, from [1, 500] Hz. This determines the speed of
        the animation.
        
        A frame is defined as a transition in the state of the LEDs, turning all LEDs on
        or off.
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: StrobeAnimation")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlStrobeAnimation(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.led_start_index, self.led_end_index, self.slot, self.color.red, self.color.green, self.color.blue, self.color.white, self.frame_rate))

    
    def with_led_start_index(self, new_led_start_index: int) -> 'StrobeAnimation':
        """
        ...
        :returns: Itself
        :rtype: StrobeAnimation
        """
        self.led_start_index = new_led_start_index
        return self
    
    def with_led_end_index(self, new_led_end_index: int) -> 'StrobeAnimation':
        """
    ...
    def with_slot(self, new_slot: int) -> 'StrobeAnimation':
        """
    ...
    def with_color(self, new_color: RGBWColor) -> 'StrobeAnimation':
        """
    ...
    def with_frame_rate(self, new_frame_rate: hertz) -> 'StrobeAnimation':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'StrobeAnimation':
        """
