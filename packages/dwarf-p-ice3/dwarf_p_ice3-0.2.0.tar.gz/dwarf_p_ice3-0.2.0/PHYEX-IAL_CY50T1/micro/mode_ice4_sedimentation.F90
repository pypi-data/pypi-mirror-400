...
!
!
IF (BUCONF%LBUDGET_RC .AND. PARAMI%LSEDIC) CALL TBUDGETS(NBUDGET_RC)%PTR%INIT_PHY(D, 'SEDI', PRCS(:, :) * PRHODJ(:, :))
...
IF (BUCONF%LBUDGET_RH .AND. KRR==7) CALL TBUDGETS(NBUDGET_RH)%PTR%INIT_PHY(D, 'SEDI', PRHS(:, :) * PRHODJ(:, :))
!
! budget of electric charges
IF (BUCONF%LBUDGET_SV .AND. OELEC) THEN
  IF (PARAMI%LSEDIC) CALL TBUDGETS(NBUDGET_SV1-1+NSV_ELECBEG+1)%PTR%INIT_PHY(D, 'SEDI', PQCS(:, :) * PRHODJ(:, :))
  CALL TBUDGETS(NBUDGET_SV1-1+NSV_ELECBEG+2)%PTR%INIT_PHY(D, 'SEDI', PQRS(:, :) * PRHODJ(:, :))
  CALL TBUDGETS(NBUDGET_SV1-1+NSV_ELECBEG+3)%PTR%INIT_PHY(D, 'SEDI', PQIS(:, :) * PRHODJ(:, :))
  CALL TBUDGETS(NBUDGET_SV1-1+NSV_ELECBEG+4)%PTR%INIT_PHY(D, 'SEDI', PQSS(:, :) * PRHODJ(:, :))
  CALL TBUDGETS(NBUDGET_SV1-1+NSV_ELECBEG+5)%PTR%INIT_PHY(D, 'SEDI', PQGS(:, :) * PRHODJ(:, :))
  IF (KRR == 7)      CALL TBUDGETS(NBUDGET_SV1-1+NSV_ELECBEG+6)%PTR%INIT_PHY(D, 'SEDI', PQHS(:, :) * PRHODJ(:, :))
END IF
!
...
!
!
IF (BUCONF%LBUDGET_RC .AND. PARAMI%LSEDIC) CALL TBUDGETS(NBUDGET_RC)%PTR%END_PHY(D, 'SEDI', PRCS(:, :) * PRHODJ(:, :))
...
IF (BUCONF%LBUDGET_RH .AND. KRR==7) CALL TBUDGETS(NBUDGET_RH)%PTR%END_PHY(D, 'SEDI', PRHS(:, :) * PRHODJ(:, :))
!
! Budget for electric charges
IF (BUCONF%LBUDGET_SV .AND. OELEC) THEN
  IF (PARAMI%LSEDIC) CALL TBUDGETS(NBUDGET_SV1-1+NSV_ELECBEG+1)%PTR%END_PHY(D, 'SEDI', PQCS(:, :) * PRHODJ(:, :))
  CALL TBUDGETS(NBUDGET_SV1-1+NSV_ELECBEG+2)%PTR%END_PHY(D, 'SEDI', PQRS(:, :) * PRHODJ(:, :))
  CALL TBUDGETS(NBUDGET_SV1-1+NSV_ELECBEG+3)%PTR%END_PHY(D, 'SEDI', PQIS(:, :) * PRHODJ(:, :))
  CALL TBUDGETS(NBUDGET_SV1-1+NSV_ELECBEG+4)%PTR%END_PHY(D, 'SEDI', PQSS(:, :) * PRHODJ(:, :))
  CALL TBUDGETS(NBUDGET_SV1-1+NSV_ELECBEG+5)%PTR%END_PHY(D, 'SEDI', PQGS(:, :) * PRHODJ(:, :))
  IF (KRR == 7)      CALL TBUDGETS(NBUDGET_SV1-1+NSV_ELECBEG+6)%PTR%END_PHY(D, 'SEDI', PQHS(:, :) * PRHODJ(:, :))
END IF
!
