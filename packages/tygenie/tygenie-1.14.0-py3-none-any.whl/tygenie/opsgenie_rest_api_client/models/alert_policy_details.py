...
T = TypeVar("T", bound="AlertPolicyDetails")


@_attrs_define
class AlertPolicyDetails:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        alert_policy_details = cls()

        alert_policy_details.additional_properties = d
        return alert_policy_details
