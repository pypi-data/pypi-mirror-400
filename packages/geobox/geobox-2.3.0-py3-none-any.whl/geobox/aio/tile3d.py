...
class AsyncTile3d(AsyncBase):
    ...
    @classmethod
    async def get_3dtiles(cls, api: 'AsyncGeoboxClient', **kwargs) -> Union[List['AsyncTile3d'], int]:
        """
        ...
        return await super()._get_list(api, cls.BASE_ENDPOINT, params, factory_func=lambda api, item: AsyncTile3d(api, item['uuid'], item))
    

    @classmethod
    async def get_3dtile(cls, api: 'AsyncGeoboxClient', uuid: str, user_id: int = None) -> 'AsyncTile3d':
        """
        ...
        return await super()._get_detail(api, cls.BASE_ENDPOINT, uuid, params, factory_func=lambda api, item: AsyncTile3d(api, item['uuid'], item))


    @classmethod
    async def get_3dtile_by_name(cls, api: 'AsyncGeoboxClient', name: str, user_id: int = None) -> Union['AsyncTile3d', None]:
        """
