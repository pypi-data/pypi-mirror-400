"""
General role representing any individual or organization that interacts with or maintains DER components.
...
class DerUser(GridSTIXDomainObject):
    """
    General role representing any individual or organization that interacts with or maintains DER components.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize DerUser with Grid-STIX properties."""
