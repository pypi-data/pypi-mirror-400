...
from crimsy.openapi import get_openapi_route, get_scalar_ui_route, get_swagger_ui_route
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            docs_url: URL path for Scalar UI documentation
            swagger_url: URL path for Swagger UI documentation
        """
        self.title = title
        ...
        if swagger_url and openapi_url:
            routes.append(get_swagger_ui_route(self, swagger_url, openapi_url))
