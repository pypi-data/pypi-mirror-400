...
T = TypeVar("T", bound="SearchMessageSubscriptionsDataFilter")


@_attrs_define
class SearchMessageSubscriptionsDataFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_message_subscriptions_data_filter = cls(
        ...
        search_message_subscriptions_data_filter.additional_properties = d
        return search_message_subscriptions_data_filter
