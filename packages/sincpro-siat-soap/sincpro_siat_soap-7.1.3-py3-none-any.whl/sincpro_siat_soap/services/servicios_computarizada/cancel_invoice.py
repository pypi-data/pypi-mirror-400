...
class CommandInvoiceCancelComputarizada(DataTransferObject):
    nit: int | str
    cuis: str
    cufd: str
    cuf: str
...
class ResponseInvoiceCancelComputarizada(DataTransferObject):
    transaction: bool
    raw_response: Any


@siat_soap_sdk.feature(CommandInvoiceCancelComputarizada)
class InvoiceCancellationRequest(Feature):

    def execute(
        self, dto: CommandInvoiceCancelComputarizada
        ...
        return ResponseInvoiceCancelComputarizada(
