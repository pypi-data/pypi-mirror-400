...
>>>
>>> # Simple smoothing
>>> result = fastloess.smooth(x, y, fraction=0.5)
>>> print(result.y)
[2.   4.1  5.9  8.2  9.8]

**Full-Featured LOESS:**

>>> result = fastloess.smooth(
...     x, y,
...     fraction=0.5,
...     iterations=3,
...
smooth(x, y, fraction=0.67, iterations=3, weight_function="tricube",
    ...
    **Parameters**
    ...
    weight_function : str, optional
        ...
        - "tricube" (default): Classic LOESS kernel
    ...
    **Examples**
    ...
    >>> result = fastloess.smooth(x, y)
    >>> result.y  # smoothed values

    Using quadratic polynomial with custom distance metric:
    >>> result = fastloess.smooth(x, y, polynomial_degree='quadratic', distance_metric='euclidean')

smooth_streaming(x, y, fraction=0.3, chunk_size=5000, overlap=500,
    ...
    **Parameters**
    ...
    merge_strategy : str, optional
        Strategy for merging overlapping chunks: "average" (default),
        "weighted_average", "take_first", "take_last".
    zero_weight_fallback : str, optional
    ...
    **Examples**
    ...
    >>> result = fastloess.smooth_streaming(x, y, chunk_size=10000)


smooth_online(x, y, fraction=0.2, window_capacity=1000, min_points=3,
    iterations=3, weight_function="tricube",
    robustness_method="bisquare", scaling_method="mad", boundary_policy="extend",
    update_mode="incremental", auto_converge=None,
    ...
    **Parameters**
    ...
    window_capacity : int, optional
        Maximum points to retain in window. Default: 1000.
    ...
    **Examples**
    ...
    >>> result = fastloess.smooth_online(x, y, window_capacity=50)
...
LoessResult
    ...
    **Examples**
    >>> result = fastloess.smooth(x, y, confidence_intervals=0.95)
...
Diagnostics
    ...
    **Examples**
    >>> result = fastloess.smooth(x, y, return_diagnostics=True)
...
2. Use interpolation surface mode for very large datasets (>10,000 points)
...
Version Information
-------------------
This package is built on top of the fastLoess Rust crate, providing
parallel LOESS smoothing with NumPy integration.
"""

# Import from native extension
from .fastloess import (
    smooth,
    smooth_streaming,
    smooth_online,
    LoessResult,
