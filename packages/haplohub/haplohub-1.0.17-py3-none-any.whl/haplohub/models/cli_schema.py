...
class CliSchema(BaseModel):
    ...
    auth_domain: StrictStr = Field(...)
    auth_client_id: StrictStr = Field(...)
    auth_audience: StrictStr = Field(...)
    __properties = ["auth_domain", "auth_client_id", "auth_audience"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CliSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CliSchema:
        """Create an instance of CliSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CliSchema.parse_obj(obj)

        _obj = CliSchema.parse_obj(
            {
