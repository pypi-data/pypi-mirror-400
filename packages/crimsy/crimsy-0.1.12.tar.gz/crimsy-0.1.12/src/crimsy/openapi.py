...
def get_swagger_ui_route(app: Any, swagger_path: str, openapi_path: str) -> Route:
    ...
    return Route(swagger_path, swagger_ui_handler, methods=["GET"])
