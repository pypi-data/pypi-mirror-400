...
from loracode import __version__, urls, utils
from loracode.dump import dump  # noqa: F401

loracode_user_agent = f"LoraCode/{__version__} +{urls.website}"
...
def install_playwright(io):
    ...
    pip_cmd = utils.get_pip_install(["loracode[playwright]"])
...
class Scraper:
    ...
    def scrape_with_playwright(self, url):
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                user_agent = user_agent.replace("headless", "")
                user_agent += " " + loracode_user_agent
    ...
    def scrape_with_httpx(self, url):
        ...
        headers = {"User-Agent": f"Mozilla./5.0 ({loracode_user_agent})"}
        try:
            with httpx.Client(
