...
class World:
    ...
    change_action_properties : list
        ...
        :func:`actions.change() <pydialogue.environment.actions.change>` function.
    ...
    def __init__(self, obj_list=None, undo_changes=None, change_action_properties=None,
                 all_description_objects=None, location_positions=None, random_seed=None, init=True):
        if random_seed is None:
            random_seed = random.randrange(1_000_000_000)
        ...
        if all_description_objects is None:
            self.all_description_objects = [descriptions.BaseDescription(random_gen=self.random_gen,
                                                                         cand_elements=['material',
                                                                                        'size',
                                                                                        'color',
                                                                                        'type']),
                                            descriptions.BaseDescription(random_gen=self.random_gen,
                                                                         cand_elements=['material',
                                                                                        'size',
                                                                                        'color',
                                                                                        'container',
    ...
    def save_state(self):
        ...
        return len(self.undo_changes), self.random_gen.getstate()
    ...
    def recover_state(self, state):
        ...
        self.random_gen.setstate(state[1])
