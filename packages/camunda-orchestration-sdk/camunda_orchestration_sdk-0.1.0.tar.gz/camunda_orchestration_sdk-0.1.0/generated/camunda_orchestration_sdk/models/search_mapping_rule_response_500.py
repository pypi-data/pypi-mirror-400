...
T = TypeVar("T", bound="SearchMappingRuleResponse500")


@_attrs_define
class SearchMappingRuleResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_mapping_rule_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_mapping_rule_response_500.additional_properties = d
        return search_mapping_rule_response_500
