...
static PyObject *
I16Vector1Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(int16_t) * 1;
...
static PyMethodDef I16Vector1Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)I16Vector1Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
