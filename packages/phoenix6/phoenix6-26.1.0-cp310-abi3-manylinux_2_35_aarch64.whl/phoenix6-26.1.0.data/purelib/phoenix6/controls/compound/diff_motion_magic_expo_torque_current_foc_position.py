...
@final
class Diff_MotionMagicExpoTorqueCurrentFOC_Position:
    """
    ...
    def __init__(self, average_request: MotionMagicExpoTorqueCurrentFOC, differential_request: PositionTorqueCurrentFOC):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_MotionMagicExpoTorqueCurrentFOC_Position"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicExpoTorqueCurrentFOC_Position")
    ...
    def with_average_request(self, new_average_request: MotionMagicExpoTorqueCurrentFOC) -> 'Diff_MotionMagicExpoTorqueCurrentFOC_Position':
        ...
        :returns: Itself
        :rtype: Diff_MotionMagicExpoTorqueCurrentFOC_Position
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: PositionTorqueCurrentFOC) -> 'Diff_MotionMagicExpoTorqueCurrentFOC_Position':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicExpoTorqueCurrentFOC_Position':
        """
