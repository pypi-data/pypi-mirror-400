...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Any | ListMetricsDataAndMetricIDOutput | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Any | ListMetricsDataAndMetricIDOutput]:
    return Response(
...
) -> Response[Any | ListMetricsDataAndMetricIDOutput]:
...
def sync(
    ...
    *,
...
) -> Any | ListMetricsDataAndMetricIDOutput | None:
    """  Returns the metrics data associated with given metric ID(s)
    ...
    Returns:
        Any | ListMetricsDataAndMetricIDOutput
     """
