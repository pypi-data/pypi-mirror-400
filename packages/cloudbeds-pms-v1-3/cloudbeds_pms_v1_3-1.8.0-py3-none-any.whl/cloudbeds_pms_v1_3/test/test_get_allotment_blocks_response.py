    ...
    def make_instance(self, include_optional) -> GetAllotmentBlocksResponse:
        ...
        if include_optional:
            return GetAllotmentBlocksResponse(
                ...
                total = 56,
                data = [
                    cloudbeds_pms_v1_3.models.get_allotment_blocks_response_data_inner.GetAllotmentBlocksResponse_data_inner(
                        property_id = '', 
                        ...
                        allotment_intervals = [
                            cloudbeds_pms_v1_3.models.get_allotment_blocks_response_data_inner_allotment_intervals_inner.GetAllotmentBlocksResponse_data_inner_allotmentIntervals_inner(
                                ...
                                availability = [
                                    cloudbeds_pms_v1_3.models.get_allotment_blocks_response_data_inner_allotment_intervals_inner_availability_inner.GetAllotmentBlocksResponse_data_inner_allotmentIntervals_inner_availability_inner(
                                ...
                                restrictions = cloudbeds_pms_v1_3.models.get_allotment_blocks_response_data_inner_allotment_intervals_inner_restrictions.GetAllotmentBlocksResponse_data_inner_allotmentIntervals_inner_restrictions(
                                    min_los = 56, 
                                    max_los = 56, 
                                    cut_off_days = 56, 
