...
class ContainerContainerDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["repository", "hidden", "pulp_last_updated", "content_guard", "base_path", "pulp_labels", "no_content_change_since", "pulp_created", "name", "prn", "pulp_href", "repository_version", "registry_path", "remote", "namespace", "private", "description"]
