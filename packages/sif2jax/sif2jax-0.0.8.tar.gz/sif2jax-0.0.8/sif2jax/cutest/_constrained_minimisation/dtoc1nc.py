...
class DTOC1NC(AbstractConstrainedMinimisation):
    ...
    n_controls: int = 2  # NX
    n_states: int = 4  # NY
    mu: float = 0.5  # Nonlinearity parameter
    ...
    def expected_objective_value(self):
        # From the SIF file: S(1000,2,4) 35.1993544122
        return jnp.array(35.1993544122)
