...
class AsphalteneCharacterization:
    ...
    def addAsphalteneComponents(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, double: float) -> None: ...
...
class Characterise(java.io.Serializable, java.lang.Cloneable):
    ...
    @typing.overload
    def characterizeToReference(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface) -> jneqsim.neqsim.thermo.system.SystemInterface: ...
    @typing.overload
    def characterizeToReference(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, characterizationOptions: 'CharacterizationOptions') -> jneqsim.neqsim.thermo.system.SystemInterface: ...
    ...
    def transferBipsFrom(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface) -> 'Characterise': ...
...
class CharacterizationValidationReport:
    @staticmethod
    def generate(systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, systemInterface2: jneqsim.neqsim.thermo.system.SystemInterface, systemInterface3: jneqsim.neqsim.thermo.system.SystemInterface) -> 'CharacterizationValidationReport': ...
...
class PedersenAsphalteneCharacterization:
    ...
    @typing.overload
    @staticmethod
    def TPflash(systemInterface: jneqsim.neqsim.thermo.system.SystemInterface) -> bool: ...
    @typing.overload
    @staticmethod
    def TPflash(systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, double: float, double2: float) -> bool: ...
    def addAsphalteneToSystem(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, double: float) -> java.lang.String: ...
    def addDistributedAsphaltene(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, double: float, int: int) -> None: ...
    def assessStability(self, double: float) -> java.lang.String: ...
    def calculateOnsetPressure(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, double: float, double2: float) -> float: ...
    ...
    @staticmethod
    def markAsphalteneRichLiquidPhases(systemInterface: jneqsim.neqsim.thermo.system.SystemInterface) -> bool: ...
...
class PseudoComponentCombiner:
    ...
    @typing.overload
    @staticmethod
    def characterizeToReference(systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, systemInterface2: jneqsim.neqsim.thermo.system.SystemInterface, characterizationOptions: CharacterizationOptions) -> jneqsim.neqsim.thermo.system.SystemInterface: ...
    @typing.overload
    @staticmethod
    ...
    @staticmethod
    def generateValidationReport(systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, systemInterface2: jneqsim.neqsim.thermo.system.SystemInterface, systemInterface3: jneqsim.neqsim.thermo.system.SystemInterface) -> CharacterizationValidationReport: ...
    @staticmethod
    def normalizeComposition(systemInterface: jneqsim.neqsim.thermo.system.SystemInterface) -> None: ...
    @staticmethod
    def transferBinaryInteractionParameters(systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, systemInterface2: jneqsim.neqsim.thermo.system.SystemInterface) -> None: ...
...
class TBPfractionModel(java.io.Serializable):
    ...
    class CavettModel(jneqsim.neqsim.thermo.characterization.TBPfractionModel.TBPBaseModel):
    ...
    class RiaziDaubert(jneqsim.neqsim.thermo.characterization.TBPfractionModel.PedersenTBPModelSRK):
        ...
        def calcTB(self, double: float, double2: float) -> float: ...
        def calcTC(self, double: float, double2: float) -> float: ...
    class StandingModel(jneqsim.neqsim.thermo.characterization.TBPfractionModel.TBPBaseModel):
        def __init__(self, tBPfractionModel: 'TBPfractionModel'): ...
        def calcAcentricFactor(self, double: float, double2: float) -> float: ...
        def calcPC(self, double: float, double2: float) -> float: ...
        def calcRacketZ(self, systemInterface: jneqsim.neqsim.thermo.system.SystemInterface, double: float, double2: float) -> float: ...
