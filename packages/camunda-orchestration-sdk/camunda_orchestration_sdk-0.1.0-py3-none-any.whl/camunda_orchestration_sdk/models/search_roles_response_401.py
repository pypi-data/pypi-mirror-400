...
T = TypeVar("T", bound="SearchRolesResponse401")


@_attrs_define
class SearchRolesResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_roles_response_401.additional_properties = d
        return search_roles_response_401
