...
class OrganizationListDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["organizations", "page", "pageSize", "total"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationListDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationListDto from a dict"""
        if obj is None:
            return None
