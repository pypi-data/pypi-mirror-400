...
class GetAlgorithmResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAlgorithmResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAlgorithmResponse:
        """Create an instance of GetAlgorithmResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAlgorithmResponse.parse_obj(obj)

        _obj = GetAlgorithmResponse.parse_obj(
            {
