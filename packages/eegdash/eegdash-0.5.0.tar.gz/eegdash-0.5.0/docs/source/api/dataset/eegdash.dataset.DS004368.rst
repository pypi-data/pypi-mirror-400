...
Meta-rdk: Preprocessed EEG data (OpenNeuro ``ds004368``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 1` :bdg-light:`License: CC0` :bdg-light:`Subjects: 39` :bdg-light:`Recordings: 40` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds004368.v1.0.2 <https://doi.org/10.18112/openneuro.ds004368.v1.0.2>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds004368>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds004368>`__
