...
class VaRCalculator:
    ...
    def monte_carlo_var(self, confidence_level: float = 0.95, n_simulations: int = 10000) -> float:
...
class MonteCarloVaR(VaRCalculator):
    ...
    def calculate(self, confidence_level: float = 0.95, n_simulations: int = 10000) -> float:
