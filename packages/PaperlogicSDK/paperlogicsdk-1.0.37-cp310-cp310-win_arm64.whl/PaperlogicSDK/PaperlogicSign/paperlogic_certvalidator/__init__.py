...
class CertificateValidator:
    # A paperlogic_certvalidator.path.ValidationPath object - only set once validated
    _path = None
    ...
    def __init__(
        ...
        :param validation_context:
            A paperlogic_certvalidator.context.ValidationContext() object that
        ...
        :param pkix_params:
            A paperlogic_certvalidator.context.PKIXValidationParams() object that
    ...
    async def async_validate_path(self) -> ValidationPath:
        ...
        :raises:
            paperlogic_certvalidator.errors.PathBuildingError - when an error occurs building the path
            paperlogic_certvalidator.errors.PathValidationError - when an error occurs validating the path
            paperlogic_certvalidator.errors.RevokedError - when the certificate or another certificate in its path has been revoked
        """
    ...
    def validate_usage(
        ...
        :raises:
            paperlogic_certvalidator.errors.PathValidationError - when an error occurs validating the path
            paperlogic_certvalidator.errors.RevokedError - when the certificate or another certificate in its path has been revoked
            paperlogic_certvalidator.errors.InvalidCertificateError - when the certificate is not valid for the usages specified

        :return:
            A paperlogic_certvalidator.path.ValidationPath object of the validated
    ...
    def validate_tls(self, hostname):
        ...
        :raises:
            paperlogic_certvalidator.errors.PathValidationError - when an error occurs validating the path
            paperlogic_certvalidator.errors.RevokedError - when the certificate or another certificate in its path has been revoked
            paperlogic_certvalidator.errors.InvalidCertificateError - when the certificate is not valid for TLS or the hostname
