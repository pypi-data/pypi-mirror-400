...
class Investigationusers(BaseModel):
    """
    Investigationusers
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "fullName", "role", "investigationName", "investigationId", "familyName", "givenName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Investigationusers from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Investigationusers from a dict"""
        if obj is None:
            return None
