    ...
    def __init__(
        ...
        **kwargs
        ...
        Args:
            ...
            secret_key: InteractiveAI secret key (defaults to INTERACTIVEAI_PRIVATE_KEY env var)
        ...
        if secret_key is None:
            secret_key = os.environ.get("INTERACTIVEAI_PRIVATE_KEY")
            if secret_key is None:
                raise ValueError("INTERACTIVEAI_PRIVATE_KEY is not set in .env nor passed as argument, please check documentation at https://docs.interactive.ai/docs/keys")
