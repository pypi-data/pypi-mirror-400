"""
The physical border surrounding locations where critical cyber assets are housed.
...
class PhysicalSecurityPerimeter(GridSTIXDomainObject):
    """
    The physical border surrounding locations where critical cyber assets are housed.
    ...
    _type = "x-grid-physical-security-perimeter"
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize PhysicalSecurityPerimeter with Grid-STIX properties."""
