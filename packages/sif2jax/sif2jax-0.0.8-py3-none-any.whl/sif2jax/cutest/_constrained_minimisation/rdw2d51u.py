...
class RDW2D51U(AbstractConstrainedMinimisation):
    """RDW2D51U problem - A finite-element approximation to distributed optimal control.
    ...
    quadrilateral elements. This is the unconstrained version without
    bounds on the control variables f.
    ...
    def constraint(self, y):
        ...
        # A element contributions: 4*u1 - u2 - u3 - 2*u4 at corners
    ...
    def bounds(self):
        ...
        # F boundary variables are fixed at 0 (much simpler than RDW2D51F)
        ...
        # Interior F variables are unbounded (no complex bounds like in RDW2D51F)
