...
setup(
    ...
    description="Cryptographically secure stress testing data generator library for competitive programming. Generates random test cases for arrays, numbers, strings, and graphs using secrets module.",
