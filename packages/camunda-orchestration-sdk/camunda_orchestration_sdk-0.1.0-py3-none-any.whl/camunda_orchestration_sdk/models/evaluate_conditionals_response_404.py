...
T = TypeVar("T", bound="EvaluateConditionalsResponse404")


@_attrs_define
class EvaluateConditionalsResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        evaluate_conditionals_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        evaluate_conditionals_response_404.additional_properties = d
        return evaluate_conditionals_response_404
