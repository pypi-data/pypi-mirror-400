"""
Demo script showing how to call `insert_row_yjs` on a y-websocket room.
"""
...
from rowsncolumns_spreadsheet import insert_row_yjs
...
async def main() -> None:
    ...
    async with websockets.connect(f"{url}/{room}") as websocket:
        ...
        with doc_transaction(ydoc):
            insert_row_yjs(ydoc, 1, reference_row_index=2, num_rows=2)
