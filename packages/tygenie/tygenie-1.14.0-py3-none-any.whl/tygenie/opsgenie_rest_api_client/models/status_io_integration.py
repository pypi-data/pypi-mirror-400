...
T = TypeVar("T", bound="StatusIOIntegration")
...
class StatusIOIntegration:
    ...
    Attributes:
        ...
        status_io_api_id (Union[Unset, str]):
        status_io_api_key (Union[Unset, str]):
        status_io_status_page_id (Union[Unset, str]):
    """
    ...
    status_io_api_id: Union[Unset, str] = UNSET
    status_io_api_key: Union[Unset, str] = UNSET
    status_io_status_page_id: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        status_io_api_id = self.status_io_api_id

        status_io_api_key = self.status_io_api_key

        status_io_status_page_id = self.status_io_status_page_id
        ...
        if status_io_api_id is not UNSET:
            field_dict["statusIoApiId"] = status_io_api_id
        if status_io_api_key is not UNSET:
            field_dict["statusIoApiKey"] = status_io_api_key
        if status_io_status_page_id is not UNSET:
            field_dict["statusIoStatusPageId"] = status_io_status_page_id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status_io_api_id = d.pop("statusIoApiId", UNSET)

        status_io_api_key = d.pop("statusIoApiKey", UNSET)

        status_io_status_page_id = d.pop("statusIoStatusPageId", UNSET)

        status_io_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
            ...
            status_io_api_id=status_io_api_id,
            status_io_api_key=status_io_api_key,
            status_io_status_page_id=status_io_status_page_id,
        )

        status_io_integration.additional_properties = d
        return status_io_integration
