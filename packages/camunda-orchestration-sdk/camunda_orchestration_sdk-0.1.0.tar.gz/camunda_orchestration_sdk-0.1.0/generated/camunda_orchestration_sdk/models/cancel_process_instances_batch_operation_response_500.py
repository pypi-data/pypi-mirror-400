...
T = TypeVar("T", bound="CancelProcessInstancesBatchOperationResponse500")


@_attrs_define
class CancelProcessInstancesBatchOperationResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancel_process_instances_batch_operation_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        cancel_process_instances_batch_operation_response_500.additional_properties = d
        return cancel_process_instances_batch_operation_response_500
