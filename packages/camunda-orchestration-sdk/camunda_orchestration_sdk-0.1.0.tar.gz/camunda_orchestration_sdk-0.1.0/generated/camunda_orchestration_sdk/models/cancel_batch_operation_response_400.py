...
T = TypeVar("T", bound="CancelBatchOperationResponse400")


@_attrs_define
class CancelBatchOperationResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancel_batch_operation_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        cancel_batch_operation_response_400.additional_properties = d
        return cancel_batch_operation_response_400
