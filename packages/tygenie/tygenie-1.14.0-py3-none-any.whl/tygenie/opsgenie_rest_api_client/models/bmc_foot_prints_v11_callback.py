...
T = TypeVar("T", bound="BMCFootPrintsV11Callback")


@_attrs_define
class BMCFootPrintsV11Callback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bmc_foot_prints_v11_callback = cls(
        ...
        bmc_foot_prints_v11_callback.additional_properties = d
        return bmc_foot_prints_v11_callback
