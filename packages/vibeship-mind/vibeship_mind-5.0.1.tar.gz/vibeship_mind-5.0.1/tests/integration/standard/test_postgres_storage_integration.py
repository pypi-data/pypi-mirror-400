"""Integration tests for PostgreSQL storage adapters.
...
# =============================================================================
# PostgresMemoryStorage Integration Tests
# =============================================================================


class TestPostgresMemoryStorageIntegration:
    """Integration tests for PostgresMemoryStorage."""
...
# =============================================================================
# PostgresDecisionStorage Integration Tests
# =============================================================================


class TestPostgresDecisionStorageIntegration:
    """Integration tests for PostgresDecisionStorage."""
    ...
    async def memory_storage(self, clean_db):
        """Create a PostgresMemoryStorage instance for creating test memories."""
        from mind.adapters.standard.postgres_storage import PostgresMemoryStorage
        return PostgresMemoryStorage(pool=clean_db)
