...
from viktor._vendor.libcst._metadata_dependent import LazyValue, MetadataDependent
from viktor._vendor.libcst.helpers.module import calculate_module_and_package, ModuleNameAndPackage
