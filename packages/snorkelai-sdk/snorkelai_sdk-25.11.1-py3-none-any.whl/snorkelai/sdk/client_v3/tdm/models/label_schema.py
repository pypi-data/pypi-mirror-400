...
if TYPE_CHECKING:
    ...
    from ..models.label_schema_label_descriptions import (
        LabelSchemaLabelDescriptions,  # noqa: F401
    )
    from ..models.label_schema_label_map import LabelSchemaLabelMap  # noqa: F401
    from ..models.label_schema_label_ordinality import (
        LabelSchemaLabelOrdinality,  # noqa: F401
    )
    # fmt: on


T = TypeVar("T", bound="LabelSchema")
...
class LabelSchema:
    ...
    Attributes:
        ...
        has_associated_assets (Union[Unset, bool]):
        ...
        label_descriptions (Union[Unset, LabelSchemaLabelDescriptions]):
        label_ordinality (Union[Unset, LabelSchemaLabelOrdinality]):
    ...
    has_associated_assets: Union[Unset, bool] = UNSET
    ...
    label_descriptions: Union[Unset, "LabelSchemaLabelDescriptions"] = UNSET
    label_ordinality: Union[Unset, "LabelSchemaLabelOrdinality"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        has_associated_assets = self.has_associated_assets
        ...
        if has_associated_assets is not UNSET:
            field_dict["has_associated_assets"] = has_associated_assets
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        label_map = LabelSchemaLabelMap.from_dict(d.pop("label_map"))
        ...
        _has_associated_assets = d.pop("has_associated_assets", UNSET)
        has_associated_assets = (
            UNSET if _has_associated_assets is None else _has_associated_assets
        )
        ...
        if isinstance(_label_descriptions, Unset):
            ...
            label_descriptions = LabelSchemaLabelDescriptions.from_dict(
                _label_descriptions
            )
        ...
        if isinstance(_label_ordinality, Unset):
            ...
            label_ordinality = LabelSchemaLabelOrdinality.from_dict(_label_ordinality)
        ...
        obj = cls(
            ...
            has_associated_assets=has_associated_assets,
