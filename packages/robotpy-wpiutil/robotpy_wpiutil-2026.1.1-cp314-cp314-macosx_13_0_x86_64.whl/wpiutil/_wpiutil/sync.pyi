...
import typing
__all__: list[str] = ['createEvent', 'createSemaphore', 'createSignalObject', 'destroyEvent', 'destroySemaphore', 'destroySignalObject', 'releaseSemaphore', 'resetEvent', 'resetSignalObject', 'setEvent', 'setSignalObject', 'waitForObject', 'waitForObjects']
def createEvent(manualReset: bool = False, initialState: bool = False) -> int:
    ...
    """
def createSemaphore(initialCount: typing.SupportsInt = 0, maximumCount: typing.SupportsInt = 2147483647) -> int:
    """
    ...
    """
def createSignalObject(handle: typing.SupportsInt, manualReset: bool = False, initialState: bool = False) -> None:
    """
    ...
    """
def destroyEvent(handle: typing.SupportsInt) -> None:
    """
    Destroys an event.  Destruction wakes up any waiters.
    
    :param handle: event handle
    """
def destroySemaphore(handle: typing.SupportsInt) -> None:
    """
    Destroys a semaphore.  Destruction wakes up any waiters.
    
    :param handle: semaphore handle
    """
def destroySignalObject(handle: typing.SupportsInt) -> None:
    """
    Cleans up signaling for a handle.  Destruction wakes up any waiters.
    
    :param handle: handle
    """
def releaseSemaphore(handle: typing.SupportsInt, releaseCount: typing.SupportsInt = 1) -> tuple[bool, int]:
    """
    ...
    """
def resetEvent(handle: typing.SupportsInt) -> None:
    """
    Sets an event to non-signaled state.
    
    :param handle: event handle
    """
def resetSignalObject(handle: typing.SupportsInt) -> None:
    """
    Sets a handle to non-signaled state.
    
    :param handle: handle
    """
def setEvent(handle: typing.SupportsInt) -> None:
    """
    Sets an event to signaled state.
    
    :param handle: event handle
    """
def setSignalObject(handle: typing.SupportsInt) -> None:
    """
    ...
    """
@typing.overload
def waitForObject(handle: typing.SupportsInt) -> bool:
    """
    ...
    """
@typing.overload
def waitForObject(handle: typing.SupportsInt, timeout: typing.SupportsFloat) -> tuple[bool, bool]:
    """
    ...
    """
@typing.overload
def waitForObjects(handles: list[typing.SupportsInt]) -> list[int]:
    """
    ...
    """
@typing.overload
def waitForObjects(handles: list[typing.SupportsInt], timeout: typing.SupportsFloat) -> tuple[list[int], bool]:
    """
