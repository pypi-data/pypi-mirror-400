...
class DomoPublication_Content:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any], auth: DomoAuth, parent: Any = None):
    ...
    async def get_entity(
        ...
        **context_kwargs,
        ...
        # DomoPublication_Content doesn't extend DomoBase, so use RouteContext.build_context() directly
    ...
    async def create_publication(
        ...
        **context_kwargs,
        ...
        res = await publish_routes.create_publish_job(
            auth=auth, body=body, context=context
        )
    ...
    async def update_publication(
        ...
        **context_kwargs,
        ...
        res = await publish_routes.update_publish_job(
            auth=auth, publication_id=self.id, body=body, context=context
        )
...
class DomoEverywhere:
    ...
    async def get_publications(
        ...
        **context_kwargs,
        ...
        # DomoEverywhere doesn't extend DomoBase, so use RouteContext.build_context() directly
        base_context = RouteContext.build_context(
            session=session,
            debug_api=debug_api,
            debug_num_stacks_to_drop=debug_num_stacks_to_drop,
    ...
    async def get_subscriptions(
        ...
        **context_kwargs,
        ...
        res = await publish_routes.get_subscription_summaries(
            auth=self.auth, context=context
        )
