...
def rectSolverClassic_NM(
    ...
    return {"sigmac": sol[0], "sigmas": sol[1], "xi": sol[2]}


def relativeError(valCal: float, valRef: Union[float, None]):
    if valRef is None:
        return 0.0
    else:
...
class Test(unittest.TestCase):
    ...
    def test_301_solver_NM(self):
        ...
        self.autoTestFun(
            1e-7, -6.165718127, 168.630377249, 442.754601582, solDomain, title
        )
    ...
    def test_302_solver_NM(self):
        ...
        solDomain = rectSolverDomain_NM(**sectionVal)
        self.autoTestFun(
            1e-7, -1.904647142, 0.950300863, 2177.986768409, solDomain, title
        )
    ...
    def test_303_solver_NM(self):
        ...
        solDomain = rectSolverDomain_NM(**sectionVal)
        self.autoTestFun(
            1e-9, -3.389314680, 34.797034357, 1276.484106795, solDomain, title
        )
