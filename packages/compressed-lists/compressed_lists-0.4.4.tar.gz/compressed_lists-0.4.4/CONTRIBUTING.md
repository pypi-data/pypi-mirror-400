...
Welcome to `compressed-lists` contributor's guide.
...
If you experience bugs or general issues with `compressed-lists`, please have a look
...
You can help improve `compressed-lists` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`compressed-lists` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `compressed-lists`'s files. While this mechanism can
...
```
conda create -n compressed-lists python=3 six virtualenv pytest pytest-cov
conda activate compressed-lists
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/compressed-lists.git
   cd compressed-lists
   ```
...
5. Install [pre-commit]:
   ...
   `compressed-lists` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/compressed-lists
[issue tracker]: https://github.com/<USERNAME>/compressed-lists/issues
