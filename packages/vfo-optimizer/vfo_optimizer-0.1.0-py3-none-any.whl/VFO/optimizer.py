        ...
        for t in range(1, self.max_iter + 1):
            ...
            for i in range(self.n):
                ...
                if new_fit < old_fit:
                    ...
                    # Algo 1 Line 11 is an assignment, suggesting we move regardless.
                    # However, moving to a worse position is typically accepted only in SA-like logic.
                    # Or this is a swarm algorithm where they follow the leader regardless.
