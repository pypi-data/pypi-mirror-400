...
if TYPE_CHECKING:
    from ..models.get_incident_response_200_error_type import (
        GetIncidentResponse200ErrorType,
    )
    from ..models.get_incident_response_200_state import GetIncidentResponse200State
...
class GetIncidentResponse200:
    ...
    Attributes:
        ...
        error_type (GetIncidentResponse200ErrorType | Unset):
        ...
        state (GetIncidentResponse200State | Unset):
    ...
    error_type: GetIncidentResponse200ErrorType | Unset = UNSET
    error_message: str | Unset = UNSET
    element_id: ElementId | Unset = UNSET
    creation_time: datetime.datetime | Unset = UNSET
    state: GetIncidentResponse200State | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_error_type, Unset):
            ...
            error_type = GetIncidentResponse200ErrorType.from_dict(_error_type)
        ...
        if isinstance(_state, Unset):
            ...
            state = GetIncidentResponse200State.from_dict(_state)
