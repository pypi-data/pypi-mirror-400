...
T = TypeVar("T", bound="PrtgIntegration")
...
class PrtgIntegration:
    ...
    Attributes:
        ...
        passhash (Union[Unset, str]):
        prtg_url (Union[Unset, str]):
    """
    ...
    passhash: Union[Unset, str] = UNSET
    prtg_url: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if passhash is not UNSET:
            field_dict["passhash"] = passhash
        if prtg_url is not UNSET:
            field_dict["prtgUrl"] = prtg_url
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        passhash = d.pop("passhash", UNSET)

        prtg_url = d.pop("prtgUrl", UNSET)

        prtg_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        prtg_integration.additional_properties = d
        return prtg_integration
