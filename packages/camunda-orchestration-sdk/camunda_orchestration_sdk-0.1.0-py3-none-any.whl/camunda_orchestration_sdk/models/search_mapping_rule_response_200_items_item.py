...
T = TypeVar("T", bound="SearchMappingRuleResponse200ItemsItem")


@_attrs_define
class SearchMappingRuleResponse200ItemsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_mapping_rule_response_200_items_item = cls(
        ...
        search_mapping_rule_response_200_items_item.additional_properties = d
        return search_mapping_rule_response_200_items_item
