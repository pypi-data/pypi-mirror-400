...
T = TypeVar("T", bound="AutoTaskEmailIntegration")
...
class AutoTaskEmailIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        auto_task_email_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        auto_task_email_integration.additional_properties = d
        return auto_task_email_integration
