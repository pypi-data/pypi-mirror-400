...
class DynamicMotionMagicExpoVoltage:
    ...
    kA, and (optional) Cruise Velocity.  Users can optionally provide a voltage
    feedforward.
    ...
    def __init__(self, position: rotation, k_v: volts_per_rotation_per_second, k_a: volts_per_rotation_per_second_squared, velocity: rotations_per_second = 0, enable_foc: bool = True, feed_forward: volt = 0.0, slot: int = 0, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, ignore_software_limits: bool = False, use_timesync: bool = False):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "DynamicMotionMagicExpoVoltage"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: DynamicMotionMagicExpoVoltage")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlDynamicMotionMagicExpoVoltage(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.position, self.k_v, self.k_a, self.velocity, self.enable_foc, self.feed_forward, self.slot, self.override_brake_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.ignore_hardware_limits, self.ignore_software_limits, self.use_timesync))

    
    def with_position(self, new_position: rotation) -> 'DynamicMotionMagicExpoVoltage':
        """
        ...
        :returns: Itself
        :rtype: DynamicMotionMagicExpoVoltage
        """
        self.position = new_position
        return self
    
    def with_k_v(self, new_k_v: volts_per_rotation_per_second) -> 'DynamicMotionMagicExpoVoltage':
        """
    ...
    def with_k_a(self, new_k_a: volts_per_rotation_per_second_squared) -> 'DynamicMotionMagicExpoVoltage':
        """
    ...
    def with_velocity(self, new_velocity: rotations_per_second) -> 'DynamicMotionMagicExpoVoltage':
        """
    ...
    def with_enable_foc(self, new_enable_foc: bool) -> 'DynamicMotionMagicExpoVoltage':
        """
    ...
    def with_feed_forward(self, new_feed_forward: volt) -> 'DynamicMotionMagicExpoVoltage':
        """
    ...
    def with_slot(self, new_slot: int) -> 'DynamicMotionMagicExpoVoltage':
        """
    ...
    def with_override_brake_dur_neutral(self, new_override_brake_dur_neutral: bool) -> 'DynamicMotionMagicExpoVoltage':
        """
    ...
    def with_limit_forward_motion(self, new_limit_forward_motion: bool) -> 'DynamicMotionMagicExpoVoltage':
        """
    ...
    def with_limit_reverse_motion(self, new_limit_reverse_motion: bool) -> 'DynamicMotionMagicExpoVoltage':
        """
    ...
    def with_ignore_hardware_limits(self, new_ignore_hardware_limits: bool) -> 'DynamicMotionMagicExpoVoltage':
        """
    ...
    def with_ignore_software_limits(self, new_ignore_software_limits: bool) -> 'DynamicMotionMagicExpoVoltage':
        """
    ...
    def with_use_timesync(self, new_use_timesync: bool) -> 'DynamicMotionMagicExpoVoltage':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'DynamicMotionMagicExpoVoltage':
        """
