...
class TENBARS3(AbstractConstrainedMinimisation):
    @property
    def name(self) -> str:
        return "TENBARS3"
    ...
    def constraint(self, y):
        ...
        # No inequality constraints for TENBARS3
    ...
    @property
    def bounds(self):
        # Lower bounds on U4 and U8 only (-50.8)
    ...
    def expected_objective_value(self):
        # According to the SIF file comment, the solution value is 2247.1290
