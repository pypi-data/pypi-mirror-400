...
T = TypeVar("T", bound="CreateSavedSearchPayload")
...
class CreateSavedSearchPayload:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_saved_search_payload = cls(
            name=name,
            query=query,
            owner=owner,
        ...
        create_saved_search_payload.additional_properties = d
        return create_saved_search_payload
