...
from p_pattern.hint.instance import position_h
from p_pattern.hint.number import number_h
from p_pattern.hint.sampler import new_samples_integer_h, new_samples_real_h
from p_pattern.type.sampler.domain import educated_domain_t
