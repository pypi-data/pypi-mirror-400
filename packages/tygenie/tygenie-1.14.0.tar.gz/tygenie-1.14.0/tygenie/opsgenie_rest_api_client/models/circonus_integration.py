...
T = TypeVar("T", bound="CirconusIntegration")
...
class CirconusIntegration:
    ...
    circonus_url: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        circonus_url = self.circonus_url
        ...
        if circonus_url is not UNSET:
            field_dict["circonusURL"] = circonus_url
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        circonus_url = d.pop("circonusURL", UNSET)

        circonus_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
            ...
            circonus_url=circonus_url,
        )

        circonus_integration.additional_properties = d
        return circonus_integration
