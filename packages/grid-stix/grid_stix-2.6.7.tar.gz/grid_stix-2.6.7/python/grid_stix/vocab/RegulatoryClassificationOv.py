"""
Open vocabulary for regulatory classification systems
...
class RegulatoryClassificationOv(GridSTIXDomainObject):
    """
    Open vocabulary for regulatory classification systems
    ...
    _type = "x-grid-regulatory-classification-ov"
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize RegulatoryClassificationOv with Grid-STIX properties."""
