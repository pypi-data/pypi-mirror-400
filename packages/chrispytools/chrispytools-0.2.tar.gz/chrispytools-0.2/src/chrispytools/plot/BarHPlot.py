...
def BarHPlot(ax, Plot_list, X_label, Y_label, **kwargs):
    """
    Plots a horizontal bar chart using a standardized plotting interface.

    This function renders horizontal bars with support for axis scaling, user-defined
    matplotlib style arguments, and optional legend handling via
    :func:`chrispytools.plot.base.BasePlot`.
    ...
    Plot_list : list
        ...
        ``[YData, XData, Label, style_string (optional)]``

        - **YData** (array-like): Bar positions on the Y-axis.
        ...
        - **style_string** (str, optional): A comma-separated string of matplotlib style parameters,
          e.g., ``"color=blue,height=0.3,align=center"``.
