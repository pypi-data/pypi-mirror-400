"""
Relationship indicating that a protective device protects another grid asset.
...
class ProtectsAssetRelationship(GridSTIXRelationshipObject):
    """
    Relationship indicating that a protective device protects another grid asset.
    ...
    _properties = OrderedDict(
        [
            ...
            ("x_protection_type", ListProperty(StringProperty())),
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize ProtectsAssetRelationship with Grid-STIX properties."""
