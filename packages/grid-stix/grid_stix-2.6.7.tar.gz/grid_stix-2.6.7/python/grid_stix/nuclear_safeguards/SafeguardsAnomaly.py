"""
Observed anomaly in safeguards systems or material accounting that may indicate proliferation concern.
...
from ..vocab import SafeguardsAnomalyTypeOv


class SafeguardsAnomaly(GridSTIXDomainObject):
    """
    Observed anomaly in safeguards systems or material accounting that may indicate proliferation concern.
    ...
    _properties = OrderedDict(
        [
            ...
            ("x_material_unaccounted_for_kg", ListProperty(FloatProperty())),
        ]
    )

    def __init__(self, **kwargs: Any) -> None:
        """Initialize SafeguardsAnomaly with Grid-STIX properties."""
