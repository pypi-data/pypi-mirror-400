...
from layerlearn.baseCatR import CatDecisionRegressor, CatForestRegressor, CatSupportRegressor, CatLinearRegressor, CatKNNRegressor, CatXGBRegressor, CatGradientRegressor, CatAdaRegressor, CatLightRegressor
import warnings
...
models = {
    "Cat Forest Regressor": CatForestRegressor(),
    "Cat Support Regressor": CatSupportRegressor(),
    "Cat Linear Regressor": CatLinearRegressor(),
    "Cat KNN Regressor": CatKNNRegressor(),
    "Cat XGBoost Regressor": CatXGBRegressor(),
    "Cat Ada Regressor": CatAdaRegressor(),
    "Cat Gradient Boosting Regressor": CatGradientRegressor(),
    "Cat Decision Regressor": CatDecisionRegressor(),
    "Cat LightGBM Regressor": CatLightRegressor(),
}
...
ax.set_title('Comparison of Cat Model Regression Performance', fontsize=18, fontweight='bold')
