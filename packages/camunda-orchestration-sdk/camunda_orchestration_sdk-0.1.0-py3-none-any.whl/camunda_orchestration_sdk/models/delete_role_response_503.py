...
T = TypeVar("T", bound="DeleteRoleResponse503")


@_attrs_define
class DeleteRoleResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_role_response_503.additional_properties = d
        return delete_role_response_503
