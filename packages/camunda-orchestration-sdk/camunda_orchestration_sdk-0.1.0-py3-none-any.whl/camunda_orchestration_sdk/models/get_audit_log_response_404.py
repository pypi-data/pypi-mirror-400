...
T = TypeVar("T", bound="GetAuditLogResponse404")


@_attrs_define
class GetAuditLogResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_audit_log_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_audit_log_response_404.additional_properties = d
        return get_audit_log_response_404
