...
T = TypeVar("T", bound="ReportTemplateBranding")



@_attrs_define
class ReportTemplateBranding:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        report_template_branding.additional_properties = d
        return report_template_branding
