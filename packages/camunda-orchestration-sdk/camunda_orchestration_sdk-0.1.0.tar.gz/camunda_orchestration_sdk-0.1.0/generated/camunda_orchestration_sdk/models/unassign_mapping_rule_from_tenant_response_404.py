...
T = TypeVar("T", bound="UnassignMappingRuleFromTenantResponse404")


@_attrs_define
class UnassignMappingRuleFromTenantResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unassign_mapping_rule_from_tenant_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        unassign_mapping_rule_from_tenant_response_404.additional_properties = d
        return unassign_mapping_rule_from_tenant_response_404
