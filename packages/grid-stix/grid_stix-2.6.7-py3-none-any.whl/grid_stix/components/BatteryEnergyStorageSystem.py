"""
DER asset used to store and release electricity to balance load and generation.
...
class BatteryEnergyStorageSystem(GridSTIXDomainObject):
    """
    DER asset used to store and release electricity to balance load and generation.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize BatteryEnergyStorageSystem with Grid-STIX properties."""
