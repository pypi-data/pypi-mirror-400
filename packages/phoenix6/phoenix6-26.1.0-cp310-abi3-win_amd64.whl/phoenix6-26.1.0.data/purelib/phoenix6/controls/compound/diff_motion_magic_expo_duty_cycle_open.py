...
@final
class Diff_MotionMagicExpoDutyCycle_Open:
    """
    Requires Phoenix Pro and CANivore;
    Differential control with Motion Magic® Expo average target and duty cycle
    difference target.
    ...
    def __init__(self, average_request: MotionMagicExpoDutyCycle, differential_request: DutyCycleOut):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_MotionMagicExpoDutyCycle_Open"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicExpoDutyCycle_Open")
    ...
    def with_average_request(self, new_average_request: MotionMagicExpoDutyCycle) -> 'Diff_MotionMagicExpoDutyCycle_Open':
        ...
        :returns: Itself
        :rtype: Diff_MotionMagicExpoDutyCycle_Open
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: DutyCycleOut) -> 'Diff_MotionMagicExpoDutyCycle_Open':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicExpoDutyCycle_Open':
        """
