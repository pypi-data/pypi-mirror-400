...
T = TypeVar("T", bound="SearchProcessInstanceIncidentsDataFilter")


@_attrs_define
class SearchProcessInstanceIncidentsDataFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_process_instance_incidents_data_filter = cls(
        ...
        search_process_instance_incidents_data_filter.additional_properties = d
        return search_process_instance_incidents_data_filter
