"""
ModuleBuilder - Fluent builder for Module entities.
...
from ainalyn.domain.entities import EIPBinding, Module
...
class ModuleBuilder:
    ...
    def eip_binding(self, binding: EIPBinding) -> Self:
        """
        Bind this Module to a specific EIP provider and service.
    ...
    def build(self) -> Module:
        ...
        if self._description is None:
            raise MissingFieldError("description", "ModuleBuilder")
