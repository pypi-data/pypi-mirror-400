...
def run_setup() -> bool:
    ...
    try:
        ...
        # Copy README.md from package to current directory
        try:
            # Get the package root directory
            package_files = files("mcp_trendminer_server")
            readme_path = package_files.parent / "README.md"
            ...
            print(f"ℹ️  Could not copy README.md: {e}")
