...
class FolderListableDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "dueDate", "metadata", "draftCreationDate", "stillSinceDate", "type", "subtype", "originUser", "originDesk", "finalDesk", "isReadByCurrentUser", "state", "legacyId", "readByCurrentUser"]
