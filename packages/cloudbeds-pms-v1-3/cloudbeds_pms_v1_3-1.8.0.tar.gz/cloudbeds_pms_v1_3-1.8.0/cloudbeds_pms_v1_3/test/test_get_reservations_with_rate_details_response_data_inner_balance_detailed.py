...
class TestGetReservationsWithRateDetailsResponseDataInnerBalanceDetailed(unittest.TestCase):
    """GetReservationsWithRateDetailsResponseDataInnerBalanceDetailed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservationsWithRateDetailsResponseDataInnerBalanceDetailed:
        """Test GetReservationsWithRateDetailsResponseDataInnerBalanceDetailed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservationsWithRateDetailsResponseDataInnerBalanceDetailed`
        """
        model = GetReservationsWithRateDetailsResponseDataInnerBalanceDetailed()
        if include_optional:
            return GetReservationsWithRateDetailsResponseDataInnerBalanceDetailed(
                suggested_deposit = '',
                sub_total = 1.337,
    ...
    def testGetReservationsWithRateDetailsResponseDataInnerBalanceDetailed(self):
        """Test GetReservationsWithRateDetailsResponseDataInnerBalanceDetailed"""
