"""
Operational characteristics and control systems associated with grid infrastructure, potentially separate from physical assets.
...
class OperationalGridEntity(GridSTIXDomainObject):
    """
    Operational characteristics and control systems associated with grid infrastructure, potentially separate from physical assets.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize OperationalGridEntity with Grid-STIX properties."""
