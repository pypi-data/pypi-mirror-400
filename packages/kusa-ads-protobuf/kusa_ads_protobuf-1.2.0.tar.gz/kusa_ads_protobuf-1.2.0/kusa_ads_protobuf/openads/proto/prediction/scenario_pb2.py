...
# source: openads/proto/prediction/scenario.proto
...
_SCENARIO_TYPE = _descriptor.EnumDescriptor(
  name='Type',
  full_name='openads.proto.prediction.Scenario.Type',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SCENARIO = _descriptor.Descriptor(
  name='Scenario',
  full_name='openads.proto.prediction.Scenario',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='openads.proto.prediction.Scenario.type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='junction_id', full_name='openads.proto.prediction.Scenario.junction_id', index=1,
...
Scenario = _reflection.GeneratedProtocolMessageType('Scenario', (_message.Message,), dict(
  ...
  __module__ = 'openads.proto.prediction.scenario_pb2'
  # @@protoc_insertion_point(class_scope:openads.proto.prediction.Scenario)
  ))
