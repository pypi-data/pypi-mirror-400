...
Welcome to `txdb` contributor's guide.
...
If you experience bugs or general issues with `txdb`, please have a look
...
You can help improve `txdb` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`txdb` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `txdb`'s files. While this mechanism can
...
```
conda create -n txdb python=3 six virtualenv pytest pytest-cov
conda activate txdb
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/txdb.git
   cd txdb
   ```
...
5. Install [pre-commit]:
   ...
   `txdb` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/txdb
[issue tracker]: https://github.com/<USERNAME>/txdb/issues
