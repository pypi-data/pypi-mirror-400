...
T = TypeVar("T", bound="UpdateMaintenancePayload")
...
class UpdateMaintenancePayload:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_maintenance_payload = cls(
            time=time,
            rules=rules,
            description=description,
        )

        update_maintenance_payload.additional_properties = d
        return update_maintenance_payload
