...
class InstallerBase(ABC):
    ...
    @classmethod
    def get_version(cls, original_version: str) -> str:
        """
        在某些场景下，传入版本可能并非实际版本.
        默认返回原始版本，可重载实现逻辑.
        Args:
    ...
    @classmethod
    def get_filename_version(cls, version: str) -> str:
        """
        获取某个版本中资源文件名中体现的版本号.
        Args:
            version: 实际版本号
    ...
    def get_latest_version(cls) -> str:
        ...
        Raises:
            ValueError: 如果没有可用版本
        """
        versions = cls.get_version_list(True, True)
    ...
    def get_version_list(
        cls, reverse: bool = True, stable: bool = Config.FORCE_STABLE
    ) -> Iterable[str]:
        """获取可用版本列表。
