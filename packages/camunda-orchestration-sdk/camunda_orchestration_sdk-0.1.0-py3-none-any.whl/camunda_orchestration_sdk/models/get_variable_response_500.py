...
T = TypeVar("T", bound="GetVariableResponse500")


@_attrs_define
class GetVariableResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_variable_response_500.additional_properties = d
        return get_variable_response_500
