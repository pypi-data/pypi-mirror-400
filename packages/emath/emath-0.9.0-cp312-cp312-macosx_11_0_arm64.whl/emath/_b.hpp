...
static PyObject *
BArray_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(bool);
...
static PyMethodDef BArray_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)BArray_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
