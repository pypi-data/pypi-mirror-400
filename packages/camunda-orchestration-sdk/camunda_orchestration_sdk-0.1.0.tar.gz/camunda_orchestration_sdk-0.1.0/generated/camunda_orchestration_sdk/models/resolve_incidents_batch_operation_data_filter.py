...
if TYPE_CHECKING:
    ...
    from ..models.resolve_incidents_batch_operation_data_filter_or_item import (
        ResolveIncidentsBatchOperationDataFilterOrItem,
    )
    from ..models.resolve_incidents_batch_operation_data_filter_variables_item import (
...
T = TypeVar("T", bound="ResolveIncidentsBatchOperationDataFilter")


@_attrs_define
class ResolveIncidentsBatchOperationDataFilter:
    ...
    Attributes:
        ...
        variables (list[ResolveIncidentsBatchOperationDataFilterVariablesItem] | Unset): The process instance variables.
        ...
        or_ (list[ResolveIncidentsBatchOperationDataFilterOrItem] | Unset): Defines a list of alternative filter groups
    ...
    variables: list[ResolveIncidentsBatchOperationDataFilterVariablesItem] | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        variables: (
            list[ResolveIncidentsBatchOperationDataFilterVariablesItem] | Unset
        ) = UNSET
        if _variables is not UNSET:
            variables = []
            for variables_item_data in _variables:
                variables_item = (
                    ResolveIncidentsBatchOperationDataFilterVariablesItem.from_dict(
                        variables_item_data
                    )
                )
        ...
        if _or_ is not UNSET:
            ...
            for or_item_data in _or_:
                or_item = ResolveIncidentsBatchOperationDataFilterOrItem.from_dict(
                    or_item_data
                )

                or_.append(or_item)

        resolve_incidents_batch_operation_data_filter = cls(
        ...
        resolve_incidents_batch_operation_data_filter.additional_properties = d
        return resolve_incidents_batch_operation_data_filter
