...
class ShortUrlsLinkDelete422Response(BaseModel):
    """
    ShortUrlsLinkDelete422Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Short link not found. Please check short link id.")
