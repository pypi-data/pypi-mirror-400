...
from agentops.metrics.metrics import DescriptionQualityMetric
from agentops.prompt.template_render import BadToolDescriptionRenderer
from agentops.service_provider import get_provider
from agentops.tool_planner import (
...
class ToolDescriptionIssue(Enum):
    ...
    For more detail on what each issue indicates, please take a look at the template here: `agentops/prompt/bad_tool_descriptions_prompt.jinja2`.
    """
...
class DescriptionQualityInspector:
    ...
    def detect_bad_description(
        ...
        json_objects = parse_json_string(response.choices[0].message.content)
