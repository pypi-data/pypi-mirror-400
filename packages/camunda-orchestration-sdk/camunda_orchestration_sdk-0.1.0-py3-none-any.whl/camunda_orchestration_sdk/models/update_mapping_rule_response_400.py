...
T = TypeVar("T", bound="UpdateMappingRuleResponse400")


@_attrs_define
class UpdateMappingRuleResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_mapping_rule_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        update_mapping_rule_response_400.additional_properties = d
        return update_mapping_rule_response_400
