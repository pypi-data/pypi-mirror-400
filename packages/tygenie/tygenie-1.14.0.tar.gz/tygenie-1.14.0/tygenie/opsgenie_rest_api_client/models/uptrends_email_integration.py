...
T = TypeVar("T", bound="UptrendsEmailIntegration")
...
class UptrendsEmailIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        uptrends_email_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        uptrends_email_integration.additional_properties = d
        return uptrends_email_integration
