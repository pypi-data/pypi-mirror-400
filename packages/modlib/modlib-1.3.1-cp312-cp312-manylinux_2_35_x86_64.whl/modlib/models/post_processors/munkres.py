...
# - Removal of unused utility functions and examples

# NOTE: Possible upgrade and speedup using backtracking
# https://github.com/bmc/munkres/issues/49
# https://github.com/bmc/munkres/pull/50
