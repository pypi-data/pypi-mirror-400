"""
DER system can be viewed as composed of two classes of components: physical hardware/firmware components and cyber controller components that manage the physical components
...
class DerSystem(GridSTIXDomainObject):
    """
    DER system can be viewed as composed of two classes of components: physical hardware/firmware components and cyber controller components that manage the physical components
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize DerSystem with Grid-STIX properties."""
