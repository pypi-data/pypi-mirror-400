...
class FeatrixTableEncoder(nn.Module):
    ...
    def compute_total_loss(
        ...
        if self._loss_debug_counter < 5:
            ...
            logger.info(f"   reconstruction_loss: {reconstruction_loss.item():.4f} (requires_grad={reconstruction_loss.requires_grad})")
            ...
            logger.info(f"   reconstruction_weight: {reconstruction_weight:.4f}")
        ...
        if self._loss_debug_counter <= 5:
            ...
            logger.info(f"   reconstruction: {(reconstruction_weight * reconstruction_loss).item():.4f}")
