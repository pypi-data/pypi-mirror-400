...
class TestGetTaxesAndFeesResponseDataInnerAmountRateBasedInnerPercentage(unittest.TestCase):
    """GetTaxesAndFeesResponseDataInnerAmountRateBasedInnerPercentage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTaxesAndFeesResponseDataInnerAmountRateBasedInnerPercentage:
        """Test GetTaxesAndFeesResponseDataInnerAmountRateBasedInnerPercentage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTaxesAndFeesResponseDataInnerAmountRateBasedInnerPercentage`
        """
        model = GetTaxesAndFeesResponseDataInnerAmountRateBasedInnerPercentage()
        if include_optional:
            return GetTaxesAndFeesResponseDataInnerAmountRateBasedInnerPercentage(
            )
        else:
            return GetTaxesAndFeesResponseDataInnerAmountRateBasedInnerPercentage(
        )
    ...
    def testGetTaxesAndFeesResponseDataInnerAmountRateBasedInnerPercentage(self):
        """Test GetTaxesAndFeesResponseDataInnerAmountRateBasedInnerPercentage"""
