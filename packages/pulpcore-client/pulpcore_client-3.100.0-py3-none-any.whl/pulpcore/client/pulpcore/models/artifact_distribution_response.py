...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_labels", "name", "pulp_href", "pulp_created", "prn", "hidden", "content_guard", "base_path", "base_url", "pulp_last_updated", "no_content_change_since"]
