...
from ..models.migrate_process_instances_batch_operation_response_200_batch_operation_type import (
    MigrateProcessInstancesBatchOperationResponse200BatchOperationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="MigrateProcessInstancesBatchOperationResponse200")


@_attrs_define
class MigrateProcessInstancesBatchOperationResponse200:
    """The created batch operation.

    Attributes:
        batch_operation_key (str | Unset): Key of the batch operation. Example: 2251799813684321.
        batch_operation_type (MigrateProcessInstancesBatchOperationResponse200BatchOperationType | Unset): The type of
            the batch operation.
    """

    batch_operation_key: BatchOperationKey | Unset = UNSET
    batch_operation_type: (
        MigrateProcessInstancesBatchOperationResponse200BatchOperationType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        migrate_process_instances_batch_operation_response_200 = cls(
            batch_operation_key=batch_operation_key,
            batch_operation_type=batch_operation_type,
        )

        migrate_process_instances_batch_operation_response_200.additional_properties = d
        return migrate_process_instances_batch_operation_response_200
