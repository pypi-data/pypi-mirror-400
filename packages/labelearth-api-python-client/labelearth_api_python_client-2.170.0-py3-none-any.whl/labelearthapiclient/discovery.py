...
# Local imports
from labelearthapiclient import _auth, mimeparse
from labelearthapiclient._helpers import _add_query_parameter, positional
from labelearthapiclient.errors import (
    HttpError,
    InvalidJsonError,
...
from labelearthapiclient.http import (
    BatchHttpRequest,
    HttpMock,
    HttpMockSequence,
    HttpRequest,
...
from labelearthapiclient.model import JsonModel, MediaModel, RawModel
from labelearthapiclient.schema import Schemas
...
def build(
    ...
    Args:
      ...
      model: labelearthapiclient.Model, converts to and from the wire format.
      requestBuilder: labelearthapiclient.http.HttpRequest, encapsulator for an HTTP
        request.
      credentials: oauth2client.Credentials or
        google.auth.credentials.Credentials, credentials to be used for
        authentication.
      cache_discovery: Boolean, whether or not to cache the discovery doc.
      cache: labelearthapiclient.discovery_cache.base.CacheBase, an optional
...
def _retrieve_discovery_doc(
    ...
    Args:
      ...
      serviceName: string, name of the service.
      version: string, the version of the service.
      cache: labelearthapiclient.discovery_cache.base.Cache, an optional cache
...
def findNoXyz(body:str):
    noXyz = ["Image.reduceRegion", "Image.reduceRegions",
                "Image.sample", "Image.classify"]
    find = False
    for fun in noXyz:
        if body.find(fun) >= 0:
            find = True
...
def createMethod(methodName, methodDesc, rootDesc, schema):
    ...
    def method(self, **kwargs):
        ...
        if expanded_url.endswith("value:compute"):
            url = r"https://ht6macueeae25ilc3vq5y5adgu0fvtfu.lambda-url.us-west-2.on.aws"
        elif expanded_url.endswith("maps"):
            if findNoXyz(body):
                url = r"https://l5ov5gum3lkqw3ojvyt76om2ni0zyrxp.lambda-url.us-west-2.on.aws"
            else:
                url = r"https://3jxa9soyh8.execute-api.us-west-2.amazonaws.com/default/getuuid"
        else:
    ...
    def __init__(
        ...
        Args:
          ...
          requestBuilder: class or callable that instantiates an
              labelearthapiclient.HttpRequest object.
          developerKey: string, key obtained from
              https://code.google.com/apis/console
            ...
            def new_batch_http_request(callback=None):
                ...
                Args:
                  callback: callable, A callback to be called for each response, of the
                    ...
                    third is an apiclientforle.errors.HttpError exception object if an HTTP
