"""
Entity responsible for operating and maintaining DER assets on behalf of the owner or a utility.
...
class DerOperator(GridSTIXDomainObject):
    """
    Entity responsible for operating and maintaining DER assets on behalf of the owner or a utility.
    ...
    _properties = OrderedDict(
        [
            ...
            ("x_manages_device", ListProperty(StringProperty())),
            ("x_operates", ListProperty(StringProperty())),
        ]
    )

    def __init__(self, **kwargs: Any) -> None:
        """Initialize DerOperator with Grid-STIX properties."""
