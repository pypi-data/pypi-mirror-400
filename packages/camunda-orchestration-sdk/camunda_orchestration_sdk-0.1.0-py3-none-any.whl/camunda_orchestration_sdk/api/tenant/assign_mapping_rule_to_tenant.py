...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Any | AssignMappingRuleToTenantResponse400 | AssignMappingRuleToTenantResponse403 | AssignMappingRuleToTenantResponse404 | AssignMappingRuleToTenantResponse500 | AssignMappingRuleToTenantResponse503 | None:
    ...
    if response.status_code == 400:
        response_400 = AssignMappingRuleToTenantResponse400.from_dict(response.json())
        return response_400
    if response.status_code == 403:
        response_403 = AssignMappingRuleToTenantResponse403.from_dict(response.json())
        return response_403
    if response.status_code == 404:
        response_404 = AssignMappingRuleToTenantResponse404.from_dict(response.json())
        return response_404
    if response.status_code == 500:
        response_500 = AssignMappingRuleToTenantResponse500.from_dict(response.json())
        return response_500
    if response.status_code == 503:
        response_503 = AssignMappingRuleToTenantResponse503.from_dict(response.json())
        return response_503
