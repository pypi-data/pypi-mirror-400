...
Installation
============
The Diffusivity step is probably already installed in your SEAMM
...
check for `diffusivity-step`. If it is not installed, or
...
The non-graphical installer is also straightforward::
  ...
  seamm-installer install --update diffusivity-step
