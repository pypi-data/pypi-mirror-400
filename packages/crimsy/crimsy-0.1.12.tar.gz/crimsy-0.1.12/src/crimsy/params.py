...
class ParamInfo:
    ...
    def __init__(
        ...
        # Treat Ellipsis (...) as a marker for required parameters
        self.is_required = default in (inspect.Parameter.empty, ...)
...
def analyze_function_params(
    ...
    for param_name, param in sig.parameters.items():
        ...
        # Treat Ellipsis (...) as a marker for required parameters, not as a default value
