...
class FunnelChart(GeneralMethods, TitleMethods, ChartWithLUT, ChartWithLabelStyling, ChartsWithCoordinateTransforms, FunnelPyramidLabelConnectorMethods, ChartsWithAddEventListener):
    ...
    def set_slice_stroke(self, thickness: int | float, color: ColorInput | None = None) -> Self:
...
class FunnelChartContainer(FunnelChart):
    def __init__(
            self, 
            instance, 
            container, 
