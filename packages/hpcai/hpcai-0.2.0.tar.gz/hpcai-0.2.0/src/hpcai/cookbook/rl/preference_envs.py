...
from hpcai.cookbook.completers import StopCondition
from hpcai.cookbook.preference.preference_datasets import (
    ComparisonDatasetBuilder,
)
from hpcai.cookbook.preference.types import (
    Comparison,
    LabeledComparison,
    PreferenceModel,
)
...
from hpcai.cookbook.utils.logtree_formatters import ConversationFormatter
...
class PreferenceEnv(Env):
    ...
    async def step(self, action: Action) -> StepResult:
        ...
        return StepResult(
            reward=0,
            episode_done=True,
            next_observation=hpcai.ModelInput.empty(),
