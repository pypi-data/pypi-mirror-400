...
# source: openads/proto/common/adapter_config.proto
...
_ADAPTERCONFIG_MESSAGETYPE = _descriptor.EnumDescriptor(
  name='MessageType',
  full_name='openads.proto.common.AdapterConfig.MessageType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_ADAPTERCONFIG_MODE = _descriptor.EnumDescriptor(
  name='Mode',
  full_name='openads.proto.common.AdapterConfig.Mode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_ADAPTERCONFIG = _descriptor.Descriptor(
  name='AdapterConfig',
  full_name='openads.proto.common.AdapterConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='openads.proto.common.AdapterConfig.type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='mode', full_name='openads.proto.common.AdapterConfig.mode', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='message_history_limit', full_name='openads.proto.common.AdapterConfig.message_history_limit', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='latch', full_name='openads.proto.common.AdapterConfig.latch', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='topic', full_name='openads.proto.common.AdapterConfig.topic', index=4,
...
_ADAPTERMANAGERCONFIG = _descriptor.Descriptor(
  ...
  full_name='openads.proto.common.AdapterManagerConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='config', full_name='openads.proto.common.AdapterManagerConfig.config', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_ros', full_name='openads.proto.common.AdapterManagerConfig.is_ros', index=1,
...
AdapterConfig = _reflection.GeneratedProtocolMessageType('AdapterConfig', (_message.Message,), dict(
  ...
  __module__ = 'openads.proto.common.adapter_config_pb2'
  # @@protoc_insertion_point(class_scope:openads.proto.common.AdapterConfig)
  ))
...
AdapterManagerConfig = _reflection.GeneratedProtocolMessageType('AdapterManagerConfig', (_message.Message,), dict(
  ...
  __module__ = 'openads.proto.common.adapter_config_pb2'
  # @@protoc_insertion_point(class_scope:openads.proto.common.AdapterManagerConfig)
  ))
