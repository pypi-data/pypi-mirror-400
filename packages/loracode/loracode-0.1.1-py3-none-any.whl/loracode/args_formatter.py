...
class DotEnvFormatter(argparse.HelpFormatter):
    ...
    def _format_text(self, text):
        return f"""
##########################################################
# Sample loracode .env file.
# Place at the root of your git repo.
# Or use `loracode --env <fname>` to specify.
##########################################################

#################
# Lora Code API parameters:
#
...
## Lora Code API Base URL (optional)
#LORA_CODE_API_BASE=https://api.loratech.dev
...
# https://loracode.dev/docs/config/dotenv.html
