...
T = TypeVar("T", bound="SearchDecisionRequirementsResponse200ItemsItem")


@_attrs_define
class SearchDecisionRequirementsResponse200ItemsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_decision_requirements_response_200_items_item = cls(
        ...
        return search_decision_requirements_response_200_items_item
