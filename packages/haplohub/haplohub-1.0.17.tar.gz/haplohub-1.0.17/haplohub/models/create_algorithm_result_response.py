...
class CreateAlgorithmResultResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAlgorithmResultResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAlgorithmResultResponse:
        """Create an instance of CreateAlgorithmResultResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAlgorithmResultResponse.parse_obj(obj)

        _obj = CreateAlgorithmResultResponse.parse_obj(
            {
