...
T = TypeVar("T", bound="UnassignRoleFromGroupResponse500")


@_attrs_define
class UnassignRoleFromGroupResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unassign_role_from_group_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        unassign_role_from_group_response_500.additional_properties = d
        return unassign_role_from_group_response_500
