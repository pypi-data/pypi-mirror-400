...
T = TypeVar("T", bound="PublishMessageResponse400")


@_attrs_define
class PublishMessageResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        publish_message_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        publish_message_response_400.additional_properties = d
        return publish_message_response_400
