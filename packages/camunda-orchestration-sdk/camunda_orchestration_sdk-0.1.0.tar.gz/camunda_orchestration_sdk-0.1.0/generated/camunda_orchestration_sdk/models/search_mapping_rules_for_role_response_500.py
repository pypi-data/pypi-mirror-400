...
T = TypeVar("T", bound="SearchMappingRulesForRoleResponse500")


@_attrs_define
class SearchMappingRulesForRoleResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_mapping_rules_for_role_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_mapping_rules_for_role_response_500.additional_properties = d
        return search_mapping_rules_for_role_response_500
