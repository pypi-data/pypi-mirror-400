...
T = TypeVar("T", bound="SearchElementInstanceIncidentsResponse200Page")


@_attrs_define
class SearchElementInstanceIncidentsResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_element_instance_incidents_response_200_page = cls(
        ...
        search_element_instance_incidents_response_200_page.additional_properties = d
        return search_element_instance_incidents_response_200_page
