...
Author  : 写上自己的名字
Contact : 邮箱地址
Time    : 2022-08-31 14:52
Desc: 生成随机身份证号
"""

import random
import datetime
from china_address import addr
...
if __name__ == '__main__':
    ...
    cid = getRandomIdNumber(0)[0]
    id = getRandomIdNumber(0)
    idcard = id[0] + id[5]
    print("随机生成身份证号:{}".format(idcard))
    print("随机生成手机号:{}".format(createPhone()))
