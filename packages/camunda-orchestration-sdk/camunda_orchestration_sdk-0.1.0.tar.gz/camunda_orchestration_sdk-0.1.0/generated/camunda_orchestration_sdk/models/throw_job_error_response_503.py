...
T = TypeVar("T", bound="ThrowJobErrorResponse503")


@_attrs_define
class ThrowJobErrorResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        throw_job_error_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        throw_job_error_response_503.additional_properties = d
        return throw_job_error_response_503
