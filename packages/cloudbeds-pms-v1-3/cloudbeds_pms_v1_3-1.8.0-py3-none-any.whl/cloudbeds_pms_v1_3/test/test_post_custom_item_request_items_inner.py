    ...
    def make_instance(self, include_optional) -> PostCustomItemRequestItemsInner:
        ...
        if include_optional:
            return PostCustomItemRequestItemsInner(
                ...
                item_note = '',
                item_taxes = [
                    cloudbeds_pms_v1_3.models.post_custom_item_request_items_inner_item_taxes_inner.PostCustomItemRequest_items_inner_itemTaxes_inner(
                        tax_name = '', 
                        tax_value = 1.337, )
                    ],
                item_fees = [
                    cloudbeds_pms_v1_3.models.post_custom_item_request_items_inner_item_fees_inner.PostCustomItemRequest_items_inner_itemFees_inner(
                        fee_name = '', 
                        fee_value = 1.337, )
                    ]
            )
