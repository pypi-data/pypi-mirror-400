...
T = TypeVar("T", bound="GetRoleResponse401")


@_attrs_define
class GetRoleResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_role_response_401.additional_properties = d
        return get_role_response_401
