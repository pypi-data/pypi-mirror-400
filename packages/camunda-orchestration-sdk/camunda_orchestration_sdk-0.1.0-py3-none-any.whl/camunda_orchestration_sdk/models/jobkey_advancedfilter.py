...
T = TypeVar("T", bound="JobkeyAdvancedfilter")


@_attrs_define
class JobkeyAdvancedfilter:
    """Advanced JobKey filter.

    Attributes:
        eq (str | Unset): Checks for equality with the provided value. Example: 2251799813653498.
        neq (str | Unset): Checks for inequality with the provided value. Example: 2251799813653498.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jobkey_advancedfilter.additional_properties = d
        return jobkey_advancedfilter
