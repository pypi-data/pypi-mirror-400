...
T = TypeVar("T", bound="StatusPageIOIntegration")
...
class StatusPageIOIntegration:
    ...
    Attributes:
        ...
        status_page_page_id (Union[Unset, str]):
        status_page_api_key (Union[Unset, str]):
    """
    ...
    status_page_page_id: Union[Unset, str] = UNSET
    status_page_api_key: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        status_page_page_id = self.status_page_page_id

        status_page_api_key = self.status_page_api_key
        ...
        if status_page_page_id is not UNSET:
            field_dict["statusPagePageId"] = status_page_page_id
        if status_page_api_key is not UNSET:
            field_dict["statusPageApiKey"] = status_page_api_key
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status_page_page_id = d.pop("statusPagePageId", UNSET)

        status_page_api_key = d.pop("statusPageApiKey", UNSET)

        status_page_io_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
            ...
            status_page_page_id=status_page_page_id,
            status_page_api_key=status_page_api_key,
        )

        status_page_io_integration.additional_properties = d
        return status_page_io_integration
