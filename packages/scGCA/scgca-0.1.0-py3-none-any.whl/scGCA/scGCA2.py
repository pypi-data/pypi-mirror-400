...
class scGCA2(nn.Module):
    ...
    def fit(self, xs, 
        ...
        use_jax
            ...
            the Python script or Jupyter notebook. It is OK if it is used when runing scGCA2 in the shell command.
        """
