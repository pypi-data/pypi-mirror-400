"""
System for tracking and accounting for nuclear material quantities and locations.
...
class MaterialAccountingSystem(GridSTIXDomainObject):
    """
    System for tracking and accounting for nuclear material quantities and locations.
    ...
    _properties = OrderedDict(
        [
            ...
            ("x_measures_at_point", ListProperty(StringProperty())),
        ]
    )

    def __init__(self, **kwargs: Any) -> None:
        """Initialize MaterialAccountingSystem with Grid-STIX properties."""
