...
T = TypeVar("T", bound="GetAuthorizationResponse404")


@_attrs_define
class GetAuthorizationResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_authorization_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_authorization_response_404.additional_properties = d
        return get_authorization_response_404
