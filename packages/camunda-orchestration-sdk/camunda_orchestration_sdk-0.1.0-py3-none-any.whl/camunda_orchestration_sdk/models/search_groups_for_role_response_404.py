...
T = TypeVar("T", bound="SearchGroupsForRoleResponse404")


@_attrs_define
class SearchGroupsForRoleResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_groups_for_role_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_groups_for_role_response_404.additional_properties = d
        return search_groups_for_role_response_404
