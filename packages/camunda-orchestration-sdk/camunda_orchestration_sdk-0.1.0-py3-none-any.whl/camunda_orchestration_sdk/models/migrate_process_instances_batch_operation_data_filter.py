...
if TYPE_CHECKING:
    ...
    from ..models.migrate_process_instances_batch_operation_data_filter_or_item import (
        MigrateProcessInstancesBatchOperationDataFilterOrItem,
    )
    from ..models.migrate_process_instances_batch_operation_data_filter_variables_item import (
...
T = TypeVar("T", bound="MigrateProcessInstancesBatchOperationDataFilter")


@_attrs_define
class MigrateProcessInstancesBatchOperationDataFilter:
    ...
    Attributes:
        ...
        variables (list[MigrateProcessInstancesBatchOperationDataFilterVariablesItem] | Unset): The process instance
            variables.
        ...
        or_ (list[MigrateProcessInstancesBatchOperationDataFilterOrItem] | Unset): Defines a list of alternative filter
    ...
    variables: (
        list[MigrateProcessInstancesBatchOperationDataFilterVariablesItem] | Unset
    ) = UNSET
    ...
    or_: list[MigrateProcessInstancesBatchOperationDataFilterOrItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _variables is not UNSET:
            ...
            for variables_item_data in _variables:
                variables_item = MigrateProcessInstancesBatchOperationDataFilterVariablesItem.from_dict(
                    variables_item_data
                )
        ...
        if _or_ is not UNSET:
            ...
            for or_item_data in _or_:
                or_item = (
                    MigrateProcessInstancesBatchOperationDataFilterOrItem.from_dict(
                        or_item_data
                    )
                )
        ...
        migrate_process_instances_batch_operation_data_filter = cls(
        ...
        migrate_process_instances_batch_operation_data_filter.additional_properties = d
        return migrate_process_instances_batch_operation_data_filter
