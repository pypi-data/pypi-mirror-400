...
if TYPE_CHECKING:
    ...
    from ..models.get_process_definition_statistics_data_filter_or_item_variables_item import (
...
T = TypeVar("T", bound="GetProcessDefinitionStatisticsDataFilterOrItem")


@_attrs_define
class GetProcessDefinitionStatisticsDataFilterOrItem:
    ...
    Attributes:
        ...
        variables (list[GetProcessDefinitionStatisticsDataFilterOrItemVariablesItem] | Unset): The process instance
            variables.
    ...
    variables: (
        list[GetProcessDefinitionStatisticsDataFilterOrItemVariablesItem] | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _variables is not UNSET:
            ...
            for variables_item_data in _variables:
                variables_item = GetProcessDefinitionStatisticsDataFilterOrItemVariablesItem.from_dict(
                    variables_item_data
                )
        ...
        get_process_definition_statistics_data_filter_or_item = cls(
        ...
        get_process_definition_statistics_data_filter_or_item.additional_properties = d
        return get_process_definition_statistics_data_filter_or_item
