...
@_attrs_define
class SearchUserTaskAuditLogsResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_user_task_audit_logs_response_200 = cls(
            page=page,
            items=items,
        )

        search_user_task_audit_logs_response_200.additional_properties = d
        return search_user_task_audit_logs_response_200
