...
from bb_integrations_lib.provider.api.kachoolie.client import KachoolieApiClient
...
class APIFactory:
    ...
    @_log_creation
    async def kachoolie(self, secret_name: str) -> KachoolieApiClient:
        return await self._make(secret_name, KachoolieApiClient)
