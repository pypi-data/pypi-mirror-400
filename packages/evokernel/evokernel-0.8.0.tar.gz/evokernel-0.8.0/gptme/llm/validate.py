...
# Provider documentation URLs - OpenRouter only
...
def validate_api_key(
    ...
    try:
        ...
        #     return True, ""
            ...
            # Unknown or non-OpenRouter provider
            logger.info(f"Only OpenRouter is supported. Provider: {provider}")
            return False, "Only OpenRouter is supported. Get a key at https://openrouter.ai/"
...
# Other provider validators commented out - OpenRouter only
