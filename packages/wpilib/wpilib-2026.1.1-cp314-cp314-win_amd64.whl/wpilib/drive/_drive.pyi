...
__all__: list[str] = ['DifferentialDrive', 'MecanumDrive', 'RobotDriveBase']
    ...
    * :meth:`curvatureDrive` is similar in concept to
    ...
    class WheelSpeeds:
        ...
        def right(self, arg0: typing.SupportsFloat) -> None:
            ...
    @staticmethod
    def arcadeDriveIK(xSpeed: typing.SupportsFloat, zRotation: typing.SupportsFloat, squareInputs: bool = True) -> DifferentialDrive.WheelSpeeds:
        """
        ...
        """
    @staticmethod
    def curvatureDriveIK(xSpeed: typing.SupportsFloat, zRotation: typing.SupportsFloat, allowTurnInPlace: bool) -> DifferentialDrive.WheelSpeeds:
        """
        ...
        """
    @staticmethod
    def tankDriveIK(leftSpeed: typing.SupportsFloat, rightSpeed: typing.SupportsFloat, squareInputs: bool = True) -> DifferentialDrive.WheelSpeeds:
        """
    ...
    def __init__(self, leftMotor: wpilib.interfaces._interfaces.MotorController, rightMotor: wpilib.interfaces._interfaces.MotorController) -> None:
        ...
        """
    @typing.overload
    def __init__(self, leftMotor: collections.abc.Callable[[typing.SupportsFloat], None], rightMotor: collections.abc.Callable[[typing.SupportsFloat], None]) -> None:
        """
        Construct a DifferentialDrive.
        ...
        """
    def arcadeDrive(self, xSpeed: typing.SupportsFloat, zRotation: typing.SupportsFloat, squareInputs: bool = True) -> None:
        """
        ...
        :param squareInputs: If set, decreases the input sensitivity at low speeds.
        """
    def curvatureDrive(self, xSpeed: typing.SupportsFloat, zRotation: typing.SupportsFloat, allowTurnInPlace: bool) -> None:
        """
    ...
    def stopMotor(self) -> None:
        ...
    def tankDrive(self, leftSpeed: typing.SupportsFloat, rightSpeed: typing.SupportsFloat, squareInputs: bool = True) -> None:
        """
...
class MecanumDrive(RobotDriveBase, wpiutil._wpiutil.Sendable):
    ...
    class WheelSpeeds:
        ...
        def frontLeft(self) -> float:
            ...
            """
        @frontLeft.setter
        def frontLeft(self, arg0: typing.SupportsFloat) -> None:
            ...
        @property
        def frontRight(self) -> float:
            ...
            """
        @frontRight.setter
        def frontRight(self, arg0: typing.SupportsFloat) -> None:
            ...
        @property
        def rearLeft(self) -> float:
            ...
            """
        @rearLeft.setter
        def rearLeft(self, arg0: typing.SupportsFloat) -> None:
            ...
        @property
        def rearRight(self) -> float:
            ...
            """
        @rearRight.setter
        def rearRight(self, arg0: typing.SupportsFloat) -> None:
            ...
    @staticmethod
    def driveCartesianIK(xSpeed: typing.SupportsFloat, ySpeed: typing.SupportsFloat, zRotation: typing.SupportsFloat, gyroAngle: wpimath.geometry._geometry.Rotation2d = ...) -> MecanumDrive.WheelSpeeds:
        """
    ...
    def __init__(self, frontLeftMotor: wpilib.interfaces._interfaces.MotorController, rearLeftMotor: wpilib.interfaces._interfaces.MotorController, frontRightMotor: wpilib.interfaces._interfaces.MotorController, rearRightMotor: wpilib.interfaces._interfaces.MotorController) -> None:
        ...
        """
    @typing.overload
    def __init__(self, frontLeftMotor: collections.abc.Callable[[typing.SupportsFloat], None], rearLeftMotor: collections.abc.Callable[[typing.SupportsFloat], None], frontRightMotor: collections.abc.Callable[[typing.SupportsFloat], None], rearRightMotor: collections.abc.Callable[[typing.SupportsFloat], None]) -> None:
        """
        Construct a MecanumDrive.
        ...
        """
    def driveCartesian(self, xSpeed: typing.SupportsFloat, ySpeed: typing.SupportsFloat, zRotation: typing.SupportsFloat, gyroAngle: wpimath.geometry._geometry.Rotation2d = ...) -> None:
        """
        ...
        :param gyroAngle: The gyro heading around the Z axis. Use this to implement
                          field-oriented controls.
        """
    def drivePolar(self, magnitude: typing.SupportsFloat, angle: wpimath.geometry._geometry.Rotation2d, zRotation: typing.SupportsFloat) -> None:
        """
        Drive method for Mecanum platform.
...
class RobotDriveBase(wpilib._wpilib.MotorSafety):
    ...
    @staticmethod
    def _desaturate(wheelSpeeds: list[typing.SupportsFloat]) -> None:
        """
    ...
    def getDescription(self) -> str:
        ...
    def setDeadband(self, deadband: typing.SupportsFloat) -> None:
        """
        ...
        """
    def setMaxOutput(self, maxOutput: typing.SupportsFloat) -> None:
        """
    ...
    def _m_deadband(self) -> float:
        ...
        """
    @_m_deadband.setter
    def _m_deadband(self, arg0: typing.SupportsFloat) -> None:
        ...
    @property
    def _m_maxOutput(self) -> float:
        ...
        """
    @_m_maxOutput.setter
    def _m_maxOutput(self, arg0: typing.SupportsFloat) -> None:
        ...
