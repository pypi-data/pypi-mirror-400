...
T = TypeVar("T", bound="DeleteProcessInstancesBatchOperationResponse500")


@_attrs_define
class DeleteProcessInstancesBatchOperationResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_process_instances_batch_operation_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_process_instances_batch_operation_response_500.additional_properties = d
        return delete_process_instances_batch_operation_response_500
