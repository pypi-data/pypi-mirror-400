...
async def sync_project_context():
    ...
    try:
        ...
        # Sync Knowledge Base (Enrichment)
        await sync_knowledge(client, project_id)
        
        # Sync Issues
        await sync_issues(client, project_id)
...
async def sync_knowledge(client, project_id: str):
    ...
    try:
        ...
        click.secho(f"❌ Failed to sync Knowledge Base: {e}", fg="red")
