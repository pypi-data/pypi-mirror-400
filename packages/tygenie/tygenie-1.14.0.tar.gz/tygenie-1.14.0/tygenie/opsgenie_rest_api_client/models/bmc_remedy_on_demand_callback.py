...
T = TypeVar("T", bound="BMCRemedyOnDemandCallback")


@_attrs_define
class BMCRemedyOnDemandCallback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bmc_remedy_on_demand_callback = cls(
        ...
        bmc_remedy_on_demand_callback.additional_properties = d
        return bmc_remedy_on_demand_callback
