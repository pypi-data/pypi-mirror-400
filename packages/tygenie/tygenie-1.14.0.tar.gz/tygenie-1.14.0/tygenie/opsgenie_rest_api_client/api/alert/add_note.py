...
from ...models.add_note_identifier_type import AddNoteIdentifierType
...
def _get_kwargs(
    ...
    *,
    ...
    identifier_type: Union[Unset, AddNoteIdentifierType] = AddNoteIdentifierType.ID,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        identifier (str):
        identifier_type (Union[Unset, AddNoteIdentifierType]):  Default: AddNoteIdentifierType.ID.
        body (AlertActionPayload):
