...
class MCPToolInfo(BaseModel):
    ...
    enabled: Optional[StrictBool] = Field(default=None, description="Whether the tool is enabled")
    __properties: ClassVar[List[str]] = ["name", "title", "description", "input_schema", "enabled"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MCPToolInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MCPToolInfo from a dict"""
        if obj is None:
            return None
