...
T = TypeVar("T", bound="SearchMappingRuleDataFilter")


@_attrs_define
class SearchMappingRuleDataFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_mapping_rule_data_filter = cls(
        ...
        search_mapping_rule_data_filter.additional_properties = d
        return search_mapping_rule_data_filter
