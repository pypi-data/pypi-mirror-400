...
T = TypeVar("T", bound="GetProcessDefinitionStatisticsResponse200ItemsItem")


@_attrs_define
class GetProcessDefinitionStatisticsResponse200ItemsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_process_definition_statistics_response_200_items_item = cls(
        ...
        get_process_definition_statistics_response_200_items_item.additional_properties = d
        return get_process_definition_statistics_response_200_items_item
