...
from ..models.state_advancedfilter_2_eq import StateAdvancedfilter2Eq
...
@_attrs_define
class StateAdvancedfilter2:
    r"""Advanced DecisionInstanceStateEnum filter.

    Attributes:
        eq (StateAdvancedfilter2Eq | Unset): Checks for equality with the provided value.
        neq (StateAdvancedfilter2Neq | Unset): Checks for inequality with the provided value.
        exists (bool | Unset): Checks if the current property exists.
        in_ (list[StateAdvancedfilter2InItem] | Unset): Checks if the property matches any of the provided values.
        not_in (list[StateAdvancedfilter2NotInItem] | Unset): Checks if the property matches none of the provided
            values.
    ...
    eq: StateAdvancedfilter2Eq | Unset = UNSET
    neq: StateAdvancedfilter2Neq | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        _eq = d.pop("$eq", UNSET)
        eq: StateAdvancedfilter2Eq | Unset
        if isinstance(_eq, Unset):
            eq = UNSET
        else:
            eq = StateAdvancedfilter2Eq(_eq)

        _neq = d.pop("$neq", UNSET)
        neq: StateAdvancedfilter2Neq | Unset
        if isinstance(_neq, Unset):
            neq = UNSET
        else:
            neq = StateAdvancedfilter2Neq(_neq)
        ...
        if _in_ is not UNSET:
            ...
            for in_item_data in _in_:
                in_item = StateAdvancedfilter2InItem(in_item_data)
        ...
        if _not_in is not UNSET:
            ...
            for not_in_item_data in _not_in:
                not_in_item = StateAdvancedfilter2NotInItem(not_in_item_data)

                not_in.append(not_in_item)

        like = d.pop("$like", UNSET)

        state_advancedfilter_2 = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        state_advancedfilter_2.additional_properties = d
        return state_advancedfilter_2
