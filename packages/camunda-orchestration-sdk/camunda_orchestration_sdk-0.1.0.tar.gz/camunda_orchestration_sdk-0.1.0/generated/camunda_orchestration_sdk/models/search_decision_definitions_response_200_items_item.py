...
T = TypeVar("T", bound="SearchDecisionDefinitionsResponse200ItemsItem")


@_attrs_define
class SearchDecisionDefinitionsResponse200ItemsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_decision_definitions_response_200_items_item = cls(
        ...
        search_decision_definitions_response_200_items_item.additional_properties = d
        return search_decision_definitions_response_200_items_item
