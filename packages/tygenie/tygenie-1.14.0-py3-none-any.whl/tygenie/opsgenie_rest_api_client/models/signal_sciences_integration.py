...
T = TypeVar("T", bound="SignalSciencesIntegration")
...
class SignalSciencesIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        signal_sciences_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        signal_sciences_integration.additional_properties = d
        return signal_sciences_integration
