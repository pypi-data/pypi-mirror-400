...
@final
class Diff_MotionMagicExpoVoltage_Velocity:
    """
    ...
    def __init__(self, average_request: MotionMagicExpoVoltage, differential_request: VelocityVoltage):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_MotionMagicExpoVoltage_Velocity"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicExpoVoltage_Velocity")
    ...
    def with_average_request(self, new_average_request: MotionMagicExpoVoltage) -> 'Diff_MotionMagicExpoVoltage_Velocity':
        ...
        :returns: Itself
        :rtype: Diff_MotionMagicExpoVoltage_Velocity
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: VelocityVoltage) -> 'Diff_MotionMagicExpoVoltage_Velocity':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicExpoVoltage_Velocity':
        """
