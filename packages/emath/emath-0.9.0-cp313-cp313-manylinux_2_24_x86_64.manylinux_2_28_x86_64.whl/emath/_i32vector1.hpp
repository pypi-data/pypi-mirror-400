...
static PyObject *
I32Vector1Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(int32_t) * 1;
...
static PyMethodDef I32Vector1Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)I32Vector1Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
