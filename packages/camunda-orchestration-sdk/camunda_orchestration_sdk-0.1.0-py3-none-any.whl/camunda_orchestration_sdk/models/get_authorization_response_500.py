...
T = TypeVar("T", bound="GetAuthorizationResponse500")


@_attrs_define
class GetAuthorizationResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_authorization_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_authorization_response_500.additional_properties = d
        return get_authorization_response_500
