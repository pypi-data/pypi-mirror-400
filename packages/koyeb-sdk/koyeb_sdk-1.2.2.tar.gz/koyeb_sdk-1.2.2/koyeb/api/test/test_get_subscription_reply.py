    ...
    def make_instance(self, include_optional) -> GetSubscriptionReply:
        ...
        if include_optional:
            return GetSubscriptionReply(
                subscription = koyeb.api.models.subscription.Subscription(
                    id = '', 
                    ...
                    amount_paid = '', 
                    amount_remaining = '', 
                    payment_failure = koyeb.api.models.subscription/payment_failure.Subscription.PaymentFailure(
                        ...
                        redirect_url = '', 
                        stripe_sdk = koyeb.api.models.subscription/payment_failure/stripe_sdk.Subscription.PaymentFailure.StripeSDK(
                            client_secret_key = '', 
                            raw_json = '', ), ), 
                    trialing = True, 
