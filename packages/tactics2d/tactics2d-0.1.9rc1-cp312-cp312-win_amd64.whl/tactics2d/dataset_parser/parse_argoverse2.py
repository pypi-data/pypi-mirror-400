...
"""Argoverse 2 parser implementation."""
...
class Argoverse2Parser:
    """This class implements a parser for Argoverse 2 dataset. The default size of the participants are referred to the [official visualization toolkit](https://github.com/argoverse/av2-api/blob/main/src/av2/datasets/motion_forecasting/viz/scenario_visualization.py).
