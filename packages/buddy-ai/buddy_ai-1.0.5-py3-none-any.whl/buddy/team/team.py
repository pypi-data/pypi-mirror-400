...
from buddy.agent.metrics import SessionMetrics
from buddy.exceptions import ModelProviderError, RunCancelledException
from buddy.knowledge.agent import AgentKnowledge
from buddy.media import Audio, AudioArtifact, AudioResponse, File, Image, ImageArtifact, Video, VideoArtifact
from buddy.memory.agent import AgentMemory
from buddy.memory.team import TeamMemory, TeamRun
from buddy.memory.v2.memory import Memory, SessionSummary
...
from buddy.reasoning.step import NextAction, ReasoningStep, ReasoningSteps
from buddy.run.base import RunResponseExtraData, RunStatus
from buddy.run.messages import RunMessages
from buddy.run.response import RunEvent, RunResponse, RunResponseEvent
from buddy.run.team import TeamRunEvent, TeamRunResponse, TeamRunResponseEvent, ToolCallCompletedEvent
...
from buddy.utils.events import (
...
from buddy.utils.message import get_text_from_message
from buddy.utils.response import (
...
from buddy.utils.safe_formatter import SafeFormatter
from buddy.utils.string import is_valid_uuid, parse_response_model_str, url_safe_string
...
class Team:
    ...
    # monitoring=True logs Team information to buddy.com for monitoring
    ...
    def _set_monitoring(self) -> None:
        ...
        telemetry_env = getenv("BUDDY_TELEMETRY")
    ...
    def _set_default_model(self) -> None:
        ...
        if self.model is None:
            try:
                ...
                log_exception(e)
                log_error(
                    "Buddy agents use `openai` as the default model provider. "
    ...
    def _run_stream(
        ...
        if self.output_model is None:
            ...
            for event in self._handle_model_response_stream(
                ...
                from buddy.run.team import IntermediateRunResponseContentEvent, RunResponseContentEvent
    ...
    def _print_response(
        ...
        **kwargs: Any,
        ...
        from buddy.utils.response import format_tool_calls
    ...
    def _reason(
        ...
        if reasoning_model_provided:
            from buddy.reasoning.azure_ai_foundry import is_ai_foundry_reasoning_model
            from buddy.reasoning.deepseek import is_deepseek_reasoning_model
            from buddy.reasoning.groq import is_groq_reasoning_model
            from buddy.reasoning.helpers import get_reasoning_agent
            from buddy.reasoning.ollama import is_ollama_reasoning_model
            from buddy.reasoning.openai import is_openai_reasoning_model
            ...
            if is_deepseek or is_groq or is_openai or is_ollama or is_ai_foundry:
                ...
                if is_deepseek:
                    from buddy.reasoning.deepseek import get_deepseek_reasoning
                    ...
                    from buddy.reasoning.groq import get_groq_reasoning
                    ...
                    from buddy.reasoning.openai import get_openai_reasoning
                    ...
                    from buddy.reasoning.ollama import get_ollama_reasoning
                    ...
                    from buddy.reasoning.azure_ai_foundry import get_ai_foundry_reasoning
        ...
        if use_default_reasoning:
            from buddy.reasoning.default import get_default_reasoning_agent
            from buddy.reasoning.helpers import get_next_action, update_messages_with_reasoning
    ...
    async def _areason(
        ...
        if reasoning_model_provided:
            ...
            if is_deepseek or is_groq or is_openai or is_ollama or is_ai_foundry:
                reasoning_message: Optional[Message] = None
                if is_deepseek:
                    from buddy.reasoning.deepseek import aget_deepseek_reasoning
                    ...
                    from buddy.reasoning.groq import aget_groq_reasoning
                    ...
                    from buddy.reasoning.openai import aget_openai_reasoning
    ...
    def get_system_message(
        ...
        if self.add_location_to_instructions:
            from buddy.utils.location import get_location
            ...
            if isinstance(self.memory, TeamMemory):
                try:
                    ...
                    if "memories" in session.memory:
                        from buddy.memory.memory import Memory as UserMemoryV1
                ...
                if "team_context" in session.memory:
                    from buddy.memory.v2.memory import TeamContext
                ...
                if "memories" in session.memory:
                    if self.memory.memories is not None:
                        ...
                        from buddy.memory.v2.memory import UserMemory as UserMemoryV2
                ...
                if "summaries" in session.memory:
                    if self.memory.summaries is not None:
                        ...
                        from buddy.memory.v2.memory import SessionSummary as SessionSummaryV2
    ...
    def _add_reasoning_step_to_extra_data(self, run_response: TeamRunResponse, reasoning_step: ReasoningStep) -> None:
        if run_response.extra_data is None:
            from buddy.run.response import RunResponseExtraData
    ...
    def _log_team_run(self, session_id: str, user_id: Optional[str] = None) -> None:
        ...
        from buddy.api.team import TeamRunCreate, create_team_run
    ...
    async def _alog_team_run(self, session_id: str, user_id: Optional[str] = None) -> None:
        ...
        from buddy.api.team import TeamRunCreate, acreate_team_run
    ...
    def _log_team_session(self, session_id: str, user_id: Optional[str] = None):
        ...
        from buddy.api.team import TeamSessionCreate, upsert_team_session
