...
class BuildAssemblyListParams(TypedDict, total=False):
    ...
    **NOTE**: If any of the values you specify in this parameter are not found, the
    ...
    pending_status: Annotated[Literal["all", "not_pending", "pending"], PropertyInfo(alias="pendingStatus")]
    ...
    **NOTE**: If you use this parameter, you cannot also use `refNumberContains` or
    ...
    """
    Filter for build assemblies whose `refNumber` is greater than or equal to this
    ...
    **NOTE**: If you use this parameter, you cannot also use `refNumberContains` or
    ...
    """
    Filter for build assemblies whose `refNumber` is less than or equal to this
    ...
    """
    Filter for build assemblies whose `date` field is on or after this date, in ISO
    ...
    **NOTE:** QuickBooks Desktop interprets this date as the **start of the
    ...
    """
    Filter for build assemblies whose `date` field is on or before this date, in ISO
    8601 format (YYYY-MM-DD).
    ...
    **NOTE:** QuickBooks Desktop interprets this date as the **end of the specified
    ...
    """Filter for build assemblies updated on or after this date/time.
    ...
    """Filter for build assemblies updated on or before this date/time.
