"""
Application-layer protocol for DER control and monitoring, also known as Smart Energy Profile 2 (SEP2). Includes embedded security features.
...
class Ieee20305(GridSTIXDomainObject):
    """
    Application-layer protocol for DER control and monitoring, also known as Smart Energy Profile 2 (SEP2). Includes embedded security features.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize Ieee20305 with Grid-STIX properties."""
