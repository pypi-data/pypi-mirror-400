...
The BMI-HDEEG dataset 1 (OpenNeuro ``ds004444``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 1` :bdg-light:`License: CC0` :bdg-light:`Subjects: 30` :bdg-light:`Recordings: 465` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds004444.v1.0.1 <https://doi.org/10.18112/openneuro.ds004444.v1.0.1>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds004444>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds004444>`__
