...
@click.command()
@click.option("--parent-id", help="The parent Asset ID for the parent folder.")
@click.option("--url", help="The Nomad URL of the parent Asset folder (bucket::object-key).")
@click.option("--object-key", help="Object-key of the parent Asset folder. This option assumes the default bucket that was previously set with the `set-bucket` command.")
