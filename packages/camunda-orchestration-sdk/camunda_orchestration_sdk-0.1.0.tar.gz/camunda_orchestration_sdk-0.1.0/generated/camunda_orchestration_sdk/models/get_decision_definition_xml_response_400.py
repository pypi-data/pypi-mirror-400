...
T = TypeVar("T", bound="GetDecisionDefinitionXMLResponse400")


@_attrs_define
class GetDecisionDefinitionXMLResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_decision_definition_xml_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_decision_definition_xml_response_400.additional_properties = d
        return get_decision_definition_xml_response_400
