...
T = TypeVar("T", bound="AssignRoleToUserResponse503")


@_attrs_define
class AssignRoleToUserResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assign_role_to_user_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        assign_role_to_user_response_503.additional_properties = d
        return assign_role_to_user_response_503
