...
class ScreenshotData(BaseModel):
    ...
    ScreenshotData
    """ # noqa: E501
    screenshot_url: Optional[StrictStr] = Field(default=None, description="URL to screenshot")
    screenshot_path: Optional[StrictStr] = Field(default=None, description="Path to screenshot file")
    __properties: ClassVar[List[str]] = ["screenshot_url", "screenshot_path"]
