...
T = TypeVar("T", bound="AppOpticsIntegration")


@_attrs_define
class AppOpticsIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        app_optics_integration.additional_properties = d
        return app_optics_integration
