...
T = TypeVar("T", bound="GetGroupResponse403")


@_attrs_define
class GetGroupResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_group_response_403.additional_properties = d
        return get_group_response_403
