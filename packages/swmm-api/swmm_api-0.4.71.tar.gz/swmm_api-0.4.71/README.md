...
see [examples/inp_file_reader.ipynb](https://gitlab.com/markuspichler/swmm_api/-/blob/main/examples/inp_file_reader.ipynb) ([see in docs](https://markuspichler.gitlab.io/swmm_api/examples/inp_file_reader.html))

see [examples/inp_file_structure.ipynb](https://gitlab.com/markuspichler/swmm_api/-/blob/main/examples/inp_file_structure.ipynb) ([see in docs](https://markuspichler.gitlab.io/swmm_api/examples/inp_file_structure.html))

see [examples/inp_file_macros.ipynb](https://gitlab.com/markuspichler/swmm_api/-/blob/main/examples/inp_file_macros.ipynb) for plotting the model on a map or as a longitudinal plot. ([see in docs](https://markuspichler.gitlab.io/swmm_api/examples/inp_file_macros.html))
...
Run SWMM with a specified executable. (You can set a default SWMM exe using the CONFIG object or a config file, see [below](#configuration))
...
see [examples/how_to_run_swmm.ipynb](https://gitlab.com/markuspichler/swmm_api/-/blob/main/examples/how_to_run_swmm.ipynb) ([see in docs](https://markuspichler.gitlab.io/swmm_api/examples/how_to_run_swmm.html))
...
```
see [examples/out_file_reader.ipynb](https://gitlab.com/markuspichler/swmm_api/-/blob/main/examples/out_file_reader.ipynb) ([see in docs](https://markuspichler.gitlab.io/swmm_api/examples/out_file_reader.html))
...
```
see [examples/rpt_file_reader.ipynb](https://gitlab.com/markuspichler/swmm_api/-/blob/main/examples/rpt_file_reader.ipynb) ([see in docs](https://markuspichler.gitlab.io/swmm_api/examples/rpt_file_reader.html))
...
`swmm_api` includes a global configuration system (`CONFIG`) that allows users to define and customize default parameters used throughout the package. Typical examples include file encoding, number formatting for GIS data, the path to the SWMM executable, and default coordinate reference systems. These settings can be changed during runtime, saved to a configuration file, or temporarily overridden for specific operations.

A detailed tutorial with explanations and examples is provided in the Jupyter notebook [examples/how_to_use_config.ipynb](https://gitlab.com/markuspichler/swmm_api/-/blob/main/examples/how_to_use_config.ipynb)  ([see in docs](https://markuspichler.gitlab.io/swmm_api/examples/how_to_use_config.html)).
...
15. Koslowski, J., Campbell, E., Stapf, M., Gürtler, H., Gunkel, M., & Gnirss, R. (2025). SWEET HEAT Modelling Wastewater Temperatures for Efficient Wastewater Heat Recovery. The University of Sheffield. <https://doi.org/10.15131/shef.data.29920913.v1>
