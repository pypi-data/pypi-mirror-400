...
#ifndef ALGO_GNOMON_GNOMON_PARAMS_BASE_HPP
#define ALGO_GNOMON_GNOMON_PARAMS_BASE_HPP
...
/////////////////////////////////////////////////////////////////////////////
class NCBI_XALGOGNOMON_EXPORT CGnomon_params_Base : public CSerialObject
{
    typedef CSerialObject Tparent;
public:
    // constructor
    CGnomon_params_Base(void);
    // destructor
    virtual ~CGnomon_params_Base(void);

    // type info
    DECLARE_INTERNAL_TYPE_INFO();

    // types
    typedef list< CRef< CGnomon_param > > Tdata;
...
private:
    ...
    CGnomon_params_Base(const CGnomon_params_Base&);
    CGnomon_params_Base& operator=(const CGnomon_params_Base&);

    // data
    Uint4 m_set_State[1];
    list< CRef< CGnomon_param > > m_data;
};
...
#endif // ALGO_GNOMON_GNOMON_PARAMS_BASE_HPP
