    ...
    try:
        ...
        for acc in accounts:
            ...
            if kyma and kyma.status == 'OK':
                ...
                mem_str = f"{kyma.memory_used_mb or 0}M"
...
def account_info(identifier):
    ...
    try:
        ...
        if kyma:
            ...
            click.echo(f"内存: {kyma.memory_used_mb or 0}/{kyma.memory_limit_mb}M")
        ...
        if cf:
            ...
            click.echo(f"内存: {cf.memory_used_mb or 0}/{cf.memory_quota_mb}M")
