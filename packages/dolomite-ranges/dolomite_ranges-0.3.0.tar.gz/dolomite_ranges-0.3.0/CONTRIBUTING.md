...
Welcome to `dolomite-ranges` contributor's guide.
...
If you experience bugs or general issues with `dolomite-ranges`, please have a look
...
You can help improve `dolomite-ranges` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`dolomite-ranges` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `dolomite-ranges`'s files. While this mechanism can
...
```
conda create -n dolomite-ranges python=3 six virtualenv pytest pytest-cov
conda activate dolomite-ranges
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/dolomite-ranges.git
   cd dolomite-ranges
   ```
...
5. Install [pre-commit]:
   ...
   `dolomite-ranges` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/dolomite-ranges
[issue tracker]: https://github.com/<USERNAME>/dolomite-ranges/issues
