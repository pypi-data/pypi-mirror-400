...
T = TypeVar("T", bound="DynatraceAppMonIntegration")


@_attrs_define
class DynatraceAppMonIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        dynatrace_app_mon_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        dynatrace_app_mon_integration.additional_properties = d
        return dynatrace_app_mon_integration
