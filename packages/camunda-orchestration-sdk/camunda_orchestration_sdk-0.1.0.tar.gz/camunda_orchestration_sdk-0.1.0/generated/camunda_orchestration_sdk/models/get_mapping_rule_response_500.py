...
T = TypeVar("T", bound="GetMappingRuleResponse500")


@_attrs_define
class GetMappingRuleResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_mapping_rule_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_mapping_rule_response_500.additional_properties = d
        return get_mapping_rule_response_500
