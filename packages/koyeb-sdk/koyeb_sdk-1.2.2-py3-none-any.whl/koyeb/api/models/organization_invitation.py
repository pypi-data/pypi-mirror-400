...
class OrganizationInvitation(BaseModel):
    ...
    status: Optional[OrganizationInvitationStatus] = (
        ...
        _obj = cls.model_validate(
            {
                ...
                "organization": (
                    PublicOrganization.from_dict(obj["organization"])
                    if obj.get("organization") is not None
                    else None
                ),
                "invitee_id": obj.get("invitee_id"),
                "invitee": (
                    PublicUser.from_dict(obj["invitee"])
                    if obj.get("invitee") is not None
                    else None
                ),
                "inviter_id": obj.get("inviter_id"),
                "inviter": (
                    PublicUser.from_dict(obj["inviter"])
