...
T = TypeVar("T", bound="GetTenantClusterVariableResponse400")


@_attrs_define
class GetTenantClusterVariableResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_tenant_cluster_variable_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_tenant_cluster_variable_response_400.additional_properties = d
        return get_tenant_cluster_variable_response_400
