...
async def _extract_data_from_page(
    *,
    ...
    # Handle edge case where max_retries is 0 or negative
    if max_retries <= 0:
        raise RuntimeError(f"Max retries of {max_retries} exceeded for extraction")
    ...
    # This should never be reached - all paths either return or raise
