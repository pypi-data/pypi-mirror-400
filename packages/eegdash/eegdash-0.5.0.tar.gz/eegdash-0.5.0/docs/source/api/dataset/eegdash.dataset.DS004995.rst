...
The Time-Course of Food Representation in the Human Brain (OpenNeuro ``ds004995``). Access recordings and metadata through EEGDash.
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds004995.v1.0.2 <https://doi.org/10.18112/openneuro.ds004995.v1.0.2>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds004995>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds004995>`__
