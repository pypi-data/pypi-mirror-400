...
function SolidShell(props: { onExit?: () => void }) {
  ...
  useKeyboard((evt) => {
    ...
    // Results: allow with or without shift (people often hold shift accidentally).
    // Sessions remains Shift+O but only inside the Agent/OpenCode pane.
    if (evt.name === "o") {
      evt.preventDefault()
      openResultsModal()
      return
        ...
        <Show 
          ...
          fallback={
            <box flexDirection="row" gap={1}>
              ...
              <text fg={COLORS.textDim}>|</text>
              <KeyHint description="results" keyLabel="o" />
              <text fg={COLORS.textDim}>|</text>
