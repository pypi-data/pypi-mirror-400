...
T = TypeVar("T", bound="SearchMappingRulesForGroupResponse401")


@_attrs_define
class SearchMappingRulesForGroupResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_mapping_rules_for_group_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_mapping_rules_for_group_response_401.additional_properties = d
        return search_mapping_rules_for_group_response_401
