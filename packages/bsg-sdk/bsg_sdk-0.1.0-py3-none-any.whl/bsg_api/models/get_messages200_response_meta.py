...
class GetMessages200ResponseMeta(BaseModel):
    """
    Information about search criteria and total results count
    """ # noqa: E501
    page: Optional[GetMessages200ResponseMetaPage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "page": GetMessages200ResponseMetaPage.from_dict(obj["page"]) if obj.get("page") is not None else None
        })
        return _obj
