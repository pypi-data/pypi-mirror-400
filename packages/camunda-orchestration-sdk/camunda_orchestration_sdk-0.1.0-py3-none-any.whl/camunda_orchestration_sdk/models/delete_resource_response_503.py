...
T = TypeVar("T", bound="DeleteResourceResponse503")


@_attrs_define
class DeleteResourceResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_resource_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_resource_response_503.additional_properties = d
        return delete_resource_response_503
