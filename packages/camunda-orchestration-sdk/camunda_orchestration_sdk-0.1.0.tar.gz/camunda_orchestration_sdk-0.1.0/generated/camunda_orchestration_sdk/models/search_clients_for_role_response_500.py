...
T = TypeVar("T", bound="SearchClientsForRoleResponse500")


@_attrs_define
class SearchClientsForRoleResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_clients_for_role_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_clients_for_role_response_500.additional_properties = d
        return search_clients_for_role_response_500
