...
if TYPE_CHECKING:
    ...
    from ..models.cancel_process_instances_batch_operation_data_filter_or_item import (
        CancelProcessInstancesBatchOperationDataFilterOrItem,
    )
    from ..models.cancel_process_instances_batch_operation_data_filter_variables_item import (
...
T = TypeVar("T", bound="CancelProcessInstancesBatchOperationDataFilter")


@_attrs_define
class CancelProcessInstancesBatchOperationDataFilter:
    ...
    Attributes:
        ...
        variables (list[CancelProcessInstancesBatchOperationDataFilterVariablesItem] | Unset): The process instance
            variables.
        ...
        or_ (list[CancelProcessInstancesBatchOperationDataFilterOrItem] | Unset): Defines a list of alternative filter
    ...
    variables: (
        list[CancelProcessInstancesBatchOperationDataFilterVariablesItem] | Unset
    ) = UNSET
    ...
    or_: list[CancelProcessInstancesBatchOperationDataFilterOrItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _variables is not UNSET:
            ...
            for variables_item_data in _variables:
                variables_item = CancelProcessInstancesBatchOperationDataFilterVariablesItem.from_dict(
                    variables_item_data
                )
        ...
        if _or_ is not UNSET:
            ...
            for or_item_data in _or_:
                or_item = (
                    CancelProcessInstancesBatchOperationDataFilterOrItem.from_dict(
                        or_item_data
                    )
                )
        ...
        cancel_process_instances_batch_operation_data_filter = cls(
        ...
        cancel_process_instances_batch_operation_data_filter.additional_properties = d
        return cancel_process_instances_batch_operation_data_filter
