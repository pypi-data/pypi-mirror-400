...
T = TypeVar("T", bound="NagiosBasedV1Callback")


@_attrs_define
class NagiosBasedV1Callback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nagios_based_v1_callback.additional_properties = d
        return nagios_based_v1_callback
