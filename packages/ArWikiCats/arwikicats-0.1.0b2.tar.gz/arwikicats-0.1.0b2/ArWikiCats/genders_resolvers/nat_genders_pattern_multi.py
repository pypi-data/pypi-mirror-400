...
def generate_jobs_data_dict():
    ...
    # "[ا-ي]+ون* و[ا-ي]+ات"
    jobs_data_new = {
        "bobsledders": {"job_males": "متزلجون جماعيون", "job_females": "متزلجات جماعيات", "both_jobs": "متزلجون ومتزلجات جماعيون"},
        ...
        "classical composers": {"job_males": "ملحنون كلاسيكيون", "job_females": "ملحنات كلاسيكيات", "both_jobs": "ملحنون وملحنات كلاسيكيون"},
        ...
        "guitarists": {"job_males": "عازفو قيثارة", "job_females": "عازفات قيثارة", "both_jobs": "عازفو وعازفات قيثارة"},
        "singers": {"job_males": "مغنون", "job_females": "مغنيات", "both_jobs": "مغنون ومغنيات"},
        "television actors": {"job_males": "ممثلو تلفاز", "job_females": "ممثلات تلفاز", "both_jobs": "ممثلو وممثلات تلفاز"},
    }
