    ...
    def _get_logo_from_config(self, logo_key: str) -> str:
        ...
        try:
            ...
            if logo_data and logo_data.startswith("data:image"):
                return logo_data
            elif logo_data and os.path.exists(logo_data):
...
<body>
    <div class="container">
        ...
        {self._generate_charts_section(summary) if self.config['charts']['enabled'] else ''}
            ...
            <div class="header-content">
                <div class="header-layout">
                    ...
                    <div class="main-title">
                        <div class="primary-logo-circle">
                            {f'<img src="{primary_logo}" alt="Primary Logo" class="primary-img">' if primary_logo else '<span class="primary-fallback">🥋</span>'}
                        </div>
    ...
    def _generate_footer(self) -> str:
        ...
        # Usar logo principal o fallback
        logo_html = f'<img src="{self.primary_logo_b64}" alt="Logo" class="primary-logo-footer">' if self.primary_logo_b64 else '<span class="primary-fallback-footer">🥋</span>'
        ...
        if footer_config['show_creator']:
            footer_html += f"""
                <div class="footer-logo">
                    {logo_html}
                    <span class="footer-text">Framework creado por {footer_config['creator_name']} - </span>
                    <a href="mailto:{footer_config['creator_email']}" class="footer-email">{footer_config['creator_email']}</a>
                </div>
            """
        ...
        document.addEventListener('DOMContentLoaded', function() {{
            ...
            if (document.getElementById('comparisonChart')) {{
                ...
                new Chart(comparisonCtx, {{
                    type: 'bar',
                    data: {{
                        labels: ['Escenarios', 'Pasos'],
                        datasets: [{{
                            label: 'Exitosos',
                            data: [{summary['scenario_counts']['passed']}, {summary['step_counts']['passed']}],
                            backgroundColor: '{chart_colors['passed']}',
                            borderColor: '{chart_colors['passed']}',
                            borderWidth: 1
                        }}, {{
                            label: 'Fallidos',
                            data: [{summary['scenario_counts']['failed']}, {summary['step_counts']['failed']}],
                            backgroundColor: '{chart_colors['failed']}',
                            borderColor: '{chart_colors['failed']}',
                            borderWidth: 1
                        }}, {{
                            label: 'Omitidos',
                            data: [{summary['scenario_counts']['skipped']}, {summary['step_counts']['skipped']}],
                            backgroundColor: '{chart_colors['skipped']}',
