...
A Resting-state EEG Dataset for Sleep Deprivation (OpenNeuro ``ds004902``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 2` :bdg-light:`License: CC0` :bdg-light:`Subjects: 71` :bdg-light:`Recordings: 218` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds004902.v1.0.8 <https://doi.org/10.18112/openneuro.ds004902.v1.0.8>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds004902>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds004902>`__
