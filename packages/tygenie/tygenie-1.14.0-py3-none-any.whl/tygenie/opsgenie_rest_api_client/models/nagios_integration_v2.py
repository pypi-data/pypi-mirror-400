...
T = TypeVar("T", bound="NagiosIntegrationV2")


@_attrs_define
class NagiosIntegrationV2:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nagios_integration_v2.additional_properties = d
        return nagios_integration_v2
