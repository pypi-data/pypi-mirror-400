...
static PyObject *
DVector3Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(double) * 3;
...
static PyMethodDef DVector3Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)DVector3Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
