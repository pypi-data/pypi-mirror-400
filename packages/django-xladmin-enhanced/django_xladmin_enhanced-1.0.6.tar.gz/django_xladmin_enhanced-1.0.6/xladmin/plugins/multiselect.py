...
from xladmin.util import vendor
...
class SelectMultipleTransfer(forms.SelectMultiple):
    ...
    @property
    def media(self):
        return vendor('xladmin.widget.select-transfer.js', 'xladmin.widget.select-transfer.css')
    ...
    def render(self, name, value, attrs=None, choices=()):
        ...
        return mark_safe(loader.render_to_string('xladmin/forms/transfer.html', context))
...
class SelectMultipleDropdown(forms.SelectMultiple):
    ...
    @property
    def media(self):
        return vendor('multiselect.js', 'multiselect.css', 'xladmin.widget.multiselect.js')
...
xladmin.site.register_plugin(M2MSelectPlugin, ModelFormAdminView)
