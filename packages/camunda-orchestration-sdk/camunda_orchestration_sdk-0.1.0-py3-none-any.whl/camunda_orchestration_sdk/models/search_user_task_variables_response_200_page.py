...
T = TypeVar("T", bound="SearchUserTaskVariablesResponse200Page")


@_attrs_define
class SearchUserTaskVariablesResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_user_task_variables_response_200_page = cls(
        ...
        search_user_task_variables_response_200_page.additional_properties = d
        return search_user_task_variables_response_200_page
