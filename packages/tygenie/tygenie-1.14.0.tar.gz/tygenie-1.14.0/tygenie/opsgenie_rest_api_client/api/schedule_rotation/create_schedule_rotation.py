...
from ...models.create_schedule_rotation_schedule_identifier_type import CreateScheduleRotationScheduleIdentifierType
...
def _get_kwargs(
    identifier: str,
    *,
    body: CreateScheduleRotationPayload,
    schedule_identifier_type: Union[
        Unset, CreateScheduleRotationScheduleIdentifierType
    ] = CreateScheduleRotationScheduleIdentifierType.ID,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        identifier (str):
        schedule_identifier_type (Union[Unset, CreateScheduleRotationScheduleIdentifierType]):
            Default: CreateScheduleRotationScheduleIdentifierType.ID.
        body (CreateScheduleRotationPayload):
