    ...
    def make_instance(self, include_optional) -> PostPatchRateRequestRatesInner:
        ...
        if include_optional:
            return PostPatchRateRequestRatesInner(
                rate_id = '',
                interval = cloudbeds_pms_v1_3.models.post_patch_rate_request_rates_inner_interval.PostPatchRateRequest_rates_inner_interval(
                    ...
                    blocked = True, 
                    guest_pricing = cloudbeds_pms_v1_3.models.post_create_allotment_block_request_allotment_intervals_inner_availability_inner_guest_pricing.PostCreateAllotmentBlockRequest_allotmentIntervals_inner_availability_inner_guestPricing(
                        adult1 = '', 
                        adult2 = '', 
                        adult3 = '', 
                        child1 = '', 
