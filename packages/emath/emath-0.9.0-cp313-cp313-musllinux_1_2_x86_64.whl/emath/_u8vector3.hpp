...
static PyObject *
U8Vector3Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(uint8_t) * 3;
...
static PyMethodDef U8Vector3Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)U8Vector3Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
