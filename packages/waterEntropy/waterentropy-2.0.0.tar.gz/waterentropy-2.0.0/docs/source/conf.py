#
# Sphinx configuration for waterEntropy
#
...
release = waterEntropy.__version__
...
# of the sidebar.
html_logo = "images/waterentropy_logo_grey.png"
...
html_use_opensearch = "http://waterentropy.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "waterEntropy")
