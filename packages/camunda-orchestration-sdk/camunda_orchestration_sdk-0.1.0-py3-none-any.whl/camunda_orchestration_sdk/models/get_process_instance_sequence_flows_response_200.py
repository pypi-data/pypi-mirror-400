...
T = TypeVar("T", bound="GetProcessInstanceSequenceFlowsResponse200")


@_attrs_define
class GetProcessInstanceSequenceFlowsResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_process_instance_sequence_flows_response_200 = cls(
            items=items,
        )

        get_process_instance_sequence_flows_response_200.additional_properties = d
        return get_process_instance_sequence_flows_response_200
