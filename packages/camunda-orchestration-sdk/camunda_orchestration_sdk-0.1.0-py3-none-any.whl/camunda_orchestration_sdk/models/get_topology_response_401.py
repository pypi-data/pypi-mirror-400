...
T = TypeVar("T", bound="GetTopologyResponse401")


@_attrs_define
class GetTopologyResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_topology_response_401.additional_properties = d
        return get_topology_response_401
