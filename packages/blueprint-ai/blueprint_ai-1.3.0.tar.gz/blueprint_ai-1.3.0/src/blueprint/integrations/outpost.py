...
if __name__ == "__main__":
    ...
    # Test dispatch
    dispatcher = OutpostDispatcher(
        aws_access_key_id="AKIAURBT4BNWYWLAKSJP",
        aws_secret_access_key="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",
    )
    ...
    test_task = {
        ...
        "interface": {"input": "None", "output": "hello.py file"},
        "acceptance_criteria": ["File created", "Prints 'Hello, Blueprint!'"],
        "files_to_create": ["hello.py"],
    }
    
    print("Dispatching test task...")
    try:
        result = dispatcher.dispatch(test_task, agent="claude")
        print(f"Dispatched: command_id={result.command_id}")
