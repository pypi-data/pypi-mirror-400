...
def all_reduce(value, *, op=None, uniform=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def block_dim(dimension, *, upper_bound=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def block_id(dimension, *, upper_bound=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def cluster_block_id(dimension, *, upper_bound=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def cluster_dim_blocks(dimension, *, upper_bound=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def cluster_dim(dimension, *, upper_bound=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def cluster_id(dimension, *, upper_bound=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def global_id(dimension, *, upper_bound=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def grid_dim(dimension, *, upper_bound=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def lane_id(*, upper_bound=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def num_subgroups(*, upper_bound=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def rotate(value, offset, width, *, results=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
...
def shuffle(value, offset, width, mode, *, results=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
...
def subgroup_broadcast(src, broadcast_type, *, lane=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def subgroup_id(*, upper_bound=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def subgroup_mma_compute(op_a, op_b, op_c, *, a_transpose=None, b_transpose=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def subgroup_mma_extract_thread_local(matrix, indices, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def subgroup_reduce(value, op, *, uniform=None, cluster_size=None, cluster_stride=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def subgroup_size(*, upper_bound=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def thread_id(dimension, *, upper_bound=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
