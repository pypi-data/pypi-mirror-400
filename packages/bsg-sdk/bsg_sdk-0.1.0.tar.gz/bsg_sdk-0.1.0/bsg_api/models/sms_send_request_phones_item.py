...
class SmsSendRequestPhonesItem(BaseModel):
    """
    SmsSendRequestPhonesItem
    """ # noqa: E501
    number: Annotated[int, Field(le=999999999999999, strict=True, ge=100000000)] = Field(description="Phone number without leading plus, just digits")
