...
extern int CacheDocument(long long unsigned int handle);
...
extern int UpdateNodeTag(long long unsigned int nodeHandle, char* tagNameC, char* valueC);
...
extern int ClearTagsFromNodesByType(long long unsigned int docHandle, char* typeName);
...
extern long long unsigned int* GetTaggedNodesByTagUUID(long long unsigned int docHandle, char* tagUUID, int* outCount);
extern long long unsigned int GetNodeByNumericID(long long unsigned int docHandle, long long unsigned int nodeID);
extern long long int GetNodeCountByTypeName(long long unsigned int docHandle, char* typeName);
extern char* GetFeatureTypesWithCounts(long long unsigned int docHandle);
extern char* GetNodeTypesWithCounts(long long unsigned int docHandle);
extern int ReplaceAllExceptions(long long unsigned int docHandle, char* exceptionsJSON);
extern char* GetTagsByPrefix(long long unsigned int docHandle, char* prefix);
extern int CreateDataException(long long unsigned int docHandle, char* exceptionJSON);
extern char* GetDataObjectsByParentID(long long unsigned int docHandle, long long unsigned int parentID);
extern char* GetAllFeatures(long long unsigned int docHandle);
extern char* GetDocumentFilename(long long unsigned int docHandle);
extern int HasNextNode(long long unsigned int nodeHandle, char* nodeTypeRegex, int skipVirtual);
extern int HasPreviousNode(long long unsigned int nodeHandle, char* nodeTypeRegex, int skipVirtual);
extern int GetFirstChildIndex(long long unsigned int nodeHandle);
extern int GetLastChildIndex(long long unsigned int nodeHandle);
extern long long unsigned int GetNodeAtChildIndex(long long unsigned int nodeHandle, int index);
extern long long unsigned int AddChildContent(long long unsigned int nodeHandle, char* nodeType, char* content, int index);
extern long long unsigned int* GetNodeAncestors(long long unsigned int nodeHandle, int* outCount);
extern long long unsigned int* GetNodeDescendants(long long unsigned int nodeHandle, int* outCount);
