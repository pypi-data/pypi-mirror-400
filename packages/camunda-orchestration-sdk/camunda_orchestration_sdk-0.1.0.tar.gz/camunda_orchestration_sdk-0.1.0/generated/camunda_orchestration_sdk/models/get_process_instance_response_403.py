...
T = TypeVar("T", bound="GetProcessInstanceResponse403")


@_attrs_define
class GetProcessInstanceResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_process_instance_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_process_instance_response_403.additional_properties = d
        return get_process_instance_response_403
