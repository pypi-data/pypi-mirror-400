...
T = TypeVar("T", bound="OpsviewIntegration")


@_attrs_define
class OpsviewIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        opsview_integration.additional_properties = d
        return opsview_integration
