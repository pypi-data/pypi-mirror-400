...
import six
from fabric_cf.orchestrator.swagger_client.models.status200_ok_paginated import Status200OkPaginated  # noqa: F401,E501

class Slivers(Status200OkPaginated):
    ...
    def __init__(self, data=None, *args, **kwargs):  # noqa: E501
        """Slivers - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this Slivers.  # noqa: E501


        :return: The data of this Slivers.  # noqa: E501
        :rtype: list[Sliver]
        """
        return self._data
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Slivers):
            return False
