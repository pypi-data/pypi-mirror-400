...
def swmm5_run_progress(fn_inp, fn_rpt=None, fn_out=None, n_total=100, working_dir=None):
    """
    ...
    with TemporaryWorkingDirectory(working_dir):
        with Simulation(inputfile=str(fn_inp), reportfile=fn_rpt, outputfile=fn_out) as sim:
