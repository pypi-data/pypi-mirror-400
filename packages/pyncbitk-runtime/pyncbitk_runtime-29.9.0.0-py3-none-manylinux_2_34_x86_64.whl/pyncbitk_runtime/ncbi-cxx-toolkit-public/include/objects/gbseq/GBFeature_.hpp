...
{
    m_Key = std::forward<CGBFeature_Base::TKey>(value);
    m_set_State[0] |= 0x3;
}
...
{
    m_Location = std::forward<CGBFeature_Base::TLocation>(value);
    m_set_State[0] |= 0xc;
}
...
{
    m_Operator = std::forward<CGBFeature_Base::TOperator>(value);
    m_set_State[0] |= 0xc0;
}
