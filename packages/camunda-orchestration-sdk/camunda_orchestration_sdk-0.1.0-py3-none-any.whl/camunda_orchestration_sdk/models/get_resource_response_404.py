...
T = TypeVar("T", bound="GetResourceResponse404")


@_attrs_define
class GetResourceResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_resource_response_404.additional_properties = d
        return get_resource_response_404
