"""PVAccess server of Tektronix MSO scopes"""
import argparse
...
def main():
    ...
    parser.add_argument('-a','--addr', default= '130.199.41.111:4000', help=
...
'Prefix, to be applied to all PVs')
    parser.add_argument('-t', '--timing', help=
'Parameter to be benchmarked')
