...
T = TypeVar("T", bound="CancelBatchOperationResponse403")


@_attrs_define
class CancelBatchOperationResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancel_batch_operation_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        cancel_batch_operation_response_403.additional_properties = d
        return cancel_batch_operation_response_403
