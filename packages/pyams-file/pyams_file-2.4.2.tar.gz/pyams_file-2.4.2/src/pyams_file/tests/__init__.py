...
class MyErrorSupportingContent(MyContent):
    """Custom error supporting content class"""
    data = FileProperty(IMyInterface['data'], accept_unknown_image_as_file=True)
    img_data = FileProperty(IMyInterface['img_data'], accept_unknown_image_as_file=True)
