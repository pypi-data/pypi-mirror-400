...
T = TypeVar("T", bound="SearchMessageSubscriptionsResponse200Page")


@_attrs_define
class SearchMessageSubscriptionsResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_message_subscriptions_response_200_page = cls(
        ...
        search_message_subscriptions_response_200_page.additional_properties = d
        return search_message_subscriptions_response_200_page
