...
from pulpcore.client.pulp_deb.models.deb_apt_alternate_content_source import DebAptAlternateContentSource
from pulpcore.client.pulp_deb.models.deb_apt_alternate_content_source_response import DebAptAlternateContentSourceResponse
...
from pulpcore.client.pulp_deb.models.paginateddeb_apt_alternate_content_source_response_list import PaginateddebAptAlternateContentSourceResponseList
from pulpcore.client.pulp_deb.models.patcheddeb_apt_alternate_content_source import PatcheddebAptAlternateContentSource
from pulpcore.client.pulp_deb.models.task_group_operation_response import TaskGroupOperationResponse
...
class AcsDebApi:
    ...
    def add_role(
        self,
        deb_apt_alternate_content_source_href: StrictStr,
        ...
        :param deb_apt_alternate_content_source_href: (required)
        :type deb_apt_alternate_content_source_href: str
        ...
        _param = self._add_role_serialize(
            deb_apt_alternate_content_source_href=deb_apt_alternate_content_source_href,
    ...
    def _add_role_serialize(
        ...
        if deb_apt_alternate_content_source_href is not None:
            _path_params['deb_apt_alternate_content_source_href'] = deb_apt_alternate_content_source_href
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{deb_apt_alternate_content_source_href}add_role/',
    ...
    def create(
        self,
        deb_apt_alternate_content_source: DebAptAlternateContentSource,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param deb_apt_alternate_content_source: (required)
        :type deb_apt_alternate_content_source: DebAptAlternateContentSource
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._create_serialize(
            deb_apt_alternate_content_source=deb_apt_alternate_content_source,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "DebAptAlternateContentSourceResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DebAptAlternateContentSourceResponse]:
        """Create an apt alternate content source
    ...
    def _create_serialize(
        self,
        deb_apt_alternate_content_source,
        x_task_diagnostics,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if deb_apt_alternate_content_source is not None:
            _body_params = deb_apt_alternate_content_source
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/pulp/api/v3/acs/deb/deb/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='{deb_apt_alternate_content_source_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginateddebAptAlternateContentSourceResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginateddebAptAlternateContentSourceResponseList]:
        """List apt alternate content sources
    ...
    def _list_roles_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{deb_apt_alternate_content_source_href}list_roles/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _my_permissions_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{deb_apt_alternate_content_source_href}my_permissions/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def partial_update(
        self,
        deb_apt_alternate_content_source_href: StrictStr,
        patcheddeb_apt_alternate_content_source: PatcheddebAptAlternateContentSource,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param deb_apt_alternate_content_source_href: (required)
        :type deb_apt_alternate_content_source_href: str
        :param patcheddeb_apt_alternate_content_source: (required)
        :type patcheddeb_apt_alternate_content_source: PatcheddebAptAlternateContentSource
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._partial_update_serialize(
            deb_apt_alternate_content_source_href=deb_apt_alternate_content_source_href,
            patcheddeb_apt_alternate_content_source=patcheddeb_apt_alternate_content_source,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DebAptAlternateContentSourceResponse",
            '202': "AsyncOperationResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    def _partial_update_serialize(
        self,
        deb_apt_alternate_content_source_href,
        patcheddeb_apt_alternate_content_source,
        x_task_diagnostics,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if patcheddeb_apt_alternate_content_source is not None:
            _body_params = patcheddeb_apt_alternate_content_source
    ...
    def _refresh_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{deb_apt_alternate_content_source_href}refresh/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _remove_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{deb_apt_alternate_content_source_href}remove_role/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
