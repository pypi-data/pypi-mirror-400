...
class NCVXQP2(AbstractConstrainedQuadraticProblem):
    """NCVXQP2 problem - a non-convex quadratic program.
    ...
    def expected_result(self):
        ...
        raise NotImplementedError("Expected result not available for NCVXQP2")
