...
T = TypeVar("T", bound="SearchBatchOperationsResponse400")


@_attrs_define
class SearchBatchOperationsResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_batch_operations_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_batch_operations_response_400.additional_properties = d
        return search_batch_operations_response_400
