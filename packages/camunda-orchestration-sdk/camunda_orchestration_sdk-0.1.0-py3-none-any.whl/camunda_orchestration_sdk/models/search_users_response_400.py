...
T = TypeVar("T", bound="SearchUsersResponse400")


@_attrs_define
class SearchUsersResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_users_response_400.additional_properties = d
        return search_users_response_400
