...
T = TypeVar("T", bound="GetStartProcessFormResponse500")


@_attrs_define
class GetStartProcessFormResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_start_process_form_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_start_process_form_response_500.additional_properties = d
        return get_start_process_form_response_500
