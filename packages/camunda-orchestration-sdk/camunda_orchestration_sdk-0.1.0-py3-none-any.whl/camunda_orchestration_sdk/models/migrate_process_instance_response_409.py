...
T = TypeVar("T", bound="MigrateProcessInstanceResponse409")


@_attrs_define
class MigrateProcessInstanceResponse409:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        migrate_process_instance_response_409 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        migrate_process_instance_response_409.additional_properties = d
        return migrate_process_instance_response_409
