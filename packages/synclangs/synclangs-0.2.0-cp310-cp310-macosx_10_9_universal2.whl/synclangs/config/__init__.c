...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "synclangs.config.__init__",
        "sources": [
            "src/synclangs/config/__init__.py"
        ]
    },
    "module_name": "synclangs.config.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__synclangs__config
#define __PYX_HAVE_API__synclangs__config
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "synclangs.config" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "synclangs.config.__init__"
extern int __pyx_module_is_main_synclangs__config____init__;
int __pyx_module_is_main_synclangs__config____init__ = 0;

/* Implementation of "synclangs.config" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
static const char __pyx_k_SyncLangs_configuration_utilitie[] = "SyncLangs configuration utilities.";
/* #### Code section: decls ### */
...
#define __pyx_kp_u_synclangs_config___init __pyx_string_tab[2]
#define __pyx_n_u_CaseConversionConfig __pyx_string_tab[3]
#define __pyx_n_u_CaseConversionFields __pyx_string_tab[4]
#define __pyx_n_u_OptionsConfig __pyx_string_tab[5]
#define __pyx_n_u_OutputsConfig __pyx_string_tab[6]
#define __pyx_n_u_PythonConfig __pyx_string_tab[7]
#define __pyx_n_u_SyncLangsConfig __pyx_string_tab[8]
#define __pyx_n_u_TypeScriptConfig __pyx_string_tab[9]
#define __pyx_n_u_all __pyx_string_tab[10]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[11]
#define __pyx_n_u_load_config __pyx_string_tab[12]
...
#define __pyx_n_u_resolve_config_path __pyx_string_tab[17]
#define __pyx_n_u_setdefault __pyx_string_tab[18]
#define __pyx_n_u_synclangs_config_loader __pyx_string_tab[19]
#define __pyx_n_u_synclangs_config_schema __pyx_string_tab[20]
...
namespace {
  ...
  #endif
  {
      ...
      "config",
      __pyx_k_SyncLangs_configuration_utilitie, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_RefNannySetupContext("PyInit_config", 0);
  ...
  if (__pyx_module_is_main_synclangs__config____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_synclangs_config___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "synclangs.config")) {
      if (unlikely((PyDict_SetItemString(modules, "synclangs.config", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "synclangs/config/__init__.py":3
...
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_load_config,__pyx_mstate_global->__pyx_n_u_resolve_config_path};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_synclangs_config_loader, __pyx_imported_names, 2, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 3, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  ...
  /* "synclangs/config/__init__.py":4
 * 
 * from synclangs.config.loader import load_config, resolve_config_path
 * from synclangs.config.schema import (             # <<<<<<<<<<<<<<
 *     CaseConversionConfig,
...
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_CaseConversionConfig,__pyx_mstate_global->__pyx_n_u_CaseConversionFields,__pyx_mstate_global->__pyx_n_u_OptionsConfig,__pyx_mstate_global->__pyx_n_u_OutputsConfig,__pyx_mstate_global->__pyx_n_u_PythonConfig,__pyx_mstate_global->__pyx_n_u_SyncLangsConfig,__pyx_mstate_global->__pyx_n_u_TypeScriptConfig};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_synclangs_config_schema, __pyx_imported_names, 7, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 4, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
  ...
  /* "synclangs/config/__init__.py":14
 * )
 * 
 * __all__ = [             # <<<<<<<<<<<<<<
 *     "SyncLangsConfig",
 *     "OutputsConfig",
*/
  __pyx_t_2 = __Pyx_PyList_Pack(9, __pyx_mstate_global->__pyx_n_u_SyncLangsConfig, __pyx_mstate_global->__pyx_n_u_OutputsConfig, __pyx_mstate_global->__pyx_n_u_TypeScriptConfig, __pyx_mstate_global->__pyx_n_u_PythonConfig, __pyx_mstate_global->__pyx_n_u_OptionsConfig, __pyx_mstate_global->__pyx_n_u_CaseConversionConfig, __pyx_mstate_global->__pyx_n_u_CaseConversionFields, __pyx_mstate_global->__pyx_n_u_load_config, __pyx_mstate_global->__pyx_n_u_resolve_config_path); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  /* "synclangs/config/__init__.py":1
 * """SyncLangs configuration utilities."""             # <<<<<<<<<<<<<<
 * 
 * from synclangs.config.loader import load_config, resolve_config_path
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init synclangs.config", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init synclangs.config");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{25},{20},{20},{13},{13},{12},{15},{16},{7},{18},{11},{8},{10},{8},{12},{19},{10},{23},{23},{8}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (213 bytes) */
const char* const cstring = "BZh91AY&SYY\335U\246\000\000\001\337\200@\000\000\001\000\000\211\004\314\000\277\357\377 0\000\272\220\321Lh\203\021\223@4hc\t\211\223\0010\000\tBi\252m54`&\232=Axe\355\024y7\016*\333BY\274\307R\000\201R\034~.ig\006\262\030,\303y\256\335\2053\324\031\026\263\025\351\351\031\035\305\206\204c\225\314\362\213\206*\210\373\032R\326\231-\360\256TD.D\024)3\235\021\014s\356\267\221ZR\025+\273P\371\263\353\035`\345\323\021\257\374\022tB`\314\216m\213\354\275\223\201\024f+|\255\246\0136\300\274)\262\355\347!\n\007\n\271]K4\206\230&\313:Z)\253Y!\343\312\326\374]\311\024\341BAguV\230";
...
const char* const cstring = "x\332ePI\016\3030\010\374Q\276\320C\244\236*\245RzG\324&\211U\274\324\340H\371}\235\355\320\226\0133\3000\202\346\"K0\214a\224\306\3040\270\261\001p\301)@\213Bm\0143eq1\264[\363\273vu\304V\272\244\025\313>\320\025ME\017r_t:\225}\265\271\2556;},\211z\223]\322\235\003 3\200a\027\250\372\203f4\364D\363\342\210\026\3141\343\261\266j\370h\013\323\212\002\372-\277\013\362\2163I\344\231NMB\235\204\324\322\200\205\365\357\330u}=\346\267,f\"\217\000JR?\361\001\333\255t\364";
...
const char* const bytes = ".?synclangs.config.__init__CaseConversionConfigCaseConversionFieldsOptionsConfigOutputsConfigPythonConfigSyncLangsConfigTypeScriptConfig__all__cline_in_tracebackload_config__main____module____name____qualname__resolve_config_pathsetdefaultsynclangs.config.loadersynclangs.config.schema__test__";
    PyObject *data = NULL;
