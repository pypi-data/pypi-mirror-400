...
class DatasetBatch:
    ...
    Attributes:
        ...
        assignee_uids (Union[Unset, List[int]]):
    ...
    assignee_uids: Union[Unset, List[int]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        assignee_uids: Union[Unset, List[int]] = UNSET
        if not isinstance(self.assignee_uids, Unset):
            assignee_uids = self.assignee_uids
        ...
        if assignee_uids is not UNSET:
            field_dict["assignee_uids"] = assignee_uids
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _assignee_uids = d.pop("assignee_uids", UNSET)
        assignee_uids = cast(
            List[int], UNSET if _assignee_uids is None else _assignee_uids
        )
