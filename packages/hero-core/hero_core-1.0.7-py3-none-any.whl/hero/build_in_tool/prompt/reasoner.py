...
# Return Format Rules
Your output must be in the format of [output begin]...[output end] (not including the square brackets content).
You are limited to one reasoning step and one tool call per turn.
The param type can be string, array, number, boolean, object.
"""
    
    basic_guidelines="""- Must put your reasoning process inside the reasoning tag, and the tool call inside the tool_call tag.
