...
class UserLogsListDto(BaseModel):
    """
    UserLogsListDto
    """ # noqa: E501
    user_logs: Optional[List[UserLog]] = Field(default=None, alias="userLogs")
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["userLogs", "total"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserLogsListDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserLogsListDto from a dict"""
        if obj is None:
            return None
