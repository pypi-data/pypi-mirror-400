...
class ContactListSearch200ResponseMeta(BaseModel):
    """
    Information about search criteria and total results count
    """ # noqa: E501
    page: Optional[ContactListSearch200ResponseMetaPage] = None
    search: Optional[ContactListSearch200ResponseMetaSearch] = None
    __properties: ClassVar[List[str]] = ["page", "search"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "page": ContactListSearch200ResponseMetaPage.from_dict(obj["page"]) if obj.get("page") is not None else None,
            "search": ContactListSearch200ResponseMetaSearch.from_dict(obj["search"]) if obj.get("search") is not None else None
        })
        return _obj
