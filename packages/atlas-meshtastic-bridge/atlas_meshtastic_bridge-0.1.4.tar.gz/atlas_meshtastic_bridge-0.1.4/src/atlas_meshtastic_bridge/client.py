...
class MeshtasticClient:
    ...
    def get_entity(
        self, entity_id: str, *, timeout: Optional[float] = None, max_retries: Optional[int] = None
    ) -> MessageEnvelope:
        if not entity_id:
    ...
    def get_entity_by_alias(
        self, alias: str, *, timeout: Optional[float] = None, max_retries: Optional[int] = None
    ) -> MessageEnvelope:
        if not alias:
    ...
    def get_task(
        self, task_id: str, *, timeout: Optional[float] = None, max_retries: Optional[int] = None
    ) -> MessageEnvelope:
        if not task_id:
    ...
    def get_tasks_by_entity(
        ...
        *,
        ...
        return self._send_typed(
            "get_tasks_by_entity", {"entity_id": entity_id, "limit": limit}, timeout, max_retries
        )
    ...
    def transition_task_status(
        ...
        *,
        ...
        return self._send_typed(
            "transition_task_status", {"task_id": task_id, "status": status}, timeout, max_retries
        )
    ...
    def delete_object(
        self, object_id: str, *, timeout: Optional[float] = None, max_retries: Optional[int] = None
    ) -> MessageEnvelope:
        if not object_id:
    ...
    def get_objects_by_entity(
        ...
        *,
        ...
        return self._send_typed(
            "get_objects_by_entity", {"entity_id": entity_id, "limit": limit}, timeout, max_retries
        )
    ...
    def get_objects_by_task(
        ...
        *,
        ...
        return self._send_typed(
            "get_objects_by_task", {"task_id": task_id, "limit": limit}, timeout, max_retries
        )
