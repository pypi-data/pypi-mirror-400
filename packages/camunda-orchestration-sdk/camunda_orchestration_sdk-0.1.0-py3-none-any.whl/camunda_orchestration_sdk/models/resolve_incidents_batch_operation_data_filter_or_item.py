...
if TYPE_CHECKING:
    ...
    from ..models.resolve_incidents_batch_operation_data_filter_or_item_variables_item import (
...
T = TypeVar("T", bound="ResolveIncidentsBatchOperationDataFilterOrItem")


@_attrs_define
class ResolveIncidentsBatchOperationDataFilterOrItem:
    ...
    Attributes:
        ...
        variables (list[ResolveIncidentsBatchOperationDataFilterOrItemVariablesItem] | Unset): The process instance
            variables.
    ...
    variables: (
        list[ResolveIncidentsBatchOperationDataFilterOrItemVariablesItem] | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _variables is not UNSET:
            ...
            for variables_item_data in _variables:
                variables_item = ResolveIncidentsBatchOperationDataFilterOrItemVariablesItem.from_dict(
                    variables_item_data
                )
        ...
        resolve_incidents_batch_operation_data_filter_or_item = cls(
        ...
        resolve_incidents_batch_operation_data_filter_or_item.additional_properties = d
        return resolve_incidents_batch_operation_data_filter_or_item
