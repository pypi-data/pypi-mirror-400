...
if __name__ == "__main__":
    ...
    arg_parser = ArgumentParser(
        description="A tool for visualizing, week by week, \
    who contributes code. This function runs an activity analysis on the dataset provided. \
    It explores the weekly activity of the members of a team or community."
    )
