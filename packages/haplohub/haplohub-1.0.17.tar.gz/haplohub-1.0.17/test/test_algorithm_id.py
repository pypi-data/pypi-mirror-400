...
from haplohub.models.algorithm_id import AlgorithmId  # noqa: E501


class TestAlgorithmId(unittest.TestCase):
    """AlgorithmId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgorithmId:
        """Test AlgorithmId
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AlgorithmId`
        """
        model = AlgorithmId()  # noqa: E501
        if include_optional:
            return AlgorithmId(
            )
        else:
