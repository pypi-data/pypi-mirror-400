...
class FunctionTool(Protocol):
    __riyadhai_tool_info: _FunctionToolInfo
...
class RawFunctionTool(Protocol):
    __riyadhai_raw_tool_info: _RawFunctionToolInfo
...
def function_tool(
    ...
    *,
    ...
    def deco_raw(func: Raw_F) -> RawFunctionTool:
        ...
        setattr(func, "__riyadhai_raw_tool_info", info)
    ...
    def deco_func(func: F) -> FunctionTool:
        ...
        setattr(func, "__riyadhai_tool_info", info)
...
def is_function_tool(f: Any) -> TypeGuard[FunctionTool]:
    return hasattr(f, "__riyadhai_tool_info")


def get_function_info(f: FunctionTool) -> _FunctionToolInfo:
    return cast(_FunctionToolInfo, getattr(f, "__riyadhai_tool_info"))


def is_raw_function_tool(f: Any) -> TypeGuard[RawFunctionTool]:
    return hasattr(f, "__riyadhai_raw_tool_info")


def get_raw_function_info(f: RawFunctionTool) -> _RawFunctionToolInfo:
    return cast(_RawFunctionToolInfo, getattr(f, "__riyadhai_raw_tool_info"))
