...
T = TypeVar("T", bound="ModifyProcessInstanceResponse500")


@_attrs_define
class ModifyProcessInstanceResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        modify_process_instance_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        modify_process_instance_response_500.additional_properties = d
        return modify_process_instance_response_500
