...
const chromeStyles = `
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  /* Hide bottom bar when edit overlay is visible to prevent stacking issues */
  .bottom-bar.hidden {
    visibility: hidden;
  }
    ...
    <>
      ...
      <div className="preview-wrapper">
        <div className="app-container">
          ...
          {/* Bottom bar with actions - hidden when edit overlay is visible */}
          <div className={`bottom-bar ${showEditOverlay ? 'hidden' : ''}`}>
