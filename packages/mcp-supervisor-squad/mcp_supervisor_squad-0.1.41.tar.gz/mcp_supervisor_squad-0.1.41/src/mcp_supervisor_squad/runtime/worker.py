...
class Worker:
    ...
    def _run(self, run_id: str, repo_root_hint: str | None = None) -> None:
        ...
        # Planner phase: read director report (if any) and produce requirements/compact.
        ...
        for slug, project_root_str in task_specs:
            ...
            prompt = self._build_coder_prompt(requirements_path=requirements_hint)
    ...
    def _build_coder_prompt(self, *, requirements_path: Path) -> str:
        parts = [
