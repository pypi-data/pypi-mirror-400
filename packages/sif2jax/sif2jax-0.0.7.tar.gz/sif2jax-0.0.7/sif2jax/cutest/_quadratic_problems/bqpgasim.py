...
class BQPGASIM(AbstractBoundedQuadraticProblem):
    """BQPGASIM problem - the first 50 variable subproblem from BQPGAUSS.
    ...
    def bounds(self):
        ...
        lower = lower.at[0].set(-5.4966e-05)
        upper = upper.at[0].set(9.9945e-02)
        ...
        lower = lower.at[12].set(-4.5551e-05)  # Variable 13: LO BOUND 13
        upper = upper.at[12].set(9.9954e-02)  # Variable 13: UP BOUND 13
        lower = lower.at[13].set(
            -9.9999e-02
        )  # Variable 14: LO BOUND 14 (no UP BOUND, uses default 0.1)
        # lower[15] default -0.1, upper[15] default 0.1
        lower = lower.at[15].set(-7.2801e-02)  # Line 103 in SIF (variable 16)
        ...
        # lower[41] default -0.1, upper[41] default 0.1
        ...
        # lower[49] default -0.1, upper[49] default 0.1
