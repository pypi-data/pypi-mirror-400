...
) -> Any | GetOpenapiJsonResponse200 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | GetOpenapiJsonResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Any, GetOpenapiJsonResponse200]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, GetOpenapiJsonResponse200]
    """
