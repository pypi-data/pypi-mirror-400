...
class GetAggregationsPayload(BaseModel):
    """
    GetAggregationsPayload
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["username", "dataset", "filters"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAggregationsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAggregationsPayload from a dict"""
        if obj is None:
            return None
