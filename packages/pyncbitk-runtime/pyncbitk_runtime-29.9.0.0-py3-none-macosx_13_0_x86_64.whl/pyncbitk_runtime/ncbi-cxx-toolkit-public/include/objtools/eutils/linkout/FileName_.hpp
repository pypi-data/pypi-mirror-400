...
public:
    ...
    public:
        ...
        void SetFieldname(TFieldname&& value);
...
inline
void CFileName_Base::C_Attlist::SetFieldname(CFileName_Base::C_Attlist::TFieldname&& value)
{
    m_Fieldname = std::forward<CFileName_Base::C_Attlist::TFieldname>(value);
    m_set_State[0] |= 0x3;
}
...
{
    m_FileName = std::forward<CFileName_Base::TFileName>(value);
    m_set_State[0] |= 0xc;
}
