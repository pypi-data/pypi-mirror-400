...
def host_tree_contains(base_host: str, other_host: str):
...
def uri_tree_contains(base: str, other: str):
...
class NameSubtree:
    ...
    def __contains__(self, item: Union[str, x509.Name]):
...
class PermittedSubtrees:
    ...
    def accept_name(self, name_type: GeneralNameType, name):
...
class ExcludedSubtrees:
    ...
    def reject_name(self, name_type: GeneralNameType, name):
        try:
