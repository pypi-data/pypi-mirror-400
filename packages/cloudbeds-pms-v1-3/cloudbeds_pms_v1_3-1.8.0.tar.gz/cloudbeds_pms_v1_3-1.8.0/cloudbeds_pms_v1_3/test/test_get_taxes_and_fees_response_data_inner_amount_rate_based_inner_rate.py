...
class TestGetTaxesAndFeesResponseDataInnerAmountRateBasedInnerRate(unittest.TestCase):
    """GetTaxesAndFeesResponseDataInnerAmountRateBasedInnerRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTaxesAndFeesResponseDataInnerAmountRateBasedInnerRate:
        """Test GetTaxesAndFeesResponseDataInnerAmountRateBasedInnerRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTaxesAndFeesResponseDataInnerAmountRateBasedInnerRate`
        """
        model = GetTaxesAndFeesResponseDataInnerAmountRateBasedInnerRate()
        if include_optional:
            return GetTaxesAndFeesResponseDataInnerAmountRateBasedInnerRate(
            )
        else:
            return GetTaxesAndFeesResponseDataInnerAmountRateBasedInnerRate(
        )
    ...
    def testGetTaxesAndFeesResponseDataInnerAmountRateBasedInnerRate(self):
        """Test GetTaxesAndFeesResponseDataInnerAmountRateBasedInnerRate"""
