"""
Communication interface (wired or wireless) enabling DER devices to send and receive data from external systems (e.g., DERMS, SCADA)
...
class DerNetworkInterface(GridSTIXDomainObject):
    """
    Communication interface (wired or wireless) enabling DER devices to send and receive data from external systems (e.g., DERMS, SCADA)
    ...
    _type = "x-grid-der-network-interface"
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize DerNetworkInterface with Grid-STIX properties."""
