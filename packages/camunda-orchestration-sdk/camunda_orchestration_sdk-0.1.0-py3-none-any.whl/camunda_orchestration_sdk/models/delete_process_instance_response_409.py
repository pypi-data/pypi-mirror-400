...
T = TypeVar("T", bound="DeleteProcessInstanceResponse409")


@_attrs_define
class DeleteProcessInstanceResponse409:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_process_instance_response_409 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_process_instance_response_409.additional_properties = d
        return delete_process_instance_response_409
