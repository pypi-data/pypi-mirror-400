...
from haplohub.models.algorithm_version_schema import AlgorithmVersionSchema  # noqa: E501


class TestAlgorithmVersionSchema(unittest.TestCase):
    """AlgorithmVersionSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgorithmVersionSchema:
        """Test AlgorithmVersionSchema
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AlgorithmVersionSchema`
        """
        model = AlgorithmVersionSchema()  # noqa: E501
        if include_optional:
            return AlgorithmVersionSchema(
                id = '',
                algorithm_id = '',
                version = '',
    ...
    def testAlgorithmVersionSchema(self):
        """Test AlgorithmVersionSchema"""
