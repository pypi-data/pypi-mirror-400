...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/projects/{project_id}/builds/accounts".format(project_id=project_id,),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """  Get all the account names that have created builds in the given project. These usernames are
