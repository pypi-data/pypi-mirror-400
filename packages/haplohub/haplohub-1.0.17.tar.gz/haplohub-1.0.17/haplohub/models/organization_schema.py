...
class OrganizationSchema(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrganizationSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrganizationSchema:
        """Create an instance of OrganizationSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrganizationSchema.parse_obj(obj)

        _obj = OrganizationSchema.parse_obj(
            {"id": obj.get("id"), "name": obj.get("name"), "display_name": obj.get("display_name")}
        )
        return _obj
