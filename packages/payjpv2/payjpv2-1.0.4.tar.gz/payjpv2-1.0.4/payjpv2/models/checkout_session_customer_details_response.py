...
class CheckoutSessionCustomerDetailsResponse(BaseModel):
    """
    ...
    address: Optional[CheckoutSessionCustomerDetailsAddressResponse]
    __properties: ClassVar[List[str]] = ["name", "email", "phone", "address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "phone": obj.get("phone"),
            "address": CheckoutSessionCustomerDetailsAddressResponse.from_dict(obj["address"]) if obj.get("address") is not None else None
        })
        return _obj
