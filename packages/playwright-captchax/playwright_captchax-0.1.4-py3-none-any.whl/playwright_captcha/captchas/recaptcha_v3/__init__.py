...
from .solvers.capsolver import solve_recaptcha_v3_capsolver
...
BaseSolver.register_solver(SolverType.capsolver, CaptchaType.RECAPTCHA_V3, solve_recaptcha_v3_capsolver)
