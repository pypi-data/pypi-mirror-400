...
| `SessionMiddleware` | Cookie-based sessions | `SECRET_KEY`, `SESSION_*` |
...
Enables signed cookie sessions. Requires `SECRET_KEY`:
...
Access sessions in handlers via `request.session`:
