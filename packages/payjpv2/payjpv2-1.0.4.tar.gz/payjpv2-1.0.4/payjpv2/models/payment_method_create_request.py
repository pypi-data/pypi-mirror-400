...
class PaymentMethodCreateRequest(BaseModel):
    ...
    """
    # data type: PaymentMethodCardCreateRequest
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = PaymentMethodCreateRequest.model_construct()
        error_messages = []
        match = 0
        # validate data type: PaymentMethodCardCreateRequest
        if not isinstance(v, PaymentMethodCardCreateRequest):
            error_messages.append(f"Error! Input type `{type(v)}` is not `PaymentMethodCardCreateRequest`")
        else:
            match += 1
        # validate data type: PaymentMethodPayPayCreateRequest
        if not isinstance(v, PaymentMethodPayPayCreateRequest):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into PaymentMethodCardCreateRequest
        try:
            instance.actual_instance = PaymentMethodCardCreateRequest.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into PaymentMethodPayPayCreateRequest
        try:
            instance.actual_instance = PaymentMethodPayPayCreateRequest.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
