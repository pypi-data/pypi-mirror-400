...
class Blueprint(InteractiveHALResponse):
    ...
    def get_automations_link(self) -> HALLink:
        return HALLink(uri=self.get_self_link().uri + "/automations")
...
class EntityDefinition(InteractiveHALResponse):
    ...
    def create_relation(self, relation_name: str, target:str, many_source_per_target:bool, many_target_per_source:bool, relation_description: str | None = None, *, required: bool=False):
        payload = {
            "name" : relation_name,
            "required" : required,
            "target" : target,
...
class RelationDefinition(InteractiveHALResponse):
    ...
    def patch(self, new_relation_name: str | None = None, new_relation_description: str | None = None):
        payload = {}
