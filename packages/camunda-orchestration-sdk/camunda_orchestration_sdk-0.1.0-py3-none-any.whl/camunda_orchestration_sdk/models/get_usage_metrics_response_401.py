...
T = TypeVar("T", bound="GetUsageMetricsResponse401")


@_attrs_define
class GetUsageMetricsResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_usage_metrics_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_usage_metrics_response_401.additional_properties = d
        return get_usage_metrics_response_401
