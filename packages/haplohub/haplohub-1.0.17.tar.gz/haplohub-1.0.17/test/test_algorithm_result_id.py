...
from haplohub.models.algorithm_result_id import AlgorithmResultId  # noqa: E501


class TestAlgorithmResultId(unittest.TestCase):
    """AlgorithmResultId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgorithmResultId:
        """Test AlgorithmResultId
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AlgorithmResultId`
        """
        model = AlgorithmResultId()  # noqa: E501
        if include_optional:
    ...
    def testAlgorithmResultId(self):
        """Test AlgorithmResultId"""
