...
public:
    ...
    void SetUrlName(TUrlName&& value);
...
inline
void CObjectUrl_Base::C_Data::C_BaseData::SetBase(CObjectUrl_Base::C_Data::C_BaseData::TBase&& value)
{
    m_Base = std::forward<CObjectUrl_Base::C_Data::C_BaseData::TBase>(value);
    m_set_State[0] |= 0x3;
}
...
{
    m_UrlName = std::forward<CObjectUrl_Base::TUrlName>(value);
    m_set_State[0] |= 0x30;
}
