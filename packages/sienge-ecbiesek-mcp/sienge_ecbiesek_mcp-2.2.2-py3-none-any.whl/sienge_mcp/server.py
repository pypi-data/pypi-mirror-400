...
# Note: tenacity and supabase imports are handled in their respective modules
...
async def query_supabase_database(
    ...
    return await supabase_tools.query_supabase_database(
        table_name, columns, filters, limit, order_by, search_term, search_columns
    )
...
async def search_supabase_data(
    ...
    return await supabase_tools.search_supabase_data(
        search_term, table_names, limit_per_table
    )
