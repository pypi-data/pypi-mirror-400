...
class NmeaNmeaMessageTypedDict(TypedDict):
    fields: NotRequired[Nullable[List[str]]]
    sentence_id: NotRequired[str]
    talker_id: NotRequired[str]
    talker_name: NotRequired[str]


class NmeaNmeaMessage(BaseModel):
