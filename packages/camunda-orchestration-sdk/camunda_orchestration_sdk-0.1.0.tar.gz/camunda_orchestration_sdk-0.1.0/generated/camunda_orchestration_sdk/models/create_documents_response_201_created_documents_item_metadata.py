...
if TYPE_CHECKING:
    from ..models.create_documents_response_201_created_documents_item_metadata_custom_properties import (
        CreateDocumentsResponse201CreatedDocumentsItemMetadataCustomProperties,
    )


T = TypeVar("T", bound="CreateDocumentsResponse201CreatedDocumentsItemMetadata")


@_attrs_define
class CreateDocumentsResponse201CreatedDocumentsItemMetadata:
    ...
    Attributes:
        ...
        process_instance_key (str | Unset): The key of the process instance that created the document. Example:
            2251799813690746.
        custom_properties (CreateDocumentsResponse201CreatedDocumentsItemMetadataCustomProperties | Unset): Custom
    ...
    custom_properties: (
        CreateDocumentsResponse201CreatedDocumentsItemMetadataCustomProperties | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_properties, Unset):
            ...
            custom_properties = CreateDocumentsResponse201CreatedDocumentsItemMetadataCustomProperties.from_dict(
                _custom_properties
            )

        create_documents_response_201_created_documents_item_metadata = cls(
        ...
        create_documents_response_201_created_documents_item_metadata.additional_properties = d
        return create_documents_response_201_created_documents_item_metadata
