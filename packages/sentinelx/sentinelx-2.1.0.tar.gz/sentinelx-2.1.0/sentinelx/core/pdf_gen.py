...
def check_auth_and_generate_pdf(report_data, output_path=os.path.join(os.path.dirname(os.path.dirname(__file__)), "reports", "SentinelX_Report.pdf")):
    ...
    story.append(Paragraph("CONFIDENTIAL: Authorized Personnel Only. Generated by SentinelX v2.0", disclaimer_style))

    doc.build(story)
    console.print(f"[bold green]✔ PDF Report generated at: {output_path}[/bold green]")
