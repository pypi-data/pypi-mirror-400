...
G13_BUTTON_POSITIONS = {
    ...
    "G6": {
        "x": KEYS_LEFT + (KEY_W + KEY_GAP) * 5,
        "y": KEYS_TOP + 4,
        "width": KEY_W,
        "height": KEY_H,
    },
    "G7": {
        "x": KEYS_LEFT + (KEY_W + KEY_GAP) * 6,
        "y": KEYS_TOP + 8,
        "width": KEY_W,
        "height": KEY_H,
    },
    ...
    "G9": {
        "x": KEYS_LEFT + (KEY_W + KEY_GAP) * 1,
        "y": KEYS_TOP + KEY_H + KEY_GAP + 4,
        "width": KEY_W,
        "height": KEY_H,
    },
    "G10": {
        "x": KEYS_LEFT + (KEY_W + KEY_GAP) * 2,
        "y": KEYS_TOP + KEY_H + KEY_GAP,
        "width": KEY_W,
        "height": KEY_H,
    },
    "G11": {
        "x": KEYS_LEFT + (KEY_W + KEY_GAP) * 3,
        "y": KEYS_TOP + KEY_H + KEY_GAP,
        "width": KEY_W,
        "height": KEY_H,
    },
    "G12": {
        "x": KEYS_LEFT + (KEY_W + KEY_GAP) * 4,
        "y": KEYS_TOP + KEY_H + KEY_GAP,
        "width": KEY_W,
        "height": KEY_H,
    },
    ...
    "G15": {
        "x": KEYS_LEFT + (KEY_W + KEY_GAP) * 1,
        "y": KEYS_TOP + (KEY_H + KEY_GAP) * 2 + 4,
        "width": KEY_W,
        "height": KEY_H,
    },
    "G16": {
        "x": KEYS_LEFT + (KEY_W + KEY_GAP) * 2,
        "y": KEYS_TOP + (KEY_H + KEY_GAP) * 2,
        "width": KEY_W,
        "height": KEY_H,
    },
    "G17": {
    ...
    "G20": {
        "x": KEYS_LEFT + (KEY_W + KEY_GAP) * 2,
        "y": KEYS_TOP + (KEY_H + KEY_GAP) * 3,
        "width": KEY_W + 8,
        "height": KEY_H + 4,
    },
    "G21": {
        "x": KEYS_LEFT + (KEY_W + KEY_GAP) * 3 + 4,
        "y": KEYS_TOP + (KEY_H + KEY_GAP) * 3,
        "width": KEY_W + 8,
        "height": KEY_H + 4,
    },
    "G22": {
        "x": KEYS_LEFT + (KEY_W + KEY_GAP) * 4 + 8,
        "y": KEYS_TOP + (KEY_H + KEY_GAP) * 3,
        "width": KEY_W + 8,
        "height": KEY_H + 4,
    },
