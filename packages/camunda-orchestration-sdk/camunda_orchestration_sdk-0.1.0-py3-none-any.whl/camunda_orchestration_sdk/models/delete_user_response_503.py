...
T = TypeVar("T", bound="DeleteUserResponse503")


@_attrs_define
class DeleteUserResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_user_response_503.additional_properties = d
        return delete_user_response_503
