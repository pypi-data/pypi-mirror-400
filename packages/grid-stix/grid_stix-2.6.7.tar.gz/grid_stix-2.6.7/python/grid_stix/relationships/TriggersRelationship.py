"""
Relationship indicating that one event or condition triggers another.
...
class TriggersRelationship(GridSTIXRelationshipObject):
    """
    Relationship indicating that one event or condition triggers another.
    ...
    _properties = OrderedDict(
        [
            ...
            ("x_trigger_probability", ListProperty(FloatProperty())),
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize TriggersRelationship with Grid-STIX properties."""
