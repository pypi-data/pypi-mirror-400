"""
Customer-side electrical environment connecting DERs and loads, including breakers, relays, and transformers. Defines the operating context before utility interconnection.
...
class LocalElectricPowerSystem(GridSTIXDomainObject):
    """
    Customer-side electrical environment connecting DERs and loads, including breakers, relays, and transformers. Defines the operating context before utility interconnection.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize LocalElectricPowerSystem with Grid-STIX properties."""
