...
def main():
    ...
    prog_push.add_argument("-u", "--username", default=None, help="the username of Code Hosting Platform")
    prog_push.add_argument("-p", "--password", default=None, help="the password or access-token of Code Hosting Platform")
