...
T = TypeVar("T", bound="AuditlogkeyAdvancedfilter")


@_attrs_define
class AuditlogkeyAdvancedfilter:
    """Advanced AuditLogKey filter.

    Attributes:
        eq (str | Unset): Checks for equality with the provided value. Example: 22517998136843567.
        neq (str | Unset): Checks for inequality with the provided value. Example: 22517998136843567.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        auditlogkey_advancedfilter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        auditlogkey_advancedfilter.additional_properties = d
        return auditlogkey_advancedfilter
