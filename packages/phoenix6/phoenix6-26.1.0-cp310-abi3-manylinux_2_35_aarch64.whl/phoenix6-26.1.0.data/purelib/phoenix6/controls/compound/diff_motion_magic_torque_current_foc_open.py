...
@final
class Diff_MotionMagicTorqueCurrentFOC_Open:
    """
    Requires Phoenix Pro and CANivore;
    Differential control with Motion Magic® average target and torque current
    difference target.
    ...
    def __init__(self, average_request: MotionMagicTorqueCurrentFOC, differential_request: TorqueCurrentFOC):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_MotionMagicTorqueCurrentFOC_Open"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicTorqueCurrentFOC_Open")
    ...
    def with_average_request(self, new_average_request: MotionMagicTorqueCurrentFOC) -> 'Diff_MotionMagicTorqueCurrentFOC_Open':
        ...
        :returns: Itself
        :rtype: Diff_MotionMagicTorqueCurrentFOC_Open
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: TorqueCurrentFOC) -> 'Diff_MotionMagicTorqueCurrentFOC_Open':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicTorqueCurrentFOC_Open':
        """
