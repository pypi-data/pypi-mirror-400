...
static PyObject *
FVector1Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(float) * 1;
...
static PyMethodDef FVector1Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)FVector1Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
