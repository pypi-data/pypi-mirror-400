...
module_dir = os.path.join(__location__, "../src/experimenthub")
try:
...
try:
    from experimenthub import __version__ as version
except ImportError:
    version = ""
...
htmlhelp_basename = "experimenthub-doc"
...
latex_documents = [
    ("index", "user_guide.tex", "experimenthub Documentation", "Jayaram Kancherla", "manual")
]
