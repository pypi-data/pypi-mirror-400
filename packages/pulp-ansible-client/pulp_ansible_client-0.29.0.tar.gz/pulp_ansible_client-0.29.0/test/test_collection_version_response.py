...
class TestCollectionVersionResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CollectionVersionResponse:
        """Test CollectionVersionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionVersionResponse`
        """
        model = CollectionVersionResponse()
        if include_optional:
