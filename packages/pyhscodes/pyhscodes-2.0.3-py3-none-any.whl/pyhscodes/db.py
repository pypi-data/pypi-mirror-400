...
logger = logging.getLogger("pyhscodes.db")
...
class HSCode(Data):
    """Represents a Harmonized System code with hierarchical structure."""

    @property
    def is_chapter(self) -> bool:
        """Returns True if this is a 2-digit chapter code."""
        return self.level == "2"

    @property
    def is_heading(self) -> bool:
        """Returns True if this is a 4-digit heading code."""
        return self.level == "4"
