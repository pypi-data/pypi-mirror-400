...
T = TypeVar("T", bound="CreateProcessInstanceResponse504")


@_attrs_define
class CreateProcessInstanceResponse504:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_process_instance_response_504 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_process_instance_response_504.additional_properties = d
        return create_process_instance_response_504
