...
from typing import Any, Generator, Literal, TypeVar, overload, Generic
...
class FortiObject(Generic[_DataT]):
    ...
    def __getattr__(self, name: str) -> Any:
        ...
        NOTE: For IDE autocomplete, consider using typed annotations:
            from hfortix_fortios.api.v2.cmdb.firewall.policy import PolicyPayload
            policy: FortiObject[PolicyPayload] = fgt.api.cmdb.firewall.policy.get()[0]
            policy.name  # <- Now type checkers know about PolicyPayload fields!
