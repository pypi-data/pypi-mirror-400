...
T = TypeVar("T", bound="SearchMappingRulesForGroupResponse200Page")


@_attrs_define
class SearchMappingRulesForGroupResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_mapping_rules_for_group_response_200_page = cls(
        ...
        search_mapping_rules_for_group_response_200_page.additional_properties = d
        return search_mapping_rules_for_group_response_200_page
