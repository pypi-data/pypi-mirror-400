...
class Sampleinformation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_id", "investigationId", "sampleId", "resources"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Sampleinformation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Sampleinformation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "resources": [Resourceinformation.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None
        })
        return _obj
