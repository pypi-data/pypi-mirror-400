...
- Corrects OpenSpec task status to accurately reflect documentation completion state
...
- `openspec/changes/add-duckdb-merge-aware-write/tasks.md` - Corrected task completion status
...
- Existing comprehensive examples integrated and accessible