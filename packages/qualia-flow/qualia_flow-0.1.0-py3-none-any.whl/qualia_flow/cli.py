...
def create_demo_runs(num_runs: int = 3, tracking_uri: str = "./mlruns"):
...
def interactive_selection():
    ...
    if not tracking_uri:
        tracking_uri = str(Path.cwd() / "mlruns")
    ...
    try:
        ...
        if len(sys.argv) > 1:
            ...
            if command == "create":
                ...
                create_demo_runs(num_runs=num_runs, tracking_uri=tracking_uri)
