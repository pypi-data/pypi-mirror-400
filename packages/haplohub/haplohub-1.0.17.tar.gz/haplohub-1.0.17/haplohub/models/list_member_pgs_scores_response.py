...
class ListMemberPgsScoresResponse(BaseModel):
    """
    ...
    items: conlist(MemberPgsScoreSchema) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListMemberPgsScoresResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListMemberPgsScoresResponse:
        """Create an instance of ListMemberPgsScoresResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListMemberPgsScoresResponse.parse_obj(obj)

        _obj = ListMemberPgsScoresResponse.parse_obj(
            {
                "status": obj.get("status"),
                "total_count": obj.get("total_count"),
                "items": [MemberPgsScoreSchema.from_dict(_item) for _item in obj.get("items")]
