...
T = TypeVar("T", bound="SalesForceServiceCloudCallback")


@_attrs_define
class SalesForceServiceCloudCallback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sales_force_service_cloud_callback = cls(
        ...
        sales_force_service_cloud_callback.additional_properties = d
        return sales_force_service_cloud_callback
