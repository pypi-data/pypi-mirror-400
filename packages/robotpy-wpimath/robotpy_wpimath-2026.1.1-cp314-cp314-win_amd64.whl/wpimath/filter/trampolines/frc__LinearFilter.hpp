...
struct bind_frc__LinearFilter {
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_LinearFilter.def(py::init<std::span<const double>, std::span<const double>>()
    ...
    cls_LinearFilter.def_static("singlePoleIIR", &frc::LinearFilter<T>::SinglePoleIIR
    ...
    cls_LinearFilter.def_static("highPass", &frc::LinearFilter<T>::HighPass
      , py::arg("timeConstant"), py::arg("period")
      , release_gil()
      , py::doc(
    ...
    cls_LinearFilter.def_static("movingAverage", &frc::LinearFilter<T>::MovingAverage
      , py::arg("taps")
      , release_gil()
      , py::doc(
    ...
    cls_LinearFilter.def("reset", static_cast<void (frc::LinearFilter<T>::*)()>(&frc::LinearFilter<T>::Reset)
      , release_gil()
      , py::doc("Reset the filter state.")
    );
    cls_LinearFilter.def("reset", static_cast<void (frc::LinearFilter<T>::*)(std::span<const T>, std::span<const T>)>(&frc::LinearFilter<T>::Reset)
    ...
    cls_LinearFilter.def("calculate", &frc::LinearFilter<T>::Calculate
      , py::arg("input")
      , release_gil()
      , py::doc(
    ...
    cls_LinearFilter.def("lastValue", &frc::LinearFilter<T>::LastValue
      , release_gil()
      , py::doc(
