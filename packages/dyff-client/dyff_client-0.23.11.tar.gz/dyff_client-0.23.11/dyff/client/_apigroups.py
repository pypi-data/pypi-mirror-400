...
class _Pipelines(
    ...
    def run(self, id: str, request: PipelineRunRequest) -> PipelineRun:
        ...
        return PipelineRun.model_validate(entity)

    def get_run_status(self, id: str) -> PipelineRunStatus:
        entity = self._raw_ops.get_run_status(id)
        return PipelineRunStatus.model_validate(entity)
    ...
    # def query(self, query: QueryT | None = None) -> list[Pipeline]:
    #     response = self._request(
    #         "GET", "/pipelines", params={"query": _encode_query(query)}
    #     )
    #     return [Pipeline.model_validate(d) for d in response.json()]
...
class _SafetyCases(
    ...
    def curves(self, id: str) -> list[Curve]:
        ...
        """
        return [Curve.model_validate(obj) for obj in self._raw_ops.curves(id)]
...
class _Submissions:
    def __init__(
        ...
        self._client = _client
        self.__raw_ops = _client.raw.submissions
    ...
    def get(self, id: str) -> Submission:
        ...
        :return: The entity with the given ID.
        """
        return Submission.model_validate(self._raw_ops.get(id))
