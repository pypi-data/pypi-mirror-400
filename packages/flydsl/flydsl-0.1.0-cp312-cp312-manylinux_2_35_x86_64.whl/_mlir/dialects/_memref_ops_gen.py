...
def assume_alignment(memref, alignment, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def atomic_rmw(kind, value, memref, indices, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def load(memref, indices, *, nontemporal=None, alignment=None, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def dim(source, index, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def extract_aligned_pointer_as_index(source, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def extract_strided_metadata(source, *, results=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(ExtractStridedMetadataOp(source=source, results=results, loc=loc, ip=ip))
...
def rank(memref, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
