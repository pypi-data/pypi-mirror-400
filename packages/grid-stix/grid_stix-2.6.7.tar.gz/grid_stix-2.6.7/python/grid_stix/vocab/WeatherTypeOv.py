"""
Open vocabulary for weather types
...
class WeatherTypeOv(GridSTIXDomainObject):
    """
    Open vocabulary for weather types
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize WeatherTypeOv with Grid-STIX properties."""
