...
T = TypeVar("T", bound="CorrelateMessageResponse503")


@_attrs_define
class CorrelateMessageResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        correlate_message_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        correlate_message_response_503.additional_properties = d
        return correlate_message_response_503
