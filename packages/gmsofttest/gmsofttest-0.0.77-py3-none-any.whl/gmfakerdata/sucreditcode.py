...
class CreditIdentifier(object):
    ...
    def get_random_address():
        with open(Path(__file__).parent / "china_address.py", encoding='utf-8') as reader:
...
if __name__ == '__main__':
    s = CreditIdentifier()
    credit_response = s.gen_random_credit_code()
    print('企业名称:{}'.format(credit_response['address']))
    print('社会信用代码:{} \n'.format(credit_response['code']))
