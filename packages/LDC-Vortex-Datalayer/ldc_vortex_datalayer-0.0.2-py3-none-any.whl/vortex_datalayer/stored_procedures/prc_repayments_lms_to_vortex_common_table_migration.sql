-- Stored Procedure: LMS to Vortex Common Table Repayment Migration
-- This procedure migrates repayment records from LMS to the common table (fmpp_vortex_common_repayment_transfer)
-- Both FMPP and Vortex can then consume from this common table independently

CREATE OR REPLACE PROCEDURE prc_repayments_lms_to_vortex_common_table_migration(
...
BEGIN
    ...
    VALUES (
        v_migration_batch_id, 'LMS', 'PROCESSING', 0,
        ...
        EXCEPTION
            WHEN unique_violation THEN
                ...
                VALUES (
                    ...
                    'Conflict detected during LMS to common table migration',
                    v_current_timestamp,
                    v_current_timestamp
                );
        END;
