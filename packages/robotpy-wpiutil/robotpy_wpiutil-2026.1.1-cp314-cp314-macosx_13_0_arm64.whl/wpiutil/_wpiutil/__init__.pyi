...
__all__: list[str] = ['DataLogBackgroundWriter', 'DataLogWriter', 'Sendable', 'SendableBuilder', 'SendableRegistry', 'TimestampSource', 'getStackTrace', 'getStackTraceDefault', 'log', 'sync', 'wpistruct']
class DataLogBackgroundWriter(log.DataLog):
    ...
    def __init__(self, dir: str = '', filename: str = '', period: typing.SupportsFloat = 0.25, extraHeader: str = '') -> None:
        ...
        """
    @typing.overload
    def __init__(self, write: collections.abc.Callable[[typing_extensions.Buffer], None], period: typing.SupportsFloat = 0.25, extraHeader: str = '') -> None:
        """
...
class SendableRegistry:
    ...
    @staticmethod
    @typing.overload
    def addLW(sendable: Sendable, moduleType: str, channel: typing.SupportsInt) -> None:
        """
        Adds an object to the registry and LiveWindow.
    ...
    @staticmethod
    @typing.overload
    def addLW(sendable: Sendable, moduleType: str, moduleNumber: typing.SupportsInt, channel: typing.SupportsInt) -> None:
        """
        Adds an object to the registry and LiveWindow.
    ...
    def remove(sendable: Sendable) -> bool:
        ...
        """
    @staticmethod
    def setLiveWindowBuilderFactory(factory: collections.abc.Callable[[], SendableBuilder]) -> None:
        """
