...
EEG data set for a architectural affordances task (OpenNeuro ``ds004980``). Access recordings and metadata through EEGDash.
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds004980.v1.0.0 <https://doi.org/10.18112/openneuro.ds004980.v1.0.0>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds004980>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds004980>`__
...
.. grid:: 1 2 3 3
   ...
   .. grid-item-card:: Channels & sampling rate
      ...
      - Channels: 64
      - Sampling rate (Hz): 499*
      - Duration (hours): 36.846
