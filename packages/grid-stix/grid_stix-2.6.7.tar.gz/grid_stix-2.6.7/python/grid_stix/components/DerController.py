"""
Directly manages DER operations, including control of generation, storage, and interconnection behavior. A critical asset at the DER site for both utility and customer-owned systems.
...
class DerController(GridSTIXDomainObject):
    """
    Directly manages DER operations, including control of generation, storage, and interconnection behavior. A critical asset at the DER site for both utility and customer-owned systems.
    ...
    _properties = OrderedDict(
        [
            ...
            ("x_controls_device", ListProperty(StringProperty())),
        ]
    )

    def __init__(self, **kwargs: Any) -> None:
        """Initialize DerController with Grid-STIX properties."""
