...
T = TypeVar("T", bound="UnassignRoleFromGroupResponse400")


@_attrs_define
class UnassignRoleFromGroupResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unassign_role_from_group_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        unassign_role_from_group_response_400.additional_properties = d
        return unassign_role_from_group_response_400
