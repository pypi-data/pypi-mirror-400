...
class HS96(AbstractConstrainedMinimisation):
    """Hock and Schittkowski problem 96.
    ...
    def constraint(self, y):
        ...
        # C1: Same structure as HS95 but constant = 4.97
        c1 = (
            17.1 * x1
            + 38.2 * x2
            + 204.2 * x3
        ...
        # C2: Same structure as HS95 but constant = -1.88
        c2 = (
            17.9 * x1
            + 36.8 * x2
            + 113.9 * x3
        ...
        # C3: Different constant = -69.08 (vs -29.08 in HS95)
        c3 = -273.0 * x2 - 70.0 * x4 - 819.0 * x5 + 26000.0 * x4 * x5 + 69.08

        # C4: Different constant = -118.02 (vs -78.02 in HS95)
        c4 = (
            159.9 * x1
            - 311.0 * x2
            + 587.0 * x4
    ...
    def expected_objective_value(self):
        ...
        # LO SOLTN = 0.015619515
        return jnp.array(0.015619515)
