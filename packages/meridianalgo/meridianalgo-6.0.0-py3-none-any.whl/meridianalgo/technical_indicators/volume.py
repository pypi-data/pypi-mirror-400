...
def ChaikinOscillator(high: pd.Series, low: pd.Series, close: pd.Series, 
...
def MoneyFlowIndex(high: pd.Series, low: pd.Series, close: pd.Series, 
...
def EaseOfMovement(high: pd.Series, low: pd.Series, volume: pd.Series, 
