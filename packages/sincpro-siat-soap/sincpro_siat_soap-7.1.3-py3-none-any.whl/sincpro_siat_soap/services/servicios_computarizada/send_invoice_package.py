...
class CommandSendInvoicePackageComputarizada(DataTransferObject):
    nit: int | str
    cuis: str
    cufd: str
...
class ResponseSendInvoicePackageComputarizada(DataTransferObject):
    literal_status: SectorDocumentState | str
    reception_code: str
    raw_response: Any


@siat_soap_sdk.feature(CommandSendInvoicePackageComputarizada)
class SendInvoicePackage(Feature):

    def execute(
        self, dto: CommandSendInvoicePackageComputarizada
        ...
        return ResponseSendInvoicePackageComputarizada(
