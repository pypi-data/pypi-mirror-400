...
class SocketStopConversation(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["username", "dataset", "jwt", "api_key", "conversation_id", "user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SocketStopConversation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SocketStopConversation from a dict"""
        if obj is None:
            return None
