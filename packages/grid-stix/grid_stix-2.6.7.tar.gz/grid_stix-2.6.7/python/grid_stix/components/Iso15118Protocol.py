"""
Standard for vehicle-to-grid communication interface supporting plug-and-charge and secure messaging. Vulnerable to spoofing and man-in-the-middle attacks.
...
class Iso15118Protocol(GridSTIXDomainObject):
    """
    Standard for vehicle-to-grid communication interface supporting plug-and-charge and secure messaging. Vulnerable to spoofing and man-in-the-middle attacks.
    ...
    _type = "x-grid-iso-15118-protocol"
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize Iso15118Protocol with Grid-STIX properties."""
