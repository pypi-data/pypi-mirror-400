    ...
    def add_ee_layer(
        ...
        **kwargs,
        ...
        if isinstance(asset_id, str):
            ...
            try:
                import geemap_le
                from geemap_le.ee_tile_layers import _get_tile_url_format

                if ee_initialize:
                    geemap_le.ee_initialize()
                ...
                print(e)
                print(
                    "Please install the `le_map_tools` package to use the `add_ee_layer` function."
                )
                return
