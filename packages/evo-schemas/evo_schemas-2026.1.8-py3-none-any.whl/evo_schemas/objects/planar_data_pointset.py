...
class PlanarDataPointset_V1_3_0(BaseSpatialDataProperties_V1_1_0):
    ...
    Attributes:
        schema (str)
        locations (PlanarDataPointset_V1_3_0_Locations): The structural planar data and attributes.
...
class PlanarDataPointset_V1_1_0(BaseSpatialDataProperties_V1_0_1):
    ...
    Attributes:
        schema (str)
        locations (PlanarDataPointset_V1_1_0_Locations): The structural planar data and attributes.
        bounding_box (BoundingBox_V1_0_1): Bounding box of the spatial data.
        coordinate_reference_system (Crs_V1_0_1): Coordinate system of the spatial data
        name (str): Name of the object.
...
class PlanarDataPointset_V1_0_1(BaseSpatialDataProperties_V1_0_1):
    ...
    Attributes:
        schema (str)
        locations (PlanarDataPointset_V1_0_1_Locations): The structural planar data and attributes.
        bounding_box (BoundingBox_V1_0_1): Bounding box of the spatial data.
        coordinate_reference_system (Crs_V1_0_1): Coordinate system of the spatial data
        name (str): Name of the object.
        uuid (BaseObjectProperties_V1_0_1_Uuid): Identifier of the object.
...
class PlanarDataPointset_V1_2_0(BaseSpatialDataProperties_V1_0_1):
    ...
    Attributes:
        schema (str)
        locations (PlanarDataPointset_V1_2_0_Locations): The structural planar data and attributes.
        bounding_box (BoundingBox_V1_0_1): Bounding box of the spatial data.
        coordinate_reference_system (Crs_V1_0_1): Coordinate system of the spatial data
        name (str): Name of the object.
        uuid (BaseObjectProperties_V1_0_1_Uuid): Identifier of the object.
