...
T = TypeVar("T", bound="SearchDecisionInstancesResponse200Page")


@_attrs_define
class SearchDecisionInstancesResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_decision_instances_response_200_page = cls(
        ...
        search_decision_instances_response_200_page.additional_properties = d
        return search_decision_instances_response_200_page
