...
class CLPLATEB(AbstractBoundedMinimisation):
    ...
    def objective(self, y, args):
        ...
        # Add weight contribution distributed along upper edge X(P,J) for J=1:P
        # DISW = WGHT / (P-1) is the distributed weight per point
        disw = self.WGHT / (self.P - 1)
        for j in range(self.P):
            obj = obj + disw * X[-1, j]
