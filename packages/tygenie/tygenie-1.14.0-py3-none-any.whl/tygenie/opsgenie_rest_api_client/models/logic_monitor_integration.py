...
T = TypeVar("T", bound="LogicMonitorIntegration")
...
class LogicMonitorIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        logic_monitor_integration.additional_properties = d
        return logic_monitor_integration
