...
T = TypeVar("T", bound="PageCursorBasedforwardpagination")


@_attrs_define
class PageCursorBasedforwardpagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_cursor_basedforwardpagination = cls(
            after=after,
            limit=limit,
        )

        page_cursor_basedforwardpagination.additional_properties = d
        return page_cursor_basedforwardpagination
