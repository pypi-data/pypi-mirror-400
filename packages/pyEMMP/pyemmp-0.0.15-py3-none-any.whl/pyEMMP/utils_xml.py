...
class XMLUtils:
    ...
    def CreateADCPDict(self, instrument_id: str, add_ssc: bool = True) -> Dict[str, Any]:
        ...
        if _enabled(maskAbsoluteBackscatter):
            absback_min = float(self._get_value(maskAbsoluteBackscatter, "Min", Constants._LOW_NUMBER))
            absback_max = float(self._get_value(maskAbsoluteBackscatter, "Max", 0))
        else:
            absback_min, absback_max = Constants._LOW_NUMBER, 0
        ...
        pos_cfg = {
            ...
            'transect_shift_x': transect_shift_x, 'transect_shift_y': transect_shift_y, 'transect_shift_z': transect_shift_z
        }
