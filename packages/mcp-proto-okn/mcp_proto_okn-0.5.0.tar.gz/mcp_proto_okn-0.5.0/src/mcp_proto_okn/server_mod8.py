...
*Created by [mcp-proto-okn](https://github.com/sbl-sdsc/mcp-proto-okn) {__version__} for {sparql_server.kg_name} using <model_string> on {today}*
...
6. MANDATORY: Use ONLY the cleaned output from step 3 in your response - do NOT use your original draft
7. Present the cleaned diagram inline in a mermaid code block
8. Render the diagram in the output window
