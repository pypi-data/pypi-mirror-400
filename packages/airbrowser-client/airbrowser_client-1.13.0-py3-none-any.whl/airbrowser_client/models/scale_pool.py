...
class ScalePool(BaseModel):
    """
    ScalePool
    """ # noqa: E501
    target_size: Annotated[int, Field(le=200, strict=True, ge=1)] = Field(description="New maximum number of browsers")
    __properties: ClassVar[List[str]] = ["target_size"]
