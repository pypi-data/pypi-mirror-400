...
def execute_train_data(
    ...
    2. Validates that required fields are provided
    3. Executes the training pipeline
    4. Saves model to tools/pyinn/model_saved/ and plots to tools/plots/
    ...
    Args:
        ...
        TD_type: Tensor decomposition type - 'CP' or 'Tucker'
