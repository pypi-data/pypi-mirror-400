...
class PanoscApi:
    ...
    def api_scoring_items_get(
        ...
        _param = self._api_scoring_items_get_serialize(
    ...
    @validate_call
    def api_scoring_items_get_with_http_info(
        self,
        start_date: Annotated[StrictStr, Field(description="start date")],
        end_date: Annotated[StrictStr, Field(description="start date")],
        _request_timeout: Union[
    ...
    @validate_call
    def api_scoring_items_get_without_preload_content(
        self,
        start_date: Annotated[StrictStr, Field(description="start date")],
        end_date: Annotated[StrictStr, Field(description="start date")],
        _request_timeout: Union[
    ...
    def _api_scoring_items_get_serialize(
        self,
        start_date,
        end_date,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/scoring/items',
