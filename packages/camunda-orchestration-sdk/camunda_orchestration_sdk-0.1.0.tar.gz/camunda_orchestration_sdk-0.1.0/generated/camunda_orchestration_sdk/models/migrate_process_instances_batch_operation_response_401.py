...
T = TypeVar("T", bound="MigrateProcessInstancesBatchOperationResponse401")


@_attrs_define
class MigrateProcessInstancesBatchOperationResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        migrate_process_instances_batch_operation_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        migrate_process_instances_batch_operation_response_401.additional_properties = d
        return migrate_process_instances_batch_operation_response_401
