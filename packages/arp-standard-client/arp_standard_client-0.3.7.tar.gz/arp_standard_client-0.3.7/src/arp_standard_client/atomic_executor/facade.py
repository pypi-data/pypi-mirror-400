...
class AtomicExecutorClient:
    ...
    def cancel_atomic_node_run(self, request: AtomicExecutorCancelAtomicNodeRunRequest) -> None:
        params = request.params
        resp = cancel_atomic_node_run.sync_detailed(client=self._client, node_run_id=params.node_run_id)
