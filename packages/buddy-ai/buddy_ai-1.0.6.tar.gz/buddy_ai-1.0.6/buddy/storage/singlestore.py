...
from buddy.storage.session import Session
        ...
        with self.SqlSession.begin() as sess:
            ...
            try:
                ...
                if not self.table_exists():
                    ...
                    log_warning(
                        "A table upgrade might be required, please review these docs for more information: https://buddy.link/upgrade-schema"
                    )
                    return None
