...
T = TypeVar("T", bound="UpdateUserTaskResponse409")


@_attrs_define
class UpdateUserTaskResponse409:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_user_task_response_409 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        update_user_task_response_409.additional_properties = d
        return update_user_task_response_409
