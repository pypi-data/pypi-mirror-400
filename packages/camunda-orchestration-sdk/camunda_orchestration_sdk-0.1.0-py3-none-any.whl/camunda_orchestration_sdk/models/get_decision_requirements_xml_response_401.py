...
T = TypeVar("T", bound="GetDecisionRequirementsXMLResponse401")


@_attrs_define
class GetDecisionRequirementsXMLResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_decision_requirements_xml_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_decision_requirements_xml_response_401.additional_properties = d
        return get_decision_requirements_xml_response_401
