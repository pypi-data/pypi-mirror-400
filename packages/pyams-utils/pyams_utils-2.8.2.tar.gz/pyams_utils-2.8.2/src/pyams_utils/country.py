...
"""PyAMS_utils.country module

This module defines a vocabulary of countries as defined by their ISO-3166 codes.
"""
...
ISO_COUNTRIES_VOCABULARY = SimpleVocabulary([
    SimpleTerm(v, title=t)
    for v, t in ISO_COUNTRIES.items()
])