...
static PyObject *
BVector1Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(bool) * 1;
...
static PyMethodDef BVector1Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)BVector1Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
