...
Welcome to `biostrings` contributor's guide.
...
If you experience bugs or general issues with `biostrings`, please have a look
...
You can help improve `biostrings` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`biostrings` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `biostrings`'s files. While this mechanism can
...
```
conda create -n biostrings python=3 six virtualenv pytest pytest-cov
conda activate biostrings
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/biostrings.git
   cd biostrings
   ```
...
5. Install [pre-commit]:
   ...
   `biostrings` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/biostrings
[issue tracker]: https://github.com/<USERNAME>/biostrings/issues
