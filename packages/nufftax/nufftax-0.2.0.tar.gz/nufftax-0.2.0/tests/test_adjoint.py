...
@pytest.mark.skip(reason="Type 3 transforms don't have custom VJP implementations yet")
class TestGradientFiniteDifferenceType3:
    """Verify Type 3 gradients using finite differences.

    NOTE: These tests are skipped because Type 3 transforms (nufft1d3, nufft2d3, nufft3d3)
    only have forward pass implementations. Custom VJPs need to be added for gradient support.
    """
