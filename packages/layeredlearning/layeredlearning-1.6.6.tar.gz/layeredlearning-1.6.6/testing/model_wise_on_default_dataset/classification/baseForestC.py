...
from layerlearn.baseForestC import ForestAdaClassifier, ForestCatClassifier, ForestDecisionClassifier, ForestGradientClassifier, ForestKNNClassifier, ForestLightClassifier, ForestSupportClassifier, ForestXGBClassifier, ForestLogisticClassifier
import warnings
...
X, y = make_classification(n_samples=10000, n_features=10, n_informative=5, n_classes=3, random_state=42)
...
models = {
    "Forest Logistic Classifier": ForestLogisticClassifier(),
    "Forest Support Classifier": ForestSupportClassifier(),
    "Forest Decision Classifier": ForestDecisionClassifier(),
    "Forest KNN Classifier": ForestKNNClassifier(),
    "Forest XGBoost Classifier": ForestXGBClassifier(),
    "Forest CatBoost Classifier": ForestCatClassifier(),
    "Forest Gradient Boosting Classifier": ForestGradientClassifier(),
    "Forest AdaBoost Classifier": ForestAdaClassifier(),
    "Forest LightGBM Classifier": ForestLightClassifier(),
}
