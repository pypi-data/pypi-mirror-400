...
T = TypeVar("T", bound="AzureAutoScaleIntegration")
...
class AzureAutoScaleIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        azure_auto_scale_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        azure_auto_scale_integration.additional_properties = d
        return azure_auto_scale_integration
