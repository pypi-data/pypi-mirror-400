...
T = TypeVar("T", bound="CreateMappingRuleResponse400")


@_attrs_define
class CreateMappingRuleResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_mapping_rule_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_mapping_rule_response_400.additional_properties = d
        return create_mapping_rule_response_400
