...
T = TypeVar("T", bound="HPServiceManagerCallback")


@_attrs_define
class HPServiceManagerCallback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        hp_service_manager_callback = cls(
        ...
        hp_service_manager_callback.additional_properties = d
        return hp_service_manager_callback
