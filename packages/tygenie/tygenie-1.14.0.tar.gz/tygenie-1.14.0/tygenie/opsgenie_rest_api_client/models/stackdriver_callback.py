...
T = TypeVar("T", bound="StackdriverCallback")
...
class StackdriverCallback:
    ...
    Attributes:
        ...
        stackdriver_api_key (Union[Unset, str]):
    """
    ...
    stackdriver_api_key: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if stackdriver_api_key is not UNSET:
            field_dict["stackdriverApiKey"] = stackdriver_api_key
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stackdriver_api_key = d.pop("stackdriverApiKey", UNSET)

        stackdriver_callback = cls(
        ...
        stackdriver_callback.additional_properties = d
        return stackdriver_callback
