...
CONFIG = _cleanup(
  {
    "Build Dependencies": {
      "blas": {
        ...
        "include directory": r"C:/Users/runneradmin/AppData/Local/Temp/cibw-run-8fz6fhx9/cp313-win_amd64/build/venv/Lib/site-packages/scipy_openblas64/include",
        "lib directory": r"C:/Users/runneradmin/AppData/Local/Temp/cibw-run-8fz6fhx9/cp313-win_amd64/build/venv/Lib/site-packages/scipy_openblas64/lib",
        "openblas configuration": r"OpenBLAS 0.3.29.dev  USE64BITINT DYNAMIC_ARCH NO_AFFINITY SkylakeX MAX_THREADS=24",
    ...
    "Python Information": {
      "path": r"C:\Users\runneradmin\AppData\Local\Temp\build-env-ycy71eie\Scripts\python.exe",
      "version": "3.13",
    },
  }
)
