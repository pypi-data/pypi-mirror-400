...
T = TypeVar("T", bound="GetApiV1TemplatesIdResponse200DefaultSettings")


@_attrs_define
class GetApiV1TemplatesIdResponse200DefaultSettings:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_api_v1_templates_id_response_200_default_settings = cls(
            close_date=close_date,
            resolution=resolution,
            visibility=visibility,
        )

        return get_api_v1_templates_id_response_200_default_settings
