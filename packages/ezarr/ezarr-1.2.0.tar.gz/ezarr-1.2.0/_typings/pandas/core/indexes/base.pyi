...
from typing import Any, Callable, Hashable, Self, final, overload

import numpy as np
import numpy.typing as npt
from pandas import DataFrame, Series
from pandas._libs import index as libindex
from pandas._typing import ArrayLike, DtypeObj, FloatFormatType
...
class Index(IndexOpsMixin, PandasObject):
    ...
    _accessors: set[str] = {"str"}

    str: CachedAccessor = CachedAccessor("str", StringMethods)

    _references: None = None
    ...
    def _get_values_for_csv(
        self, *, na_rep: str_t = "", decimal: str_t = ".", float_format=None, date_format=None, quoting=None
    ) -> npt.NDArray[np.object_]: ...
    ...
    def sortlevel(
        self, level=None, ascending: bool | list[bool] = True, sort_remaining=None, na_position: NaPosition = "first"
    ):
        """
    ...
    def is_numeric(self) -> bool:
        ...
        """
        warnings.warn(
            f"{type(self).__name__}.is_numeric is deprecated. Use pandas.api.types.is_any_real_numeric_dtype instead",
            FutureWarning,
            stacklevel=find_stack_level(),
        )
    ...
    def get_loc(self, key):
        ...
        try:
            ...
            if isinstance(casted_key, slice) or (
                isinstance(casted_key, abc.Iterable) and any(isinstance(x, slice) for x in casted_key)
            ):
    ...
    @final
    def get_indexer(
        self, target, method: ReindexMethod | None = None, limit: int | None = None, tolerance=None
    ) -> npt.NDArray[np.intp]:
        """
    ...
    def _raise_invalid_indexer(
        self, form: Literal["slice", "positional"], key, reraise: lib.NoDefault | None | Exception = lib.no_default
    ) -> None:
        """
    ...
    def _wrap_joined_index(
        self, joined: ArrayLike, other: Self, lidx: npt.NDArray[np.intp], ridx: npt.NDArray[np.intp]
    ) -> Self:
        assert other.dtype == self.dtype
    ...
    def sort_values(
        ...
        """
        if key is None and (
            (ascending and self.is_monotonic_increasing) or (not ascending and self.is_monotonic_decreasing)
        ):
            if return_indexer:
    ...
    def slice_indexer(
        self, start: Hashable | None = None, end: Hashable | None = None, step: int | None = None
    ) -> slice:
        """
