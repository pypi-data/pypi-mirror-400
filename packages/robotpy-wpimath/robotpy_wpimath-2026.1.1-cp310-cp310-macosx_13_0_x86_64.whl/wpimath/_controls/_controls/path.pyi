...
__all__: list[str] = ['TravelingSalesman']
class TravelingSalesman:
    ...
    def __init__(self) -> None:
        ...
        """
    @typing.overload
    def __init__(self, cost: collections.abc.Callable[[wpimath.geometry._geometry.Pose2d, wpimath.geometry._geometry.Pose2d], float]) -> None:
        """
        ...
        """
    def solve(self, poses: list[wpimath.geometry._geometry.Pose2d], iterations: typing.SupportsInt) -> list[wpimath.geometry._geometry.Pose2d]:
        """
