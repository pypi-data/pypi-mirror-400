...
! Dummy arrays for ICE4_PACK when OELEC=.FALSE. and OSAVE_MICRO=.FALSE.
REAL, DIMENSION(0,0,0) :: ZMICRO_TEND
REAL, DIMENSION(0,0) :: ZLATHAM_IAGGS
!
!-------------------------------------------------------------------------------
...
CALL ICE4_PACK(D, CST, PARAMI, ICEP, ICED, BUCONF,                   &
               IPROMA, ISIZE, ISIZE2,                                &
               PTSTEP, KRR, .FALSE., LLMICRO, .FALSE., PEXN,         &
