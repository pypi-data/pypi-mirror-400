...
from haplohub.models.member_id1 import MemberId1  # noqa: E501


class TestMemberId1(unittest.TestCase):
    """MemberId1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MemberId1:
        """Test MemberId1
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MemberId1`
        """
        model = MemberId1()  # noqa: E501
        if include_optional:
            return MemberId1(
            )
        else:
