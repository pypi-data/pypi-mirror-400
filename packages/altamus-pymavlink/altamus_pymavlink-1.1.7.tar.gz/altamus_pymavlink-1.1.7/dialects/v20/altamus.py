...
class MAVLink_identifier_message(MAVLink_message):
    ...
    def __init__(self, fw_version: int, particle_id: bytes, local_ip: Sequence[int], mac: Sequence[int], name: bytes, site_friendly_name: bytes, site_name: bytes):
...
class MAVLink(object):
    ...
    def identifier_encode(self, fw_version: int, particle_id: bytes, local_ip: Sequence[int], mac: Sequence[int], name: bytes, site_friendly_name: bytes, site_name: bytes) -> MAVLink_identifier_message:
        """
        Indentifiying information about the EOS device
    ...
    def identifier_send(self, fw_version: int, particle_id: bytes, local_ip: Sequence[int], mac: Sequence[int], name: bytes, site_friendly_name: bytes, site_name: bytes, force_mavlink1: bool = False) -> None:
        """
        Indentifiying information about the EOS device
