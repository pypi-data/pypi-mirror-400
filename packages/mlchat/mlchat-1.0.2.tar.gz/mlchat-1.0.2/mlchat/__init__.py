...
class MCPClient:
    ...
    async def chat(self, messages:list[Messager|dict], max_tool_num=3, use_tool_name:str|list[str]=None,
                   ban_tools:list[str]=None, custom_tools:list[ToolCeil]=None, **kwargs)->AsyncIterator[Messager]:
