...
T = TypeVar("T", bound="AssignUserTaskResponse409")


@_attrs_define
class AssignUserTaskResponse409:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assign_user_task_response_409 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        assign_user_task_response_409.additional_properties = d
        return assign_user_task_response_409
