...
/*! brief          Create a client or server object with call-backs for reading, writing and updating data objects
    parameter[in]      psParameters    DNP3 Object Parameters
    parameter[out]     pi16ErrorCode     Pointer to a Error Code (if any error occurs)
    parameter[out]     ptErrorValue    Pointer to a Error Value (if any error occurs while creating the object)
...
/*! brief          Load the configuration to be used by DNP3 object.
    parameter[in]      myDNP3Obj       DNP3 object 
    parameter[in]      psDNP3Config    Pointer to DNP3 Configuration parameters 
    parameter[out]     ptErrorValue    Pointer to a Error Value (if any error occurs while creating the object)
...
/*! brief          Start DNP3 object communication
    parameter[in]      myDNP3Obj       DNP3 object to Start
    parameter[out]     ptErrorValue    Pointer to a Error Value (if any error occurs while creating the object)
...
'''
 /*! brief           Set DNP3 debug options.
      parameter[in]      myDNP3Obj           DNP3 object to Get Type and Size
      parameter[in]      psDebugParams       Pointer to debug parameters
      parameter[out]     ptErrorValue        Pointer to a Error Value (if any error occurs while creating the object)
...
/*! brief          Stop DNP3 object communication
    parameter[in]      myDNP3Obj       DNP3 object to Stop
    parameter[out]     ptErrorValue    Pointer to a Error Value (if any error occurs while creating the object)
...
/*! brief          Free memory used by DNP3 object.
    parameter[in]      myDNP3Obj     DNP3 object to free
    parameter[out]     ptErrorValue  Pointer to a Error Value (if any error occurs while creating the object)
...
/*!brief           Update DNP3 data attribute ID to the New Value. 
    parameter[in]      myDNP3Obj       DNP3 object to Update
    parameter[in]      psDAID          Pointer to DNP3 Data Attribute ID
    parameter[in]      psNewValue      Pointer to DNP3 Data Attribute Data
    parameter[in]      u16Count        Number of DNP3 Data attribute ID and Data attribute data to be updated simultaneously
    parameter[in]      eUpdateClass  eUpdateClassID - here, we can decide, the event generate , you can chose, default, no event, create class 1 / 2/ 3 event
    parameter[out]     ptErrorValue    Pointer to a Error Value (if any error occurs while creating the object)
...
/*!brief           Read a value to a given Object ID. 
    parameter[in]      myDNP3Obj        DNP3 object 
    parameter[in]      psDAID           Pointer to DNP3 DataAttributeID structure (or compatable) that idendifies the point that is to be read
    parameter[in]      psReturnedValue  Pointer to Object Data structure that hold the returned vaule
    parameter[out]     ptErrorValue     Pointer to a Error Value (if any error occurs while reading the object)
...
/*!brief           Write a value to a given Object ID. 
    parameter[in]      myDNP3Obj       DNP3 object 
    parameter[in]      eFunctionID     enum eWriteFunctionID 
    parameter[in]      psDAID          Pointer to DNP3_DataAttributeID structure (or compatable) that idendifies the point that is to be written
    parameter[in]      psNewValue      Pointer to Object Data structure that hold the new vaule of the tObjectID
    parameter[out]     ptErrorValue    Pointer to a Error Value 
...
/*!brief           Select a given control Data object. 
    parameter[in]      myDNP3Obj       DNP3 object 
    parameter[in]      psDAID          Pointer to DNP3 Data Attribute ID of control that is to be Selected
    parameter[in]      psSelectValue   Pointer to DNP3 Data Attribute Data (The value the control is to be set)
    parameter[in]      psSelectParams  Pointer to DNP3 struct sDNP3CommandParameters 
    parameter[out]     ptErrorValue    Pointer to a Error Value 
...
/*! brief           Send an Operate command on given control Data object. 
    parameter[in]      myDNP3Obj       DNP3 object 
    parameter[in]      psDAID          Pointer to DNP3 Data Attribute ID of control that is to be Operated
    parameter[in]      psOperateValue  Pointer to DNP3 Data Attribute Data (The value the control is to be set )
    parameter[in]      psOperateParams Pointer to DNP3 struct sDNP3CommandParameters 
    parameter[out]     ptErrorValue    Pointer to a Error Value 
...
/*! brief           Cancel current command on given control Data object. 
    parameter[in]      myDNP3Obj       DNP3 object 
    parameter[in]      psDAID          Pointer to DNP3 Data Attribute ID of control that is to be canceled
    parameter[in]      psCancelValue   Pointer to DNP3 Data Attribute Data (The value the control is to be set to)
    parameter[in]      psCancelParams  Pointer to struct sDNP3CommandParameters 
    parameter[out]     ptErrorValue    Pointer to a Error Value 
...
/*! brief        Get DNP3 data type and data size to the returned Value.
    parameter[in]    myDNP3Obj           DNP3 object to Get Type and Size
    parameter[in]    psDAID              Pointer to DNP3 Data Attribute ID
    parameter[out]   psReturnedValue     Pointer to DNP3 Data Attribute Data containing only data type and data size.
    parameter[out]   ptErrorValue        Pointer to a Error Value 
 ...
 *	parameter		  Get DNP3 Get Client connection status.
 *
 *	parameter[in]	  myDNP3Obj		  DNP3 object 
 *	parameter[in]	  psDAID			  Pointer to dnp3 Data Attribute ID
 *	parameter[out]   *peSat			  Pointer to enum eServerConnectionStatus 
 *	parameter[out]   ptErrorValue		  Pointer to a Error Value
 *
 *	return 	  EC_NONE on success
 *	return 	  otherwise error code
 ...
 *	parameter		  Get DNP3 File Read.
 *
 *	parameter[in]	  myDNP3Obj		  DNP3 object 
 *	parameter[in]	  psDAID			  Pointer to dnp3 Data Attribute ID
 *	parameter[out]   psDNP3FileAttributeData			  Pointer to struct sDNP3FileAttributeData 
 *	parameter[out]   ptErrorValue		  Pointer to a Error Value
 *
 *	return 	  EC_NONE on success
 *	return 	  otherwise error code
 ...
 *	parameter		  Get DNP3 Read DataSet Prototype
 *
 *	parameter[in]	  myDNP3Obj		  DNP3 object 
 *	parameter[in]	  psDAID			  Pointer to dnp3 Data Attribute ID
 *	parameter[out]   psClDatasetPrototype 			  Pointer to struct sClientDatasetPrototype 
 *	parameter[out]   ptErrorValue		  Pointer to a Error Value
 *
 *	return 	  EC_NONE on success
 *	return 	  otherwise error code
 ...
 *	parameter		  Get DNP3 Read DataSet Descriptor
 *
 *	parameter[in]	  myDNP3Obj		  DNP3 object 
 *	parameter[in]	  psDAID			  Pointer to dnp3 Data Attribute ID
 *	parameter[out]   psClDatasetDescriptor			  Pointer to struct sClientDatasetPrototype 
 *	parameter[out]   ptErrorValue		  Pointer to a Error Value
 *
 *	return 	  EC_NONE on success
 *	return 	  otherwise error code
 ...
 *	parameter		  Get DNP3 Read DataSet Present Value
 *
 *	parameter[in]	  myDNP3Obj		  DNP3 object 
 *	parameter[in]	  psDAID			  Pointer to dnp3 Data Attribute ID
 *	parameter[out]   *psClDatasetPsValue			  Pointer to struct sClientDatasetPresentvalue  
 *	parameter[out]   ptErrorValue		  Pointer to a Error Value
 *
 *	return 	  EC_NONE on success
 *	return 	  otherwise error code
 ...
 *	parameter		  Get DNP3 Directory Read
 *
 *	parameter[in]	  myDNP3Obj		  DNP3 object 
 *	parameter[in]	  psDAID			  Pointer to dnp3 Data Attribute ID
 *	parameter[out]   *psDNP3DirAttributeData			  Pointer to struct sDNP3DirAttributeData  
 *	parameter[out]   ptErrorValue		  Pointer to a Error Value
 *
 *	return 	  EC_NONE on success
 *	return 	  otherwise error code
 ...
 *	parameter		  DNP3 Get Server Database Value
 *
 *	parameter[in]	  myDNP3Obj		  DNP3 object 
 *	parameter[out]   *psDNPServerDatabase Pointer to struct sDNPServerDatabase  
 *	parameter[out]   ptErrorValue		  Pointer to a Error Value
 *
 *	return 	  EC_NONE on success
 *	return 	  otherwise error code
 ...
 *	parameter		  DNP3 Get Client Database Value
 *
 *	parameter[in]	  myDNP3Obj		  DNP3 object 
 *	parameter[out]   *psDNPClientDatabase Pointer to struct sDNPClientDatabase  
 *	parameter[out]   ptErrorValue		  Pointer to a Error Value
 *
 *	return 	  EC_NONE on success
 *	return 	  otherwise error code
 ...
 *	parameter		  DNP3 Read Device Attribute Data
 *
 *	parameter[in]	  myDNP3Obj		  DNP3 object 
 *	parameter[in]	  psDAID			  Pointer to dnp3 Data Attribute ID
 *	parameter[in]    u8Variation         variation to read and get value  
 *	parameter[out]   ptErrorValue		  Pointer to a Error Value
 *
 *	return 	  EC_NONE on success
 *	return 	  otherwise error code
 ...
 *	parameter		  DNP3 Client Get Internal Indication
 *
 *	parameter[in]	  myDNP3Obj		  DNP3 object 
 *	parameter[in]	  psDAID			  Pointer to dnp3 Data Attribute ID
 *	parameter[out]   *pu8IIN1             Pointer to Unsigned8 IIN 1
 *	parameter[out]   *pu8IIN2             Pointer to Unsigned8 IIN 2
 *	parameter[out]   *ptErrorValue		  Pointer to a Error Value
 *
 *	return 	  EC_NONE on success
 *	return 	  otherwise error code
 ...
 *	parameter		  Get DNP3 Get object status -  loaded, running, stoped, freed.
 *
 *	parameter[in]	  myDNP3Obj		  DNP3 object 
 *	parameter[out]   *peCurrentState	  Pointer to enum  eAppState   
 *	parameter[out]   *ptErrorValue		  Pointer to a Error Value
 *
 *	return 	  EC_NONE on success
 *	return 	  otherwise error code
...
*  parameter 		   For particular Error code , get Error String
*
*  parameter[in]	   *psDNP3ErrorCodeDes - Pointer to struct sDNP3ErrorCode
*
...
*
*  parameter[in]	   *psDNP3ErrorValueDes - Pointer to struct sDNP3ErrorValue 
*
 ...
 *	parameter			   Function used to get DNP3 Library License information
 *
 ...
 *	parameter		  Get DNP3 Get Client - stop/start polling particular server in serial multi drop
 *
 *	parameter[in]	  myDNP3Obj 	  DNP3 object 
 *	parameter[in]	  psDAID			  Pointer to dnp3 Data Attribute ID
 *	parameter[out]   bStop 			True - stop , false - start polling particular server/device
 *	parameter[out]   ptErrorValue		  Pointer to a Error Value
 *
 *	return 	  EC_NONE on success
 *	return 	  otherwise error code
