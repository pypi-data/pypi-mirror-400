...
class CANcoderSimState:
    ...
    __device_type = DeviceType.P6_CANcoderType

    def __init__(self, device: 'CoreCANcoder', orientation: ChassisReference = ChassisReference.COUNTER_CLOCKWISE_POSITIVE):
        ...
        """
        self.sensor_offset: rotation = 0.0
        """
