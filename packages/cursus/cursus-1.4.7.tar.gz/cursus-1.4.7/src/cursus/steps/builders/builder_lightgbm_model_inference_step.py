...
class LightGBMModelInferenceStepBuilder(StepBuilderBase):
    """
    Builder for a LightGBM Model Inference ProcessingStep.
    ...
    def __init__(
        ...
        Args:
            config: A LightGBMModelInferenceConfig instance containing all necessary settings.
            sagemaker_session: The SageMaker session object to manage interactions with AWS.
            role: The IAM role ARN to be used by the SageMaker Processing Job.
            registry_manager: Optional registry manager for dependency injection
            dependency_resolver: Optional dependency resolver for dependency injection
        """
        if not isinstance(config, LightGBMModelInferenceConfig):
            raise ValueError(
        ...
        self.config: LightGBMModelInferenceConfig = config
    ...
    def validate_configuration(self) -> None:
        ...
        """
        self.log_info("Validating LightGBMModelInferenceConfig...")
        ...
        for attr in required_attrs:
            if not hasattr(self.config, attr) or getattr(self.config, attr) in [
                ...
                raise ValueError(
                    f"LightGBMModelInferenceConfig missing required attribute: {attr}"
                )
    ...
    def create_step(self, **kwargs) -> ProcessingStep:
        ...
        """
        self.log_info("Creating LightGBMModelInference ProcessingStep...")
