...
class QToolButton(QtWidgets.QToolButton):
    def __init__(self, text: str = '', icon: QIcon | str | None = None, tip: str = '', triggered: Callable[[], ...] | None = None, toggled: Callable[[bool], ...] | None = None, parent: QObject = None, id: str = '') -> None: ...
