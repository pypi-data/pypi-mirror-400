...
VALID_BODY_ENC_ALGORITHM: Literal[{"description": "Encrypt logs using high and medium encryption", "help": "Encrypt logs using high and medium encryption.", "label": "High Medium", "name": "high-medium"}, {"description": "Encrypt logs using high encryption", "help": "Encrypt logs using high encryption.", "label": "High", "name": "high"}, {"description": "Encrypt logs using low encryption", "help": "Encrypt logs using low encryption.", "label": "Low", "name": "low"}]
