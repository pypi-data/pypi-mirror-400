...
T = TypeVar("T", bound="DeleteMappingRuleResponse500")


@_attrs_define
class DeleteMappingRuleResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_mapping_rule_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_mapping_rule_response_500.additional_properties = d
        return delete_mapping_rule_response_500
