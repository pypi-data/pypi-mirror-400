...
__all__ = ['SAP2000Analysis']

class SAP2000Analysis(PythonAnalysis):
    ''' ::version(14.17.0)

    SAP2000Analysis can be used to evaluate a SAP2000-python script on third-party infrastructure. The script is expected
