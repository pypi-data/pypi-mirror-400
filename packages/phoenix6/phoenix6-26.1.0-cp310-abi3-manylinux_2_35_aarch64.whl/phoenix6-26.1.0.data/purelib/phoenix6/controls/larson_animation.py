...
class LarsonAnimation:
    ...
    :param size: The number of LEDs in the pocket of light, up to 15.
    :type size: int
    :param bounce_mode: The behavior of the pocket of light when it reaches the end
                        of the strip.
    :type bounce_mode: LarsonBounceValue
    ...
    def __init__(self, led_start_index: int, led_end_index: int, slot: int = 0, color: RGBWColor = RGBWColor(), size: int = 3, bounce_mode: LarsonBounceValue = LarsonBounceValue.FRONT, frame_rate: hertz = 25):
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: LarsonAnimation")
        ...
        ss.append("    size: " + str(self.size))
        ss.append("    bounce_mode: " + str(self.bounce_mode))
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlLarsonAnimation(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.led_start_index, self.led_end_index, self.slot, self.color.red, self.color.green, self.color.blue, self.color.white, self.size, self.bounce_mode.value, self.frame_rate))

    
    def with_led_start_index(self, new_led_start_index: int) -> 'LarsonAnimation':
        """
        ...
        :returns: Itself
        :rtype: LarsonAnimation
        """
        self.led_start_index = new_led_start_index
        return self
    
    def with_led_end_index(self, new_led_end_index: int) -> 'LarsonAnimation':
        """
    ...
    def with_slot(self, new_slot: int) -> 'LarsonAnimation':
        """
    ...
    def with_color(self, new_color: RGBWColor) -> 'LarsonAnimation':
        """
    ...
    def with_size(self, new_size: int) -> 'LarsonAnimation':
        """
        Modifies this Control Request's size parameter and returns itself for
        method-chaining and easier to use request API.
    
        The number of LEDs in the pocket of light, up to 15.
    
        :param new_size: Parameter to modify
        :type new_size: int
        :returns: Itself
        :rtype: LarsonAnimation
        """
    ...
    def with_bounce_mode(self, new_bounce_mode: LarsonBounceValue) -> 'LarsonAnimation':
        """
        Modifies this Control Request's bounce_mode parameter and returns itself for
        method-chaining and easier to use request API.
    
        The behavior of the pocket of light when it reaches the end of the strip.
    
        :param new_bounce_mode: Parameter to modify
        :type new_bounce_mode: LarsonBounceValue
        :returns: Itself
        :rtype: LarsonAnimation
        """
        self.bounce_mode = new_bounce_mode
        return self
    
    def with_frame_rate(self, new_frame_rate: hertz) -> 'LarsonAnimation':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'LarsonAnimation':
        """
    ...
    def control_info(self) -> dict:
        ...
        control_info["size"] = self.size
        control_info["bounce_mode"] = self.bounce_mode
