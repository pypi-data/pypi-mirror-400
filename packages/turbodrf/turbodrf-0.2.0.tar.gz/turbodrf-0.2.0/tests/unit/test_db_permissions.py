...
class TestPermissionSnapshot(TestCase):
    ...
    def test_snapshot_caching(self):
        ...
        snapshot1 = build_permission_snapshot(self.viewer_user, self.TestBook, use_cache=True)

        # Build again (should use cache)
        snapshot2 = build_permission_snapshot(self.viewer_user, self.TestBook, use_cache=True)
