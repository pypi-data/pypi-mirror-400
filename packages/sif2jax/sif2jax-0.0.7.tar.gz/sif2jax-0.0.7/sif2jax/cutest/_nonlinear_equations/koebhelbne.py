...
class KOEBHELBNE(AbstractNonlinearEquations):
    ...
    Our implementation counts 1 finite bound (lower bound 0.001 for B)
    Pycutest counts 2 (2 lower bounds > -1e20)
    ...
    def _get_data(self):
        ...
        # Y data values (budget frequency in sample)
        y_data = jnp.array(
            [
                1.3956745794,
                0.0384714261,
    ...
    def residual(self, y: Array, args) -> Array:
        ...
        Args:
            y: Array of shape (3,) containing [N, A, B]
            args: Additional arguments (unused)

        Returns:
            Array of shape (156,) containing the residuals
        """
