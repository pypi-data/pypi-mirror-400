...
T = TypeVar("T", bound="GetDecisionInstanceResponse404")


@_attrs_define
class GetDecisionInstanceResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_decision_instance_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_decision_instance_response_404.additional_properties = d
        return get_decision_instance_response_404
