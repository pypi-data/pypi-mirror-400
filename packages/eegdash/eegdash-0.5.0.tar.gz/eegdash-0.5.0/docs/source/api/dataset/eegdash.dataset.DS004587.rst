...
IllusionGameEEG_data (OpenNeuro ``ds004587``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 1` :bdg-light:`License: CC0` :bdg-light:`Subjects: 103` :bdg-light:`Recordings: 114` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds004587.v1.0.0 <https://doi.org/10.18112/openneuro.ds004587.v1.0.0>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds004587>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds004587>`__
