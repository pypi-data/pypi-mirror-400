...
T = TypeVar("T", bound="SearchProcessInstancesResponse200Page")


@_attrs_define
class SearchProcessInstancesResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_process_instances_response_200_page = cls(
        ...
        search_process_instances_response_200_page.additional_properties = d
        return search_process_instances_response_200_page
