...
T = TypeVar("T", bound="PingdomWebhookIntegration")


@_attrs_define
class PingdomWebhookIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pingdom_webhook_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        pingdom_webhook_integration.additional_properties = d
        return pingdom_webhook_integration
