...
from lusid_notifications.configuration import Configuration, Timeouts
...
class ApiConfiguration:
    def __init__(
        ...
        :param lusid_notifications.extensions.ProxyConfig proxy_config: The proxy configuration to use
        """
