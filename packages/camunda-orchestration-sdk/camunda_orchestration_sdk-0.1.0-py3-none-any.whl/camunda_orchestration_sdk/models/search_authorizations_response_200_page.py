...
T = TypeVar("T", bound="SearchAuthorizationsResponse200Page")


@_attrs_define
class SearchAuthorizationsResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_authorizations_response_200_page = cls(
        ...
        search_authorizations_response_200_page.additional_properties = d
        return search_authorizations_response_200_page
