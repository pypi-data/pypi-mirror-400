...
T = TypeVar("T", bound="SolarwindsMSPNcentralCallback")


@_attrs_define
class SolarwindsMSPNcentralCallback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        solarwinds_msp_ncentral_callback = cls(
        ...
        solarwinds_msp_ncentral_callback.additional_properties = d
        return solarwinds_msp_ncentral_callback
