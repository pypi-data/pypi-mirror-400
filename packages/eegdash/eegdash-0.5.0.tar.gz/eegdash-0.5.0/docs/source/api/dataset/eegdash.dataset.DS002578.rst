...
Visual Oddball Task (256 channels) (OpenNeuro ``ds002578``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 1` :bdg-light:`License: CC0` :bdg-light:`Subjects: 2` :bdg-light:`Recordings: 2` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `10.18112/openneuro.ds002578.v1.1.0 <https://doi.org/10.18112/openneuro.ds002578.v1.1.0>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds002578>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds002578>`__
