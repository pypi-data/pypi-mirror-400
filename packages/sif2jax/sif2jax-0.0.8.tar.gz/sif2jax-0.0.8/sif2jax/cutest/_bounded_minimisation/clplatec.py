...
class CLPLATEC(AbstractBoundedMinimisation):
    ...
    def objective(self, y, args):
        ...
        # WR = 0.99 * WGHT on upper right corner X(P,P)
        # WL = 0.01 * WGHT on upper left corner X(P,1)
        wr = 0.99 * self.WGHT
        wl = 0.01 * self.WGHT
        obj = obj + wr * X[-1, -1]  # X(P,P)
        obj = obj + wl * X[-1, 0]  # X(P,1)
