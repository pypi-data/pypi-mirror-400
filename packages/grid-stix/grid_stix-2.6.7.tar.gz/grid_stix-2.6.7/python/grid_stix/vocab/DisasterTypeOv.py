"""
Open vocabulary for disaster types
...
class DisasterTypeOv(GridSTIXDomainObject):
    """
    Open vocabulary for disaster types
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize DisasterTypeOv with Grid-STIX properties."""
