...
static PyObject *
IVector1Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(int) * 1;
...
static PyMethodDef IVector1Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)IVector1Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
