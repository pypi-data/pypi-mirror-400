...
static PyObject *
I64Vector2Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(int64_t) * 2;
...
static PyMethodDef I64Vector2Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)I64Vector2Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
