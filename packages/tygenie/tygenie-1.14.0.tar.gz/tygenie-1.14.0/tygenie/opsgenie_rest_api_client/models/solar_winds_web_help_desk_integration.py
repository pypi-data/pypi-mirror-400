...
T = TypeVar("T", bound="SolarWindsWebHelpDeskIntegration")
...
class SolarWindsWebHelpDeskIntegration:
    ...
    Attributes:
        ...
        solar_winds_web_help_desk_api_key (Union[Unset, str]):
        solar_winds_web_help_server_url (Union[Unset, str]):
    """
    ...
    solar_winds_web_help_desk_api_key: Union[Unset, str] = UNSET
    solar_winds_web_help_server_url: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        solar_winds_web_help_desk_api_key = self.solar_winds_web_help_desk_api_key

        solar_winds_web_help_server_url = self.solar_winds_web_help_server_url
        ...
        if solar_winds_web_help_desk_api_key is not UNSET:
            field_dict["solarWindsWebHelpDeskApiKey"] = solar_winds_web_help_desk_api_key
        if solar_winds_web_help_server_url is not UNSET:
            field_dict["solarWindsWebHelpServerURL"] = solar_winds_web_help_server_url
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        solar_winds_web_help_desk_api_key = d.pop("solarWindsWebHelpDeskApiKey", UNSET)

        solar_winds_web_help_server_url = d.pop("solarWindsWebHelpServerURL", UNSET)

        solar_winds_web_help_desk_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
            ...
            solar_winds_web_help_desk_api_key=solar_winds_web_help_desk_api_key,
            solar_winds_web_help_server_url=solar_winds_web_help_server_url,
        )

        solar_winds_web_help_desk_integration.additional_properties = d
        return solar_winds_web_help_desk_integration
