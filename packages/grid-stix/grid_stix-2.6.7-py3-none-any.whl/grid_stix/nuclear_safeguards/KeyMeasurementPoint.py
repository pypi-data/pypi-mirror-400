"""
Location where nuclear material quantities are measured to maintain material accountancy.
...
class KeyMeasurementPoint(GridSTIXDomainObject):
    """
    Location where nuclear material quantities are measured to maintain material accountancy.
    ...
    _properties = OrderedDict(
        [
            ...
            ("x_measurement_uncertainty", ListProperty(FloatProperty())),
        ]
    )

    def __init__(self, **kwargs: Any) -> None:
        """Initialize KeyMeasurementPoint with Grid-STIX properties."""
