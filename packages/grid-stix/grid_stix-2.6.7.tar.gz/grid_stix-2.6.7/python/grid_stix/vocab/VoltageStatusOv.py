"""
Open vocabulary for voltage statuses
...
class VoltageStatusOv(GridSTIXDomainObject):
    """
    Open vocabulary for voltage statuses
    ...
    _type = "x-grid-voltage-status-ov"
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize VoltageStatusOv with Grid-STIX properties."""
