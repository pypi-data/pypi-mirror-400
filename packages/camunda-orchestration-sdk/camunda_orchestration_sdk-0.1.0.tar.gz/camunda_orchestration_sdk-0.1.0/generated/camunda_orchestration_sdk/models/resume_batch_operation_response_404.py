...
T = TypeVar("T", bound="ResumeBatchOperationResponse404")


@_attrs_define
class ResumeBatchOperationResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resume_batch_operation_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        resume_batch_operation_response_404.additional_properties = d
        return resume_batch_operation_response_404
