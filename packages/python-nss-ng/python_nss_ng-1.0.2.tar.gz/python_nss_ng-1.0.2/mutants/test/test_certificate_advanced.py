...
class TestCertificateSearch:
    ...
    def test_find_nonexistent_cert(self, nss_db_context):
    ...
    def test_enumerate_certificates(self, nss_db_context):
        ...
        try:
            certs = nss_db_context.find_certs_by_subject('')
            # Empty subject may return all certs or none
        except (NSPRError, AttributeError):
            # Method might not exist or might fail
            pytest.skip("Certificate enumeration not available")
