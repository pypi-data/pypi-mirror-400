...
class MIDIPlayer:
    ...
    def __init__(self,
        ...
        debug=False,
        sound_font="https://resource.dataphi.cn/soundfonts/soundfont-snes",        # optional custom soundfont url or path
    ...
    def to_player_html(self, url_or_file, styler=basic):
        ...
        return styler(self.url, viz_type=self.viz_type, dl=self.dl, title=self.title, sound_font=self.sound_font)
