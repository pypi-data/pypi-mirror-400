...
from ...models.close_alert_identifier_type import CloseAlertIdentifierType
...
def _get_kwargs(
    ...
    *,
    ...
    identifier_type: Union[
        Unset, CloseAlertIdentifierType
    ] = CloseAlertIdentifierType.ID,
) -> Dict[str, Any]:
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": f"/v2/alerts/{identifier}/close",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        identifier (str):
        identifier_type (Union[Unset, CloseAlertIdentifierType]):  Default:
            CloseAlertIdentifierType.ID.
        body (AlertActionPayload):
