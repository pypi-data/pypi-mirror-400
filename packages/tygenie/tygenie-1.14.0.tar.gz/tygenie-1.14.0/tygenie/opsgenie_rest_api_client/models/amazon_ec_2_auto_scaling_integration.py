...
T = TypeVar("T", bound="AmazonEc2AutoScalingIntegration")
...
class AmazonEc2AutoScalingIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        amazon_ec_2_auto_scaling_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        amazon_ec_2_auto_scaling_integration.additional_properties = d
        return amazon_ec_2_auto_scaling_integration
