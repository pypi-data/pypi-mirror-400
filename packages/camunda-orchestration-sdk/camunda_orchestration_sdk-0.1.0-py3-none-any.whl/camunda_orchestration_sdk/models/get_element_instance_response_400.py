...
T = TypeVar("T", bound="GetElementInstanceResponse400")


@_attrs_define
class GetElementInstanceResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_element_instance_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_element_instance_response_400.additional_properties = d
        return get_element_instance_response_400
