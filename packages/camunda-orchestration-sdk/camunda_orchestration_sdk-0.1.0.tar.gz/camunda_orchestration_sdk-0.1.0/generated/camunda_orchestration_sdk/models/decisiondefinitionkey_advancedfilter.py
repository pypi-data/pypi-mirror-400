...
T = TypeVar("T", bound="DecisiondefinitionkeyAdvancedfilter")


@_attrs_define
class DecisiondefinitionkeyAdvancedfilter:
    """Advanced DecisionDefinitionKey filter.

    Attributes:
        eq (str | Unset): Checks for equality with the provided value. Example: 2251799813326547.
        neq (str | Unset): Checks for inequality with the provided value. Example: 2251799813326547.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        decisiondefinitionkey_advancedfilter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        decisiondefinitionkey_advancedfilter.additional_properties = d
        return decisiondefinitionkey_advancedfilter
