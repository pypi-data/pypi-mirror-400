...
from xladmin.plugins.ajax import JsonErrorDict
from xladmin.sites import site
from xladmin.util import lookup_field, display_for_field, label_for_field, unquote, boolean_icon
from xladmin.views import BaseAdminPlugin, ModelFormAdminView, ListAdminView
from xladmin.views.base import csrf_protect_m, filter_hook
from xladmin.views.edit import ModelFormAdminUtil
from xladmin.views.list import EMPTY_CHANGELIST_VALUE
...
class EditablePlugin(BaseAdminPlugin):
    ...
    def get_media(self, media):
        if self.editable_need_fields:
            ...
            media = media + m +\
                self.vendor(
                    'xladmin.plugin.editable.js', 'xladmin.widget.editable.css')
        return media
