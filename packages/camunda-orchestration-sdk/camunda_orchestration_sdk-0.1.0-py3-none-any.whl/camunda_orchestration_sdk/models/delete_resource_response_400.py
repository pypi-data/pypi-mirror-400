...
T = TypeVar("T", bound="DeleteResourceResponse400")


@_attrs_define
class DeleteResourceResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_resource_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_resource_response_400.additional_properties = d
        return delete_resource_response_400
