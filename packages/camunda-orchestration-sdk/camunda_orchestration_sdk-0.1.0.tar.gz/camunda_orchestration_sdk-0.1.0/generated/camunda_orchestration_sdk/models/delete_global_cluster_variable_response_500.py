...
T = TypeVar("T", bound="DeleteGlobalClusterVariableResponse500")


@_attrs_define
class DeleteGlobalClusterVariableResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_global_cluster_variable_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_global_cluster_variable_response_500.additional_properties = d
        return delete_global_cluster_variable_response_500
