...
__all__: list[str] = ['Debouncer', 'LinearFilter', 'MedianFilter', 'SlewRateLimiter']
class Debouncer:
    """
    ...
    def calculate(self, input: bool) -> bool:
        ...
        """
    def getDebounceTime(self) -> wpimath.units.seconds:
        """
        ...
        """
    def getDebounceType(self) -> Debouncer.DebounceType:
        """
        Get the debounce type.
        
        :returns: Which type of state change the debouncing will be performed on.
        """
    def setDebounceTime(self, time: wpimath.units.seconds) -> None:
        """
        ...
        :param time: The number of seconds the value must change from baseline
                     for the filtered value to change.
        """
    def setDebounceType(self, type: Debouncer.DebounceType) -> None:
        """
...
class LinearFilter:
    ...
    """
    @staticmethod
    def highPass(timeConstant: typing.SupportsFloat, period: wpimath.units.seconds) -> LinearFilter:
        """
        ...
        """
    @staticmethod
    def movingAverage(taps: typing.SupportsInt) -> LinearFilter:
        """
        ...
        """
    @staticmethod
    def singlePoleIIR(timeConstant: typing.SupportsFloat, period: wpimath.units.seconds) -> LinearFilter:
        """
        ...
        :param period:       The period in seconds between samples taken by the
                             user.
        """
    def __init__(self, ffGains: list[typing.SupportsFloat], fbGains: list[typing.SupportsFloat]) -> None:
        """
        ...
        """
    def calculate(self, input: typing.SupportsFloat) -> float:
        """
    ...
    def reset(self) -> None:
        ...
        """
    @typing.overload
    def reset(self, inputBuffer: list[typing.SupportsFloat], outputBuffer: list[typing.SupportsFloat]) -> None:
        """
...
class MedianFilter:
    ...
    def __init__(self, size: typing.SupportsInt) -> None:
        ...
        """
    def calculate(self, next: typing.SupportsFloat) -> float:
        """
