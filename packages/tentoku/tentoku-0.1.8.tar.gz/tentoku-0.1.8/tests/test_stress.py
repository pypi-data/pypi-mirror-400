...
class TestStress(unittest.TestCase):
    ...
    def test_tokenize_performance_long_text(self):
        ...
        # Updated: Allow slightly more time (2.7s) to account for getting multiple results
        # to find longest match with deinflection_reasons and system variability
        self.assertLess(elapsed, 2.7, f"Tokenization took {elapsed*1000:.2f}ms, expected < 2700ms")
