...
T = TypeVar("T", bound="SearchClientsForGroupResponse400")


@_attrs_define
class SearchClientsForGroupResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_clients_for_group_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_clients_for_group_response_400.additional_properties = d
        return search_clients_for_group_response_400
