...
@final
class Diff_MotionMagicVelocityDutyCycle_Position:
    """
    Requires Phoenix Pro and CANivore;
    Differential control with Motion Magic® Velocity average target and position
    ...
    def __init__(self, average_request: MotionMagicVelocityDutyCycle, differential_request: PositionDutyCycle):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_MotionMagicVelocityDutyCycle_Position"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicVelocityDutyCycle_Position")
    ...
    def with_average_request(self, new_average_request: MotionMagicVelocityDutyCycle) -> 'Diff_MotionMagicVelocityDutyCycle_Position':
        ...
        :type new_average_request: MotionMagicVelocityDutyCycle
        :returns: Itself
        :rtype: Diff_MotionMagicVelocityDutyCycle_Position
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: PositionDutyCycle) -> 'Diff_MotionMagicVelocityDutyCycle_Position':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicVelocityDutyCycle_Position':
        """
