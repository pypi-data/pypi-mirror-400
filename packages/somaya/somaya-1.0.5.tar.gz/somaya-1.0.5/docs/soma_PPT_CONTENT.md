...
**Title:** SOMA: Universal Text Tokenization Framework
...
- **Theorem**: For any tokenization algorithm T in SOMA and input text, R(T(text)) = text
...
- Include SOMA logo if available
