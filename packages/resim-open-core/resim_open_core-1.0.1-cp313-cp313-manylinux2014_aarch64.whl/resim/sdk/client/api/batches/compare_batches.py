...
def _get_kwargs(
    ...
    other_batch_id: str,
    *,
    status: CompareBatchesStatusFilter | Unset = UNSET,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Any | CompareBatchesOutput | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Any | CompareBatchesOutput]:
    return Response(
...
def sync_detailed(
    ...
    *,
...
) -> Response[Any | CompareBatchesOutput]:
    ...
    Args:
        ...
        batch_id (str):
        other_batch_id (str):
        status (CompareBatchesStatusFilter | Unset):
        search (str | Unset):
        page_size (int | Unset):
