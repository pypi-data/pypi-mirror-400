...
T = TypeVar("T", bound="SearchBatchOperationItemsResponse200Page")


@_attrs_define
class SearchBatchOperationItemsResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_batch_operation_items_response_200_page = cls(
        ...
        search_batch_operation_items_response_200_page.additional_properties = d
        return search_batch_operation_items_response_200_page
