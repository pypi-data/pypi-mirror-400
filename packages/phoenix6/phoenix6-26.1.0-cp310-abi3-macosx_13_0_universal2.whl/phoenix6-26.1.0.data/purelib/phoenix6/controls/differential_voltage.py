...
class DifferentialVoltage:
    ...
    :param average_output: Voltage to attempt to drive at on the Average axis.
    :type average_output: volt
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "DifferentialVoltage"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: DifferentialVoltage")
        ss.append("    average_output: " + str(self.average_output) + " Volts")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlDifferentialVoltage(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.average_output, self.differential_position, self.enable_foc, self.differential_slot, self.override_brake_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.ignore_hardware_limits, self.ignore_software_limits, self.use_timesync))

    
    def with_average_output(self, new_average_output: volt) -> 'DifferentialVoltage':
        """
    ...
    def with_ignore_software_limits(self, new_ignore_software_limits: bool) -> 'DifferentialVoltage':
        """
