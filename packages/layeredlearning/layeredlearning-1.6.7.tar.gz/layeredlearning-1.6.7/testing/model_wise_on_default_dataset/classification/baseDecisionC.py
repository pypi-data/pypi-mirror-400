...
from layerlearn.baseDecisionC import DecisionForestClassifier, DecisionSupportClassifier, DecisionLogisticClassifier, DecisionKNNClassifier, DecisionXGBClassifier, DecisionCatClassifier, DecisionGradientClassifier, DecisionAdaClassifier, DecisionLightClassifier
import warnings
...
models = {
    "Decision Forest Classifier": DecisionForestClassifier(),
    "Decision Support Classifier": DecisionSupportClassifier(),
    "Decision Logistic Classifier": DecisionLogisticClassifier(),
    "Decision KNN Classifier": DecisionKNNClassifier(),
    "Decision XGBoost Classifier": DecisionXGBClassifier(),
    "Decision CatBoost Classifier": DecisionCatClassifier(),
    "Decision Gradient Boosting Classifier": DecisionGradientClassifier(),
    "Decision AdaBoost Classifier": DecisionAdaClassifier(),
    "Decision LightGBM Classifier": DecisionLightClassifier(),
}
...
ax.set_title('Comparison of Decision Model Classifier Performance', fontsize=18, fontweight='bold')
