...
static PyObject *
FMatrix3x3Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(float) * 9;
...
static PyMethodDef FMatrix3x3Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)FMatrix3x3Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
