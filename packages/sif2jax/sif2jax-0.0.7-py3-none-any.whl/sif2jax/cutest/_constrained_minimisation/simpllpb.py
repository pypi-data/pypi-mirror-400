...
class SIMPLLPB(AbstractConstrainedMinimisation):
    ...
    def objective(self, y, args):
        """Linear objective function: 1.5*x1 + x2."""
        x1, x2 = y
        return 1.5 * x1 + x2
    ...
    def constraint(self, y):
        ...
        - x1 + 2*x2 >= 1.2  =>  x1 + 2*x2 - 1.2 >= 0
        - 2*x1 + x2 >= 1.2  =>  2*x1 + x2 - 1.2 >= 0
        """
        x1, x2 = y
        ...
        g2 = x1 + 2.0 * x2 - 1.2
        g3 = 2.0 * x1 + x2 - 1.2
        ineq_constraints = jnp.array([g1, g2, g3])
