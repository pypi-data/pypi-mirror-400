...
class DagContext:
  def __init__(self, mdt_endpoint:str) -> None:
    self.__task_output_dict:dict[str, ElementValueDict] = {}
  ...
  def __repr__(self) -> str:
    import json
    output_dict = { 'mdt_endpoint': self.mdt_endpoint, 'task_outputs': self.__task_output_dict }
