...
@final
class Diff_MotionMagicVelocityVoltage_Open:
    """
    Requires Phoenix Pro and CANivore;
    Differential control with Motion Magic® Velocity average target and voltage
    difference target.
    ...
    def __init__(self, average_request: MotionMagicVelocityVoltage, differential_request: VoltageOut):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_MotionMagicVelocityVoltage_Open"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicVelocityVoltage_Open")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlDiff_MotionMagicVelocityVoltage_Open(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.average_request.velocity, self.average_request.acceleration, self.average_request.enable_foc, self.average_request.feed_forward, self.average_request.slot, self.average_request.override_brake_dur_neutral, self.average_request.limit_forward_motion, self.average_request.limit_reverse_motion, self.average_request.ignore_hardware_limits, self.average_request.ignore_software_limits, self.average_request.use_timesync, self.differential_request.output, self.differential_request.enable_foc, self.differential_request.override_brake_dur_neutral, self.differential_request.limit_forward_motion, self.differential_request.limit_reverse_motion, self.differential_request.ignore_hardware_limits, self.differential_request.ignore_software_limits, self.differential_request.use_timesync))

    
    def with_average_request(self, new_average_request: MotionMagicVelocityVoltage) -> 'Diff_MotionMagicVelocityVoltage_Open':
        """
        ...
        :returns: Itself
        :rtype: Diff_MotionMagicVelocityVoltage_Open
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: VoltageOut) -> 'Diff_MotionMagicVelocityVoltage_Open':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicVelocityVoltage_Open':
        """
