...
Defines the contract for the LightGBM model inference script that loads trained models,
processes evaluation data, and generates predictions without metrics computation.
"""

from ...core.base.contract_base import ScriptContract

LIGHTGBM_MODEL_INFERENCE_CONTRACT = ScriptContract(
    entry_point="lightgbm_model_inference.py",
    ...
    description="""
    LightGBM model inference script that:
