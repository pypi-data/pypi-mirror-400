...
from le import _utils
from le import computedobject
from le import deprecation
from le import ee_exception
from le import encodable
from le import image_converter
from le import oauth
from le import serializer
from le import table_converter
...
DEFAULT_TILE_BASE_URL = 'https://62dg4pnfmwt5bmbvh4neupdwhe0poelx.lambda-url.us-west-2.on.aws/default'

# The default base URL for Cloud API calls.
DEFAULT_CLOUD_API_BASE_URL = 'https://b7obz35kn0.execute-api.us-west-2.amazonaws.com/default'
...
def _execute_cloud_call(
    call: labelearthapiclient.http.HttpRequest, num_retries: Optional[int] = None
) -> Any:
...
def getMapId(params: Dict[str, Any]) -> Dict[str, Any]:
  ...
  if result.get("version") == 1:
    _tile_base_url = "https://iqiwcv35ask2zn2nshmrmmo4zq0kuenu.lambda-url.us-west-2.on.aws/default"
  else:
    _tile_base_url = DEFAULT_TILE_BASE_URL
