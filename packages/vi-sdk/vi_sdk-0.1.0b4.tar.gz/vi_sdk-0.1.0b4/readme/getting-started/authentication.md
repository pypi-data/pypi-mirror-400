...
excerpt: "Learn how to authenticate with the Vi platform"
...
- **[Configuration](vi-sdk-configuration)** - Configure logging, timeouts, and other settings
- **[Error Handling](vi-sdk-error-handling)** - Learn how to handle authentication errors
- **[User Guide](vi-sdk-overview)** - Continue with the user guide
