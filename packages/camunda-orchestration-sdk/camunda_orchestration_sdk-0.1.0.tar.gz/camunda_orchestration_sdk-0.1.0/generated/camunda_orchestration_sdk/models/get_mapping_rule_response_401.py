...
T = TypeVar("T", bound="GetMappingRuleResponse401")


@_attrs_define
class GetMappingRuleResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_mapping_rule_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_mapping_rule_response_401.additional_properties = d
        return get_mapping_rule_response_401
