...
T = TypeVar("T", bound="SearchMappingRulesForRoleResponse401")


@_attrs_define
class SearchMappingRulesForRoleResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_mapping_rules_for_role_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_mapping_rules_for_role_response_401.additional_properties = d
        return search_mapping_rules_for_role_response_401
