...
T = TypeVar("T", bound="StruxureWareIntegration")
...
class StruxureWareIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        struxure_ware_integration.additional_properties = d
        return struxure_ware_integration
