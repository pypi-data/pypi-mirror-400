...
class SandboxStatus(BaseModel):
    ...
    last_task_time: Optional[datetime] = Field(default=None, alias="lastTaskTime")
    ...
    __properties: ClassVar[List[str]] = ["conditions", "lastTaskTime", "phase", "podIP", "podName", "workDir"]
