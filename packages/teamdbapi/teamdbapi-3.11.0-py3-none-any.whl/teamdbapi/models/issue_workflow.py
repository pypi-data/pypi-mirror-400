...
class IssueWorkflow(object):
    ...
    def __init__(self, Id=None, Name=None, Description=None, DefaultReportId=None, _configuration=None):  # noqa: E501
        ...
        if DefaultReportId is not None:
            self.DefaultReportId = DefaultReportId
    ...
    @property
    def DefaultReportId(self):
        """Gets the DefaultReportId of this IssueWorkflow.  # noqa: E501

        Unique identifier of the report associated to the workflow  # noqa: E501

        :return: The DefaultReportId of this IssueWorkflow.  # noqa: E501
        :rtype: str
        """
        return self._DefaultReportId

    @DefaultReportId.setter
    def DefaultReportId(self, DefaultReportId):
        """Sets the DefaultReportId of this IssueWorkflow.

        Unique identifier of the report associated to the workflow  # noqa: E501

        :param DefaultReportId: The DefaultReportId of this IssueWorkflow.  # noqa: E501
        :type: str
        """

        self._DefaultReportId = DefaultReportId
