"""Integration tests for PostgreSQL event adapters (Embedded).
...
class TestPostgresEventPublisherEmbedded:
    """Integration tests for PostgresEventPublisher using embedded PostgreSQL."""
...
class TestPostgresEventConsumerEmbedded:
    """Integration tests for PostgresEventConsumer using embedded PostgreSQL."""
...
class TestEventFlowEmbedded:
    """Integration tests for complete event flow using embedded PostgreSQL."""
