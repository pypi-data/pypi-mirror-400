...
T = TypeVar("T", bound="SearchJobsResponse401")


@_attrs_define
class SearchJobsResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_jobs_response_401.additional_properties = d
        return search_jobs_response_401
