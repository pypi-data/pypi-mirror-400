    ...
    payload: dict[str, Any] = {
        ...
        "workflow": {
            ...
            "notes": [
                ...
                "squad_status returns summary/events/forced_wait_ms (no has_update/event_id); if events empty, only summary=等待提示 + forced_wait_ms.",
                "Print events to users in a compact form: [tag] message; if data_lines present, list them with leading '- '.",
