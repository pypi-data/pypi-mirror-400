...
T = TypeVar("T", bound="ThundraIntegration")


@_attrs_define
class ThundraIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        thundra_integration.additional_properties = d
        return thundra_integration
