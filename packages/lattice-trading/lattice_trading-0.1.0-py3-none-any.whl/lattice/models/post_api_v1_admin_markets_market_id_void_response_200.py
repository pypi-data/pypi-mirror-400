...
T = TypeVar("T", bound="PostApiV1AdminMarketsMarketIdVoidResponse200")


@_attrs_define
class PostApiV1AdminMarketsMarketIdVoidResponse200:
    """
    Attributes:
        market_id (str):
        status (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_api_v1_admin_markets_market_id_void_response_200 = cls(
            market_id=market_id,
            status=status,
        ...
        return post_api_v1_admin_markets_market_id_void_response_200
