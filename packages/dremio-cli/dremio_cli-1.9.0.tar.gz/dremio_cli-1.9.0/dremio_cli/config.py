...
class AuthType(str, Enum):
    ...
    PAT = "pat"
    BASIC = "basic"
    EXTERNAL_JWT = "external_jwt"


class Profile(BaseModel):
    """Connection profile configuration."""
    name: str
    type: str # cloud or software
    base_url: str
    auth_type: AuthType = AuthType.PAT
    
    # Credentials
    token: Optional[str] = None # PAT or Software Auth Token
    username: Optional[str] = None
    password: Optional[str] = None
    external_token: Optional[str] = None # IDP JWT
...
class ProfileManager:
    ...
    def __init__(self, config_dir: Optional[Path] = None):
        ...
        if config_dir:
            ...
            env_dir = os.environ.get("DREMIO_CONFIG_DIR")
            if env_dir:
                self.config_dir = Path(env_dir)
            else:
                self.config_dir = Path.home() / ".dremio"
    ...
    def create_profile(
        ...
        Args:
            ...
            auth_type: Authentication type ('pat', 'oauth', 'username_password', 'external_jwt')
            ...
            external_token: External Identity Provider JWT (for external_jwt auth)
        """
        config = self._load_config()
        ...
        if external_token:
            profile["auth"]["external_token"] = external_token
