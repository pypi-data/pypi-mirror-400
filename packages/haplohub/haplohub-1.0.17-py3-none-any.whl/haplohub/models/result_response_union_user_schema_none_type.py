...
class ResultResponseUnionUserSchemaNoneType(BaseModel):
    """
    ResultResponseUnionUserSchemaNoneType
    """

    status: Optional[StrictStr] = "success"
    result: Optional[UserSchema] = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResultResponseUnionUserSchemaNoneType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResultResponseUnionUserSchemaNoneType:
        """Create an instance of ResultResponseUnionUserSchemaNoneType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResultResponseUnionUserSchemaNoneType.parse_obj(obj)

        _obj = ResultResponseUnionUserSchemaNoneType.parse_obj(
            {
                "status": obj.get("status") if obj.get("status") is not None else "success",
                "result": UserSchema.from_dict(obj.get("result")) if obj.get("result") is not None else None,
            }
        )
        return _obj
