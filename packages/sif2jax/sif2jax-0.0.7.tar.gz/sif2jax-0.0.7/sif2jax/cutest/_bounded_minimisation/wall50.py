...
_SPARSE_H, _LINEAR_INDICES = _parse_wall50_sif()
...
class WALL50(AbstractBoundedMinimisation):
    ...
    classification QBR2-RN-37311-0
    """
    ...
    @property
    def y0(self):
        """Initial guess - zeros except for elements 11026-11087 which are 1.0."""
        y = jnp.zeros(self.n)
        # Set elements 11026-11087 (0-indexed: 11025-11086) to 1.0
        y = y.at[11025:11087].set(1.0)
        return y
