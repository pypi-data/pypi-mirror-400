...
T = TypeVar("T", bound="CreateDocumentResponse415")


@_attrs_define
class CreateDocumentResponse415:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_document_response_415 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_document_response_415.additional_properties = d
        return create_document_response_415
