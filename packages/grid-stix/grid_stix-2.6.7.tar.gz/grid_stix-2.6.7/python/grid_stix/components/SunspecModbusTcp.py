"""
SunSpec-defined Modbus profile over TCP/IP for DER monitoring and control.
...
class SunspecModbusTcp(GridSTIXDomainObject):
    """
    SunSpec-defined Modbus profile over TCP/IP for DER monitoring and control.
    ...
    _type = "x-grid-sunspec-modbus-tcp"
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize SunspecModbusTcp with Grid-STIX properties."""
