...
@final
class Diff_VelocityDutyCycle_Open:
    """
    ...
    def __init__(self, average_request: VelocityDutyCycle, differential_request: DutyCycleOut):
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_VelocityDutyCycle_Open")
    ...
    def with_average_request(self, new_average_request: VelocityDutyCycle) -> 'Diff_VelocityDutyCycle_Open':
        ...
        :returns: Itself
        :rtype: Diff_VelocityDutyCycle_Open
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: DutyCycleOut) -> 'Diff_VelocityDutyCycle_Open':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_VelocityDutyCycle_Open':
        """
