...
class DatasetDocument(BaseModel):
    ...
    investigation: Optional[DatasetDocumentInvestigation] = None
    id: Union[StrictFloat, StrictInt]
    name: StrictStr
    start_date: StrictStr = Field(alias="startDate")
    end_date: StrictStr = Field(alias="endDate")
    location: StrictStr
    sample_name: StrictStr = Field(alias="sampleName")
    __properties: ClassVar[List[str]] = ["parameters", "investigation", "id", "name", "startDate", "endDate", "location", "sampleName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DatasetDocument from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DatasetDocument from a dict"""
        if obj is None:
            return None
