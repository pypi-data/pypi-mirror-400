...
class TestOstreeOstreeDistributionResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OstreeOstreeDistributionResponse:
        """Test OstreeOstreeDistributionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OstreeOstreeDistributionResponse`
        """
        model = OstreeOstreeDistributionResponse()
        if include_optional:
