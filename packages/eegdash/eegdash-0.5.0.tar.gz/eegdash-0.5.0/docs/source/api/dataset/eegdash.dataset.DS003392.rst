...
NeuroSpin hMT+ Localizer DATA (MEG & aMRI) (OpenNeuro ``ds003392``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: meg` :bdg-light:`Tasks: 2` :bdg-light:`License: CC0` :bdg-light:`Subjects: 12` :bdg-light:`Recordings: 33` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `10.18112/openneuro.ds003392.v1.0.4 <https://doi.org/10.18112/openneuro.ds003392.v1.0.4>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds003392>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds003392>`__
...
.. grid:: 1 2 3 3
   ...
   .. grid-item-card:: Provenance
      ...
      - Source: openneuro
      - OpenNeuro: `ds003392 <https://openneuro.org/datasets/ds003392>`__
      - NeMAR: `ds003392 <https://nemar.org/dataexplorer/detail?dataset_id=ds003392>`__
...
.. autoclass:: eegdash.dataset.DS003392
...
* :mod:`eegdash.dataset`
* `OpenNeuro dataset page <https://openneuro.org/datasets/ds003392>`__
* `NeMAR dataset page <https://nemar.org/dataexplorer/detail?dataset_id=ds003392>`__
