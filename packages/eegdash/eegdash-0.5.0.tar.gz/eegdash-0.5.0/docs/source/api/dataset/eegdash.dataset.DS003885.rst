...
Capacity for movement is an organisational principle in object representations: EEG data from Experiment 1 (OpenNeuro ``ds003885``). Access recordings and metadata through EEGDash.
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds003885.v1.0.7 <https://doi.org/10.18112/openneuro.ds003885.v1.0.7>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds003885>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds003885>`__
