...
try:
    ...
    FORMTOOLS_AVAILABLE = True
except Exception:
    # If django-formtools is not installed, disable this plugin gracefully.
    get_storage = None
    ManagementForm = None
    StepsHelper = None
    FORMTOOLS_AVAILABLE = False
...
class WizardFormPlugin(BaseAdminPlugin):
    ...
    def init_request(self, *args, **kwargs):
        # Disable wizard plugin when formtools is unavailable
        if not FORMTOOLS_AVAILABLE:
            return False
