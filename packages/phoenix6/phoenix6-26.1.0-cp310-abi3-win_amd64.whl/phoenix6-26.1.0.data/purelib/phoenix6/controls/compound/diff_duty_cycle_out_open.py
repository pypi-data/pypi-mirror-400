...
@final
class Diff_DutyCycleOut_Open:
    """
    Requires Phoenix Pro and CANivore;
    Differential control with duty cycle average target and duty cycle difference
    target.
    ...
    def __init__(self, average_request: DutyCycleOut, differential_request: DutyCycleOut):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_DutyCycleOut_Open"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_DutyCycleOut_Open")
    ...
    def with_average_request(self, new_average_request: DutyCycleOut) -> 'Diff_DutyCycleOut_Open':
        ...
        :returns: Itself
        :rtype: Diff_DutyCycleOut_Open
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: DutyCycleOut) -> 'Diff_DutyCycleOut_Open':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_DutyCycleOut_Open':
        """
