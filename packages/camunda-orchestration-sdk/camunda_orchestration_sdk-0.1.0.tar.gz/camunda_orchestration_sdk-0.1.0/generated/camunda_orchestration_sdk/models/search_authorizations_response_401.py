...
T = TypeVar("T", bound="SearchAuthorizationsResponse401")


@_attrs_define
class SearchAuthorizationsResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_authorizations_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_authorizations_response_401.additional_properties = d
        return search_authorizations_response_401
