...
static PyObject *
U16Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(uint16_t);
...
static PyMethodDef U16Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)U16Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
