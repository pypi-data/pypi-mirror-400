...
setuptools.setup(
    ...
    scripts=[
        ...
        "anatools/bin/anaprofile",
        "anatools/bin/anarules",
        "anatools/bin/anaserver",
        "anatools/bin/anatransfer",
        "anatools/bin/anautils"
    ],
    entry_points = {
        'console_scripts': [
            'anacreate=anatools.anacreate:main'
            ],
    },
    package_data={"": ["*.yml", "*.png", "*.md", "*.glb"]},
    classifiers=[
