...
T = TypeVar("T", bound="SearchMappingRulesForGroupDataFilter")


@_attrs_define
class SearchMappingRulesForGroupDataFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_mapping_rules_for_group_data_filter = cls(
        ...
        search_mapping_rules_for_group_data_filter.additional_properties = d
        return search_mapping_rules_for_group_data_filter
