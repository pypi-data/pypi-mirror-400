...
T = TypeVar("T", bound="GetProcessDefinitionInstanceVersionStatisticsResponse200Page")


@_attrs_define
class GetProcessDefinitionInstanceVersionStatisticsResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_process_definition_instance_version_statistics_response_200_page = cls(
        ...
        get_process_definition_instance_version_statistics_response_200_page.additional_properties = d
        return get_process_definition_instance_version_statistics_response_200_page
