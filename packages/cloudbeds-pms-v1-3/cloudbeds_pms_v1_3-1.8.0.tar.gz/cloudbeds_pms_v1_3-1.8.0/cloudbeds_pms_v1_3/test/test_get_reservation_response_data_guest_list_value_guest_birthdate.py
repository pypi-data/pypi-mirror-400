...
class TestGetReservationResponseDataGuestListValueGuestBirthdate(unittest.TestCase):
    """GetReservationResponseDataGuestListValueGuestBirthdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservationResponseDataGuestListValueGuestBirthdate:
        """Test GetReservationResponseDataGuestListValueGuestBirthdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservationResponseDataGuestListValueGuestBirthdate`
        """
        model = GetReservationResponseDataGuestListValueGuestBirthdate()
        if include_optional:
            return GetReservationResponseDataGuestListValueGuestBirthdate(
            )
        else:
            return GetReservationResponseDataGuestListValueGuestBirthdate(
        )
    ...
    def testGetReservationResponseDataGuestListValueGuestBirthdate(self):
        """Test GetReservationResponseDataGuestListValueGuestBirthdate"""
