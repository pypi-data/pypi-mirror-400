...
# c.IncludeHeaderFooter.header = "../../source/<assignment_id>/header.ipynb"  # Header notebook file
# c.IncludeHeaderFooter.footer = "../../source/<assignment_id>/footer.ipynb"  # Footer notebook file
