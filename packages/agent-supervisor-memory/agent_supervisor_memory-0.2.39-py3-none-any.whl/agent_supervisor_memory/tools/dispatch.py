...
def register_dispatch_tools(
    ...
    *,
    ...
    def _dispatch_for_job(job_id: str) -> CodexDispatch:
        ...
        if bucket:
            return CodexDispatch(CodexDispatchConfig(jobs_dir=Path(dispatch_base_dir).expanduser() / bucket))
        try:
            base = Path(dispatch_base_dir).expanduser()
            ...
            pass
        return CodexDispatch(CodexDispatchConfig(jobs_dir=Path(dispatch_base_dir).expanduser()))
