...
# TODO: Comment odoorpc because it doesn't work in python3.10 and is used only in one checker.
#   more info: https://git.vauxoo.com/deployv/deployv/-/merge_requests/703
# import odoorpc
...
class TestDockerUser(EventListenerBase):
    ...
    def execute(self, obj):
        ...
        from docker import from_env  # pylint: disable=C0415
        cli = from_env().api
        try:
...
class InstallTestRepo(EventListenerBase):
    ...
    def execute(self, obj, returned_value):
        ...
        if instance_type in instancev.INSTALL_RIBBON\
                ...
                and not obj.instance_manager._skip_install_test_ribbon:
            res = True
...
class TestContainer(EventListenerBase):
    ...
    def execute(self, obj, returned_value):
        ...
        # TODO: Comment `test_connection` checker,
        # more info: https://git.vauxoo.com/deployv/deployv/-/merge_requests/703
    ...
    # TODO: Comment checker more info: https://git.vauxoo.com/deployv/deployv/-/merge_requests/703
