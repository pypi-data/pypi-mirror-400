...
if TYPE_CHECKING:
    from ..models.create_documents_data_metadata_list_item_custom_properties import (
        CreateDocumentsDataMetadataListItemCustomProperties,
    )


T = TypeVar("T", bound="CreateDocumentsDataMetadataListItem")


@_attrs_define
class CreateDocumentsDataMetadataListItem:
    ...
    Attributes:
        ...
        process_instance_key (str | Unset): The key of the process instance that created the document. Example:
            2251799813690746.
        custom_properties (CreateDocumentsDataMetadataListItemCustomProperties | Unset): Custom properties of the
            document.
    """
    ...
    custom_properties: CreateDocumentsDataMetadataListItemCustomProperties | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_properties, Unset):
            ...
            custom_properties = (
                CreateDocumentsDataMetadataListItemCustomProperties.from_dict(
                    _custom_properties
                )
            )

        create_documents_data_metadata_list_item = cls(
        ...
        create_documents_data_metadata_list_item.additional_properties = d
        return create_documents_data_metadata_list_item
