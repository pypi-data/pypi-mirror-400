...
if TYPE_CHECKING:
    # fmt: off
    from ..models.delete_secret_params_kwargs import (
        DeleteSecretParamsKwargs,  # noqa: F401
    )
    # fmt: on


T = TypeVar("T", bound="DeleteSecretParams")


@attrs.define
class DeleteSecretParams:
    """
    Attributes:
        key (str):
        kwargs (Union[Unset, DeleteSecretParamsKwargs]):
        secret_store (Union[Unset, str]):  Default: 'local_store'.
        workspace_uid (Union[Unset, int]):  Default: 1.
    """

    key: str
    kwargs: Union[Unset, "DeleteSecretParamsKwargs"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_kwargs, Unset):
            ...
            kwargs = DeleteSecretParamsKwargs.from_dict(_kwargs)
