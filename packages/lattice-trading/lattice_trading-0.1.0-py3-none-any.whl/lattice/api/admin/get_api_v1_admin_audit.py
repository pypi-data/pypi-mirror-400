...
from ...models.get_api_v1_admin_audit_response_200 import GetApiV1AdminAuditResponse200
...
) -> Any | GetApiV1AdminAuditResponse200 | None:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetApiV1AdminAuditResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | GetApiV1AdminAuditResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Any, GetApiV1AdminAuditResponse200]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, GetApiV1AdminAuditResponse200]
    """
