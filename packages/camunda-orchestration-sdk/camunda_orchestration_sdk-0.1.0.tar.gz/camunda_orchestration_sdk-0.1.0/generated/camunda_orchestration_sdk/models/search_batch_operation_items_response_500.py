...
T = TypeVar("T", bound="SearchBatchOperationItemsResponse500")


@_attrs_define
class SearchBatchOperationItemsResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_batch_operation_items_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_batch_operation_items_response_500.additional_properties = d
        return search_batch_operation_items_response_500
