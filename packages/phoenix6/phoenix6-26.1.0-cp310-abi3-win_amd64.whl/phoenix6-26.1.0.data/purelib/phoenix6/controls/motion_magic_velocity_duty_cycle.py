...
class MotionMagicVelocityDutyCycle:
    ...
    def __init__(self, velocity: rotations_per_second, acceleration: rotations_per_second_squared = 0.0, enable_foc: bool = True, feed_forward: float = 0.0, slot: int = 0, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, ignore_software_limits: bool = False, use_timesync: bool = False):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "MotionMagicVelocityDutyCycle"
    ...
    def with_ignore_software_limits(self, new_ignore_software_limits: bool) -> 'MotionMagicVelocityDutyCycle':
        """
