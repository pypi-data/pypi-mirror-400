...
__all__: list[str] = ['CubicHermiteSpline', 'QuinticHermiteSpline', 'Spline3', 'Spline5', 'SplineHelper', 'SplineParameterizer']
class CubicHermiteSpline(Spline3):
    """
    Represents a hermite spline of degree 3.
    """
    def __init__(self, xInitialControlVector: tuple[typing.SupportsFloat, typing.SupportsFloat], xFinalControlVector: tuple[typing.SupportsFloat, typing.SupportsFloat], yInitialControlVector: tuple[typing.SupportsFloat, typing.SupportsFloat], yFinalControlVector: tuple[typing.SupportsFloat, typing.SupportsFloat]) -> None:
        """
...
class QuinticHermiteSpline(Spline5):
    ...
    """
    def __init__(self, xInitialControlVector: tuple[typing.SupportsFloat, typing.SupportsFloat, typing.SupportsFloat], xFinalControlVector: tuple[typing.SupportsFloat, typing.SupportsFloat, typing.SupportsFloat], yInitialControlVector: tuple[typing.SupportsFloat, typing.SupportsFloat, typing.SupportsFloat], yFinalControlVector: tuple[typing.SupportsFloat, typing.SupportsFloat, typing.SupportsFloat]) -> None:
        """
...
class Spline3:
    ...
    class ControlVector:
        ...
        dimension.
        """
        def __init__(self, x: tuple[typing.SupportsFloat, typing.SupportsFloat], y: tuple[typing.SupportsFloat, typing.SupportsFloat]) -> None:
            ...
        @property
        def x(self) -> tuple[float, float]:
            ...
            """
        @x.setter
        def x(self, arg0: tuple[typing.SupportsFloat, typing.SupportsFloat]) -> None:
            ...
        @property
        def y(self) -> tuple[float, float]:
            ...
            """
        @y.setter
        def y(self, arg0: tuple[typing.SupportsFloat, typing.SupportsFloat]) -> None:
            ...
    def __init__(self) -> None:
        ...
    def coefficients(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 4]"]:
        """
    ...
    def getInitialControlVector(self) -> Spline3.ControlVector:
        ...
        :returns: The initial control vector that created this spline.
        """
    def getPoint(self, t: typing.SupportsFloat) -> tuple[wpimath.geometry._geometry.Pose2d, wpimath.units.radians_per_meter] | None:
        """
...
class Spline5:
    ...
    class ControlVector:
        ...
        dimension.
        """
        def __init__(self, x: tuple[typing.SupportsFloat, typing.SupportsFloat, typing.SupportsFloat], y: tuple[typing.SupportsFloat, typing.SupportsFloat, typing.SupportsFloat]) -> None:
            ...
        @property
        def x(self) -> tuple[float, float, float]:
            ...
            """
        @x.setter
        def x(self, arg0: tuple[typing.SupportsFloat, typing.SupportsFloat, typing.SupportsFloat]) -> None:
            ...
        @property
        def y(self) -> tuple[float, float, float]:
            ...
            """
        @y.setter
        def y(self, arg0: tuple[typing.SupportsFloat, typing.SupportsFloat, typing.SupportsFloat]) -> None:
            ...
    def __init__(self) -> None:
        ...
    def coefficients(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[6, 6]"]:
        """
        Returns the coefficients of the spline.
...
class SplineHelper:
    ...
    """
    @staticmethod
    def cubicControlVectorsFromWaypoints(start: wpimath.geometry._geometry.Pose2d, interiorWaypoints: collections.abc.Sequence[wpimath.geometry._geometry.Translation2d], end: wpimath.geometry._geometry.Pose2d) -> tuple[Spline3.ControlVector, Spline3.ControlVector]:
        """
        ...
        """
    @staticmethod
    def cubicSplinesFromControlVectors(start: Spline3.ControlVector, waypoints: collections.abc.Sequence[wpimath.geometry._geometry.Translation2d], end: Spline3.ControlVector) -> list[CubicHermiteSpline]:
        """
        ...
        """
    @staticmethod
    def optimizeCurvature(splines: collections.abc.Sequence[QuinticHermiteSpline]) -> list[QuinticHermiteSpline]:
        """
        ...
        """
    @staticmethod
    def quinticSplinesFromControlVectors(controlVectors: collections.abc.Sequence[Spline5.ControlVector]) -> list[QuinticHermiteSpline]:
        """
        ...
        """
    @staticmethod
    def quinticSplinesFromWaypoints(waypoints: collections.abc.Sequence[wpimath.geometry._geometry.Pose2d]) -> list[QuinticHermiteSpline]:
        """
...
class SplineParameterizer:
    ...
    @staticmethod
    @typing.overload
    def parameterize(spline: Spline3, t0: typing.SupportsFloat = 0.0, t1: typing.SupportsFloat = 1.0) -> list[tuple[wpimath.geometry._geometry.Pose2d, wpimath.units.radians_per_meter]]:
        """
    ...
    @staticmethod
    @typing.overload
    def parameterize(spline: Spline5, t0: typing.SupportsFloat = 0.0, t1: typing.SupportsFloat = 1.0) -> list[tuple[wpimath.geometry._geometry.Pose2d, wpimath.units.radians_per_meter]]:
        """
        Parametrizes the spline. This method breaks up the spline into various
        arcs until their dx, dy, and dtheta are within specific tolerances.
