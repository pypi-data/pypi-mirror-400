...
T = TypeVar("T", bound="UptimeRobotEmailIntegration")


@_attrs_define
class UptimeRobotEmailIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        uptime_robot_email_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        uptime_robot_email_integration.additional_properties = d
        return uptime_robot_email_integration
