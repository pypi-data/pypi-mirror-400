...
class StringArray_V1_0_1(Serialiser):
    """List of strings.
    ...
    SCHEMA_ID = "/elements/string-array/1.0.1/string-array.schema.json"
    ...
    def __post_init__(self):
        ...
        if not self.data_type == "string":
            raise ValidationFailed('self.data_type == "string" failed')
