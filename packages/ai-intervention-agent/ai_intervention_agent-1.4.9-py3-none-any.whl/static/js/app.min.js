...
async function insertCodeFromClipboard(){try{if(!navigator.clipboard||typeof navigator.clipboard.readText!=='function'){openCodePasteModal()
return}
const text=await navigator.clipboard.readText()
if(!text){showStatus('剪贴板为空','error')
return}
insertCodeBlockIntoFeedbackTextarea(text)
showStatus('代码已插入','success')}catch(error){console.error('读取剪贴板失败:',error)
...
if(name==='NotFoundError'){return'未读取到剪贴板内容。请在下方手动粘贴代码。'}}catch(e){}
