"""
Meter integrated within EVSE to record energy consumption or injection. Supports billing, analytics, and load tracking.
...
class EnergyMeterEvse(GridSTIXDomainObject):
    """
    Meter integrated within EVSE to record energy consumption or injection. Supports billing, analytics, and load tracking.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize EnergyMeterEvse with Grid-STIX properties."""
