...
class ListFilesFilter(BaseModel):
    ...
    __properties = ["recursive", "sample_id", "member_id", "sample_external_id", "member_external_id", "path"]
    ...
    def to_dict(self):
        ...
        # set to None if sample_external_id (nullable) is None
        # and __fields_set__ contains the field
        if self.sample_external_id is None and "sample_external_id" in self.__fields_set__:
            _dict["sample_external_id"] = None
        ...
        _obj = ListFilesFilter.parse_obj(
            {
                ...
                "sample_external_id": obj.get("sample_external_id"),
