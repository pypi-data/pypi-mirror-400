...
@final
class Diff_MotionMagicVelocityVoltage_Position:
    """
    ...
    def __init__(self, average_request: MotionMagicVelocityVoltage, differential_request: PositionVoltage):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_MotionMagicVelocityVoltage_Position"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicVelocityVoltage_Position")
    ...
    def with_average_request(self, new_average_request: MotionMagicVelocityVoltage) -> 'Diff_MotionMagicVelocityVoltage_Position':
        ...
        :returns: Itself
        :rtype: Diff_MotionMagicVelocityVoltage_Position
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: PositionVoltage) -> 'Diff_MotionMagicVelocityVoltage_Position':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicVelocityVoltage_Position':
        """
