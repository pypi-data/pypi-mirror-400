...
EEG Semantic Imagination and Perception Dataset (OpenNeuro ``ds004306``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 1` :bdg-light:`License: CC0` :bdg-light:`Subjects: 12` :bdg-light:`Recordings: 15` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds004306.v1.0.2 <https://doi.org/10.18112/openneuro.ds004306.v1.0.2>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds004306>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds004306>`__
