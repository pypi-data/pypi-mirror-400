...
class GetInternalCorePrices200Response(BaseModel):
    """
    GetInternalCorePrices200Response
    """ # noqa: E501
    data: List[CorePriceSchema]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [CorePriceSchema.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
