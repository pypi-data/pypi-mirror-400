...
T = TypeVar("T", bound="NagiosXIV2Callback")


@_attrs_define
class NagiosXIV2Callback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nagios_xiv2_callback.additional_properties = d
        return nagios_xiv2_callback
