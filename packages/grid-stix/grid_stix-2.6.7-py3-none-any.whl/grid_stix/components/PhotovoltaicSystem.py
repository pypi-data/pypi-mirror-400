"""
DER asset that generates electricity from solar energy using photovoltaic cells.
...
class PhotovoltaicSystem(GridSTIXDomainObject):
    """
    DER asset that generates electricity from solar energy using photovoltaic cells.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize PhotovoltaicSystem with Grid-STIX properties."""
