...
from xladmin.views import BaseAdminPlugin, ModelFormAdminView, DetailAdminView
from xladmin.layout import Fieldset, Column
...
class BasePortalPlugin(BaseAdminPlugin):
    ...
    def get_media(self, media):
        ...
        return media + Media(js=[self.static('xladmin/js/xladmin.plugin.portal.js')])
