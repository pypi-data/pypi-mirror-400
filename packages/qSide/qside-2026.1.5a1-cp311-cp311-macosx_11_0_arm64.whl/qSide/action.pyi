...
class QAction(QtGui.QAction):
    ...
    def __init__(self, text: str = '', icon: QIcon | str | None = None, parent: QObject | None = None, tip: str = '', data: Any = None, checkable: bool = False, checked: bool = False, shortcut: QKeySequence | QKeySequence.StandardKey | str | int = '', shortcutContext: Qt.ShortcutContext = ..., visiblePredicate: Callable[[QAction], bool] | None = None, enabledPredicate: Callable[[QAction], bool] | None = None, checkedPredicate: Callable[[QAction], bool] | None = None, triggered: Callable[[], None] | None = None, toggled: Callable[[bool], None] | None = None, id: str = '') -> None: ...
