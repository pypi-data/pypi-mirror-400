...
T = TypeVar("T", bound="AmazonCloudTrailIntegration")
...
class AmazonCloudTrailIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        amazon_cloud_trail_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        amazon_cloud_trail_integration.additional_properties = d
        return amazon_cloud_trail_integration
