...
T = TypeVar("T", bound="AmazonSecurityHubIntegration")


@_attrs_define
class AmazonSecurityHubIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        amazon_security_hub_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        amazon_security_hub_integration.additional_properties = d
        return amazon_security_hub_integration
