...
T = TypeVar("T", bound="FailJobResponse409")


@_attrs_define
class FailJobResponse409:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fail_job_response_409.additional_properties = d
        return fail_job_response_409
