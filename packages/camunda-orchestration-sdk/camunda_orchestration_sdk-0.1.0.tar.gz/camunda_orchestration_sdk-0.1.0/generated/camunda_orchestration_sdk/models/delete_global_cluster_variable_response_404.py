...
T = TypeVar("T", bound="DeleteGlobalClusterVariableResponse404")


@_attrs_define
class DeleteGlobalClusterVariableResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_global_cluster_variable_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_global_cluster_variable_response_404.additional_properties = d
        return delete_global_cluster_variable_response_404
