...
T = TypeVar("T", bound="TokenBasedIncomingFeature")
...
class TokenBasedIncomingFeature:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        token_based_incoming_feature = cls(
        ...
        token_based_incoming_feature.additional_properties = d
        return token_based_incoming_feature
