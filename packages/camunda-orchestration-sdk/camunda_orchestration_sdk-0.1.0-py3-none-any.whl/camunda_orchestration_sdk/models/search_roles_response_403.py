...
T = TypeVar("T", bound="SearchRolesResponse403")


@_attrs_define
class SearchRolesResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_roles_response_403.additional_properties = d
        return search_roles_response_403
