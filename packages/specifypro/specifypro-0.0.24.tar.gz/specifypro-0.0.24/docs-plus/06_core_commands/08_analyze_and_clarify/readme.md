...
With clarifications resolved and coverage verified, proceed to [Step 8: Ship with `/spp.git.commit_pr`](../09_git_commit_pr/readme.md) to finalize the branch and open the pull request.
