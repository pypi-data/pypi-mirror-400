...
T = TypeVar("T", bound="GetTenantResponse404")


@_attrs_define
class GetTenantResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_tenant_response_404.additional_properties = d
        return get_tenant_response_404
