...
T = TypeVar("T", bound="SearchCorrelatedMessageSubscriptionsResponse200Page")


@_attrs_define
class SearchCorrelatedMessageSubscriptionsResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_correlated_message_subscriptions_response_200_page = cls(
        ...
        search_correlated_message_subscriptions_response_200_page.additional_properties = d
        return search_correlated_message_subscriptions_response_200_page
