...
T = TypeVar("T", bound="NagiosXIV1Callback")


@_attrs_define
class NagiosXIV1Callback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nagios_xiv1_callback.additional_properties = d
        return nagios_xiv1_callback
