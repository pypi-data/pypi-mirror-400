...
from ..models.search_audit_logs_response_200_items_item_actor_type import (
    SearchAuditLogsResponse200ItemsItemActorType,
)
from ..models.search_audit_logs_response_200_items_item_batch_operation_type import (
    SearchAuditLogsResponse200ItemsItemBatchOperationType,
)
from ..models.search_audit_logs_response_200_items_item_category import (
    SearchAuditLogsResponse200ItemsItemCategory,
)
from ..models.search_audit_logs_response_200_items_item_entity_type import (
    SearchAuditLogsResponse200ItemsItemEntityType,
)
from ..models.search_audit_logs_response_200_items_item_operation_type import (
    SearchAuditLogsResponse200ItemsItemOperationType,
)
from ..models.search_audit_logs_response_200_items_item_result import (
    SearchAuditLogsResponse200ItemsItemResult,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SearchAuditLogsResponse200ItemsItem")


@_attrs_define
class SearchAuditLogsResponse200ItemsItem:
    """Audit log item.
    ...
    Attributes:
        ...
        entity_type (SearchAuditLogsResponse200ItemsItemEntityType | Unset): The type of entity affected by the
            operation.
        operation_type (SearchAuditLogsResponse200ItemsItemOperationType | Unset): The type of operation performed.
        batch_operation_key (str | Unset): Key of the batch operation. Example: 2251799813684321.
        batch_operation_type (SearchAuditLogsResponse200ItemsItemBatchOperationType | Unset): The type of batch
        ...
        actor_type (SearchAuditLogsResponse200ItemsItemActorType | Unset): The type of actor who performed the
            operation.
        tenant_id (str | Unset): The tenant ID of the audit log. Example: customer-service.
        result (SearchAuditLogsResponse200ItemsItemResult | Unset): The result status of the operation.
        annotation (str | Unset): Additional notes about the operation.
        category (SearchAuditLogsResponse200ItemsItemCategory | Unset): The category of the audit log operation.
    ...
    entity_type: SearchAuditLogsResponse200ItemsItemEntityType | Unset = UNSET
    operation_type: SearchAuditLogsResponse200ItemsItemOperationType | Unset = UNSET
    batch_operation_key: BatchOperationKey | Unset = UNSET
    batch_operation_type: (
        SearchAuditLogsResponse200ItemsItemBatchOperationType | Unset
    ) = UNSET
    timestamp: datetime.datetime | Unset = UNSET
    actor_id: str | Unset = UNSET
    actor_type: SearchAuditLogsResponse200ItemsItemActorType | Unset = UNSET
    tenant_id: TenantId | Unset = UNSET
    result: SearchAuditLogsResponse200ItemsItemResult | Unset = UNSET
    annotation: str | Unset = UNSET
    category: SearchAuditLogsResponse200ItemsItemCategory | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_entity_type, Unset):
            ...
            entity_type = SearchAuditLogsResponse200ItemsItemEntityType(_entity_type)

        _operation_type = d.pop("operationType", UNSET)
        operation_type: SearchAuditLogsResponse200ItemsItemOperationType | Unset
        if isinstance(_operation_type, Unset):
            operation_type = UNSET
        else:
            operation_type = SearchAuditLogsResponse200ItemsItemOperationType(
                _operation_type
            )
        ...
        actor_type: SearchAuditLogsResponse200ItemsItemActorType | Unset
        ...
        if isinstance(_result, Unset):
            ...
            result = SearchAuditLogsResponse200ItemsItemResult(_result)

        annotation = d.pop("annotation", UNSET)

        _category = d.pop("category", UNSET)
        category: SearchAuditLogsResponse200ItemsItemCategory | Unset
        ...
        return search_audit_logs_response_200_items_item
