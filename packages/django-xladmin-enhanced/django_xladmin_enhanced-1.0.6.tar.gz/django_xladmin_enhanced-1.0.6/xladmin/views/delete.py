...
from xladmin.views.edit import UpdateAdminView
from xladmin.views.detail import DetailAdminView
from xladmin.views.base import ModelAdminView, filter_hook, csrf_protect_m
