...
class NCVXQP7(AbstractConstrainedQuadraticProblem):
    """NCVXQP7 problem - a non-convex quadratic program.
    ...
    def expected_result(self):
        ...
        raise NotImplementedError("Expected result not available for NCVXQP7")
