...
if TYPE_CHECKING:
    # fmt: off
    from ..models.template_filter_schema_template_config import (
        TemplateFilterSchemaTemplateConfig,  # noqa: F401
    )
    # fmt: on


T = TypeVar("T", bound="TemplateFilterSchema")


@attrs.define
class TemplateFilterSchema:
    """
    Attributes:
        template_config (TemplateFilterSchemaTemplateConfig):
        filter_type (Union[Unset, FilterTransformFilterTypes]):
        transform_config_type (Union[Literal['template_filter_schema'], Unset]):  Default: 'template_filter_schema'.
    """

    template_config: "TemplateFilterSchemaTemplateConfig"
    filter_type: Union[Unset, FilterTransformFilterTypes] = UNSET
    transform_config_type: Union[Literal["template_filter_schema"], Unset] = (
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        # fmt: on
        d = src_dict.copy()
        template_config = TemplateFilterSchemaTemplateConfig.from_dict(
            d.pop("template_config")
        )
