...
T = TypeVar("T", bound="BroadcastSignalResponse500")


@_attrs_define
class BroadcastSignalResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        broadcast_signal_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        broadcast_signal_response_500.additional_properties = d
        return broadcast_signal_response_500
