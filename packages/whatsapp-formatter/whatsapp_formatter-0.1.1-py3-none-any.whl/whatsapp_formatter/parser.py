...
def _get_model() -> str:
    ...
    return os.environ.get("OPENROUTER_MODEL") or os.environ.get("OPENAI_MODEL") or "openai/gpt-4o-mini"
...
def parse(text: str) -> LLMOutput:
    ...
    - OPENROUTER_BASE_URL or OPENAI_BASE_URL (optional, for OpenRouter)
