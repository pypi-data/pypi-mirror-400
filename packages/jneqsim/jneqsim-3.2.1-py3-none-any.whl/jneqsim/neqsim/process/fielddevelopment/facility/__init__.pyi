...
class FacilityBuilder(java.io.Serializable):
    ...
    @staticmethod
    def autoGenerate(fieldConcept: jneqsim.neqsim.process.fielddevelopment.concept.FieldConcept) -> 'FacilityBuilder': ...
    def build(self) -> 'FacilityConfig': ...
    def designMargin(self, double: float) -> 'FacilityBuilder': ...
    @staticmethod
    def forConcept(fieldConcept: jneqsim.neqsim.process.fielddevelopment.concept.FieldConcept) -> 'FacilityBuilder': ...
...
class FacilityConfig(java.io.Serializable):
    ...
    def getConcept(self) -> jneqsim.neqsim.process.fielddevelopment.concept.FieldConcept: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("jneqsim.neqsim.process.fielddevelopment.facility")``.
