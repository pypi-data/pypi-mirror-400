...
T = TypeVar("T", bound="GetApiV1AdminMarketsMarketIdSettlementResponse200")


@_attrs_define
class GetApiV1AdminMarketsMarketIdSettlementResponse200:
    """
    Attributes:
        market_id (str):
        status (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_api_v1_admin_markets_market_id_settlement_response_200 = cls(
            market_id=market_id,
            status=status,
        ...
        return get_api_v1_admin_markets_market_id_settlement_response_200
