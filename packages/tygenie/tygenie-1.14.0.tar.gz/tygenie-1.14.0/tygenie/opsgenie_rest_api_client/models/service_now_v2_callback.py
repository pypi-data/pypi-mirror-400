...
T = TypeVar("T", bound="ServiceNowV2Callback")


@_attrs_define
class ServiceNowV2Callback:
    """
    Attributes:
        ...
        scripted_rest_apiurl (Union[Unset, str]):
        servicenow_user_name (Union[Unset, str]):
        servicenow_password (Union[Unset, str]):
    """
    ...
    scripted_rest_apiurl: Union[Unset, str] = UNSET
    servicenow_user_name: Union[Unset, str] = UNSET
    servicenow_password: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        scripted_rest_apiurl = self.scripted_rest_apiurl

        servicenow_user_name = self.servicenow_user_name
        ...
        if scripted_rest_apiurl is not UNSET:
            field_dict["scriptedRestAPIURL"] = scripted_rest_apiurl
        if servicenow_user_name is not UNSET:
            field_dict["servicenowUserName"] = servicenow_user_name
        if servicenow_password is not UNSET:
            field_dict["servicenowPassword"] = servicenow_password
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        scripted_rest_apiurl = d.pop("scriptedRestAPIURL", UNSET)

        servicenow_user_name = d.pop("servicenowUserName", UNSET)

        servicenow_password = d.pop("servicenowPassword", UNSET)

        service_now_v2_callback = cls(
            ...
            scripted_rest_apiurl=scripted_rest_apiurl,
            servicenow_user_name=servicenow_user_name,
            servicenow_password=servicenow_password,
        )

        service_now_v2_callback.additional_properties = d
        return service_now_v2_callback
