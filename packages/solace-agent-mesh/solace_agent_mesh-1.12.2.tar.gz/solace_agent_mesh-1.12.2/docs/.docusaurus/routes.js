...
export default [
  {
    ...
    component: ComponentCreator('/solace-agent-mesh/docs', '5e0'),
    routes: [
      {
        path: '/solace-agent-mesh/docs',
        component: ComponentCreator('/solace-agent-mesh/docs', '39d'),
        routes: [
          {
            path: '/solace-agent-mesh/docs',
            component: ComponentCreator('/solace-agent-mesh/docs', '876'),
            routes: [
              {
              ...
              {
                path: '/solace-agent-mesh/docs/documentation/getting-started/vibe_coding',
                component: ComponentCreator('/solace-agent-mesh/docs/documentation/getting-started/vibe_coding', '2e0'),
                exact: true,
                sidebar: "docSidebar"
              },
              {
