...
class AsyncClient:
    ...
    Example:
        ...
        ...     alias="production-db",
        ... ) as client:
        ...     result = await client.cypher_query("MATCH (c:Class) RETURN c")
        ...     for node in result.get_nodes():
        ...         print(node.name)

        >>> # Enable writes explicitly
        >>> client = AsyncClient(api_key="your-key", read_only=False)
        >>> await client.cypher_query("CREATE (n:Test) RETURN n")
    """
    ...
    async def get_all_classes(
        ...
        Example:
            >>> classes = await client.get_all_classes(limit=100)
        """
    ...
    async def find_class_by_name(
        ...
        Example:
            >>> cls = await client.find_class_by_name("UserService")
            >>> if cls:
            ...     print(cls.docstring)
        """
    ...
    async def find_classes_by_name_pattern(
        self,
        pattern: str,
        alias: str | None = None,
    ) -> list[ClassNode]:
        ...
        Example:
            ...
            >>> pattern = ".*Service$"
            >>> services = await client.find_classes_by_name_pattern(pattern)
        """
    ...
    async def find_classes_by_metadata(
        self,
        ...
        Example:
            ...
            >>> abstract = await client.find_classes_by_metadata(meta)
        """
        if not filters:
            return await self.get_all_classes(alias=alias)
    ...
    async def count_classes(self, alias: str | None = None) -> int:
        """
        ...
        Example:
            >>> total = await client.count_classes()
    ...
    async def class_exists(self, name: str, alias: str | None = None) -> bool:
        """
        ...
        Example:
            >>> if await client.class_exists("UserService"):
            ...     print("Class found")
        """
        escaped = _escape_cypher_string(name)
        query = (
    ...
    async def get_all_modules(
        ...
        Example:
            >>> modules = await client.get_all_modules(limit=50)
        """
        limit_clause = f" LIMIT {limit}" if limit else ""
    ...
    async def find_module_by_name(
        ...
        Example:
            >>> mod = await client.find_module_by_name("utils")
        """
        escaped = _escape_cypher_string(name)
    ...
    async def find_modules_by_name_pattern(
        self,
        pattern: str,
        alias: str | None = None,
    ) -> list[ModuleNode]:
        ...
        Example:
            >>> pattern = "^test_.*"
            >>> test_mods = await client.find_modules_by_name_pattern(pattern)
        """
        escaped = _escape_cypher_string(pattern)
    ...
    async def find_modules_by_path_pattern(
        self,
        pattern: str,
        alias: str | None = None,
    ) -> list[ModuleNode]:
        ...
        Example:
            ...
            >>> svc = await client.find_modules_by_path_pattern(pattern)
        """
        escaped = _escape_cypher_string(pattern)
    ...
    async def find_modules_by_metadata(
        self,
        filters: dict[str, Any],
        alias: str | None = None,
    ) -> list[ModuleNode]:
        ...
        """
        if not filters:
            return await self.get_all_modules(alias=alias)
    ...
    async def count_modules(self, alias: str | None = None) -> int:
        """
    ...
    async def module_exists(self, name: str, alias: str | None = None) -> bool:
        """
    ...
    async def find_subroutine_by_name(
        self,
        name: str,
        alias: str | None = None,
    ) -> SubroutineNode | None:
    ...
    async def find_subroutines_by_name_pattern(
        self,
        pattern: str,
        alias: str | None = None,
    ) -> list[SubroutineNode]:
        ...
        Example:
            >>> pat = "^get_.*"
            >>> getters = await client.find_subroutines_by_name_pattern(pat)
        """
        escaped = _escape_cypher_string(pattern)
    ...
    async def find_subroutines_by_return_type(
        self,
        return_type: str,
        alias: str | None = None,
    ) -> list[SubroutineNode]:
        ...
        Example:
            >>> funcs = await client.find_subroutines_by_return_type("bool")
        """
    ...
    async def find_subroutines_by_metadata(
        self,
        filters: dict[str, Any],
        alias: str | None = None,
    ) -> list[SubroutineNode]:
        ...
        """
        if not filters:
            return await self.get_all_subroutines(alias=alias)
    ...
    async def count_subroutines(self, alias: str | None = None) -> int:
        """
    ...
    async def find_attribute_by_name(
        self,
        name: str,
        alias: str | None = None,
    ) -> AttributeNode | None:
    ...
    async def find_attributes_by_name_pattern(
        self,
        pattern: str,
        alias: str | None = None,
    ) -> list[AttributeNode]:
        ...
        Example:
            ...
            >>> private = await client.find_attributes_by_name_pattern("^_.*")
        """
        escaped = _escape_cypher_string(pattern)
    ...
    async def find_attributes_by_type(
        ...
        Example:
            ...
            >>> str_attrs = await client.find_attributes_by_type("str")
        """
    ...
    async def count_attributes(self, alias: str | None = None) -> int:
        """
    ...
    async def get_classes_inheriting_from(
        self,
        base_class_name: str,
        ...
        Example:
            >>> direct = await client.get_classes_inheriting_from("X")
            >>> all_sub = await client.get_classes_inheriting_from(
            ...     "X", recursive=True
            ... )
        """
    ...
    async def get_base_classes(
        ...
        Example:
            ...
            >>> parents = await client.get_base_classes("UserService")
            >>> # Get all ancestors
            >>> ancestors = await client.get_base_classes("UserService", True)
        """
        escaped = _escape_cypher_string(class_name)
        depth = "*1.." if recursive else ""
        query = (
    ...
    async def get_subroutines_calling(
        self,
        subroutine_name: str,
        alias: str | None = None,
    ) -> list[SubroutineNode]:
        ...
        Example:
            >>> callers = await client.get_subroutines_calling("validate_user")
        """
        escaped = _escape_cypher_string(subroutine_name)
        query = (
            f"MATCH (caller:Subroutine)-[:triggers]->"
    ...
    async def get_subroutines_called_by(
        self,
        subroutine_name: str,
        alias: str | None = None,
    ) -> list[SubroutineNode]:
        ...
        Example:
            >>> callees = await client.get_subroutines_called_by("process")
        """
        escaped = _escape_cypher_string(subroutine_name)
        query = (
            f"MATCH (s:Subroutine {{name: '{escaped}'}})"
    ...
    async def get_modules_importing(
        self,
        module_name: str,
        alias: str | None = None,
    ) -> list[ModuleNode]:
        ...
        Example:
            ...
            >>> dependents = await client.get_modules_importing("utils")
        """
        escaped = _escape_cypher_string(module_name)
        query = (
    ...
    async def get_modules_imported_by(
        self,
        module_name: str,
        alias: str | None = None,
    ) -> list[ModuleNode]:
        ...
        Example:
            ...
            >>> deps = await client.get_modules_imported_by("user_service")
        """
        escaped = _escape_cypher_string(module_name)
        query = (
            f"MATCH (m:Module {{name: '{escaped}'}})"
    ...
    async def get_classes_used_by_subroutine(
        self,
        subroutine_name: str,
        alias: str | None = None,
    ) -> list[ClassNode]:
        ...
        Example:
            >>> cls = await client.get_classes_used_by_subroutine("fn")
        """
        escaped = _escape_cypher_string(subroutine_name)
        query = (
            f"MATCH (s:Subroutine {{name: '{escaped}'}})"
    ...
    async def get_subroutines_using_class(
        self,
        class_name: str,
        alias: str | None = None,
    ) -> list[SubroutineNode]:
        ...
        Example:
            >>> users = await client.get_subroutines_using_class("DatabaseConnection")  # noqa: E501
        """
        escaped = _escape_cypher_string(class_name)
        query = (
    ...
    async def find_async_subroutines(
        self,
        alias: str | None = None,
    ) -> list[SubroutineNode]:
        """
        ...
        Example:
            >>> async_funcs = await client.find_async_subroutines()
    ...
    async def find_abstract_classes(
        self,
        alias: str | None = None,
    ) -> list[ClassNode]:
        """
        ...
        Example:
            >>> abstract = await client.find_abstract_classes()
            >>> for cls in abstract:
    ...
    async def find_classes_with_base(
        self,
        base_name: str,
        alias: str | None = None,
    ) -> list[ClassNode]:
        ...
        Example:
            >>> models = await client.find_classes_with_base("BaseModel")
        """
    ...
    async def find_orphan_classes(
        ...
        Example:
            >>> orphans = await client.find_orphan_classes()
    ...
    async def find_orphan_subroutines(
        self,
        alias: str | None = None,
    ) -> list[SubroutineNode]:
        """
    ...
    async def get_classes_with_method_count(
        self,
        min_methods: int = 0,
        ...
        Example:
            >>> large = await client.get_classes_with_method_count(20)
            >>> for cls, cnt in large:
            ...     print(f"{cls.name}: {cnt} methods")
        """
    ...
    async def get_classes_by_names(
        self,
        names: list[str],
        alias: str | None = None,
    ) -> list[ClassNode]:
        ...
        Example:
            >>> classes = await client.get_classes_by_names(
    ...
    async def get_subroutines_by_names(
        self,
        names: list[str],
        alias: str | None = None,
    ) -> list[SubroutineNode]:
