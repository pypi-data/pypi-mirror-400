...
__all__: list[str] = ['CounterBase', 'GenericHID', 'MotorController']
class CounterBase:
    """
...
class GenericHID:
    ...
    class RumbleType:
        ...
        def value(self) -> int:
            ...
    @typing.overload
    def POV(self, angle: typing.SupportsInt, loop: wpilib.event._event.EventLoop) -> wpilib.event._event.BooleanEvent:
        """
        ...
        """
    @typing.overload
    def POV(self, pov: typing.SupportsInt, angle: typing.SupportsInt, loop: wpilib.event._event.EventLoop) -> wpilib.event._event.BooleanEvent:
        """
        Constructs a BooleanEvent instance based around this angle of a POV on the
        HID.
    ...
    def __repr__(self) -> str:
        ...
    def axisGreaterThan(self, axis: typing.SupportsInt, threshold: typing.SupportsFloat, loop: wpilib.event._event.EventLoop) -> wpilib.event._event.BooleanEvent:
        """
        ...
        """
    def axisLessThan(self, axis: typing.SupportsInt, threshold: typing.SupportsFloat, loop: wpilib.event._event.EventLoop) -> wpilib.event._event.BooleanEvent:
        """
        ...
        :returns: an event instance that is true when the axis value is less than the
                  provided threshold.
        """
    def button(self, button: typing.SupportsInt, loop: wpilib.event._event.EventLoop) -> wpilib.event._event.BooleanEvent:
        """
    ...
    def getAxisCount(self) -> int:
        ...
        """
    def getAxisType(self, axis: typing.SupportsInt) -> int:
        """
    ...
    def getName(self) -> str:
        ...
        """
    def getPOV(self, pov: typing.SupportsInt = 0) -> int:
        """
    ...
    def getPort(self) -> int:
        ...
        """
    def getRawAxis(self, axis: typing.SupportsInt) -> float:
        """
        ...
        """
    def getRawButton(self, button: typing.SupportsInt) -> bool:
        """
        ...
        """
    def getRawButtonPressed(self, button: typing.SupportsInt) -> bool:
        """
        ...
        """
    def getRawButtonReleased(self, button: typing.SupportsInt) -> bool:
        """
    ...
    def isConnected(self) -> bool:
        ...
        """
    def setOutput(self, outputNumber: typing.SupportsInt, value: bool) -> None:
        """
        ...
        """
    def setOutputs(self, value: typing.SupportsInt) -> None:
        """
        Set all output values for the HID.
        
        :param value: The 32 bit output value (1 bit for each output)
        """
    def setRumble(self, type: GenericHID.RumbleType, value: typing.SupportsFloat) -> None:
        """
