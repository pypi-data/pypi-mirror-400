...
class IndexArray4_V1_0_1(Serialiser):
    """Array of 4 indices, mostly a convenience for quadrilaterals.
    ...
    SCHEMA_ID = "/elements/index-array-4/1.0.1/index-array-4.schema.json"
    ...
    def __post_init__(self):
        ...
        if not self.width == 4:
            raise ValidationFailed("self.width == 4 failed")
