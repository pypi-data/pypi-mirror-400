...
T = TypeVar("T", bound="AzureServiceHealthIntegration")


@_attrs_define
class AzureServiceHealthIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        azure_service_health_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        azure_service_health_integration.additional_properties = d
        return azure_service_health_integration
