...
class DynamicMotionMagicDutyCycle:
    ...
    (optional) Jerk.  Users can optionally provide a duty cycle feedforward.
    ...
    def __init__(self, position: rotation, velocity: rotations_per_second, acceleration: rotations_per_second_squared, jerk: rotations_per_second_cubed = 0.0, enable_foc: bool = True, feed_forward: float = 0.0, slot: int = 0, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, ignore_software_limits: bool = False, use_timesync: bool = False):
    ...
    def with_ignore_software_limits(self, new_ignore_software_limits: bool) -> 'DynamicMotionMagicDutyCycle':
        """
