"""
Open vocabulary for renewable energy types
...
class RenewableTypeOv(GridSTIXDomainObject):
    """
    Open vocabulary for renewable energy types
    ...
    _type = "x-grid-renewable-type-ov"
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize RenewableTypeOv with Grid-STIX properties."""
