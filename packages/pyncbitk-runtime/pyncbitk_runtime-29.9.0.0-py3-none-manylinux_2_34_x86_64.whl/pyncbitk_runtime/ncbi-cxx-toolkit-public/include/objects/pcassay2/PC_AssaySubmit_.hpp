...
#ifndef OBJECTS_PCASSAY2_PC_ASSAYSUBMIT_BASE_HPP
#define OBJECTS_PCASSAY2_PC_ASSAYSUBMIT_BASE_HPP
...
class CPC_AssaySubmit_Base : public CSerialObject
{
...
public:
    ...
    class C_Assay : public CSerialObject
    {
        typedef CSerialObject Tparent;
    public:
        // constructor
        ...
        typedef objects::CPC_ID TAidver;
    ...
    /// List of SID's whose data is to be suppressed (vector)
    /// optional
    /// typedef vector< int > TRevoke
...
#endif // OBJECTS_PCASSAY2_PC_ASSAYSUBMIT_BASE_HPP
