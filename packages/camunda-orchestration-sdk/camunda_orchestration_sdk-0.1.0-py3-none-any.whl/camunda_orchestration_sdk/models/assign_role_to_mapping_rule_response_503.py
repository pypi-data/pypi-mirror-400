...
T = TypeVar("T", bound="AssignRoleToMappingRuleResponse503")


@_attrs_define
class AssignRoleToMappingRuleResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assign_role_to_mapping_rule_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        assign_role_to_mapping_rule_response_503.additional_properties = d
        return assign_role_to_mapping_rule_response_503
