...
class LogSeverity(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LogSeverity:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LogSeverity:
        """Create an instance of LogSeverity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LogSeverity.parse_obj(obj)

        _obj = LogSeverity.parse_obj({
            "value": obj.get("value")
        })
        return _obj

LogSeverity.update_forward_refs()
