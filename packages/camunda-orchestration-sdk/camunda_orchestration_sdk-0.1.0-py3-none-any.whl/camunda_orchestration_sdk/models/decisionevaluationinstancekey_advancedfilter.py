...
T = TypeVar("T", bound="DecisionevaluationinstancekeyAdvancedfilter")


@_attrs_define
class DecisionevaluationinstancekeyAdvancedfilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        decisionevaluationinstancekey_advancedfilter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        decisionevaluationinstancekey_advancedfilter.additional_properties = d
        return decisionevaluationinstancekey_advancedfilter
