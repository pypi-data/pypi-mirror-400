#!/usr/bin/env bash
# =============================================================================
# check-links.sh - Link Validation with lychee
# =============================================================================
# Usage: ./scripts/tools/check-links.sh [--check|--online] [--json] [-v] [paths...]
# =============================================================================
#
...
#   cd /path/to/workspace_template && shellcheck scripts/tools/check_links.sh
# =============================================================================
