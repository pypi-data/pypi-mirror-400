...
class SingleFadeAnimation:
    ...
    def __init__(self, led_start_index: int, led_end_index: int, slot: int = 0, color: RGBWColor = RGBWColor(), frame_rate: hertz = 100):
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: SingleFadeAnimation")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlSingleFadeAnimation(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.led_start_index, self.led_end_index, self.slot, self.color.red, self.color.green, self.color.blue, self.color.white, self.frame_rate))

    
    def with_led_start_index(self, new_led_start_index: int) -> 'SingleFadeAnimation':
        """
        ...
        :returns: Itself
        :rtype: SingleFadeAnimation
        """
        self.led_start_index = new_led_start_index
        return self
    
    def with_led_end_index(self, new_led_end_index: int) -> 'SingleFadeAnimation':
        """
    ...
    def with_slot(self, new_slot: int) -> 'SingleFadeAnimation':
        """
    ...
    def with_color(self, new_color: RGBWColor) -> 'SingleFadeAnimation':
        """
    ...
    def with_frame_rate(self, new_frame_rate: hertz) -> 'SingleFadeAnimation':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'SingleFadeAnimation':
        """
