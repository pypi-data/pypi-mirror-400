...
class DifferentialPositionDutyCycle:
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "DifferentialPositionDutyCycle"
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlDifferentialPositionDutyCycle(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.average_position, self.differential_position, self.enable_foc, self.average_slot, self.differential_slot, self.override_brake_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.ignore_hardware_limits, self.ignore_software_limits, self.use_timesync))

    
    def with_average_position(self, new_average_position: rotation) -> 'DifferentialPositionDutyCycle':
        """
    ...
    def with_average_slot(self, new_average_slot: int) -> 'DifferentialPositionDutyCycle':
        """
    ...
    def with_ignore_software_limits(self, new_ignore_software_limits: bool) -> 'DifferentialPositionDutyCycle':
        """
