...
class AsyncClient(BaseAsyncClient, AsyncHelperMixin):
    ...
    async def polygon_balances_v1(self, address: str) -> Dict:
        """Getting account balances"""
        params = None
        json = None
        return await self._request(
    ...
    async def polygon_account_v1_post(self) -> Dict:
        """Create an account"""
        params = None
        json = None
        return await self._request(
    ...
    async def polygon_transaction_v1(self, txid: str) -> Dict:
        """Getting transaction information"""
        params = None
        json = None
        return await self._request(
    ...
    async def polygon_transaction_v1_post(
        self,
        amount: Optional[float] = None,
        currency: Optional[str] = None,
        private_key: Optional[str] = None,
    ...
    async def polygon_subscribe_v1_post(
        self, addresses: Optional[Any] = None, currency: Optional[str] = None
    ) -> Dict:
        """Subscribe for notifications (callbacks)"""
        params = None
    ...
    async def operation_v1(self, operation_id: str) -> Dict:
