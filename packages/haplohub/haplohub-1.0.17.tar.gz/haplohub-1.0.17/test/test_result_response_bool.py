...
from haplohub.models.result_response_bool import ResultResponseBool  # noqa: E501


class TestResultResponseBool(unittest.TestCase):
    """ResultResponseBool unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultResponseBool:
        """Test ResultResponseBool
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ResultResponseBool`
        """
        model = ResultResponseBool()  # noqa: E501
        if include_optional:
    ...
    def testResultResponseBool(self):
        """Test ResultResponseBool"""
