...
static PyObject *
U8Vector2Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(uint8_t) * 2;
...
static PyMethodDef U8Vector2Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)U8Vector2Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
