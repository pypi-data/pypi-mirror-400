...
class DynamicPortPolicyPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    """
    name: NotRequired[str]  # Dynamic port policy name.
    description: NotRequired[str]  # Description for the Dynamic port policy.
    fortilink: str  # FortiLink interface for which this Dynamic port policy belon
    policy: NotRequired[list[dict[str, Any]]]  # Port policies with matching criteria and actions.
