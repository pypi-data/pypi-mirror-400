...
T = TypeVar("T", bound="EvaluateExpressionResponse401")


@_attrs_define
class EvaluateExpressionResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        evaluate_expression_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        evaluate_expression_response_401.additional_properties = d
        return evaluate_expression_response_401
