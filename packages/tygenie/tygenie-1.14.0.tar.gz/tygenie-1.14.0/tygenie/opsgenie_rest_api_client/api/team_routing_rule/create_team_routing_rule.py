...
from ...models.create_team_routing_rule_payload import CreateTeamRoutingRulePayload
from ...models.create_team_routing_rule_team_identifier_type import CreateTeamRoutingRuleTeamIdentifierType
...
def _get_kwargs(
    identifier: str,
    *,
    body: CreateTeamRoutingRulePayload,
    team_identifier_type: Union[
        Unset, CreateTeamRoutingRuleTeamIdentifierType
    ] = CreateTeamRoutingRuleTeamIdentifierType.ID,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        identifier (str):
        team_identifier_type (Union[Unset, CreateTeamRoutingRuleTeamIdentifierType]):  Default:
            CreateTeamRoutingRuleTeamIdentifierType.ID.
        body (CreateTeamRoutingRulePayload):
