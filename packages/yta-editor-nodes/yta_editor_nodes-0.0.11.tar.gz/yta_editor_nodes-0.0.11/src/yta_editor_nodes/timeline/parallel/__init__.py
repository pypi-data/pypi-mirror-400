from yta_editor_nodes.timeline.parallel.abstract import _ParallelNodeAbstract
from typing import Union


class ParallelNode(_ParallelNodeAbstract):
    """
    A node that is a composition of different nodes
    that are executed in parallel to obtain different
    outputs that are combined into a single one.
