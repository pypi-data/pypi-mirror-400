...
A dataset recorded during development of an affective brain-computer music interface: testing session (OpenNeuro ``ds002723``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 6` :bdg-light:`License: CC0` :bdg-light:`Subjects: 8` :bdg-light:`Recordings: 44` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `10.18112/openneuro.ds002723.v1.1.0 <https://doi.org/10.18112/openneuro.ds002723.v1.1.0>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds002723>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds002723>`__
