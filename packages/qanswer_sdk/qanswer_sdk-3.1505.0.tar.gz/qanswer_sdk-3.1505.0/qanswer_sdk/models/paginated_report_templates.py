...
class PaginatedReportTemplates(BaseModel):
    ...
    page: StrictInt
    page_size: StrictInt
    __properties: ClassVar[List[str]] = ["items", "total", "page", "page_size"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaginatedReportTemplates from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaginatedReportTemplates from a dict"""
        if obj is None:
            return None
