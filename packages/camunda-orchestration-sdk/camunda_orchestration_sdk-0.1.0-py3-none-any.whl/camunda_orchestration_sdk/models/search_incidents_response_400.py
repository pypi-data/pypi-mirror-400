...
T = TypeVar("T", bound="SearchIncidentsResponse400")


@_attrs_define
class SearchIncidentsResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_incidents_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_incidents_response_400.additional_properties = d
        return search_incidents_response_400
