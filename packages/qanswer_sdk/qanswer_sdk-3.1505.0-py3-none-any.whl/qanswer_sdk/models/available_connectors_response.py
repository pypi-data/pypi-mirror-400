...
class AvailableConnectorsResponse(BaseModel):
    ...
    def available_connectors_validate_enum(cls, value):
        """Validates the enum"""
        for i in value:
            if i not in set(['document', 'audio', 'website', 'qna', 'pinecone', 'rdf', 'websearch', 'econsilium', 'econsilium_search_index', 'publication_office', 'onedrive', 'sharepoint', 'gdrive', 'onenote', 'imap']):
                raise ValueError("each list item must be one of ('document', 'audio', 'website', 'qna', 'pinecone', 'rdf', 'websearch', 'econsilium', 'econsilium_search_index', 'publication_office', 'onedrive', 'sharepoint', 'gdrive', 'onenote', 'imap')")
        return value
