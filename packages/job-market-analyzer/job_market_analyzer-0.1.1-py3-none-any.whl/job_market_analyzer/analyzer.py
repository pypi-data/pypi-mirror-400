...
def load_jobs():
    """
    Safely load jobs.csv from installed package
    Works after pip install
    """
    csv_path = files("job_market_analyzer").joinpath("data/jobs.csv")   #📌 What it does:Reads CSV ,Converts it into DataFrame
