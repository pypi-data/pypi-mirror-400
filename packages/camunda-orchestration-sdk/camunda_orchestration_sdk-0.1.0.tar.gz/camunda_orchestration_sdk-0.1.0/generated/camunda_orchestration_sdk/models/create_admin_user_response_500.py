...
T = TypeVar("T", bound="CreateAdminUserResponse500")


@_attrs_define
class CreateAdminUserResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_admin_user_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_admin_user_response_500.additional_properties = d
        return create_admin_user_response_500
