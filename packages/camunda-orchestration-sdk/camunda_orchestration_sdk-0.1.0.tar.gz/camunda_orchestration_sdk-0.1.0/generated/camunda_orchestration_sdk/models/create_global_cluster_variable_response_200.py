...
from ..models.create_global_cluster_variable_response_200_scope import (
    CreateGlobalClusterVariableResponse200Scope,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateGlobalClusterVariableResponse200")


@_attrs_define
class CreateGlobalClusterVariableResponse200:
    """
    Attributes:
        ...
        scope (CreateGlobalClusterVariableResponse200Scope): The scope of a cluster variable.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_global_cluster_variable_response_200.additional_properties = d
        return create_global_cluster_variable_response_200
