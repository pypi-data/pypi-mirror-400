...
T = TypeVar("T", bound="SearchRolesResponse400")


@_attrs_define
class SearchRolesResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_roles_response_400.additional_properties = d
        return search_roles_response_400
