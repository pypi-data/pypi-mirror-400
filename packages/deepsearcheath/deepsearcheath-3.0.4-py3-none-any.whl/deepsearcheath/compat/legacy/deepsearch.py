...
class BaseAPIClient:
    ...
    def __init__(self, api_key: str, base_url: str):
        """
            https://api-v2-internal.deepsearch.com/v2/_internal/markets/indice
        """
    ...
    def _make_request(self, endpoint: str, params: Dict[str, Any] = None, headers: Dict[str, Any] = None) -> dict:
        ...
        if headers is None:
            print("No headers provided, ask X-INTERNAL-SERVICE-KEY")
            headers = {"X-INTERNAL-SERVICE-KEY": "ask-header-internal-service-key",}
...
class DeepSearchGlobalAPI(BaseAPIClient):
    ...
    async def get_company_stock_async(
        ...
        if region == 'kr':
            endpoint = f"/v2/_internal/companies/{symbol}/stock"
            ...
            url = f"{self.base_url}{endpoint}"
            headers = {
                "X-INTERNAL-SERVICE-KEY": "uTDg4yMYgCqpwXpVWM1Za96M2JQOal5O",
            }
    ...
    def get_market_index(self, 
        ...
        """
            ...
            https://api-v2-internal.deepsearch.com/v2/_internal/markets/indice
        """
        endpoint = "/v2/_internal/markets/indice"
