...
T = TypeVar("T", bound="AssignRoleToClientResponse409")


@_attrs_define
class AssignRoleToClientResponse409:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assign_role_to_client_response_409 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        assign_role_to_client_response_409.additional_properties = d
        return assign_role_to_client_response_409
