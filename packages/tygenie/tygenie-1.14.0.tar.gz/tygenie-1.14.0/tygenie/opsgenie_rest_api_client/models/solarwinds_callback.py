...
T = TypeVar("T", bound="SolarwindsCallback")


@_attrs_define
class SolarwindsCallback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        solarwinds_callback.additional_properties = d
        return solarwinds_callback
