...
class BuildImage:
    ...
    def _render_files(self):
        ...
        for file_name in files:
            ...
            with open(file_path, 'r') as srcobj:
                file_contents = srcobj.read()
            with open(path.join(self._files_folder, file_name), 'w') as destobj:
                destobj.write(file_contents)
