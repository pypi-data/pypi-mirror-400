...
def write_repo_contract(*, layout: StorageLayout, cfg: RepoConfig, package_version: str) -> Path:
    ...
    payload: dict[str, Any] = {
        ...
        "principles": {
            "external_output": "squad_status is event-driven (has_update/event_id/summary<=3 lines); details are persisted under .codex/supervisor-squad/",
            "max_project_roots": 2,
            "no_compat": True,
        },
        "paths": {
        ...
        "workflow": {
            ...
            "notes": [
                ...
                "squad_status returns has_update/event_id/recommended_poll_ms; if has_update=false, do not spam status calls.",
