...
> **Purpose**: 20+ specialized agents for Mind v5 development
...
**Each skill contains 4 files:**
- `skill.yaml` - Identity, patterns, anti-patterns, handoffs
- `sharp-edges.yaml` - Gotchas and common pitfalls
- `validations.yaml` - Code validation rules
- `collaboration.yaml` - Handoff protocols to other skills
...
| Skill | Path | Focus |
|-------|------|-------|
| event-architect | `skills/event-architect/` | Event sourcing, NATS, CQRS |
| graph-engineer | `skills/graph-engineer/` | FalkorDB, causal graphs |
| vector-specialist | `skills/vector-specialist/` | Qdrant, pgvector, embeddings, RRF |
| temporal-craftsman | `skills/temporal-craftsman/` | Temporal.io workflows |
| ml-memory | `skills/ml-memory/` | Hierarchical memory systems |
| causal-scientist | `skills/causal-scientist/` | DoWhy, counterfactuals |
| privacy-guardian | `skills/privacy-guardian/` | Differential privacy, encryption |
| performance-hunter | `skills/performance-hunter/` | Profiling, optimization |

### Extended Team (12 Skills)
| Skill | Path | Focus |
|-------|------|-------|
| infra-architect | `skills/infra-architect/` | Kubernetes, Terraform, GitOps |
| postgres-wizard | `skills/postgres-wizard/` | PostgreSQL internals, pgvector |
| api-designer | `skills/api-designer/` | REST/gRPC design, versioning |
| test-architect | `skills/test-architect/` | Testing strategy, quality gates |
| observability-sre | `skills/observability-sre/` | Prometheus, tracing, alerting |
| data-engineer | `skills/data-engineer/` | Pipelines, ETL, data quality |
| code-reviewer | `skills/code-reviewer/` | Code quality, patterns, standards |
| docs-engineer | `skills/docs-engineer/` | Technical writing, API docs |
| migration-specialist | `skills/migration-specialist/` | Zero-downtime migrations |
| chaos-engineer | `skills/chaos-engineer/` | Resilience testing, failure injection |
| python-craftsman | `skills/python-craftsman/` | Python idioms, async, types |
| sdk-builder | `skills/sdk-builder/` | Client libraries, developer experience |

### Bonus Skills
| Skill | Path | Focus |
|-------|------|-------|
| llm-architect | `skills/llm-architect/` | LLM integration patterns |
| redis-specialist | `skills/redis-specialist/` | Redis caching, pub/sub |
| realtime-engineer | `skills/realtime-engineer/` | WebSockets, SSE |
| mcp-developer | `skills/mcp-developer/` | MCP server development |
...
**Check sharp edges:**
```
Read: C:\Users\USER\Desktop\vibeship-mind\skills\{skill-name}\sharp-edges.yaml
```
...
### `skills/infra-architect/skill.yaml`
