...
if TYPE_CHECKING:
    from ..models.create_document_data_metadata_custom_properties import (
        CreateDocumentDataMetadataCustomProperties,
    )


T = TypeVar("T", bound="CreateDocumentDataMetadata")


@_attrs_define
class CreateDocumentDataMetadata:
    ...
    Attributes:
        ...
        process_instance_key (str | Unset): The key of the process instance that created the document. Example:
            2251799813690746.
        custom_properties (CreateDocumentDataMetadataCustomProperties | Unset): Custom properties of the document.
    """
    ...
    custom_properties: CreateDocumentDataMetadataCustomProperties | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_properties: CreateDocumentDataMetadataCustomProperties | Unset
        if isinstance(_custom_properties, Unset):
            custom_properties = UNSET
        else:
            custom_properties = CreateDocumentDataMetadataCustomProperties.from_dict(
                _custom_properties
            )

        create_document_data_metadata = cls(
        ...
        create_document_data_metadata.additional_properties = d
        return create_document_data_metadata
