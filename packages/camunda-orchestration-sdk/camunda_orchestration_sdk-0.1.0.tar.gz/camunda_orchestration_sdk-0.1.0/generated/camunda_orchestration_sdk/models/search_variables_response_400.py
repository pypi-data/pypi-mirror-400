...
T = TypeVar("T", bound="SearchVariablesResponse400")


@_attrs_define
class SearchVariablesResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_variables_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_variables_response_400.additional_properties = d
        return search_variables_response_400
