...
#define ATLAS_OS_NAME          "Linux-6.14.0-1014-azure"
#define ATLAS_OS_BITS          64
#define ATLAS_OS_BITS_STR      "64"
#define ATLAS_OS_STR           "linux.64"
#define ATLAS_OS_VERSION       "6.14.0-1014-azure"
#define ATLAS_SYS_PROCESSOR    "aarch64"

#define ATLAS_BUILD_TIMESTAMP  "20260105151111"
#define ATLAS_BUILD_TYPE       "RelWithDebInfo"

#define ATLAS_C_COMPILER_ID      "GNU"
#define ATLAS_C_COMPILER_VERSION "14.2.1"

#define ATLAS_CXX_COMPILER_ID      "GNU"
#define ATLAS_CXX_COMPILER_VERSION "14.2.1"

#define ATLAS_C_COMPILER       "/opt/rh/gcc-toolset-14/root/usr/bin/cc"
#define ATLAS_C_FLAGS          " -pipe -O2 -g -DNDEBUG"

#define ATLAS_CXX_COMPILER     "/opt/rh/gcc-toolset-14/root/usr/bin/c++"
...
#define ATLAS_Fortran_COMPILER "/opt/rh/gcc-toolset-14/root/usr/bin/gfortran"
