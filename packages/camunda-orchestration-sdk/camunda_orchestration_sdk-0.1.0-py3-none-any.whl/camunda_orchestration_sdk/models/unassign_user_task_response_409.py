...
T = TypeVar("T", bound="UnassignUserTaskResponse409")


@_attrs_define
class UnassignUserTaskResponse409:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unassign_user_task_response_409 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        unassign_user_task_response_409.additional_properties = d
        return unassign_user_task_response_409
