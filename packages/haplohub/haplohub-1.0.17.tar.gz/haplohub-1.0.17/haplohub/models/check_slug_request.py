...
class CheckSlugRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CheckSlugRequest:
        """Create an instance of CheckSlugRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CheckSlugRequest:
        """Create an instance of CheckSlugRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CheckSlugRequest.parse_obj(obj)

        _obj = CheckSlugRequest.parse_obj({"slug": obj.get("slug")})
        return _obj
