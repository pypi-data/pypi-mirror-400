...
T = TypeVar("T", bound="UpdateRoleResponse503")


@_attrs_define
class UpdateRoleResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_role_response_503.additional_properties = d
        return update_role_response_503
