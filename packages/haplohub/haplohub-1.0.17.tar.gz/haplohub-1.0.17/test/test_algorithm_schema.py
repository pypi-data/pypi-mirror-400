...
from haplohub.models.algorithm_schema import AlgorithmSchema  # noqa: E501


class TestAlgorithmSchema(unittest.TestCase):
    """AlgorithmSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgorithmSchema:
        """Test AlgorithmSchema
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AlgorithmSchema`
        """
        model = AlgorithmSchema()  # noqa: E501
        if include_optional:
