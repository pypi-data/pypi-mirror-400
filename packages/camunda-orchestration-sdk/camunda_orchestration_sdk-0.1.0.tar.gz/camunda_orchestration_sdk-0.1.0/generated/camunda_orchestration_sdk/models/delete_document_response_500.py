...
T = TypeVar("T", bound="DeleteDocumentResponse500")


@_attrs_define
class DeleteDocumentResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_document_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_document_response_500.additional_properties = d
        return delete_document_response_500
