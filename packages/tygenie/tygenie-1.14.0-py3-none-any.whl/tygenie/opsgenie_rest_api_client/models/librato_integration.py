...
T = TypeVar("T", bound="LibratoIntegration")


@_attrs_define
class LibratoIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        librato_integration.additional_properties = d
        return librato_integration
