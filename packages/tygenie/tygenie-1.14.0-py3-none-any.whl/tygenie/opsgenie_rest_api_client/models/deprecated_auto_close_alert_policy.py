...
T = TypeVar("T", bound="DeprecatedAutoCloseAlertPolicy")
...
class DeprecatedAutoCloseAlertPolicy:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        deprecated_auto_close_alert_policy = cls(
            type=type,
            id=id,
            name=name,
        ...
        deprecated_auto_close_alert_policy.additional_properties = d
        return deprecated_auto_close_alert_policy
