...
static PyObject *
DArray_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(double);
...
static PyMethodDef DArray_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)DArray_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
