...
class ProjectionTest(apitestcase.ApiTestCase):
  ...
  def test_init(self):
    ...
    projection = le.Projection(crs, transform=transform)
    self.assertEqual({'value': 'fakeValue'}, projection.getInfo())

    projection_func = le.ApiFunction.lookup('Projection')
  ...
  def test_init_transform_wkt(self):
    ...
    projection = le.Projection(crs, transformWkt=transform_wkt)
    self.assertEqual({'value': 'fakeValue'}, projection.getInfo())
  ...
  def test_serialize(self):
    ...
    result = json.loads(le.Projection(crs, transform=transform).serialize())
    expect = {
        'result': '0',
        'values': {
            '0': {
  ...
  def test_cast(self):
    ...
    projection = le.Projection(le.Projection(crs))
  ...
  def test_at_scale(self):
    ...
    expression = le.Projection(EPSG_4326).atScale(1)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Projection(EPSG_4326).atScale(meters=1)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_crs(self):
    ...
    expression = le.Projection(EPSG_4326).crs()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_nominal_scale(self):
    ...
    expression = le.Projection(EPSG_4326).nominalScale()
    result = json.loads(expression.serialize())
    print(result)
    self.assertEqual(expect, result)
  ...
  def test_scale(self):
    ...
    expression = le.Projection(EPSG_4326).scale(1, 2)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Projection(EPSG_4326).scale(x=1, y=2)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_transform(self):
    ...
    expression = le.Projection(EPSG_4326).transform()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_translate(self):
    ...
    expression = le.Projection(EPSG_4326).translate(1, 2)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)

    expression = le.Projection(EPSG_4326).translate(x=1, y=2)
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
  ...
  def test_wkt(self):
    ...
    expression = le.Projection(EPSG_4326).wkt()
    result = json.loads(expression.serialize())
    self.assertEqual(expect, result)
