...
T = TypeVar("T", bound="AssignMappingRuleToTenantResponse403")


@_attrs_define
class AssignMappingRuleToTenantResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assign_mapping_rule_to_tenant_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        assign_mapping_rule_to_tenant_response_403.additional_properties = d
        return assign_mapping_rule_to_tenant_response_403
