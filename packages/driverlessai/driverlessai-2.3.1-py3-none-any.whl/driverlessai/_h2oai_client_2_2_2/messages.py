...
class UserInfoResponse:
    ...
    def clone(self) -> 'UserInfoResponse':
        return UserInfoResponse(self.username, self.created, self.is_logged_in)

    @staticmethod
    def load(d: dict, *, validate_toml=False) -> 'UserInfoResponse':
        return UserInfoResponse(**d, validate_toml=validate_toml)
...
class S3CreateDatasetArgs:
    ...
    """
    def __init__(self, access_key_id, secret_access_key, assumed_role_arn, session_token, *, validate_toml=False) -> None:
    ...
    def clone(self) -> 'S3CreateDatasetArgs':
        return S3CreateDatasetArgs(self.access_key_id, self.secret_access_key, self.assumed_role_arn, self.session_token)
