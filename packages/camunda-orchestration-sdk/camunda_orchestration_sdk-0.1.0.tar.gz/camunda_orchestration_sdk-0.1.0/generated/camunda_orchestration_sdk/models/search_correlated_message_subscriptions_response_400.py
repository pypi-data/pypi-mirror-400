...
T = TypeVar("T", bound="SearchCorrelatedMessageSubscriptionsResponse400")


@_attrs_define
class SearchCorrelatedMessageSubscriptionsResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_correlated_message_subscriptions_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_correlated_message_subscriptions_response_400.additional_properties = d
        return search_correlated_message_subscriptions_response_400
