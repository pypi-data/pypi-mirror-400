...
class LISWET8(_AbstractLISWET):
    """LISWET8 - Li and Swetits k-convex approximation problem.
    ...
    def _g_function(self, t):
        """The g(t) function for LISWET8: g(t) = sin(2π*t)."""
        return jnp.sin(2.0 * jnp.pi * t)
