...
if TYPE_CHECKING:
    ...
    from ..models.search_process_instances_data_filter_or_item import (
        SearchProcessInstancesDataFilterOrItem,
    )
    from ..models.search_process_instances_data_filter_variables_item import (
...
T = TypeVar("T", bound="SearchProcessInstancesDataFilter")


@_attrs_define
class SearchProcessInstancesDataFilter:
    ...
    Attributes:
        ...
        variables (list[SearchProcessInstancesDataFilterVariablesItem] | Unset): The process instance variables.
        ...
        or_ (list[SearchProcessInstancesDataFilterOrItem] | Unset): Defines a list of alternative filter groups combined
            using OR logic. Each object in the array is evaluated independently, and the filter matches if any one of them
            is satisfied.
    ...
    variables: list[SearchProcessInstancesDataFilterVariablesItem] | Unset = UNSET
    ...
    or_: list[SearchProcessInstancesDataFilterOrItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _variables is not UNSET:
            ...
            for variables_item_data in _variables:
                variables_item = (
                    SearchProcessInstancesDataFilterVariablesItem.from_dict(
                        variables_item_data
                    )
                )
        ...
        if _or_ is not UNSET:
            ...
            for or_item_data in _or_:
                or_item = SearchProcessInstancesDataFilterOrItem.from_dict(or_item_data)

                or_.append(or_item)

        search_process_instances_data_filter = cls(
        ...
        search_process_instances_data_filter.additional_properties = d
        return search_process_instances_data_filter
