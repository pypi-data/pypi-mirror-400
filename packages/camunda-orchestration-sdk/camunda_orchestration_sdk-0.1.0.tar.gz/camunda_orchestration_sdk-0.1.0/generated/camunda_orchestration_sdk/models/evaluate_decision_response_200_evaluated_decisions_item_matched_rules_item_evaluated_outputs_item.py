...
T = TypeVar(
    "T",
    bound="EvaluateDecisionResponse200EvaluatedDecisionsItemMatchedRulesItemEvaluatedOutputsItem",
)


@_attrs_define
class EvaluateDecisionResponse200EvaluatedDecisionsItemMatchedRulesItemEvaluatedOutputsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        evaluate_decision_response_200_evaluated_decisions_item_matched_rules_item_evaluated_outputs_item = cls(
            output_id=output_id,
        ...
        evaluate_decision_response_200_evaluated_decisions_item_matched_rules_item_evaluated_outputs_item.additional_properties = d
        return evaluate_decision_response_200_evaluated_decisions_item_matched_rules_item_evaluated_outputs_item
