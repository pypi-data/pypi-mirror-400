...
from xladmin.views import BaseAdminPlugin, BaseAdminView
from xladmin.util import static, json
import six
if six.PY2:
    import urllib
else:
...
class ThemePlugin(BaseAdminPlugin):
    ...
    default_theme = static('xladmin/css/themes/bootstrap-xladmin.css')
    bootstrap2_theme = static('xladmin/css/themes/bootstrap-theme.css')
    ...
    def get_media(self, media):
        ...
        return media + self.vendor('jquery-ui-effect.js') + Media(js=[self.static('xladmin/js/xladmin.plugin.themes.js')])
    ...
    def block_top_navmenu(self, context, nodes):
        ...
        nodes.append(loader.render_to_string('xladmin/blocks/comm.top.theme.html', {'themes': themes, 'select_css': select_css}))
