...
class Amazon2014Beauty_1000_LOU(NextItemRecDataSet):
    r"""
    Settings:
    ---------
    kcore4user: 10
    ...
    | #User | #Item | #Interactions | #Train | #Valid | #Test |        Density        |
    +-------+-------+---------------+--------+--------+-------+-----------------------+
    | 12595 | 75253 |     222897    | 197707 | 12595  | 12595 | 0.0002351701701963355 |
    +-------+-------+---------------+--------+--------+-------+-----------------------+
    """


class Amazon2014CDs_1000_LOU(NextItemRecDataSet):
    r"""
    Settings:
    ---------
    kcore4user: 10
    ...
    | #User | #Item  | #Interactions |  #Train | #Valid | #Test |        Density        |
    +-------+--------+---------------+---------+--------+-------+-----------------------+
    | 41248 | 334305 |    1301231    | 1218735 | 41248  | 41248 | 9.436449789205816e-05 |
    +-------+--------+---------------+---------+--------+-------+-----------------------+
    """


class Amazon2014Clothing_1000_LOU(NextItemRecDataSet):
    r"""
    Settings:
    ---------
    kcore4user: 10
    ...
    | #User | #Item  | #Interactions | #Train | #Valid | #Test |        Density        |
    +-------+--------+---------------+--------+--------+-------+-----------------------+
    | 41878 | 355571 |     678329    | 594573 | 41878  | 41878 | 4.555416796464584e-05 |
    +-------+--------+---------------+--------+--------+-------+-----------------------+
    """
...
class Amazon2014Home_1000_LOU(NextItemRecDataSet):
    r"""
    Settings:
    ---------
    kcore4user: 10
    ...
    | #User | #Item  | #Interactions | #Train | #Valid | #Test |        Density         |
    +-------+--------+---------------+--------+--------+-------+------------------------+
    | 25251 | 115657 |     421132    | 370630 | 25251  | 25251 | 0.00014420082261520087 |
    +-------+--------+---------------+--------+--------+-------+------------------------+
    """
...
class Amazon2014Movies_1000_LOU(NextItemRecDataSet):
    r"""
    Settings:
    ---------
    kcore4user: 10
    ...
    | #User | #Item  | #Interactions |  #Train | #Valid | #Test |        Density        |
    +-------+--------+---------------+---------+--------+-------+-----------------------+
    | 46483 | 134198 |    1349351    | 1256385 | 46483  | 46483 | 0.0002163140568148684 |
    +-------+--------+---------------+---------+--------+-------+-----------------------+
    """
...
class Amazon2014Video_1000_LOU(NextItemRecDataSet):
    r"""
    Settings:
    ---------
    kcore4user: 10
    ...
    | #User | #Item | #Interactions | #Train | #Valid | #Test |        Density        |
    +-------+-------+---------------+--------+--------+-------+-----------------------+
    |  8057 | 26729 |     157494    | 141380 |  8057  |  8057 | 0.0007313208218039309 |
    +-------+-------+---------------+--------+--------+-------+-----------------------+
    """
