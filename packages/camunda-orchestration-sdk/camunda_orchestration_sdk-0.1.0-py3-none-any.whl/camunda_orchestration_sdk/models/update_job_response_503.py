...
T = TypeVar("T", bound="UpdateJobResponse503")


@_attrs_define
class UpdateJobResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_job_response_503.additional_properties = d
        return update_job_response_503
