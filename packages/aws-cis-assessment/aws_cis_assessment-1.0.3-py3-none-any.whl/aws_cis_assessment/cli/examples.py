...
USAGE_EXAMPLES = {
    "basic": {
        ...
        "explanation": "This will assess all Implementation Groups (IG1, IG2, IG3) across all enabled regions and generate a JSON report."
    },
    "specific_ig": {
        ...
        "explanation": "This focuses on the most critical security controls in two specific regions."
    },
    "specific_controls": {
    ...
    "list_regions": {
        ...
        "explanation": "Shows all AWS regions that can be used for assessment, indicating which are default regions."
    },
    "show_stats": {
...
BEST_PRACTICES = [
    ...
    },
    {
        ...
        "description": "Start with your most important regions to get faster results.",
