...
class CreateJobRequest(BaseModel):
    ...
    date_created: Optional[datetime] = Field(default=None, description="Date when job was created. Defaults to now.", alias="dateCreated")
...
CreateJobRequest.update_forward_refs()
