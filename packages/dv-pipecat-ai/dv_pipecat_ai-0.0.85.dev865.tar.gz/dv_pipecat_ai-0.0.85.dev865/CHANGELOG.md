...
- Added `ElevenLabsRealtimeSTTService`, enabling native integration with the
  `scribe_v2_realtime` WebSocket API (manual and VAD commit strategies, partial
  frames, and word-timestamp forwarding).
