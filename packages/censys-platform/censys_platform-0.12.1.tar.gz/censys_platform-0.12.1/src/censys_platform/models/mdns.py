...
class MdnsTypedDict(TypedDict):
    multiple_responses: NotRequired[bool]
    names: NotRequired[Nullable[List[str]]]
    results: NotRequired[Nullable[List[MdnsResultTypedDict]]]


class Mdns(BaseModel):
    multiple_responses: Optional[bool] = None

    names: OptionalNullable[List[str]] = UNSET

    results: OptionalNullable[List[MdnsResult]] = UNSET
