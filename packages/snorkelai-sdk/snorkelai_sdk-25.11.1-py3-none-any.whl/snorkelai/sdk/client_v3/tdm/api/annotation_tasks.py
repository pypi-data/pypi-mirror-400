...
def fetch_annotation_task_dataframes_annotation_tasks__annotation_task_uid__dataframes_get(
    ...
    *,
    ...
    annotator_user_uids: Union[Unset, List[int]] = UNSET,
    raw: Literal[True],
) -> requests.Response: ...
...
def fetch_annotation_task_dataframes_annotation_tasks__annotation_task_uid__dataframes_get(
    ...
    *,
    ...
    json_annotator_user_uids: Union[Unset, List[int]] = UNSET
    if not isinstance(annotator_user_uids, Unset):
        json_annotator_user_uids = annotator_user_uids

    params["annotator_user_uids"] = json_annotator_user_uids
...
from ..models import (
    GetDatapointStatusMetadataAnnotationTasksAnnotationTaskUidDatapointStatusGetResponseGetDatapointStatusMetadataAnnotationTasksAnnotationTaskUidDatapointStatusGet,
)
from ..types import UNSET, Unset


@overload
def get_datapoint_status_metadata_annotation_tasks__annotation_task_uid__datapoint_status_get(
    annotation_task_uid: int,
    *,
    x_uids: Union[Unset, List[str]] = UNSET,
    raw: Literal[True],
...
def get_datapoint_status_metadata_annotation_tasks__annotation_task_uid__datapoint_status_get(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "endpoint": f"/annotation-tasks/{annotation_task_uid}/datapoint-status",
        "params": params,
    }
    ...
    def _parse_response(
        ...
        """Parse response based on OpenAPI schema."""
        # Parse the success response
        # Parse as GetDatapointStatusMetadataAnnotationTasksAnnotationTaskUidDatapointStatusGetResponseGetDatapointStatusMetadataAnnotationTasksAnnotationTaskUidDatapointStatusGet
        response_200 = GetDatapointStatusMetadataAnnotationTasksAnnotationTaskUidDatapointStatusGetResponseGetDatapointStatusMetadataAnnotationTasksAnnotationTaskUidDatapointStatusGet.from_dict(
            response
        )
...
from ..models import UpdateStatusOnGTCommitParams


def update_datapoint_status_annotation_tasks__annotation_task_uid__datapoint_datapoint_status_complete_patch(
    annotation_task_uid: int,
    *,
    body: UpdateStatusOnGTCommitParams,
) -> Any:
    # Get the context
    ctx = SnorkelSDKContext.get_global()

    _kwargs: Dict[str, Any] = {
        "endpoint": f"/annotation-tasks/{annotation_task_uid}/datapoint/datapoint-status/complete",
    }
