...
T = TypeVar("T", bound="GetProcessInstanceStatisticsByDefinitionResponse200Page")


@_attrs_define
class GetProcessInstanceStatisticsByDefinitionResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_process_instance_statistics_by_definition_response_200_page = cls(
        ...
        get_process_instance_statistics_by_definition_response_200_page.additional_properties = d
        return get_process_instance_statistics_by_definition_response_200_page
