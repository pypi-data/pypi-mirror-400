...
T = TypeVar("T", bound="StatusFilterSchema")


@attrs.define
class StatusFilterSchema:
    """
    Attributes:
        status (str):
        filter_type (Union[Unset, FilterTransformFilterTypes]):
        transform_config_type (Union[Literal['status_filter_schema'], Unset]):  Default: 'status_filter_schema'.
    """

    status: str
    filter_type: Union[Unset, FilterTransformFilterTypes] = UNSET
    transform_config_type: Union[Literal["status_filter_schema"], Unset] = (
