...
static PyObject *
FMatrix4x2Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(float) * 8;
...
static PyMethodDef FMatrix4x2Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)FMatrix4x2Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
