...
T = TypeVar("T", bound="BMCFootPrintsV12Integration")


@_attrs_define
class BMCFootPrintsV12Integration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bmc_foot_prints_v12_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        bmc_foot_prints_v12_integration.additional_properties = d
        return bmc_foot_prints_v12_integration
