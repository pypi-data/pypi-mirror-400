...
from haplohub.models.member_pgs_score_query_params import MemberPgsScoreQueryParams  # noqa: E501


class TestMemberPgsScoreQueryParams(unittest.TestCase):
    """MemberPgsScoreQueryParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MemberPgsScoreQueryParams:
        """Test MemberPgsScoreQueryParams
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MemberPgsScoreQueryParams`
        """
        model = MemberPgsScoreQueryParams()  # noqa: E501
        if include_optional:
            return MemberPgsScoreQueryParams(
                member_id = '',
                latest = True
            )
        else:
    ...
    def testMemberPgsScoreQueryParams(self):
        """Test MemberPgsScoreQueryParams"""
