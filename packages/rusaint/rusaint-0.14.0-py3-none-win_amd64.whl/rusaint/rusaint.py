...
class RegisteredLecture:
    ...
    def __init__(self, *, syllabus: "typing.Optional[str]", category: "str", sub_category: "typing.Optional[str]", abeek_info: "typing.Optional[str]", field: "typing.Optional[str]", code: "str", name: "str", division: "typing.Optional[str]", professor: "str", department: "str", time_points: "str", personeel: "str", remaining_seats: "str", schedule_room: "str", target: "str", remarks: "str"):
        self.syllabus = syllabus
        self.category = category
        self.sub_category = sub_category
        self.abeek_info = abeek_info
    ...
    def __str__(self):
        return "RegisteredLecture(syllabus={}, category={}, sub_category={}, abeek_info={}, field={}, code={}, name={}, division={}, professor={}, department={}, time_points={}, personeel={}, remaining_seats={}, schedule_room={}, target={}, remarks={})".format(self.syllabus, self.category, self.sub_category, self.abeek_info, self.field, self.code, self.name, self.division, self.professor, self.department, self.time_points, self.personeel, self.remaining_seats, self.schedule_room, self.target, self.remarks)
...
class _UniffiConverterTypeRegisteredLecture(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return RegisteredLecture(
            ...
            schedule_room=_UniffiConverterString.read(buf),
            target=_UniffiConverterString.read(buf),
            remarks=_UniffiConverterString.read(buf),
        )
    ...
    def check_lower(value):
        ...
        _UniffiConverterString.check_lower(value.schedule_room)
        _UniffiConverterString.check_lower(value.target)
        _UniffiConverterString.check_lower(value.remarks)
    ...
    def write(value, buf):
        ...
        _UniffiConverterString.write(value.schedule_room, buf)
        _UniffiConverterString.write(value.target, buf)
        _UniffiConverterString.write(value.remarks, buf)
