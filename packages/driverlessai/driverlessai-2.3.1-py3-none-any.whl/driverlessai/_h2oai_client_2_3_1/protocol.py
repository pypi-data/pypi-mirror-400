...
from _h2oai_client_2_3_1 import references
from _h2oai_client_2_3_1 import validation
from _h2oai_client_2_3_1.messages import *
...
class Client:
    ...
    # These are extension methods that are appended to the _h2oai_client_2_3_1 module
    ...
    def perform_chunked_upload_sync(
        ...
        url = self.address + (
            "/chunkedupload" if not file_type else f"/chunkedupload_{file_type}"
        )
        if skip_parse:
            url += "?noparse=1"
    ...
    def upload_dataset(
        ...
        """
        return self.perform_chunked_upload_sync(file_path, "dataset", progress_callback)
    ...
    def create_dataset_from_s3_sync(
        self,
        filepath: str,
        access_key_id: str = "",
        ...
        key = self.create_dataset_from_s3(filepath, args, False)
        job = self._wait_for_dataset(key)
        return job.entity
    ...
    def create_dataset_from_snowflake_sync(
        self,
        region: str,
        database: str,
        warehouse: str,
    ...
    def create_dataset_from_jdbc_sync(
        self,
        jdbc_user: str,
        password: str,
        query: str,
        ...
        :param keytab_path: Optional (String) path to keytab file for Kerberos authentication.
        :param user_principal: Optional (String) user principal for Kerberos authentication.

        :return: (Dataset) dataset object containing information regarding resultant dataset
        """
        args = JdbcCreateDatasetArgs(
            dst=destination,
            query=query,
            id_column=id_column,
            jdbc_user=jdbc_user,
    ...
    def import_experiment_sync(
        ...
        remote_file_paths = self.perform_chunked_upload_sync(
            file_path, "experiment", file_system, progress_callback, skip_parse=True
        )
    ...
    def get_users_info(self, offset: int, limit: int) -> UserDetailsResponse:
        """

        """
        req_ = dict(offset=offset, limit=limit)
        res_ = self._request('get_users_info', req_)
        return UserDetailsResponse.load(res_)
    ...
    def get_user_purge_job(self, key: str) -> UserPurgeJob:
        """

        """
        req_ = dict(key=key)
        res_ = self._request('get_user_purge_job', req_)
        return UserPurgeJob.load(res_)
    ...
    def search_s3_files(self, pattern: str, args: S3CreateDatasetArgs, use_irsa: bool) -> FileSearchResults:
        """

        """
        req_ = dict(pattern=pattern, args=args.dump(), use_irsa=use_irsa)
    ...
    def is_gpt_summary_enabled(self) -> bool:
        """

        """
        req_ = dict()
        res_ = self._request('is_gpt_summary_enabled', req_)
        return res_
    ...
    def create_dataset_from_s3(self, filepath: str, args: S3CreateDatasetArgs, use_irsa: bool) -> str:
        """

        """
        req_ = dict(filepath=filepath, args=args.dump(), use_irsa=use_irsa)
    ...
    def create_dataset_from_delta_table(self, args: DeltaTableCreateDatasetArgs) -> str:
        """

        """
        req_ = dict(args=args.dump())
        res_ = self._request('create_dataset_from_delta_table', req_)
        return res_
    ...
    def get_experiments_queue(self, offset: int, limit: int) -> TaskQueueResponse:
        """
    ...
    def admin_get_experiments_queue(self, offset: int, limit: int) -> TaskQueueResponse:
        """
    ...
    def am_i_admin(self) -> bool:
        ...
        """
        req_ = dict()
        res_ = self._request('am_i_admin', req_)
        return res_
    ...
    def admin_purge_user(self, username: str, dry_run: bool) -> str:
        """

        :param username: Username of user to be impersonated
        :param dry_run: Indication as if its a dry run or not
        """
        req_ = dict(username=username, dry_run=dry_run)
        res_ = self._request('admin_purge_user', req_)
        return res_
    ...
    def use_multi_project(self) -> bool:
        """

        """
        req_ = dict()
        res_ = self._request('use_multi_project', req_)
        return res_
    ...
    def get_default_project_key(self) -> str:
        ...
        """
        req_ = dict()
        res_ = self._request('get_default_project_key', req_)
        return res_
    ...
    def get_user_insights(self, username: str) -> UserInsightsResponse:
        """

        """
        req_ = dict(username=username)
        res_ = self._request('get_user_insights', req_)
        return UserInsightsResponse.load(res_)
    ...
    def determine_gpu_scheduling_status(self) -> int:
        """

        """
        req_ = dict()
        res_ = self._request('determine_gpu_scheduling_status', req_)
        return res_

    def get_action_allowances(self, action: List[str], ui_function_name: str) -> dict:
        """

        """
        req_ = dict(action=action, ui_function_name=ui_function_name)
        res_ = self._request('get_action_allowances', req_)
        return res_
...
class AutovizClient:
    ...
    def __init__(self, _h2oai_client_2_3_1):
        self.client = _h2oai_client_2_3_1
