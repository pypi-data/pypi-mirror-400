...
def createParamDictFromString(parameterString, ps=True, useDecimal=True):
    """createParamDictFromString(parameterString, ps=True, useDecimal=True)
...
def formatStringFromParamDict(parameters, joinPS=',', rmtrailing0=False):
    """formatStringFromParamDict(parameters, joinPS=',', rmtrailing0=False)
...
#==================================================================================================================        
class inpKeyword:
    """This class creates a blank :class:`inpKeyword` object.
