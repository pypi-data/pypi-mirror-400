...
from kodexa_document.model.ref import Ref
from kodexa_document.model.processing import ProcessingStep
...
class TaskEndpoint(EntityEndpoint, Task):
    ...
    def create_with_request(self, task: Task, task_template: Optional[TaskTemplate] = None, document_families: Optional[List[DocumentFamily]] = None):
        ...
        url = "/api/tasks/create-task-with-request"
...
class PageRetainedGuidanceEndpoint(PageRetainedGuidance, PageEndpoint):
    ...
    def get_type(self) -> Optional[str]:
        ...
        it will always return "retained-guidance".

        Returns:
            str: The type of the endpoint, which is "retainedGuidance".
        """
        return "retained-guidance"
...
class OrganizationEndpoint(Organization, EntityEndpoint):
    ...
    def available_templates(self, page=1, page_size=10, query="*"):
        ...
        """
        url = f"/api/organizations/{self.id}/available-templates"
    ...
    def available_models(self, page=1, page_size=10, query="*"):
        ...
        Returns:
            MarketplaceEndpoint: The marketplace endpoint of the organization.
        """
        url = f"/api/organizations/{self.id}/available-models"
        response = self.client.get(url, params={"page": page, "pageSize": page_size, "query": query})
    ...
    def available_assistants(self, page=1, page_size=10, query="*"):
        ...
        Returns:
            MarketplaceEndpoint: The marketplace endpoint of the organization.
        """
        url = f"/api/organizations/{self.id}/available-assistants"
        response = self.client.get(url, params={"page": page, "pageSize": page_size, "query": query})
    ...
    def get_subscriptions(self, page: int = 1, page_size: int = 10) -> "PageProductSubscriptionEndpoint":
        ...
        from kodexa_document.model.entities.product_subscription import PageProductSubscriptionEndpoint
    ...
    def remove_subscription(self, subscription: "ProductSubscription") -> None:
        ...
        """
        url = f"/api/product-subscriptions/{subscription.id}"
        self.client.delete(url)
    ...
    def add_subscription(self, product: "Product") -> None:
        ...
        """
        url = f"/api/product-subscriptions"
        from kodexa_document.model.entities.product_subscription import ProductSubscription
...
class WorkspaceEndpoint(EntityEndpoint, Workspace):
    ...
    def add_document_family(self, document_family: DocumentFamily):
        ...
        """
        url = f"/api/workspaces/{self.id}/document-families"
        response = self.client.post(
    ...
    def remove_document_family(self, document_family: DocumentFamily):
        ...
        """
        url = f"/api/workspaces/{self.id}/document-families/{document_family.id}"
        response = self.client.delete(url)
        process_response(response)
...
class ProjectEndpoint(EntityEndpoint, Project):
    ...
    def create_project_template_request(self) -> ProjectTemplateRequest:
        ...
        """
        response = self.client.get(f"/api/projects/{self.id}/create-project-template-request")
...
class ExtensionPacksEndpoint(ComponentEndpoint, ClientEndpoint, OrganizationOwned):
    ...
    def deploy_from_url(
        ...
        """
        url = f"/api/extension-packs/{self.organization.slug}"
        create_response = self.client.post(
            url,
...
class ExtensionPackEndpoint(ComponentInstanceEndpoint, ExtensionPack):
    ...
    def undeploy(self):
        ...
        Returns:
            None
        """
        response = self.client.put(f"/api/extension-packs/{self.ref}/_undeploy")
        process_response(response)
    ...
    def deploy(self):
        ...
        :return: None
        """
        response = self.client.put(f"/api/extension-packs/{self.ref}/_deploy")
        process_response(response)
    ...
    def repack(self):
        ...
        :return: None
        """
        response = self.client.put(f"/api/extension-packs/{self.ref}/_repack")
        process_response(response)
...
class DataObjectEndpoint(DataObject, ClientEndpoint):
    ...
    def update(self):
        ...
        Returns:
            None
        """
        url = f"/api/stores/{self.store_ref.replace(':', '/')}/data-objects/{self.id}"
    ...
    def attributes(self) -> List[DataAttributeEndpoint]:
        ...
        """
        url = f"/api/stores/{self.store_ref.replace(':', '/')}/data-objects/{self.id}/attributes"
        response = self.client.get(url)
        return [
...
class DataStoreEndpoint(StoreEndpoint):
    ...
    def get_data_objects_export(
        ...
        """
        url = f"/api/stores/{self.ref.replace(':', '/')}/data-objects"
        params = {
    ...
    def get_data_object(self, data_object_id: str):
        ...
        url = f"/api/stores/{self.ref.replace(':', '/')}/data-objects/{data_object_id}"
...
class ModelCostsEndpoint:
    ...
    def get_model_costs(self, filters: Optional[List[str]] = None) -> List[AggregatedModelCost]:
        ...
        response = self.client.get("/api/model-costs", params=params)
        return [
...
class KodexaClient:
    ...
    def __init__(self, url=None, access_token=None):
        ...
        from kodexa_document.model.entities.product import ProductsEndpoint

        self.base_url = url if url is not None else KodexaPlatform.get_url()
        self.access_token = (
            access_token
            if access_token is not None
            else KodexaPlatform.get_access_token()
        )
    ...
    def deserialize(
        ...
        if "type" in component_dict or component_type is not None:
            ...
            from kodexa_document.model.entities.product import ProductEndpoint
            from kodexa_document.model.entities.product_subscription import ProductSubscriptionEndpoint
            from kodexa_document.model.entities.check_response import CheckResponseEndpoint
            known_components = {
