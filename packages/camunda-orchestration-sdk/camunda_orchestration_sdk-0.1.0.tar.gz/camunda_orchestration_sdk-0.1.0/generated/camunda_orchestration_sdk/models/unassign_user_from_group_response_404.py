...
T = TypeVar("T", bound="UnassignUserFromGroupResponse404")


@_attrs_define
class UnassignUserFromGroupResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unassign_user_from_group_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        unassign_user_from_group_response_404.additional_properties = d
        return unassign_user_from_group_response_404
