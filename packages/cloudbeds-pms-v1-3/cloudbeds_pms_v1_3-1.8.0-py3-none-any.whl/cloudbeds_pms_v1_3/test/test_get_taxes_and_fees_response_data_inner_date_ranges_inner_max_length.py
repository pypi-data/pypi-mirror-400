...
class TestGetTaxesAndFeesResponseDataInnerDateRangesInnerMaxLength(unittest.TestCase):
    """GetTaxesAndFeesResponseDataInnerDateRangesInnerMaxLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTaxesAndFeesResponseDataInnerDateRangesInnerMaxLength:
        """Test GetTaxesAndFeesResponseDataInnerDateRangesInnerMaxLength
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTaxesAndFeesResponseDataInnerDateRangesInnerMaxLength`
        """
        model = GetTaxesAndFeesResponseDataInnerDateRangesInnerMaxLength()
        if include_optional:
            return GetTaxesAndFeesResponseDataInnerDateRangesInnerMaxLength(
            )
        else:
            return GetTaxesAndFeesResponseDataInnerDateRangesInnerMaxLength(
        )
    ...
    def testGetTaxesAndFeesResponseDataInnerDateRangesInnerMaxLength(self):
        """Test GetTaxesAndFeesResponseDataInnerDateRangesInnerMaxLength"""
