...
T = TypeVar("T", bound="CancelProcessInstanceResponse404")


@_attrs_define
class CancelProcessInstanceResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancel_process_instance_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        cancel_process_instance_response_404.additional_properties = d
        return cancel_process_instance_response_404
