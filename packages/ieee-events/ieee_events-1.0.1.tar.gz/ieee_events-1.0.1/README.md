...
### 1. Enhanced Client (Recommended)
Advanced Python client library with:
- `SpanBuilder` for intuitive time arithmetic queries
- Enum-based parameter types for type safety and IDE autocomplete
...
- Graceful error handling for API limitations

### 2. Basic Client
Simplified Python client featuring:
...
```bash
git clone https://github.com/Assem-ElQersh/IEEE-Events-API-Toolkit.git
