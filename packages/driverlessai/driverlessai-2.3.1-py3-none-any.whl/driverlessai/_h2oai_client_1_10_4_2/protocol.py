...
from _h2oai_client_1_10_4_2 import references
from _h2oai_client_1_10_4_2 import validation
from _h2oai_client_1_10_4_2.messages import *
...
class Client:
    ...
    # These are extension methods that are appended to the _h2oai_client_1_10_4_2 module
    ...
    def start_wizard_random_attack(self, action: str, seed: int, dataset_key: str) -> None:
        """
        Start a new wizard random attack.

        """
        req_ = dict(action=action, seed=seed, dataset_key=dataset_key)
...
class AutovizClient:
    ...
    def __init__(self, _h2oai_client_1_10_4_2):
        self.client = _h2oai_client_1_10_4_2
