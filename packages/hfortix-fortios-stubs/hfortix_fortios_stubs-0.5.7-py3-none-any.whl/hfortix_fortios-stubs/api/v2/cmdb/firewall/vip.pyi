...
class VipPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    ldb_method: NotRequired[Literal[{"description": "Distribute to server based on source IP", "help": "Distribute to server based on source IP.", "label": "Static", "name": "static"}, {"description": "Distribute to server based round robin order", "help": "Distribute to server based round robin order.", "label": "Round Robin", "name": "round-robin"}, {"description": "Distribute to server based on weight", "help": "Distribute to server based on weight.", "label": "Weighted", "name": "weighted"}, {"description": "Distribute to server with lowest session count", "help": "Distribute to server with lowest session count.", "label": "Least Session", "name": "least-session"}, {"description": "Distribute to server with lowest Round-Trip-Time", "help": "Distribute to server with lowest Round-Trip-Time.", "label": "Least Rtt", "name": "least-rtt"}, {"description": "Distribute to the first server that is alive", "help": "Distribute to the first server that is alive.", "label": "First Alive", "name": "first-alive"}, {"description": "Distribute to server based on host field in HTTP header", "help": "Distribute to server based on host field in HTTP header.", "label": "Http Host", "name": "http-host"}]]  # Method used to distribute sessions to real servers.
    ...
    nat44: NotRequired[Literal[{"description": "Disable NAT44", "help": "Disable NAT44.", "label": "Disable", "name": "disable"}, {"description": "Enable NAT44", "help": "Enable NAT44.", "label": "Enable", "name": "enable"}]]  # Enable/disable NAT44.
    ...
    arp_reply: NotRequired[Literal[{"description": "Disable ARP reply", "help": "Disable ARP reply.", "label": "Disable", "name": "disable"}, {"description": "Enable ARP reply", "help": "Enable ARP reply.", "label": "Enable", "name": "enable"}]]  # Enable to respond to ARP requests for this virtual IP addres
    ...
    nat_source_vip: NotRequired[Literal[{"description": "Force only the source NAT mapped IP to the external IP for traffic egressing the external interface of the VIP", "help": "Force only the source NAT mapped IP to the external IP for traffic egressing the external interface of the VIP.", "label": "Disable", "name": "disable"}, {"description": "Force the source NAT mapped IP to the external IP for all traffic", "help": "Force the source NAT mapped IP to the external IP for all traffic.", "label": "Enable", "name": "enable"}]]  # Enable/disable forcing the source NAT mapped IP to the exter
    portforward: NotRequired[Literal[{"description": "Disable port forward", "help": "Disable port forward.", "label": "Disable", "name": "disable"}, {"description": "Enable port forward", "help": "Enable port forward.", "label": "Enable", "name": "enable"}]]  # Enable/disable port forwarding.
    status: NotRequired[Literal[{"description": "Disable the VIP", "help": "Disable the VIP.", "label": "Disable", "name": "disable"}, {"description": "Enable the VIP", "help": "Enable the VIP.", "label": "Enable", "name": "enable"}]]  # Enable/disable VIP.
    protocol: NotRequired[Literal[{"description": "TCP", "help": "TCP.", "label": "Tcp", "name": "tcp"}, {"description": "UDP", "help": "UDP.", "label": "Udp", "name": "udp"}, {"description": "SCTP", "help": "SCTP.", "label": "Sctp", "name": "sctp"}, {"description": "ICMP", "help": "ICMP.", "label": "Icmp", "name": "icmp"}]]  # Protocol to use when forwarding packets.
    ...
    portmapping_type: NotRequired[Literal[{"description": "One to one", "help": "One to one.", "label": "1 To 1", "name": "1-to-1"}, {"description": "Many to many", "help": "Many to many.", "label": "M To N", "name": "m-to-n"}]]  # Port mapping type.
    ...
    ssl_algorithm: NotRequired[Literal[{"description": "High encryption", "help": "High encryption. Allow only AES and ChaCha.", "label": "High", "name": "high"}, {"description": "Medium encryption", "help": "Medium encryption. Allow AES, ChaCha, 3DES, and RC4.", "label": "Medium", "name": "medium"}, {"description": "Low encryption", "help": "Low encryption. Allow AES, ChaCha, 3DES, RC4, and DES.", "label": "Low", "name": "low"}, {"description": "Custom encryption", "help": "Custom encryption. Use config ssl-cipher-suites to select the cipher suites that are allowed.", "label": "Custom", "name": "custom"}]]  # Permitted encryption algorithms for SSL sessions according t
    ssl_cipher_suites: NotRequired[list[dict[str, Any]]]  # SSL/TLS cipher suites acceptable from a client, ordered by p
    ssl_server_algorithm: NotRequired[Literal[{"description": "High encryption", "help": "High encryption. Allow only AES and ChaCha.", "label": "High", "name": "high"}, {"description": "Medium encryption", "help": "Medium encryption. Allow AES, ChaCha, 3DES, and RC4.", "label": "Medium", "name": "medium"}, {"description": "Low encryption", "help": "Low encryption. Allow AES, ChaCha, 3DES, RC4, and DES.", "label": "Low", "name": "low"}, {"description": "Custom encryption", "help": "Custom encryption. Use ssl-server-cipher-suites to select the cipher suites that are allowed.", "label": "Custom", "name": "custom"}, {"description": "Use the same encryption algorithms for both client and server sessions", "help": "Use the same encryption algorithms for both client and server sessions.", "label": "Client", "name": "client"}]]  # Permitted encryption algorithms for the server side of SSL f
    ...
    ssl_client_renegotiation: NotRequired[Literal[{"description": "Allow a SSL client to renegotiate", "help": "Allow a SSL client to renegotiate.", "label": "Allow", "name": "allow"}, {"description": "Abort any client initiated SSL re-negotiation attempt", "help": "Abort any client initiated SSL re-negotiation attempt.", "label": "Deny", "name": "deny"}, {"description": "Abort any client initiated SSL re-negotiation attempt that does not use RFC 5746 Secure Renegotiation", "help": "Abort any client initiated SSL re-negotiation attempt that does not use RFC 5746 Secure Renegotiation.", "label": "Secure", "name": "secure"}]]  # Allow, deny, or require secure renegotiation of client sessi
    ...
    one_click_gslb_server: NotRequired[Literal[{"description": "Disable integration with FortiGSLB", "help": "Disable integration with FortiGSLB.", "label": "Disable", "name": "disable"}, {"description": "Enable integration with FortiGSLB", "help": "Enable integration with FortiGSLB.", "label": "Enable", "name": "enable"}]]  # Enable/disable one click GSLB server integration with FortiG
...
class Vip:
    ...
    def post(
        ...
        uuid: str | None = ...,
        comment: str | None = ...,
        type: Literal[{"description": "Static NAT", "help": "Static NAT.", "label": "Static Nat", "name": "static-nat"}, {"description": "Load balance", "help": "Load balance.", "label": "Load Balance", "name": "load-balance"}, {"description": "Server load balance", "help": "Server load balance.", "label": "Server Load Balance", "name": "server-load-balance"}, {"description": "DNS translation", "help": "DNS translation.", "label": "Dns Translation", "name": "dns-translation"}, {"description": "Fully qualified domain name", "help": "Fully qualified domain name.", "label": "Fqdn", "name": "fqdn"}, {"description": "Access proxy", "help": "Access proxy.", "label": "Access Proxy", "name": "access-proxy"}] | None = ...,
        ...
        ldb_method: Literal[{"description": "Distribute to server based on source IP", "help": "Distribute to server based on source IP.", "label": "Static", "name": "static"}, {"description": "Distribute to server based round robin order", "help": "Distribute to server based round robin order.", "label": "Round Robin", "name": "round-robin"}, {"description": "Distribute to server based on weight", "help": "Distribute to server based on weight.", "label": "Weighted", "name": "weighted"}, {"description": "Distribute to server with lowest session count", "help": "Distribute to server with lowest session count.", "label": "Least Session", "name": "least-session"}, {"description": "Distribute to server with lowest Round-Trip-Time", "help": "Distribute to server with lowest Round-Trip-Time.", "label": "Least Rtt", "name": "least-rtt"}, {"description": "Distribute to the first server that is alive", "help": "Distribute to the first server that is alive.", "label": "First Alive", "name": "first-alive"}, {"description": "Distribute to server based on host field in HTTP header", "help": "Distribute to server based on host field in HTTP header.", "label": "Http Host", "name": "http-host"}] | None = ...,
        ...
        quic: str | None = ...,
        nat44: Literal[{"description": "Disable NAT44", "help": "Disable NAT44.", "label": "Disable", "name": "disable"}, {"description": "Enable NAT44", "help": "Enable NAT44.", "label": "Enable", "name": "enable"}] | None = ...,
        ...
        nat_source_vip: Literal[{"description": "Force only the source NAT mapped IP to the external IP for traffic egressing the external interface of the VIP", "help": "Force only the source NAT mapped IP to the external IP for traffic egressing the external interface of the VIP.", "label": "Disable", "name": "disable"}, {"description": "Force the source NAT mapped IP to the external IP for all traffic", "help": "Force the source NAT mapped IP to the external IP for all traffic.", "label": "Enable", "name": "enable"}] | None = ...,
        portforward: Literal[{"description": "Disable port forward", "help": "Disable port forward.", "label": "Disable", "name": "disable"}, {"description": "Enable port forward", "help": "Enable port forward.", "label": "Enable", "name": "enable"}] | None = ...,
        status: Literal[{"description": "Disable the VIP", "help": "Disable the VIP.", "label": "Disable", "name": "disable"}, {"description": "Enable the VIP", "help": "Enable the VIP.", "label": "Enable", "name": "enable"}] | None = ...,
        protocol: Literal[{"description": "TCP", "help": "TCP.", "label": "Tcp", "name": "tcp"}, {"description": "UDP", "help": "UDP.", "label": "Udp", "name": "udp"}, {"description": "SCTP", "help": "SCTP.", "label": "Sctp", "name": "sctp"}, {"description": "ICMP", "help": "ICMP.", "label": "Icmp", "name": "icmp"}] | None = ...,
        extport: str | None = ...,
        mappedport: str | None = ...,
        gratuitous_arp_interval: int | None = ...,
        srcintf_filter: list[dict[str, Any]] | None = ...,
        portmapping_type: Literal[{"description": "One to one", "help": "One to one.", "label": "1 To 1", "name": "1-to-1"}, {"description": "Many to many", "help": "Many to many.", "label": "M To N", "name": "m-to-n"}] | None = ...,
        ...
        ssl_algorithm: Literal[{"description": "High encryption", "help": "High encryption. Allow only AES and ChaCha.", "label": "High", "name": "high"}, {"description": "Medium encryption", "help": "Medium encryption. Allow AES, ChaCha, 3DES, and RC4.", "label": "Medium", "name": "medium"}, {"description": "Low encryption", "help": "Low encryption. Allow AES, ChaCha, 3DES, RC4, and DES.", "label": "Low", "name": "low"}, {"description": "Custom encryption", "help": "Custom encryption. Use config ssl-cipher-suites to select the cipher suites that are allowed.", "label": "Custom", "name": "custom"}] | None = ...,
        ssl_cipher_suites: list[dict[str, Any]] | None = ...,
        ssl_server_algorithm: Literal[{"description": "High encryption", "help": "High encryption. Allow only AES and ChaCha.", "label": "High", "name": "high"}, {"description": "Medium encryption", "help": "Medium encryption. Allow AES, ChaCha, 3DES, and RC4.", "label": "Medium", "name": "medium"}, {"description": "Low encryption", "help": "Low encryption. Allow AES, ChaCha, 3DES, RC4, and DES.", "label": "Low", "name": "low"}, {"description": "Custom encryption", "help": "Custom encryption. Use ssl-server-cipher-suites to select the cipher suites that are allowed.", "label": "Custom", "name": "custom"}, {"description": "Use the same encryption algorithms for both client and server sessions", "help": "Use the same encryption algorithms for both client and server sessions.", "label": "Client", "name": "client"}] | None = ...,
        ...
        ssl_client_renegotiation: Literal[{"description": "Allow a SSL client to renegotiate", "help": "Allow a SSL client to renegotiate.", "label": "Allow", "name": "allow"}, {"description": "Abort any client initiated SSL re-negotiation attempt", "help": "Abort any client initiated SSL re-negotiation attempt.", "label": "Deny", "name": "deny"}, {"description": "Abort any client initiated SSL re-negotiation attempt that does not use RFC 5746 Secure Renegotiation", "help": "Abort any client initiated SSL re-negotiation attempt that does not use RFC 5746 Secure Renegotiation.", "label": "Secure", "name": "secure"}] | None = ...,
        ...
        one_click_gslb_server: Literal[{"description": "Disable integration with FortiGSLB", "help": "Disable integration with FortiGSLB.", "label": "Disable", "name": "disable"}, {"description": "Enable integration with FortiGSLB", "help": "Enable integration with FortiGSLB.", "label": "Enable", "name": "enable"}] | None = ...,
        gslb_hostname: str | None = ...,
        gslb_domain_name: str | None = ...,
        gslb_public_ips: list[dict[str, Any]] | None = ...,
        vdom: str | bool | None = ...,
        raw_json: bool = ...,
        **kwargs: Any,
    ) -> Union[dict[str, Any], Coroutine[Any, Any, dict[str, Any]]]: ...
