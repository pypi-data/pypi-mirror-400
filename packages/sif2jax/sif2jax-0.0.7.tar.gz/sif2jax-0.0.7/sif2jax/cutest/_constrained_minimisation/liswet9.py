...
class LISWET9(_AbstractLISWET):
    """LISWET9 - Li and Swetits k-convex approximation problem.
    ...
    def _g_function(self, t):
        """The g(t) function for LISWET9: g(t) = sin(4π*t)."""
        return jnp.sin(4.0 * jnp.pi * t)
