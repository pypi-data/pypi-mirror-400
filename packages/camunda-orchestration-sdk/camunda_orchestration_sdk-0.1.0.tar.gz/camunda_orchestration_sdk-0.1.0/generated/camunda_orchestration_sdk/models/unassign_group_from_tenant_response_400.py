...
T = TypeVar("T", bound="UnassignGroupFromTenantResponse400")


@_attrs_define
class UnassignGroupFromTenantResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unassign_group_from_tenant_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        unassign_group_from_tenant_response_400.additional_properties = d
        return unassign_group_from_tenant_response_400
