...
T = TypeVar("T", bound="AnnotationFilterSchema")


@attrs.define
class AnnotationFilterSchema:
    """
    Attributes:
        annotator (Union[int, str]):
        label_schema_uid (int):
        filter_type (Union[Unset, FilterTransformFilterTypes]):
        transform_config_type (Union[Literal['annotation_filter_schema'], Unset]):  Default: 'annotation_filter_schema'.
    ...
    transform_config_type: Union[Literal["annotation_filter_schema"], Unset] = (
        "annotation_filter_schema"
    )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_annotator(data: object) -> Union[int, str]:
            return cast(Union[int, str], data)

        annotator = _parse_annotator(d.pop("annotator"))
