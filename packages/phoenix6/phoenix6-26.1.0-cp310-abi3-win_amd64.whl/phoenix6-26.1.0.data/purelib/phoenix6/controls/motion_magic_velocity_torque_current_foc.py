...
class MotionMagicVelocityTorqueCurrentFOC:
    ...
    :param velocity: Target velocity to drive toward in rotations per second.  This
    ...
    def __init__(self, velocity: rotations_per_second, acceleration: rotations_per_second_squared = 0.0, feed_forward: ampere = 0.0, slot: int = 0, override_coast_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, ignore_software_limits: bool = False, use_timesync: bool = False):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "MotionMagicVelocityTorqueCurrentFOC"
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlMotionMagicVelocityTorqueCurrentFOC(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.velocity, self.acceleration, self.feed_forward, self.slot, self.override_coast_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.ignore_hardware_limits, self.ignore_software_limits, self.use_timesync))
    ...
    def with_ignore_software_limits(self, new_ignore_software_limits: bool) -> 'MotionMagicVelocityTorqueCurrentFOC':
        """
