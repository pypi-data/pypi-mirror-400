...
T = TypeVar("T", bound="SplunkITSIIntegration")


@_attrs_define
class SplunkITSIIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        splunk_itsi_integration.additional_properties = d
        return splunk_itsi_integration
