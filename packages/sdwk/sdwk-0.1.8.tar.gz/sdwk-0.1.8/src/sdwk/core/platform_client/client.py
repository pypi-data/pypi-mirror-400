...
class PlatformClient:
    ...
    def get_sdk_settings(self) -> dict[str, Any]:
        ...
        """
        try:
            response = self._http_client.get("/api/sdk/settings")
            return response
    ...
    def get_llm_api_keys(self) -> dict[str, Any]:
        ...
        """
        try:
            response = self._http_client.get("/api/sdk/llm_setting")
            return response
        except PlatformAPIError:
            raise
        except Exception as e:
    ...
    def submit_artifact_manifest(
        ...
        """
        try:
            response = self._http_client.post("/api/artifacts/manifest", json=manifest)
            return response
        except PlatformAPIError:
            raise
        except Exception as e:
