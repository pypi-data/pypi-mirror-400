...
from viktor._vendor.libcst._nodes.internal import CodegenState, visit_body_sequence, visit_sequence
from viktor._vendor.libcst._nodes.statement import (
    BaseCompoundStatement,
    get_docstring_impl,
    SimpleStatementLine,
)
from viktor._vendor.libcst._nodes.whitespace import EmptyLine
