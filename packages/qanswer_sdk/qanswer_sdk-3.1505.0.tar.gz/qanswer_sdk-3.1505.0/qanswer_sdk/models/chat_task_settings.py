...
class ChatTaskSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prompt", "bot_seed", "bot_temperature", "bot_answer_length", "number_of_references", "stream_speed", "context_window", "max_tokens", "slots_values", "bot_name", "bot_description", "llm_id", "llm_endpoint", "query_expansion_prompt", "map_prompt", "reduce_prompt", "enable_enhanced_context", "show_date_in_sources", "selected_aggregations", "chat_initial_message", "human_takeover"]
