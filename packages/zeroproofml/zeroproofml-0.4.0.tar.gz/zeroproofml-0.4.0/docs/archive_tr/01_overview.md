...
- Autodiff rules: See `docs/archive_tr/autodiff_mask_real.md` and `docs/archive_tr/saturating_grad_guide.md`.
- Layers overview: `docs/layers.md` (TR-Rational, TR-Norm, enhanced variants).
- Bridges and interop: `docs/09_bridge_summary.md` and `docs/10_bridge_extended.md`.
- Precision and float64 enforcement: `docs/12_float64_enforcement.md`.
- Adaptive loss & coverage: `docs/13_adaptive_loss_guide.md` and summaries in `docs/14_adaptive_loss_summary.md`.
 - Robotics how‑tos & parity runner: `docs/archive_tr/topics/08_howto_checklists.md` (dataset flags, quick/full profiles, comparator driver, and bench metrics).
