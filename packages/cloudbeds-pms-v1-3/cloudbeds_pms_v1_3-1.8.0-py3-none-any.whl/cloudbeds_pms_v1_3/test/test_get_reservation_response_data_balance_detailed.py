...
class TestGetReservationResponseDataBalanceDetailed(unittest.TestCase):
    """GetReservationResponseDataBalanceDetailed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservationResponseDataBalanceDetailed:
        """Test GetReservationResponseDataBalanceDetailed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservationResponseDataBalanceDetailed`
        """
        model = GetReservationResponseDataBalanceDetailed()
        if include_optional:
            return GetReservationResponseDataBalanceDetailed(
                suggested_deposit = '',
                sub_total = 1.337,
    ...
    def testGetReservationResponseDataBalanceDetailed(self):
        """Test GetReservationResponseDataBalanceDetailed"""
