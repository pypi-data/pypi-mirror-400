...
textarea.focus()
showStatus('代码已插入','success')}else{showStatus('剪贴板为空','error')}}catch(error){console.error('读取剪贴板失败:',error)
...
return false}
try{const imageId=Date.now()+Math.random()
...
return null}}
document.addEventListener('paste',async function(e){const clipboardData=e.clipboardData
