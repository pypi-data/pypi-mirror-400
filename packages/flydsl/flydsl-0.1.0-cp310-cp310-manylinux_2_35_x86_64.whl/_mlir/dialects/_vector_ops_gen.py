...
def vscale(*, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def compressstore(base, indices, mask, value_to_store, *, alignment=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def deinterleave(source, *, results=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
...
def expandload(result, base, indices, mask, pass_thru, *, alignment=None, loc=None, ip=None) -> _ods_ir.Value:
...
class ExtractOp(_ods_ir.OpView):
  ...
  def __init__(self, vector, dynamic_position, static_position, *, results=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
...
def extract(vector, dynamic_position, static_position, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
  return ExtractOp(vector=vector, dynamic_position=dynamic_position, static_position=static_position, results=results, loc=loc, ip=ip).result
...
def fma(lhs, rhs, acc, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def gather(result, base, offsets, indices, mask, pass_thru, *, alignment=None, loc=None, ip=None) -> _ods_ir.Value:
...
def insert(value_to_store, dest, dynamic_position, static_position, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def insert_strided_slice(value_to_store, dest, offsets, strides, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def interleave(lhs, rhs, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def multi_reduction(kind, source, acc, reduction_dims, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def scalable_insert(value_to_store, dest, pos, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def scan(kind, source, initial_value, reduction_dim, inclusive, *, results=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
...
def scatter(base, offsets, indices, mask, value_to_store, *, alignment=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def shuffle(v1, v2, mask, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
...
def to_elements(source, *, results=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ToElementsOp(source=source, results=results, loc=loc, ip=ip))
