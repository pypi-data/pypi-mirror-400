...
from xladmin.views import BaseAdminPlugin, ListAdminView, ModelFormAdminView, DetailAdminView
...
class AjaxDetailPlugin(BaseAjaxPlugin):
    ...
    def get_response(self, __):
        if self.request.GET.get('_format') == 'html':
            self.admin_view.detail_template = 'xladmin/views/quick_detail.html'
            return __()
