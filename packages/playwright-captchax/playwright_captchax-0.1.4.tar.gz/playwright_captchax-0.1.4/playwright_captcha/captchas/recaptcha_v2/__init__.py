...
from .solvers.capsolver import solve_recaptcha_v2_capsolver
...
BaseSolver.register_solver(SolverType.capsolver, CaptchaType.RECAPTCHA_V2, solve_recaptcha_v2_capsolver)
