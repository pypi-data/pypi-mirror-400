...
class BackgroundWorker:
    ...
    def _process(self, run_id: str, slug: str) -> None:
        ...
        if not is_repo_root and isinstance(allow_globs, list) and allow_globs:
