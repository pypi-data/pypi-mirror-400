...
@click.option("--destinations", help="The destinations of the live input in JSON list format.")
...
def update_live_input(ctx, live_input_id, name, source, input_type, is_standard, video_asset_id, destinations, sources):
    ...
    try:
        result = nomad_sdk.update_live_input(
            ...
            is_standard,
            video_asset_id,
            validate_json(destinations, "destinations") if destinations else None,
