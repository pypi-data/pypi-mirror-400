...
class SenderRequestNatural201Response(BaseModel):
    """
    SenderRequestNatural201Response
    """ # noqa: E501
    data: Optional[SenderRequestNaturalSchema] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SenderRequestNaturalSchema.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
