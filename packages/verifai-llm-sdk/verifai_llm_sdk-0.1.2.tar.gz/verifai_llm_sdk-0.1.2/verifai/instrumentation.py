...
def auto_instrument(project_name: str, service_name: str = "default", api_url: str = "http://localhost:8000"):
    ...
    export = VerifAISpanExporter(api_url=api_url, project_name=project_name)
    _provider.add_span_processor(BatchSpanProcessor(export))
    ...
    try:
        ...
        print("✅ VerifAI: OpenAI instrumentation enabled")
    except ImportError:
        pass
    except Exception as e:
        print(f"⚠️ VerifAI: Failed to instrument OpenAI: {e}")

    # Auto-instrument LangChain
    try:
        from opentelemetry.instrumentation.langchain import LangchainInstrumentor
        LangchainInstrumentor().instrument(tracer_provider=_provider)
        print("✅ VerifAI: LangChain instrumentation enabled")
    except ImportError:
        pass
    except Exception as e:
        print(f"⚠️ VerifAI: Failed to instrument LangChain: {e}")
