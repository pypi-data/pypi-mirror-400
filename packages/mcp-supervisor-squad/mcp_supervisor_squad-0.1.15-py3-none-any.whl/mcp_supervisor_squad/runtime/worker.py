...
class Worker:
    ...
    def _run(self, run_id: str, repo_root_hint: str | None = None) -> None:
        ...
        try:
            ...
            write_kb_index(layout=layout, note="planner completed")
            archive_and_clear_inbox(layout=layout, keep=state.kb_archive_keep, max_kb=state.kb_archive_max_kb)
        except Exception:
            update(
                phase="error",
        ...
        *,
        ...
        parts += [
            ...
            *scope_lines,
            ...
            contract_rule,
            f"Keep `compact_md` <= {compact_max_kb}KB. No fenced code blocks. No logs. Use file paths + brief commands as evidence.",
            "",
