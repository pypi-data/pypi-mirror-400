...
T = TypeVar("T", bound="GetUsageMetricsResponse400")


@_attrs_define
class GetUsageMetricsResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_usage_metrics_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_usage_metrics_response_400.additional_properties = d
        return get_usage_metrics_response_400
