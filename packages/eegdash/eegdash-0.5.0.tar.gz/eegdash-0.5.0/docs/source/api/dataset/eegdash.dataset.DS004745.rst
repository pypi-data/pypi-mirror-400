...
8-Channel SSVEP EEG Dataset with Artifact Trials (OpenNeuro ``ds004745``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 1` :bdg-light:`License: CC0` :bdg-light:`Subjects: 6` :bdg-light:`Recordings: 6` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds004745.v1.0.1 <https://doi.org/10.18112/openneuro.ds004745.v1.0.1>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds004745>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds004745>`__
