...
class Browser(EventEmitter):
    ...
    through :func:`~cdpy.connect.connect`.
    """
    ...
    def process(self) -> Optional[Popen]:
        ...
        If browser instance is created by :func:`cdpy.connect.connect`,
        return ``None``.
        """
...
class BrowserContext(EventEmitter):
    ...
    async def set_permission(
        self, name: str, setting: typing.Literal["granted", "denied", "prompt"]
    ):
        assert self._id, "No browser context"
