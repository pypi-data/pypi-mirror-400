...
T = TypeVar("T", bound="ZendeskIntegration")
...
class ZendeskIntegration:
    ...
    Attributes:
        ...
        zendesk_api_token (Union[Unset, str]):
        zendesk_email (Union[Unset, str]):
        zendesk_subdomain (Union[Unset, str]):
    """
    ...
    zendesk_api_token: Union[Unset, str] = UNSET
    zendesk_email: Union[Unset, str] = UNSET
    zendesk_subdomain: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if zendesk_api_token is not UNSET:
            field_dict["zendeskApiToken"] = zendesk_api_token
        if zendesk_email is not UNSET:
            field_dict["zendeskEmail"] = zendesk_email
        if zendesk_subdomain is not UNSET:
            field_dict["zendeskSubdomain"] = zendesk_subdomain
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        zendesk_api_token = d.pop("zendeskApiToken", UNSET)

        zendesk_email = d.pop("zendeskEmail", UNSET)

        zendesk_subdomain = d.pop("zendeskSubdomain", UNSET)

        zendesk_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        zendesk_integration.additional_properties = d
        return zendesk_integration
