...
T = TypeVar("T", bound="StatusHubIntegration")


@_attrs_define
class StatusHubIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status_hub_integration.additional_properties = d
        return status_hub_integration
