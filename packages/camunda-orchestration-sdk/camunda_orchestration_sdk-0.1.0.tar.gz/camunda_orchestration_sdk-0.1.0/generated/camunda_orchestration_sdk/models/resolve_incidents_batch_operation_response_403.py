...
T = TypeVar("T", bound="ResolveIncidentsBatchOperationResponse403")


@_attrs_define
class ResolveIncidentsBatchOperationResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resolve_incidents_batch_operation_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        resolve_incidents_batch_operation_response_403.additional_properties = d
        return resolve_incidents_batch_operation_response_403
