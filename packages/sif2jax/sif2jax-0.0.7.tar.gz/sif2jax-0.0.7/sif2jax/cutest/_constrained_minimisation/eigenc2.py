...
class EIGENC2(AbstractConstrainedMinimisation):
    """EIGENC2 - Quadratic eigenvalue problem for Wilkinson matrix."""
    ...
    def constraint(self, y):
        ...
        # Extract constraints following SIF order: for J, for I <= J: O(I,J)
