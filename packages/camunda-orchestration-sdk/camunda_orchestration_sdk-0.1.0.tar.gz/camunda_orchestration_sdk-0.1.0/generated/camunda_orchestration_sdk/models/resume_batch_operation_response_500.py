...
T = TypeVar("T", bound="ResumeBatchOperationResponse500")


@_attrs_define
class ResumeBatchOperationResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resume_batch_operation_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        resume_batch_operation_response_500.additional_properties = d
        return resume_batch_operation_response_500
