...
T = TypeVar("T", bound="GetStartProcessFormResponse404")


@_attrs_define
class GetStartProcessFormResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_start_process_form_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_start_process_form_response_404.additional_properties = d
        return get_start_process_form_response_404
