...
T = TypeVar("T", bound="SearchTenantsResponse500")


@_attrs_define
class SearchTenantsResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_tenants_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_tenants_response_500.additional_properties = d
        return search_tenants_response_500
