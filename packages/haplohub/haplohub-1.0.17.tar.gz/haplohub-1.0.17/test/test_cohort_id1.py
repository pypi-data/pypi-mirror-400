...
from haplohub.models.cohort_id1 import CohortId1  # noqa: E501


class TestCohortId1(unittest.TestCase):
    """CohortId1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CohortId1:
        """Test CohortId1
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CohortId1`
        """
        model = CohortId1()  # noqa: E501
        if include_optional:
            return CohortId1(
            )
        else:
