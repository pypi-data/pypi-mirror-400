...
''' SOURCE : https://github.com/Intan-Technologies/load-rhd-notebook-python/blob/main/importrhdutilities.py '''

"""Imports a variety of Python helper functions for reading intan info files"""
import struct
import math
import os
import time
...
## Modified 02/06/25 -> keep num channel info not present in header
