...
T = TypeVar("T", bound="ObserviumIntegration")


@_attrs_define
class ObserviumIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        observium_integration.additional_properties = d
        return observium_integration
