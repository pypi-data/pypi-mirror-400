...
class DutyCycleOut:
    ...
    :param output: Proportion of supply voltage to apply in fractional units between
                   -1 and +1
    :type output: float
    ...
    def __init__(self, output: float, enable_foc: bool = True, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, ignore_software_limits: bool = False, use_timesync: bool = False):
    ...
    def with_ignore_software_limits(self, new_ignore_software_limits: bool) -> 'DutyCycleOut':
        """
