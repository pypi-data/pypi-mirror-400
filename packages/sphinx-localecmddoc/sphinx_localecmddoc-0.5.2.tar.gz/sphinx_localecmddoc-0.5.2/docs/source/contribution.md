...
File an issue! Go to [Issue tracker](https://codeberg.org/jbox/sphinx-localecmddoc/issues)
and press «new issue». 
...
## Submit changes
To submit changes, fork https://codeberg.org/jbox/sphinx-localecmddoc, and work at your fork.
...
As in the linked example, you can choose if you want to include the type in the same line or in the line below.
...
Try to achieve high testing coverage.
