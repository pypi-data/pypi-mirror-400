"""
Power generation facilities that burn fossil fuels such as coal, natural gas, or oil.
...
class FossilFuelPlant(GridSTIXDomainObject):
    """
    Power generation facilities that burn fossil fuels such as coal, natural gas, or oil.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize FossilFuelPlant with Grid-STIX properties."""
