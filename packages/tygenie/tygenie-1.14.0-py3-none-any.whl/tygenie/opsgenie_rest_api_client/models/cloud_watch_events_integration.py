...
T = TypeVar("T", bound="CloudWatchEventsIntegration")


@_attrs_define
class CloudWatchEventsIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        cloud_watch_events_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        cloud_watch_events_integration.additional_properties = d
        return cloud_watch_events_integration
