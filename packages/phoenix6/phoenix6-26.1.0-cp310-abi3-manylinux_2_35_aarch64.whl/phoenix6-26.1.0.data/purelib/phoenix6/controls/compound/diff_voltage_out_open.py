...
class Diff_VoltageOut_Open:
    ...
    def __init__(self, average_request: VoltageOut, differential_request: VoltageOut):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_VoltageOut_Open"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_VoltageOut_Open")
    ...
    def with_average_request(self, new_average_request: VoltageOut) -> 'Diff_VoltageOut_Open':
        ...
        :returns: Itself
        :rtype: Diff_VoltageOut_Open
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: VoltageOut) -> 'Diff_VoltageOut_Open':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_VoltageOut_Open':
        """
