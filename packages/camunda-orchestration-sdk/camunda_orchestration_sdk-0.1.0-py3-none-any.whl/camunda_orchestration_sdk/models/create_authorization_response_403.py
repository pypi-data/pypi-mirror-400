...
T = TypeVar("T", bound="CreateAuthorizationResponse403")


@_attrs_define
class CreateAuthorizationResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_authorization_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_authorization_response_403.additional_properties = d
        return create_authorization_response_403
