...
from xladmin.util import is_related_field, is_related_field2
import datetime
...
class BaseFilter(object):
    title = None
    template = 'xladmin/filters/list.html'
...
class TextFieldListFilter(FieldFilter):
    template = 'xladmin/filters/char.html'
...
class NumberFieldListFilter(FieldFilter):
    template = 'xladmin/filters/number.html'
...
class DateFieldListFilter(ListFieldFilter):
    template = 'xladmin/filters/date.html'
...
class RelatedFieldSearchFilter(FieldFilter):
    template = 'xladmin/filters/fk_search.html'
...
class MultiSelectFieldListFilter(ListFieldFilter):
    ...
    """
    template = 'xladmin/filters/checklist.html'
