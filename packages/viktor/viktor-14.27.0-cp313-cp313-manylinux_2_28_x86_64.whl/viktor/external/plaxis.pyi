...
__all__ = ['PlaxisAnalysis']

class PlaxisAnalysis(PythonAnalysis):
    ''' ::version(14.17.0)

    PlaxisAnalysis can be used to evaluate a plaxis-python script on third-party infrastructure. The script is expected
    ...
    .. code-block:: python
        ...
        analysis = PlaxisAnalysis(script=script, files=files, output_filenames=["output.txt"])
