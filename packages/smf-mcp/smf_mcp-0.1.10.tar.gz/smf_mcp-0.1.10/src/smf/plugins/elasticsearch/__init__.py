...
def create_elasticsearch_tools(
    ...
    def update_document_tool(
        ...
        return es_client.update_document(
            index=target_index, document_id=document_id, doc=doc
        )
    ...
    def delete_document_tool(
        ...
        return es_client.delete_document(index=target_index, document_id=document_id)
