...
NOD-EEG (OpenNeuro ``ds005787``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 1` :bdg-light:`License: CC0` :bdg-light:`Subjects: 19` :bdg-light:`Recordings: 448` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - Year
     - Unknown
   * - Authors
     - Guohao Zhang, Yaoze Liu, Zonglei Zhen
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds005787.v1.0.0 <https://doi.org/10.18112/openneuro.ds005787.v1.0.0>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds005787>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds005787>`__
...
.. dropdown:: Copy-paste BibTeX
   ...
   .. code-block:: bibtex
      ...
      @dataset{ds005787,
        title = {NOD-EEG},
        author = {Guohao Zhang and Yaoze Liu and Zonglei Zhen},
        doi = {10.18112/openneuro.ds005787.v1.0.0},
        url = {https://doi.org/10.18112/openneuro.ds005787.v1.0.0},
      }
...
.. grid:: 1 2 3 3
   ...
   .. grid-item-card:: License & citation
      ...
      - License: CC0
      - DOI: doi:10.18112/openneuro.ds005787.v1.0.0
...
.. tab-set::
   ...
   .. tab-item:: Basic
      ...
      .. code-block:: python
         ...
         dataset = DS005787(cache_dir="./data", subject="01")
