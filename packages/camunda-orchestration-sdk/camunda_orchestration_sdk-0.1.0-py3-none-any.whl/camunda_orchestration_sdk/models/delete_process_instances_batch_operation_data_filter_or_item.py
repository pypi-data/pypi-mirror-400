...
if TYPE_CHECKING:
    ...
    from ..models.delete_process_instances_batch_operation_data_filter_or_item_variables_item import (
...
T = TypeVar("T", bound="DeleteProcessInstancesBatchOperationDataFilterOrItem")


@_attrs_define
class DeleteProcessInstancesBatchOperationDataFilterOrItem:
    ...
    Attributes:
        ...
        variables (list[DeleteProcessInstancesBatchOperationDataFilterOrItemVariablesItem] | Unset): The process
            instance variables.
    ...
    variables: (
        list[DeleteProcessInstancesBatchOperationDataFilterOrItemVariablesItem] | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        variables: (
            list[DeleteProcessInstancesBatchOperationDataFilterOrItemVariablesItem]
            | Unset
        ) = UNSET
        if _variables is not UNSET:
            variables = []
            for variables_item_data in _variables:
                variables_item = DeleteProcessInstancesBatchOperationDataFilterOrItemVariablesItem.from_dict(
                    variables_item_data
                )
        ...
        delete_process_instances_batch_operation_data_filter_or_item = cls(
        ...
        delete_process_instances_batch_operation_data_filter_or_item.additional_properties = d
        return delete_process_instances_batch_operation_data_filter_or_item
