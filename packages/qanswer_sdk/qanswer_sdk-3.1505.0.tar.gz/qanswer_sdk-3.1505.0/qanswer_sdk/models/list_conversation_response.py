...
class ListConversationResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListConversationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListConversationResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "conversations": [ConversationModel.from_dict(_item) for _item in obj["conversations"]] if obj.get("conversations") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
