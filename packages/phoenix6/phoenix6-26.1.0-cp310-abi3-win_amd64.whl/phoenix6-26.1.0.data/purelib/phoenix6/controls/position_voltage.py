...
class PositionVoltage:
    ...
    def __init__(self, position: rotation, velocity: rotations_per_second = 0.0, enable_foc: bool = True, feed_forward: volt = 0.0, slot: int = 0, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, ignore_software_limits: bool = False, use_timesync: bool = False):
    ...
    def with_ignore_software_limits(self, new_ignore_software_limits: bool) -> 'PositionVoltage':
        """
