...
class RmonStatPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    """
    id: int  # RMON Ethernet statistics entry ID.
    source: str  # Data source of the Ethernet statistics entry.
    owner: NotRequired[str]  # Owner of the Ethernet statistics entry.
