...
from xladmin.layout import Fieldset, Main, Side, Row, FormHelper
from xladmin.sites import site
from xladmin.util import unquote
from xladmin.views import BaseAdminPlugin, ModelFormAdminView, ModelAdminView, CommAdminView, csrf_protect_m
...
class ChangePasswordView(ModelAdminView):
    ...
    def get_media(self):
        ...
        media = media + self.vendor('xladmin.form.css', 'xladmin.page.form.js') + self.form.media
        return media
