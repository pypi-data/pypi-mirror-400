...
from layerlearn.baseCatC import CatForestClassifier, CatSupportClassifier, CatLogisticClassifier, CatKNNClassifier, CatXGBClassifier, CatAdaClassifier, CatGradientClassifier, CatDecisionClassifier, CatLightClassifier
...
models = {
    "Cat Forest Classifier": CatForestClassifier(),
    "Cat Support Classifier": CatSupportClassifier(),
    "Cat Linear Classifier": CatLogisticClassifier(),
    "Cat KNN Classifier": CatKNNClassifier(),
    "Cat XGBoost Classifier": CatXGBClassifier(),
    "Cat Ada Classifier": CatAdaClassifier(),
    "Cat Gradient Boosting Classifier": CatGradientClassifier(),
    "Cat Decision Classifier": CatDecisionClassifier(),
    "Cat LightGBM Classifier": CatLightClassifier(),
}
...
ax.set_title('Comparison of Cat Model Classifier Performance', fontsize=18, fontweight='bold')
