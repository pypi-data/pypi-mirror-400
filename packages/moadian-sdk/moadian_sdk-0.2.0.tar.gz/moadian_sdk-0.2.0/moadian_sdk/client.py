...
class MoadianClient:
    ...
    def __init__(
        ...
        self.serial_manager = SerialNumberManager(
            serial_file=serial_file, enable_file_storage=enable_serial_storage
        )
        ...
        **header_overrides: Any,
        ...
        Args:
            ...
            **header_overrides: Optional keyword arguments to override header/invoice parameters.
                Any parameter accepted by build_invoice_dict() can be passed here to override
                values from invoice_data. Examples:
                - seller_tin: Override seller TIN
                - buyer_tin: Override buyer TIN
                - invoice_type: Override invoice type
                - settlement_method: Override settlement method
                - tob: Override type of business
                - irtaxid: Set related tax ID
                - Any other header field from build_invoice_dict()
        ...
        # Build invoice dictionary with overrides
        ...
        # Submit
        result = self.send_invoices(
            [invoice_packet], tax_id=tax_id, serial=serial
        )
