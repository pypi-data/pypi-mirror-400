...
from kosmos.ml.datasets.qsar_dataset import QSARDataset
from kosmos.utils.rng import RNG


def qsar_nn_example() -> None:
    """Run example of training and testing on the QSAR dataset using a neural network."""
