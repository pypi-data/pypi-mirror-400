"""
audio_python - A Rust-based Python extension for audio processing.
...
Example usage:
    ...
    >>> from audio_python import generation, io
    >>>
...
# The native extension is compiled as audio_python.cpython-*.so
# When placed in the audio_python/ directory, Python can import it 
...
_so_files = list(_package_dir.glob("audio_samples_python.cpython-*.so"))
if _so_files:
    ...
    raise ImportError("Could not find the audio_python native extension (.so file)")
