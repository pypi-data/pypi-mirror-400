...
T = TypeVar("T", bound="CreateTenantResponse403")


@_attrs_define
class CreateTenantResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_tenant_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_tenant_response_403.additional_properties = d
        return create_tenant_response_403
