...
Healthy Brain Network (HBN) EEG - Release 9 (OpenNeuro ``ds005514``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 10` :bdg-light:`License: CC-BY-SA 4.0` :bdg-light:`Subjects: 295` :bdg-light:`Recordings: 2885` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC-BY-SA 4.0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds005514.v1.0.1 <https://doi.org/10.18112/openneuro.ds005514.v1.0.1>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds005514>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds005514>`__
