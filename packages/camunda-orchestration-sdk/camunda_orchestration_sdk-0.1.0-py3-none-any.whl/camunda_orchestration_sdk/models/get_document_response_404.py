...
T = TypeVar("T", bound="GetDocumentResponse404")


@_attrs_define
class GetDocumentResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_document_response_404.additional_properties = d
        return get_document_response_404
