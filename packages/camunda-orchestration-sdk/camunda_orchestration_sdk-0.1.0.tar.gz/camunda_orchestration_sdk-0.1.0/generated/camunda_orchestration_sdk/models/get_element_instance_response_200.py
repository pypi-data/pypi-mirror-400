...
from ..models.get_element_instance_response_200_state import (
    GetElementInstanceResponse200State,
)
from ..models.get_element_instance_response_200_type import (
    GetElementInstanceResponse200Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetElementInstanceResponse200")


@_attrs_define
class GetElementInstanceResponse200:
    """
    Attributes:
        ...
        type_ (GetElementInstanceResponse200Type): Type of element as defined set of values.
        state (GetElementInstanceResponse200State): State of element instance as defined set of values.
    ...
    element_name: str
    type_: GetElementInstanceResponse200Type
    state: GetElementInstanceResponse200State
    has_incident: bool
    tenant_id: TenantId
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetElementInstanceResponse200Type(d.pop("type"))

        state = GetElementInstanceResponse200State(d.pop("state"))
        ...
        get_element_instance_response_200.additional_properties = d
        return get_element_instance_response_200
