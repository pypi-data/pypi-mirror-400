...
T = TypeVar("T", bound="BidirectionalCallbackNew")
...
class BidirectionalCallbackNew:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bidirectional_callback_new = cls(
        ...
        bidirectional_callback_new.additional_properties = d
        return bidirectional_callback_new
