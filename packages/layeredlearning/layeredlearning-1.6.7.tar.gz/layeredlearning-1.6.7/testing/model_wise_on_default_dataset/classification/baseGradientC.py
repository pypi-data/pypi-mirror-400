...
from layerlearn.baseGradientC import GradientAdaClassifier, GradientCatClassifier, GradientDecisionClassifier, GradientForestClassifier, GradientKNNClassifier, GradientLogisticClassifier, GradientLightClassifier, GradientSupportClassifier, GradientXGBClassifier
...
models = {
    "Gradient Forest Classifier": GradientForestClassifier(),
    "Gradient Support Classifier": GradientSupportClassifier(),
    "Gradient Logistic Classifier": GradientLogisticClassifier(),
    "Gradient KNN Classifier": GradientKNNClassifier(),
    "Gradient XGBoost Classifier": GradientXGBClassifier(),
    "Gradient Ada Classifier": GradientAdaClassifier(),
    "Gradient Cat Classifier": GradientCatClassifier(),
    "Gradient Decision Classifier": GradientDecisionClassifier(),
    "Gradient LightGBM Classifier": GradientLightClassifier(),
}
...
ax.set_title('Comparison of Gradient Model Classifier Performance', fontsize=18, fontweight='bold')
