...
T = TypeVar("T", bound="GetResourceContentResponse500")


@_attrs_define
class GetResourceContentResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_resource_content_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_resource_content_response_500.additional_properties = d
        return get_resource_content_response_500
