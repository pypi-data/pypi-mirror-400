...
def convert_ttf_to_css(ttf_path, output_css_path="icons.css", font_family="Material Icons"):
    ...
    if not os.path.exists(ttf_path):
        print(f"❌ Error: File not found at '{ttf_path}'")
        return

    try:
        print(f"🔄 Reading '{ttf_path}'...")
...
"""
        ...
        print(f"🎉 Success! CSS file generated at: {output_css_path}")
        print(f"📝 Total size: {len(css_content) / 1024:.2f} KB")
