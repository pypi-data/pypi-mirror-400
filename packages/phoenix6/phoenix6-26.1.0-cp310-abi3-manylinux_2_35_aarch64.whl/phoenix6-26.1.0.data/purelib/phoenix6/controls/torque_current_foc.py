...
class TorqueCurrentFOC:
    ...
    :param deadband: Deadband in Amperes.  If torque request is within deadband, the
    ...
    def __init__(self, output: ampere, max_abs_duty_cycle: float = 1.0, deadband: ampere = 0.0, override_coast_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, ignore_software_limits: bool = False, use_timesync: bool = False):
    ...
    def with_ignore_software_limits(self, new_ignore_software_limits: bool) -> 'TorqueCurrentFOC':
        """
