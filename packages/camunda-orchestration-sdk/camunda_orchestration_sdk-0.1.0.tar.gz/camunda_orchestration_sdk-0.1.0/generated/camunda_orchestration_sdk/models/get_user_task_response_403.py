...
T = TypeVar("T", bound="GetUserTaskResponse403")


@_attrs_define
class GetUserTaskResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_user_task_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_user_task_response_403.additional_properties = d
        return get_user_task_response_403
