...
T = TypeVar("T", bound="AssignClientToGroupResponse409")


@_attrs_define
class AssignClientToGroupResponse409:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assign_client_to_group_response_409 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        assign_client_to_group_response_409.additional_properties = d
        return assign_client_to_group_response_409
