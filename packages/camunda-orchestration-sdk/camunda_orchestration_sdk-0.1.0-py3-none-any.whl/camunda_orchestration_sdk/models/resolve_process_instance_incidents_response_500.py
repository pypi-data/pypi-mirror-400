...
T = TypeVar("T", bound="ResolveProcessInstanceIncidentsResponse500")


@_attrs_define
class ResolveProcessInstanceIncidentsResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resolve_process_instance_incidents_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        resolve_process_instance_incidents_response_500.additional_properties = d
        return resolve_process_instance_incidents_response_500
