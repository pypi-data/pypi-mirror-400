"""
Fireworks AI provider adapter implementation
"""
...
class FireworksAdapter(ProviderAdapter):
    """Fireworks AI provider adapter - uses OpenAI-compatible API format."""
    ...
    def estimate_cost(self, request_metadata: Dict[str, Any]) -> CostEstimate:
        try:
            model = request_metadata.get("model", "accounts/fireworks/models/llama-v3p1-70b-instruct")
