            ...
            def __init__(self, Coeff, Expon, Offset, Delay, open_level=np.nan, close_level=np.nan, Qcurve=np.nan):
                ...
                Args:
                    ...
                    Delay: number of dry weather hours that must elapse before the drain line in a
                        ...
                        LIDs.
                    open_level (): The height of water (in inches or mm) in the drain's Storage Layer that causes
                        the drain to automatically open. Use 0 to disable this feature.
                    close_level (): The height of water (in inches or mm) in the drain's Storage Layer that causes
