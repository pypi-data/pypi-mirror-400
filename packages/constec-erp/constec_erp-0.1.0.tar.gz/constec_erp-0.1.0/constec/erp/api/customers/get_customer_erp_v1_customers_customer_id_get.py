...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/erp/v1/customers/{customer_id}".format(customer_id=quote(str(customer_id), safe=""),),
        "params": params,
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> CustomerSchema | HTTPValidationError | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[CustomerSchema | HTTPValidationError]:
    return Response(
