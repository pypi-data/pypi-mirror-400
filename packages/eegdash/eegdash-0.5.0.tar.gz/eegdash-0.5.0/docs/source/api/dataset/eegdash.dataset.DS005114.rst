...
EEG: DPX Cog Ctl Task in Acute Mild TBI (OpenNeuro ``ds005114``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 1` :bdg-light:`License: CC0` :bdg-light:`Subjects: 91` :bdg-light:`Recordings: 223` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds005114.v1.0.0 <https://doi.org/10.18112/openneuro.ds005114.v1.0.0>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds005114>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds005114>`__
