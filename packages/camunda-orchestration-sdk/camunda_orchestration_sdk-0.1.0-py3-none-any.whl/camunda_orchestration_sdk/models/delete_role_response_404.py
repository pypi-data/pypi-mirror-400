...
T = TypeVar("T", bound="DeleteRoleResponse404")


@_attrs_define
class DeleteRoleResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_role_response_404.additional_properties = d
        return delete_role_response_404
