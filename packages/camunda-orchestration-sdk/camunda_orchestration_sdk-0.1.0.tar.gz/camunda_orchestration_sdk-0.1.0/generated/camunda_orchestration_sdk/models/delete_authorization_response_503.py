...
T = TypeVar("T", bound="DeleteAuthorizationResponse503")


@_attrs_define
class DeleteAuthorizationResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_authorization_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_authorization_response_503.additional_properties = d
        return delete_authorization_response_503
