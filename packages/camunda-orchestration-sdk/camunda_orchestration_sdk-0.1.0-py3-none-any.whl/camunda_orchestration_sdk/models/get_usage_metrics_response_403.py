...
T = TypeVar("T", bound="GetUsageMetricsResponse403")


@_attrs_define
class GetUsageMetricsResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_usage_metrics_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_usage_metrics_response_403.additional_properties = d
        return get_usage_metrics_response_403
