...
from layerlearn.baseForestR import ForestAdaRegressor, ForestCatRegressor, ForestDecisionRegressor, ForestGradientRegressor, ForestKNNRegressor, ForestLightRegressor, ForestSupportRegressor, ForestXGBRegressor, ForestLinearRegressor
import warnings
...
models = {
    "Forest Linear Regressor": ForestLinearRegressor(),
    "Forest Support Regressor": ForestSupportRegressor(),
    "Forest Decision Regressor": ForestDecisionRegressor(),
    "Forest KNN Regressor": ForestKNNRegressor(),
    "Forest XGBoost Regressor": ForestXGBRegressor(),
    "Forest CatBoost Regressor": ForestCatRegressor(),
    "Forest Gradient Boosting Regressor": ForestGradientRegressor(),
    "Forest AdaBoost Regressor": ForestAdaRegressor(),
    "Forest LightGBM Regressor": ForestLightRegressor(),
}
...
ax.set_title('Comparison of Forest Model Regression Performance', fontsize=18, fontweight='bold')
