...
class Edge(BaseModel, ABC):
    ...
    file_id: str | None = Field(default=None, description='file identifier for this edge')
...
class EntityEdge(Edge):
    ...
    file_id: str | None = Field(
        default=None, description='file identifier for this edge'
    )
    ...
    async def save(self, driver: GraphDriver):
        edge_data: dict[str, Any] = {
            ...
            'file_id': self.file_id,  # 添加 file_id 字段
