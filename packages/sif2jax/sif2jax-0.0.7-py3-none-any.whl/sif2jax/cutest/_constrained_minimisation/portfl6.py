...
_data_file = Path(__file__).parent / "data" / "portfl6_data.npz"
...
class PORTFL6(AbstractConstrainedMinimisation):
    """Portfolio optimization problem PORTFL6.
    ...
    def expected_objective_value(self):
        # From SIF file: *LO SOLTN 2.57917996D-2
        return jnp.array(2.57917996e-2)
