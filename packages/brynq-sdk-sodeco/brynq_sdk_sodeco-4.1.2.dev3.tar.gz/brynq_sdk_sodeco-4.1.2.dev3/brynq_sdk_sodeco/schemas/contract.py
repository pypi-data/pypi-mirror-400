...
class ClsDimona(BaseModel):
    ...
    planned_hours_nbr: Optional[pd.Int64Dtype] = Field(None, alias="PlannedHoursNbr", description="Planned hours number", example=40, ge=0, le=999)
    ...
    exceeding_hours_nbr: Optional[pd.Int64Dtype] = Field(None, alias="ExceedingHoursNbr", description="Exceeding hours number", example=5, ge=0, le=999)
