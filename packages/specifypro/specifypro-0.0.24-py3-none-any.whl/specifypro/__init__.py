...
def version_callback(value: bool):
    ...
    if value:
        ...
        console.print(f"SpecifyPro CLI v{pkg_version}")
        raise typer.Exit()
...
def init(
    ...
    steps_lines.append("   2.4 [cyan]/spp.tasks[/] - Generate actionable tasks")
    ...
    enhancement_lines = [
        ...
        f"○ [cyan]/spp.readme[/] [bright_black](optional)[/bright_black] - Create professional and attractive README.md files with project documentation, setup instructions, and usage guides (after [cyan]/spp.plan[/] or [cyan]/spp.implement[/])"
    ]
