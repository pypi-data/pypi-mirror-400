...
from ...paperlogic_certvalidator.authority import (
    Authority,
    AuthorityWithCert,
    TrustAnchor,
)
...
from ...paperlogic_certvalidator.policy_decl import (
    CertRevTrustPolicy,
...
async def verify_ocsp_response(
    ...
    :param validation_context:
        A paperlogic_certvalidator.context.ValidationContext object to use for
    ...
    :raises:
        paperlogic_certvalidator.errors.OCSPNoMatchesError - when none of the OCSP responses match the certificate
        paperlogic_certvalidator.errors.OCSPValidationIndeterminateError - when the OCSP response could not be verified
        paperlogic_certvalidator.errors.RevokedError - when the OCSP response indicates the certificate has been revoked
    """
