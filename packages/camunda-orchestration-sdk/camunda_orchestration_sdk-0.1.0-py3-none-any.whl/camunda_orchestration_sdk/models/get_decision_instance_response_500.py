...
T = TypeVar("T", bound="GetDecisionInstanceResponse500")


@_attrs_define
class GetDecisionInstanceResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_decision_instance_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_decision_instance_response_500.additional_properties = d
        return get_decision_instance_response_500
