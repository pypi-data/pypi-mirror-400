...
class WarmPoolSpecTemplateSpecContainersInnerVolumeMountsInner(BaseModel):
    ...
    mount_propagation: Optional[StrictStr] = Field(default=None, alias="mountPropagation")
    name: StrictStr
    read_only: Optional[StrictBool] = Field(default=None, alias="readOnly")
    recursive_read_only: Optional[StrictStr] = Field(default=None, alias="recursiveReadOnly")
    sub_path: Optional[StrictStr] = Field(default=None, alias="subPath")
    sub_path_expr: Optional[StrictStr] = Field(default=None, alias="subPathExpr")
