...
class TestAnsibleCollectionVersionMarkResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AnsibleCollectionVersionMarkResponse:
        """Test AnsibleCollectionVersionMarkResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnsibleCollectionVersionMarkResponse`
        """
        model = AnsibleCollectionVersionMarkResponse()
        if include_optional:
