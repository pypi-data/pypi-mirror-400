...
### v0.0.6
- ✅ **NUEVO**: Generación de imágenes con `client.image.generate(prompt=...)`
- ✅ **NUEVO**: Análisis de imágenes con `client.vision.analisis(prompt=..., image=...)`
- ✅ **NUEVO**: Soporte para archivos de imagen (rutas y file-like objects)
