...
from .services.dispatch import prune_all_buckets
...
def build_server(
    *,
    ...
    resolved_config = config or resolve_server_config(
        ...
        dispatch_prune_enabled=dispatch_prune_enabled,
        dispatch_prune_on_job_finish=dispatch_prune_on_job_finish,
        dispatch_prune_on_startup=dispatch_prune_on_startup,
        dispatch_retain_max_jobs_per_bucket=dispatch_retain_max_jobs_per_bucket,
        dispatch_retain_max_age_days=dispatch_retain_max_age_days,
        dispatch_retain_keep_failed=dispatch_retain_keep_failed,
        dispatch_prune_dry_run=dispatch_prune_dry_run,
        dispatch_prune_verbose=dispatch_prune_verbose,
    ...
    if resolved_config.dispatch.prune.enabled and resolved_config.dispatch.prune.prune_on_startup:
        prune_all_buckets(resolved_config.dispatch.base_dir, prune_settings=resolved_config.dispatch.prune)
    ...
    register_core_tools(
        ...
        dispatch_prune_settings=resolved_config.dispatch.prune,
    ...
    register_dispatch_tools(
        ...
        dispatch_enabled_default=resolved_config.dispatch.enabled,
        prune_settings=resolved_config.dispatch.prune,
    ...
    register_project_tools(
        ...
        prune_settings=resolved_config.dispatch.prune,
        memory_enabled_default=resolved_config.memory.enabled,
        memory_global_scope=resolved_config.memory.global_scope,
        resolved_memory_path=resolved_config.memory.path,
        memory_max_items=resolved_config.memory.max_items,
        memory_max_bytes=resolved_config.memory.max_bytes,
        get_verbosity=get_verbosity,
