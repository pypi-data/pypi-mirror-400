...
T = TypeVar("T", bound="MagentrixIntegration")


@_attrs_define
class MagentrixIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        magentrix_integration.additional_properties = d
        return magentrix_integration
