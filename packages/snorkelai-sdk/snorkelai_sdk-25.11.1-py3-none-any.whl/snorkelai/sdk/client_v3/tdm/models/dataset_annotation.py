...
if TYPE_CHECKING:
    # fmt: off
    from ..models.dataset_annotation_metadata import (
        DatasetAnnotationMetadata,  # noqa: F401
    )
...
T = TypeVar("T", bound="DatasetAnnotation")
...
class DatasetAnnotation:
    ...
    Attributes:
        ...
        metadata (Union[Unset, DatasetAnnotationMetadata]):
    ...
    metadata: Union[Unset, "DatasetAnnotationMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = DatasetAnnotationMetadata.from_dict(_metadata)
