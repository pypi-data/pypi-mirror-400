...
from arp_standard_model import NodeRunEvaluationReportRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/node-runs/{node_run_id}:evaluation".format(node_run_id=quote(str(node_run_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Report evaluation for a NodeRun
