...
T = TypeVar("T", bound="CompleteUserTaskResponse503")


@_attrs_define
class CompleteUserTaskResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        complete_user_task_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        complete_user_task_response_503.additional_properties = d
        return complete_user_task_response_503
