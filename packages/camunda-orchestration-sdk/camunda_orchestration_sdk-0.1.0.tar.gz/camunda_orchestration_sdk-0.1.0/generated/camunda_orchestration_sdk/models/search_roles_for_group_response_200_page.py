...
T = TypeVar("T", bound="SearchRolesForGroupResponse200Page")


@_attrs_define
class SearchRolesForGroupResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_roles_for_group_response_200_page = cls(
        ...
        search_roles_for_group_response_200_page.additional_properties = d
        return search_roles_for_group_response_200_page
