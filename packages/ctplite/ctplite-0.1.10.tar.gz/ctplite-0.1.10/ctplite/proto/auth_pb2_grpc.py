...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RefreshToken = channel.unary_unary(
                '/ctplite.AuthService/RefreshToken',
                ...
                _registered_method=True)
        self.QueryLoginStatus = channel.unary_unary(
                '/ctplite.AuthService/QueryLoginStatus',
                request_serializer=auth__pb2.QueryLoginStatusRequest.SerializeToString,
                response_deserializer=auth__pb2.QueryLoginStatusResponse.FromString,
                _registered_method=True)
...
class AuthServiceServicer(object):
    ...
    def QueryLoginStatus(self, request, context):
        """查询登录状态
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'QueryLoginStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.QueryLoginStatus,
                    request_deserializer=auth__pb2.QueryLoginStatusRequest.FromString,
                    response_serializer=auth__pb2.QueryLoginStatusResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'ctplite.AuthService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('ctplite.AuthService', rpc_method_handlers)
...
class AuthService(object):
    ...
    def QueryLoginStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/ctplite.AuthService/QueryLoginStatus',
            auth__pb2.QueryLoginStatusRequest.SerializeToString,
            auth__pb2.QueryLoginStatusResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
