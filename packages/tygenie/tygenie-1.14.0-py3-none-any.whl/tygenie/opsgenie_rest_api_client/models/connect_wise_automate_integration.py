...
T = TypeVar("T", bound="ConnectWiseAutomateIntegration")


@_attrs_define
class ConnectWiseAutomateIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        connect_wise_automate_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        connect_wise_automate_integration.additional_properties = d
        return connect_wise_automate_integration
