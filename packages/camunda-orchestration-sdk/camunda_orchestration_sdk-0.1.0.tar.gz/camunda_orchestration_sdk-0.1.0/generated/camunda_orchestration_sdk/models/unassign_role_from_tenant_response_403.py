...
T = TypeVar("T", bound="UnassignRoleFromTenantResponse403")


@_attrs_define
class UnassignRoleFromTenantResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unassign_role_from_tenant_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        unassign_role_from_tenant_response_403.additional_properties = d
        return unassign_role_from_tenant_response_403
