...
*ConfigApi* | [**haplohub_api_v1_config_config**](docs/ConfigApi.md#haplohub_api_v1_config_config) | **GET** /api/v1/config/ | Config
...
*UserApi* | [**haplohub_api_v1_user_check_slug**](docs/UserApi.md#haplohub_api_v1_user_check_slug) | **POST** /api/v1/user/check-slug/ | Check Slug
*UserApi* | [**haplohub_api_v1_user_get_user**](docs/UserApi.md#haplohub_api_v1_user_get_user) | **GET** /api/v1/user/ | Get User
*UserApi* | [**haplohub_api_v1_user_init_user**](docs/UserApi.md#haplohub_api_v1_user_init_user) | **POST** /api/v1/user/init/ | Init User
...
## Documentation For Models
 ...
 - [CheckSlugRequest](docs/CheckSlugRequest.md)
 - [CliSchema](docs/CliSchema.md)
 ...
 - [InitUserRequest](docs/InitUserRequest.md)
 ...
 - [ResultResponseBool](docs/ResultResponseBool.md)
 - [ResultResponseConfigSchema](docs/ResultResponseConfigSchema.md)
 ...
 - [ResultResponseUnionUserSchemaNoneType](docs/ResultResponseUnionUserSchemaNoneType.md)
