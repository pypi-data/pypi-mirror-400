...
T = TypeVar("T", bound="HipChatIntegrationV2")


@_attrs_define
class HipChatIntegrationV2:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        hip_chat_integration_v2.additional_properties = d
        return hip_chat_integration_v2
