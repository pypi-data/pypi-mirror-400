...
T = TypeVar("T", bound="ResolveIncidentResponse503")


@_attrs_define
class ResolveIncidentResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resolve_incident_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        resolve_incident_response_503.additional_properties = d
        return resolve_incident_response_503
