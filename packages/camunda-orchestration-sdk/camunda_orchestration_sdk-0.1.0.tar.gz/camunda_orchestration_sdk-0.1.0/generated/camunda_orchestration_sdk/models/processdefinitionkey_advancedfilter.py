...
T = TypeVar("T", bound="ProcessdefinitionkeyAdvancedfilter")


@_attrs_define
class ProcessdefinitionkeyAdvancedfilter:
    """Advanced ProcessDefinitionKey filter.

    Attributes:
        eq (str | Unset): Checks for equality with the provided value. Example: 2251799813686749.
        neq (str | Unset): Checks for inequality with the provided value. Example: 2251799813686749.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        processdefinitionkey_advancedfilter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        processdefinitionkey_advancedfilter.additional_properties = d
        return processdefinitionkey_advancedfilter
