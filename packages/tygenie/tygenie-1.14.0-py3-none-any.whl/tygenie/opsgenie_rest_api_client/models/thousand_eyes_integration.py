...
T = TypeVar("T", bound="ThousandEyesIntegration")
...
class ThousandEyesIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        thousand_eyes_integration.additional_properties = d
        return thousand_eyes_integration
