...
from ...models.remove_tags_identifier_type import RemoveTagsIdentifierType
...
def _get_kwargs(
    ...
    *,
    identifier_type: Union[
        Unset, RemoveTagsIdentifierType
    ] = RemoveTagsIdentifierType.ID,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        identifier (str):
        identifier_type (Union[Unset, RemoveTagsIdentifierType]):  Default:
            RemoveTagsIdentifierType.ID.
