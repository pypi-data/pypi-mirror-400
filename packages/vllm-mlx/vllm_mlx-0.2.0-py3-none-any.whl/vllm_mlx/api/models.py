...
class ContentPart(BaseModel):
    ...
    - audio_url: Audio from URL or file path
    """
...
class AudioSpeechRequest(BaseModel):
    """Request for speech generation (TTS)."""
    model: str = "kokoro"
    input: str
    voice: str = "af_heart"
    speed: float = 1.0
    response_format: str = "wav"  # "wav", "mp3", "opus"


class AudioSeparationRequest(BaseModel):
    """Request for audio separation (SAM-Audio)."""
    model: str = "sam-audio-large"
