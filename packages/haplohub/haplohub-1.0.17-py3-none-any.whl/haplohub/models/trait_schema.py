...
class TraitSchema(BaseModel):
    ...
    ontology_url: StrictStr = Field(...)
    __properties = ["id", "label", "category_id", "ontology_url"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TraitSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TraitSchema:
        """Create an instance of TraitSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TraitSchema.parse_obj(obj)

        _obj = TraitSchema.parse_obj(
            {
                "id": obj.get("id"),
                "label": obj.get("label"),
                "category_id": obj.get("category_id"),
                "ontology_url": obj.get("ontology_url"),
            }
        )
        return _obj
