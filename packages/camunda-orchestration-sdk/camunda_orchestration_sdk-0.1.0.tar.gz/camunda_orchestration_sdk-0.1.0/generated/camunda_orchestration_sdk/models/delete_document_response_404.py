...
T = TypeVar("T", bound="DeleteDocumentResponse404")


@_attrs_define
class DeleteDocumentResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_document_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_document_response_404.additional_properties = d
        return delete_document_response_404
