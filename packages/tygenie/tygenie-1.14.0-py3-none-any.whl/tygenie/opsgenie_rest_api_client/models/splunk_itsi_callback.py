...
T = TypeVar("T", bound="SplunkITSICallback")


@_attrs_define
class SplunkITSICallback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        splunk_itsi_callback.additional_properties = d
        return splunk_itsi_callback
