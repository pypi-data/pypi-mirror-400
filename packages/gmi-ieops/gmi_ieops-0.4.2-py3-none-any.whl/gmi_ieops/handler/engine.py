...
class Engine:
    ...
    def __init__(
        ...
        Args:
            ...
            filter_headers: Set of header names (lowercase) to filter when proxying.
                           Defaults to DEFAULT_FILTER_HEADERS from interceptor.
                           Set to empty set to forward all headers.
        """
