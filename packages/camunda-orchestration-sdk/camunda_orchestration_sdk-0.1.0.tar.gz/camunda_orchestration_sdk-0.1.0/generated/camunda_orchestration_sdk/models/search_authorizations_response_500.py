...
T = TypeVar("T", bound="SearchAuthorizationsResponse500")


@_attrs_define
class SearchAuthorizationsResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_authorizations_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_authorizations_response_500.additional_properties = d
        return search_authorizations_response_500
