...
if TYPE_CHECKING:
    # fmt: off
    from ..models.list_integrations_params_kwargs import (
        ListIntegrationsParamsKwargs,  # noqa: F401
    )
    # fmt: on


T = TypeVar("T", bound="ListIntegrationsParams")


@attrs.define
class ListIntegrationsParams:
    """
    Attributes:
        kwargs (Union[Unset, ListIntegrationsParamsKwargs]):
        secret_store (Union[Unset, str]):  Default: 'local_store'.
        workspace_uid (Union[Unset, int]):  Default: 1.
    """

    kwargs: Union[Unset, "ListIntegrationsParamsKwargs"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_kwargs, Unset):
            ...
            kwargs = ListIntegrationsParamsKwargs.from_dict(_kwargs)
