...
from layerlearn.baseLinear import LinearForestRegressor, LinearSupportRegressor, LinearDecisionRegressor, LinearKNNRegressor, LinearXGBRegressor, LinearCatRegressor, LinearGradientRegressor, LinearAdaRegressor, LinearLightRegressor
import warnings
...
models = {
    "Linear Forest Regressor": LinearForestRegressor(),
    "Linear Support Regressor": LinearSupportRegressor(),
    "Linear Decision Regressor": LinearDecisionRegressor(),
    "Linear KNN Regressor": LinearKNNRegressor(),
    "Linear XGBoost Regressor": LinearXGBRegressor(),
    "Linear CatBoost Regressor": LinearCatRegressor(),
    "Linear Gradient Boosting Regressor": LinearGradientRegressor(),
    "Linear AdaBoost Regressor": LinearAdaRegressor(),
    "Linear LightGBM Regressor": LinearLightRegressor(),
}
...
ax.set_title('Comparison of Linear Model Regression Performance', fontsize=18, fontweight='bold')
