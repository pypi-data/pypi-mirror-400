"""
Relationship indicating fuel or energy supply chains for generation assets.
...
class SuppliedByRelationship(GridSTIXRelationshipObject):
    """
    Relationship indicating fuel or energy supply chains for generation assets.
    ...
    _type = "x-grid-supplied-by-relationship"
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize SuppliedByRelationship with Grid-STIX properties."""
