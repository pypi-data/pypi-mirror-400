...
T = TypeVar("T", bound="GetProcessDefinitionInstanceVersionStatisticsResponse403")


@_attrs_define
class GetProcessDefinitionInstanceVersionStatisticsResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_process_definition_instance_version_statistics_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_process_definition_instance_version_statistics_response_403.additional_properties = d
        return get_process_definition_instance_version_statistics_response_403
