...
T = TypeVar("T", bound="AssignUserToGroupResponse400")


@_attrs_define
class AssignUserToGroupResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assign_user_to_group_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        assign_user_to_group_response_400.additional_properties = d
        return assign_user_to_group_response_400
