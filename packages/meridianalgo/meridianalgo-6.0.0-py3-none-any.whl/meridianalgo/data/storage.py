...
class ParquetStorage:
    ...
    def store_data(self, data: pd.DataFrame, symbol: str, data_type: str = 'ohlcv',
...
class RedisCache:
    ...
    def _generate_key(self, symbol: str, data_type: str, start_date: Optional[datetime] = None,
                     end_date: Optional[datetime] = None, **kwargs) -> str:
    ...
    def get(self, symbol: str, data_type: str, start_date: Optional[datetime] = None,
            end_date: Optional[datetime] = None, **kwargs) -> Optional[pd.DataFrame]:
        """Get data from cache."""
    ...
    def set(self, data: pd.DataFrame, symbol: str, data_type: str,
        ...
        try:
            ...
            if len(serialized_data) > 100 * 1024 * 1024:  # 100MB limit
                logger.warning(f"Data too large for cache: {len(serialized_data)} bytes")
                return False
    ...
    def delete(self, symbol: str, data_type: str, start_date: Optional[datetime] = None,
               end_date: Optional[datetime] = None, **kwargs) -> bool:
...
class DataStorageManager:
    ...
    def __init__(self, parquet_path: str = "data/parquet",
        ...
        logger.info(f"Data storage manager initialized (cache: {'enabled' if self.enable_cache else 'disabled'})")
    ...
    def store_data_response(self, response: DataResponse) -> str:
        ...
        # Store in Parquet
        storage_path = self.parquet_storage.store_data(
            response.data, symbol, data_type
        )
    ...
    def load_data(self, request: DataRequest, use_cache: bool = True) -> Optional[DataResponse]:
        """
