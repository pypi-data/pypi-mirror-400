...
T = TypeVar("T", bound="UnassignRoleFromTenantResponse503")


@_attrs_define
class UnassignRoleFromTenantResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unassign_role_from_tenant_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        unassign_role_from_tenant_response_503.additional_properties = d
        return unassign_role_from_tenant_response_503
