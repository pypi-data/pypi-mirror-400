...
T = TypeVar("T", bound="GetVariableResponse404")


@_attrs_define
class GetVariableResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_variable_response_404.additional_properties = d
        return get_variable_response_404
