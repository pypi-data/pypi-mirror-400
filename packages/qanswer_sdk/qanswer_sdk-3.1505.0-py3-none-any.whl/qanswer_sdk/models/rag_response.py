...
class RAGResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["conversation_id", "message_id", "ai_response", "sources", "finish_reason", "is_regenerate", "aggs", "filters", "is_input_data_cropped", "mode", "prompt_used", "prompt_type"]
