...
licenses = {
    ...
    'gpl3': ('GNU General Public License v3 (GPLv3)', 'OSI Approved :: GNU General Public License v3 (GPLv3)'),
}
...
setuptools.setup(
    ...
    data_files=[
        ("share/jupyter/nbextensions", [ "static/nbmeta.js", ]),
        ("etc/jupyter/nbconfig/notebook.d", [ "jupyter-config/nbmeta.json" ])
    ],
    ...
    entry_points = {
        ...
        'ipython': [ 'ai_magic=aimagic.core:load_ipython_extension' ]
