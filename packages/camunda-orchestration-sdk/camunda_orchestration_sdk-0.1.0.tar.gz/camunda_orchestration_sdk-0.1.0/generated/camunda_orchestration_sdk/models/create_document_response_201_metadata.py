...
if TYPE_CHECKING:
    from ..models.create_document_response_201_metadata_custom_properties import (
        CreateDocumentResponse201MetadataCustomProperties,
    )


T = TypeVar("T", bound="CreateDocumentResponse201Metadata")


@_attrs_define
class CreateDocumentResponse201Metadata:
    ...
    Attributes:
        ...
        process_instance_key (str | Unset): The key of the process instance that created the document. Example:
            2251799813690746.
        custom_properties (CreateDocumentResponse201MetadataCustomProperties | Unset): Custom properties of the
            document.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_properties, Unset):
            ...
            custom_properties = (
                CreateDocumentResponse201MetadataCustomProperties.from_dict(
                    _custom_properties
                )
            )

        create_document_response_201_metadata = cls(
        ...
        create_document_response_201_metadata.additional_properties = d
        return create_document_response_201_metadata
