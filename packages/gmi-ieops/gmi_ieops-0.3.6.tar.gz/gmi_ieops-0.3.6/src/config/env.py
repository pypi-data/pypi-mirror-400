...
def _get_certifi_ca_bundle() -> str:
    """Get CA bundle path from certifi package"""
    try:
        import certifi
...
def get_ca_bundle() -> str:
    """
    Get CA bundle path with fallback chain:
    1. SSL_CERT_FILE environment variable
    2. REQUESTS_CA_BUNDLE environment variable  
    3. certifi package (if installed)
    4. Empty string (system default)
    """
...
class Env:
    ...
    def get_ca_bundle(self) -> str:
        """Get CA bundle path (convenience method)"""
