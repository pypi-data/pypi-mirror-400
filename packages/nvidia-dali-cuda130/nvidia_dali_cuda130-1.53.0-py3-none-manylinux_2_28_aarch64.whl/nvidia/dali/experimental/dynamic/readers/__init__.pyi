...
class COCO:
    ...
    * **image_ids** (Optional, present if argument `image_ids` is set to True)
    ...
    def __init__(
        ...
        device: Union[Device, Literal["cpu"]] = "cpu",
        num_inputs: Optional[int] = None,
        *,
        annotations_file: Optional[str] = "",
        avoid_class_remapping: Optional[builtins.bool] = False,
        dont_use_mmap: Optional[builtins.bool] = False,
        file_root: Optional[str] = None,
        image_ids: Optional[builtins.bool] = False,
        images: Union[Sequence[str], str, None] = None,
        include_iscrowd: Optional[builtins.bool] = True,
        initial_fill: Optional[int] = 1024,
        lazy_init: Optional[builtins.bool] = False,
        ltrb: Optional[builtins.bool] = False,
        num_shards: Optional[int] = 1,
        pad_last_batch: Optional[builtins.bool] = False,
        pixelwise_masks: Optional[builtins.bool] = False,
        polygon_masks: Optional[builtins.bool] = False,
        prefetch_queue_depth: Optional[int] = 1,
        preprocessed_annotations: Optional[str] = "",
        random_shuffle: Optional[builtins.bool] = False,
        ratio: Optional[builtins.bool] = False,
        read_ahead: Optional[builtins.bool] = False,
        save_preprocessed_annotations: Optional[builtins.bool] = False,
        save_preprocessed_annotations_dir: Optional[str] = "",
        seed: Optional[int] = -1,
        shard_id: Optional[int] = 0,
        shuffle_after_epoch: Optional[builtins.bool] = False,
        size_threshold: Optional[float] = 0.1,
        skip_cached_images: Optional[builtins.bool] = False,
        skip_empty: Optional[builtins.bool] = False,
        stick_to_shard: Optional[builtins.bool] = False,
        tensor_init_bytes: Optional[int] = 1048576,
    ) -> None: ...
    @overload
    def __call__(self, /) -> Tensor: ...
    @overload
    def __call__(self, /, *, batch_size: int) -> Batch: ...
    @overload
    def next_epoch(
        self,
...
class Caffe:
    ...
    def __init__(
        ...
        *,
        dont_use_mmap: Optional[builtins.bool] = False,
        image_available: Optional[builtins.bool] = True,
        initial_fill: Optional[int] = 1024,
        label_available: Optional[builtins.bool] = True,
        lazy_init: Optional[builtins.bool] = False,
        num_shards: Optional[int] = 1,
        pad_last_batch: Optional[builtins.bool] = False,
...
class Caffe2:
    ...
    def __init__(
        ...
        *,
        ...
        bbox: Optional[builtins.bool] = False,
        dont_use_mmap: Optional[builtins.bool] = False,
        image_available: Optional[builtins.bool] = True,
        initial_fill: Optional[int] = 1024,
...
class File:
    ...
    def __init__(
        ...
        num_inputs: Optional[int] = None,
        *,
        case_sensitive_filter: Optional[builtins.bool] = False,
...
class NemoAsr:
    ...
    def __init__(
        ...
        *,
        dont_use_mmap: Optional[builtins.bool] = False,
        downmix: Optional[builtins.bool] = True,
        dtype: Union[DALIDataType, DType, None] = DALIDataType.FLOAT,
        initial_fill: Optional[int] = 1024,
        lazy_init: Optional[builtins.bool] = False,
        ...
        random_shuffle: Optional[builtins.bool] = False,
        read_ahead: Optional[builtins.bool] = False,
        read_idxs: Optional[builtins.bool] = False,
        read_sample_rate: Optional[builtins.bool] = True,
        read_text: Optional[builtins.bool] = True,
...
class Numpy:
    ...
    register_buffers : bool, optional, default = `True`
        ...
        sizes vary a lot.
    rel_roi_end : float or list of float or Tensor/Batch of float, optional
    ...
    rel_roi_shape : float or list of float or Tensor/Batch of float, optional
    ...
    rel_roi_start : float or list of float or Tensor/Batch of float, optional
    ...
    roi_end : int or list of int or Tensor/Batch of int, optional
    ...
    roi_shape : int or list of int or Tensor/Batch of int, optional
    ...
    roi_start : int or list of int or Tensor/Batch of int, optional
    ...
    def __init__(
        ...
        max_batch_size: Optional[int] = None,
        name: Optional[str] = None,
        device: Union[Device, Literal["cpu", "gpu"]] = "cpu",
        num_inputs: Optional[int] = None,
        *,
        cache_header_information: Optional[builtins.bool] = False,
        dont_use_mmap: Optional[builtins.bool] = False,
        ...
        random_shuffle: Optional[builtins.bool] = False,
        read_ahead: Optional[builtins.bool] = False,
        register_buffers: Optional[builtins.bool] = True,
    ...
    def __call__(
        ...
        /,
        *,
        rel_roi_end: Union[TensorLikeArg, Batch, Sequence[float], float, None] = None,
        rel_roi_shape: Union[TensorLikeArg, Batch, Sequence[float], float, None] = None,
        rel_roi_start: Union[TensorLikeArg, Batch, Sequence[float], float, None] = None,
        roi_end: Union[TensorLikeArg, Batch, Sequence[int], int, None] = None,
        roi_shape: Union[TensorLikeArg, Batch, Sequence[int], int, None] = None,
        roi_start: Union[TensorLikeArg, Batch, Sequence[int], int, None] = None,
    ) -> Tensor: ...
    @overload
    def __call__(
        self,
...
class TFRecord:
    ...
    tensor_init_bytes : int, optional, default = `1048576`
        Hint for how much memory to allocate per image.
    use_o_direct : bool, optional, default = `False`
        If set to True, the data will be read directly from the storage bypassing the system
        cache.
...
class Video:
    ...
    def __init__(
        ...
        max_batch_size: Optional[int] = None,
        name: Optional[str] = None,
        device: Union[Device, Literal["gpu"]] = "cpu",
        num_inputs: Optional[int] = None,
        *,
        ...
        enable_frame_num: Optional[builtins.bool] = False,
        enable_timestamps: Optional[builtins.bool] = False,
        file_list: Optional[str] = "",
        file_list_frame_num: Optional[builtins.bool] = False,
        file_list_include_preceding_frame: Optional[builtins.bool] = False,
        ...
        labels: Union[Sequence[int], int, None] = None,
        lazy_init: Optional[builtins.bool] = False,
        normalized: Optional[builtins.bool] = False,
        num_shards: Optional[int] = 1,
        pad_last_batch: Optional[builtins.bool] = False,
        pad_sequences: Optional[builtins.bool] = False,
        prefetch_queue_depth: Optional[int] = 1,
        random_shuffle: Optional[builtins.bool] = False,
        read_ahead: Optional[builtins.bool] = False,
        seed: Optional[int] = -1,
        ...
        shard_id: Optional[int] = 0,
        skip_cached_images: Optional[builtins.bool] = False,
        skip_vfr_check: Optional[builtins.bool] = False,
        step: Optional[int] = -1,
        stick_to_shard: Optional[builtins.bool] = False,
        stride: Optional[int] = 1,
        tensor_init_bytes: Optional[int] = 1048576,
...
class VideoResize:
    ...
    def __call__(
        ...
        *,
        interp_type: Union[
            TensorLikeArg, Batch, DALIInterpType, None
...
class Webdataset:
    ...
    def __init__(
        ...
        num_inputs: Optional[int] = None,
        *,
        case_sensitive_extensions: Optional[builtins.bool] = True,
        dont_use_mmap: Optional[builtins.bool] = False,
        dtypes: Union[Sequence[Union[DALIDataType, DType]], DALIDataType, DType, None] = None,
