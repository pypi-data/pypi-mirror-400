...
T = TypeVar("T", bound="DynatraceAppMonCallback")


@_attrs_define
class DynatraceAppMonCallback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        dynatrace_app_mon_callback = cls(
        ...
        dynatrace_app_mon_callback.additional_properties = d
        return dynatrace_app_mon_callback
