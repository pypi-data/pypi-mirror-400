...
T = TypeVar("T", bound="SearchUsersForGroupResponse404")


@_attrs_define
class SearchUsersForGroupResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_users_for_group_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_users_for_group_response_404.additional_properties = d
        return search_users_for_group_response_404
