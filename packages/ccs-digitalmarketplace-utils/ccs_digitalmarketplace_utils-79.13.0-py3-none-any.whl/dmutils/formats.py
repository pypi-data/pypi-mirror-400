...
def shortdateformat(value, default_value=None):
    ...
    ** USE OUR STANDARD dateformat RATHER THAN THIS UNLESS THERE IS A GOOD REASON NOT TO **
    """
    return _format_date(value, default_value, DISPLAY_SHORT_DATE_FORMAT, localize=True)
...
def nodaydateformat(value, default_value=None):
    ...
    """
    return _format_date(value, default_value, DISPLAY_NO_DAY_DATE_FORMAT, localize=True)
...
def dateformat(value, default_value=None):
    ...
    """
    return _format_date(value, default_value, DISPLAY_DATE_FORMAT, localize=True)
...
def monthyearformat(value, default_value=None):
    ...
    """
    return _format_date(value, default_value, DISPLAY_MONTH_YEAR_FORMAT, localize=True)
