...
class VIBRBEAMNE(AbstractNonlinearEquations):
    """Vibrating beam nonlinear equations from laser-Doppler measurements.
    ...
    This is the nonlinear equations version of VIBRBEAM.
    ...
    m: int = 30  # Number of equations (measurements)
    ...
    def expected_objective_value(self):
        """Expected objective value (for least squares version)."""
