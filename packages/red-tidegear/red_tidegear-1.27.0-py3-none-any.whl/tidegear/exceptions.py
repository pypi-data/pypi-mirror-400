...
class TidegearError(Exception):
    ...
    Attributes:
        message: An error message. May be conditionally shown to end users.
            Defaults to [`default_message`][tidegear.exceptions.TidegearError.default_message] if not provided.
    ...
    def default_message(self) -> str:
        """The default message to use when no message argument is provided.

        This is a property to allow for translations.
        """
        return _("No message was provided for this exception!")
