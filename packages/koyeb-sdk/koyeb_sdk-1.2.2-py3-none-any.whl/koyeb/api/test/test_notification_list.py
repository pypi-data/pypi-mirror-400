    ...
    def make_instance(self, include_optional) -> NotificationList:
        ...
        if include_optional:
            return NotificationList(
                notifications = [
                    koyeb.api.models.notification.Notification(
                        id = '', 
                        activity = koyeb.api.models.activity.Activity(
                            id = '', 
                            actor = koyeb.api.models.object.Object(
                                id = '', 
                                name = '', 
                                type = '', 
                                metadata = koyeb.api.models.metadata.metadata(), 
                                deleted = True, ), 
                            object = koyeb.api.models.object.Object(
                                id = '', 
                                name = '', 
                                type = '', 
                                metadata = koyeb.api.models.metadata.metadata(), 
