...
T = TypeVar("T", bound="SearchGroupsForRoleResponse200Page")


@_attrs_define
class SearchGroupsForRoleResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_groups_for_role_response_200_page = cls(
        ...
        search_groups_for_role_response_200_page.additional_properties = d
        return search_groups_for_role_response_200_page
