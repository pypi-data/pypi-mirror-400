...
class RichLogger:
    ...
    def debug(self, msg: str):
        rich.print(f"[cyan][DEBUG]: {self._prefix()} {msg} [/cyan] ")

    def info(self, msg: str):
        rich.print(f"[green][INFO]: {self._prefix()} {msg} [/green]")

    def warn(self, msg: str):
        rich.print(f"[yellow][WARN]: {self._prefix()} {msg} [/yellow]")

    def error(self, msg: str, exc: Exception | None = None):
        rich.print(f"[red][ERROR]: {self._prefix()} {msg}[/red]")
        if exc:
