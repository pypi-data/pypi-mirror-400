...
T = TypeVar("T", bound="HipChatAddOnCallback")


@_attrs_define
class HipChatAddOnCallback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        hip_chat_add_on_callback.additional_properties = d
        return hip_chat_add_on_callback
