...
T = TypeVar("T", bound="MSTeamsV2Callback")


@_attrs_define
class MSTeamsV2Callback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ms_teams_v2_callback.additional_properties = d
        return ms_teams_v2_callback
