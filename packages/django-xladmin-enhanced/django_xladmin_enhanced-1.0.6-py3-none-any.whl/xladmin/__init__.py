...
from xladmin.sites import AdminSite, site
...
def autodiscover():
    ...
    from xladmin.views import register_builtin_views
    register_builtin_views(site)

    # load xladmin settings from XLADMIN_CONF module
    try:
        xladmin_conf = getattr(settings, 'XLADMIN_CONF', 'xladmin_conf.py')
        conf_mod = import_module(xladmin_conf)
    except Exception:
        conf_mod = None
    ...
    from xladmin.plugins import register_builtin_plugins
...
default_app_config = 'xladmin.apps.XAdminConfig'
