...
T = TypeVar("T", bound="SearchUserTaskAuditLogsResponse500")


@_attrs_define
class SearchUserTaskAuditLogsResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_user_task_audit_logs_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_user_task_audit_logs_response_500.additional_properties = d
        return search_user_task_audit_logs_response_500
