...
T = TypeVar("T", bound="ScopekeyAdvancedfilter")


@_attrs_define
class ScopekeyAdvancedfilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scopekey_advancedfilter.additional_properties = d
        return scopekey_advancedfilter
