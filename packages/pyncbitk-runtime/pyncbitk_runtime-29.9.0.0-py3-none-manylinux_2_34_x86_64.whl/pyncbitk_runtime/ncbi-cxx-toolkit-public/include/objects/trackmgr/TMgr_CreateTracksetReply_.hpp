...
public:
    ...
    void SetTrackset_id(TTrackset_id&& value);
...
inline
void CTMgr_CreateTracksetReply_Base::SetTrackset_id(CTMgr_CreateTracksetReply_Base::TTrackset_id&& value)
{
    m_Trackset_id = std::forward<CTMgr_CreateTracksetReply_Base::TTrackset_id>(value);
    m_set_State[0] |= 0x30;
}
