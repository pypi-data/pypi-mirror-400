...
from .shapes import Polygon, Line, Polyline, Point
...
class Labelme(object):
    ...
    def parse_info(labelme_info):
        ...
        for shape in labelme_info['shapes']:
            ...
            if shape_type == 'polygon':
            ...
            elif shape_type == 'polyline' or shape_type == 'linestrip':
                shape = Polyline(
                    points=shape['points'],
                    class_name=shape['label'],
                    **temp_shape
                ...
                raise NotImplementedError("Shape type {} is not supported".format(shape_type))
            shapes.append(shape)
