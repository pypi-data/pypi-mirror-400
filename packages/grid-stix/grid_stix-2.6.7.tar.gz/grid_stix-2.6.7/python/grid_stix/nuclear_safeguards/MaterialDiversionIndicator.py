"""
Indicator pattern suggesting potential diversion or misuse of nuclear material.
...
class MaterialDiversionIndicator(GridSTIXDomainObject):
    """
    Indicator pattern suggesting potential diversion or misuse of nuclear material.
    ...
    _properties = OrderedDict(
        [
            ...
            ("x_detection_confidence", ListProperty(FloatProperty())),
        ]
    )

    def __init__(self, **kwargs: Any) -> None:
        """Initialize MaterialDiversionIndicator with Grid-STIX properties."""
