...
from ..models.search_user_task_audit_logs_response_200_items_item_actor_type import (
    SearchUserTaskAuditLogsResponse200ItemsItemActorType,
)
from ..models.search_user_task_audit_logs_response_200_items_item_batch_operation_type import (
    SearchUserTaskAuditLogsResponse200ItemsItemBatchOperationType,
)
from ..models.search_user_task_audit_logs_response_200_items_item_category import (
    SearchUserTaskAuditLogsResponse200ItemsItemCategory,
)
from ..models.search_user_task_audit_logs_response_200_items_item_entity_type import (
    SearchUserTaskAuditLogsResponse200ItemsItemEntityType,
)
from ..models.search_user_task_audit_logs_response_200_items_item_operation_type import (
    SearchUserTaskAuditLogsResponse200ItemsItemOperationType,
)
from ..models.search_user_task_audit_logs_response_200_items_item_result import (
    SearchUserTaskAuditLogsResponse200ItemsItemResult,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SearchUserTaskAuditLogsResponse200ItemsItem")


@_attrs_define
class SearchUserTaskAuditLogsResponse200ItemsItem:
    """Audit log item.
    ...
    Attributes:
        ...
        batch_operation_type (SearchUserTaskAuditLogsResponse200ItemsItemBatchOperationType | Unset): The type of batch
            operation performed, if this is part of a batch.
        ...
        actor_type (SearchUserTaskAuditLogsResponse200ItemsItemActorType | Unset): The type of actor who performed the
            operation.
        tenant_id (str | Unset): The tenant ID of the audit log. Example: customer-service.
        result (SearchUserTaskAuditLogsResponse200ItemsItemResult | Unset): The result status of the operation.
        annotation (str | Unset): Additional notes about the operation.
        category (SearchUserTaskAuditLogsResponse200ItemsItemCategory | Unset): The category of the audit log operation.
    ...
    batch_operation_type: (
        SearchUserTaskAuditLogsResponse200ItemsItemBatchOperationType | Unset
    ) = UNSET
    timestamp: datetime.datetime | Unset = UNSET
    actor_id: str | Unset = UNSET
    actor_type: SearchUserTaskAuditLogsResponse200ItemsItemActorType | Unset = UNSET
    tenant_id: TenantId | Unset = UNSET
    result: SearchUserTaskAuditLogsResponse200ItemsItemResult | Unset = UNSET
    annotation: str | Unset = UNSET
    category: SearchUserTaskAuditLogsResponse200ItemsItemCategory | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_entity_type, Unset):
            ...
            entity_type = SearchUserTaskAuditLogsResponse200ItemsItemEntityType(
                _entity_type
            )
        ...
        if isinstance(_operation_type, Unset):
            ...
            operation_type = SearchUserTaskAuditLogsResponse200ItemsItemOperationType(
                _operation_type
            )
        ...
        actor_type: SearchUserTaskAuditLogsResponse200ItemsItemActorType | Unset
        if isinstance(_actor_type, Unset):
            actor_type = UNSET
        else:
            actor_type = SearchUserTaskAuditLogsResponse200ItemsItemActorType(
                _actor_type
            )
        ...
        result: SearchUserTaskAuditLogsResponse200ItemsItemResult | Unset
        if isinstance(_result, Unset):
            result = UNSET
        else:
            result = SearchUserTaskAuditLogsResponse200ItemsItemResult(_result)

        annotation = d.pop("annotation", UNSET)

        _category = d.pop("category", UNSET)
        category: SearchUserTaskAuditLogsResponse200ItemsItemCategory | Unset
        if isinstance(_category, Unset):
            category = UNSET
        else:
            category = SearchUserTaskAuditLogsResponse200ItemsItemCategory(_category)
        ...
        search_user_task_audit_logs_response_200_items_item = cls(
        ...
        search_user_task_audit_logs_response_200_items_item.additional_properties = d
        return search_user_task_audit_logs_response_200_items_item
