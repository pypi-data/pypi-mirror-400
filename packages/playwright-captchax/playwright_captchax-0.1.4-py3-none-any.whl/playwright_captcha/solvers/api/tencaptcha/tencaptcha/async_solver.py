...
class AsyncTenCaptcha():
    ...
    async def normal(self, file, **kwargs):
        ...
        file : str
            ...
            - URL to the image
        phrase : int, optional
            0 - captcha contains one word (default)
            1 - captcha contains two or more words
        regsense : int, optional
            0 - captcha is not case sensitive (default)
        ...
        module : str, optional
            ...
            Options: common-1, common-2, common-3, collection-1, etc.
        softId : int, optional
            ID of software developer.
        callback : str, optional
            URL for pingback (callback) response.
        '''
