...
class SearchMessageSubscriptionsResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_message_subscriptions_response_200 = cls(
            page=page,
            items=items,
        )

        search_message_subscriptions_response_200.additional_properties = d
        return search_message_subscriptions_response_200
