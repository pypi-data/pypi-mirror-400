...
_data_file = Path(__file__).parent / "data" / "portfl2_data.npz"
...
class PORTFL2(AbstractConstrainedMinimisation):
    """Portfolio optimization problem PORTFL2.
    ...
    def expected_objective_value(self):
        # From SIF file: *LO SOLTN 2.9689208D-2
        return jnp.array(2.9689208e-2)
