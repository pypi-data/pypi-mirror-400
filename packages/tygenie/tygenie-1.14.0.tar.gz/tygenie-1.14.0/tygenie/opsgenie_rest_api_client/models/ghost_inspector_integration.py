...
T = TypeVar("T", bound="GhostInspectorIntegration")
...
class GhostInspectorIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ghost_inspector_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        ghost_inspector_integration.additional_properties = d
        return ghost_inspector_integration
