        ...
        _obj = cls.model_validate(
            {
                ...
                "metadata": (
                    DeploymentMetadata.from_dict(obj["metadata"])
                    if obj.get("metadata") is not None
                    else None
                ),
                "definition": (
                    DeploymentDefinition.from_dict(obj["definition"])
                    if obj.get("definition") is not None
                    else None
                ),
                "messages": obj.get("messages"),
                "provisioning_info": (
                    DeploymentProvisioningInfo.from_dict(obj["provisioning_info"])
                    if obj.get("provisioning_info") is not None
                    else None
                ),
                "database_info": (
                    DeploymentDatabaseInfo.from_dict(obj["database_info"])
