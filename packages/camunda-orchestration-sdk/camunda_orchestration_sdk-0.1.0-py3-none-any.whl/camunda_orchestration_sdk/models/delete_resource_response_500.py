...
T = TypeVar("T", bound="DeleteResourceResponse500")


@_attrs_define
class DeleteResourceResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_resource_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_resource_response_500.additional_properties = d
        return delete_resource_response_500
