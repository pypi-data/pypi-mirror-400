...
T = TypeVar("T", bound="ElementinstancekeyAdvancedfilter")


@_attrs_define
class ElementinstancekeyAdvancedfilter:
    """Advanced ElementInstanceKey filter.

    Attributes:
        eq (str | Unset): Checks for equality with the provided value. Example: 2251799813686789.
        neq (str | Unset): Checks for inequality with the provided value. Example: 2251799813686789.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        elementinstancekey_advancedfilter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        elementinstancekey_advancedfilter.additional_properties = d
        return elementinstancekey_advancedfilter
