...
@_attrs_define
class SearchMappingRulesForTenantResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_mapping_rules_for_tenant_response_200_page.additional_properties = d
        return search_mapping_rules_for_tenant_response_200_page
