...
T = TypeVar("T", bound="PartialUpdateServiceAudienceTemplatePayload")


@_attrs_define
class PartialUpdateServiceAudienceTemplatePayload:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        partial_update_service_audience_template_payload = cls(
            responder=responder,
            stakeholder=stakeholder,
        )

        partial_update_service_audience_template_payload.additional_properties = d
        return partial_update_service_audience_template_payload
