...
if importlib.resources.is_resource("_h2oai_client_1_11_0", "BUILD_INFO.txt"):
    exec(importlib.resources.read_text("_h2oai_client_1_11_0", "BUILD_INFO.txt"), build_info)
