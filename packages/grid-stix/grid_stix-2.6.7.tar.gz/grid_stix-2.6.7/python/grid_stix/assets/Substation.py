"""
A facility that contains equipment for switching and transforming electricity between different voltage levels.
...
class Substation(GridSTIXDomainObject):
    """
    A facility that contains equipment for switching and transforming electricity between different voltage levels.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize Substation with Grid-STIX properties."""
