        ...
        _obj = cls.model_validate(
            {
                ...
                "routes": (
                    [DeploymentRoute.from_dict(_item) for _item in obj["routes"]]
                    if obj.get("routes") is not None
                    else None
                ),
                "ports": (
                    [DeploymentPort.from_dict(_item) for _item in obj["ports"]]
                    if obj.get("ports") is not None
                    else None
                ),
                "proxy_ports": (
                    [
                        DeploymentProxyPort.from_dict(_item)
                ...
                "env": (
                    [DeploymentEnv.from_dict(_item) for _item in obj["env"]]
                ...
                "database": (
                    DatabaseSource.from_dict(obj["database"])
