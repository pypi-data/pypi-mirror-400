...
from semantic.common.utils import msg, err, redMsg, greenMsg, to_json_ld_type, resolve_either, reject_promised, reject_either,  instance_count, refForPath, idForPath
...
class semantic:
  ...
  '''
   ...
   def get_insert_instance(self, type: str, *predicate_values):   
      ...
      greenMsg('get_insert_instance( type '+type+' key '+ unique_identifier(predicate_values)+')' )
