...
T = TypeVar("T", bound="GetBatchOperationResponse500")


@_attrs_define
class GetBatchOperationResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_batch_operation_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_batch_operation_response_500.additional_properties = d
        return get_batch_operation_response_500
