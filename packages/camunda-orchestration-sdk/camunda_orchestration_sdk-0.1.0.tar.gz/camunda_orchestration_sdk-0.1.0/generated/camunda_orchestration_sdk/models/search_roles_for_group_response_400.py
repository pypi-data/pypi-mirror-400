...
T = TypeVar("T", bound="SearchRolesForGroupResponse400")


@_attrs_define
class SearchRolesForGroupResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_roles_for_group_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_roles_for_group_response_400.additional_properties = d
        return search_roles_for_group_response_400
