...
T = TypeVar("T", bound="CreateDeploymentResponse503")


@_attrs_define
class CreateDeploymentResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_deployment_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_deployment_response_503.additional_properties = d
        return create_deployment_response_503
