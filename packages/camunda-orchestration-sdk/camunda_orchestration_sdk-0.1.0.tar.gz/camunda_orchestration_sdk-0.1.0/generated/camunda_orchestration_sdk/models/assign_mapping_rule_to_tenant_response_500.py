...
T = TypeVar("T", bound="AssignMappingRuleToTenantResponse500")


@_attrs_define
class AssignMappingRuleToTenantResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assign_mapping_rule_to_tenant_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        assign_mapping_rule_to_tenant_response_500.additional_properties = d
        return assign_mapping_rule_to_tenant_response_500
