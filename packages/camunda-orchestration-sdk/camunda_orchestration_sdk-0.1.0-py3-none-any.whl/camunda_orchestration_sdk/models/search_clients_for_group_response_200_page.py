...
T = TypeVar("T", bound="SearchClientsForGroupResponse200Page")


@_attrs_define
class SearchClientsForGroupResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_clients_for_group_response_200_page = cls(
        ...
        search_clients_for_group_response_200_page.additional_properties = d
        return search_clients_for_group_response_200_page
