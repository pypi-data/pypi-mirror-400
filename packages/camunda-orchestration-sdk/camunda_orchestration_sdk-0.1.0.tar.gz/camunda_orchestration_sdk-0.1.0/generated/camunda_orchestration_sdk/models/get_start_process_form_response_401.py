...
T = TypeVar("T", bound="GetStartProcessFormResponse401")


@_attrs_define
class GetStartProcessFormResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_start_process_form_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_start_process_form_response_401.additional_properties = d
        return get_start_process_form_response_401
