...
if TYPE_CHECKING:
    ...
    from ..models.create_documents_response_207_failed_documents_item import (
        CreateDocumentsResponse207FailedDocumentsItem,
    )


T = TypeVar("T", bound="CreateDocumentsResponse207")


@_attrs_define
class CreateDocumentsResponse207:
    """
    Attributes:
        failed_documents (list[CreateDocumentsResponse207FailedDocumentsItem] | Unset): Documents that were successfully
            created.
        created_documents (list[CreateDocumentsResponse207CreatedDocumentsItem] | Unset): Documents that failed
            creation.
    """

    failed_documents: list[CreateDocumentsResponse207FailedDocumentsItem] | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        failed_documents: (
            list[CreateDocumentsResponse207FailedDocumentsItem] | Unset
        ) = UNSET
        if _failed_documents is not UNSET:
            failed_documents = []
            for failed_documents_item_data in _failed_documents:
                failed_documents_item = (
                    CreateDocumentsResponse207FailedDocumentsItem.from_dict(
        ...
        created_documents: (
            list[CreateDocumentsResponse207CreatedDocumentsItem] | Unset
        ) = UNSET
        if _created_documents is not UNSET:
            created_documents = []
            for created_documents_item_data in _created_documents:
                created_documents_item = (
                    CreateDocumentsResponse207CreatedDocumentsItem.from_dict(
        ...
        create_documents_response_207 = cls(
            failed_documents=failed_documents,
            created_documents=created_documents,
        )

        create_documents_response_207.additional_properties = d
        return create_documents_response_207
