...
if TYPE_CHECKING:
    from ..models.get_decision_instance_response_200_matched_rules_item_evaluated_outputs_item import (
        GetDecisionInstanceResponse200MatchedRulesItemEvaluatedOutputsItem,
    )


T = TypeVar("T", bound="GetDecisionInstanceResponse200MatchedRulesItem")


@_attrs_define
class GetDecisionInstanceResponse200MatchedRulesItem:
    ...
    Attributes:
        ...
        evaluated_outputs (list[GetDecisionInstanceResponse200MatchedRulesItemEvaluatedOutputsItem] | Unset): The
            evaluated decision outputs.
    """

    rule_id: str | Unset = UNSET
    rule_index: int | Unset = UNSET
    evaluated_outputs: (
        list[GetDecisionInstanceResponse200MatchedRulesItemEvaluatedOutputsItem] | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        evaluated_outputs: (
            list[GetDecisionInstanceResponse200MatchedRulesItemEvaluatedOutputsItem]
            | Unset
        ) = UNSET
        if _evaluated_outputs is not UNSET:
            evaluated_outputs = []
            for evaluated_outputs_item_data in _evaluated_outputs:
                evaluated_outputs_item = GetDecisionInstanceResponse200MatchedRulesItemEvaluatedOutputsItem.from_dict(
                    evaluated_outputs_item_data
                )

                evaluated_outputs.append(evaluated_outputs_item)

        get_decision_instance_response_200_matched_rules_item = cls(
            rule_id=rule_id,
            rule_index=rule_index,
            evaluated_outputs=evaluated_outputs,
        )

        get_decision_instance_response_200_matched_rules_item.additional_properties = d
        return get_decision_instance_response_200_matched_rules_item
