...
# Load FBRAIN data (FBRAIN2 uses same data as FBRAIN)
A_coeffs, A_lambdas, B_coeffs, B_lambdas, R_values = load_fbrain_data("fbrain")


class FBRAIN2(AbstractNonlinearEquations):
    """FBRAIN2 - Brain tissue shear stress model with 4 parameters as NE.
