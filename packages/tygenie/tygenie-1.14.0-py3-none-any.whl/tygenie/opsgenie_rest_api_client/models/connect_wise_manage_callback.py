...
T = TypeVar("T", bound="ConnectWiseManageCallback")


@_attrs_define
class ConnectWiseManageCallback:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        connect_wise_manage_callback = cls(
        ...
        connect_wise_manage_callback.additional_properties = d
        return connect_wise_manage_callback
