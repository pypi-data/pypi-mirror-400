...
def branch_is_named_branch(branch):
    """Tell if GitLab branch is a topic.

    Examples::

      >>> branch_is_named_branch(b'branch/gnu')
      True
      >>> branch_is_named_branch(b'topic/default/gnu')
      False
    """
    return branch.startswith(NAMED_BRANCH_PREFIX)
