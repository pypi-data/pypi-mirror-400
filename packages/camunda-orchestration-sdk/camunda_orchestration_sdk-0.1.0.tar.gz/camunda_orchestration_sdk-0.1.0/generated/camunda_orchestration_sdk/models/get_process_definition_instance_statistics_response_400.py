...
T = TypeVar("T", bound="GetProcessDefinitionInstanceStatisticsResponse400")


@_attrs_define
class GetProcessDefinitionInstanceStatisticsResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_process_definition_instance_statistics_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_process_definition_instance_statistics_response_400.additional_properties = d
        return get_process_definition_instance_statistics_response_400
