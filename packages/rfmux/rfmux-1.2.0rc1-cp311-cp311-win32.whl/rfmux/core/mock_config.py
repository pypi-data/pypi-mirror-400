...
# Unified default configuration for mock framework
MOCK_DEFAULTS: Dict[str, Any] = {
    ...
    # Cache quantization steps for convergence reuse (fine defaults for minimal structure)
    ...
    # Not exposed in the dialog but preserved for programmatic control
...
def apply_overrides(overrides: Dict[str, Any] | None) -> Dict[str, Any]:
    ...
    Unknown keys are allowed (forward-compatible), but callers should prefer the documented keys.
