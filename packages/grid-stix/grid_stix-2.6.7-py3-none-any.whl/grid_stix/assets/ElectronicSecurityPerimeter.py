"""
A logical border surrounding a network where critical cyber assets are located, per NERC CIP standards.
...
class ElectronicSecurityPerimeter(GridSTIXDomainObject):
    """
    A logical border surrounding a network where critical cyber assets are located, per NERC CIP standards.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize ElectronicSecurityPerimeter with Grid-STIX properties."""
