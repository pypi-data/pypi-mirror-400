...
# NOTE: No skip fixture here. Tests require native Zig backend.
# If tests fail with "parse_yaml requires native Zig backend", run: make build
# See CLAUDE.md - tests should NEVER skip, only pass or fail.
