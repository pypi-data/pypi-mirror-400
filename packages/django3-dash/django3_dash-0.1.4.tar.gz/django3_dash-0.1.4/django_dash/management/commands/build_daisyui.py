...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        django_dash_dir_path = os.path.abspath(__file__).replace(
            'django_dash/management/commands/build_daisyui.py', ''
        )

        # Set the project root as an environment variable
        os.environ['DJANGO_ROOT_PROJECT_PATH'] = project_root

        os.chdir(django_dash_dir_path)
        ...
        if not self.are_npm_packages_installed(django_dash_dir_path):
