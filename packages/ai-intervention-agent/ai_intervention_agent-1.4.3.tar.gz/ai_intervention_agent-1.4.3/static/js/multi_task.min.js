...
if(typeof window.MathJax!=='undefined'&&window.MathJax.typesetPromise){window.MathJax.typesetPromise([descriptionElement]).catch(err=>{console.warn('MathJax 渲染失败:',err)})}}catch(error){console.error('更新描述失败:',error)
...
const defaultMessage=typeof feedbackPrompts!=='undefined'&&feedbackPrompts.resubmit_prompt?feedbackPrompts.resubmit_prompt:'请立即调用 interactive_feedback 工具'
