...
class ListAlgorithmsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListAlgorithmsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListAlgorithmsResponse:
        """Create an instance of ListAlgorithmsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListAlgorithmsResponse.parse_obj(obj)

        _obj = ListAlgorithmsResponse.parse_obj(
            {
