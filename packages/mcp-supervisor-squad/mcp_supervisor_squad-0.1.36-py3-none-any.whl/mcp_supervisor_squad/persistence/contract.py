    ...
    payload: dict[str, Any] = {
        ...
        "workflow": {
            ...
            "notes": [
                ...
                "Force print+wait: whenever squad_start/squad_status returns summary_lines/event_lines, first print them line by line (concise), then sleep forced_wait_ms before next status; do not call squad_status during sleep.",
