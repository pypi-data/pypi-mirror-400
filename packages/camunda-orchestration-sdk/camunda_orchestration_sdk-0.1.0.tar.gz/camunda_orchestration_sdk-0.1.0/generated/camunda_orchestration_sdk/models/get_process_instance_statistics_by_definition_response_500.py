...
T = TypeVar("T", bound="GetProcessInstanceStatisticsByDefinitionResponse500")


@_attrs_define
class GetProcessInstanceStatisticsByDefinitionResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_process_instance_statistics_by_definition_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_process_instance_statistics_by_definition_response_500.additional_properties = d
        return get_process_instance_statistics_by_definition_response_500
