...
class Canvas(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.drawingLineColor = QColor(0, 0, 0)
    ...
    def mouseMoveEvent(self, ev):
        ...
        self.parent().parent().parent().show_position(pos.x(), pos.y())
        ...
        if Qt.LeftButton & ev.buttons():
            delta_x = int(pos.x() - self.pan_initial_pos.x())
            delta_y = int(pos.y() - self.pan_initial_pos.y())
    ...
    def wheelEvent(self, ev):
        ...
        if delta > 0:
            self.scale = min(4, self.scale + step)
        else:
