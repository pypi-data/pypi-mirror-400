...
T = TypeVar("T", bound="NagiosXIIntegrationV1")


@_attrs_define
class NagiosXIIntegrationV1:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nagios_xi_integration_v1.additional_properties = d
        return nagios_xi_integration_v1
