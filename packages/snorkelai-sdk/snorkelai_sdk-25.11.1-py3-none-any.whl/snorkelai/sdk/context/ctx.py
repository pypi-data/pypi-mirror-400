...
class SnorkelSDKContext:
    ...
    def from_endpoint_url(
        ...
        **kwargs: Any,
        ...
        set_global
            Whether to set the context as the global context, accessible across all notebooks.
        debug
