...
class CommandVerifyInvoiceStateComputarizada(DataTransferObject):
    document_type: int
    emission_code: int
    point_of_sale: int
    system_code: str
...
class ResponseVerifyInvoiceStateComputarizada(DataTransferObject):
    reception_code: str | None
    literal_status: SectorDocumentState | str
    raw_response: Any


@siat_soap_sdk.feature(CommandVerifyInvoiceStateComputarizada)
class VerifyInvoiceStateSiat(Feature):

    def execute(
        self, dto: CommandVerifyInvoiceStateComputarizada
        ...
        return ResponseVerifyInvoiceStateComputarizada(
