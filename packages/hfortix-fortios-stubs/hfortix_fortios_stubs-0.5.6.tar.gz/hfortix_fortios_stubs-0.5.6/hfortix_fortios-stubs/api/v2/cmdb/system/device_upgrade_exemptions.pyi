...
class DeviceUpgradeExemptionsPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    """
    id: NotRequired[int]  # Device upgrade exemption ID (0 - 65535).
    fortinet_device: str  # Fortinet extension device (FortiAP, FortiSwitch, FortiExtend
    version: str  # Highest version of Fortinet firmware to exempt (format in Ma
