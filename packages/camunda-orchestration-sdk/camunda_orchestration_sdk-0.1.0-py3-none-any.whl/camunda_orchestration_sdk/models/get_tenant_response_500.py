...
T = TypeVar("T", bound="GetTenantResponse500")


@_attrs_define
class GetTenantResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_tenant_response_500.additional_properties = d
        return get_tenant_response_500
