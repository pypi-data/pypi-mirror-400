...
T = TypeVar("T", bound="CreateMappingRuleResponse403")


@_attrs_define
class CreateMappingRuleResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_mapping_rule_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_mapping_rule_response_403.additional_properties = d
        return create_mapping_rule_response_403
