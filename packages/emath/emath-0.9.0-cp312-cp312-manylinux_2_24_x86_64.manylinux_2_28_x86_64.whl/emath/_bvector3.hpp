...
static PyObject *
BVector3Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(bool) * 3;
...
static PyMethodDef BVector3Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)BVector3Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
