...
def prune_repo_storage(*, layout: StorageLayout, retention_days: int, rate_limit_seconds: int = 3600) -> None:
    """
    ...
    atomic_write_json(meta_path, {"last_prune_at": utc_now_iso(), "retention_days": retention_days})
