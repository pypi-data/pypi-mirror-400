...
T = TypeVar("T", bound="MigrateProcessInstanceResponse500")


@_attrs_define
class MigrateProcessInstanceResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        migrate_process_instance_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        migrate_process_instance_response_500.additional_properties = d
        return migrate_process_instance_response_500
