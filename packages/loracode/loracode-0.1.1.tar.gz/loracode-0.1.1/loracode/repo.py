...
class GitRepo:
    ...
    def commit(self, fnames=None, context=None, message=None, loracode_edits=False, coder=None):
        ...
        Args:
            ...
            loracode_edits (bool, optional): Whether the changes were made by LoraCode. Defaults to False.
        ...
        LoraCode generated the changes (`loracode_edits`).
        ...
        - loracode_edits=True: Changes were generated by LoraCode (LLM).
        - loracode_edits=False: Commit is user-driven (e.g., /commit manually staged changes).
        ...
        Flags:
        - --attribute-author: Modify Author name to "User Name (loracode)".
        - --attribute-committer: Modify Committer name to "User Name (loracode)".
        - --attribute-co-authored-by: Add
          "Co-authored-by: loracode (<model>) <loracode@loratech.dev>" trailer to commit message.

        Behavior Summary:

        1. When loracode_edits = True (AI Changes):
        ...
        2. When loracode_edits = False (User Changes):
           - --attribute-co-authored-by is IGNORED (trailer never added).
           - Author name is NEVER modified (--attribute-author ignored).
           - Committer name IS modified by default (implicit True, as LoraCode runs `git commit`).
           - EXCEPTION: If --attribute-committer is EXPLICITLY False, the name is NOT modified.

        Resulting Scenarios:
        - Standard AI edit (defaults): Co-authored-by=False -> Author=You(loracode),
          Committer=You(loracode)
        ...
        - AI edit with Co-authored-by + Explicit Author: Co-authored-by=True,
          --attribute-author -> Author=You(loracode), Committer=You, Trailer added
        - User commit (defaults): loracode_edits=False -> Author=You, Committer=You(loracode)
        - User commit with explicit no-committer: loracode_edits=False,
