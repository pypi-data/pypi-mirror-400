...
class UnstructuredHexGrid_V1_3_0(BaseSpatialDataProperties_V1_1_0):
    ...
    Attributes:
        schema (str)
        hexahedrons (Hexahedrons_V1_2_0): The hexahedrons of the unstructured grid.
...
class UnstructuredHexGrid_V1_1_0(BaseSpatialDataProperties_V1_0_1):
    ...
    Attributes:
        schema (str)
        hexahedrons (Hexahedrons_V1_1_0): The hexahedrons of the unstructured grid.
        bounding_box (BoundingBox_V1_0_1): Bounding box of the spatial data.
        coordinate_reference_system (Crs_V1_0_1): Coordinate system of the spatial data
        name (str): Name of the object.
...
class UnstructuredHexGrid_V1_0_1(BaseSpatialDataProperties_V1_0_1):
    ...
    Attributes:
        schema (str)
        hexahedrons (Hexahedrons_V1_0_1): The hexahedrons of the unstructured grid.
        bounding_box (BoundingBox_V1_0_1): Bounding box of the spatial data.
        coordinate_reference_system (Crs_V1_0_1): Coordinate system of the spatial data
        name (str): Name of the object.
        uuid (BaseObjectProperties_V1_0_1_Uuid): Identifier of the object.
