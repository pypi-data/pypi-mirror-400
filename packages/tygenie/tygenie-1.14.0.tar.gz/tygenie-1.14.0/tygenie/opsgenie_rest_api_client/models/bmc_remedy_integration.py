...
T = TypeVar("T", bound="BMCRemedyIntegration")


@_attrs_define
class BMCRemedyIntegration:
    """
    Attributes:
        ...
        midtier_server_url (Union[Unset, str]):
    ...
    midtier_server_url: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        midtier_server_url = self.midtier_server_url
        ...
        if midtier_server_url is not UNSET:
            field_dict["midtierServerUrl"] = midtier_server_url
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        midtier_server_url = d.pop("midtierServerUrl", UNSET)

        server_name = d.pop("serverName", UNSET)

        bmc_remedy_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
            ...
            username=username,
            password=password,
            midtier_server_url=midtier_server_url,
            server_name=server_name,
        )

        bmc_remedy_integration.additional_properties = d
        return bmc_remedy_integration
