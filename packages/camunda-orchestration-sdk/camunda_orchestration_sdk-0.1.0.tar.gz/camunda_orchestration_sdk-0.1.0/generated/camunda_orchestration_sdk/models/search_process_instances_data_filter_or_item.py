...
if TYPE_CHECKING:
    ...
    from ..models.search_process_instances_data_filter_or_item_variables_item import (
...
T = TypeVar("T", bound="SearchProcessInstancesDataFilterOrItem")


@_attrs_define
class SearchProcessInstancesDataFilterOrItem:
    ...
    Attributes:
        ...
        variables (list[SearchProcessInstancesDataFilterOrItemVariablesItem] | Unset): The process instance variables.
    ...
    variables: list[SearchProcessInstancesDataFilterOrItemVariablesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        variables: list[SearchProcessInstancesDataFilterOrItemVariablesItem] | Unset = (
            UNSET
        )
        if _variables is not UNSET:
            ...
            for variables_item_data in _variables:
                variables_item = (
                    SearchProcessInstancesDataFilterOrItemVariablesItem.from_dict(
                        variables_item_data
                    )
                )
        ...
        search_process_instances_data_filter_or_item = cls(
        ...
        search_process_instances_data_filter_or_item.additional_properties = d
        return search_process_instances_data_filter_or_item
