...
T = TypeVar("T", bound="UpdateRoleResponse400")


@_attrs_define
class UpdateRoleResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_role_response_400.additional_properties = d
        return update_role_response_400
