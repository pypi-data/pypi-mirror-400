...
T = TypeVar("T", bound="HPServiceManagerIntegration")


@_attrs_define
class HPServiceManagerIntegration:
    """
    Attributes:
        ...
        api_ket (Union[Unset, str]):
        base_domain (Union[Unset, str]):
    """
    ...
    api_ket: Union[Unset, str] = UNSET
    base_domain: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if api_ket is not UNSET:
            field_dict["apiKet"] = api_ket
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_ket = d.pop("apiKet", UNSET)

        base_domain = d.pop("baseDomain", UNSET)

        hp_service_manager_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        hp_service_manager_integration.additional_properties = d
        return hp_service_manager_integration
