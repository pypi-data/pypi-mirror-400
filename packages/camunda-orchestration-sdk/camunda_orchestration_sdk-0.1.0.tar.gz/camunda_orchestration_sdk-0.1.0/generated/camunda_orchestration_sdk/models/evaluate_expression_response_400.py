...
T = TypeVar("T", bound="EvaluateExpressionResponse400")


@_attrs_define
class EvaluateExpressionResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        evaluate_expression_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        evaluate_expression_response_400.additional_properties = d
        return evaluate_expression_response_400
