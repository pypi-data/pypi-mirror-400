...
T = TypeVar("T", bound="DeleteResourceResponse404")


@_attrs_define
class DeleteResourceResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_resource_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_resource_response_404.additional_properties = d
        return delete_resource_response_404
