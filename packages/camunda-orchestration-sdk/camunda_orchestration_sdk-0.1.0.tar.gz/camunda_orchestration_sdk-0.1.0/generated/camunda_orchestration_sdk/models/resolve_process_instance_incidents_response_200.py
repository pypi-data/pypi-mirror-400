...
from ..models.resolve_process_instance_incidents_response_200_batch_operation_type import (
    ResolveProcessInstanceIncidentsResponse200BatchOperationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ResolveProcessInstanceIncidentsResponse200")


@_attrs_define
class ResolveProcessInstanceIncidentsResponse200:
    """The created batch operation.

    Attributes:
        batch_operation_key (str | Unset): Key of the batch operation. Example: 2251799813684321.
        batch_operation_type (ResolveProcessInstanceIncidentsResponse200BatchOperationType | Unset): The type of the
            batch operation.
    """

    batch_operation_key: BatchOperationKey | Unset = UNSET
    batch_operation_type: (
        ResolveProcessInstanceIncidentsResponse200BatchOperationType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resolve_process_instance_incidents_response_200 = cls(
            batch_operation_key=batch_operation_key,
            batch_operation_type=batch_operation_type,
        )

        resolve_process_instance_incidents_response_200.additional_properties = d
        return resolve_process_instance_incidents_response_200
