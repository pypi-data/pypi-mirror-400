...
T = TypeVar("T", bound="BlueMatadorIntegration")


@_attrs_define
class BlueMatadorIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        blue_matador_integration.additional_properties = d
        return blue_matador_integration
