...
Welcome to `opensemantic` contributor's guide.
...
If you experience bugs or general issues with `opensemantic`, please have a look
...
You can help improve `opensemantic` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`opensemantic` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `opensemantic`'s files. While this mechanism can
...
```
conda create -n opensemantic python=3 six virtualenv pytest pytest-cov
conda activate opensemantic
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/opensemantic.git
   cd opensemantic
   ```
...
5. Install [pre-commit]:
   ...
   `opensemantic` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/opensemantic
[issue tracker]: https://github.com/<USERNAME>/opensemantic/issues
