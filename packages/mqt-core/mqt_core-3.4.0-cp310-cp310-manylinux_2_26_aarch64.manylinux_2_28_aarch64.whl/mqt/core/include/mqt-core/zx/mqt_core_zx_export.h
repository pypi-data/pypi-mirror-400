...
#      define MQT_CORE_ZX_EXPORT __attribute__((visibility("default")))
#    else
...
#    define MQT_CORE_ZX_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef MQT_CORE_ZX_DEPRECATED
#  define MQT_CORE_ZX_DEPRECATED __attribute__ ((__deprecated__))
#endif
