...
static PyObject *
UVector4Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(unsigned int) * 4;
...
static PyMethodDef UVector4Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)UVector4Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
