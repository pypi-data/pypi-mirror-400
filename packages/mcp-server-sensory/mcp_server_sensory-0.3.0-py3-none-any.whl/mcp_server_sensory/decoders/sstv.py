...
def reflux_decode(audio_data: bytes, sample_rate: int = 44100) -> Dict[str, Any]:
    """
    ...
    Args:
        audio_data: SSTV audio (WAV bytes)
    ...
    if not detection.get("detected", False):
        ...
        result["note"] = "No SSTV signal detected in audio"
        return result

    # Step 2: Save audio to temp file for external decode
    ...
    # Step 3: Decode with external tool
