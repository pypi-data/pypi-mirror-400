...
#define NCBI_SIGNATURE "APPLE_CLANG_1700-ReleaseMT64--arm64-Darwin24.6.0-sjc20-cw715-2fd74450-e4d2-47c1-8cbc-2e65fb1da789-1E4636CACAE1.local"
...
#define HOST "arm64-Darwin"

/* CPU type only */
#define HOST_CPU "arm64"
...
#define NCBI_COMPILER_VERSION 1700
...
/* Define to 1 if you have the `__builtin_mul_overflow' function. */
...
/* ======================================================================= */
/* ======================================================================= */
/* Define to 1 if backward.hpp is available. */
/* #undef HAVE_BACKWARD_HPP */
...
/* Define to 1 if libopentelemetry is available. */
/* #undef HAVE_LIBOPENTELEMETRY */
