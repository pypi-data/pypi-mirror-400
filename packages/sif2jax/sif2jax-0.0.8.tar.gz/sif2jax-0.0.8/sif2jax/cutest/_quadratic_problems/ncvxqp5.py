...
class NCVXQP5(AbstractConstrainedQuadraticProblem):
    """NCVXQP5 problem - a non-convex quadratic program.
    ...
    def objective(self, y, args):
        ...
        # where p = i for i <= n/2 and p = -i for i > n/2 (50% positive eigenvalues)
        ...
        def compute_term(i):
            ...
            # Parameter p (50% positive eigenvalues)
            nplus = n // 2
    ...
    def expected_result(self):
        ...
        raise NotImplementedError("Expected result not available for NCVXQP5")
