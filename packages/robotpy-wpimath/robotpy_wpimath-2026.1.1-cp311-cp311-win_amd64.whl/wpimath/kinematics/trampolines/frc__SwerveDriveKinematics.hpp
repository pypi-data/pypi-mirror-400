...
struct PyTrampoline_SwerveDriveKinematics : PyTrampolineBase_SwerveDriveKinematics<PyTrampolineBase, NumModules, PyTrampolineCfg> {
  ...
  #ifndef SWGEN_DISABLE_KToChassisSpeeds_KRTarray
  ...
  #ifndef SWGEN_DISABLE_KToTwist2d_KRTarray_KRTarray
  ...
  #ifndef SWGEN_DISABLE_KInterpolate_KRTarray_KRTarray_d
...
struct bind_frc__SwerveDriveKinematics {
  ...
  static_assert(std::is_abstract<SwerveDriveKinematics_Trampoline>::value == false, "frc::SwerveDriveKinematics<NumModules> " SEMIWRAP_BAD_TRAMPOLINE);
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_SwerveDriveKinematics.def("resetHeadings", static_cast<void (frc::SwerveDriveKinematics<NumModules>::*)(wpi::array<Rotation2d, NumModules>)>(&frc::SwerveDriveKinematics<NumModules>::ResetHeadings)
    ...
    cls_SwerveDriveKinematics.def("toSwerveModuleStates", &frc::SwerveDriveKinematics<NumModules>::ToSwerveModuleStates
    ...
    cls_SwerveDriveKinematics.def("toWheelSpeeds", &frc::SwerveDriveKinematics<NumModules>::ToWheelSpeeds
      , py::arg("chassisSpeeds")
      , release_gil()
    );
    cls_SwerveDriveKinematics.def("toChassisSpeeds", static_cast<ChassisSpeeds (frc::SwerveDriveKinematics<NumModules>::*)(const wpi::array<SwerveModuleState, NumModules>&) const>(&frc::SwerveDriveKinematics<NumModules>::ToChassisSpeeds)
      , py::arg("moduleStates")
      , release_gil()
      , py::doc(
    ...
    cls_SwerveDriveKinematics.def("toTwist2d", static_cast<Twist2d (frc::SwerveDriveKinematics<NumModules>::*)(wpi::array<SwerveModulePosition, NumModules>) const>(&frc::SwerveDriveKinematics<NumModules>::ToTwist2d)
      , py::arg("moduleDeltas")
      , release_gil()
      , py::doc(
    ...
    cls_SwerveDriveKinematics.def("toTwist2d", static_cast<Twist2d (frc::SwerveDriveKinematics<NumModules>::*)(const wpi::array<SwerveModulePosition, NumModules>&, const wpi::array<SwerveModulePosition, NumModules>&) const>(&frc::SwerveDriveKinematics<NumModules>::ToTwist2d)
      , py::arg("start"), py::arg("end")
      , release_gil()
    );
    cls_SwerveDriveKinematics.def_static("desaturateWheelSpeeds", [](wpi::array<SwerveModuleState, NumModules> moduleStates, units::meters_per_second_t attainableMaxSpeed) {
    ...
    cls_SwerveDriveKinematics.def_static("desaturateWheelSpeeds", [](wpi::array<SwerveModuleState, NumModules> moduleStates,
    ...
    cls_SwerveDriveKinematics.def("interpolate", &frc::SwerveDriveKinematics<NumModules>::Interpolate
      , py::arg("start"), py::arg("end"), py::arg("t")
      , release_gil()
    );
    cls_SwerveDriveKinematics.def("getModules", &frc::SwerveDriveKinematics<NumModules>::GetModules
      , release_gil()
    );
    if (set_doc) {
