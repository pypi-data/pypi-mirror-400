...
class Test(unittest.TestCase):
    ...
    def test_005_contained_false(self):
        ...
        contained, points, factor, indexes = pc.contains(1.0, 1.0, ro=ro)
    ...
    def test_006_contained_true(self):
        ...
        bb = pc.boundingBox()
        ro = (bb[1] - bb[0], bb[3] - bb[2])
        contained, points, factor, indexes = pc.contains(0.25, 0.25, ro=ro)
        assert isinstance(points, list)
        assert isinstance(factor, float)
        assert isinstance(indexes, list)
    ...
    def test_007_contained_horizontal(self):
        ...
        bb = pc.boundingBox()
        ro = (bb[1] - bb[0], bb[3] - bb[2])
        contained, points, factor, indexes = pc.contains(0.25, 0.0, ro=ro)
        assert isinstance(points, list)
        assert isinstance(factor, float)
        assert isinstance(indexes, list)
    ...
    def test_008_contained_vertical(self):
        ...
        bb = pc.boundingBox()
        ro = (bb[1] - bb[0], bb[3] - bb[2])
        contained, points, factor, indexes = pc.contains(0.0, 0.25, ro=ro)
        assert isinstance(points, list)
        assert isinstance(factor, float)
        assert isinstance(indexes, list)
