...
def root(context, missing=missing):
    ...
    if t_2((undefined(name='patch_panel') if l_0_patch_panel is missing else l_0_patch_panel)):
        ...
        if t_2(environment.getattr(environment.getattr((undefined(name='patch_panel') if l_0_patch_panel is missing else l_0_patch_panel), 'connector'), 'interface')):
            ...
            yield '   !\n'
        for l_1_patch in t_1(environment.getattr((undefined(name='patch_panel') if l_0_patch_panel is missing else l_0_patch_panel), 'patches'), sort_key='name'):
            _loop_vars = {}
            pass
            if t_2(environment.getattr(l_1_patch, 'name')):
                ...
                if t_2(environment.getattr(l_1_patch, 'enabled'), False):
                    pass
                    yield '      shutdown\n'
                for l_2_connector in t_1(environment.getattr(l_1_patch, 'connectors'), sort_key='id'):
...
blocks = {}
debug_info = '7=24&10=27&11=29&12=32&14=36&19=40&20=43&21=46&22=48&25=51&26=55&27=57&28=59&29=61&31=64'