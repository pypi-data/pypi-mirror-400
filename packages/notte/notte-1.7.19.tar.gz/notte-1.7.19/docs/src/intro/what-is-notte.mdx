...
1. **[Deploy your automations as edge functions](/concepts/functions)**. Create and manage reusable functions that combine traditional deterministic steps with LLM-powered agents for reliable and cost-effective automation.
