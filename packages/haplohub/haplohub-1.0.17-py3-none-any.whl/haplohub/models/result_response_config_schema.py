...
class ResultResponseConfigSchema(BaseModel):
    """
    ResultResponseConfigSchema
    """

    status: Optional[StrictStr] = "success"
    result: ConfigSchema = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResultResponseConfigSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResultResponseConfigSchema:
        """Create an instance of ResultResponseConfigSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResultResponseConfigSchema.parse_obj(obj)

        _obj = ResultResponseConfigSchema.parse_obj(
            {
                "status": obj.get("status") if obj.get("status") is not None else "success",
                "result": ConfigSchema.from_dict(obj.get("result")) if obj.get("result") is not None else None,
            }
        )
        return _obj
