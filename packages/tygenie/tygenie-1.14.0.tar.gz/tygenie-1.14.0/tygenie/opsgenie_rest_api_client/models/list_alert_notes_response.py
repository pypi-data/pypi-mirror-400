...
T = TypeVar("T", bound="ListAlertNotesResponse")
...
class ListAlertNotesResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, List['AlertNote']]):
        paging (Union[Unset, AlertPaging]):
    """

    request_id: str
    took: float = 0.0
    data: Union[Unset, List["AlertNote"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = AlertNote.from_dict(data_item_data)
        ...
        list_alert_notes_response.additional_properties = d
        return list_alert_notes_response
