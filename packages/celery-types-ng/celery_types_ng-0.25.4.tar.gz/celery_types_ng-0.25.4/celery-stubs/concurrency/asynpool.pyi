...
class AsynPool(_pool.Pool):
    ...
    def on_partial_read(self, job: Any, proc: Any) -> None: ...  # ty: ignore[invalid-method-override]
    def on_process_alive(self, pid: int) -> None: ...
    def process_flush_queues(self, proc: Any) -> None: ...  # ty: ignore[invalid-method-override]
    def register_with_event_loop(self, hub: Any) -> None: ...
