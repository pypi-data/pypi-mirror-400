...
class ValidationContext:
    ...
    def record_validation(self, cert, path):
        ...
        :param path:
            A paperlogic_certvalidator.path.ValidationPath object
        """
    ...
    def check_validation(self, cert):
        ...
        :return:
            None if not validated, or a paperlogic_certvalidator.path.ValidationPath
