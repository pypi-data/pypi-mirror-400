...
T = TypeVar("T", bound="SearchClusterVariablesResponse500")


@_attrs_define
class SearchClusterVariablesResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_cluster_variables_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_cluster_variables_response_500.additional_properties = d
        return search_cluster_variables_response_500
