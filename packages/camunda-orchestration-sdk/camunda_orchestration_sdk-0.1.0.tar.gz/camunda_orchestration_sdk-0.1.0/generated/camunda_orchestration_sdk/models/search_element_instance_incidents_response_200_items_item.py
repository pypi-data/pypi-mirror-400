...
if TYPE_CHECKING:
    from ..models.search_element_instance_incidents_response_200_items_item_error_type import (
        SearchElementInstanceIncidentsResponse200ItemsItemErrorType,
    )
    from ..models.search_element_instance_incidents_response_200_items_item_state import (
        SearchElementInstanceIncidentsResponse200ItemsItemState,
    )


T = TypeVar("T", bound="SearchElementInstanceIncidentsResponse200ItemsItem")


@_attrs_define
class SearchElementInstanceIncidentsResponse200ItemsItem:
    """
    Attributes:
        ...
        error_type (SearchElementInstanceIncidentsResponse200ItemsItemErrorType | Unset):
        ...
        state (SearchElementInstanceIncidentsResponse200ItemsItemState | Unset):
    ...
    state: SearchElementInstanceIncidentsResponse200ItemsItemState | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_error_type, Unset):
            ...
            error_type = (
                SearchElementInstanceIncidentsResponse200ItemsItemErrorType.from_dict(
                    _error_type
                )
            )
        ...
        if isinstance(_state, Unset):
            ...
            state = SearchElementInstanceIncidentsResponse200ItemsItemState.from_dict(
                _state
            )
        ...
        search_element_instance_incidents_response_200_items_item = cls(
        ...
        search_element_instance_incidents_response_200_items_item.additional_properties = d
        return search_element_instance_incidents_response_200_items_item
