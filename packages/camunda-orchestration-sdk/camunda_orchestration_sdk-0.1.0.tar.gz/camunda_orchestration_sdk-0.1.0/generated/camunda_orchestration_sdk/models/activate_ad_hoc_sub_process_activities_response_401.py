...
T = TypeVar("T", bound="ActivateAdHocSubProcessActivitiesResponse401")


@_attrs_define
class ActivateAdHocSubProcessActivitiesResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activate_ad_hoc_sub_process_activities_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        activate_ad_hoc_sub_process_activities_response_401.additional_properties = d
        return activate_ad_hoc_sub_process_activities_response_401
