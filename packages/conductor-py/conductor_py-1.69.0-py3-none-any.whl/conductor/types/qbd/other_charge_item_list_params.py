...
__all__ = ["OtherChargeItemListParams"]
...
class OtherChargeItemListParams(TypedDict, total=False):
    ...
    A class is a way end-users can categorize other charge items in QuickBooks.
    """
    ...
    """Filter for specific other charge items by their full-name(s), case-insensitive.
    ...
    **NOTE**: If any of the values you specify in this parameter are not found, the
    ...
    """
    Filter for specific other charge items by their QuickBooks-assigned unique
    identifier(s).
    ...
    **NOTE**: If any of the values you specify in this parameter are not found, the
    ...
    """
    Filter for other charge items whose `name` contains this substring,
    case-insensitive.
    ...
    **NOTE**: If you use this parameter, you cannot also use `nameStartsWith` or
    ...
    """
    Filter for other charge items whose `name` ends with this substring,
    case-insensitive.
    ...
    **NOTE**: If you use this parameter, you cannot also use `nameContains` or
    ...
    """
    Filter for other charge items whose `name` is alphabetically greater than or
    equal to this value.
    """

    name_starts_with: Annotated[str, PropertyInfo(alias="nameStartsWith")]
    """
    Filter for other charge items whose `name` starts with this substring,
    case-insensitive.
    ...
    **NOTE**: If you use this parameter, you cannot also use `nameContains` or
    ...
    """
    Filter for other charge items whose `name` is alphabetically less than or equal
    to this value.
    """
    ...
    """Filter for other charge items updated on or after this date/time.
    ...
    """Filter for other charge items updated on or before this date/time.
