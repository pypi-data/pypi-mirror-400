...
class HIMMELP5(AbstractConstrainedMinimisation):
    ...
    def objective(self, y: Any, args: Any) -> Any:
        ...
        # Element OB (OBNL type) - same as HIMMELP2/P3/P4
    ...
    def constraint(self, y: Any):
        ...
        return None, jnp.array([c5, c8, c9])

    @property
    def bounds(self) -> tuple[jnp.ndarray, jnp.ndarray]:
        return (jnp.array([54.0, 0.0]), jnp.array([75.0, 65.0]))
    ...
    def expected_objective_value(self):
        # From SIF file comment: -59.01312394 (same as HIMMELP3/P4)
