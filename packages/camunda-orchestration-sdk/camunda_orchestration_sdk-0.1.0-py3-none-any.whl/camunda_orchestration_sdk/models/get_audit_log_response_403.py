...
T = TypeVar("T", bound="GetAuditLogResponse403")


@_attrs_define
class GetAuditLogResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_audit_log_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_audit_log_response_403.additional_properties = d
        return get_audit_log_response_403
