...
T = TypeVar("T", bound="GetAuthenticationResponse500")


@_attrs_define
class GetAuthenticationResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_authentication_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_authentication_response_500.additional_properties = d
        return get_authentication_response_500
