...
from py_mdr.ocsf_models.objects.request_elements import RequestElements
from py_mdr.ocsf_models.objects.response_elements import ResponseElements
from py_mdr.ocsf_models.objects.service import Service
...
class API(BaseModel):
    ...
    request: RequestElements = field(default_factory=RequestElements)
    response: ResponseElements = field(default_factory=ResponseElements)
