...
def save_task_config(
    ...
    config_file = output_dir / f"{config_name}{suffix}"
...
def get_hostname_from_vbi_config() -> str:
    """从 vbi.yaml 中获取第一个 hostname

    Returns:
        hostname 字符串，未找到返回空字符串
    """
    from ..client_config.client_config import CONFIG_FILE
