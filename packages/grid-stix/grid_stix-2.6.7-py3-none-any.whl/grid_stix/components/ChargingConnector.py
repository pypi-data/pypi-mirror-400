"""
Physical interface used to connect an Electric Vehicle to EVSE. Subject to hardware and protocol vulnerabilities.
...
class ChargingConnector(GridSTIXDomainObject):
    """
    Physical interface used to connect an Electric Vehicle to EVSE. Subject to hardware and protocol vulnerabilities.
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize ChargingConnector with Grid-STIX properties."""
