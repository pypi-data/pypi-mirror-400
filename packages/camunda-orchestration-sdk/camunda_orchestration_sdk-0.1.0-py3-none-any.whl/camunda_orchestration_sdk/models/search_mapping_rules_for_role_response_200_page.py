...
T = TypeVar("T", bound="SearchMappingRulesForRoleResponse200Page")


@_attrs_define
class SearchMappingRulesForRoleResponse200Page:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_mapping_rules_for_role_response_200_page = cls(
        ...
        search_mapping_rules_for_role_response_200_page.additional_properties = d
        return search_mapping_rules_for_role_response_200_page
