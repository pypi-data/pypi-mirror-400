...
#   timestamp: 2025-09-26T08:34:36+00:00
...
class InputParametersOnnxIr(BaseModel):
    input_name: constr(max_length=255) | None = Field(
        None,
    ...
    shape: list[ShapeItem] | None = Field(
        [],
...
class JobEventMessageResponse(BaseModel):
    ...
    is_publishable: bool | None = Field(
        False,
...
class ModelInstancePatchRequest(BaseModel):
    ...
    model_type: EnumModelType | None = Field(
        None, description="Type of the ModelInstance."
    )
    model_precision_type: EnumModelPrecisionType | None = Field(
        None, description="Type of the percision of the ModelInstance."
    )
    name: constr(max_length=255) | None = Field(
        None, description="Name of the ModelInstance.", title="Name"
    )
    description: constr(max_length=255) | None = Field(
        None,
    ...
    hardware_parameters: dict[str, Any] | None = Field(
        None,
        description="Hardware parameters of the Model.",
        title="Hardware Parameters",
    )
    input_shape: list[list[PositiveInt]] | None = Field(
        None,
    ...
    yolo_version: EnumYoloVersion | None = Field(
        None,
...
class ModelInstanceRequest(BaseModel):
    ...
    model_type: EnumModelType = Field(
        ..., description="Type of the ModelInstance."
    )
    model_precision_type: EnumModelPrecisionType | None = Field(
        None, description="Type of the percision of the ModelInstance."
    )
...
class ModelInstanceResponse(BaseModel):
    ...
    model_class: EnumModelClass | None = Field(
        None,
...
class ModelPatchRequest(BaseModel):
    ...
    license_type: EnumLicenseType | None = Field(
    ...
    description_short: constr(max_length=255) | None = Field(
        None,
    ...
    tasks: list[EnumTaskType] | None = Field(
        [], description="Array of types of tasks.", title="Tasks"
    )
    links: list[ModelLinkBase] | None = Field(
...
class ModelResponse(BaseModel):
    ...
    links: list[ModelLinkResponse] | None = Field(
        [], description="Links to official Model pages.", title="Links"
    )
    is_yolo: bool | None = Field(
        False,
    ...
    likes: int | None = Field(0, description="Number of likes.", title="Likes")
    downloads: int = Field(
        ..., description="Number of downloads.", title="Downloads"
    )
    versions: int | None = Field(
    ...
    is_official: bool | None = Field(
        False,
        description="Is the model created by Luxonis.",
        title="Is Official",
    )
    is_liked_by_user: bool | None = Field(
        None,
        description="True if the model is liked by the user.",
        title="Is Liked By User",
    )
    model_image_link: str | None = Field(
        None,
        description="The CDN link to upload/download model images.",
        title="Model Image Link",
    )
    exportable_types: list[EnumModelType] | None = Field(
        [],
...
class ModelVersionPatchRequest(BaseModel):
    ...
    version: constr(max_length=255) | None = Field(
        None,
    ...
    repository_url: constr(max_length=255) | None = Field(
        None,
        description="URL of the model's repository.",
        title="Repository Url",
    )
    commit_hash: constr(max_length=255) | None = Field(
        None,
    ...
    training_run_name: constr(max_length=255) | None = Field(
        None,
...
class Output(BaseModel):
    ...
    name: str = Field(
        ..., description="Name of the output layer.", title="Name"
    )
...
class PerformanceRating(BaseModel):
    ...
    speed_rating: int | None = Field(
        ...,
        description="Speed rating of the architecture on a scale of 1-10.",
        title="Speed Rating",
    )
    fps_rating: confloat(ge=0.0) | None = Field(
...
class RVC2ExportParametersOnnxIr(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    name: constr(max_length=255) = Field(
...
class RVC3ExportParametersOnnxIr(BaseModel):
    ...
    pot_target_device: EnumPotTargetDevice | None = Field(
...
class ArchitecturePatchRequest(BaseModel):
    ...
    training_image: str | None = Field(
        None,
        description="The internal training image used in this architecture (DO NOT expose to user).",
...
class GetFromSlugsRequest(BaseModel):
    team_slugs: list[str] | None = Field(None, title="Team Slugs")
    model_slugs: list[str] | None = Field(None, title="Model Slugs")
    variant_slugs: list[str] | None = Field(None, title="Variant Slugs")
...
class Input(BaseModel):
    ...
    name: str = Field(
        ..., description="Name of the input layer.", title="Name"
    )
    dtype: DataType = Field(
    ...
    layout: constr(min_length=1) | None = Field(
        "NCHW",
...
class ModelVersionResponse(BaseModel):
    ...
    slug: str = Field(
        ..., description="Slug for the ModelVersion.", title="Slug"
    )
    ...
    number_base_files: int | None = Field(
        0,
    ...
    available_for: list[AvailableForModel] | None = Field(
        [],
    ...
    has_base_nn_archive: bool | None = Field(
        False,
