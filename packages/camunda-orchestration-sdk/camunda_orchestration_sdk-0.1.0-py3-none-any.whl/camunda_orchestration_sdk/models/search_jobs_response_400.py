...
T = TypeVar("T", bound="SearchJobsResponse400")


@_attrs_define
class SearchJobsResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_jobs_response_400.additional_properties = d
        return search_jobs_response_400
