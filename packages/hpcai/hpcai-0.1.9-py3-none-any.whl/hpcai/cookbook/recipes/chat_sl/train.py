...
import chz
from hpcai.cookbook import cli_utils, model_info, renderers
from hpcai.cookbook.eval.evaluators import EvaluatorBuilder
...
from hpcai.cookbook.supervised.types import ChatDatasetBuilder, ChatDatasetBuilderCommonConfig
from hpcai.cookbook.utils.lr_scheduling import LRSchedule
...
def get_infrequent_evaluator_builders(
    ...
    if inline_evals is None:
        ...
        from hpcai.cookbook.eval.inspect_evaluators import InspectEvaluatorBuilder
...
def cli_main(cli_config: CLIConfig):
    ...
    if cli_config.log_path is not None:
        ...
        log_path = f"/tmp/hpcai-examples/chat_sl/{run_name}"
