...
T = TypeVar("T", bound="StackStormIntegration")


@_attrs_define
class StackStormIntegration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stack_storm_integration.additional_properties = d
        return stack_storm_integration
