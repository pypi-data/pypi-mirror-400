...
if TYPE_CHECKING:
    # fmt: off
    from ..models.multi_data_sources_ingestion_request_col_fill_values import (
        MultiDataSourcesIngestionRequestColFillValues,  # noqa: F401
    )
...
T = TypeVar("T", bound="MultiDataSourcesIngestionRequest")


@attrs.define
class MultiDataSourcesIngestionRequest:
    """
    Attributes:
        source_type (str):
        col_fill_values (Union[Unset, MultiDataSourcesIngestionRequestColFillValues]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_col_fill_values, Unset):
            ...
            col_fill_values = MultiDataSourcesIngestionRequestColFillValues.from_dict(
                _col_fill_values
            )
