...
@final
class Diff_MotionMagicExpoDutyCycle_Position:
    """
    ...
    def __init__(self, average_request: MotionMagicExpoDutyCycle, differential_request: PositionDutyCycle):
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return "Diff_MotionMagicExpoDutyCycle_Position"

    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicExpoDutyCycle_Position")
    ...
    def with_average_request(self, new_average_request: MotionMagicExpoDutyCycle) -> 'Diff_MotionMagicExpoDutyCycle_Position':
        ...
        :type new_average_request: MotionMagicExpoDutyCycle
        :returns: Itself
        :rtype: Diff_MotionMagicExpoDutyCycle_Position
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: PositionDutyCycle) -> 'Diff_MotionMagicExpoDutyCycle_Position':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicExpoDutyCycle_Position':
        """
