...
from haplohub.models.sample_id1 import SampleId1  # noqa: E501


class TestSampleId1(unittest.TestCase):
    """SampleId1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleId1:
        """Test SampleId1
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SampleId1`
        """
        model = SampleId1()  # noqa: E501
        if include_optional:
            return SampleId1(
            )
        else:
