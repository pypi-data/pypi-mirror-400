...
from haplohub.models.get_trait_response import GetTraitResponse  # noqa: E501


class TestGetTraitResponse(unittest.TestCase):
    """GetTraitResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTraitResponse:
        """Test GetTraitResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetTraitResponse`
        """
        model = GetTraitResponse()  # noqa: E501
        if include_optional:
            return GetTraitResponse(
                status = 'success',
                result = haplohub.models.trait_schema.TraitSchema(
                    id = '', 
                    label = '', 
                    category_id = '', 
                    ontology_url = '', )
