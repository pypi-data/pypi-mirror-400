"""
Module that enables bi-directional communication between EV, EVSE, and grid systems. Supports V2G protocols such as ISO 15118 or OCPP.
...
class V2gCommunicationModule(GridSTIXDomainObject):
    """
    Module that enables bi-directional communication between EV, EVSE, and grid systems. Supports V2G protocols such as ISO 15118 or OCPP.
    ...
    _type = "x-grid-v2g-communication-module"
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize V2gCommunicationModule with Grid-STIX properties."""
