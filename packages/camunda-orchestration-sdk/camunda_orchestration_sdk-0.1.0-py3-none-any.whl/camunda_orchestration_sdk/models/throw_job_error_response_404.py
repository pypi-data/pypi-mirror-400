...
T = TypeVar("T", bound="ThrowJobErrorResponse404")


@_attrs_define
class ThrowJobErrorResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        throw_job_error_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        throw_job_error_response_404.additional_properties = d
        return throw_job_error_response_404
