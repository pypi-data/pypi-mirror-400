...
if TYPE_CHECKING:
    # fmt: off
    from ..models.add_source_params_metadata import (
        AddSourceParamsMetadata,  # noqa: F401
    )
    # fmt: on


T = TypeVar("T", bound="AddSourceParams")
...
class AddSourceParams:
    """
    Attributes:
        metadata (Union[Unset, AddSourceParamsMetadata]):
    ...
    metadata: Union[Unset, "AddSourceParamsMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = AddSourceParamsMetadata.from_dict(_metadata)
