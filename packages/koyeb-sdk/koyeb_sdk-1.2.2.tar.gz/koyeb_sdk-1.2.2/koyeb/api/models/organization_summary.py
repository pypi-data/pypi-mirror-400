        ...
        _obj = cls.model_validate(
            {
                ...
                "instances": (
                    InstancesSummary.from_dict(obj["instances"])
                    if obj.get("instances") is not None
                    else None
                ),
                "apps": (
                    AppsSummary.from_dict(obj["apps"])
                ...
                "domains": (
                    DomainsSummary.from_dict(obj["domains"])
                    if obj.get("domains") is not None
                    else None
                ),
                "secrets": (
                    SecretsSummary.from_dict(obj["secrets"])
                    if obj.get("secrets") is not None
                    else None
                ),
                "neon_postgres": (
                    NeonPostgresSummary.from_dict(obj["neon_postgres"])
                    if obj.get("neon_postgres") is not None
                    else None
                ),
                "members": (
                    MembersSummary.from_dict(obj["members"])
