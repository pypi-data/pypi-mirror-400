...
T = TypeVar("T", bound="XPackAlertingIntegration")
...
class XPackAlertingIntegration:
    ...
    Attributes:
        ...
        eswatcher_action_id (Union[Unset, str]):
        eswatcher_host_id (Union[Unset, str]):
    """
    ...
    eswatcher_action_id: Union[Unset, str] = UNSET
    eswatcher_host_id: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        eswatcher_action_id = self.eswatcher_action_id

        eswatcher_host_id = self.eswatcher_host_id
        ...
        if eswatcher_action_id is not UNSET:
            field_dict["eswatcherActionId"] = eswatcher_action_id
        if eswatcher_host_id is not UNSET:
            field_dict["eswatcherHostId"] = eswatcher_host_id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        eswatcher_action_id = d.pop("eswatcherActionId", UNSET)

        eswatcher_host_id = d.pop("eswatcherHostId", UNSET)

        x_pack_alerting_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
            ...
            eswatcher_action_id=eswatcher_action_id,
            eswatcher_host_id=eswatcher_host_id,
        )

        x_pack_alerting_integration.additional_properties = d
        return x_pack_alerting_integration
