...
EEG: RL Task (3-Armed Bandit) with alcohol cues in hazardous drinkers and ctls (OpenNeuro ``ds004595``). Access recordings and metadata through EEGDash.
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds004595.v1.0.0 <https://doi.org/10.18112/openneuro.ds004595.v1.0.0>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds004595>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds004595>`__
