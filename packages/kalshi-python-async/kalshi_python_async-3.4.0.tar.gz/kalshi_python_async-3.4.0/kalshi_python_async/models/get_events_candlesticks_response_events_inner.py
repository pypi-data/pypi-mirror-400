...
class GetEventsCandlesticksResponseEventsInner(BaseModel):
    """
    GetEventsCandlesticksResponseEventsInner
    """ # noqa: E501
    event_ticker: StrictStr = Field(description="The event ticker")
    ...
    __properties: ClassVar[List[str]] = ["event_ticker", "market_tickers", "market_candlesticks", "adjusted_end_ts"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetEventsCandlesticksResponseEventsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetEventsCandlesticksResponseEventsInner from a dict"""
        if obj is None:
            return None
