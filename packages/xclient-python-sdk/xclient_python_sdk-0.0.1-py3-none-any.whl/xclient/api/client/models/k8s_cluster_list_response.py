...
T = TypeVar("T", bound="K8SClusterListResponse")


@_attrs_define
class K8SClusterListResponse:
    """
    Attributes:
        clusters (Union[Unset, list['K8SCluster']]):
        page (Union[Unset, int]):  Example: 1.
        page_size (Union[Unset, int]):  Example: 20.
        total (Union[Unset, int]):  Example: 5.
    """

    clusters: Union[Unset, list["K8SCluster"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for clusters_item_data in _clusters or []:
            clusters_item = K8SCluster.from_dict(clusters_item_data)
        ...
        k8s_cluster_list_response.additional_properties = d
        return k8s_cluster_list_response
