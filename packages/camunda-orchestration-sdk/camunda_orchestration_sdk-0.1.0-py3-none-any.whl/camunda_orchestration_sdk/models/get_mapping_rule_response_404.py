...
T = TypeVar("T", bound="GetMappingRuleResponse404")


@_attrs_define
class GetMappingRuleResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_mapping_rule_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_mapping_rule_response_404.additional_properties = d
        return get_mapping_rule_response_404
