...
if TYPE_CHECKING:
    # fmt: off
    from ..models.criteria_template import CriteriaTemplate  # noqa: F401
    # fmt: on


T = TypeVar("T", bound="CriteriaTemplatesListResponse")


@attrs.define
class CriteriaTemplatesListResponse:
    """
    Attributes:
        limit (int):
        offset (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for templates_item_data in _templates:
            templates_item = CriteriaTemplate.from_dict(templates_item_data)
