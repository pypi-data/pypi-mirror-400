...
T = TypeVar("T", bound="JiraServiceDeskIntegration")
...
class JiraServiceDeskIntegration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        jira_service_desk_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        jira_service_desk_integration.additional_properties = d
        return jira_service_desk_integration
