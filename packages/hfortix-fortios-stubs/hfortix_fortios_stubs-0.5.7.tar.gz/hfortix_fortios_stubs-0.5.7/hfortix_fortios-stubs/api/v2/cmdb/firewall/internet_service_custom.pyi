...
class InternetServiceCustomPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    reputation: NotRequired[int]  # Reputation level of the custom Internet Service.
    comment: NotRequired[str]  # Comment.
    entry: NotRequired[list[dict[str, Any]]]  # Entries added to the Internet Service database and custom da
