...
class HS98(AbstractConstrainedMinimisation):
    """Hock and Schittkowski problem 98.
    ...
    def constraint(self, y):
        ...
        # HS98 has same structure as HS95 but different constants (like HS97/98 in SIF)
        # C1: Same structure, constant = 32.97
        c1 = (
            17.1 * x1
            + 38.2 * x2
            + 204.2 * x3
        ...
        # C2: Same structure, constant = 25.12
        c2 = (
            17.9 * x1
            + 36.8 * x2
            + 113.9 * x3
        ...
        # C3: Different constant = -124.08 (vs -29.08 in HS95/97)
        c3 = -273.0 * x2 - 70.0 * x4 - 819.0 * x5 + 26000.0 * x4 * x5 + 124.08

        # C4: Different constant = -173.02 (vs -78.02 in HS95/97)
        c4 = (
            159.9 * x1
            - 311.0 * x2
            + 587.0 * x4
