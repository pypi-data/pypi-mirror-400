...
VALID_BODY_TYPE: Literal[{"description": "Static NAT", "help": "Static NAT.", "label": "Static Nat", "name": "static-nat"}, {"description": "Server load balance", "help": "Server load balance.", "label": "Server Load Balance", "name": "server-load-balance"}, {"description": "Access proxy", "help": "Access proxy.", "label": "Access Proxy", "name": "access-proxy"}]
...
VALID_BODY_NAT_SOURCE_VIP: Literal[{"description": "Disable nat-source-vip", "help": "Disable nat-source-vip.", "label": "Disable", "name": "disable"}, {"description": "Perform SNAT on traffic from mappedip to the extip for all egress interfaces", "help": "Perform SNAT on traffic from mappedip to the extip for all egress interfaces.", "label": "Enable", "name": "enable"}]
VALID_BODY_NDP_REPLY: Literal[{"description": "Disable this FortiGate unit\u0027s ability to respond to NDP requests for this virtual IP address", "help": "Disable this FortiGate unit\u0027s ability to respond to NDP requests for this virtual IP address.", "label": "Disable", "name": "disable"}, {"description": "Enable this FortiGate unit\u0027s ability to respond to NDP requests for this virtual IP address", "help": "Enable this FortiGate unit\u0027s ability to respond to NDP requests for this virtual IP address.", "label": "Enable", "name": "enable"}]
VALID_BODY_PORTFORWARD: Literal[{"description": "Disable port forward", "help": "Disable port forward.", "label": "Disable", "name": "disable"}, {"description": "Enable/disable port forwarding", "help": "Enable/disable port forwarding.", "label": "Enable", "name": "enable"}]
VALID_BODY_PROTOCOL: Literal[{"description": "TCP", "help": "TCP.", "label": "Tcp", "name": "tcp"}, {"description": "UDP", "help": "UDP.", "label": "Udp", "name": "udp"}, {"description": "SCTP", "help": "SCTP.", "label": "Sctp", "name": "sctp"}]
VALID_BODY_LDB_METHOD: Literal[{"description": "Distribute sessions based on source IP", "help": "Distribute sessions based on source IP.", "label": "Static", "name": "static"}, {"description": "Distribute sessions based round robin order", "help": "Distribute sessions based round robin order.", "label": "Round Robin", "name": "round-robin"}, {"description": "Distribute sessions based on weight", "help": "Distribute sessions based on weight.", "label": "Weighted", "name": "weighted"}, {"description": "Sends new sessions to the server with the lowest session count", "help": "Sends new sessions to the server with the lowest session count.", "label": "Least Session", "name": "least-session"}, {"description": "Distribute new sessions to the server with lowest Round-Trip-Time", "help": "Distribute new sessions to the server with lowest Round-Trip-Time.", "label": "Least Rtt", "name": "least-rtt"}, {"description": "Distribute sessions to the first server that is alive", "help": "Distribute sessions to the first server that is alive.", "label": "First Alive", "name": "first-alive"}, {"description": "Distribute sessions to servers based on host field in HTTP header", "help": "Distribute sessions to servers based on host field in HTTP header.", "label": "Http Host", "name": "http-host"}]
...
VALID_BODY_NAT66: Literal[{"description": "Disable DNAT66", "help": "Disable DNAT66.", "label": "Disable", "name": "disable"}, {"description": "Enable DNAT66", "help": "Enable DNAT66.", "label": "Enable", "name": "enable"}]
...
VALID_BODY_SSL_ALGORITHM: Literal[{"description": "Use AES", "help": "Use AES.", "label": "High", "name": "high"}, {"description": "Use AES, 3DES, or RC4", "help": "Use AES, 3DES, or RC4.", "label": "Medium", "name": "medium"}, {"description": "Use AES, 3DES, RC4, or DES", "help": "Use AES, 3DES, RC4, or DES.", "label": "Low", "name": "low"}, {"description": "Use config ssl-cipher-suites to select the cipher suites that are allowed", "help": "Use config ssl-cipher-suites to select the cipher suites that are allowed.", "label": "Custom", "name": "custom"}]
...
VALID_BODY_SSL_SERVER_ALGORITHM: Literal[{"description": "Use AES", "help": "Use AES.", "label": "High", "name": "high"}, {"description": "Use AES, 3DES, or RC4", "help": "Use AES, 3DES, or RC4.", "label": "Medium", "name": "medium"}, {"description": "Use AES, 3DES, RC4, or DES", "help": "Use AES, 3DES, RC4, or DES.", "label": "Low", "name": "low"}, {"description": "Use config ssl-server-cipher-suites to select the cipher suites that are allowed", "help": "Use config ssl-server-cipher-suites to select the cipher suites that are allowed.", "label": "Custom", "name": "custom"}, {"description": "Use the same encryption algorithms for client and server sessions", "help": "Use the same encryption algorithms for client and server sessions.", "label": "Client", "name": "client"}]
