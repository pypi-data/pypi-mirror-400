...
class Segments_V1_1_0(Serialiser):
    ...
    Attributes:
        vertices (Segments_V1_1_0_Vertices): Vertex coordinates. Columns: x, y, z.
        indices (Segments_V1_1_0_Indices): 0-based indices into the vertices. Each pair is a segment. Columns: n0, n1.
    """
...
class Segments_V1_2_0(Serialiser):
    ...
    Attributes:
        vertices (Segments_V1_2_0_Vertices): Vertex coordinates. Columns: x, y, z.
        indices (Segments_V1_2_0_Indices): 0-based indices into the vertices. Each pair is a segment. Columns: n0, n1.
    """
...
class Segments_V1_0_1(Serialiser):
    ...
    Attributes:
        vertices (Segments_V1_0_1_Vertices): Vertex coordinates. Columns: x, y, z.
        indices (Segments_V1_0_1_Indices): 0-based indices into the vertices. Each pair is a segment. Columns: n0, n1.
    """
