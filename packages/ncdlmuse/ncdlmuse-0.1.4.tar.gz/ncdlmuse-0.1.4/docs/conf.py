# ncdlmuse documentation build configuration file, created by
...
# Notes on ncdlmuse-specific style:
...
# html_title = "ncdlmuse version"

# A shorter title for the navigation bar.  Default is the same as html_title.
# html_short_title = "ncdlmuse"
...
man_pages = [(master_doc, 'ncdlmuse', 'ncdlmuse Documentation', [author], 1)]
...
linkcode_resolve = make_linkcode_resolve(
    'ncdlmuse',
    'https://github.com/pennlinc/ncdlmuse/blob/{revision}/{package}/{path}#L{lineno}',
)
...
# sphinxcontrib-bibtex
# -----------------------------------------------------------------------------
bibtex_bibfiles = ['../ncdlmuse/data/boilerplate.bib']
bibtex_style = 'unsrt'
