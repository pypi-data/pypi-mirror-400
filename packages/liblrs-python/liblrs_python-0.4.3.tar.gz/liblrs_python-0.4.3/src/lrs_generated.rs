...
impl<'a> Lrs<'a> {
  ...
  /// The spatial index of the lrms.
  /// The serialization is the one generated by https://github.com/kylebarron/geo-index
  /// but is compatible with other libraries such as flatbush and kdbush
  #[inline]
