...
def export_traces_jsonl(
    traces: list[Any], output_path: str | Path, compress: bool = False
) -> None:
    """
...
def export_traces_hdf5(
    ...
    try:
        ...
        raise ImportError("h5py not installed") from None
...
def append_trace_jsonl(
    trace: Any, output_path: str | Path, compress: bool = False
) -> None:
    """
...
def load_traces_jsonl(
    input_path: str | Path, compress: bool = False
) -> list[dict[str, Any]]:
    """
