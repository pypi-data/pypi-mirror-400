...
from ropt_eo.everest_optimizers import _OPTIONS_SCHEMA


def test_optpp_options_table() -> None:
    msg = "Regenerate using: python -m ropt_eo.everest_optimizers "
    md_file = (
        Path(__file__).parent.parent / "docs" / "snippets" / "everest_optimizers.md"
    )
