...
class AvailableStoragePreference(BaseModel):
    """
    AvailableStoragePreference
    """ # noqa: E501
    option: StrictStr
    status: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AvailableStoragePreference from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AvailableStoragePreference from a dict"""
        if obj is None:
            return None
