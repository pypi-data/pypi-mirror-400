...
EEG Resting-state Microstates Correlates of Executive Functions (OpenNeuro ``ds005305``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 1` :bdg-light:`License: CC0` :bdg-light:`Subjects: 165` :bdg-light:`Recordings: 165` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds005305.v1.0.1 <https://doi.org/10.18112/openneuro.ds005305.v1.0.1>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds005305>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds005305>`__
