...
class AluraOpenAI:
    ...
    Usage:
        ...
        # Auto-tracked with default event name "llm_call"
        ...
        # Or with custom event name
        alura_openai = AluraOpenAI(openai_client, client, event_name="ai-therapist-response")
    """
    ...
    def __init__(
        ...
        openai_client: Any,
        alura_client: Alura,
        event_name: str = "llm_call",
        embedding_event_name: str = "embedding_call",
    ):
        self._openai = openai_client
        self._alura = alura_client
        self._event_name = event_name
        self._embedding_event_name = embedding_event_name
        self.chat = _ChatNamespace(openai_client, alura_client, event_name)
        self.embeddings = _EmbeddingsNamespace(openai_client, alura_client, embedding_event_name)
...
class _ChatNamespace:
    ...
    def __init__(self, openai_client: Any, alura_client: Alura, event_name: str = "llm_call"):
        self._openai = openai_client
        self._alura = alura_client
        self._event_name = event_name
        self.completions = _ChatCompletions(openai_client, alura_client, event_name)
...
class _EmbeddingsNamespace:
    ...
    def __init__(self, openai_client: Any, alura_client: Alura, event_name: str = "embedding_call"):
        self._openai = openai_client
        self._alura = alura_client
        self._event_name = event_name
