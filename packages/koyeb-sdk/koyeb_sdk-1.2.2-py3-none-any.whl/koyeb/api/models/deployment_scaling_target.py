...
class DeploymentScalingTarget(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "average_cpu": (
                    DeploymentScalingTargetAverageCPU.from_dict(obj["average_cpu"])
                    if obj.get("average_cpu") is not None
                    else None
                ),
                "average_mem": (
                    DeploymentScalingTargetAverageMem.from_dict(obj["average_mem"])
                    if obj.get("average_mem") is not None
                    else None
                ),
                "requests_per_second": (
                    DeploymentScalingTargetRequestsPerSecond.from_dict(
                ...
                "concurrent_requests": (
                    DeploymentScalingTargetConcurrentRequests.from_dict(
                ...
                "requests_response_time": (
                    DeploymentScalingTargetRequestsResponseTime.from_dict(
                ...
                "sleep_idle_delay": (
                    DeploymentScalingTargetSleepIdleDelay.from_dict(
