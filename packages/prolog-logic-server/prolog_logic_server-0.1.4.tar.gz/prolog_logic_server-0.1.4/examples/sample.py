...
#   Fact = { "predicate": string, "args": term[] }
#   Term = string | number | boolean | {"atom": str, "quoted"?: bool} | {"string": str}
#          | {"var": str} | {"number": num} | {"bool": bool} | {"list": term[]}
    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                "facts": {
                    "type": "array",
                    "description": "Ground facts as predicate + term list.",
                    "items": {
                        "type": "object",
                        "properties": {
                            "predicate": {
                            ...
                            "args": {
                                "type": "array",
                                "description": "Arguments as terms (string/number/bool or structured term objects).",
                                "items": {
                                    "oneOf": [
                                        {"type": "string"},
                                        {"type": "number"},
                ...
                "rules_program": {
                    ...
                    "description": "Optional rules as plain text or structured rule objects.",
                },
                "base_knowledge": {
                    "type": "array",
                ...
                "query": {
                    "type": ["string", "object"],
                    "description": "The Prolog query to run, as text or structured goal object.",
                },
                "max_solutions": {
                    "type": "integer",
