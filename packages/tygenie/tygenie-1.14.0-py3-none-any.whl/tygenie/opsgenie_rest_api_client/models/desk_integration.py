...
T = TypeVar("T", bound="DeskIntegration")
...
class DeskIntegration:
    ...
    Attributes:
        ...
        consumer_key (Union[Unset, str]):
        consumer_key_secret (Union[Unset, str]):
        access_token (Union[Unset, str]):
        access_token_secret (Union[Unset, str]):
    ...
    consumer_key_secret: Union[Unset, str] = UNSET
    access_token: Union[Unset, str] = UNSET
    access_token_secret: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        consumer_key_secret = self.consumer_key_secret
        ...
        if consumer_key_secret is not UNSET:
            field_dict["consumerKeySecret"] = consumer_key_secret
        if access_token is not UNSET:
            field_dict["accessToken"] = access_token
        if access_token_secret is not UNSET:
            field_dict["accessTokenSecret"] = access_token_secret
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        consumer_key_secret = d.pop("consumerKeySecret", UNSET)

        access_token = d.pop("accessToken", UNSET)

        access_token_secret = d.pop("accessTokenSecret", UNSET)

        subdomain = d.pop("subdomain", UNSET)

        desk_integration = cls(
            type=type,
            name=name,
            id=id,
            enabled=enabled,
        ...
        desk_integration.additional_properties = d
        return desk_integration
