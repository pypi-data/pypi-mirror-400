...
T = TypeVar("T", bound="SearchProcessDefinitionsResponse403")


@_attrs_define
class SearchProcessDefinitionsResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_process_definitions_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        search_process_definitions_response_403.additional_properties = d
        return search_process_definitions_response_403
