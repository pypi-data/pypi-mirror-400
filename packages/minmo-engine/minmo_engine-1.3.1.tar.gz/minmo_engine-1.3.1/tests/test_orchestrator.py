...
from minmo.gemini_cli_wrapper import TaskPlan, ProjectAnalysis
...
class TestMinmoOrchestrator:
    ...
    def mock_gemini(self):
        """Mock GeminiCLIWrapper."""
        with patch("minmo.orchestrator.GeminiCLIWrapper") as mock:
            instance = MagicMock()
...
class TestIntegration:
    ...
    def mock_deps(self):
        ...
        with patch("minmo.orchestrator.log_event") as mock_log, \
             patch("minmo.orchestrator.update_todo") as mock_update, \
             patch("minmo.orchestrator.get_state") as mock_state, \
             patch("minmo.orchestrator.GeminiCLIWrapper") as mock_gemini_cls, \
