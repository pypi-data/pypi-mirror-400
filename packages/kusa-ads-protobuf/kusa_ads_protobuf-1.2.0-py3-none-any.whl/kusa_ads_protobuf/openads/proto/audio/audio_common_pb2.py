...
# source: openads/proto/audio/audio_common.proto
...
_AUDIOTYPE = _descriptor.EnumDescriptor(
  name='AudioType',
  full_name='openads.proto.audio.AudioType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_AUDIODIRECTION = _descriptor.EnumDescriptor(
  name='AudioDirection',
  full_name='openads.proto.audio.AudioDirection',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
