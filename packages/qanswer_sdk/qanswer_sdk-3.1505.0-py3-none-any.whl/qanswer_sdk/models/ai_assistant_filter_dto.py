...
class AiAssistantFilterDto(BaseModel):
    ...
    favorite_first: Optional[StrictBool] = Field(default=None, alias="favoriteFirst")
    ...
    __properties: ClassVar[List[str]] = ["search", "aiAssistantId", "userId", "teamId", "organizationId", "owned", "favorite", "favoriteFirst", "page", "size", "sortBy", "sortDir"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "favoriteFirst": obj.get("favoriteFirst"),
            "page": obj.get("page"),
            "size": obj.get("size"),
