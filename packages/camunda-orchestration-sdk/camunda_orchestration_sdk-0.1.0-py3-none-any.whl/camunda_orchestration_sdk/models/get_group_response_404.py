...
T = TypeVar("T", bound="GetGroupResponse404")


@_attrs_define
class GetGroupResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_group_response_404.additional_properties = d
        return get_group_response_404
