...
# source: openads/proto/common/monitor_log.proto
...
_MONITORMESSAGEITEM_MESSAGESOURCE = _descriptor.EnumDescriptor(
  name='MessageSource',
  full_name='openads.proto.common.monitor.MonitorMessageItem.MessageSource',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_MONITORMESSAGEITEM_LOGLEVEL = _descriptor.EnumDescriptor(
  name='LogLevel',
  full_name='openads.proto.common.monitor.MonitorMessageItem.LogLevel',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_MONITORMESSAGEITEM = _descriptor.Descriptor(
  ...
  full_name='openads.proto.common.monitor.MonitorMessageItem',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='source', full_name='openads.proto.common.monitor.MonitorMessageItem.source', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='msg', full_name='openads.proto.common.monitor.MonitorMessageItem.msg', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='log_level', full_name='openads.proto.common.monitor.MonitorMessageItem.log_level', index=2,
...
_MONITORMESSAGE = _descriptor.Descriptor(
  name='MonitorMessage',
  full_name='openads.proto.common.monitor.MonitorMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='header', full_name='openads.proto.common.monitor.MonitorMessage.header', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='item', full_name='openads.proto.common.monitor.MonitorMessage.item', index=1,
...
_MONITORMESSAGE.fields_by_name['header'].message_type = openads_dot_proto_dot_common_dot_header__pb2._HEADER
...
MonitorMessageItem = _reflection.GeneratedProtocolMessageType('MonitorMessageItem', (_message.Message,), dict(
  ...
  __module__ = 'openads.proto.common.monitor_log_pb2'
  # @@protoc_insertion_point(class_scope:openads.proto.common.monitor.MonitorMessageItem)
  ))
...
MonitorMessage = _reflection.GeneratedProtocolMessageType('MonitorMessage', (_message.Message,), dict(
  ...
  __module__ = 'openads.proto.common.monitor_log_pb2'
  # @@protoc_insertion_point(class_scope:openads.proto.common.monitor.MonitorMessage)
  ))
