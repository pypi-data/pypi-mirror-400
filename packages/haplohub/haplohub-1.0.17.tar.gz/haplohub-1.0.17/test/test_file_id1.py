...
from haplohub.models.file_id1 import FileId1  # noqa: E501


class TestFileId1(unittest.TestCase):
    """FileId1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileId1:
        """Test FileId1
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FileId1`
        """
        model = FileId1()  # noqa: E501
        if include_optional:
            return FileId1(
            )
        else:
