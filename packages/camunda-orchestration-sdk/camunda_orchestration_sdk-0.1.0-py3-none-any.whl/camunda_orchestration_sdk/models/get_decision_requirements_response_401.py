...
T = TypeVar("T", bound="GetDecisionRequirementsResponse401")


@_attrs_define
class GetDecisionRequirementsResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_decision_requirements_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_decision_requirements_response_401.additional_properties = d
        return get_decision_requirements_response_401
