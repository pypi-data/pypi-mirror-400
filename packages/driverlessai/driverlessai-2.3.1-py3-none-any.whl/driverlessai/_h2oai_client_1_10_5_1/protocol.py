...
from _h2oai_client_1_10_5_1 import references
from _h2oai_client_1_10_5_1 import validation
from _h2oai_client_1_10_5_1.messages import *
...
class Client:
    ...
    # These are extension methods that are appended to the _h2oai_client_1_10_5_1 module
    ...
    def import_experiment_sync(self, file_path: str) -> str:
        ...
        :rtype: str
        """
        remote_file_paths = self.perform_chunked_upload(file_path, skip_parse=True)
    ...
    def create_dataset_from_sa_ws(self, sa_key: str, hist_entry: int) -> str:
        """
    ...
    def make_dataset_split(self, dataset_key: str, output_name1: str, output_name2: str, target: str, fold_col: str, time_col: str, ratio: float, seed: int, split_datetime: str) -> str:
        """
    ...
    def get_experiments_queue(self) -> TaskQueueResponse:
        """
        Returns list of experiment IDs in Task queue
    ...
    def list_triton_models(self, url: str, offset: int, limit: int) -> ListTritonModelQueryResponse:
        """

        """
        req_ = dict(url=url, offset=offset, limit=limit)
        res_ = self._request('list_triton_models', req_)
        return ListTritonModelQueryResponse.load(res_)

    def load_triton_model(self, experiment_key: str, url: str, config: str, files: dict) -> None:
        """

        """
        req_ = dict(experiment_key=experiment_key, url=url, config=config, files=files)
        self._request('load_triton_model', req_)
        return None

    def unload_triton_model(self, experiment_key: str, url: str) -> None:
        """

        """
        req_ = dict(experiment_key=experiment_key, url=url)
        self._request('unload_triton_model', req_)
        return None

    def delete_triton_model(self, experiment_key: str, url: str) -> None:
        """
    ...
    def deploy_model_to_triton(self, experiment_key: str, local: bool, deploy_preds: bool, deploy_pred_contribs: bool, deploy_pred_contribs_orig: bool, dest_dir: str, high_concurrency: bool) -> None:
        """
        ...
        self._request('deploy_model_to_triton', req_)
        return None
...
class AutovizClient:
    ...
    def __init__(self, _h2oai_client_1_10_5_1):
        self.client = _h2oai_client_1_10_5_1
