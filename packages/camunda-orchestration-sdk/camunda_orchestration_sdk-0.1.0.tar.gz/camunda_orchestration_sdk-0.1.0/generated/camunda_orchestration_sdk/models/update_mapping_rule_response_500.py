...
T = TypeVar("T", bound="UpdateMappingRuleResponse500")


@_attrs_define
class UpdateMappingRuleResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_mapping_rule_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        update_mapping_rule_response_500.additional_properties = d
        return update_mapping_rule_response_500
