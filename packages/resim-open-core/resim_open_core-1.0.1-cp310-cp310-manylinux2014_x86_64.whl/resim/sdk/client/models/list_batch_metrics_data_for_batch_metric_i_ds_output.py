...
class ListBatchMetricsDataForBatchMetricIDsOutput:
    """ 
        Attributes:
            batch_metrics_data_and_i_ds (list[BatchMetricsDataAndIDs] | Unset):
            next_page_token (str | Unset):
     """

    batch_metrics_data_and_i_ds: list[BatchMetricsDataAndIDs] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.batch_metrics_data_and_i_ds import BatchMetricsDataAndIDs
        batch_metrics_data_and_i_ds: list[dict[str, Any]] | Unset = UNSET
