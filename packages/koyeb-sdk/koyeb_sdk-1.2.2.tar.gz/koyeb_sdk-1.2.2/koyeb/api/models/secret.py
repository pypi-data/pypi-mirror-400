        ...
        _obj = cls.model_validate(
            {
                ...
                "value": obj.get("value"),
                "docker_hub_registry": (
                    DockerHubRegistryConfiguration.from_dict(obj["docker_hub_registry"])
                    if obj.get("docker_hub_registry") is not None
                    else None
                ),
                "private_registry": (
                    PrivateRegistryConfiguration.from_dict(obj["private_registry"])
                    if obj.get("private_registry") is not None
                    else None
                ),
                "digital_ocean_registry": (
                    DigitalOceanRegistryConfiguration.from_dict(
                ...
                "github_registry": (
                    GitHubRegistryConfiguration.from_dict(obj["github_registry"])
                    if obj.get("github_registry") is not None
                    else None
                ),
                "gitlab_registry": (
                    GitLabRegistryConfiguration.from_dict(obj["gitlab_registry"])
                ...
                "azure_container_registry": (
                    AzureContainerRegistryConfiguration.from_dict(
                ...
                "database_role_password": (
                    DatabaseRolePassword.from_dict(obj["database_role_password"])
