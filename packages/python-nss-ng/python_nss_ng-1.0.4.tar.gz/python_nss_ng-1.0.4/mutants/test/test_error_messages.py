...
class TestErrorMessageQuality:
    ...
    def test_certificate_not_found_error_message(self, nss_db_context):
    ...
    def test_invalid_database_path_error_message(self):
        ...
        # Shutdown NSS if initialized
        try:
            nss.nss_shutdown()
        except:
            pass

        with pytest.raises((NSPRError, Exception)) as exc_info:
            nss.nss_init('sql:/completely/invalid/nonexistent/path/to/database')
    ...
    def test_malformed_data_error_message(self, nss_db_context):
    ...
    def test_type_error_messages_informative(self, nss_db_context):
...
class TestExceptionTypes:
    ...
    def test_value_error_for_invalid_values(self, nss_db_context):
    ...
    def test_file_not_found_for_missing_tools(self):
        """Test that missing tools raise FileNotFoundError."""
...
class TestErrorContext:
    ...
    def test_error_includes_operation_context(self, nss_db_context):
    ...
    def test_error_preserves_traceback(self, nss_db_context):
    ...
    def test_nested_exceptions_handled(self, nss_db_context):
...
class TestErrorRecovery:
    ...
    def test_recovery_after_certificate_error(self, nss_db_context):
    ...
    def test_recovery_after_digest_error(self, nss_db_context):
    ...
    def test_recovery_after_ssl_error(self, nss_db_context):
...
class TestErrorConsistency:
    ...
    def test_nonexistent_items_raise_same_error_type(self, nss_db_context):
    ...
    def test_type_errors_consistent(self, nss_db_context):
...
class TestErrorAttributes:
    ...
    def test_nspr_error_has_message(self, nss_db_context):
    ...
    def test_nspr_error_has_errno(self, nss_db_context):
    ...
    def test_type_error_has_message(self, nss_db_context):
...
class TestUserFriendlyErrors:
    ...
    def test_errors_use_plain_language(self, nss_db_context):
...
class TestDeprecationWarnings:
    ...
    def test_deprecation_warnings_suggest_alternatives(self):
        ...
        from deprecations import get_deprecation_message
