...
__all__ = ["JinjaStateMachineLexer"]
...
class JinjaStateMachineLexer(CStyleNumbersMixin, StateMachineLexer):
    ...
    def _tokenize_expression(
        ...
        """Tokenize inside {{ ... }}."""
        yield from self._tokenize_jinja_content(code, pos, line, line_start, "}}")
