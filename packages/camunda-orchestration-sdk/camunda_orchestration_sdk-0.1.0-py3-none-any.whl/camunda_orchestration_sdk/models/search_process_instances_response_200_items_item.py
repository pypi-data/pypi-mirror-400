...
from ..models.search_process_instances_response_200_items_item_state import (
    SearchProcessInstancesResponse200ItemsItemState,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SearchProcessInstancesResponse200ItemsItem")


@_attrs_define
class SearchProcessInstancesResponse200ItemsItem:
    ...
    Attributes:
        ...
        state (SearchProcessInstancesResponse200ItemsItemState): Process instance states
    ...
    process_definition_version: int
    start_date: datetime.datetime
    state: SearchProcessInstancesResponse200ItemsItemState
    has_incident: bool
    tenant_id: TenantId
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        state = SearchProcessInstancesResponse200ItemsItemState(d.pop("state"))
        ...
        search_process_instances_response_200_items_item = cls(
        ...
        search_process_instances_response_200_items_item.additional_properties = d
        return search_process_instances_response_200_items_item
