...
static PyObject *
I8Vector1Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(int8_t) * 1;
...
static PyMethodDef I8Vector1Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)I8Vector1Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
