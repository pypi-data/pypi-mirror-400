...
from . import tunnel_pb2 as grpctunnel_dot_v1_dot_tunnel__pb2
...
class TunnelServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.OpenTunnel = channel.stream_stream(
                ...
                request_serializer=grpctunnel_dot_v1_dot_tunnel__pb2.ClientToServer.SerializeToString,
                response_deserializer=grpctunnel_dot_v1_dot_tunnel__pb2.ServerToClient.FromString,
                _registered_method=True)
        self.OpenReverseTunnel = channel.stream_stream(
                '/grpctunnel.v1.TunnelService/OpenReverseTunnel',
                request_serializer=grpctunnel_dot_v1_dot_tunnel__pb2.ServerToClient.SerializeToString,
                response_deserializer=grpctunnel_dot_v1_dot_tunnel__pb2.ClientToServer.FromString,
                _registered_method=True)
...
def add_TunnelServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'OpenTunnel': grpc.stream_stream_rpc_method_handler(
                    servicer.OpenTunnel,
                    request_deserializer=grpctunnel_dot_v1_dot_tunnel__pb2.ClientToServer.FromString,
                    response_serializer=grpctunnel_dot_v1_dot_tunnel__pb2.ServerToClient.SerializeToString,
            ),
            'OpenReverseTunnel': grpc.stream_stream_rpc_method_handler(
                    servicer.OpenReverseTunnel,
                    request_deserializer=grpctunnel_dot_v1_dot_tunnel__pb2.ServerToClient.FromString,
                    response_serializer=grpctunnel_dot_v1_dot_tunnel__pb2.ClientToServer.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'grpctunnel.v1.TunnelService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('grpctunnel.v1.TunnelService', rpc_method_handlers)
...
class TunnelService(object):
    ...
    def OpenTunnel(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/grpctunnel.v1.TunnelService/OpenTunnel',
            grpctunnel_dot_v1_dot_tunnel__pb2.ClientToServer.SerializeToString,
            grpctunnel_dot_v1_dot_tunnel__pb2.ServerToClient.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def OpenReverseTunnel(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/grpctunnel.v1.TunnelService/OpenReverseTunnel',
            grpctunnel_dot_v1_dot_tunnel__pb2.ServerToClient.SerializeToString,
            grpctunnel_dot_v1_dot_tunnel__pb2.ClientToServer.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
