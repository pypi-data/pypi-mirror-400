...
- `extension/README.md` â€“ extension usage and UI
- `extension/documentation/README.md` â€“ architecture and internals
- `runyx_bridge/README.md` â€“ Python bridge and runner details
