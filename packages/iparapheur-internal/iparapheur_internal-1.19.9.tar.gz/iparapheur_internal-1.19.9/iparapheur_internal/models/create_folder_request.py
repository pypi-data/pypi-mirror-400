...
class CreateFolderRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "dueDate", "metadata", "draftCreationDate", "stillSinceDate", "type", "subtype", "originUser", "originDesk", "finalDesk", "isReadByCurrentUser", "state", "legacyId", "typeId", "subtypeId", "stepList", "documentList", "signatureProofList", "readByUserIds", "variableDesksIds", "detachedSignaturesMapping", "visibility", "readByCurrentUser"]
