...
T = TypeVar("T", bound="GetBatchOperationResponse404")


@_attrs_define
class GetBatchOperationResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_batch_operation_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_batch_operation_response_404.additional_properties = d
        return get_batch_operation_response_404
