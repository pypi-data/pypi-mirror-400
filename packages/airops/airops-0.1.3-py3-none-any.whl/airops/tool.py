    ...
    def serve(
        ...
        *,
        ...
        Args:
            ...
            reload: Enable hot reload on file changes. None (default) auto-detects
                    based on whether running from __main__.
        """
        if self._handler is None:
            raise RuntimeError(
                f"No handler registered for tool '{self.name}'. "
        ...
        if reload is None:
            reload = caller_module is not None and caller_module.__name__ == "__main__"
