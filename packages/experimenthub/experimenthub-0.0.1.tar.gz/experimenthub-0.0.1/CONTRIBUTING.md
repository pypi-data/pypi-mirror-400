...
Welcome to `experimenthub` contributor's guide.
...
If you experience bugs or general issues with `experimenthub`, please have a look
...
You can help improve `experimenthub` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`experimenthub` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `experimenthub`'s files. While this mechanism can
...
```
conda create -n experimenthub python=3 six virtualenv pytest pytest-cov
conda activate experimenthub
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/experimenthub.git
   cd experimenthub
   ```
...
5. Install [pre-commit]:
   ...
   `experimenthub` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/experimenthub
[issue tracker]: https://github.com/<USERNAME>/experimenthub/issues
