...
configuring image settings. It also contains a function to create a Dictionary with
missing objects per species based on GBIF data and MinIO storage.
"""
...
def load_dataframe(path: str) -> pd.DataFrame:
    ...
    try:
        ...
        raise RuntimeError("Error reading CSV file %s: %s", path) from e
