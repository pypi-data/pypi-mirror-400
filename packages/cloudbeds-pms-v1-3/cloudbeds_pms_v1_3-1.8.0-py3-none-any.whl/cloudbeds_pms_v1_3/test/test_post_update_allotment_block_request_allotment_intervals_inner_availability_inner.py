    ...
    def make_instance(self, include_optional) -> PostUpdateAllotmentBlockRequestAllotmentIntervalsInnerAvailabilityInner:
        ...
        if include_optional:
            return PostUpdateAllotmentBlockRequestAllotmentIntervalsInnerAvailabilityInner(
                ...
                rate = '',
                guest_pricing = cloudbeds_pms_v1_3.models.post_update_allotment_block_request_allotment_intervals_inner_availability_inner_guest_pricing.PostUpdateAllotmentBlockRequest_allotmentIntervals_inner_availability_inner_guestPricing(
                    adult1 = '', 
                    adult2 = '', 
                    adult3 = '', 
                    child1 = '', 
