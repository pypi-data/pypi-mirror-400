...
Healthy Brain Network (HBN) EEG - Release 4 (OpenNeuro ``ds005508``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 10` :bdg-light:`License: CC-BY-SA 4.0` :bdg-light:`Subjects: 324` :bdg-light:`Recordings: 3342` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC-BY-SA 4.0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds005508.v1.0.1 <https://doi.org/10.18112/openneuro.ds005508.v1.0.1>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds005508>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds005508>`__
