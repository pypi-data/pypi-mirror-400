...
T = TypeVar("T", bound="CreateDocumentsResponse400")


@_attrs_define
class CreateDocumentsResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_documents_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_documents_response_400.additional_properties = d
        return create_documents_response_400
