...
if TYPE_CHECKING:
    from ..models.get_start_process_form_response_200_schema import (
        GetStartProcessFormResponse200Schema,
    )


T = TypeVar("T", bound="GetStartProcessFormResponse200")


@_attrs_define
class GetStartProcessFormResponse200:
    """
    Attributes:
        ...
        schema (GetStartProcessFormResponse200Schema | Unset): The form content.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_schema, Unset):
            ...
            schema = GetStartProcessFormResponse200Schema.from_dict(_schema)
        ...
        get_start_process_form_response_200.additional_properties = d
        return get_start_process_form_response_200
