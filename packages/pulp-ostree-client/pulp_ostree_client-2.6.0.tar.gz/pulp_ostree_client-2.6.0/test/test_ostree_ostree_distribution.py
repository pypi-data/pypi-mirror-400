...
class TestOstreeOstreeDistribution(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OstreeOstreeDistribution:
        """Test OstreeOstreeDistribution
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OstreeOstreeDistribution`
        """
        model = OstreeOstreeDistribution()
        if include_optional:
