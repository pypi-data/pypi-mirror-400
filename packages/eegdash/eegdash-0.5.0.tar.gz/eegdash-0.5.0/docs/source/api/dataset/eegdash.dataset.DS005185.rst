...
Ear-EEG Sleep Monitoring 2019 (EESM19) (OpenNeuro ``ds005185``). Access recordings and metadata through EEGDash.

.. rst-class:: sd-badges

:bdg-light:`Modality: eeg` :bdg-light:`Tasks: 3` :bdg-light:`License: CC0` :bdg-light:`Subjects: 20` :bdg-light:`Recordings: 356` :bdg-light:`Source: openneuro`
...
.. list-table::
   ...
   * - License
     - CC0
   * - Citation / DOI
     - `doi:10.18112/openneuro.ds005185.v1.0.2 <https://doi.org/10.18112/openneuro.ds005185.v1.0.2>`__
   * - Source links
     - `OpenNeuro <https://openneuro.org/datasets/ds005185>`__ | `NeMAR <https://nemar.org/dataexplorer/detail?dataset_id=ds005185>`__
