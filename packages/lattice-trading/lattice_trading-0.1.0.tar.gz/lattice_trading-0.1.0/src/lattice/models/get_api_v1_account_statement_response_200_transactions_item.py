...
T = TypeVar("T", bound="GetApiV1AccountStatementResponse200TransactionsItem")


@_attrs_define
class GetApiV1AccountStatementResponse200TransactionsItem:
    """
    Attributes:
        id (str):
        type (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_api_v1_account_statement_response_200_transactions_item = cls(
            id=id,
            type=type,
            amount=amount,
        ...
        return get_api_v1_account_statement_response_200_transactions_item
