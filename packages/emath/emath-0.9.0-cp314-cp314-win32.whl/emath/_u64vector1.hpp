...
static PyObject *
U64Vector1Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof(uint64_t) * 1;
...
static PyMethodDef U64Vector1Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)U64Vector1Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
