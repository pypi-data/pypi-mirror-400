...
class GetAlgorithmVersionResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAlgorithmVersionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAlgorithmVersionResponse:
        """Create an instance of GetAlgorithmVersionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAlgorithmVersionResponse.parse_obj(obj)

        _obj = GetAlgorithmVersionResponse.parse_obj(
            {
