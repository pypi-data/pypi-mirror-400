    ...
    payload: dict[str, Any] = {
        ...
        "workflow": {
            ...
            "notes": [
                ...
                "Force print: whenever squad_start/squad_status returns summary_lines/event_lines, print them line by line in the current conversation (keep concise). Print first, then sleep for forced_wait_ms before the next status call.",
