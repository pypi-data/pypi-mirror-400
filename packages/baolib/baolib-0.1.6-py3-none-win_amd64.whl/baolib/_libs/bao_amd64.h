...
//
extern __declspec(dllexport) Result bao_create(long long int dbH, char* idC, char* storeC, char* configC);

// bao_open opens an existing vault with the specified identity, author and URL. The function returns a handle to the bao.
//
extern __declspec(dllexport) Result bao_open(long long int dbH, char* idC, char* configC, char* authorC);
